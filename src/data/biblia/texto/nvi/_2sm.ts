const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Eles haviam entrado na casa enquanto Is-Bosete estava deitado em seu quarto. Depois de o traspassar e matar, cortaram-lhe a cabeça. E, levando-a, viajaram toda a noite pela rota da Arabá.`,
  ...
  10: [
    ...
    `Davi pensou: “Serei bondoso com Hanum, filho de Naás, como seu pai foi bondoso comigo”. Então Davi enviou uma delegação para transmitir a Hanum seu pesar pela morte do pai dele. Mas, quando os mensageiros de Davi chegaram à terra dos amonitas,`,
  ...
  12: [
    ...
    `Dei a você a casa e as mulheres do seu senhor. Dei a você a nação de Israel e Judá. E, se tudo isso não fosse suficiente, eu teria dado mais ainda.`,
  ...
  14: [
    ...
    `Quando a mulher apresentou-se ao rei, prostrou-se com o rosto em terra, em sinal de respeito, e lhe disse: “Ajuda-me, ó rei!”`,
    ...
    `“E eu vim falar sobre isso ao rei, meu senhor, porque o povo me ameaçou. Tua serva pensou que, se falasse com o rei, talvez ele atendesse ao seu pedido`,
    ...
    `O rei perguntou: “Não é Joabe que está por trás de tudo isso?” A mulher respondeu: “Juro por tua vida, ó rei, ninguém é capaz de desviar-se para a direita ou para a esquerda do que tu dizes. Sim, foi o teu servo Joabe que me mandou aqui para dizer tudo isso.`,
    ...
    `Joabe prostrou-se com o rosto em terra, abençoou o rei e disse: “Hoje o teu servo ficou sabendo que o vês com bons olhos, pois o rei atendeu ao pedido de teu servo”.`,
    ...
    `Então Joabe foi contar tudo ao rei, que mandou chamar Absalão. Ele entrou e prostrou-se com o rosto em terra, perante o rei. E o rei saudou-o com um beijo.`,
  ],
  15: [
    ...
    `Depois de oferecer sacrifícios, Absalão mandou chamar Aitofel, da cidade de Gilo, conselheiro de Davi. A conspiração ganhou força, e cresceu o número dos que seguiam Absalão.`,
    ...
    `Itai, contudo, respondeu ao rei: “Juro pelo nome do SENHOR e por tua vida que, onde quer que o rei, meu senhor, esteja, ali estará o teu servo, para viver ou para morrer!”`,
  ...
  16: [
    ...
    `“Onde está Mefibosete, neto de seu senhor?”, perguntou o rei. Respondeu-lhe Ziba: “Ele ficou em Jerusalém, pois acredita que os israelitas lhe restituirão o reino de seu avô”.`,
  ...
  24: [
    ...
    `Quando Araúna viu o rei e seus soldados vindo ao encontro dele, saiu e prostrou-se perante o rei com o rosto em terra,`,
    ...
    `Mas o rei respondeu a Araúna: “Não! Faço questão de pagar o preço justo. Não oferecerei ao SENHOR, o meu Deus, holocaustos que não me custem nada”; e comprou a eira e os bois por cinquenta peças de prata.`,
