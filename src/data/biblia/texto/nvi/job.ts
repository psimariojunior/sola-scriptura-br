const data: Record<number, string[]> = {
  1: [
    ...
    `Enquanto ele ainda estava falando, chegou outro mensageiro e disse: “Fogo de Deus caiu do céu e queimou totalmente as ovelhas e os empregados, e eu fui o único que escapou para contar a você!”`,
    `Enquanto ele ainda estava falando, chegou outro mensageiro e disse: “Vieram caldeus em três bandos, atacaram os camelos e os levaram embora. Mataram à espada os empregados, e eu fui o único que escapou para contar a você!”`,
    ...
    `quando, de repente, um vento muito forte veio do deserto e atingiu os quatro cantos da casa, que desabou. Eles morreram, e eu fui o único que escapou para contar a você!”`,
  ...
  11: [
    ...
    `Pois ele não identifica os enganadores e não reconhece a iniquidade logo que a vê?`,
  ...
  15: [
    ...
    `Eles concebem maldade e dão à luz a iniquidade; seu ventre gera engano”.`,
  ],
  16: [
    `Então Jó respondeu:`,
  ...
  21: [
    ...
    `Eles veem os seus filhos estabelecidos ao seu redor e os seus descendentes diante dos seus olhos.`,
  ...
  39: [
    ...
    `“É graças à inteligência que você tem que o falcão alça voo e estende as asas rumo ao sul?`,
  ...
  40: [
    ...
    `“Prepare-se como simples homem que é; eu farei perguntas, e você me responderá.`,
    ...
    `Então admitirei que a sua mão direita pode salvá-lo.`,
