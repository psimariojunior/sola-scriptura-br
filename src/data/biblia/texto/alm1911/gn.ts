const data: Record<number, string[]> = {
  ...
  3: [
    `Ora a serpente era mais astuta que todas as alimarias do campo que o Senhor Deus tinha feito. E esta disse á mulher: É assim que Deus disse: Não comereis de toda a arvore do jardim?`,
    `E disse a mulher á serpente: Do fructo das arvores do jardim comeremos,`,
    `Mas do fructo da arvore que está no meio do jardim, disse Deus: Não comereis d'elle, nem n'elle tocareis para que não morraes.`,
    ...
    `E viu a mulher que aquella arvore era boa para se comer, e agradavel aos olhos, e arvore desejavel para dar intendimento; tomou do seu fructo, e comeu, e deu tambem a seu marido comsigo, e elle comeu.`,
    ...
    `E ouviram a voz do Senhor Deus, que passeava no jardim pela viração do dia: e escondeu-se Adão e sua mulher da presença do Senhor Deus, entre as arvores do jardim.`,
    ...
    `Então o Senhor Deus disse á serpente: Porquanto fizeste isto, maldita serás mais que toda a besta, e mais que todos os animaes do campo: sobre o teu ventre andarás, e pó comerás todos os dias da tua vida.`,
    ...
    `E a Adão disse: Porquanto deste ouvidos á voz de tua mulher, e comeste da arvore de que te ordenei, dizendo: Não comerás d'ella: maldita é a terra por causa de ti; com dôr comerás d'ella todos os dias da tua vida.`,
    ...
    `Então disse o Senhor Deus: Eis que o homem é como um de Nós, sabendo o bem e o mal; ora, pois, para que não estenda a sua mão, e tome tambem da arvore da vida, e coma e viva eternamente:`,
  ...
  12: [
    ...
    `E tomou Abrão a Sarai, sua mulher, e a Lot, filho de seu irmão, e toda a sua fazenda, que haviam adquirido, e as almas que lhe accresceram em Haran: e sairam para irem á terra de Canaan; e vieram á terra de Canaan.`,
    ...
    `E moveu-se d'ali para a montanha á banda do Oriente de Bethel, e armou a sua tenda, tendo Bethel ao Occidente, e Ai ao Oriente; e edificou ali um altar ao Senhor, e invocou o nome do Senhor.`,
    ...
    `E será que, quando os Egypcios te virem, dirão: Esta é sua mulher. E matar-me-hão a mim, e a ti te guardarão em vida`,
  ...
  14: [
    ...
    `Que estes fizeram guerra a Bera, rei de Sodoma, a Birsha, rei de Gomorrah, a Shinab, rei de Admah, e a Shemeber, rei de Zeboiim, e ao rei de Bela (esta é Zoar).`,
    ...
    `E ao decimo quarto anno veiu Chedorlaomer, e os reis que estavam com elle, e feriram aos Rephains em Ashteroth-karnaim, e aos Zuzins em Ham, e aos Emins em Shave-kiriathaim,`,
    ...
    `Então saiu o rei de Sodoma, e o rei de Gomorrah, e o rei de Admah, e o rei de Zeboiim, e o rei de Bela (esta é Zoar), e ordenaram batalha contra elles no valle de Siddim,`,
    ...
    `Então veiu um que escapára, e o contou a Abrão, o Hebreu: elle habitava junto dos carvalhaes de Mamre, o Amoreo, irmão de Eshcol, e irmão de Aner; elles eram confederados de Abrão.`,
    `Ouvindo pois Abrão que o seu irmão estava preso, armou os seus creados, nascidos em sua casa, trezentos e dezoito, e os perseguiu até Dan.`,
  ...
  16: [
    ...
    `Assim tomou Sarai, mulher de Abrão, a Hagar Egypcia, sua serva, e deu-a por mulher a Abrão seu marido, ao fim de dez annos que Abrão habitara na terra de Canaan.`,
  ...
  18: [
    ...
    `Visto que Abrahão certamente virá a ser uma grande e poderosa nação, e n'elle serão bemditas todas as nações da terra.`,
    `Porque eu o tenho conhecido, que elle ha de ordenar a seus filhos e a sua casa depois d'elle, para que guardem o caminho do Senhor, para obrar com justiça e juizo: para que o Senhor faça vir sobre Abrahão o que ácerca d'elle tem fallado.`,
    ...
    `Se porventura houver cincoenta justos na cidade, destruil-os-has tambem, e não pouparás o logar por causa dos cincoenta justos que estão dentro d'ella?`,
    `Longe de ti que faças tal coisa, que mates o justo com o impio: que o justo seja como o impio, longe de ti seja. Não faria justiça o Juiz de toda a terra?`,
    ...
    `Porventura faltarão de cincoenta justos cinco; destruirás por aquelles cinco toda a cidade? E disse: Não a destruirei, se eu achar ali quarenta e cinco.`,
  ...
  24: [
    ...
    `O Senhor, Deus dos céus, que me tomou da casa de meu pae e da terra da minha parentela, e que me fallou, e que me jurou, dizendo: Á tua semente darei esta terra: Elle enviará o seu anjo adiante da tua face, para que tomes mulher de lá para meu filho.`,
    ...
    `E o servo tomou dez camelos, dos camelos do seu senhor, e partiu, pois que toda a fazenda de seu senhor estava em sua mão, e levantou-se e partiu para Mesopotamia, para a cidade de Nahor,`,
    ...
    `Seja pois que a donzella, a quem eu disser: Abaixa agora o teu cantaro para que eu beba; e ella disser: Bebe, e tambem darei de beber aos teus camelos; esta seja a quem designaste ao teu servo Isaac, e que eu conheça n'isso que fizeste beneficencia a meu senhor.`,
    `E succedeu que, antes que elle acabasse de fallar, eis que Rebecca, que havia nascido a Bethuel, filho de Milcah, mulher de Nahor, irmão de Abrahão, sahia com o seu cantaro sobre o seu hombro.`,
    ...
    `E aconteceu que, acabando os camelos de beber, tomou o varão um pendente de oiro de meio siclo de peso, e duas pulseiras para as suas mãos, do peso de dez siclos de oiro.`,
    `E disse: De quem és filha? faze-m'o saber, peço-te; ha tambem em casa de teu pae logar para nós pousarmos?`,
    `E ella lhe disse: Eu sou a filha de Bethuel, filho de Milcah, o qual ella pariu a Nahor.`,
    ...
    `E disse: Bemdito seja o Senhor Deus de meu senhor Abrahão, que não retirou a sua beneficencia e a sua verdade de meu senhor: quanto a mim, o Senhor me guiou no caminho á casa dos irmãos de meu senhor.`,
    ...
    `E aconteceu que, quando elle viu o pendente, e as pulseiras sobre as mãos de sua irmã, e quando ouviu as palavras de sua irmã Rebecca, que dizia: Assim me fallou aquelle varão; veiu o varão, e eis que estava em pé junto aos camelos á fonte.`,
    ...
    `E o Senhor abençoou muito o meu senhor, de maneira que foi engrandecido, e deu-lhe ovelhas e vaccas, e prata e oiro, e servos e servas, e camelos e jumentos.`,
    ...
    `E elle me disse: O Senhor, em cuja presença tenho andado, enviará o seu anjo comtigo, e prosperará o teu caminho, para que tomes mulher para meu filho da minha familia e da casa de meu pae:`,
    ...
    `E antes que eu acabasse de fallar no meu coração, eis que Rebecca sahia com o seu cantaro sobre o seu hombro, e desceu á fonte, e tirou agua; e eu lhe disse: Ora dá-me de beber.`,
    ...
    `Então lhe perguntei, e disse: De quem és filha? E ella disse: Filha de Bethuel, filho de Nahor, que lhe pariu Milcah. Então eu puz o pendente no seu rosto, e as pulseiras sobre as suas mãos;`,
    ...
    `E Rebecca se levantou com as suas moças, e subiram sobre os camelos, e seguiram o varão: e tomou aquelle servo a Rebecca, e partiu.`,
    ...
    `E Isaac trouxe-a para a tenda de sua mãe Sarah, e tomou a Rebecca, e foi-lhe por mulher, e amou-a. Assim Isaac foi consolado depois da morte de sua mãe.`,
  ],
  25: [
  ...
  26: [
    `E havia fome na terra, além da primeira fome, que foi nos dias de Abrahão: por isso foi-se Isaac a Abimelech, rei dos philisteus, em Gerar.`,
    ...
    `E tornou Isaac, e cavou os poços d'agua que cavaram nos dias de Abrahão seu pae, e que os philisteus taparam depois da morte de Abrahão, e chamou-*os pelos nomes que os chamara seu pae.`,
    ...
    `E Abimelech veiu a elle de Gerar, com Ahuzzath seu amigo, e Phichol, principe do seu exercito.`,
    ...
    `Que nos não faças mal, como nós te não temos tocado, e como te fizemos sómente bem, e te deixámos ir em paz. Agora tu és o bemdito do Senhor`,
  ...
  31: [
    ...
    `E disse elle: Levanta agora os teus olhos, e vê todos os bodes que cobrem o rebanho, que são listrados, salpicados e malhados: porque tenho visto tudo o que Labão te fez.`,
    `Eu sou o Deus de Beth-el, onde teus ungido uma columna, onde me tens votado o voto; levanta-te agora, sae-te d'esta terra, e torna-te á terra da tua parentela.`,
    ...
    `E levou todo o seu gado, e toda a sua fazenda, que havia adquirido, o gado que possuia, que alcançara em Paddan*-aram, para ir a Isaac, seu pae, á terra de Canaan.`,
    ...
    `Alcançou pois Labão a Jacob, e armara Jacob a sua tenda n'aquella montanha: armou tambem Labão com os seus irmãos a sua na montanha de Gilead.`,
    `Então disse Labão a Jacob: Que fizeste, que te esquivaste de mim, e levaste as minhas filhas como captivas pela espada?`,
    `Porque fugiste occultamente, e te esquivaste de mim, e não me fizeste saber, para que eu te enviasse com alegria, e com canticos, e com tamboril e com harpa?`,
    ...
    `Então respondeu Jacob, e disse a Labão: Porque temia; pois que dizia commigo, se porventura me não arrebatarias as tuas filhas.`,
    ...
    `E ella disse a seu pae: Não se accenda a ira aos olhos de meu senhor, que não posso levantar-me diante da tua face; porquanto tenho o costume das mulheres. E elle procurou, mas não achou os idolos.`,
    ...
    `Tenho estado agora vinte annos na tua casa; quatorze annos te servi por tuas duas filhas, e seis annos por teu rebanho; mas o meu salario tens mudado dez vezes.`,
  ...
  32: [
    ...
    `E ordenou-lhes, dizendo: Assim direis a meu senhor Esaú: Assim diz Jacob, teu servo: Como peregrino morei com Labão, e me detive lá até agora;`,
    ...
    `Menor sou eu que todas as beneficencias, e que toda a fidelidade que fizeste ao teu servo; porque com meu cajado passei este Jordão, e agora me tornei em dois bandos;`,
    ...
    `E ordenou ao primeiro, dizendo: Quando Esaú, meu irmão, te encontrar, e te perguntar, dizendo: De quem és, e para onde vaes, e cujos são estes diante da tua face,`,
    ...
    `E direis tambem: Eis que o teu servo Jacob vem atraz de nós. Porque dizia: Eu o aplacarei com o presente, que vae diante de mim, e depois verei a sua face; porventura acceitará a minha face.`,
    ...
    `Por isso os filhos de Israel não comem o nervo encolhido, que está sobre a juntura da côxa, até o dia de hoje; porquanto tocara a juntura da côxa de Jacob no nervo encolhido.`,
  ],
  33: [
    ...
    `Então disse Jacob: Não, se agora tenho achado graça em teus olhos, peço-*te que tomes o meu presente da minha mão: porquanto tenho visto o teu rosto, como se tivesse visto o rosto de Deus, e tomaste contentamento em mim.`,
    ...
    `E chegou Jacob salvo á cidade de Sichem, que está na terra de Canaan, quando vinha de Paddan-aram; e fez o seu assento diante da cidade.`,
  ...
  37: [
    ...
    `Estas são as gerações de Jacob. Sendo José de dezesete annos, apascentava as ovelhas com seus irmãos, e estava este mancebo com os filhos de Bilhah, e com os filhos de Zilpah, mulheres de seu pae; e José trazia uma má fama d'elles a seu pae.`,
    ...
    `Eis que estavamos atando mólhos no meio do campo, e eis que o meu mólho se levantava, e tambem ficava em pé, e eis que os vossos mólhos o rodeavam, e se inclinavam ao meu mólho.`,
    `Então lhe disseram seus irmãos: Tu pois devéras reinarás sobre nós? Por isso tanto mais o aborreciam por seus sonhos e por suas palavras.`,
    `E sonhou ainda outro sonho, e o contou a seus irmãos, e disse: Eis que ainda sonhei um sonho; e eis que o sol, e a lua, e onze estrellas se inclinavam a mim.`,
    `E contando-o a seu pae e a seus irmãos, reprehendeu-o seu pae, e disse-lhe: Que sonho é este que sonhaste? porventura viremos, eu e tua mãe, e teus irmãos, para inclinar-nos a ti em terra?`,
    ...
    `E elle lhe disse: Ora vae-te, vê como estão teus irmãos, e como está o rebanho, e traze-me resposta. Assim o enviou do valle de Hebron, e veiu a Sichem.`,
    ...
    `Vinde pois agora, e matemel-o, e lancemol-o n'uma d'estas covas, e diremos: Uma besta fera o comeu; e veremos que será dos seus sonhos.`,
    `E ouvindo-o Ruben, livrou-o das suas mãos, e disse: Não lhe tiremos a vida.`,
    `Tambem lhes disse Ruben: Não derrameis sangue; lançae-o n'esta cova, que está no deserto, e não lanceis mãos n'elle; para livral-o das suas mãos, e para tornal-o a seu pae.`,
    ...
    `Depois assentaram-se a comer pão; e levantaram os seus olhos, e olharam, e eis que uma companhia de ishmaelitas vinha de Gilead; e seus camelos traziam especiarias, e balsamo, e myrrha, e iam leval-os ao Egypto.`,
    ...
    `Passando pois os mercadores midianitas, tiraram, e alçaram a José da cova, e venderam José por vinte moedas de prata aos ishmaelitas, os quaes levaram José ao Egypto.`,
    ...
    `E levantaram-se todos os seus filhos e todas as suas filhas, para o consolarem; recusou porém ser consolado, e disse: Porquanto com chôro hei de descer ao meu filho até á sepultura. Assim o chorou seu pae`,
  ...
  38: [
    ...
    `Passando-se pois muitos dias, morreu a filha de Shuah, mulher de Judah; e depois se consolou Judah, e subiu aos tosquiadores das suas ovelhas em Timnah, elle e Hirah seu amigo, o adullamita.`,
    `E deram aviso a Tamar, dizendo: Eis que o teu sogro sobe a Timnah, a tosquiar as suas ovelhas.`,
    `Então ella tirou de sobre si os vestidos da sua viuvez, e cobriu-se com o véu, e envolveu-se, e assentou-se á entrada das duas fontes que estão no caminho de Timnah, porque via que Selah já era grande, e ella lhe não fôra dada por mulher`,
    ...
    `Mas aconteceu que, tornando elle a recolher a sua mão, eis que saiu o seu irmão, e ella disse: Como tu tens rompido? sobre ti é a rotura. E chamaram o seu nome Perez;`,
    `E depois saiu o seu irmão, em cuja mão estava o fio de grã; e chamaram o seu nome Zerah.`,
  ],
  39: [
    `E José foi levado ao Egypto, e Potifar, eunucho de Pharaó, capitão da guarda, varão egypcio, comprou-o da mão dos ishmaelitas que o tinham levado lá.`,
    ...
    `Chamou aos homens de sua casa, e fallou-lhes, dizendo: Vêde, trouxe-nos o varão hebreu, para escarnecer de nós; entrou a mim para deitar-se commigo, e eu gritei com grande voz,`,
  ...
  41: [
    ...
    `E estava ali comnosco um mancebo hebreu, servo do capitão da guarda, e contámos-lh'os, e interpretou-nos os nossos sonhos, a cada um os interpretou conforme o seu sonho.`,
    `E como elle nos interpretou, assim mesmo foi feito: a mim me fez tornar ao meu estado, e a elle fez enforcar.`,
    `Então enviou Pharaó, e chamou a José, e o fizeram sair logo da cova; e barbeou-se e mudou os seus vestidos, e veiu a Pharaó.`,
    ...
    `E depois d'elles levantar-se-hão sete annos de fome, e toda aquella fartura será esquecida na terra do Egypto, e a fome consumirá a terra;`,
    ...
    `E tirou Pharaó o seu annel da sua mão, e o poz na mão de José, e o fez vestir de vestidos de linho fino, e poz um collar d'oiro no seu pescoço,`,
    ...
    `E José era da edade de trinta annos quando esteve diante da face de Pharaó, rei do Egypto. E saiu José da face de Pharaó, e passou por toda a terra do Egypto.`,
    ...
    `E começaram a vir os sete annos de fome, como José tinha dito; e havia fome em todas as terras, mas em toda a terra do Egypto havia pão.`,
    `E tendo toda a terra do Egypto fome, clamou o povo a Pharaó por pão; e Pharaó disse a todos os egypcios: Ide a José ; o que elle vos disser, fazei.`,
  ...
  42: [
    ...
    `E José, vendo os seus irmãos, conheceu-os; porém mostrou-se estranho para com elles, e fallou com elles asperamente, e disse-lhes: D'onde vindes? E elles disseram: Da terra de Canaan, para comprarmos mantimento.`,
    ...
    `E elles disseram: Nós, teus servos, somos doze irmãos, filhos de um varão na terra de Canaan; e eis que aqui o mais novo está com nosso pae hoje; mas um não está mais.`,
    ...
    `Enviae um d'entre vós, que traga vosso irmão, mas vós ficareis presos, e vossas palavras sejam provadas, se ha verdade comvosco; e se não, pela vida de Pharaó, vós sois espias.`,
    ...
    `E ordenou José, que enchessem os seus saccos de trigo, e que lhes restituissem o seu dinheiro a cada um no seu sacco, e lhes dessem comida para o caminho; e fizeram-lhes assim.`,
    ...
    `E trazei-me vosso irmão mais novo; assim saberei que não sois espias, mas homens de rectidão; então vos darei o vosso irmão e negociareis na terra.`,
    ...
    `Elle porém disse: Não descerá meu filho comvosco; porquanto o seu irmão é morto, e elle só ficou. Se lhe succedesse algum desastre no caminho que fordes, fareis descer minhas cãs com tristeza á sepultura.`,
  ],
  43: [
    ...
    `E elles disseram: Aquelle varão particularmente nos perguntou por nós, e pela nossa parentela, dizendo: Vive ainda vosso pae? tendes mais um irmão? e respondemos-lhe conforme as mesmas palavras. Podiamos nós saber que diria: Trazei vosso irmão?`,
    ...
    `Então disse-lhes Israel, seu pae: Pois que assim é, fazei isso; tomae do mais precioso d'esta terra em vossos vasos, e levae ao varão um presente: um pouco de balsamo, e um pouco de mel, especiarias, e myrrha, terebintho e amendoas;`,
    ...
    `E Deus Todo-poderoso vos dê misericordia diante do varão, para que deixe vir comvosco vosso outro irmão, e Benjamin; e eu, se fôr desfilhado, desfilhado ficarei.`,
    `E os varões tomaram aquelle presente, e tomaram dinheiro dobrado em suas mãos, e a Benjamin: e levantaram-se, e desceram ao Egypto, e apresentaram-se diante da face de José.`,
    `Vendo pois José a Benjamin com elles, disse ao que estava sobre a sua casa: Leva estes varões á casa, e mata rezes, e apresta; porque estes varões comerão commigo ao meio dia.`,
    `E o varão fez como José dissera, e o varão levou aquelles varões á casa de José`,
    `Então temeram aquelles varões, porquanto foram levados á casa de José, e diziam: Por causa do dinheiro que d'antes foi tornado nos nossos saccos, fomos levados aqui, para nos criminar e cair sobre nós, para que nos tome por servos, e a nossos jumentos.`,
    ...
    `E pozeram-lhe a elle á parte, e a elles á parte, e aos egypcios, que comiam com elle, á parte; porque os egypcios não podem comer pão com os hebreus, porquanto é abominação para os egypcios.`,
  ...
  45: [
    `Então José não se podia conter diante de todos os que estavam com elle; e clamou: Fazei sair de mim a todo o varão; e ninguem ficou com elle, quando José se deu a conhecer a seus irmãos.`,
    ...
    `Assim não fostes vós que me enviastes para cá, senão Deus, que me tem posto por pae de Pharaó, e por senhor de toda a sua casa, e como regente em toda a terra do Egypto.`,
    ...
    `E tornae a vosso pae, e a vossas familias, e vinde a mim; e eu vos farei o melhor da terra do Egypto, e comereis a gordura da terra.`,
    ...
    `E a seu pae enviou similhantemente dez jumentos carregados do melhor do Egypto, e dez jumentos carregados de trigo, e pão, e comida para seu pae, para o caminho.`,
    ...
    `Porém, havendo-lhe elles contado todas as palavras de José, que elle lhes fallára, e vendo elle os carros que José enviara para leval-o, reviveu o espirito de Jacob seu pae`,
  ...
  46: [
    ...
    `Então levantou-se Jacob de Berseba, e os filhos de Israel levaram a seu pae Jacob, e seus meninos, e as suas mulheres, nos carros que Pharaó enviara para o levar.`,
    ...
    `Depois disse José a seus irmãos, e á casa de seu pae: Eu subirei, e annunciarei a Pharaó, e lhe direi: Meus irmãos, e a casa de meu pae, que estavam na terra de Canaan, vieram a mim!`,
  ...
  50: [
    ...
    `Meu pae me fez jurar, dizendo: Eis que eu morro: em meu sepulchro, que cavei para mim na terra de Canaan, ali me sepultarás. Agora pois, te peço, que eu suba, para que sepulte a meu pae; então voltarei.`,
    `E Pharaó disse: Sobe, e sepulta a teu pae como elle te fez jurar.`,
    `E José subiu para sepultar a seu pae: e subiram com elle todos os servos de Pharaó, os anciãos da sua casa, e todos os anciãos da terra do Egypto,`,
    ...
    `Chegando elles pois á planicie do espinhal, que está além do Jordão, fizeram um grande e gravissimo pranto; e fez a seu pae um grande pranto por sete dias.`,
    `E vendo os moradores da terra, os cananeos, o luto na planicie do espinhal, disseram: É este o pranto grande dos egypcios. Por isso chamou-se o seu nome Abelmizraim, que está além do Jordão.`,
    `E fizeram-lhe os seus filhos assim como elle lhes ordenara,`,
    `Pois os seus filhos o levaram á terra de Canaan, e o sepultaram na cova do campo de Machpela, que Abrahão tinha comprado com o campo, por herança de sepultura, d'Ephron, o hetheo, em frente de Mamre.`,
    ...
    `Vendo então os irmãos de José que seu pae já estava morto, disseram: Porventura nos aborrecerá José, e nos pagará certamente todo o mal que lhe fizemos.`,
    ...
    `E disse José a seus irmãos: Eu morro; mas Deus certamente vos visitará, e vos fará subir d'esta terra á terra que jurou a Abrahão, a Isaac e a Jacob`,
