const data: Record<number, string[]> = {
  ...
  18: [
    ...
    `E a tomaram ao fim de três anos; sim, no ano sexto de Ezequias, que era o ano nono de Oseias, rei de Israel, Samaria foi tomada.`,
    `E o rei da Assíria transportou a Israel para a Assíria; e os fez levar para Hala e para Habor, junto ao rio Gozã, e às cidades dos medos;`,
    ...
    `Então, Ezequias, rei de Judá, enviou ao rei da Assíria, a Laquis, dizendo: Pequei; retira-te de mim; tudo o que me impuseres levarei. Então, o rei da Assíria impôs a Ezequias, rei de Judá, trezentos talentos de prata e trinta talentos de ouro.`,
