const data: Record<number, string[]> = {
  1: [
    `Havia um homem na terra d'Uz, cujo nome era Job: e era este homem sincero, recto e temente a Deus e desviando-se do mal.`,
    `E nasceram-lhe sete filhos e tres filhas.`,
    `E era o seu gado sete mil ovelhas, e tres mil camelos, e quinhentas juntas de bois, e quinhentas jumentas; era tambem muitissima a gente ao seu serviço, de maneira que era este homem maior do que todos os do oriente.`,
    ...
    `E disse o Senhor a Satanaz: Consideraste tu a meu servo Job? porque ninguem ha na terra similhante a elle, homem sincero e recto, temente a Deus, e desviando-se do mal.`,
    ...
    `E disse o Senhor a Satanaz: Eis-que tudo quanto tem está na tua mão; sómente contra elle não estendas a tua mão. E Satanaz saiu da presença do Senhor.`,
    ...
    `Estando este ainda fallando, veiu outro e disse: Fogo de Deus caiu do céu, e queimou as ovelhas e os moços, e os consumiu, e só eu escapei tão sómente para te trazer a nova`,
    `Estando ainda este fallando, veiu outro, e disse: Ordenando os chaldeos tres tropas, deram sobre os camelos, e os tomaram, e aos moços feriram ao fio da espada: e só eu escapei tão sómente para te trazer a nova.`,
    ...
    `E disse: Nu sahi do ventre de minha mãe, e nu tornarei para lá; o Senhor o deu, e o Senhor o tomou: bemdito seja o nome do Senhor.`,
  ...
  2: [
    ...
    `Então o Senhor disse a Satanaz: D'onde vens? E respondeu Satanaz ao Senhor, e disse: De rodeiar a terra, e passeiar por ella.`,
    `E disse o Senhor a Satanaz: Consideraste ao meu servo Job? porque ninguem ha na terra similhante a elle, homem sincero e recto, temente a Deus, e desviando-se do mal, e que ainda retem a sua sinceridade; havendo-me tu incitado contra elle, para o consumir sem causa.`,
    ...
    `Porém elle lhe disse: Como falla qualquer das doidas, fallas tu; receberemos o bem de Deus, e não receberiamos o mal? Em tudo isto não peccou Job com os seus labios.`,
    `Ouvindo pois tres amigos de Job todo este mal que tinha vindo sobre elle, vieram cada um do seu logar; Eliphaz o temanita, e Bildad o suhita, e Sofar o naamathita; e concertaram juntamente de virem condoer-se d'elle, e para o consolarem.`,
  ...
  42: [
    ...
    `Tomae pois sete bezerros e sete carneiros, e ide ao meu servo Job, e offerecei holocaustos por vós, e o meu servo Job orará por vós: porque devéras a elle acceitarei, para que vos não trate conforme a vossa loucura; porque vós não fallastes de mim o que era recto como o meu servo Job.`,
    ...
    `Então vieram a elle todos os seus irmãos, e todas as suas irmãs, e todos quantos d'antes o conheceram, e comeram com elle pão em sua casa, e se condoeram d'elle, e o consolaram ácerca de todo o mal que o Senhor lhe havia enviado: e cada um d'elles lhe deu uma peça de dinheiro, e cada um um pendente de oiro.`,
    `E assim abençoou o Senhor ao ultimo estado de Job, mais do que o primeiro: porque teve quatorze mil ovelhas, e seis mil camelos, e mil juntas de bois, e mil jumentas.`,
