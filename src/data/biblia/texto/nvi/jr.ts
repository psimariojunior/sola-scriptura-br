const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Ouça a palavra do SENHOR, ó comunidade de Jacó, todos os clãs da comunidade de Israel.`,
    ...
    `Agora, por que você vai ao Egito beber água do Nilo? E por que vai à Assíria beber água do Eufrates?`,
    ...
    `“Como você pode dizer que não se contaminou e que não correu atrás dos baalins? Reveja o seu procedimento no vale e considere o que você tem feito. Você é como uma camela jovem e arisca que corre para todos os lados;`,
    ...
    `Pois dizem à madeira: ‘Você é meu pai’ e à pedra: ‘Você me deu à luz’. Voltaram para mim as costas e não o rosto, mas na hora da adversidade dizem: ‘Venha salvar-nos!’`,
    ...
    `Será que uma jovem se esquece das suas joias, ou uma noiva, de seus enfeites nupciais? Contudo, o meu povo esqueceu-se de mim por dias sem fim.`,
  ...
  3: [
    `“Se um homem se divorciar de sua mulher e depois da separação ela casar-se com outro homem, poderá o primeiro marido voltar para ela? Não seria a terra totalmente contaminada? Mas você tem se prostituído com muitos amantes e, agora, quer voltar para mim?”, pergunta o SENHOR.`,
    ...
    `Por isso as chuvas foram retidas, e não veio chuva na primavera. Mas você, apresentando-se declaradamente como prostituta, se recusa a corar de vergonha.`,
    ...
    `“Eu mesmo disse: “Com que alegria eu a trataria como se tratam filhos e daria uma terra aprazível a você, a mais bela herança entre as nações! Pensei que você me chamaria de ‘Pai’ e que não deixaria de seguir-me.`,
  ...
  4: [
    ...
    `“Relatem isto a esta nação e proclamem contra Jerusalém: Um exército inimigo está vindo de uma terra distante, dando seu grito de guerra contra as cidades de Judá.`,
    ...
    `Olhei, e a terra fértil era um deserto; todas as suas cidades estavam em ruínas por causa do SENHOR, por causa do fogo da sua ira.`,
    ...
    `O que você está fazendo, ó cidade devastada? Por que se veste de vermelho e se enfeita com joias de ouro? Por que você pinta os olhos? Você se embeleza em vão, pois os seus amantes a desprezam e querem tirar sua vida.`,
  ...
  5: [
    ...
    `“Por que deveria eu o perdoar?” “Seus filhos me abandonaram e juraram por aqueles que não são deuses. Embora eu tenha suprido as suas necessidades, eles cometeram adultério e frequentaram as casas de prostituição.`,
    ...
    `Devorarão as suas colheitas e os seus alimentos; devorarão os seus filhos e as suas filhas; devorarão as suas ovelhas e os seus bois; devorarão as suas videiras e as suas figueiras. Destruirão ao fio da espada as cidades fortificadas nas quais vocês confiam.`,
  ...
  7: [
    ...
    `Dei-lhes, entretanto, esta ordem: Obedeçam-me, e eu serei o seu Deus e vocês serão o meu povo. Vocês andarão em todo o caminho que eu ordenar, para que tudo vá bem a vocês.`,
    ...
    `Desde a época em que os seus antepassados saíram do Egito até o dia de hoje, eu enviei os meus servos a vocês, os profetas, dia após dia.`,
  ...
  10: [
    ...
    `Prata batida é trazida de Társis, e ouro, de Ufaz. A obra do artesão e do ourives é vestida de azul e de púrpura; tudo não passa de obra de hábeis artesãos.`,
    ...
    `Aquele que é a porção de Jacó nem se compara a essas imagens, pois ele é quem forma todas as coisas, e Israel é a tribo de sua propriedade, SENHOR dos Exércitos é o seu nome.`,
  ...
  11: [
    ...
    `os quais ordenei aos antepassados de vocês, quando eu os tirei do Egito, da fornalha de fundir ferro. Eu disse: Obedeçam-me e façam tudo o que ordeno, e vocês serão o meu povo, e eu serei o seu Deus.`,
  ...
  12: [
    ...
    `Até mesmo os seus irmãos e a sua própria família traíram você e o perseguem aos gritos. Não confie neles, mesmo quando dizem coisas boas.`,
  ...
  13: [
    ...
    `“Diga-lhes também: Assim diz o SENHOR, o Deus de Israel: Deve-se encher de vinho toda vasilha de couro. E, se eles disserem a você: ‘Será que não sabemos que se deve encher de vinho toda vasilha de couro?’`,
    ...
    `Deem glória ao SENHOR, ao seu Deus, antes que ele traga trevas, antes que os pés de vocês tropecem nas colinas ao escurecer. Vocês esperam a luz, mas ele fará dela uma escuridão profunda; sim, ele a transformará em densas trevas.`,
    ...
    `Erga os olhos, Jerusalém, e veja aqueles que vêm do norte. Onde está o rebanho que foi confiado a você, as ovelhas das quais se orgulhava?`,
  ...
  16: [
    ...
    `Os meus olhos veem todos os seus caminhos; eles não estão escondidos de mim, nem a sua iniquidade está oculta aos meus olhos.`,
  ...
  17: [
    ...
    `e sobre as montanhas do campo. As riquezas de vocês e todos os seus tesouros, eu os darei como despojo, como preço por todos os seus pecados nos altares idólatras, em toda a sua terra.`,
    `Você mesmo perdeu a posse da herança que eu tinha dado a você. Eu o farei escravo de seus inimigos numa terra que você não conhece, pois acendeu-se a minha ira, que arderá para sempre.”`,
  ...
  21: [
    `Esta é a palavra que veio a Jeremias da parte do SENHOR, quando o rei Zedequias enviou-lhe Pasur, filho de Malquias, e o sacerdote Sofonias, filho de Maaseias. Eles disseram:`,
  ...
  22: [
    ...
    `Você, que está entronizada no Líbano , que está aninhada em prédios de cedro, como você gemerá quando vierem as dores de parto, dores como as de uma mulher que está para dar à luz!`,
  ...
  23: [
    ...
    `“Quando este povo ou um profeta ou um sacerdote perguntar a você: ‘Qual é a mensagem pesada da qual o SENHOR o encarregou?’, diga-lhes: Vocês são o peso! E eu os abandonarei”, declara o SENHOR.`,
  ...
  26: [
    ...
    `Entretanto, estejam certos de que, se me matarem, vocês, esta cidade e os seus habitantes serão responsáveis por derramar sangue inocente, pois, na verdade, o SENHOR enviou-me a vocês para anunciar essas palavras”.`,
    ...
    `Alguns dos líderes da terra se levantaram e disseram a toda a assembleia do povo:`,
    `“Miqueias de Moresete profetizou nos dias de Ezequias, rei de Judá, dizendo a todo o povo de Judá: ‘Assim diz o SENHOR dos Exércitos: “ ‘Sião será arada como um campo. Jerusalém se tornará um monte de entulho, a colina do templo, um monte coberto de mato’.`,
  ...
  29: [
    ...
    `Porque assim diz o SENHOR dos Exércitos, o Deus de Israel: ‘Não deixem que os profetas e adivinhos que há no meio de vocês os enganem. Não deem atenção aos sonhos que vocês os encorajam a terem.`,
    ...
    `Assim diz o SENHOR dos Exércitos, o Deus de Israel, a respeito de Acabe, filho de Colaías, e a respeito de Zedequias, filho de Maaseias, que estão profetizando mentiras a vocês em meu nome: ‘Eu os entregarei nas mãos de Nabucodonosor, rei da Babilônia, e ele os matará diante de vocês.`,
    ...
    `Diz o SENHOR dos Exércitos, o Deus de Israel, que você enviou cartas em seu próprio nome a todo o povo de Jerusalém, a Sofonias, filho do sacerdote Maaseias, e a todos os sacerdotes. Você disse a Sofonias:`,
  ...
  30: [
    ...
    `Por que você grita por causa do seu ferimento, por sua ferida incurável? Fiz essas coisas a você porque é grande a sua iniquidade e numerosos são os seus pecados.`,
    ...
    `Seu líder será um entre eles; seu governante virá do meio deles. Eu o trarei para perto e ele se aproximará de mim; pois quem se arriscaria a aproximar-se de mim?”, pergunta o SENHOR.`,
  ...
  32: [
    ...
    `Construíram altares idólatras para Baal no vale de Ben-Hinom, para sacrificarem a Moloque os seus filhos e as suas filhas, coisa que nunca ordenei, prática repugnante que jamais imaginei; e, assim, levaram Judá a pecar’.`,
  ...
  34: [
    ...
    `enquanto o exército do rei da Babilônia lutava contra Jerusalém e contra as outras cidades de Judá que ainda resistiam, Laquis e Azeca, pois só restaram essas cidades fortificadas em Judá.`,
  ...
  35: [
    ...
    `Eu os levei ao templo do SENHOR, à sala dos filhos de Hanã, filho de Jigdalias, homem de Deus. A sala ficava ao lado da sala dos líderes e debaixo da sala de Maaseias, filho de Salum, o porteiro.`,
    ...
    `Enviei a vocês, repetidas vezes, todos os meus servos, os profetas, para dizer que cada um de vocês deveria converter-se da sua má conduta, corrigir as suas ações e deixar de seguir outros deuses para prestar-lhes culto. Assim, vocês habitariam na terra que dei a vocês e a seus antepassados. Mas vocês não me deram atenção nem me obedeceram.`,
  ...
  36: [
    ...
    `“Pegue um rolo e escreva nele todas as palavras que falei a você a respeito de Israel, de Judá e de todas as outras nações, desde que comecei a falar a você, durante o reinado de Josias, até hoje.`,
    `Talvez, quando o povo de Judá souber de cada uma das desgraças que planejo trazer sobre eles, cada um se converta de sua má conduta e eu perdoe a iniquidade e o pecado deles”.`,
  ...
  37: [
    ...
    `O rei Zedequias, porém, mandou Jucal, filho de Selemias, e o sacerdote Sofonias, filho de Maaseias, ao profeta Jeremias com esta mensagem: “Ore ao SENHOR, ao nosso Deus, em nosso favor”.`,
    ...
    `Assim diz o SENHOR: “Não se enganem, dizendo: ‘Os babilônios certamente vão embora’. Porque eles não vão.`,
    ...
    `Onde estão os seus profetas que profetizaram para você: ‘O rei da Babilônia não atacará nem a vocês nem a esta terra’?`,
  ...
  38: [
    ...
    `O rei Zedequias, porém, fez este juramento secreto a Jeremias: “Juro pelo nome do SENHOR, de quem recebemos a vida, que eu não o matarei nem o entregarei nas mãos daqueles que desejam tirar sua vida”.`,
    ...
    `Todas as mulheres deixadas no palácio real de Judá serão levadas aos oficiais do rei da Babilônia. E elas dirão a você: “ ‘Aqueles teus amigos de confiança te enganaram e prevaleceram sobre ti. Teus pés estão atolados na lama; teus amigos te abandonaram’.`,
  ...
  42: [
    ...
    `Eu disse a vocês, hoje mesmo, o que o SENHOR, o seu Deus, me mandou dizer a vocês, mas vocês não lhe estão obedecendo.`,
  ...
  48: [
    ...
    `“Moabe tem estado tranquila desde a sua juventude, como o vinho deixado com os seus resíduos; não foi mudada de vasilha em vasilha. Nunca foi para o exílio; por isso, o seu sabor permanece o mesmo e o seu cheiro não mudou.`,
  ...
  50: [
    ...
    `“Anunciem e proclamem entre as nações, ergam um sinal e proclamem; não escondam nada. Digam: ‘A Babilônia foi conquistada; Bel foi humilhado, Marduque está apavorado. As imagens da Babilônia estão humilhadas e seus ídolos apavorados’.`,
    ...
    `sua mãe se envergonhará profundamente; aquela que a deu à luz ficará constrangida. Ela se tornará a menor das nações, um deserto, uma terra seca e árida.`,
    ...
    `Naqueles dias, naquela época”, declara o SENHOR, “procurarão pela iniquidade de Israel, mas nada será achado, pelos pecados de Judá, mas nenhum será encontrado, pois perdoarei o remanescente que eu poupar.`,
    `“Ataquem a terra de Merataim e aqueles que moram em Pecode. Persigam-nos, matem-nos e destruam-nos totalmente”, declara o SENHOR. “Façam tudo o que ordenei a vocês.`,
    ...
    `Por isso, os seus jovens cairão nas ruas e todos os seus guerreiros se calarão naquele dia”, declara o SENHOR.`,
    ...
    `Uma espada contra os seus cavalos, contra os seus carros de guerra e contra todos os estrangeiros em suas fileiras! Eles serão como mulheres. Uma espada contra os seus tesouros! Eles serão saqueados.`,
    ...
    `Eles empunham o arco e a lança; são cruéis e não têm misericórdia, e o seu barulho é como o bramido do mar. Vêm montados em seus cavalos, em formação de batalha, para atacá-la, ó cidade de Babilônia.`,
    ...
    `Como um leão que sobe da mata do Jordão em direção aos pastos verdejantes, subitamente eu caçarei a Babilônia pondo-a fora de sua terra. Quem é o escolhido que designarei para isso? Quem é como eu que possa me desafiar? E que pastor pode me resistir?”`,
  ...
  52: [
    ...
    `Então o muro da cidade foi rompido. O rei e todos os soldados fugiram e saíram da cidade, à noite, na direção do jardim real, pela porta entre os dois muros, embora os babilônios estivessem cercando a cidade. Foram à Arabá ,`,
    ...
    `Cada uma das colunas tinha oito metros e dez centímetros de altura e cinco metros e quarenta centímetros de circunferência ; cada uma tinha quatro dedos de espessura e era oca.`,
