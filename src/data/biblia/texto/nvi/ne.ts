const data: Record<number, string[]> = {
  1: [
    `Palavras de Neemias, filho de Hacalias: No mês de quisleu , no vigésimo ano , enquanto eu estava na cidade de Susã,`,
  ...
  3: [
    ...
    `Ao seu lado, Jedaías, filho de Harumafe, fez os reparos em frente da sua casa, e Hatus, filho de Hasabneias, fez os reparos ao seu lado.`,
    ...
    `Depois, Benjamim e Hassube fizeram os reparos em frente da sua casa, e ao lado deles Azarias, filho de Maaseias, filho de Ananias, fez os reparos ao lado de sua casa.`,
  ...
  4: [
    ...
    `que estava construindo o muro. Aqueles que transportavam material faziam o trabalho com uma das mãos e com a outra seguravam uma arma,`,
  ...
  6: [
    ...
    `em que estava escrito: “Dizem entre as nações, e Gesém diz que é verdade, que você e os judeus estão tramando uma revolta e que, por isso, estão reconstruindo o muro. Além disso, conforme dizem, você está na iminência de se tornar o rei deles,`,
  ...
  7: [
    ...
    `“E entre os sacerdotes: “os descendentes de Habaías, Hacoz e Barzilai, homem que se casou com uma filha de Barzilai, de Gileade, e que era chamado por aquele nome”.`,
  ...
  8: [
    ...
    `Assim, no primeiro dia do sétimo mês, o sacerdote Esdras trouxe a Lei diante da assembleia, que era constituída de homens e mulheres e de todos os que podiam entender.`,
    ...
    `O escriba Esdras estava numa plataforma elevada, de madeira, construída para a ocasião. Ao seu lado, à direita, estavam Matitias, Sema, Anaías, Urias, Hilquias e Maaseias; e à esquerda estavam Pedaías, Misael, Malquias, Hasum, Hasbadana, Zacarias e Mesulão.`,
    ...
    `Os levitas Jesua, Bani, Serebias, Jamim, Acube, Sabetai, Hodias, Maaseias, Quelita, Azarias, Jozabade, Hanã e Pelaías, instruíram o povo na Lei, e todos permaneciam ali.`,
  ...
  9: [
    ...
    `E os levitas Jesua, Cadmiel, Bani, Hasabneias, Serebias, Hodias, Sebanias e Petaías conclamavam o povo, dizendo: “Levantem-se e louvem o SENHOR, o seu Deus, que vive para todo o sempre. “Bendito seja o teu nome glorioso! A tua grandeza está acima de toda expressão de louvor.`,
    ...
    `“Mas foram desobedientes e se rebelaram contra ti; deram as costas para a tua Lei. Mataram os teus profetas, que os tinham advertido que se voltassem para ti; e fizeram-te ofensas detestáveis.`,
    ...
    `“Mas, tão logo voltavam a ter paz, de novo faziam o que tu reprovas. Então tu os abandonavas às mãos de seus inimigos, para que dominassem sobre eles. E, quando novamente clamavam a ti, dos céus tu os ouvias e na tua compaixão os livravas vez após vez.`,
    `“Tu os advertiste que voltassem à tua Lei, mas eles se tornaram arrogantes e desobedeceram aos teus mandamentos. Pecaram contra as tuas ordenanças, pelas quais o homem vive se lhes obedece. Com teimosia, deram-te as costas, tornaram-se obstinados e recusaram ouvir-te.`,
  ...
  12: [
    ...
    `além de Maaseias, Semaías, Eleazar, Uzi, Joanã, Malquias, Elão e Ézer. Os coros cantaram sob a direção de Jezraías.`,
