const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `os quais vieram com Zorobabel, Jesua, Neemias, Seraías, Reelaías, Mordecai, Bilsã, Mispar, Bigvai, Reum e Baaná. Eis o número dos homens do povo de Israel:`,
  ...
  7: [
    ...
    `filho de Abisua, filho de Fineias, filho de Eleazar, filho de Arão, o sumo sacerdote, este Esdras subiu da Babilônia.`,
    ...
    `Também vos fazemos saber, acerca de todos os sacerdotes e levitas, cantores, porteiros, de todos os que servem nesta Casa de Deus, que não será lícito impor-lhes nem direitos, nem impostos, nem pedágios.`,
  ...
  8: [
    ...
    `Então, receberam os sacerdotes e os levitas o peso da prata, do ouro e dos objetos, para trazerem a Jerusalém, à casa de nosso Deus.`,
    ...
    `No quarto dia, pesamos, na casa do nosso Deus, a prata, o ouro, os objetos e os entregamos a Meremote, filho do sacerdote Urias; com ele estava Eleazar, filho de Fineias, e, com eles, Jozabade, filho de Jesua, e Noadias, filho de Binui, levitas;`,
    `tudo foi contado e pesado, e o peso total, imediatamente registrado.`,
