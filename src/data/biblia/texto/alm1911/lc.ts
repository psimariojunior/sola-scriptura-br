const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `E Jesus lhe respondeu, dizendo: Escripto está que nem só de pão viverá o homem, mas de toda a palavra de Deus.`,
    ...
    `O Espirito do Senhor está sobre mim, porquanto me ungiu para evangelizar aos pobres, enviou-me a curar os quebrantados do coração,`,
    ...
    `E elle lhes disse: Sem duvida me direis este proverbio: Medico, cura-te a ti mesmo: faze tambem aqui na tua patria todas essas coisas que ouvimos terem sido feitas em Capernaum.`,
    `E disse: Em verdade vos digo que nenhum propheta é bem recebido na sua patria;`,
    `Em verdade vos digo que muitas viuvas existiam em Israel nos dias de Elias, quando o céu se cerrou por tres annos e seis mezes, de sorte que em toda a terra houve grande fome;`,
    ...
    `E, levantando-se, o expulsaram da cidade, e o levaram até ao cume do monte em que a cidade d'elles estava edificada, para d'ali o precipitarem.`,
    ...
    `E Jesus o reprehendeu, dizendo: Cala-te, e sae d'elle. E o demonio, lançando-o por terra no meio do povo, saiu d'elle sem lhe fazer mal algum.`,
    ...
    `E, ao pôr do sol, todos os que tinham enfermos de varias doenças lh'os traziam; e, pondo as mãos sobre cada um d'elles, os curava.`,
    ...
    `E, sendo já dia, saiu, e foi para um logar deserto; e a multidão o buscava, e chegou junto d'elle; e o detinham, para que não se ausentasse d'elles.`,
  ...
  5: [
    ...
    `E, respondendo Simão, disse-lhe: Mestre, havendo trabalhado toda a noite, nada apanhámos; mas, sobre tua palavra, lançarei a rede.`,
    ...
    `E aconteceu que, estando n'uma das cidades, eis que um homem cheio de lepra, vendo a Jesus, prostrou-se sobre o rosto, e rogou-lhe, dizendo: Senhor, se quizeres, bem podes limpar-me.`,
    `E elle, estendendo a mão, tocou-o, dizendo: Quero; sê limpo. E logo a lepra desappareceu d'elle.`,
    `E ordenou-lhe que a ninguem o dissesse. Porém vae, disse, mostra-te ao sacerdote, e offerece, pela tua purificação, o que Moysés determinou, para que lhes sirva de testemunho.`,
    ...
    `E aconteceu que, n'um d'aquelles dias, estava ensinando, e estavam ali assentados phariseos e doutores da lei, que tinham vindo de todas as aldeias da Galilea, e da Judea, e de Jerusalem, e a virtude do Senhor estava com elle para os curar.`,
    ...
    `E, não achando por onde podessem introduzil-o, por causa da multidão, subiram ao telhado, e pelas telhas o baixaram com a cama, até ao meio, diante de Jesus.`,
    `E, vendo elle a fé d'elles, disse-lhe: Homem, os teus peccados te são perdoados.`,
    `E os escribas e os phariseos começaram a arrazoar, dizendo: Quem é este que diz blasphemias? Quem pode perdoar peccados, senão só Deus?`,
    ...
    `Ora, para que saibaes que o Filho do homem tem sobre a terra poder de perdoar os peccados (disse ao paralytico), A ti te digo: Levanta-te, toma a tua cama, e vae para tua casa.`,
    ...
    `Disseram-lhe então elles: Porque jejuam os discipulos de João muitas vezes, e fazem orações, como tambem os dos phariseos, porém os teus comem e bebem?`,
    ...
    `E disse-lhes tambem uma parabola: Ninguem deita remendo de panno novo em vestido velho; d'outra maneira o novo romperá o velho, e o remendo novo não condiz com o velho.`,
    `E ninguem deita vinho novo em odres velhos; d'outra maneira o vinho novo romperá os odres, e entornar-se-ha o vinho, e os odres se estragarão;`,
  ...
  6: [
    ...
    `Como entrou na casa de Deus, e tomou os pães da proposição, e os comeu, e deu tambem aos que estavam com elle, os quaes não é licito comer senão só aos sacerdotes?`,
    `E dizia-lhes: O Filho do homem é Senhor até do sabbado.`,
    `E aconteceu tambem n'outro sabbado que entrou na synagoga, e estava ensinando; e estava ali um homem que tinha a mão direita mirrada.`,
    ...
    `E, descendo com elles, parou n'um logar plano, e tambem uma grande turba de seus discipulos, e grande multidão de povo de toda a Judea, e de Jerusalem, e da costa maritima de Tyro e de Sidon,`,
    ...
    `Bemaventurados sereis quando os homens vos aborrecerem, e quando vos separarem, e injuriarem, e rejeitarem o vosso nome como mau, por causa do Filho do homem.`,
    ...
    `Amae pois a vossos inimigos, e fazei bem, e emprestae, sem nada esperardes, e será grande o vosso galardão, e sereis filhos do Altissimo; porque é benigno até para com os ingratos e máus.`,
    ...
    `É similhante ao homem que edificou uma casa, e cavou, e abriu bem fundo, e poz os alicerces sobre rocha, e, vindo a enchente, bateu com impeto a corrente n'aquella casa, e não a poude abalar, porque estava fundada sobre rocha.`,
    `Mas o que ouve e não obra é similhante ao homem que edificou uma casa sobre terra, sem alicerces, na qual bateu com impeto a corrente, e logo caiu; e foi grande a queda d'aquella casa.`,
  ],
  7: [
  ...
  9: [
    ...
    `E disse-lhes: Nada leveis comvosco para o caminho, nem bordões, nem alforge, nem pão, nem dinheiro; nem tenhaes dois vestidos.`,
    `E, em qualquer casa em que entrardes, ficae ali, e de lá sahi.`,
    `E, se quaesquer vos não receberem, saindo vós d'aquella cidade, sacudi até o pó dos vossos pés, em testemunho contra elles.`,
    ...
    `E disse Herodes: A João mandei eu degolar: quem é pois este de quem ouço dizer taes coisas? E procurava vêl-o.`,
    ...
    `E já o dia começava a declinar, e, chegando-se a elle os doze, disseram-lhe: Despede a multidão, para que, indo aos logares e aldeias em redor, se agasalhem, e achem que comer; porque aqui estamos em logar deserto.`,
    ...
    `Dizendo: É necessario que o Filho do homem padeça muitas coisas, e seja rejeitado dos anciãos e dos escribas, e seja morto, e resuscite ao terceiro dia.`,
    ...
    `Porque, qualquer que de mim e das minhas palavras se envergonhar, d'elle se envergonhará o Filho do homem, quando vier na sua gloria, e na do Pae e dos sanctos anjos.`,
    `E em verdade vos digo que, dos que aqui estão, alguns ha que não gostarão a morte até que vejam o reino de Deus.`,
    `E aconteceu que, quasi oito dias depois d'estas palavras, tomou comsigo a Pedro, a João e a Thiago, e subiu ao monte a orar.`,
    ...
    `E aconteceu que, apartando-se elles d'elle, disse Pedro a Jesus: Mestre, bom é que nós estejamos aqui, e façamos tres tendas, uma para ti, uma para Moysés, e uma para Elias; não sabendo o que dizia.`,
    ...
    `E disse-lhes: Qualquer que receber este menino em meu nome, recebe-me a mim; e qualquer que me recebe a mim, recebe o que me enviou; porque aquelle que entre vós todos fôr o menor, esse será grande.`,
    ...
    `E mandou mensageiros adiante da sua face; e, indo elles, entraram n'uma aldeia de samaritanos, para lhe prepararem pousada,`,
  ...
  11: [
    ...
    `E qual o pae d'entre vós que, se o filho lhe pedir pão, lhe dará uma pedra? Ou tambem, se lhe pedir peixe, lhe dará por peixe uma serpente?`,
    ...
    `Mas, conhecendo elle os seus pensamentos, disse-lhes: Todo o reino, dividido contra si mesmo, será assolado; e a casa, dividida contra si mesma, cairá.`,
    ...
    `Quando o espirito immundo tem saido do homem, anda por logares seccos, buscando repouso; e, não o achando, diz: Tornarei para minha casa, d'onde sahi.`,
    ...
    `E aconteceu que, dizendo elle estas coisas, uma mulher d'entre a multidão, levantando a voz, lhe disse: Bemaventurado o ventre que te trouxe e os peitos em que mamaste.`,
    `Mas elle disse: Antes bemaventurados os que ouvem a palavra de Deus e a guardam.`,
    `E, ajuntando-se a multidão, começou a dizer: Maligna é esta geração: ella pede um signal; e não lhe será dado outro signal, senão o signal do propheta Jonas:`,
    `Porque, assim como Jonas foi signal para os ninivitas, assim o Filho do homem o será tambem para esta geração.`,
    `A rainha do sul se levantará no juizo com os homens d'esta geração, e os condemnará; pois até dos confins da terra veiu ouvir a sabedoria de Salomão; e eis aqui está quem é maior do que Salomão`,
    `Os homens de Ninive se levantarão no juizo com esta geração, e a condemnarão; pois se converteram com a prégação de Jonas, e eis aqui está quem é maior do que Jonas.`,
    ...
    `A candeia do corpo é o olho. Sendo pois o teu olho simples, tambem todo o teu corpo será luminoso, mas, se fôr mau, tambem o teu corpo será tenebroso.`,
    `Vê pois que a tua luz que em ti ha não sejam trevas.`,
    `Se, pois, todo o teu corpo é luminoso, não tendo em trevas parte alguma, todo será luminoso, como quando a candeia te allumia com o seu resplendor.`,
    ...
    `E o Senhor lhe disse; Vós, os phariseos, limpaes agora o exterior do copo e do prato; porém o vosso interior está cheio de rapina e maldade.`,
    `Loucos! o que fez o exterior, não fez tambem o interior?`,
    `Antes dae esmola do que tiverdes, e eis que tudo vos será limpo.`,
    `Mas ai de vós, phariseos, que dizimaes a hortelã, e a arruda, e toda a hortaliça, e desprezaes o juizo e amor de Deus. Importava fazer estas coisas, e não deixar as outras.`,
    ...
    `Porém elle disse: Ai de vós tambem, doutores da lei, que carregaes os homens com cargas difficeis de transportar, e vós mesmos nem ainda com um dos vossos dedos tocaes nas ditas cargas.`,
    ...
    `Desde o sangue de Abel, até ao sangue de Zacharias, que foi morto entre o altar e o templo; assim, vos digo, será requerido d'esta geração.`,
  ...
  18: [
    ...
    `E perguntou-lhe um certo principe, dizendo: Bom Mestre, que hei de fazer para herdar a vida eterna?`,
