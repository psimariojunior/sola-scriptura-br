const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Porque, se a palavra pronunciada pelos anjos permaneceu firme, e toda a transgressão e desobediencia recebeu a justa retribuição,`,
    ...
    `Porque convinha que aquelle, por cuja causa são todas as coisas, e mediante o qual todas as coisas existem, trazendo muitos filhos á gloria, consagrasse pelas afflicções o principe da salvação d'elles.`,
  ...
  8: [
    ...
    `Porque, reprehendendo-os, lhes diz: Eis que virão dias, diz o Senhor, em que com a casa de Israel e com a casa de Judah estabelecerei um novo concerto,`,
    `Não segundo o concerto que fiz com seus paes no dia em que os tomei pela mão, para os tirar da terra do Egypto; porque não permaneceram n'aquelle meu concerto, e eu para elles não attentei, diz o Senhor.`,
    `Porque este é o concerto que depois d'aquelles dias farei com a casa de Israel, diz o Senhor; porei as minhas leis no seu entendimento, e em seu coração as escreverei: e eu lhes serei por Deus, e elles me serão por povo:`,
  ...
  9: [
    ...
    `Que tinha o incensario de oiro, e a arca do concerto, coberta de oiro toda em redor: em que estava a talha de oiro, que continha o manná, e a vara de Aarão, que tinha florescido, e as taboas do concerto;`,
    ...
    `O qual era figura para o tempo de então, em que se offereciam presentes e sacrificios, que, quanto á consciencia, não podiam aperfeiçoar aquelle que fazia o serviço.`,
    ...
    `Mas, vindo Christo, o summo sacerdote dos bens futuros, por um maior e mais perfeito tabernaculo, não feito por mãos, isto é, não d'esta feitura,`,
    ...
    `Quanto mais o sangue de Christo, que pelo Espirito eterno se offereceu a si mesmo immaculado a Deus, purificará as vossas consciencias das obras mortas para servirdes ao Deus vivo?`,
    ...
    `D'outra maneira, necessario lhe fôra padecer muitas vezes desde a fundação do mundo: mas agora na consummação dos seculos uma vez se manifestou, para aniquilar o peccado pelo sacrificio de si mesmo.`,
  ...
  11: [
    ...
    `Pela fé Abel offereceu a Deus maior sacrificio do que Caim, pela qual alcançou testemunho de que era justo, porquanto Deus deu testemunho dos seus dons, e, depois de morto, ainda falla por ella.`,
    `Pela fé Enoch foi trasladado para não ver a morte, e não foi achado, porquanto Deus o trasladara; porque antes da sua trasladação alcançou testemunho de que agradava a Deus.`,
    ...
    `Pela fé Noé, divinamente advertido das coisas que ainda se não viam, temeu, e, para salvação da sua familia, fabricou a arca, pela qual condemnou o mundo, e foi feito herdeiro da justiça que é segundo a fé.`,
    ...
    `Pela fé tambem a mesma Sarah recebeu a virtude de conceber, e deu á luz já fóra da edade; porquanto teve por fiel aquelle que lh'o tinha promettido.`,
    ...
    `Todos estes morreram na fé, sem terem recebido as promessas; porém, vendo-as de longe, e crendo-as e abraçando-as, confessaram que eram estrangeiros e peregrinos na terra.`,
    ...
    `Mas agora desejam uma melhor, isto é, a celestial. Pelo que tambem Deus se não envergonha d'elles, de se chamar seu Deus, porque já lhes apparelhou uma cidade.`,
  ...
  12: [
    ...
    `Olhando para Jesus, auctor e consummador da fé, o qual pelo gozo que lhe estava proposto supportou a cruz, desprezando a affronta, e assentou-se á dextra do throno de Deus.`,
    ...
    `E, na verdade, toda a correcção, ao presente, não parece ser causa de gozo, senão de tristeza, mas depois produz um fructo pacifico de justiça aos exercitados por ella`,
    ...
    `Porque bem sabeis que, querendo ainda depois herdar a benção, foi rejeitado, porque não achou logar de arrependimento, ainda que com lagrimas o buscou.`,
    ...
    `Vêde que não rejeiteis ao que falla; porque, se não escaparam aquelles que rejeitaram ao que na terra dava respostas divinas, muito menos escaparemos nós, se nos desviarmos d'aquelle que é dos céus`,
    ...
    `Pelo que, recebendo o reino immovel, retenhamos a graça, pela qual sirvamos a Deus agradavelmente com reverencia e piedade;`,
  ...
  13: [
    ...
    `Vos aperfeiçoe em toda a boa obra, para fazerdes a sua vontade, obrando em vós o que perante elle é agradavel por Christo Jesus, ao qual seja gloria para todo o sempre. Amen.`,
