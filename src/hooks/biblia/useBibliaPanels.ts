...
export interface UseBibliaPanelsReturn {
  ...
  sidePanelTab: 'comentarios' | 'strong' | 'notas' | 'estudos' | 'contexto' | 'referencias' | null;
...
export function UseBibliaPanels(): UseBibliaPanelsReturn {
  ...
  const [sidePanelTab, setSidePanelTab] = useState<'comentarios' | 'strong' | 'notas' | 'estudos' | 'contexto' | 'referencias' | null>(null);
