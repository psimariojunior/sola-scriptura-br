const data: Record<number, string[]> = {
  1: [
    `Paulo, apostolo de Jesus Christo segundo o mandado de Deus, nosso Salvador, e do Senhor Jesus Christo, esperança nossa,`,
    ...
    `Como te roguei, quando parti para a Macedonia, que ficasses em Epheso, para advertires a alguns, que não ensinem outra doutrina,`,
    ...
    `Sabendo isto, que a lei não foi posta para o justo, mas para os injustos e obstinados, para os impios e peccadores, para os profanos e irreligiosos, para os parricidas e matricidas, para os homicidas,`,
    ...
    `Mas por isso me foi feita misericordia, para que em mim, que sou o principal, Jesus Christo mostrasse toda a sua longanimidade, para exemplo dos que haviam de crêr n'elle para a vida eterna.`,
  ...
  6: [
    `Todos os servos que estão debaixo do jugo estimem a seus senhores por dignos de toda a honra, para que o nome de Deus e a doutrina não sejam blasphemados.`,
    ...
    `Perversas contendas de homens corruptos de entendimento, e privados da verdade, cuidando que a piedade seja ganho; aparta-te dos taes.`,
    ...
    `Manda aos ricos d'este mundo que não sejam altivos, nem ponham a esperança na incerteza das riquezas, mas em Deus vivo, que abundantemente nos dá todas as coisas para d'ellas gozarmos:`,
