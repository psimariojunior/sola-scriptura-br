const data: Record<number, string[]> = {
  1: [
    `E succedeu depois da morte de Moysés, servo do Senhor, que o Senhor fallou a Josué, filho de Nun, servo de Moysés, dizendo:`,
    ...
    `Tão sómente esforça-te e tem mui bom animo, para teres o cuidado de fazer conforme a toda a lei que meu servo Moysés te ordenou; d'ella não te desvies, nem para a direita nem para a esquerda, para que prudentemente te conduzas por onde quer que andares.`,
    `Não se aparte da tua bocca o livro d'esta lei; antes medita n'elle dia e noite, para que tenhas cuidado de fazer conforme a tudo quanto n'elle está escripto; porque então farás prosperar o teu caminho, e então prudentemente te conduzirás.`,
    ...
    `Passae pelo meio do arraial, e ordenae ao povo, dizendo: Provei-vos de comida, porque dentro de tres dias passareis este Jordão, para que entreis a possuir a terra que vos dá o Senhor vosso Deus, que possuaes.`,
  ...
  2: [
    `E enviou Josué, filho de Nun, dois homens desde Sittim a espiar secretamente, dizendo: Andae, considerae a terra, e a Jericó. Foram pois, e entraram na casa d'uma mulher prostituta, cujo nome era Rahab, e dormiram ali.`,
    `Então deu-se noticia ao rei de Jericó, dizendo: Eis-que esta noite vieram aqui uns homens dos filhos d'Israel, para espiar a terra.`,
    ...
    `Porque temos ouvido que o Senhor seccou as aguas do Mar Vermelho diante de vós, quando saíeis do Egypto, e o que fizestes aos dois reis dos amorrheos, a Sehon e a Og, que estavam d'além do Jordão, os quaes destruistes.`,
    `O que ouvindo, desmaiou o nosso coração, e em ninguem mais ha animo algum, por causa da vossa presença: porque o Senhor vosso Deus é Deus em cima nos céus e em baixo na terra.`,
    ...
    `Foram-se pois, e chegaram ao monte, e ficaram ali tres dias, até que voltaram os perseguidores, porque os perseguidores os buscaram por todo o caminho, porém não os acharam.`,
  ...
  3: [
    `Levantou-se pois Josué de madrugada, e partiram de Sittim, e vieram até ao Jordão, elle e todos os filhos d'Israel: e pousaram ali, antes que passassem.`,
    `E succedeu, ao fim de tres dias, que os principes passaram pelo meio do arraial;`,
    `E ordenaram ao povo, dizendo: Quando virdes a arca do concerto do Senhor vosso Deus, e que os sacerdotes levitas a levam, parti vós tambem do vosso logar, e segui-a.`,
    ...
    `E o Senhor disse a Josué: Este dia começarei a engrandecer-te perante os olhos de todo o Israel, para que saibam, que assim como fui com Moysés assim serei comtigo.`,
    ...
    `Disse mais Josué: N'isto conhecereis que o Deus vivo está no meio de vós: e que de todo lançará de diante de vós aos cananeos, e aos hetheos, e aos heveos, e aos phereseos, e aos girgaseos, e aos amorrheos, e aos jebuseos.`,
    ...
    `Porque ha de acontecer que, assim que as plantas dos pés dos sacerdotes que levam a arca do Senhor, o Senhor de toda a terra, repousem nas aguas do Jordão, se separarão as aguas do Jordão, e as aguas que de cima descem pararão n'um montão.`,
    ...
    `Pararam-se as aguas, que vinham de cima; levantaram-se n'um montão, mui longe da cidade d'Adam, que está da banda de Santan; e as que desciam ao mar das campinas, que é o mar salgado, faltavam de todo e separaram-se: então passou o povo defronte de Jericó.`,
    `Porém os sacerdotes, que levavam a arca do concerto do Senhor, pararam firmes em secco no meio do Jordão: e todo o Israel passou em secco, até que todo o povo acabou de passar o Jordão.`,
  ],
  4: [
    ...
    `E mandae-lhes, dizendo: Tomae-vos d'aqui, do meio do Jordão, do logar do assento dos pés dos sacerdotes, doze pedras; e levae-as comvosco á outra banda e depositae-as no alojamento em que haveis de passar esta noite.`,
    `Chamou pois Josué os doze homens, que escolhera dos filhos d'Israel: de cada tribu um homem;`,
    ...
    `Então lhes direis que as aguas do Jordão se separaram diante da arca do concerto do Senhor; passando ella pelo Jordão, separaram-se as aguas do Jordão: assim que estas pedras serão para sempre por memorial aos filhos de Israel.`,
    `Fizeram pois os filhos d'Israel assim como Josué tinha ordenado, e levantaram doze pedras do meio do Jordão, como o Senhor dissera a Josué, segundo o numero das tribus dos filhos de Israel: e levaram-n'as comsigo ao alojamento, e as depositaram ali.`,
  ...
  6: [
    ...
    `E sete sacerdotes levarão sete buzinas de carneiros diante da arca, e no setimo dia rodeareis a cidade sete vezes: e os sacerdotes tocarão as buzinas.`,
    ...
    `Então chamou Josué, filho de Nun, aos sacerdotes, e disse-lhes: Levae a arca do concerto; e sete sacerdotes levem sete buzinas de carneiros, diante da arca do Senhor.`,
    ...
    `E succedeu que ao setimo dia madrugaram ao subir da alva, e da mesma maneira rodeiaram a cidade sete vezes: n'aquelle dia sómente rodeiaram a cidade sete vezes.`,
    ...
    `Gritou pois o povo, tocando os sacerdotes as buzinas: e succedeu que, ouvindo o povo o sonido da buzina, gritou o povo com grande grita; e o muro caiu abaixo, e o povo subiu á cidade, cada qual em frente de si, e tomaram a cidade.`,
    ...
    `Então entraram os mancebos espias, e tiraram a Rahab, e a seu pae, e a sua mãe, e a seus irmãos, e a tudo quanto tinha; tiraram tambem a todas as suas familias, e pozeram-n'os fóra do arraial d'Israel.`,
    ...
    `Assim deu Josué vida á prostituta Rahab, e á familia de seu pae, e a tudo quanto tinha; e habitou no meio de Israel até ao dia de hoje: porquanto escondera os mensageiros que Josué tinha enviado a espiar a Jericó.`,
    `E n'aquelle tempo Josué os esconjurou, dizendo: Maldito diante do Senhor seja o homem que se levantar e reedificar esta cidade de Jericó: no seu primogenito a fundará, e no seu filho mais novo lhe porá as portas.`,
  ...
  8: [
    `Então disse o Senhor a Josué: Não temas, e não te espantes: toma comtigo toda a gente de guerra, e levanta-te, sobe a Hai: olha que te tenho dado na tua mão o rei d'Hai, e o seu povo, e a sua cidade, e a sua terra.`,
    ...
    `E será que, tomando vós a cidade, poreis a cidade a fogo; conforme á palavra do Senhor fareis; olhae que vol-o tenho mandado.`,
    `Assim Josué os enviou, e elles se foram á emboscada; e ficaram entre Bethel e Hai, ao occidente d'Hai: porém Josué passou aquella noite no meio do povo.`,
    ...
    `E pozeram o povo, todo o arraial que estava ao norte da cidade, e a sua emboscada ao occidente da cidade: e foi Josué aquella noite ao meio do valle.`,
    `E succedeu que, vendo-o o rei d'Hai, se apressaram, e se levantaram de madrugada, e os homens da cidade sairam ao encontro d'Israel ao combate, elle e todo o seu povo, ao tempo assignalado, perante as campinas: porque elle não sabia, que se lhe houvesse posto emboscada detraz da cidade.`,
    ...
    `E virando-se os homens de Hai para traz, olharam, e eis-que o fumo da cidade subia ao céu, e não tiveram logar para fugirem para uma parte nem outra: porque o povo, que fugia para o deserto, se tornou contra os que os seguiam.`,
    ...
    `E ao rei d'Hai enforcou n'um madeiro, até á tarde: e ao pôr do sol ordenou Josué, que o seu corpo se tirasse do madeiro; e o lançaram á porta da cidade, e levantaram sobre elle um grande montão de pedras, até ao dia d'hoje.`,
  ...
  10: [
    `E succedeu que, ouvindo Adonizedek, rei de Jerusalem, que Josué tomara a Hai, e a tinha destruido totalmente, e fizera a Hai e ao seu rei como tinha feito a Jericó e ao seu rei, e que os moradores de Gibeon fizeram paz com os israelitas, e estavam no meio d'elles,`,
    ...
    `Pelo que Adonizedek, rei de Jerusalem, enviou a Hoham, rei de Hebron, e a Piram, rei de Jarmuth, e a Jafia, rei de Lachis, e a Debir, rei de Eglon, dizendo:`,
    `Subi a mim, e ajudae-me, e firamos a Gibeon: porquanto fez paz com Josué e com os filhos de Israel.`,
    `Então se ajuntaram, e subiram cinco reis dos amorrheos, o rei de Jerusalem, o rei de Hebron, o rei de Jarmuth, o rei de Lachis, o rei de Eglon, elles e todos os seus exercitos: e sitiaram a Gibeon e pelejaram contra ella.`,
    `Enviaram pois os homens de Gibeon a Josué ao arraial de Gilgal, dizendo: Não retires as tuas mãos de teus servos; sobe apressadamente a nós, e livra-nos, e ajuda-nos, porquanto todos os reis dos amorrheos, que habitam na montanha, se ajuntaram contra nós`,
    ...
    `E succedeu que, fugindo elles diante de Israel, á descida de Bethoron, o Senhor lançou sobre elles, do céu, grandes pedras até Azeka, e morreram: e foram muitos mais os que morreram das pedras da saraiva do que os que os filhos d'Israel mataram á espada.`,
    `Então Josué fallou ao Senhor, no dia em que o Senhor deu os amorrheos na mão dos filhos de Israel, e disse aos olhos dos israelitas: Sol, detem-te em Gibeon, e tu, lua, no valle de Ajalon.`,
    ...
    `E succedeu que, trazendo aquelles reis a Josué, Josué chamou todos os homens de Israel, e disse aos capitães da gente de guerra, que com elle foram: Chegae, ponde os vossos pés sobre os pescoços d'estes reis. E chegaram, e pozeram os seus pés sobre os seus pescoços.`,
    ...
    `E succedeu que, ao tempo do pôr do sol, deu Josué ordem que os tirassem dos madeiros: e lançaram-n'os na cova onde se esconderam: e pozeram grandes pedras á bocca da cova, que ainda ali estão até ao mesmo dia de hoje.`,
    ...
    `E tambem o Senhor a deu na mão d' Israel, a ella e a seu rei, e a feriu a fio de espada, a ella e a toda a alma que n'ella havia; nada deixou de resto: e fez ao seu rei como fizera ao rei de Jericó.`,
    ...
    `E a tomaram, e a feriram ao fio de espada, assim ao seu rei como a todas as suas cidades; e a toda a alma, que n'ellas havia, a ninguem deixou com vida, conforme a tudo o que fizera a Eglon: e a destruiu totalmente, a ella e a toda a alma que n'ella havia.`,
    `Então Josué, e todo o Israel com elle, tornou a Debir, e pelejou contra ella;`,
    `E tomou-a com o seu rei, e a todas as suas cidades, e as feriram a fio de espada, e a toda a alma que n'ellas havia destruiram totalmente, nada deixou de resto: como fizera a Hebron, assim fez a Debir e ao seu rei, e como fizera a Libna e ao seu rei.`,
    `Assim feriu Josué toda aquella terra, as montanhas, o sul, e as campinas, e as descidas das aguas, e a todos os seus reis; nada deixou de resto: mas tudo o que tinha folego destruiu, como ordenara o Senhor Deus d'Israel.`,
  ...
  14: [
    `Isto pois é o que os filhos de Israel tiveram em herança na terra de Canaan: o que Eleazar, o sacerdote, e Josué, filho de Nun, e os Cabeças dos paes das tribus dos filhos de Israel lhes fizeram repartir,`,
    ...
    `Então os filhos de Judah chegaram a Josué em Gilgal; e Caleb, filho de Jefoné o kenezeo, lhe disse: Tu sabes a palavra que o Senhor fallou a Moysés, homem de Deus, em Cades-barnea, por causa de mim e de ti.`,
    ...
    `Então Moysés n'aquelle dia jurou, dizendo: Certamente a terra que pisou o teu pé será tua, e de teus filhos, em herança perpetuamente; pois perseveraste em seguir ao Senhor meu Deus`,
    `E agora eis-que o Senhor me conservou em vida, como disse; quarenta e cinco annos ha agora, desde que o Senhor fallou esta palavra a Moysés, andando Israel ainda no deserto: e agora eis-que já hoje sou de edade de oitenta e cinco annos.`,
    ...
    `Agora pois dá-me este monte de que o Senhor fallou aquelle dia: pois n'aquelle dia tu ouviste que os enakins estão ali, e grandes e fortes cidades ha ali: porventura o Senhor será comigo, para os expellir, como o Senhor disse.`,
    `E Josué o abençoou, e deu a Caleb, filho de Jefoné, a Hebron em herança.`,
    `Portanto Hebron foi de Caleb, filho de Jefoné o kenezeo, em herança até ao dia d'hoje: porquanto perseverara em seguir ao Senhor Deus d'Israel.`,
  ...
  17: [
    ...
    `Tambem os mais filhos de Manasseh tiveram sorte, segundo as suas familias, a saber: os filhos d'Abiezer, e os filhos de Helek, e os filhos d'Asriel, e os filhos de Sechem, e os filhos de Hepher, e os filhos de Semida: estes são os filhos machos de Manasseh, filho de José, segundo as suas familias.`,
    `Selofad, porém, filho d'Hepher, o filho de Gilead, filho de Machir, o filho de Manasseh, não teve filhos, mas só filhas: e estes são os nomes de suas filhas: Machla, Noa, Hogla, Milka e Tirsa.`,
    `Estas, pois, chegaram diante d'Eleazar, o sacerdote, e diante de Josué, filho de Nun, e diante dos principes, dizendo: O Senhor ordenou a Moysés que se nos désse herança no meio de nossos irmãos: pelo que, conforme ao dito do Senhor, lhes deu herança no meio dos irmãos de seu pae.`,
    ...
    `Então disseram os filhos de José: As montanhas nos não bastariam: tambem carros ferrados ha entre todos os cananeos que habitam na terra do valle, entre os de Beth-sean e os logares da sua jurisdicção, e entre os que estão no valle de Jezreel.`,
    `Então Josué fallou á casa de José, a Ephraim e a Manasseh, dizendo: Grande povo és, e grande força tens; uma só sorte não terás;`,
  ...
  18: [
    ...
    `Porquanto os levitas não teem parte no meio de vós, porém o sacerdocio do Senhor é a sua parte: e Gad, e Ruben e a meia tribu de Manasseh tomaram a sua herança d'além do Jordão para o oriente, a qual lhes deu Moysés, o servo do Senhor.`,
    ...
    `Foram pois aquelles homens, e passaram pela terra, e a descreveram, segundo as cidades, em sete partes, n'um livro: e voltaram a Josué, ao arraial em Silo.`,
    ...
    `E d'ali passa este termo a Luza, ao lado de Luza (que é Beth-el) para o sul: e desce este termo a Ataroth-adar, ao pé do monte que está da banda do sul de Beth-horon a baixa.`,
    ...
    `E Beth-araba, e Semaraim, e Beth-*el,`,
  ...
  24: [
    `Depois ajuntou Josué todas as tribus d'Israel em Sichem: e chamou os anciãos d'Israel, e os seus Cabeças, e os seus juizes, e os seus officiaes: e elles se apresentaram diante de Deus.`,
    ...
    `E clamaram ao Senhor, e poz uma escuridão entre vós e os egypcios, e trouxe o mar sobre elles, e os cobriu, e os vossos olhos viram o que eu fiz no Egypto: depois habitastes no deserto muitos dias.`,
    ...
    `Levantou-se tambem Balac, filho de Zippor, rei dos moabitas, e pelejou contra Israel: e enviou e chamou a Balaão, filho de Beor, para que vos amaldiçoasse.`,
    `Porém eu não quiz ouvir a Balaão: pelo que, abençoando-vos, abençoou, e livrei-vos da sua mão.`,
    `E, passando vós o Jordão, e vindo a Jericó, os habitantes de Jericó pelejaram contra vós, os amorrheos, e os pherezeos, e os cananeos, e os hetheos, e os girgaseos, e os heveos, e os jebuseos; porém os dei na vossa mão.`,
    ...
    `E eu vos dei a terra em que não trabalhastes, e cidades que não edificastes, e habitaes n'ellas, e comeis das vinhas e dos olivaes que não plantastes.`,
    ...
    `Porém, se vos parece mal aos vossos olhos servir ao Senhor, escolhei-vos hoje a quem sirvaes: se os deuses a quem serviram vossos paes, que estavam d'além do rio, ou os deuses dos amorrheos, em cuja terra habitaes: porém eu e a minha casa serviremos ao Senhor.`,
    `Então respondeu o povo, e disse: Nunca nos aconteça que deixemos ao Senhor para servir mos a outros deuses;`,
    `Porque o Senhor é o nosso Deus; elle é o que nos fez subir, a nós e a nossos paes, da terra do Egypto, da casa da servidão, e o que tem feito estes grandes signaes aos nossos olhos, e nos guardou por todo o caminho que andámos, e entre todos os povos pelo meio dos quaes passámos.`,
    ...
    `E disse o povo a Josué: Serviremos ao Senhor nosso Deus, e obedeceremos á sua voz.`,
    ...
    `Tambem enterraram em Sichem os ossos de José, que os filhos d'Israel trouxeram do Egypto, n'aquella parte do campo que Jacob comprara aos filhos d'Hemor, pae de Sichem, por cem peças de prata: porquanto foram em herança para os filhos de José.`,
