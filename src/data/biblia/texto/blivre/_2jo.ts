const data: Record<number, string[]> = {
  1: [
    ...
    `Muitas coisas eu tenho que vos escrever, porém não eu quis fazê-lo com papel e tinta; mas espero vir a vós, e vos falar face a face, para que nossa alegria seja completa.`,
