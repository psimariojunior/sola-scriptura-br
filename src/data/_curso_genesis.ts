...
export const CURSO_GENESIS: Curso = {
  ...
  módulos: [
    {
      id: 'genesis-mod-1',
      título: 'A Criação e a Queda',
      descrição: 'Gênesis 1-3: O início de tudo — criação, Adão e Eva, o pecado original',
      ícone: '🌍',
      aulas: [
        {
          id: 'genesis-1-1',
          título: 'No princípio: A criação do universo',
          tipo: 'video',
          duração: '15 min',
          videoUrl: 'https://www.youtube.com/watch?v=HFNKIRb8G4c',
          videoTítulo: 'Gênesis 1 — Criação do Universo | BibleProject Português',
          conteúdo: `## No princípio: A criação do universo

Gênesis 1:1 é talvez o versículo mais conhecido da Bíblia: "No princípio, Deus criou os céus e a terra." Em apenas dez palavras no hebraico (*Bereshit bara Elohim et hashamayim ve'et ha'arets*), Deus resume a origem de toda a realidade.

### O que esse versículo nos ensina

**1. Deus existia antes de tudo**
O "princípio" não é o início de Deus — é o início do universo material. Deus é eterno, preexistente, não criado. Ele não teve começo; Ele é o começo de tudo o mais.

**2. Deus criou — não formou**
O verbo hebraico *bara* (criar) é usado exclusivamente com Deus como sujeito. Significa criar algo novo, do nada (*ex nihilo*). Deus não usou matéria pré-existente. Ele falou, e o universo passou a existir.

**3. Os céus e a terra**
A expressão "céus e terra" é um merismo — uma figura de linguagem que inclui tudo entre os dois extremos. Significa "o universo inteiro": o visível e o invisível, o material e o espiritual.

### Os seis dias da criação

Gênesis 1 descreve a criação em seis dias estruturados:

| Dia | O que Deus criou |
|-----|------------------|
| 1 | Luz (separação trevas/luz) |
| 2 | Firmamento (separação águas) |
| 3 | Terra seca e vegetação |
| 4 | Sol, lua e estrelas |
| 5 | Peixes e aves |
| 6 | Animais terrestres e o ser humano |

Há um padrão: nos primeiros três dias, Deus **prepara os ambientes**; nos últimos três, **enche esses ambientes** com habitantes. Dia 1 (luz) corresponde ao Dia 4 (astros). Dia 2 (firmamento/águas) corresponde ao Dia 5 (peixes/aves). Dia 3 (terra/vegetação) corresponde ao Dia 6 (animais/humanos).

### "E Deus viu que era bom"

Sete vezes nesse capítulo, Deus avalia sua própria obra como "boa". A criação não era apenas funcional — era bela, harmoniosa e perfeita. Não havia pecado, morte ou sofrimento. O mundo como Deus o fez era radicalmente diferente do mundo que conhecemos hoje.

### E o sétimo dia?

Gênesis 2:1-3 diz que Deus "descansou" no sétimo dia. Isso não significa que Ele estava cansado — significa que Sua obra estava completa. O descanso de Deus é o modelo para o sábado, instituído para o bem humano. Deus abençoou o sétimo dia e o santificou — isto é, o separou como sagrado.

### A ciência e a criação

Muitos cristãos debatem se os "dias" de Gênesis 1 são dias literais de 24 horas ou períodos longos. O texto hebraico permite ambas as interpretações. O mais importante não é a duração exata, mas a mensagem teológica: **Deus é o Criador soberano de tudo, e Sua criação foi intencional, ordenada e boa.**
...
> "Porque em seis dias fez o Senhor os céus e a terra, o mar e tudo o que neles há e ao sétimo dia descansou." — Êxodo 20:11`,
          versículosChave: [
            ...
            { ref: 'Hebreus 11:3', texto: 'Pela fé entendemos que os mundos foram formados pela palavra de Deus.' },
            { ref: 'Salmo 19:1', texto: 'Os céus proclamam a glória de Deus.' },
          ],
        },
        {
          id: 'genesis-1-2',
...
### "Façamos" — O conselho divino

O plural em "façamos" tem gerado debate ao longo dos séculos. Alguns veem aqui uma referência à Trindade (Pai, Filho e Espírito Santo). Outros interpretam como um plural de majestade ou como Deus consultando os anjos. Seja qual for a interpretação, o ponto central é claro: a criação do ser humano foi um ato deliberado e intencional de Deus.

### Imagem e semelhança

O que significa ser feito "à imagem de Deus" (*tselem*) e "conforme a semelhança" (*demut*)?

**1. Racionalidade e criatividade**
Somos seres pensantes, capazes de raciocinar, criar, planejar e inovar. Nenhum animal faz poesia, filosofa ou constrói catedrais.

**2. Moralidade e consciência**
Temos um senso inato de certo e errado. Sabemos que há coisas que "não deveriam ser" — injustiça, crueldade, mentira. Essa consciência moral nos distingue dos animais.

**3. Relacionamento**
Assim como Deus é Trindade (relacionamento perfeito), fomos feitos para relacionamentos — com Deus, com outros seres humanos e com a criação.

**4. Domínio**
Deus deu ao ser humano autoridade sobre a terra (Gn 1:28). Isso não é exploração — é administração responsável. Somos mordomos, não donos.

### "Macho e fêmea os criou"

Gênesis 1:27 afirma que Deus criou a humanidade como masculina e feminina. Ambos são igualmente imagem de Deus. A complementaridade entre homem e mulher reflete a plenitude da imagem divina — nenhum gênero sozinho a representa por completo.

### A bênção e o mandamento

Deus abençoou os seres humanos com três mandamentos:
1. **Sede fecundos e multiplicai-vos** — procriar e formar família
2. **Enchei a terra** — espalhar-se e colonizar
3. **Sujeitai-a** — administrar a criação com sabedoria

### O que deu errado?

A criação era "muito boa" (Gn 1:31). Não havia morte, sofrimento ou separação de Deus. Mas em Gênesis 3, tudo muda. O ser humano, no exercício de sua liberdade, escolheu desobedecer — e as consequências foram catastróficas.

A boa notícia é que mesmo na queda, Deus já revelou seu plano de redenção (Gn 3:15). A história da salvação começa aqui.`,
          versículosChave: [
            { ref: 'Gênesis 1:27', texto: 'E criou Deus o homem à sua imagem; à imagem de Deus o criou; macho e fêmea os criou.' },
            { ref: 'Salmo 8:5-6', texto: 'Fizeste-o pouco menor do que os anjos e de glória e de honra o coroaste.' },
            { ref: 'Gênesis 1:31', texto: 'E viu Deus tudo quanto tinha feito, e eis que era muito bom.' },
          ],
        },
        {
          id: 'genesis-1-3',
          título: 'O Jardim do Éden: O lar original',
          tipo: 'texto',
          duração: '10 min',
          conteúdo: `## O Jardim do Éden: O lar original

Gênesis 2:8-14 descreve o Éden — o jardim que Deus plantou para o ser humano. Mais que um lugar físico, o Éden representa a intenção original de Deus para a humanidade: viver em Sua presença, em abundância e em comunhão.

### O que era o Éden?

A palavra "Éden" em hebraico significa "delícia" ou "prazer". Era um lugar de beleza extraordinária, onde Deus colocou "toda árvore agradável à vista e boa para comida" (Gn 2:9).

O texto menciona quatro rios que saem do Éden:
1. **Pisom** — rodeava a terra de Havilá (ouro, bedelista, ônix)
2. **Giom** — rodeava a terra de Cuxe
3. **Hiddequel** (Tigre) — fluía a leste da Assíria
4. **Eufrates** — o grande rio da Mesopotâmia

Dois desses rios (Tigre e Eufrates) existem até hoje no Iraque. A localização exata do Éden é incerta, mas a região da Mesopotâmia Superior é a candidata mais provável.

### As duas árvores especiais

No centro do jardim, Deus colocou duas árvores significativas:

**A Árvore da Vida** — Representava a vida eterna em comunhão com Deus. Depois da queda, Deus colocou querubins para impedir o acesso a ela (Gn 3:24). No Apocalipse, a árvore da vida reaparece na Nova Jerusalém (Ap 22:2), mostrando que o plano original será restaurado.

**A Árvore do Conhecimento do Bem e do Mal** — O teste de obediência. Deus deu liberdade ao ser humano, mas estabeleceu um limite: "De toda árvore do jardim comerás; mas da árvore do conhecimento do bem e do mal, não comerás" (Gn 2:16-17).

### Por que Deus proibiu?

A proibição não era arbitrária — era um teste de amor. Obediência sem escolha não é obediência; é programação. Deus queria ser amado livremente, não por compulsão. A árvore representava a autonomia humana: o direito de escolher entre confiar em Deus ou seguir seu próprio caminho.

### O trabalho antes da queda

Gênesis 2:15 diz que Deus "tomou o homem e o colocou no jardim do Éden para o lavrar e o guardar." O trabalho não é consequência da queda — fazia parte do plano original. O que a queda trouxe foi o trabalho árduo, o suor e a frustração (Gn 3:17-19).

### A solidão do homem

Antes de criar a mulher, Deus observou: "Não é bom que o homem esteja só" (Gn 2:18). Essa é a primeira coisa que Deus declarou como "não boa" na criação. A solidão não é parte do plano original — Deus fez o ser humano para relacionamento.

Deus trouxe todos os animais para que Adão os nomeasse, mas nenhum era "ajudador idôneo" para ele. Então Deus criou Eva a partir da costela de Adão — não do pé (para ser dominada) nem da cabeça (para dominar), mas do lado (para ser companheira igual).

### O Éden como modelo

O Jardim do Éden é o protótipo do que Deus quer para a humanidade: intimidade com Ele, trabalho significativo, relacionamentos perfeitos e harmonia com a natureza. Tudo isso foi perdido na queda, mas será restaurado na nova criação.`,
          versículosChave: [
            { ref: 'Gênesis 2:8', texto: 'E plantou o Senhor Deus um jardim no Éden, do lado oriental; e pôs ali o homem que havia formado.' },
            { ref: 'Gênesis 2:15', texto: 'Tomou, pois, o Senhor Deus ao homem e o colocou no jardim do Éden para o lavrar e o guardar.' },
            { ref: 'Gênesis 2:18', texto: 'Não é bom que o homem esteja só; far-lhe-ei uma ajudadora idônea.' },
          ],
        },
        {
          id: 'genesis-1-4',
          título: 'A queda: O pecado original',
          tipo: 'texto',
          duração: '15 min',
          conteúdo: `## A queda: O pecado original

Gênesis 3 é o capítulo mais trágico e mais importante para entender a condição humana. Aqui, a harmonia perfeita é destruída. O ser humano escolhe desobedecer a Deus, e as consequências afetam toda a criação.

### A serpente

O capítulo começa com uma descrição inquietante: "A serpente era o mais astuto de todos os animais do campo que o Senhor Deus tinha feito" (Gn 3:1). O texto não explica a origem do mal na serpente — isso é revelado mais tarde nas Escrituras (Apocalipse 12:9 identifica a serpente como Satanás).

A astúcia da serpente se manifesta em sua abordagem:
1. **Questiona a palavra de Deus**: "É verdade que Deus disse...?" (Gn 3:1)
2. **Exagera a restrição**: "Não comereis de toda árvore do jardim?" (quando Deus só proibiu uma)
3. **Nega as consequências**: "Certamente não morrereis" (Gn 3:4)
4. **Promete autonomia**: "Sereis como Deus" (Gn 3:5)

### A resposta de Eva

Eva comete três erros ao responder:
1. **Adiciona à palavra de Deus**: "Não tocareis nela" (Deus não disse isso)
2. **Diminui o privilégio**: "de todas as árvores" (Deus disse "de toda árvore do jardim comerás")
3. **Não cita a consequência corretamente**: "para que não morrais" (Deus disse "certamente morrerás")

Quando não conhecemos bem o que Deus disse, ficamos vulneráveis à mentira.

### O ato e suas consequências

"Ela tomou do seu fruto e comeu e deu também ao seu marido, e ele comeu" (Gn 3:6). Note a sequência: Eva viu, desejou, tomou e comeu. A tentação seguiu o padrão que João descreve em 1 João 2:16: "a concupiscência da carne, a concupiscência dos olhos e a soberba da vida."

O que aconteceu imediatamente?
1. **Os olhos se abriram** — mas para ver sua nudez, não para ver melhor
2. **Sentiram vergonha** — a inocência foi perdida
3. **Esconderam-se de Deus** — o relacionamento íntimo foi rompido
4. **Culparam outros** — Adão culpa Eva (e indiretamente a Deus: "a mulher que me deste"); Eva culpa a serpente

### As maldições

Deus pronuncia três maldições:

**À serpente**: Rastejará sobre o peito e comerá pó. Inimizade entre sua descendência e a da mulher. A descendência da mulher lhe ferirá a cabeça (Gn 3:14-15) — essa é a *protoevangelium*, o primeiro anúncio do evangelho.

**À mulher**: Dor na gravidez e no parto. Desejo pelo marido, que a governará (Gn 3:16).

**Ao homem**: A terra será amaldiçoada. Trabalho árduo com suor até voltar ao pó (Gn 3:17-19).

### O primeiro sacrifício

Antes de expulsar Adão e Eva, Deus fez algo extraordinário: "Fez o Senhor Deus a Adão e à sua mulher túnicas de pele e os vestiu" (Gn 3:21). Para fazer roupas de pele, um animal teve que morrer. É o primeiro sacrifício — um símbolo de que Deus provê cobertura para o pecado, mas com um custo.

### Expulsão do Éden

Deus os expulsa do jardim e coloca querubins com espada flamejante para guardar o caminho da árvore da vida. A expulsão não é apenas punição — é misericórdia. Deus não quer que o ser humano viva eternamente em estado de pecado (Gn 3:22-24).

### A esperança em Gênesis 3:15

Apesar da tragédia, Deus revela seu plano: "Porei inimizade entre ti e a mulher, entre a tua descendência e a sua descendência; esta te ferirá a cabeça, e tu lhe ferirás o calcanhar." Esse versículo é chamado de *protoevangelium* — o primeiro evangelho. Aponta para Jesus, a descendência da mulher que esmagaria a cabeça de Satanás.`,
          versículosChave: [
            { ref: 'Gênesis 3:15', texto: 'Porei inimizade entre ti e a mulher, entre a tua descendência e a sua descendência; esta te ferirá a cabeça.' },
            { ref: 'Romanos 5:12', texto: 'Por um só homem entrou o pecado no mundo, e pelo pecado a morte.' },
            { ref: '1 João 2:16', texto: 'Tudo o que há no mundo, a concupiscência da carne, a concupiscência dos olhos e a soberba da vida.' },
          ],
        },
        {
          id: 'genesis-1-5',
          título: 'Caim e Abel: O primeiro homicídio',
          tipo: 'texto',
          duração: '10 min',
          conteúdo: `## Caim e Abel: O primeiro homicídio

Gênesis 4 narra o primeiro ato de violência da história humana. Os filhos de Adão e Eva — Caim e Abel — oferecem sacrifícios a Deus, mas com corações diferentes. O resultado é trágico.

### Os dois sacrifícios

"Caim trouxe do fruto da terra uma oferta ao Senhor. Abel também trouxe dos primogênitos das suas ovelhas e da sua gordura" (Gn 4:3-4).

A diferença não estava no tipo de oferta — estava no coração. Hebreus 11:4 explica: "Pela fé Abel ofereceu a Deus maior sacrifício do que Caim." Abel ofereceu com fé e sinceridade; Caim ofereceu por obrigação, sem entrega verdadeira.

Deus aceitou a oferta de Abel e rejeitou a de Caim. Isso não significa que Deus é injusto — significa que Deus olha o coração, não apenas a aparência externa.

### A raiva de Caim

"Caim se irou muito e descaiu-lhe o semblante" (Gn 4:5). A reação de Caim revela seu coração: em vez de se arrepender e corrigir sua atitude, ele fica com raiva. Deus o adverte:

"Por que te iraste? E por que descaiu o teu semblante? Se bem fizeres, não é certo que serás aceito? Se, porém, não fizeres bem, o pecado jaz à porta. Para ti será o seu desejo, e sobre ele dominarás." (Gn 4:6-7)

Essa é uma das passagens mais importantes sobre o pecado. Deus diz a Caim:
- O pecado está à porta — sempre pronto a atacar
- O desejo do pecado é te dominar
- Mas você pode e deve dominá-lo

O pecado não é inevitável. Deus deu ao ser humano a capacidade de resistir — mas é preciso escolher.

### O primeiro assassinato

Caim chama Abel para o campo e o mata (Gn 4:8). O texto é lacônico e chocante. O primeiro ato de um ser humano contra outro é assassinato — e é entre irmãos.

Deus confronta Caim: "Onde está Abel, teu irmão?" (Gn 4:9). É a mesma pergunta que Deus faz a todo pecador. A resposta de Caim é a primeira mentira registrada: "Não sei. Sou eu guardador do meu irmão?"

Deus responde com palavras terríveis: "Que fizeste? A voz do sangue do teu irmão clama da terra a mim" (Gn 4:10). O sangue inocente fala — e Deus ouve.

### A marca de Caim

Caim é amaldiçoado: a terra não produzirá mais para ele, e ele será errante e fugitivo. Mas Caim reclama: "A minha pena é maior do que a possa sofrer. Lanças-me hoje da face da terra, e da tua presença me esconderei" (Gn 4:13-14).

Mesmo sendo um assassino, Deus mostra misericórdia: põe uma marca em Caim para que ninguém o mate, e promete vingança sete vezes contra quem o ferisse (Gn 4:15). Deus não destrói Caim — mas as consequências do pecado permanecem.

### A linhagem de Caim

O capítulo termina com a genealogia de Caim. Seus descendentes incluem:
- **Tubal-Caim** — "artífice de todo instrumento cortante de bronze e ferro" (tecnologia)
- **Jubal** — "pai de todos os que tocam harpa e flauta" (música)
- **Lameque** — o primeiro polígamo, que se gaba de violência (Gn 4:23-24)

A linhagem de Caim representa a humanidade afastada de Deus: progresso tecnológico e cultural, mas corrupção moral crescente.

### A linhagem de Sete

"Deus me concedeu outro descendente em lugar de Abel" (Gn 4:25). Sete representa a linha dos que buscavam a Deus. "Nesse tempo se começou a invocar o nome do Senhor" (Gn 4:26). A história da humanidade se divide entre essas duas linhagens: os que seguem Deus e os que se afastam.

### Lições para hoje

1. Deus olha o coração, não a aparência
2. O pecado não controla você — a menos que você permita
3. As consequências do pecado são reais e duradouras
4. A misericórdia de Deus persiste mesmo em meio ao juízo
5. A violência nasce quando o coração se afasta de Deus`,
          versículosChave: [
            { ref: 'Gênesis 4:7', texto: 'Se, porém, não fizeres bem, o pecado jaz à porta.' },
            { ref: 'Hebreus 11:4', texto: 'Pela fé Abel ofereceu a Deus maior sacrifício do que Caim.' },
            { ref: 'Gênesis 4:10', texto: 'A voz do sangue do teu irmão clama da terra a mim.' },
          ],
        },
        {
          id: 'genesis-1-6',
...
Gênesis 6:5 pinta um quadro sombrio: "Viu o Senhor que a maldade do homem se multiplicara sobre a terra e que era continuamente mau todo desígnio do seu coração." A humanidade havia se corrompido de forma irreversível.

Há debate sobre quem eram os "filhos de Deus" de Gênesis 6:1-4. Três interpretações principais:
1. Anjos que se uniram a mulheres humanas
2. Descendentes de Sete que se casaram com descendentes de Caim
3. Governantes que abusaram de seu poder

Independentemente da interpretação, o resultado é claro: a maldade atingiu um ponto sem retorno.

### Noé: Um homem justo em meio à corrupção

"Noé era homem justo e íntegro entre os seus contemporâneos; Noé andava com Deus" (Gn 6:9). Em uma geração totalmente corrupta, Noé manteve sua integridade. Três adjetivos o descrevem:
- **Justo** — vivia em conformidade com a lei de Deus
- **Íntegro** — era completo, sem hipocrisia
- **Andava com Deus** — tinha comunhão íntima com o Criador

### A arca: Projeto de Deus

Deus instrui Noé a construir uma arca — não um barco comum, mas uma embarcação gigantesca:
- **Comprimento**: 300 côvados (~137 metros)
- **Largura**: 50 côvados (~23 metros)
- **Altura**: 30 côvados (~14 metros)
- **3 andares**, com compartimentos internos

A arca tinha capacidade para cerca de 43.000 metros cúbicos — suficiente para abrigar animais e suprimentos. Não precisava de leme nem velas — Deus a guiaria.

### Os animais

Deus ordenou que Noé levasse:
- Um casal de cada animal "imundo"
- Sete pares de cada animal "limpo"
- Sete pares de cada ave

Essa distinção é importante: os animais "limpos" seriam usados para sacrifício depois do dilúvio (Gn 8:20).

### O dilúvio

"Romperam-se todas as fontes do grande abismo, e as janelas dos céus se abriram" (Gn 7:11). A chuva caiu por 40 dias e 40 noites. As águas cobriram as montanhas mais altas. Toda vida terrestre pereceu — exceto os que estavam na arca.

O dilúvio não foi um evento local — o texto descreve uma catástrofe universal. A linguagem é clara: "pereceu toda a carne" (Gn 7:21).

### A recuperação

Após 150 dias, as águas começaram a baixar. A arca pousou nas montanhas de Ararate. Noé enviou um corvo e depois uma pomba — quando a pomba voltou com uma folha de oliveira, Noé soube que a terra estava se recuperando.

Noé saiu da arca e ofereceu sacrifícios. Deus fez uma promessa: "Não tornarei mais a amaldiçoar a terra por causa do homem" (Gn 8:21). É a primeira aliança pós-dilúvio.

### O arco-íris

"E o arco estará nas nuvens, e eu o verei e me lembrarei da aliança eterna" (Gn 9:16). O arco-íris não é apenas um fenômeno natural — é um sinal da aliança de Deus com toda a terra. Cada vez que vemos um arco-íris, Deus está se lembrando de Sua promessa.

### O que o dilúvio nos ensina

1. O pecado tem consequências graves — Deus não tolera o mal para sempre
2. Deus sempre preserva um remanescente fiel
3. A obediência de uma pessoa pode salvar muitos
4. Deus é justo e misericordioso ao mesmo tempo
5. O dilúvio é um tipo do batismo (1 Pedro 3:21) — juízo sobre o pecado, salvação para os fiéis`,
          versículosChave: [
            { ref: 'Gênesis 6:9', texto: 'Noé era homem justo e íntegro entre os seus contemporâneos; Noé andava com Deus.' },
            { ref: 'Gênesis 9:13', texto: 'O meu arco tenho posto nas nuvens; este será por sinal da aliança entre mim e a terra.' },
            { ref: '2 Pedro 3:9', texto: 'O Senhor não retarda a sua promessa.' },
          ],
        },
      ],
    },
    {
      id: 'genesis-mod-2',
      título: 'Os Patriarcas',
      descrição: 'Gênesis 12-36: Abraão, Isaque e Jacó — a família da aliança',
      ícone: '👨‍👩‍👦',
      aulas: [
        {
          id: 'genesis-2-1',
...
### O contexto: Babel e a dispersão

Após o dilúvio, a humanidade novamente se rebelou. Em Gênesis 11, os homens construíram a torre de Babel — um monumento à sua própria glória. Deus confundiu suas línguas e os dispersou. A humanidade estava perdida, dividida e afastada de Deus.

É nesse contexto que Deus age: escolhe um homem e, através dele, abençoará todas as famílias da terra.

### A promessa de Deus a Abrão

"Saí da tua terra, da tua parentela e da casa de teu pai, para a terra que eu te mostrarei. Far-te-ei uma grande nação, e abençoar-te-ei e engrandecerei o teu nome; e tu serás uma bênção." (Gn 12:1-2)

Deus faz sete promessas a Abrão:
1. **Uma terra** — "a terra que eu te mostrarei"
2. **Uma nação grande** — descendência numerosa
3. **Bênção pessoal** — "abençoar-te-ei"
4. **Um grande nome** — "engrandecerei o teu nome"
5. **Será uma bênção** — não apenas receberá, mas será canal de bênção
6. **Bênção para quem o abençoar** — proteção divina
7. **Todas as famílias da terra serão abençoadas** — a promessa universal

Essa última promessa é a mais importante: através de Abraão, Deus abençoará toda a humanidade. Paulo explica em Gálatas 3:8 que essa promessa é o evangelho antecipado — a justificação pela fé.

### A resposta de Abraão

"E foi Abrão, como o Senhor lhe dissera" (Gn 12:4). A obediência de Abraão é impressionante:
- Ele tinha 75 anos
- Não sabia para onde estava indo
- Saiu sem ver o cumprimento das promessas
- Levou a esposa, o sobrinho Ló e todos os seus bens

Hebreus 11:8 comenta: "Pela fé Abraão, sendo chamado, obedeceu, para sair para um lugar que devia receber por herança; e saiu sem saber para onde ia."

### A chegada à terra de Canaã

Abrão chegou à terra de Canaã — a terra que Deus prometeu. Ele passou por Siquém (onde Deus apareceu novamente) e pelo monte E Betel, onde construiu um altar. Mesmo sendo estrangeiro em terra alheia, Abraão adorou a Deus.

Mas havia um problema: a terra já era habitada pelos cananeus. Deus prometeu a terra à descendência de Abraão, mas o cumprimento viria séculos depois — no tempo de Josué.

### A fome e a descida ao Egito

Uma grande fome obrigou Abraão a descer ao Egito. Aqui vemos uma falha em sua fé: ele pediu a Sara que dissesse ser sua irmã, com medo de ser morto por causa dela (Gn 12:11-13).

Essa mentira quase causou desastre — Faraó tomou Sara para si. Mas Deus interveio com pragas e Faraó descobriu a verdade. Abraão foi expulso do Egito, mas saiu rico (Gn 12:16-20).

### Lições da chamada de Abraão

1. **Deus toma a iniciativa** — não fomos nós que O buscamos; Ele nos chamou
2. **A fé requer obediência** — crer sem agir não é fé verdadeira
3. **A fé não vê o cumprimento imediato** — Abraão esperou 25 anos por Isaque
4. **Deus usa pessoas imperfeitas** — Abraão mentiu, duvidou, mas continuou sendo usado
5. **O plano de Deus é universal** — não apenas para um povo, mas para todas as nações`,
          versículosChave: [
            { ref: 'Gênesis 12:1-2', texto: 'Saí da tua terra... e far-te-ei uma grande nação.' },
        ...
        {
          id: 'genesis-2-2',
          título: 'A aliança com Abraão',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## A aliança com Abraão

Gênesis 15 e 17 registram dois momentos fundamentais: Deus faz uma aliança formal com Abraão. Essa aliança é a base de toda a história da salvação — dela surgem Israel, Davi e, finalmente, Jesus Cristo.

### Gênesis 15: A aliança incondicional

Depois de resgatar Ló de uma coalizão de reis, Abraão recebe uma visão de Deus. Mas Abraão tem uma preocupação: "Senhor Deus, que me hás de dar? Eu vou sem filho" (Gn 15:2).

Deus o leva para fora: "Olha agora para os céus e conta as estrelas, se as podes contar. Assim será a tua descendência" (Gn 15:5). E o texto acrescenta a frase mais importante: "Ele creu no Senhor, e isso lhe foi contado por justiça" (Gn 15:6).

Essa é a primeira menção da justificação pela fé na Bíblia. Abraão não foi justificado por suas obras, mas por crer na promessa de Deus. Paulo usa extensivamente Romanos 4 e Gálatas 3 para explicar que essa é a base da salvação — fé, não obras.

### O ritual da aliança

Deus instrui Abraão a preparar um ritual: dividir animais ao meio e dispor as metades uma em frente à outra (Gn 15:9-11). Naquela cultura, quando duas partes faziam uma aliança, ambas passavam entre as metades — significando: "Que me aconteça o mesmo a esses animais se eu quebrar esta aliança."

Mas observe: em Gênesis 15:17, apenas Deus passa entre as metades — na forma de um forno de fumaça e uma tocha de fogo. Isso significa que esta é uma **aliança incondicional**: Deus assume toda a responsabilidade. O cumprimento depende de Deus, não de Abraão.

### As promessas detalhadas

Deus revela a Abraão o futuro de sua descendência:
1. **Escravidão no Egito** por 400 anos (Gn 15:13)
2. **Libertação** com grandes riquezas (Gn 15:14)
3. **Retorno à terra** na quarta geração (Gn 15:16)
4. **Os limites da terra** — do rio do Egito ao Eufrates (Gn 15:18)

Essas profecias se cumpriram exatamente no Êxodo (século XV a.C.) e no tempo de Davi e Salomão.

### Gênesis 17: A aliança da circuncisão

Treze anos depois, Deus aparece novamente a Abraão (agora com 99 anos) e estabelece a circuncisão como sinal da aliança:

"E entre mim e vós e a tua descendência depois de ti se guardará a minha aliança; será por sinal de aliança entre mim e vós." (Gn 17:11)

A circuncisão era:
- Um sinal visível da aliança
- Um compromisso com a identidade do povo de Deus
- Um lembrete constante das promessas

### A mudança de nome

Deus muda o nome de Abrão ("pai exaltado") para Abraão ("pai de multidões") e de Sarai ("minha princesa") para Sara ("princesa"). A mudança de nome indica uma nova identidade — Deus está redefinindo quem eles são.

### A promessa de Isaque

Deus promete um filho de Sara — algo humanamente impossível, pois Sara tinha 90 anos e Abraão 100. Abraão ri (Gn 17:17) — mas Deus cumpre Sua promessa. O nome "Isaque" significa "ele ri" — uma lembrança permanente da incredulidade transformada em alegria.

### A aliança e Cristo

A aliança com Abraão aponta para Cristo de várias formas:
1. A descendência abençoada é Cristo (Gálatas 3:16)
2. A justificação pela fé é o mesmo princípio da salvação em Cristo
3. A bênção às nações se cumpre na pregação do evangelho
4. A circuncisão é substituída pelo batismo como sinal da aliança

Paulo resume: "Se sois de Cristo, sois então descendência de Abraão e herdeiros segundo a promessa" (Gálatas 3:29).`,
          versículosChave: [
            { ref: 'Gênesis 15:6', texto: 'Ele creu no Senhor, e isso lhe foi contado por justiça.' },
            { ref: 'Gênesis 17:7', texto: 'Estabelecerei a minha aliança entre mim e ti e a tua descendência.' },
            { ref: 'Gálatas 3:29', texto: 'Se sois de Cristo, sois então descendência de Abraão.' },
          ],
        },
        {
          id: 'genesis-2-3',
          ...
          tipo: 'texto',
          duração: '15 min',
          conteúdo: `## O sacrifício de Isaque

Gênesis 22 é um dos capítulos mais dramáticos e teologicamente ricos de toda a Bíblia. Deus testa a fé de Abraão pedindo o impossível: sacrificar seu único filho, Isaque.

### O teste supremo

"Depois destas coisas, provou Deus a Abraão e disse-lhe: Abraão! E ele disse: Eis-me aqui. Toma agora o teu filho, o teu único filho, Isaque, a quem amas, e vai-te à terra de Moriá; e oferece-o ali em holocausto" (Gn 22:1-2).

Observe o peso de cada palavra:
- "O teu filho" — não qualquer um, mas seu filho
- "O teu único filho" — o filho da promessa
- "A quem amas" — o mais precioso que tinha
- "Em holocausto" — sacrifício total, queimado completamente

Isaque era não apenas o filho amado — era o portador da promessa. Se Isaque morresse, como Deus cumpriria Suas promessas? Para Abraão, isso não fazia sentido humano. Mas ele obedeceu.

### A jornada de três dias

Abraão se levantou de madrugada, cortou lenha, selou o jumento e partiu com dois servos e Isaque. A jornada até Moriá durou três dias. Três dias de angústia, dúvida e fé.

Hebreus 11:19 revela o que se passava no coração de Abraão: "Ele considerou que Deus era poderoso até para ressuscitar dentre os mortos; e daí, por semelhança, ele também recebeu o seu filho."

Abraão creu que, mesmo se sacrificasse Isaque, Deus o ressuscitaria. Sua fé estava no Deus que cumpre promessas, mesmo que pareça impossível.

### "Deus proverá para si o cordeiro"

Quando Isaque perguntou: "Onde está o cordeiro para o holocausto?", Abraão respondeu com uma profecia: "Deus proverá para si o cordeiro para o holocausto, meu filho" (Gn 22:7-8). Essa resposta é mais profunda do que Abraão imaginava.

Ele construiu o altar, arrumou a lenha, amarrou Isaque e estendeu a mão para o cutelo. No último momento, o anjo do Senhor o chamou: "Abraão! Abraão! Não estendas a mão sobre o menino" (Gn 22:11-12).

Deus não queria que Isaque morresse — queria testar se Abraão O amava acima de tudo. E Abraão passou no teste.

### O cordeiro substituto

"Abraão levantou os olhos e viu um carneiro detrás, preso pelos chifres em um sarçal. Foi Abraão, tomou o carneiro e ofereceu-o em holocausto, em lugar de seu filho" (Gn 22:13).

O carneiro substituiu Isaque. Esse é o princípio do sacrifício substituto — alguém morre no lugar de outro. Esse padrão se repete em toda a Bíblia:
- O cordeiro pascal no Êxodo
- Os sacrifícios do Templo
- João Batista apontando Jesus: "Eis o Cordeiro de Deus"
- Jesus morrendo na cruz como nosso substituto

### A promessa renovada

Deus jura por si mesmo (pois não há ninguém maior) e renova as promessas com juramento solene: "Por mim mesmo juro, diz o Senhor: porquanto fizeste isso e não me negaste o teu único filho, abençoar-te-ei grandemente e multiplicarei grandemente a tua descendência" (Gn 22:16-17).

### O cumprimento em Cristo

Gênesis 22 é um tipo cristológico — uma sombra de Cristo:
- **Pai entrega o filho único** — Deus entrega Jesus
- **Filho obedece voluntariamente** — Jesus se entregou
- **Três dias** — Jesus ressuscitou ao terceiro dia
- **Substituição** — Jesus morreu em nosso lugar
- **Providência de Deus** — "Deus proverá para si o cordeiro"

João 3:16 é o cumprimento de Gênesis 22: "Porque Deus tanto amou o mundo que deu o seu Filho unigênito."`,
          versículosChave: [
        ...
        {
          id: 'genesis-2-4',
          título: 'Isaque e Jacó: A continuidade da aliança',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## Isaque e Jacó: A continuidade da aliança

Gênesis 25-27 narra a transição da aliança de Abraão para a próxima geração. Isaque e Jacó são homens imperfeitos, mas Deus cumpre Suas promessas através deles.

### Isaque: O filho da promessa

Isaque é talvez o patriarca menos "destacado" de Gênesis. Sua vida é narrada em apenas dois capítulos (25-27), mas ele tem um papel crucial: é o elo entre Abraão e Jacó, o portador da promessa em sua geração.

Isaque se casou com Rebeca aos 40 anos (Gn 25:20). O casamento é uma história de providência divina: o servo de Abraão foi à Mesopotâmia buscar uma esposa, e Deus guiou diretamente a Rebeca.

### A gravidez difícil

Rebeca era estéril — um padrão que se repete na história de Israel (Sara, Rebeca, Raquel, Ana). Deus intervém para mostrar que os filhos da promessa são obra Sua, não esforço humano.

Durante a gravidez, os gêmeos lutavam dentro dela. Rebeca perguntou ao Senhor, e Ele respondeu: "Duas nações há no teu ventre; dois povos se separarão das tuas entranhas; um povo será mais forte do que o outro; o maior servirá o menor" (Gn 25:23).

### Esaú e Jacó

Os gêmeos eram opostos:
- **Esaú** — peludo, homem do campo, caçador, impulsivo
- **Jacó** — liso, homem das tendas, estrategista, ambicioso

A rivalidade começou antes do nascimento e marcou toda a vida deles.

### O prato de lentilhas

"Esaú voltou do campo e estava ele com fome. Disse a Jacó: Deixa-me comer desse guizado vermelho, pois estou com fome" (Gn 25:29-30). Jacó aproveitou a vulnerabilidade do irmão: "Vende-me hoje a tua primogenitura" (Gn 25:31).

Esaú respondeu: "Eis que vou morrer; para que me servirá a primogenitura?" (Gn 25:32). O texto comenta: "Esaú desprezou a primogenitura" (Gn 25:34).

A primogenitura era um direito sagrado — incluía a liderança da família, o dobro da herança e, no caso dos patriarcas, a bênção da aliança. Esaú a trocou por uma refeição.

### A bênção roubada

Gênesis 27 narra o episódio mais conturbado: Jacó, com a ajuda de Rebeca, engana o cego Isaque e recebe a bênção que era de Esaú.

Isaque, velho e quase cego, pediu a Esaú que caçasse um animal e preparasse uma refeição para receber a bênção. Rebeca ouviu e preparou um plano: vestiu Jacó com as roupas de Esaú e cobriu seus braços com peles de cabrito para imitar a pelagem do irmão.

Jacó mentiu: "Eu sou Esaú, teu primogênito" (Gn 27:19). Isaque, confuso pelo cheiro das roupas e pela textura das mãos, deu a bênção a Jacó.

### As consequências

Quando Esaú descobriu, gritou com amargura: "Não tem ele porventura o nome de Jacó? Já duas vezes me suplantou" (Gn 27:36). A palavra "Jacó" (*Ya'aqov*) soa como "suplantador" — Esaú via o irmão como trapaceiro.

Esaú planejava matar Jacó após a morte de Isaque. Rebeca mandou Jacó fugir para a Mesopotâmia, para a casa de seu irmão Labão.

### A teologia de Gênesis 27

Este capítulo levanta questões difíceis:
- Deus aprova a mentira? Não.
- Deus usa pessoas imperfeitas? Sim.
- O plano de Deus depende da perfeição humana? Não.

Romanos 9:10-13 esclarece: "Sem que os gêmeos tivessem ainda nascido, nem tivessem praticado o bem ou o mal — para que o propósito de Deus, conforme a eleição, permanecesse, não por obras, mas por aquele que chama — foi-lhe dito: O maior servirá o menor."

A escolha de Deus não se baseou no mérito de Jacó nem na maldade de Esaú. Deus escolheu livremente, segundo Seu propósito soberano.

### Lições

1. Deus cumpre Suas promessas apesar das falhas humanas
2. As escolhas têm consequências — Esaú perdeu a bênção
3. A fé não justifica meios errados — Jacó sofreu as consequências de sua fraude
4. Deus é soberano — Seu plano não depende da perfeição humana`,
          versículosChave: [
            { ref: 'Gênesis 25:23', texto: 'O maior servirá o menor.' },
            { ref: 'Gênesis 28:15', texto: 'Eu estou contigo e te guardareis por onde quer que fores.' },
            { ref: 'Romanos 9:13', texto: 'A Jacó amei, mas a Esaú aborreci.' },
          ],
        },
        {
          id: 'genesis-2-5',
          título: 'Jacó em Betel: O encontro com Deus',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## Jacó em Betel: O encontro com Deus

Gênesis 28 registra um dos momentos mais marcantes da vida de Jacó: a visão de Deus em Betel. Fugindo de Esaú, sozinho no deserto, Jacó tem um encontro que transforma sua vida.

### A fuga de Jacó

Jacó deixou Beer-Sheba e rumou para Harã. Ele estava sozinho, fugindo da ira do irmão, sem nada além do que vestia. O homem que havia enganado para obter a bênção agora estava desamparado.

"Ao pôr do sol, tomou uma das pedras do lugar e a pôs por travesseiro e deitou-se naquele lugar" (Gn 28:11). Jacó, o filho da tenda, agora dormia no chão duro, com uma pedra como travesseiro.

### A escada celestial

"E sonhou; e eis que estava posta na terra uma escada, cujo topo tocava no céu; e eis que os anjos de Deus subiam e desciam por ela" (Gn 28:12).

Essa visão é extraordinária:
- A escada conectava o céu à terra — Deus não está distante
- Os anjos subiam e desciam — há comunicação entre Deus e a humanidade
- Deus estava no topo — Ele é soberano e presente

### A promessa de Deus

"E eis que o Senhor estava sobre ela e disse: Eu sou o Senhor, Deus de Abraão, teu pai, e o Deus de Isaque" (Gn 28:13). Deus se identifica como o Deus da aliança — o Deus que fez promessas a Abraão e as renovou com Isaque.

Deus repete as promessas a Jacó:
...
3. **Expansão**: "Espalhar-se-á para o ocidente e para o orientente, para o norte e para o sul"
...
Jacó acordou assustado: "Que terrível é este lugar! Não é outro senão a casa de Deus, e a porta dos céus" (Gn 28:17). Ele ergueu a pedra que usara como travesseiro, a colocou como coluna e derramou azeite sobre ela.

Jacó fez um voto: "Se Deus for comigo e me guardar nesta jornada que faço e me der pão para comer e vestes para vestir, e eu em paz voltar à casa de meu pai, então o Senhor será o meu Deus" (Gn 28:20-21).

O voto de Jacó é ambíguo — parece uma barganha. Mas é também o início de sua transformação: ele reconhece que precisa de Deus.

### Betel: A casa de Deus

Jacó chamou o lugar de "Betel" — "casa de Deus". É um dos lugares mais significativos da história de Israel. Mais tarde, Deus se encontraría novamente com Jacó em Betel (Gn 35), e ali Jacó mudou seu nome para Israel.

### O significado cristão

Jesus usou a imagem da escada de Jacó para descrever a si mesmo: "Vereis o céu aberto e os anjos de Deus subindo e descindo sobre o Filho do Homem" (João 1:51). Jesus é a escada — o mediador entre Deus e a humanidade. Nele, o céu se abre para nós.

### Lições de Betel

1. Deus encontra pessoas em momentos de desespero — Jacó estava sozinho e fugindo
2. Deus renova as promessas de geração em geração
3. A presença de Deus transforma lugares comuns em lugares sagrados
4. Jesus é a escada que conecta o céu à terra
5. Deus não abandona Seus escolhidos, mesmo quando falham`,
          versículosChave: [
        ...
        {
          id: 'genesis-2-6',
          título: 'Jacó e Esaú: A reconciliação',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## Jacó e Esaú: A reconciliação

Gênesis 32-33 narra o encontro mais tenso da vida de Jacó: após 20 anos de exílio, ele precisa enfrentar o irmão que jurou matá-lo. É uma história de medo, luta com Deus e reconciliação.

### O retorno à terra prometida

Jacó passou 20 anos na casa de Labão. Casou-se com Lia e Raquel, teve 12 filhos e acumulou grande riqueza. Mas agora Deus lhe disse: "Volta à terra de teus pais e à tua parentela, e eu serei contigo" (Gn 31:3).

Jacó obedeceu, mas sabia que precisava enfrentar Esaú. Mandou mensageiros adiante, e eles voltaram com notícia aterrorizante: "Esaú vem ao teu encontro com 400 homens" (Gn 32:6).

### O medo de Jacó

"Jacó temeu muito e angustiou-se" (Gn 32:7). O homem que havia enganado o irmão agora enfrentava as consequências. Ele dividiu seus bens em dois grupos — se Esaú atacasse um, o outro escaparia.

Então Jacó orou — e sua oração é modelo de humildade e fé:

"Ó Deus de meu pai Abraão e Deus de meu pai Isaque! Tu, Senhor, que me disseste: Volta à tua terra e à tua parentela, e eu te favorecerei. Não sou digno de menor de todas as misericórdias e de toda a verdade que tens feito ao teu servo. Com o meu bordão passei este Jordão, e agora estou em dois campos. Livra-me, peço-te, da mão de meu irmão, da mão de Esaú, porque eu temo que ele venha e me fira a mim, e às mães com os filhos." (Gn 32:9-11)

Jacó reconhece:
- Sua indignidade — "não sou digno"
- A fidelidade de Deus — "todas as misericórdias"
- Sua dependência — "livra-me"
- Seu medo — "eu temo"

### A luta no Jiboque

Na noite antes do encontro, Jacó ficou sozinho. "Então um homem lutou com ele até ao romper da aurora" (Gn 32:24). Esse "homem" era Deus (ou um anjo, ou uma teofania — a prefiguração de Cristo).

A luta durou a noite toda. Quando o homem viu que não prevalecia, tocou a articulação do quadril de Jacó, que saiu do lugar. Jacó ficou manco — mas não largou.

"Não te deixarei, se me não abençoares" (Gn 32:26). Essa é a determinação de quem já não luta por suas próprias forças, mas pela bênção de Deus.

### A mudança de nome

O homem perguntou: "Qual é o teu nome?" E ele respondeu: "Jacó" — "suplantador". O homem declarou: "O teu nome não será mais Jacó, mas Israel; pois como príncipe lutaste com Deus e com os homens e prevaleceste" (Gn 32:28).

"Israel" (*Yisra'el*) pode significar "aquele que luta com Deus" ou "príncipe de Deus". A mudança de nome é uma nova identidade: Jacó não é mais o enganador — é o que lutou com Deus e venceu.

### A reconciliação com Esaú

No dia seguinte, Jacó se aproximou de Esaú. Ele se prostrou sete vezes diante do irmão — um gesto de humildade extrema. Mas Esaú correu ao seu encontro, abraçou-o e beijou-o. Ambos choraram (Gn 33:4).

Esaú não veio com 400 homens para matar — veio para receber o irmão. Jacó disse: "Ver o teu rosto é como ver o rosto de Deus" (Gn 33:10). A reconciliação com o irmão reflete a reconciliação com Deus.

### Lições para hoje

1. **O passado tem consequências** — Jacó fugiu por 20 anos, mas precisou voltar para enfrentar seu erro
2. **A oração muda tudo** — Jacó orou com humildade e Deus o atendeu
3. **Deus transforma identidades** — de Jacó (enganador) a Israel (príncipe de Deus)
4. **A reconciliação exige humildade** — Jacó se prostrou, não exigiu seus "direitos"
5. **Lutar com Deus é parte da fé** — não é pecado questionar; é pecado desistir`,
          versículosChave: [
            { ref: 'Gênesis 32:28', texto: 'O teu nome não será mais Jacó, mas Israel.' },
            { ref: 'Gênesis 33:4', texto: 'Esaú correu-lhe ao encontro, abraçou-o e beijou-o.' },
            { ref: 'Gênesis 32:26', texto: 'Não te deixarei, se me não abençoares.' },
          ],
        },
      ],
    },
    {
      id: 'genesis-mod-3',
      título: 'José e o Desfecho',
      descrição: 'Gênesis 37-50: A história de José — de escravo a vice-rei do Egito',
      ícone: '👑',
      aulas: [
        {
          id: 'genesis-3-1',
          título: 'José vendido como escravo',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## José vendido como escravo

Gênesis 37 inicia a história de José — uma das narrativas mais bem construídas da Bíblia. José é o filho preferido de Jacó, e isso desperta a inveja mortal de seus irmãos.

### O sonho de José

"José, com 17 anos, apascentava o rebanho com seus irmãos" (Gn 37:2). Jacó amava José mais que todos os outros filhos — porque era filho da velhice e de Raquel, a esposa amada. Fez para ele uma túnica de muitas cores — um símbolo de favoritismo que acendeu a inveja.

José teve dois sonhos:
1. Os feixes de trigo dos irmãos se curvaram diante do dele
2. O sol, a lua e onze estrelas se curvaram diante dele

Em vez de manter os sonhos em silêncio, José os contou. "Acaso hás de reinar sobre nós? Acaso hás de ter domínio sobre nós?" (Gn 37:8). Até Jacó repreendeu — mas "guardou o dito" (Gn 37:11), reconhecendo que os sonhos podiam ser proféticos.

### A traição dos irmãos

Jacó enviou José para verificar se os irmãos estavam bem com o rebanho. Quando ele se aproximou, os irmãos o viram de longe e conspiraram: "Eis que vem o sonhador. Vinde, agora, e matemo-lo" (Gn 37:19-20).

Rúben, o primogênito, interveio: "Não derrameis sangue" (Gn 37:22). Em vez de matar, jogaram José numa cisterna seca.

Então mercadores ismaelitas passaram. Judá teve a ideia de vender José por 20 moedas de prata — o preço de um escravo. Os irmãos concordaram. José foi vendido e levado ao Egito.

### A túnica ensanguentada

Os irmãos mergulharam a túnica de José em sangue de cabrito e a levaram a Jacó: "Conhece, agora, se é ou não a túnica de teu filho" (Gn 37:32). Jacó reconheceu: "É a túnica de meu filho; um animal mau o devorou; José foi, sem dúvida, despedaçado" (Gn 37:33).

A dor de Jacó foi inconsolável: "Descerei saudoso meu filho até a sepultura" (Gn 37:35). A mentira dos irmãos causou décadas de sofrimento ao pai.

### O que José representa

A história de José é uma das mais ricas em tipologia cristã:
- **Filho amado do pai** — como Cristo, o Filho amado de Deus
- **Rejeitado pelos irmãos** — como Cristo foi rejeitado por Israel
- **Vendido por prata** — como Cristo foi traído por 30 moedas de prata
- **Sofreu injustamente** — como Cristo sofreu sem culpa
- **Elevado à posição mais alta** — como Cristo foi exaltado à direita de Deus

### A providência divina

Embora José não soubesse naquele momento, Deus estava orquestrando tudo. Os sonhos se cumpririam. A venda de José era parte do plano de Deus para preservar a família de Jacó durante a fome.

Gênesis 50:20 resume: "Vós bem pensastes mal contra mim; porém Deus o encaminhou para bem, para fazer como se vê neste dia, para conservar muita gente com vida."

O mal humano não frustra o plano de Deus — Deus usa até mesmo as piores ações para cumprir Seus propósitos.

### Lições da história de José

1. A inveja destrói relacionamentos
2. O favoritismo dos pais gera rivalidade entre irmãos
3. Deus tem um plano mesmo quando tudo parece perdido
4. A dor de hoje pode ser a preparação para o amanhã
5. Deus é soberano sobre todas as circunstâncias`,
          versículosChave: [
            { ref: 'Gênesis 37:5', texto: 'José teve um sonho e o contou a seus irmãos.' },
            { ref: 'Gênesis 50:20', texto: 'Deus o encaminhou para bem.' },
            { ref: 'Gênesis 37:28', texto: 'Venderam José aos ismaelitas por vinte moedas de prata.' },
          ],
        },
        {
          id: 'genesis-3-2',
          título: 'José no Egito: Fidelidade no sofrimento',
          tipo: 'texto',
          duração: '15 min',
          conteúdo: `## José no Egito: Fidelidade no sofrimento

Gênesis 39-41 narra a vida de José no Egito — de escravo a vice-rei. É uma história de fidelidade, integridade e providência divina.

### José na casa de Potifar

José foi comprado por Potifar, um oficial de Faraó. Mesmo como escravo, José prosperou: "O Senhor era com José, e ele foi homem próspero" (Gn 39:2). Potifar viu que Deus estava com ele e o colocou como administrador de toda a sua casa.

Aqui vemos um princípio: a fidelidade em pequenas coisas leva a responsabilidades maiores. José não reclamou de ser escravo — cumpriu seu papel com excelência.

### A tentação da esposa de Potifar

A esposa de Potifar olhou para José e disse: "Deita-te comigo" (Gn 39:7). José recusou com uma resposta que revela sua integridade:
...
José recusou por três razões:
1. **Confiança** — Potifar confiava nele
2. **Autoridade** — ele tinha poder, mas não o usaria para o mal
3. **Deus** — o pecado seria contra Deus, não apenas contra Potifar

A tentação não foi uma vez — "dia após dia" (Gn 39:10). Mas José manteve sua posição. Um dia, a esposa o agarrou pela roupa; ele fugiu, deixando a veste em suas mãos.

### A falsa acusação

A esposa de Potifar, rejeitada e furiosa, usou a veste como "prova" e acusou José de tentar abusá-la. Potifar acreditou na esposa e mandou José para a prisão.

Mas mesmo na prisão, "o Senhor era com José e estendeu a ele benignidade" (Gn 39:21). O carcereiro confiou a José a administração da prisão. Mais uma vez, a fidelidade de José foi reconhecida.

### Os sonhos do copeiro e do padeiro

Na prisão, José encontrou dois oficiais de Faraó que tinham sonhado. O copeiro sonhou com uma videira de três sarmentos; José interpretou: em três dias, Faraó o restauraria ao cargo.

O padeiro sonhou com três cestos de pães sobre sua cabeça; José interpretou: em três dias, Faraó o enforcaria. Ambos se cumpriram.

José pediu ao copeiro que se lembrasse dele diante de Faraó. Mas o copeiro se esqueceu — por dois anos (Gn 40:23; 41:1). José ficou na prisão, fiel a Deus, sem entender por quê.

### Os sonhos de Faraó

"Dois anos depois, Faraó sonhou" (Gn 41:1). Ninguém no Egito podia interpretar os sonhos. O copeiro então se lembrou de José e contou a Faraó.

José foi trazido da prisão. Faraó contou seus sonhos — sete vacas gordas devoradas por sete vacas magras; sete espigas cheias devoradas por sete espigas vazias. José interpretou:

"O que Deus há de fazer, ele o mostrou a Faraó. As sete vacas boas são sete anos; e as sete espigas boas são sete anos" (Gn 41:25-26). Sete anos de abundância, seguidos de sete anos de fome severa.
...
Ele se casou com Asenate, teve dois filhos (Manassés e Efraim) e administrou o Egito com sabedoria, armazenando grãos durante os anos de abundância.

### O cumprimento dos sonhos

Os sonhos de José da juventude começaram a se cumprir. Aos 30 anos, ele estava em posição de autoridade. Mas faltava o cumprimento completo — seus irmãos ainda não se curvaram diante dele.

### Lições

1. A fidelidade é recompensada — mesmo que demore
2. Deus usa até a prisão para preparar pessoas
3. A integridade é testada na tentação, não na facilidade
4. O tempo de Deus não é o nosso — José esperou 13 anos
5. O Espírito de Deus distingue pessoas em qualquer cultura`,
          versículosChave: [
            { ref: 'Gênesis 39:2', texto: 'O Senhor era com José.' },
        ...
        {
          id: 'genesis-3-3',
          título: 'A fome e a reconciliação',
          tipo: 'texto',
          duração: '15 min',
          conteúdo: `## A fome e a reconciliação

Gênesis 42-47 narra o clímax da história de José: os irmãos que o venderam vêm ao Egito buscar alimento e, sem saber, se curvam diante dele. É uma das narrativas mais emocionantes da Bíblia.

### A fome chega

"Começou a fome na terra, como José tinha predito" (Gn 41:54). Todos os países foram afetados, mas no Egito havia alimento. Jacó mandou seus dez filhos mais velhos ao Egito; Benjamim, o mais novo, ficou em casa (porque Jacó não queria perdê-lo também).

### O primeiro encontro

Quando os irmãos chegaram e se prostraram diante de José, ele os reconheceu — mas eles não o reconheceram (haviam passado mais de 20 anos). José então cumpriu parcialmente seu sonho: os irmãos se curvaram sem saber.

José os tratou com dureza. Acusou-os de serem espiões e exigiu que trouxessem Benjamim. Retém Simeão como refém e mandou os outros voltarem com grãos.

### O retorno a Jacão

Os irmãos voltaram a Jacó e contaram tudo. Jacó ficou devastado: "José já não está, nem Simeão; e levarás também a Benjamim? Tudo isso vem contra mim" (Gn 42:36).

Quando o alimento acabou, a fome persistiu. Judá assumiu a responsabilidade: "Eu mesmo darei fiador dele; da minha mão o buscarás" (Gn 43:9). Jacó finalmente consentiu, enviando Benjamim com presentes e oração: "Deus Todo-Poderoso vos conceda misericórdia diante desse homem" (Gn 43:14).

### O banquete

José viu Benjamim e ficou emocionado. Preparou um banquete para os irmãos, mas os sentou em ordem de nascimento — algo que os surpreendeu. Serviu porções especiais a Benjamim.

### O teste final

José ordenou que seu copeiro escondesse seu copo de prata no saco de Benjamim. Quando os irmãos partiram, José os mandou perseguir. O copo foi encontrado.

José declarou: "Aquele em cujo saco se achar o copo será meu servo" (Gn 44:10). Benjamim seria escravo — e os irmãos teriam que escolher entre salvar Benjamim e voltar ao pai.

### O discurso de Judá

Judá, que havia proposto vender José anos antes, agora se oferece como escravo no lugar de Benjamim. Seu discurso (Gn 44:18-34) é um dos mais tocantes da Bíblia:

"Não poderá o meu pai ver a morte do rapaz. Se não o trouxermos ao nosso pai, ele morrerá de desgosto. Agora, pois, peço-te que o teu servo fique em lugar do rapaz, como servo do meu senhor, e o rapaz suba com seus irmãos. Porque como subirei a meu pai, se o rapaz não estiver comigo? Para que eu não veja o mal que venha a atingir o meu pai!" (Gn 44:31-34)

### A revelação

José não conseguiu mais se controlar: "Fazei sair toda a gente de sobre mim" (Gn 45:1). Chorou tão alto que os egípcios ouviram.

"Eu sou José! Meu pai ainda vive?" (Gn 45:3). Os irmãos ficaram aterrorizados. José os tranquilizou:
...
José abraçou Benjamim e chorou. Depois abraçou todos os irmãos e chorou sobre eles. Faraó ficou satisfeito e convidou a família toda para vir ao Egito.

Jacó, quando soube que José estava vivo, não acreditou. Mas quando viu os carros que José enviou, seu espírito reviveu: "Basta! José, meu filho, ainda vive; irei e verei antes que eu morra" (Gn 45:28).

### A teologia da reconciliação

1. **O arrependimento é real** — os irmãos mudaram; Judá se ofereceu como sacrifício
2. **A graça supera o pecado** — José não guardou rancor; perdoou
3. **A providência divina é soberana** — Deus usou o mal para o bem
4. **A reconciliação exige verdade** — a mentira de 20 anos precisou ser revelada
5. **O perdão liberta** — tanto quem perdoa quanto quem é perdoado`,
          versículosChave: [
            { ref: 'Gênesis 45:5', texto: 'Deus me enviou diante de vós.' },
            { ref: 'Gênesis 45:7', texto: 'Para vos conservar um remanescente na terra.' },
            { ref: 'Gênesis 45:1', texto: 'Eu sou José!' },
          ],
        },
        {
          id: 'genesis-3-4',
          título: 'Jacó no Egito e a bênção final',
          tipo: 'texto',
          duração: '12 min',
          conteúdo: `## Jacó no Egito e a bênção final

Gênesis 46-49 narra a descida de Jacó ao Egito e suas bênçãos finais. É o desfecho da história dos patriarcas — e uma profecia extraordinária sobre o futuro das tribos de Israel.

### A descida ao Egito

Jacó partiu com tudo o que tinha. Em Beer-Sheba, Deus o apareceu em visão: "Não temas de descer ao Egito, porque eu farei de ti ali uma grande nação" (Gn 46:3).

Jacó chegou ao Egito com 70 pessoas (Gn 46:27). José o encontrou em Gessen e chorou sobre o pescoço dele. Jacó disse: "Agora posso morrer, depois que tenho visto o teu rosto, porque ainda vives" (Gn 46:30).

### A família no Egito

A família de Jacó se estabeleceu em Gessen, a melhor terra do Egito. José a administrava com sabedoria — durante a fome, trocou grãos por terras e gado, mas poupou os sacerdotes egípcios.

Jacó viveu 17 anos no Egito. Antes de morrer, fez dois pedidos a José: não o enterrar no Egito, mas na gruta de Macpela, onde Abraão e Sara, Isaque e Rebeca, e Lia estavam enterrados.

### A bênção de Efraim e Manassés

Gênesis 48 registra a bênção de Jacó aos netos — Efraim e Manassés, filhos de José. Jacó cruzou as mãos, colocando a direita sobre Efraim (o mais novo) e a esquerda sobre Manassés (o mais velho).

José tentou corrigir: "Não é assim, meu pai, porque este é o primogênito" (Gn 48:18). Mas Jacó insistiu: "Eu sei, meu filho, eu sei; também este será um povo, e também este será grande; porém o seu irmão mais novo será maior do que ele" (Gn 48:19).

A preferência pelo mais novo é um tema recorrente em Gênesis: Isaque sobre Ismael, Jacó sobre Esaú, Efraim sobre Manassés, José sobre os outros irmãos. Deus não escolhe pelos padrões humanos.

### As bênçãos das doze tribos

Gênesis 49 contém as bênçãos proféticas de Jacó a cada um de seus doze filhos. Algumas são bênçãos verdadeiras; outras são maldições disfarçadas:

**Rúben** — o primogênito, que perdeu sua posição por pecado (Gn 35:22): "Não terás a primogenitura" (Gn 49:3-4).

**Simeão e Levi** — violentos por causa do massacre em Siquém: "Diluirei-os em Jacó e os espalharei em Israel" (Gn 49:5-7). Simeão seria absorvido por Judá; Levi se tornaria a tribo sacerdotal, espalhada por Israel.

**Judá** — recebe a bênção mais importante: "Não se tirará o cetro de Judá, nem o legislador dentre seus pés, até que venha Siló" (Gn 49:10). Essa profecia aponta para Davi e, finalmente, para Cristo — o "Siló" a quem pertence o governo.

**Zebulom** — "Habitarás na praia do mar" (Gn 49:13).

**Dã** — "Será como serpente à beira do caminho" (Gn 49:17).

**Gade** — "Gade, uma tropa o acometerá, mas ele a perseguirá" (Gn 49:19).

**Aser** — "O seu pão será gorduroso" (Gn 49:20).

**Naftali** — "É corça que se solta e dá belos veados" (Gn 49:21).

**José** — recebe a bênção mais extensa: "Ramo frutífero, ramo frutífero junto à fonte" (Gn 49:22-26). José é abençoado com bênçãos dos céus, das profundezas, do sol e da lua.

**Benjamim** — "Lobo que arrebata; de manhã devora a presa" (Gn 49:27).

### A morte de Jacó

"Depois, ordenou a seus filhos: Eu serei recolhido ao meu povo; sepultai-me com meus pais na gruta que está no campo de Efrom, o heteu" (Gn 49:29). Jacó morreu com 147 anos.

José o embalsamou, e os egípcios o prantearam 70 dias. Depois, uma grande procissão levou Jacó à terra de Canaã, onde foi enterrado na gruta de Macpela.

### O significado das bênçãos

As bênçãos de Jacó são proféticas:
- Judá é a tribo real — da qual virão Davi e Jesus
- José é a tribo abençoada — que se dividirá em Efraim e Manassés
- Levi é a tribo sacerdotal — espalhada entre as outras tribos
- As outras tribos têm destinos variados — alguns prósperos, outros difíceis

Gênesis termina com a família de Deus crescendo no Egito — mas ainda não na Terra Prometida. A promessa de Deus continua.`,
          versículosChave: [
            { ref: 'Gênesis 46:3', texto: 'Não temas de descer ao Egito.' },
            { ref: 'Gênesis 49:10', texto: 'Não se tirará o cetro de Judá até que venha Siló.' },
            { ref: 'Gênesis 49:33', texto: 'Jacó deu as últimas instruções a seus filhos e pés na cama e expirou.' },
          ],
        },
        {
          id: 'genesis-3-5',
          título: 'O funeral de José e a promessa',
          tipo: 'texto',
          duração: '10 min',
          conteúdo: `## O funeral de José e a promessa

Gênesis 50 encerra o livro com a morte de José e uma promessa que conecta Gênesis ao Êxodo. É o fim da história dos patriarcas — mas não o fim das promessas de Deus.

### O funeral de José

"José viveu cento e dez anos" (Gn 50:22). Ele viu seus bisnetos e deixou instruções claras antes de morrer:

"Eu morro; mas Deus certamente vos visitará e vos fará subir desta terra para a terra que jurou a Abraão, Isaque e Jacó" (Gn 50:24). José não apenas creu na promessa — instruiu que seus ossos fossem levados quando Israel saísse do Egito.

"José fez jurar os filhos de Israel, dizendo: Deus certamente vos visitará; então fareis subir daqui os meus ossos" (Gn 50:25). José morreu, foi embalsamado e posto num caixão no Egito.

### A promessa não cumprida (ainda)

O livro de Gênesis termina com uma promessa pendente. A família de Jacó está no Egito, mas não na Terra Prometida. Os ossos de José ficam no Egito — aguardando o cumprimento.

Essa promessa se cumpriu séculos depois, no Êxodo: "Moisés levou consigo os ossos de José" (Êxodo 13:19). Mesmo morto, José acreditou na fidelidade de Deus.

### A estrutura de Gênesis

Gênesis se divide em duas grandes partes:
1. **Gênesis 1-11**: A história universal — criação, queda, dilúvio, Babel
2. **Gênesis 12-50**: A história dos patriarcas — Abraão, Isaque, Jacó, José

A primeira parte mostra a necessidade de salvação; a segunda mostra Deus iniciando Seu plano de redenção através de uma família.

### As grandes lições de Gênesis

**1. Deus é o Criador**
O universo não surgiu por acaso. Deus criou tudo com propósito, beleza e ordem. A criação é boa — e nós somos parte dela.

**2. O pecado é real**
A queda destruiu a harmonia original. O pecado não é um conceito abstrato — é uma força real que corrompe tudo o que toca.

**3. Deus é gracioso**
Mesmo após a queda, Deus não abandonou a humanidade. Ele prometeu um Salvador (Gn 3:15) e começou a preparar o caminho.

**4. A fé é o caminho**
Abraão creu e foi justificado. Jacó lutou com Deus. José perseverou na adversidade. A fé — não as obras — é o meio pelo qual nos aproximamos de Deus.

**5. A promessa é segura**
Deus cumpriu Suas promessas a Abraão, Isaque, Jacó e José. Ele cumprirá todas as Suas promessas — incluindo a volta de Cristo.

### O fio condutor

De Gênesis a Apocalipse, a Bíblia conta uma história: **Deus criou, o ser humano caiu, Deus redimirá.** Gênesis planta as sementes que florescem em toda a Escritura — e encontram seu pleno cumprimento em Jesus Cristo.

> "Porque Deus tanto amou o mundo que deu o seu Filho unigênido, para que todo o que nele crê não pereça, mas tenha a vida eterna." — João 3:16`,
          versículosChave: [
            { ref: 'Gênesis 50:24', texto: 'Deus certamente vos visitará.' },
            { ref: 'Êxodo 13:19', texto: 'Moisés levou consigo os ossos de José.' },
            { ref: 'Gênesis 50:20', texto: 'Deus o encaminhou para bem.' },
          ],
        },
        {
          id: 'genesis-quiz-final',
          título: 'Avaliação Final — Gênesis',
          tipo: 'quiz',
          duração: '15 min',
          perguntas: [
            {
              id: 'genesis-q1',
              pergunta: 'O que significa "bara" em hebraico?',
              opções: ['Formar de matéria existente', 'Criar do nada', 'Organizar o caos', 'Separar águas'],
              respostaCorreta: 1,
              explicação: 'Bara é o verbo hebraico usado exclusivamente com Deus como sujeito, significando criar algo novo, do nada (ex nihilo).',
            },
            {
              id: 'genesis-q2',
              pergunta: 'O que significa ser feito "à imagem de Deus"?',
              opções: ['Ter aparência física como Deus', 'Racionalidade, moralidade, relacionamento e domínio', 'Ser imortal', 'Falar idiomas'],
              respostaCorreta: 1,
              explicação: 'A imagem de Deus inclui racionalidade, consciência moral, capacidade de relacionamento e autoridade sobre a criação.',
            },
            {
              id: 'genesis-q3',
              pergunta: 'Qual é a "protoevangelium" — o primeiro anúncio do evangelho?',
              opções: ['Gênesis 1:1', 'Gênesis 3:15', 'Gênesis 12:1', 'Gênesis 22:8'],
              respostaCorreta: 1,
              explicação: 'Gênesis 3:15 promete que a descendência da mulher esmagará a cabeça da serpente — uma profecia sobre Cristo derrotando Satanás.',
            },
            {
              id: 'genesis-q4',
              pergunta: 'Pela fé, o que Abraão ofereceu a Deus?',
              opções: ['Dinheiro', 'O sacrifício de Isaque', 'Ovelhas', 'Incenso'],
              respostaCorreta: 1,
              explicação: 'Hebreus 11:17 diz que Abraão, pela fé, ofereceu Isaque, crendo que Deus poderia ressuscitá-lo.',
            },
            {
              id: 'genesis-q5',
              pergunta: 'O que significa o nome "Israel"?',
              opções: ['Amado de Deus', 'Príncipe de Deus / Aquele que luta com Deus', 'Filho da promessa', 'Pastor fiel'],
              respostaCorreta: 1,
              explicação: 'Israel (Yisra\'el) significa "aquele que luta com Deus" ou "príncipe de Deus" — nome dado a Jacó após a luta no Jiboque.',
            },
            {
              id: 'genesis-q6',
              pergunta: 'Por que José foi vendido como escravo?',
              opções: ['Por dívida', 'Por inveja dos irmãos', 'Por ordem de Deus', 'Por crime cometido'],
              respostaCorreta: 1,
              explicação: 'Os irmãos de José o venderam por inveja, por causa do favoritismo de Jacó e dos sonhos de José.',
            },
            {
              id: 'genesis-q7',
              pergunta: 'Qual foi a resposta de José quando os irmãos temeram sua vingança?',
              opções: ['Eu os perdoarei se me pagarem', 'Vós bem pensastes mal contra mim; Deus o encaminhou para bem', 'Não merecem perdão', 'Esqueci tudo'],
              respostaCorreta: 1,
              explicação: 'Gênesis 50:20: "Vós bem pensastes mal contra mim; porém Deus o encaminhou para bem."',
            },
            {
              id: 'genesis-q8',
              pergunta: 'O que Deus prometeu a Jacó em Betel?',
              opções: ['Riquezas', 'Presença e proteção: "Eis que estou contigo"', 'Um reino', 'Vingança contra Esaú'],
              respostaCorreta: 1,
              explicação: 'Em Betel, Deus prometeu: "Eis que estou contigo e te guardareis por onde quer que fores" (Gn 28:15).',
            },
            {
              id: 'genesis-q9',
              pergunta: 'O que significa o arco-íris na aliança com Noé?',
              opções: ['Beleza da natureza', 'Sinal da aliança de Deus com toda a terra', 'O fim da chuva', 'Alegria'],
              respostaCorreta: 1,
