...
export default function EstudoLivroError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-2">Erro ao carregar Estudo do Livro</h1>
        <p className="text-muted-foreground mb-6">
          Não foi possível carregar o estudo deste livro. Verifique sua conexão e tente novamente.
        </p>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <a href="/" className="px-6 py-3 bg-muted text-muted-foreground rounded-xl font-medium hover:bg-muted/80 transition-colors">
            Ir para o início
          </a>
        </div>
      </div>
