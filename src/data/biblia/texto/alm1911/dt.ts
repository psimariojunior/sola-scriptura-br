const data: Record<number, string[]> = {
  1: [
    `Estas são as palavras que Moysés fallou a todo o Israel d'áquem do Jordão, no deserto, na planicie defronte do Mar de Suph, entre Paran e Tophel, e Laban, e Hazeroth, e Dizahab.`,
    ...
    `Depois que feriu a Sehon, rei dos amorrheos, que habitava em Hesbon, e a Og, rei de Basan, que habitava em Astaroth, em Edrei.`,
    ...
    `Virae-vos, e parti-vos, e ide á montanha dos amorrheos, e a todos os seus visinhos, á planicie, e á montanha, e ao valle, e ao sul, e á ribeira do mar; á terra dos cananeos, e ao Libano, até ao grande rio, o rio Euphrates.`,
    `Vêdes aqui esta terra vol-a dei diante de vós: entrae e possui a terra que o Senhor jurou a vossos paes, Abrahão, Isaac, e Jacob, que a daria a elles e á sua semente depois d'elles.`,
    ...
    `Tomei pois os cabeças de vossas tribus, homens sabios e experimentados, e os tenho posto por cabeças sobre vós, por capitães de milhares, e por capitães de cem, e por capitães de cincoenta, e por capitães de dez, e por governadores das vossas tribus`,
    ...
    `Não attentareis para pessoa alguma em juizo, ouvireis assim o pequeno como o grande: não temereis a face de ninguem, porque o juizo é de Deus; porém a causa que vos fôr difficil fareis vir a mim, e eu a ouvirei.`,
    `Assim n'aquelle tempo vos ordenei todas as coisas que havieis de fazer.`,
    `Então partimos de Horeb, e caminhámos por todo aquelle grande e tremendo deserto que vistes, pelo caminho das montanhas dos amorrheos, como o Senhor nosso Deus nos ordenara: e chegámos a Cades-barnea.`,
    ...
    `Então todos vós vos chegastes a mim, e dissestes: Mandemos homens adiante de nós, para que nos espiem a terra, e nos dêem resposta, por que caminho devemos subir a ella, e a que cidades devemos ir.`,
    ...
    `Para onde subiremos? nossos irmãos fizeram com que se derretesse o nosso coração, dizendo: Maior e mais alto é este povo do que nós, as cidades são grandes e fortificadas até aos céus; e tambem vimos ali filhos dos gigantes.`,
    ...
    `E vossos meninos, de que dissestes: Por presa serão: e vossos filhos, que hoje nem bem nem mal sabem, elles ali entrarão, e a elles, a darei, e elles a possuirão.`,
    `Porém vós virae-vos, e parti para o deserto, pelo caminho do Mar Vermelho.`,
    `Então respondestes, e me dissestes: Peccámos contra o Senhor: nós subiremos e pelejaremos, conforme a tudo o que nos ordenou o Senhor nosso Deus: e armastes-vos pois vós, cada um dos seus instrumentos de guerra, e estivestes prestes para subir á montanha.`,
    ...
    `E os amorrheos, que habitavam n'aquella montanha, vos sairam ao encontro; e perseguiram-vos como fazem as abelhas, e vos derrotaram desde Seir até Horma.`,
  ...
  4: [
    ...
    `Porém vós, que vos che*astes ao Senhor vosso Deus, hoje todos estaes vivos.`,
  ...
  5: [
    `E chamou Moysés a todo o Israel, e disse-lhes: Ouve, ó Israel, os estatutos e juizos que hoje vos fallo aos ouvidos: e aprendel-os-heis, e guardal-os-heis, para os fazer.`,
    ...
    `(N'aquelle tempo eu estava em pé entre o Senhor e vós, para vos notificar a palavra do Senhor: porque temestes o fogo, e não subistes ao monte), dizendo:`,
    ...
    `Não te encurvarás a ellas, nem as servirás: porque Eu, o Senhor teu Deus, sou Deus zeloso, que visito a maldade dos paes sobre os filhos, até á terceira e quarta geração d'aquelles que me aborrecem,`,
    ...
    `Mas o setimo dia é o sabbado do Senhor teu Deus: não farás nenhuma obra n'elle, nem tu, nem teu filho, nem tua filha, nem o teu servo, nem a tua serva, nem o teu boi, nem o teu jumento, nem animal algum teu, nem o estrangeiro que está dentro de tuas portas: para que o teu servo e a tua serva descancem como tu:`,
    `Porque te lembrarás que foste servo na terra do Egypto, e que o Senhor teu Deus te tirou d'ali com mão forte e braço estendido: pelo que o Senhor teu Deus te ordenou que guardasses o dia de sabbado.`,
    ...
    `E dissestes: Eis aqui o Senhor vosso Deus nos fez ver a sua gloria e a sua grandeza, e ouvimos a sua voz do meio do fogo: hoje vimos que Deus falla com o homem, e que o homem fica vivo.`,
    ...
    `Ouvindo pois o Senhor a voz das vossas palavras, quando me fallaveis a mim, o Senhor me disse: Eu ouvi a voz das palavras d'este povo, que te disseram: em tudo fallaram elles bem.`,
  ...
  6: [
    ...
    `Havendo-te pois o Senhor teu Deus indroduzido na terra que jurou a teus paes, Abrahão, Isaac e Jacob, te daria: grandes e boas cidades, que tu não edificaste,`,
  ...
  7: [
    `Quando o Senhor teu Deus te tiver introduzido na terra, a qual vaes a possuir, e tiver lançado fóra muitas gentes de diante de ti, os hetheos, e os girgaseos, e os amorrheos, e os cananeos, e os phereseos, e os heveos, e os jebuseos, sete gentes mais numerosas e mais poderosas do que tu;`,
    ...
    `O Senhor não tomou prazer em vós, nem vos escolheu, porque a vossa multidão era mais do que a de todos os outros povos, pois vós ereis menos em numero do que todos os povos:`,
    ...
    `As imagens d'esculptura de seus deuses queimarás a fogo; a prata e o oiro que estão sobre ellas não cobiçarás, nem os tomarás para ti, para que te não enlaces n'elles; pois abominação é ao Senhor teu Deus.`,
    `Não metterás pois abominação em tua casa, para que não sejas anathema, assim como ella: de todo a detestarás, e de todo a abominarás, porque anathema é.`,
  ],
  8: [
  ...
  9: [
    ...
    `Quando pois o Senhor teu Deus os lançar fóra de diante de ti, não falles no teu coração, dizendo: Por causa da minha justiça é que o Senhor me trouxe a esta terra para a possuir: porque pela impiedade d'estas nações é que o Senhor as lança fóra, diante de ti.`,
    `Não é por causa da tua justiça, nem pela rectidão do teu coração que entras a possuir a sua terra, mas pela impiedade d'estas nações o Senhor teu Deus as lança fóra, de diante de ti; e para confirmar a palavra que o Senhor teu Deus jurou a teus paes, Abrahão, Isaac e Jacob.`,
    ...
    `Subindo eu ao monte a receber as taboas de pedra, as taboas do concerto que o Senhor fizera comvosco, então fiquei no monte quarenta dias e quarenta noites; pão não comi, e agua não bebi;`,
    ...
    `E o Senhor me disse: Levanta-te, desce depressa d'aqui, porque o teu povo, que tiraste do Egypto, já se tem corrompido: cedo se desviaram do caminho que eu lhes tinha ordenado: imagem de fundição para si fizeram.`,
    ...
    `E olhei, e eis-que havieis peccado contra o Senhor vosso Deus; vós tinheis feito um bezerro de fundição: cedo vos desviastes do caminho que o Senhor vos ordenara.`,
    `Então peguei das duas taboas, e as arrojei d'ambas as minhas mãos, e as quebrei aos vossos olhos.`,
    `E me lancei perante o Senhor; como d'antes, quarenta dias e quarenta noites não comi pão e não bebi agua, por causa de todo o vosso peccado que havieis peccado, fazendo mal aos olhos do Senhor, para o provocar á ira`,
    ...
    `Porém eu tomei o vosso peccado, o bezerro que tinheis feito, e o queimei a fogo, e o pisei, moendo-o bem, até que se desfez em pó: e o seu pó lancei no ribeiro que descia do monte.`,
    `Tambem em Taberah, e em Massah, e em Quibroth-hattaava provocastes muito a ira do Senhor.`,
    `Quando tambem o Senhor vos enviou desde Cades-barnea, dizendo: Subi, e possui a terra, que vos tenho dado: rebeldes fostes ao mandado do Senhor vosso Deus, e não o crestes, e não obedecestes á sua voz.`,
    ...
    `Para que o povo da terra d'onde nos tiraste não diga: Porquanto o Senhor os não pode introduzir na terra de que lhes tinha fallado, e porque os aborrecia, os tirou para os matar no deserto:`,
  ...
  11: [
    ...
    `E o que fez a Dathan e a Abiram, filhos de Eliab, filho de Ruben: como a terra abriu a sua bocca e os tragou com as suas casas e com as suas tendas, como tambem tudo o que subsistia, e lhes pertencia, no meio de todo o Israel:`,
    ...
    `Mas a terra que passaes a possuir é terra de montes e de valles: da chuva dos céus beberá as aguas:`,
    ...
    `Porque, se diligentemente guardardes todos estes mandamentos que vos ordeno para os guardardes, amando ao Senhor vosso Deus, andando em todos os seus caminhos, e a elle vos achegardes,`,
    `Tambem o Senhor de diante de vós lançará fóra todas estas nações, e possuireis nações maiores e mais poderosas do que vós`,
    `Todo o logar que pisar a planta do vosso pé será vosso: desde o deserto, e desde o Libano, desde o rio, o rio Euphrates, até ao mar occidental, será o vosso termo.`,
    `Ninguem parará diante de vós: o Senhor vosso Deus porá sobre toda a terra que pisardes o vosso terror e o vosso temor, como já vos tem dito.`,
    ...
    `Porventura não estão elles d'aquem do Jordão, junto ao caminho do pôr do sol, na terra dos cananeos, que habitam na campina defronte do Gilgal, junto aos carvalhaes de Moreh?`,
  ...
  13: [
    ...
    `Após o Senhor vosso Deus andareis, e a elle temereis, e os seus mandamentos guardareis, e a sua voz ouvireis, e a elle servireis, e a elle vos achegareis.`,
    ...
    `D'entre os deuses dos povos que estão em redor de vós, perto ou longe de ti, desde uma extremidade da terra até á outra extremidade;`,
    ...
    `Quando ouvires a voz do Senhor teu Deus, para guardar todos os seus mandamentos, que hoje te ordeno; para fazer o que fôr recto aos olhos do Senhor teu Deus.`,
  ],
  14: [
  ...
  18: [
    ...
    `E, quando vier um levita de alguma das tuas portas, de todo o Israel, onde habitar, e vier com todo o desejo da sua alma ao logar que o Senhor escolheu,`,
    ...
    `Eis lhes suscitarei um propheta do meio de seus irmãos, como tu, e porei as minhas palavras na sua bocca, e elle lhes fallará tudo o que eu lhe ordenar.`,
  ...
  21: [
    ...
    `E os anciãos d'aquella cidade trarão a bezerra a um valle aspero, que nunca foi lavrado nem semeado: e ali, n'aquelle valle, degolarão a bezerra;`,
    ...
    `E será que, se te não contentares d'ella, a deixarás ir á sua vontade; mas de sorte nenhuma a venderás por dinheiro, nem com ella mercadejarás, pois a tens humilhado.`,
    `Quando um homem tiver duas mulheres, uma a quem ama e outra a quem aborrece, e a amada e a aborrecida lhe parirem filhos, e o filho primogenito fôr da aborrecida,`,
    ...
    `E dirão aos anciãos da cidade: Este nosso filho é rebelde e contumaz, não dá ouvidos á nossa voz: é um comilão e beberrão.`,
  ...
  25: [
    ...
    `Então sua cunhada se chegará a elle aos olhos dos anciãos; e lhe descalçará o sapato do pé, e lhe cuspirá no rosto, e protestará, e dirá: Assim se fará ao homem que não edificar a casa de seu irmão:`,
    `E o seu nome se chamará em Israel: A casa do descalçado.`,
    `Quando pelejarem dois homens, um contra o outro, e a mulher d'um chegar para livrar a seu marido da mão do que o fere, e ella estender a sua mão, e lhe pegar pelas suas vergonhas,`,
    ...
    `Será pois que, quando o Senhor teu Deus te tiver dado repouso de todos os teus inimigos em redor, na terra que o Senhor teu Deus te dará por herança, para possuil-a, então apagarás a memoria de Amalek de debaixo do céu: não te esqueças.`,
  ],
  26: [
    `E será que, quando entrares na terra que o Senhor teu Deus te dér por herança, e a possuires, e n'ella habitares,`,
    `Então tomarás das primicias de todos os fructos da terra, que trouxeres da tua terra, que te dá o Senhor teu Deus, e as porás n'um cesto, e irás ao logar que escolher o Senhor teu Deus, para ali fazer habitar o seu nome`,
    ...
    `E dirás perante o Senhor teu Deus: Tirei o que é consagrado de minha casa, e dei tambem ao levita, e ao estrangeiro, e ao orphão e á viuva, conforme a todos os teus mandamentos que me tens ordenado: nada traspassei dos teus mandamentos, nem d'elles me esqueci.`,
    `D'elle não comi na minha tristeza, nem d'elle nada tirei para immundicia, nem d'elle dei para algum morto: obedeci á voz do Senhor meu Deus; conforme a tudo o que me ordenaste, tenho feito.`,
    `Olha desde a tua sancta habitação, desde o céu, e abençoa o teu povo, a Israel, e a terra que nos déste, como juraste a nossos paes, terra que mana leite e mel.`,
    ...
    `Hoje fizeste dizer ao Senhor que te será por Deus, e que andarás nos seus caminhos, e guardarás os seus estatutos, e os seus mandamentos, e os seus juizos, e darás ouvidos á sua voz.`,
  ...
  28: [
    ...
    `O Senhor te abrirá o seu bom thesouro, o céu, para dar chuva á tua terra no seu tempo, e para abençoar toda a obra das tuas mãos; e emprestarás a muitas gentes, porém tu não tomarás emprestado.`,
    ...
    `Será porém que, se não deres ouvidos á voz do Senhor teu Deus, para não cuidares em fazer todos os seus mandamentos e os seus estatutos, que hoje te ordeno, então sobre ti virão todas estas maldições, e te alcançarão:`,
    ...
    `O Senhor mandará sobre ti a maldição; a turbação e a perdição em tudo em que puzeres a tua mão para fazer; até que sejas destruido, e até que repentinamente pereças, por causa da maldade das tuas obras, com que me deixaste.`,
    ...
    `E apalparás ao meio dia, como o cego apalpa na escuridade, e não prosperarás nos teus caminhos: porém sómente serás opprimido e roubado todos os dias, e não haverá quem te salve.`,
    ...
    `O teu boi será morto aos teus olhos, porém d'elle não comerás: o teu jumento será roubado diante de ti, e não voltará a ti: as tuas ovelhas serão dadas aos teus inimigos, e não haverá quem te salve.`,
    ...
    `O fructo da tua terra e todo o teu trabalho comerá um povo que nunca conheceste: e tu serás opprimido e quebrantado todos os dias.`,
    `E serás louco pelo que verás com os teus olhos.`,
    `O Senhor te ferirá com ulceras malignas nos joelhos e nas pernas, de que não possas sarar, desde a planta do teu pé até ao alto da cabeça.`,
    `O Senhor te levará a ti e a teu rei, que tiveres posto sobre ti, a uma gente que não conheceste, nem tu nem teus paes; e ali servirás a outros deuses, ao pau e á pedra.`,
    ...
    `E todas estas maldições virão sobre ti, e te perseguirão, e te alcançarão, até que sejas destruido: porquanto não haverás dado ouvidos á voz do Senhor teu Deus, para guardar os seus mandamentos, e o seus estatutos, que te tem ordenado:`,
    ...
    `E comerá o fructo dos teus animaes, e o fructo da tua terra, até que sejas destruido; e não te deixará grão mosto, nem azeite, creação das tuas vaccas, nem rebanhos das tuas ovelhas, até que te tenha consumido;`,
    ...
    `De sorte que não dará a nenhum d'elles da carne de seus filhos, que elle comer; porquanto nada lhe ficou de resto no cerco e no aperto com que o teu inimigo te apertará em todas as tuas portas.`,
    ...
    `E isto por causa de suas páreas, que sairem d'entre os seus pés, e por causa de seus filhos que parir; porque os comerá ás escondidas pela falta de tudo, no cerco e no aperto com que o teu inimigo te apertará nas tuas portas.`,
    ...
    `E o Senhor te fará voltar ao Egypto em navios, pelo caminho de que te tenho dito: Nunca jámais o verás: e ali sereis vendidos por servos e por servas aos vossos inimigos; mas não haverá quem vos compre.`,
  ],
  29: [
    `Estas são as palavras do concerto que o Senhor ordenou a Moysés na terra de Moab, que fizesse com os filhos de Israel, além do concerto que fizera com elles em Horeb.`,
    ...
    `E aconteça que, ouvindo as palavras d'esta maldição, se abençôe no seu coração, dizendo: Terei paz, ainda que ande conforme ao bom parecer do meu coração; para accrescentar á sêde a bebedice`,
    ...
    `E toda a sua terra abrazada com enxofre e sal, de sorte que não será semeada, e nada produzirá, nem n'ella crescerá herva alguma: assim como foi a destruição de Sodoma e de Gomorrha, de Adama e de Zeboim, que o Senhor destruiu na sua ira e no seu furor`,
    ...
    `As coisas encobertas são para o Senhor nosso Deus; porém as reveladas são para nós e para nossos filhos para sempre, para fazer todas as palavras d'esta lei`,
  ],
  30: [
    ...
    `Então eu vos denuncio hoje que, certamente, perecereis: não prolongareis os dias na terra a que vaes, passando o Jordão, para que, entrando n'ella, a possuas;`,
    ...
    `Amando ao Senhor teu Deus, dando ouvidos á sua voz, e te achegando a elle: pois elle é a tua vida, e a longura dos teus dias; para que fiques na terra que o Senhor jurou a teus paes, a Abrahão, a Isaac, e a Jacob, que lhes havia de dar.`,
  ],
  31: [
    ...
    `Esforçae-vos, e animae-vos; não temaes, nem vos espanteis diante d'elles: porque o Senhor teu Deus é o que vae comtigo: não te deixará nem te desamparará.`,
    `E chamou Moysés a Josué, e lhe disse aos olhos de todo o Israel: Esforça-te e anima-te; porque com este povo entrarás na terra que o Senhor jurou a teus paes lhes dar; e tu os farás herdal-a.`,
    ...
    `Ajunta o povo, homens, e mulheres, e meninos, e os teus estrangeiros que estão dentro das tuas portas, para que ouçam, e aprendam e temam ao Senhor vosso Deus, e tenham cuidado de fazer todas as palavras d'esta lei;`,
    ...
    `E disse o Senhor a Moysés: Eis-que os teus dias são chegados, para que morras; chama a Josué, e ponde-vos na tenda da congregação, para que eu lhe dê ordem. Assim foi Moysés e Josué, e se puzeram na tenda da congregação.`,
    `Então o Senhor appareceu na tenda, na columna de nuvem; e a columna de nuvem estava sobre a porta da tenda.`,
    `E disse o Senhor a Moysés: Eis que dormirás com teus paes: e este povo se levantará, e fornicará em seguimento dos deuses dos estranhos da terra, para o meio dos quaes vae, e me deixará, e annullará o meu concerto que tenho feito com elle.`,
    `Assim se accenderá a minha ira n'aquelle dia contra elle, e desamparal-o-hei, e esconderei o meu rosto d'elles, para que sejam devorados: e tantos males e angustias o alcançarão, que dirá n'aquelle dia: Não me alcançaram estes males, porquanto o meu Deus não está no meio de mim?`,
    ...
    `Porque o metterei na terra que jurei a seus paes, que mana leite e mel; e comerá, e se fartará, e se engordará: então se tornará a outros deuses, e os servirá, e me irritarão, e annullarão o meu concerto.`,
    `E será que, quando o alcançarem muitos males e angustias, então este cantico responderá contra elle por testemunha, pois não será esquecido da bocca de sua semente; porquanto conheço a sua boa imaginação, o que elle faz hoje, antes que o metta na terra que tenho jurado.`,
    ...
    `Porque conheço a tua rebellião e a tua dura cerviz: eis que, vivendo eu ainda hoje comvosco, rebeldes fostes contra o Senhor; e quanto mais depois da minha morte.`,
    `Ajuntae perante mim todos os anciãos das vossas tribus, e vossos officiaes, e aos vossos ouvidos fallarei estas palavras, e contra elles por testemunhas tomarei os céus e a terra.`,
    `Porque eu sei que depois da minha morte certamente vos corrompereis, e vos desviareis do caminho que vos ordenei: então este mal vos alcançará nos ultimos dias, quando fizerdes mal aos olhos do Senhor, para o provocar á ira com a obra das vossas mãos.`,
  ...
  32: [
    ...
    `Achou-o na terra do deserto, e n'um ermo solitario cheio de uivos; trouxe-o ao redor, instruiu-o, guardou-o como a menina do seu olho.`,
    `Como a aguia desperta o seu ninho, se move sobre os seus filhos, estende as suas azas, toma-os, e os leva sobre as suas azas,`,
    `Assim só o Senhor o guiou: e não havia com elle deus estranho.`,
    `Elle o fez cavalgar sobre as alturas da terra, e comeu as novidades do campo, e o fez chupar mel da rocha e azeite da dura pederneira,`,
    `Manteiga de vaccas, e leite do rebanho, com a gordura dos cordeiros e dos carneiros que pastam em Basan, e dos bodes, com gordura dos rins do trigo; e bebeste o sangue das uvas, o vinho puro.`,
    ...
    `A zelos me provocaram com aquillo que não é Deus; com as suas vaidades me provocaram á ira; portanto eu os provocarei a zelos com os que não são povo; com nação louca os despertarei á ira.`,
    `Porque um fogo se accendeu na minha ira, e arderá até ao mais profundo do inferno, e consummirá a terra com a sua novidade, e abrazará os fundamentos dos montes.`,
    `Males amontoarei sobre elles; as minhas settas esgotarei contra elles.`,
    `Exhaustos serão de fome, comidos de carbunculo e de peste amarga: e entre elles enviarei dentes de feras, com ardente peçonha de serpentes do pó.`,
    ...
    `Porque a sua vinha é a vinha de Sodoma e dos campos de Gomorrha: as suas uvas são uvas de fel, cachos amargosos teem.`,
    ...
    `Vêde agora que Eu, Eu O sou, e mais nenhum Deus comigo: Eu mato, e Eu faço viver: Eu firo, e Eu saro: e ninguem ha que escape da minha mão.`,
    ...
    `Jubilae, ó nações, com o seu povo, porque vingará o sangue dos seus servos, e sobre os seus adversarios fará tornar a vingança, e terá misericordia da sua terra e do seu povo.`,
    ...
    `Porque esta palavra não vos é vã, antes é a vossa vida; e por esta mesma palavra prolongareis os dias na terra a que passaes o Jordão a possuil-a.`,
    ...
    `Porquanto traspassastes contra mim no meio dos filhos de Israel, ás aguas da contenção em Cades, no deserto de Zin: pois me não sanctificastes no meio doe filhos de Israel.`,
  ...
  33: [
    ...
    `Disse pois: O Senhor veiu de Sinai, e lhes subiu de Seir; resplandeceu desde o monte Paran, e veiu com dez milhares de sanctos: á sua direita havia para elles o fogo da lei.`,
    ...
    `E com o mais excellente da terra, e com a sua plenidão, e com a benevolencia d'aquelle que habitava na sarça, a benção venha sobre a cabeça de José, e sobre o alto da cabeça do que foi separado de seus irmãos`,
    `Elle tem a gloria do primogenito do seu boi, e as suas pontas são pontas de unicornio: com elles escorneará os povos juntamente até ás extremidades da terra: estes pois são os dez milhares de Ephraim, e estes são os milhares de Manasseh.`,
  ...
  34: [
    ...
    `E todo Naphtali, e a terra d'Ephraim, e Manasseh; e toda a terra de Judah, até ao mar ultimo;`,
    `E o sul, e a campina do valle de Jericó, a cidade das palmeiras até Zoar.`,
    `E disse-lhe o Senhor: Esta é a terra de que jurei a Abrahão, Isaac, e Jacob, dizendo: Á tua semente a darei: mostro-t'a para a veres com os teus olhos; porém lá não passarás.`,
    ...
    `E Josué, filho de Nun, foi cheio do espirito de sabedoria, porquanto Moysés tinha posto sobre elle as suas mãos: assim os filhos d'Israel lhe deram ouvidos, e fizeram como o Senhor ordenara a Moysés.`,
