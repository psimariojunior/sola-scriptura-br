const data: Record<number, string[]> = {
  1: [
    ...
    `A religião pura e não contaminada para com Deus e Pai é esta: visitar os órfãos e as viúvas nas suas aflições, e guardar a si mesmo sem a corrupção do mundo.`,
  ],
  2: [
