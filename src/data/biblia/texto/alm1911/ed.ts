const data: Record<number, string[]> = {
  1: [
    `No primeiro anno de Cyro, rei da Persia (para que se cumprisse a palavra do Senhor, por bocca de Jeremias) despertou o Senhor o espirito de Cyro, rei da Persia o qual fez passar pregão por todo o seu reino, como tambem por escripto, dizendo:`,
    ...
    `E todo aquelle que ficar atraz em alguns logares em que andar peregrinando, os homens do seu logar o ajudarão com prata, e com oiro, e com fazenda, e com gados, afóra das dadivas voluntarias para a casa do Senhor, que habita em Jerusalem.`,
  ...
  5: [
    ...
    `Porém os olhos de Deus estavam sobre os anciãos dos judeos, e não os impediram, até que o negocio viesse a Dario, e então respondessem por carta sobre isso`,
    ...
    `E até os vasos de oiro e prata, da casa de Deus, que Nabucodonosor tomou do templo que estava em Jerusalem e os metteu no templo de Babylonia, o rei Cyro os tirou do templo de Babylonia, e foram dados a um homem cujo nome era Sesbazar, a quem nomeou governador.`,
    ...
    `Agora, pois, se parece bem ao rei, busque-se lá na casa dos thesouros do rei, que está em Babylonia, se é verdade que se deu uma ordem pelo rei Cyro para edificar esta casa de Deus em Jerusalem; e sobre isto se nos manda saber a vontade do rei."`,
  ],
  6: [
    ...
    `Agora pois Tattenai, governador de além do rio, Sethar-boznai, e os seus companheiros, os apharsachitas, que estaes de além do rio, apartae-vos d'ali.`,
    ...
    `Tambem por mim se decreta o que haveis de fazer com os anciãos dos judeos, para edificar esta casa de Deus, a saber: que da fazenda do rei dos tributos d'além do rio se dê promptamente a despeza a estes homens, para que não sejam impedidos.`,
    `E o que fôr necessario, como bezerros, e carneiros, e cordeiros, por holocausto ao Deus dos céus, trigo, sal, vinho e azeite, segundo o rito dos sacerdotes que estão em Jerusalem; e dê-se-lhes, de dia em dia, para que não haja falta.`,
    ...
    `Então Tattenai, o governador de além do rio, Sethar-boznai e os seus companheiros, assim fizeram apressuradamente, conforme ao que decretara o rei Dario.`,
    `E os anciãos dos judeos iam edificando e prosperando pela prophecia do propheta Aggeo, e de Zacharias, filho d'Iddo: e a edificaram e aperfeiçoaram conforme ao mandado do Deus de Israel, e conforme ao mandado de Cyro e Dario, e d'Artaxerxes rei da Persia.`,
    ...
    `Porque os sacerdotes e levitas se purificaram como se fossem um só homem, todos estavam limpos: e mataram o cordeiro da paschoa para todos os filhos do captiveiro, e para seus irmãos, os sacerdotes, e para si mesmos.`,
    `Assim comeram os filhos d'Israel que tinham voltado do captiveiro, com todos os que a elles se apartaram da immundicia das gentes da terra, para buscarem o Senhor, Deus d'Israel:`,
  ...
  9: [
    `Acabadas pois estas coisas, chegaram-se a mim os principes, dizendo: O povo de Israel, e os sacerdotes, e os levitas, se não teem separado dos povos d'estas terras; segundo as suas abominações, a saber: dos cananeos, dos hetheos, dos pherezeos, dos jebuseos, dos amonitas, dos moabitas, dos egypcios, e dos amorrheos.`,
    ...
    `Desde os dias de nossos paes até ao dia de hoje estamos em grande culpa, e por causa das nossas iniquidades somos entregues, nós, os nossos reis, e os nossos sacerdotes, na mão dos reis das terras, á espada, ao captiveiro, e ao roubo, e á confusão do rosto, como hoje se vê`,
    `E agora, como por um pequeno momento, se nos fez graça da parte do Senhor, nosso Deus, para nos deixar aquelles que escapem, e para dar-nos uma estaca no seu sancto logar: para nos alumiar os olhos, ó Deus nosso, e para nos dar uma pouca de vida na nossa servidão;`,
    `Porque servos somos; porém na nossa servidão não nos desamparou o nosso Deus; antes estendeu sobre nós beneficencia perante os reis da Persia, para que nos desse vida, para levantarmos a casa do nosso Deus, e para restaurarmos as suas assolações; e para que nos desse uma parede em Judah e em Jerusalem.`,
    `Agora pois, ó nosso Deus, que diremos depois d'isto? pois deixámos os teus mandamentos,`,
    `Os quaes mandaste pelo ministerio de teus servos, os prophetas, dizendo: A terra em que entraes para a possuir, terra immunda é pelas immundicias dos povos das terras, pelas suas abominações com que a encheram, d'uma extremidade á outra, com a sua immundicia.`,
    ...
    `E depois de tudo o que nos tem succedido por causa das nossas más obras, e da nossa grande culpa: porquanto tu, ó nosso Deus, estorvaste que fossemos destruidos, por causa da nossa iniquidade, e ainda nos deste livramento como este;`,
