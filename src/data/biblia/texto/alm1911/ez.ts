const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Então entrou em mim o espirito, fallando elle comigo, que me poz sobre os meus pés, e ouvi o que me fallava.`,
    ...
    `E tu, ó filho do homem, não os temas, nem temas as suas palavras; ainda que são sarças e espinhos para comtigo, e tu habites com escorpiões, não temas as suas palavras, nem te assustes com os seus rostos, porque casa rebelde são elles.`,
  ...
  5: [
    ...
    `A terça parte queimarás no fogo, no meio da cidade, quando se cumprirem os dias do cerco: então tomarás outra terça parte, e feril-a-has com uma espada ao redor d'ella; e a outra terça parte espalharas ao vento; porque desembainharei a espada atraz d'elles.`,
    ...
    `Porém ella mudou em impiedade os meus juizos, mais do que as nações, e os meus estatutos mais do que as terras que estão ao redor d'ella; porque rejeitaram os meus juizos, e não andaram nos meus preceitos.`,
    ...
    `E o opprobrio e a infamia servirão de instrucção e espanto ás nações que estão em redor de ti, quando eu executar em ti juizos com ira, e com furor, e com sanhudos castigos: Eu, o Senhor, fallei`,
    ...
    `E enviarei sobre vós a fome, e as más bestas que te desfilharão; e a peste e o sangue passarão por ti; e trarei a espada sobre ti: Eu, o Senhor, fallei.`,
  ],
  6: [
    ...
    `E dirás: Montes d'Israel, ouvi a palavra do Senhor Jehovah: Assim diz o Senhor Jehovah aos montes, aos outeiros, aos ribeiros e aos valles: Eis que eu, sim eu, trarei a espada sobre vós, e destruirei os vossos altos.`,
    ...
    `Em todas as vossas habitações as cidades serão destruidas, e os altos assolados; para que os vossos altares sejam destruidos e assolados, e os vossos idolos se quebrem e cessem, e as vossas imagens do sol sejam cortadas, e desfeitas as vossas obras.`,
    ...
    `Então se lembrarão de mim os que escaparem de vós entre as nações para onde foram levados em captiveiro; porquanto me quebrantei por causa do seu coração fornicario, que se desviou de mim, e por causa dos seus olhos, que andaram fornicando após os seus idolos; e terão nojo de si mesmos, por causa das maldades que fizeram em todas as suas abominações.`,
    ...
    `O que estiver longe morrerá de peste, e o que está perto cairá á espada; e o que ficar de resto e cercado morrerá de fome: e cumprirei o meu furor contra elles.`,
    `Então sabereis que eu sou o Senhor, quando estiverem os seus traspassados no meio dos seus idolos, em redor dos seus altares, em todo o outeiro alto, em todos os cumes dos montes, e debaixo de toda a arvore verde, e debaixo de todo o carvalho espesso, no logar onde offereciam perfume de cheiro suave a todos os seus idolos.`,
    `E estenderei a minha mão sobre elles, e farei a terra assolada, e mais assolada do que o deserto da banda de Diblath, em todas as suas habitações: e saberão que eu sou o Senhor.`,
  ],
  7: [
    ...
    `E não te poupará o meu olho, nem me apiedarei de ti, mas porei sobre ti os teus caminhos, e as tuas abominações estarão no meio de ti: e sabereis que eu sou o Senhor.`,
    `Assim diz o Senhor Jehovah: Um mal, eis que um só mal vem.`,
    `Vem o fim, o fim vem, despertou-se contra ti; eis que vem.`,
    `Vem a manhã a ti, ó habitador da terra. Vem o tempo; chegado é o dia da turbação, e não ha echo nos montes.`,
    ...
    `E não te poupará o meu olho, nem me apiedarei de ti; conforme os teus caminhos carregarei sobre ti, e as tuas abominações estarão no meio de ti; e sabereis que eu sou o Senhor, que firo`,
    ...
    `A sua prata lançarão pelas ruas, e o seu oiro será como immundicia; nem a sua prata nem o seu oiro os poderá livrar no dia do furor do Senhor: não fartarão elles a sua alma, nem lhes encherão as entranhas, porque isto foi o tropeço da sua maldade`,
    ...
    `O rei lamentará, e o principe se vestirá de assolação, e as mãos do povo da terra se conturbarão; conforme o seu caminho lhes farei, e com os seus juizos os julgarei; e saberão que eu sou o Senhor`,
  ],
  8: [
    ...
    `E estendeu a fórma d'uma mão, e me tomou pelos cabellos da minha cabeça; e o Espirito me levantou entre a terra e o céu, e me trouxe a Jerusalem em visões de Deus, até á entrada da porta do pateo de dentro, que olha para o norte, onde estava o assento da imagem dos ciumes, que provoca a ciumes`,
    ...
    `E disse-me: Filho do homem, vês tu o que elles estão fazendo? as grandes abominações que a casa d'Israel faz aqui, para que me alongue do meu sanctuario? porém ainda tornarás a vêr maiores abominações.`,
    `E levou-me á porta do atrio: então olhei, e eis que havia um buraco na parede.`,
    `E disse-me: Filho do homem, cava agora n'aquella parede. E cavei na parede, e eis que havia uma porta.`,
    ...
    `E setenta homens dos anciãos da casa de Israel, com Jaazanias, filho de Saphan, que estava no meio d'elles, estavam em pé diante d'elles, e cada um tinha na mão o seu incensario; e subia uma espessa nuvem de incenso.`,
    ...
    `E levou-me para o atrio interior da casa do Senhor, e eis que estavam á entrada do templo do Senhor, entre o portico e o altar, quasi vinte e cinco homens, voltadas as costas para o templo do Senhor, e virados os rostos para o oriente; e elles adoravam o sol virados para o oriente.`,
    `Então me disse: Viste isto, filho do homem? ha porventura coisa mais leviana para a casa de Judah, do que fazer taes abominações, que fazem aqui? havendo enchido a terra de violencia, tornam a irritar-me; porque eis que elles chegam o ramo ao nariz.`,
  ...
  10: [
    ...
    `Então se levantou a gloria do Senhor de sobre o cherubim para o umbral da casa; e encheu-se a casa d'uma nuvem, e o atrio se encheu do resplandor da gloria do Senhor.`,
    ...
    `Então estendeu um cherubim a sua mão de entre os cherubins para o fogo que estava entre os cherubins; e o tomou, e o poz nas mãos do que estava vestido de linho; o qual o tomou, e saiu.`,
  ...
  11: [
    `Então me levantou o Espirito, e me levou á porta oriental da casa do Senhor, que olha para o oriente; e eis que estavam á entrada da porta vinte e cinco homens; e no meio d'elles vi a Jaazanias, filho de Azus, e a Pelatias, filho de Benaias, principes do povo.`,
    ...
    `Esta cidade não vos servirá de caldeira, nem vós servireis de carne no meio d'ella: nos confins d'Israel vos julgarei.`,
    `E sabereis que eu sou o Senhor, porque nos meus estatutos não andastes, nem fizestes os meus juizos; antes fizestes conforme os juizos das nações que estão em redor de vós`,
    ...
    `Filho do homem, teus irmãos, sim, teus irmãos, os homens de teu parentesco, e toda a casa de Israel, todos elles, são aquelles a quem os habitantes de Jerusalem disseram: Apartae-vos para longe do Senhor; esta terra se nos deu em possessão.`,
  ...
  16: [
    ...
    `Eu te fiz multiplicar como o renovo do campo, e cresceste, e te engrandeceste, e chegaste á grande formosura: avultaram os peitos, e brotou o teu pello; porém estavas nua e descoberta.`,
    ...
    `E assim foste ornada de oiro e prata, e o teu vestido foi de linho fino, e de seda e bordadura: nutriste-te de flor de farinha, e mel e oleo; e foste formosa em extremo, e foste prospera, até chegares a ser rainha.`,
    ...
    `E tomaste dos teus vestidos, e fizeste logares altos enfeitados, de diversas côres, e fornicaste sobre elles: taes coisas não vieram, nem hão de vir.`,
    ...
    `Assim diz o Senhor Jehovah: Porquanto se derramou o teu dinheiro, e se descobriu a tua nudez nas tuas fornicações com os teus amantes, como tambem com todos os idolos das tuas abominações, e no sangue de teus filhos que lhes deste:`,
    `Portanto, eis que ajuntarei a todos os teus amantes, com os quaes te misturaste, como tambem a todos os que amaste, com todos os que aborreceste, e ajuntal-os-hei contra ti em redor, e descobrirei a tua nudez diante d'elles, para que vejam toda a tua nudez.`,
    ...
    `E entregar-te-hei nas suas mãos, e derribarão a tua abobada, e transtornarão os teus altos logares, e te despirão os teus vestidos, e tomarão as tuas joias de enfeite, e te deixarão nua e descoberta.`,
    ...
    `Porquanto não te lembraste dos dias da tua mocidade, e me provocaste á ira com tudo isto: pelo que, eis que tambem eu farei recair o teu caminho sobre a tua cabeça, diz o Senhor Jehovah, e não farás tal enormidade de mais sobre todas as tuas abominações.`,
    ...
    `Eis que esta foi a maldade de Sodoma, tua irmã; soberba, fartura de pão, e abundancia de ociosidade teve ella e suas filhas, porém nunca esforçou a mão do pobre e do necessitado.`,
    ...
    `Tu pois tambem leva a tua vergonha, tu que julgaste a tuas irmãs, pelos teus peccados, que fizeste mais abominaveis do que ellas; mais justas são do que tu: envergonha-te logo tambem, e leva a tua vergonha, pois justificaste a tuas irmãs.`,
    ...
    `Quando tuas irmãs, Sodoma e suas filhas, tornarem ao seu primeiro estado, e tambem Samaria e suas filhas tornarem ao seu primeiro estado, tambem tu e tuas filhas tornareis ao vosso primeiro estado.`,
    `Nem até Sodoma, tua irmã, foi ouvida na tua bocca, no dia das tuas soberbas,`,
    `Antes que se descobrisse a tua maldade, como no tempo do desprezo das filhas da Syria, e de todos os que estavam ao redor d'ella, as filhas dos philisteos, que te desprezavam em redor.`,
    ...
    `Então te lembrarás dos teus caminhos, e te confundirás, quando receberes tuas irmãs maiores do que tu, com as menores do que tu, porque t'as darei por filhas, porém não pelo teu concerto.`,
  ...
  17: [
    ...
    `E houve mais uma grande aguia, de grandes azas, e cheia de pennas; e eis que esta videira lançou para ella as suas raizes, e estendeu para ella os seus ramos, para que a regasse pelas aréolas do seu plantio.`,
    ...
    `Dize: Assim diz o Senhor Jehovah: Porventura prosperará? ou não lhe arrancará as suas raizes, e não cortará o seu fructo, e seccar-se-ha? em todas as folhas de seus renovos se seccará, e isto não com braço grande, nem com muita gente, para a arrancar pelas suas raizes.`,
    ...
    `Então veiu a mim a palavra do Senhor, dizendo:`,
    `Dize agora á casa rebelde: Porventura não sabeis o que querem dizer estas coisas? dize: Eis que veiu o rei de Babylonia a Jerusalem, e tomou o seu rei e os seus principes, e os levou comsigo para Babylonia;`,
    ...
    `Porém se rebellou contra elle, enviando os seus mensageiros ao Egypto, para que se lhe mandassem cavallos e muita gente: porventura prosperará ou escapará aquelle que faz taes coisas? ou quebrantará o concerto, e ainda escapará?`,
    `Vivo eu, diz o Senhor Jehovah, que morrerá em logar do rei que o fez reinar, cujo juramento desprezou, e cujo concerto quebrantou; com elle no meio de Babylonia morrerá.`,
    `E Pharaó, nem com grande exercito, nem com uma companhia numerosa, nada acabará com elle em guerra, levantando tranqueiras e edificando baluartes, para destruir muitas vidas.`,
    ...
    `Assim diz o Senhor Jehovah: Tambem eu tomarei do cucuruto do cedro alto, e o plantarei; do principal dos seus renovos cortarei o mais tenro, e o plantarei sobre um monte alto e sublime.`,
    `No monte alto d'Israel o plantarei, e produzirá ramos, e dará fructo, e se fará um cedro excellente; e habitarão debaixo d'elle todas as aves de toda a sorte de azas, e á sombra dos seus ramos habitarão.`,
    `Assim saberão todas as arvores do campo que eu, o Senhor, abaixei a arvore alta, alcei a arvore baixa, sequei a arvore verde, e fiz reverdecer a arvore secca: eu, o Senhor, o fallei, e o farei.`,
  ],
  18: [
    `E veiu a mim a palavra do Senhor, dizendo:`,
    ...
    `E se não opprimir a ninguem, tornando ao devedor o seu penhor, e se não fizer roubo, se der o seu pão ao faminto, e cobrir ao nú com vestido,`,
    ...
    `Opprimir ao afflicto e necessitado, fizer roubos, não tornar o penhor, e levantar os seus olhos para os idolos, e fizer abominação,`,
    ...
    `Desviar do afflicto a sua mão, não receber usura em demasia, fizer os meus juizos, e andar nos meus estatutos, o tal não morrerá pela maldade de seu pae; certamente viverá.`,
    `Seu pae, porquanto fez oppressão, roubou os bens do irmão, e fez o que não era bom no meio de seu povo, eis que elle morrerá pela sua maldade.`,
    ...
    `A alma que peccar, essa morrerá: o filho não levará a maldade do pae, nem o pae levará a maldade do filho: a justiça do justo será sobre elle, e a impiedade do impio será sobre elle.`,
  ...
  21: [
    ...
    `E será que, quando elles te disserem: Porque suspiras tu? dirás: Pela fama, porque já vem; e todo o coração desmaiará, e todas as mãos se enfraquecerão, e todo o espirito se angustiará, e todos os joelhos se desfarão em aguas; eis que já vem, e se fará, diz o Senhor Jehovah.`,
    `E veiu a mim a palavra do Senhor, dizendo:`,
    `Filho do homem, prophetiza, e dize: Assim diz o Senhor: dize: A espada, a espada está afiada, e tambem açacalada.`,
    `Para matar com grande matança está afiada, para reduzir está açacalada: alegrar-nos-hemos pois? a vara de meu filho é que despreza todo o madeiro.`,
    ...
    `Porque o rei de Babylonia parará na encruzilhada, no cimo dos dois caminhos, para usar de adivinhações: aguçará as suas frechas, consultará os terafins, attentará para o figado`,
    ...
    `Portanto assim diz o Senhor Jehovah: Porquanto me fazeis lembrar da vossa maldade, descobrindo-se as vossas prevaricações, apparecendo os vossos peccados em todos os vossos tratos, porquanto viestes em memoria, sereis apanhados na mão.`,
    ...
    `Ao revéz, ao revéz, ao revéz porei aquella corôa, e ella mais não será, até que venha aquelle a quem pertence de direito, e a elle a darei.`,
    ...
    `Entretanto que te vêem vaidade, entretanto que te adivinham mentira, para te pôrem aos pescoços dos traspassados pelos impios, cujo dia virá no tempo da extrema maldade.`,
  ...
  22: [
    ...
    `Pelo teu sangue que derramaste te fizeste culpada, e pelos teus idolos que fabricaste te contaminaste, e fizeste chegar os teus dias, e vieste aos teus annos; por isso eu te fiz o opprobrio das nações e o escarneo de todas as terras.`,
    ...
    `Tambem um fez abominação com a mulher do seu proximo, e outro contaminou abominavelmente a sua nora, e outro humilhou no meio de ti a sua irmã, filha de seu pae.`,
    ...
    `Como se ajuntam a prata, e o bronze, e o ferro, e o chumbo, e o estanho, no meio do forno, para assoprar o fogo sobre elles, para fundir, assim vos ajuntarei na minha ira e no meu furor, e ali vos deixarei e fundirei.`,
    `E congregar-vos-hei, e assoprarei sobre vós o fogo do meu furor; e sereis fundidos no meio d'ella.`,
    `Como se funde a prata no meio do forno, assim sereis fundidos no meio d'ella; e sabereis que eu, o Senhor, derramei o meu furor sobre vós.`,
    `E veiu a mim a palavra do Senhor, dizendo:`,
    ...
    `Os seus sacerdotes violentam a minha lei, e profanam as minhas coisas sagradas; entre o sancto e o profano não fazem differença, nem discernem o impuro do puro; e de meus sabbados escondem os seus olhos, e assim sou profanado no meio d'elles.`,
  ...
  24: [
    ...
    `Eu, o Senhor, o fallei; virá, e o farei: não me tornarei atraz, e não pouparei, nem me arrependerei; conforme os teus caminhos, e conforme os teus tratos, te julgarão, diz o Senhor Jehovah.`,
    `E veiu a mim a palavra do Senhor, dizendo:`,
    ...
    `Dize á casa de Israel: Assim diz o Senhor Jehovah: Eis que eu profanarei o meu sanctuario, a gloria da vossa fortaleza, o desejo dos vossos olhos, e o regalo das vossas almas; e vossos filhos e vossas filhas, que deixastes, cairão á espada.`,
    `E fareis como eu fiz: não vos rebuçareis, e não comereis o pão dos homens.`,
    `E tereis nas cabeças os vossos turbantes, e os vossos sapatos nos pés; não lamentareis, nem chorareis, mas definhar-vos-heis nas vossas maldades, e dareis gemidos uns com os outros.`,
    `Assim vos servirá Ezequiel de signal; conforme tudo quanto fez fareis: vendo isto, então sabereis que eu sou o Senhor Jehovah.`,
    ...
    `N'aquelle dia abrir-se-ha a tua bocca para com aquelle que escapar, e fallarás, e mais não ficarás mudo: assim lhes virás a ser um signal maravilhoso, e saberão que eu sou o Senhor.`,
  ],
  25: [
    `E veiu a mim a palavra do Senhor, dizendo:`,
  ...
  26: [
    ...
    `Porque assim diz o Senhor Jehovah: Eis que eu trarei contra Tyro a Nabucodonosor, rei de Babylonia, desde o norte, o rei dos reis, com cavallos, e com carros, e com cavalleiros, e companhias, e muito povo.`,
    ...
    `Assim diz o Senhor Jehovah a Tyro: Porventura não tremerão as ilhas com o estrondo da tua queda, quando gemerem os traspassados, quando se fizer uma espantosa matança no meio de ti`,
    `E todos os principes do mar descerão dos seus thronos, e tirarão de si os seus mantos, e despirão os seus vestidos bordados: de tremores se vestirão, sobre a terra se assentarão, e estremecerão a cada momento; e em ti pasmarão.`,
    `E levantarão uma lamentação sobre ti, e te dirão: Como pereceste do mar, ó bem povoada e afamada cidade, que foste forte no mar; ella e os seus moradores, que atemorizaram a todos os moradores d'ella!`,
    ...
    `Então te farei descer com os que descem á cova, ao povo antigo, e te deitarei nas mais baixas partes da terra, em logares desertos antigos, com os que descem á cova, para que não sejas habitada; e estabelecerei a gloria na terra dos viventes.`,
  ...
  27: [
    ...
    `Linho fino bordado do Egypto era a tua cortina, para te servir de vela; azul e purpura das ilhas d'Elisa era a tua cobertura.`,
    ...
    `Os filhos de Arvad e o teu exercito estavam sobre os teus muros em redor, e os gamaditas sobre as tuas torres: penduravam os seus escudos nos teus muros em redor; elles aperfeiçoavam a tua formosura.`,
    ...
    `As tuas fazendas e as tuas feiras, o teu negocio, os teus marinheiros, e os teus pilotos, os que concertavam as tuas fendas, e os que faziam os teus negocios, e todos os teus soldados, que estão em ti, juntamente com toda a tua congregação, que está no meio de ti, cairão no meio dos mares no dia da tua queda.`,
  ...
  29: [
    ...
    `Falla, e dize: Assim diz o Senhor Jehovah: Eis-me contra ti, ó Pharaó, rei do Egypto, o grande dragão, que pousa no meio dos seus rios, e que diz: O meu rio é meu, e eu o fiz para mim`,
    ...
    `E te deixarei no deserto, a ti e a todo o peixe dos teus rios; sobre a face do campo cairás: não serás recolhido nem ajuntado: aos animaes da terra e ás aves do céu te dei por mantimento.`,
    `E saberão todos os moradores do Egypto que eu sou o Senhor, porquanto se fizera um bordão de canna para a casa d'Israel.`,
    `Tomando-te elles pela tua mão, te quebrantaste, e lhes rasgaste todo o hombro, e, encostando-se elles a ti, te quebraste, e lhes fizeste estar immoveis a todos os lombos.`,
    ...
    `E não servirá mais á casa d'Israel de confiança, para lhe trazer á lembrança a sua iniquidade, quando olharem para traz d'elles; antes saberão que eu sou o Senhor Jehovah.`,
    `E succedeu que, no anno vinte e sete, no mez primeiro, no primeiro dia do mez, veiu a mim a palavra do Senhor, dizendo:`,
    `Filho do homem, Nabucodonozor, rei de Babylonia, fez com que o seu exercito prestasse um grande serviço contra Tyro; toda a cabeça se tornou calva, e todo o hombro se pelou: e não houve paga de Tyro para ella, nem para o seu exercito, pelo serviço que prestou contra ella.`,
    `Portanto, assim diz o Senhor Jehovah: Eis que eu darei a Nabucodonozor, rei de Babylonia, a terra do Egypto; e levará a sua multidão, e despojará o seu despojo, e roubará a sua preza, e isto será a paga para o seu exercito.`,
  ...
  31: [
    ...
    `E uns estranhos o exterminaram, os mais formidaveis das nações, e o deixaram: cairam os seus ramos sobre os montes e por todos os valles, e os seus renovos foram quebrados por todas as correntes da terra; e todos os povos da terra se retiraram da sua sombra, e o deixaram.`,
    ...
    `Ao som da sua queda fiz tremer as nações, quando o fiz descer ao inferno com os que descem á cova; e todas as arvores do Eden, a flor e o melhor do Libano, todas as arvores que bebem aguas, se consolavam na terra mais baixa.`,
  ...
  32: [
    ...
    `Filho do homem, levanta uma lamentação sobre Pharaó, rei do Egypto, e dize-lhe: Similhante eras a um filho de leão entre as nações, e tu foste como um dragão nos mares, e trasbordavas os teus rios, e turbavas as aguas com os teus pés, e enlameavas os seus rios.`,
    ...
    `E farei com que muitos povos fiquem pasmados de ti, e os seus reis tremam em grande maneira, quando eu brandir a minha espada ante os seus rostos; e estremecerão a cada momento, cada um pela sua vida, no dia da tua queda.`,
    ...
    `Esta é a lamentação, segundo a qual lamentarão; as filhas das nações assim lamentarão; sobre o Egypto e sobre toda a sua multidão assim lamentarão, diz o Senhor Jehovah.`,
    ...
    `Ali está Elam com toda a sua multidão em redor do seu sepulchro: todos elles foram traspassados, e cairam á espada, os quaes desceram incircumcisos ás mais baixas partes da terra, os quaes causaram terror na terra dos viventes, e levaram a sua vergonha com os que desceram á cova`,
    `No meio dos traspassados lhe pozeram uma cama entre toda a sua multidão; ao redor d'elle estão os seus sepulchros: todos elles são incircumcisos, traspassados á espada; porque causaram terror na terra dos viventes, e levaram a sua vergonha com os que desceram á cova; no meio dos traspassados foi posto.`,
    ...
    `Porém não jazeram com os valentes que cairam dos incircumcisos, os quaes desceram ao inferno com as suas armas de guerra e pozeram as suas espadas debaixo das suas cabeças; e a sua iniquidade está sobre os seus ossos, porquanto eram o terror dos heroes na terra dos viventes.`,
    `Tambem tu serás quebrado no meio dos incircumcisos, e jazerás com os que foram traspassados á espada.`,
    `Ali está Edom, os seus reis e todos os seus principes, que com o seu poder foram postos com os que foram traspassados á espada; estes jazem com os incircumcisos e com os que desceram á cova.`,
    `Ali estão os principes do norte, todos elles, e todos os sidonios, que desceram com os traspassados, envergonhados com o terror causado pelo seu poder; e jazem incircumcisos com os que foram traspassados á espada, e levam a sua vergonha com os que desceram á cova.`,
  ...
  33: [
    ...
    `Porém, quando o atalaia vir que vem a espada, e não tocar a trombeta, e não fôr avisado o povo, e a espada vier, e levar uma vida d'entre elles, este tal foi levado na sua iniquidade, porém o seu sangue demandarei da mão do atalaia.`,
    ...
    `Mas, quando tu tiveres dissuadido ao impio do seu caminho, para que se converta d'elle, e elle se não converter do seu caminho, elle morrerá na sua iniquidade; porém tu livraste a tua alma.`,
    ...
    `Dize-lhes: Vivo eu, diz o Senhor Jehovah, que não tenho prazer na morte do impio, mas que o impio se converta do seu caminho, e viva: convertei-vos, convertei-vos dos vossos maus caminhos; pois por que razão morrereis, ó casa de Israel?`,
    `Tu pois, filho do homem, dize aos filhos do teu povo: A justiça do justo não o fará escapar no dia da sua prevaricação; e, quanto á impiedade do impio, não cairá por ella, no dia em que se converter da sua impiedade; nem o justo por ella poderá viver no dia em que peccar.`,
    `Quando eu disser ao justo que certamente viverá, e elle confiar na sua justiça, e fizer iniquidade, não virão em memoria todas as suas justiças, mas na sua iniquidade, que faz, n'ella morrerá.`,
    ...
    `Ora a mão do Senhor estivera sobre mim pela tarde, antes que viesse o que tinha escapado, e abriu a minha bocca, até que chegou a mim pela manhã; e abriu-se a minha bocca, e não fiquei mais em silencio.`,
    `Então veiu a mim a palavra do Senhor, dizendo:`,
    `Filho do homem, os moradores d'estes logares desertos da terra de Israel, fallando, dizem: Abrahão era um só, e possuiu esta terra; porém nós somos muitos, esta terra a nós foi dada em possessão.`,
    ...
    `Assim lhes dirás: Assim disse o Senhor Jehovah: Vivo eu, que os que estiverem em logares desertos, cairão á espada, e o que estiver sobre a face do campo o entregarei á fera, para que o coma, e os que estiverem em logares fortes e em cavernas morrerão de pestilencia.`,
    ...
    `Quanto a ti, ó filho do homem, os filhos do teu povo fallam de ti junto ás paredes e nas portas das casas; e falla um com o outro, cada um a seu irmão, dizendo; Vinde, peço-vos, e ouvi qual seja a palavra que procede do Senhor.`,
    `E elles veem a ti, como o povo costumava vir, e se assentam diante de ti, como o meu povo, e ouvem as tuas palavras, mas não as põem por obra: antes elles lisongeiam com a sua bocca, porém o seu coração segue a sua avareza.`,
    ...
    `Porém, quando vier isto (eis que está para vir), então saberão que houve no meio d'elles um propheta.`,
  ],
  34: [
    `E veiu a mim a palavra do Senhor, dizendo:`,
    `Filho do homem, prophetiza contra os pastores de Israel; prophetiza, e dize aos pastores: Assim diz o Senhor Jehovah: Ai dos pastores de Israel que se apascentam a si mesmos! porventura os pastores não apascentarão as ovelhas?`,
    `Comeis o gordo, e vos vestis de lã; degolaes o cevado; porém não apascentaes as ovelhas.`,
    `As fracas não fortalecestes, e a doente não curastes, e a quebrada não ligastes, e a desgarrada não tornastes a trazer, e a perdida não buscastes: porém dominaes sobre ellas com rigor e dureza.`,
    `Assim se espalharam, por não haver pastor, e ficaram para pasto de toda a besta do campo, porquanto se espalharam.`,
    `As minhas ovelhas andam desgarradas por todos os montes, e por todo o alto outeiro; e as minhas ovelhas andam espalhadas por toda a face da terra, sem haver quem pergunte por ellas, sem haver quem as busque.`,
    ...
    `Portanto, ó pastores, ouvi a palavra do Senhor:`,
    `Assim diz o Senhor Jehovah: Eis que eu estou contra os pastores, e demandarei as minhas ovelhas da sua mão, e os farei cessar de apascentar as ovelhas, e os pastores não se apascentarão mais a si mesmos; e livrarei as minhas ovelhas da sua bocca, e lhes não servirão mais de pasto.`,
    `Porque assim diz o Senhor Jehovah: Eis que eu, eu digo, perguntarei pelas minhas ovelhas, e as buscarei.`,
    `Como o pastor busca o seu rebanho, no dia em que está no meio das suas ovelhas dispersas, assim buscarei as minhas ovelhas; e as farei escapar de todos os logares por onde andam espalhadas, no dia da nuvem e da escuridão.`,
    `E as tirarei dos povos, e as congregarei das terras, e as trarei á sua terra, e as apascentarei nos montes de Israel, junto ás correntes, e em todas as habitações da terra.`,
    `Em bons pastos as apascentarei, e nos altos montes de Israel será a sua malhada; ali se deitarão n'uma boa malhada, e pastarão em pastos gordos nos montes de Israel.`,
    `Eu apascentarei as minhas ovelhas, e eu as farei repousar, diz o Senhor Jehovah.`,
    `A perdida buscarei, e a desgarrada tornarei a trazer, e a quebrada atarei, e a enferma fortalecerei; mas a gorda e a forte destruirei; apascental-as-hei com juizo.`,
    ...
    `Acaso não vos basta que pasteis o bom pasto, senão que pizeis o resto de vossos pastos a vossos pés? e que bebaes as profundas aguas, senão que enlameeis o resto com os vossos pés`,
    ...
    `E farei com elles um concerto de paz, e farei cessar a besta ruim da terra, e habitarão no deserto seguramente, e dormirão nos bosques.`,
    `E a elles, e aos logares ao redor do meu outeiro, os porei por benção; e farei descer a chuva a seu tempo: chuvas de benção serão.`,
  ...
  35: [
    ...
    `Portanto, vivo eu, diz o Senhor Jehovah, que usarei conforme a tua ira, e conforme a tua inveja, de que usaste, com o teu odio, contra elles; e serei conhecido d'elles, quando te julgar.`,
    `E saberás que eu, o Senhor, ouvi todas as tuas blasphemias, que disseste contra os montes d'Israel, dizendo: Já estão assolados, a nós nos são entregues por pasto.`,
    ...
    `Como te alegraste da herança da casa de Israel, porque está assolada, assim te farei a ti: em assolação serás tomado, ó monte de Seir, e todo o Edom, todo, digo; e saberão que eu sou o Senhor`,
  ],
  36: [
    ...
    `Portanto, prophetiza, e dize: Assim diz o Senhor Jehovah: Porquanto vos assolaram e devoraram em redor, para que vós ficasseis feitos herança do resto das nações, e estaes levantados em labios do paroleiro, e em infamia do povo,`,
    `Portanto, ouvi, ó montes de Israel, a palavra do Senhor Jehovah: Assim diz o Senhor Jehovah aos montes e aos outeiros, ás correntes e aos valles, aos logares assolados e solitarios, e ás cidades desamparadas, que se tornaram em rapina e em escarneo ao resto das nações que lhes estão em redor`,
    `Portanto, assim diz o Senhor Jehovah: Certamente no fogo do meu zelo fallei contra o resto das nações, e contra todo o Edom, que se appropriaram da minha terra, com alegria de todo o coração, e com menosprezo da alma, para ser lançada fóra á rapina`,
    `Portanto, prophetiza sobre a terra de Israel, e dize aos montes e aos outeiros, ás correntes e aos valles: Assim diz o Senhor Jehovah: Eis que fallei no meu zelo e no meu furor, porquanto levastes sobre vós o opprobrio dos gentios.`,
    ...
    `E multiplicarei homens e bestas sobre vós, e se multiplicarão, e fructificarão: e vos farei habitar como d'antes, e o farei melhor que nos vossos principios; e sabereis que eu sou o Senhor.`,
    ...
    `E dirão: Esta terra assolada ficou como jardim do Eden; e as cidades solitarias, e assoladas, e destruidas, estão fortalecidas e habitadas.`,
    `Então saberão as nações, que ficarem de resto em redor de vós, que eu, o Senhor, reedifico as cidades destruidas, e planto o assolado: eu, o Senhor, o fallei, e farei.`,
    ...
    `Como o rebanho sanctificado, como o rebanho de Jerusalem nas suas solemnidades, assim as cidades desertas serão cheias de rebanhos de homens; e saberão que eu sou o Senhor.`,
  ],
  37: [
    `Veiu sobre mim a mão do Senhor, e o Senhor, pelo espirito, me levou e me poz no meio de um valle que estava cheio de ossos.`,
    ...
    `E elle me disse: Prophetiza ao espirito, prophetiza, ó filho do homem, e dize ao espirito: Assim diz o Senhor Jehovah: Vem dos quatro ventos, ó espirito, e assopra sobre estes mortos, e viverão.`,
    ...
    `E porei em vós o meu espirito, e vivereis, e vos metterei na vossa terra, e sabereis que eu, o Senhor, fallei isto, e o fiz, diz o Senhor.`,
    `E veiu a mim a palavra do Senhor, dizendo:`,
    ...
    `Então lhes dirás: Assim diz o Senhor Jehovah: Eis que eu tomarei o pau de José, que esteve na mão de Ephraim, e das tribus de Israel, seus companheiros, e os ajuntarei com elle ao pau de Judah, e farei d'elles um só pau, e elles se farão um só na minha mão.`,
    `E os paus, sobre que houveres escripto, estarão na tua mão, perante os olhos d'elles.`,
    `Dize-lhes pois: Assim diz o Senhor Jehovah: Eis que eu tomarei os filhos de Israel de entre as nações, para onde elles foram, e os congregarei de todas as partes, e os levarei á sua terra.`,
    ...
    `E nunca mais se contaminarão com os seus idolos, nem com as suas abominações, nem com as suas prevaricações, e os livrarei de todas as suas habitações, em que peccaram, e os purificarei: assim me serão por povo, e eu lhes serei por Deus.`,
    `E meu Servo David será rei sobre elles, e todos elles terão um só pastor; e andarão nos meus juizos, e guardarão os meus estatutos, e os farão.`,
    `E habitarão na terra que dei a meu servo Jacob, em que habitaram vossos paes; e habitarão n'ella, elles e seus filhos, e os filhos de seus filhos, para sempre, e David, meu servo, será seu principe eternamente.`,
  ...
  39: [
    ...
    `E enviarei um fogo a Magog, e entre os que habitam seguros nas ilhas; e saberão que eu sou o Senhor.`,
    `E farei conhecido o meu sancto nome no meio do meu povo Israel, e nunca mais deixarei profanar o meu sancto nome; e as nações saberão que eu sou o Senhor, o Sancto em Israel.`,
    `Eis que é vindo, e será feito, diz o Senhor Jehovah: este é o dia de que tenho fallado.`,
    `E os habitantes das cidades de Israel sairão, e accenderão fogo, e queimarão as armas, e os escudos e as rodelas, com os arcos, e com as frechas, e com os bastões de mão, e com as lanças; e accenderão fogo com ellas por sete annos.`,
    ...
    `E succederá que, n'aquelle dia, darei ali a Gog um logar de sepultura em Israel, o valle dos que passam ao oriente do mar; e este tapará os narizes aos que passarem; e ali sepultarão a Gog, e a toda a sua multidão, e lhe chamarão o valle da multidão de Gog.`,
    ...
    `E separarão uns homens que incessantemente passarão pela terra, para que elles, juntamente com os que passam, sepultem os que tiverem ficado sobre a face da terra, para a purificarem: ao cabo de sete mezes farão esta busca.`,
    ...
    `Tu, pois, ó filho do homem, assim diz o Senhor Jehovah, dize ás aves de toda a aza, e a todos os animaes do campo: Ajuntae-vos e vinde, congregae-vos de ao redor para o meu sacrificio, que eu sacrifiquei por vós, um sacrificio grande, nos montes de Israel, e comei carne e bebei sangue.`,
    ...
    `Portanto assim diz o Senhor Jehovah: Agora tornarei a trazer os captivos de Jacob, e me compadecerei de toda a casa d'Israel; zelarei pelo meu sancto nome;`,
  ...
  40: [
    `No anno vinte e cinco do nosso captiveiro, no principio do anno, no decimo dia do mez, quatorze annos depois que a cidade foi ferida, n'aquelle mesmo dia veiu sobre mim a mão do Senhor, e me levou para lá.`,
    ...
    `E disse-me o homem: Filho do homem, vê com os teus olhos, e ouve com os teus ouvidos, e põe no teu coração tudo quanto eu te fizer vêr; porque afim de t'o mostrar foste tu aqui trazido: annuncia pois á casa de Israel tudo quanto tu vires`,
    `E eis um muro fóra da casa em redor, e na mão do homem uma canna de medir, de seis covados, cada covado d'um covado e um palmo, e mediu a largura do edificio, d'uma canna, e a altura, d'uma canna.`,
    `Então veiu á porta que olhava para o caminho do oriente, e subiu pelos seus degraus; mediu o umbral da porta, uma canna de largo, e o outro umbral, d'uma canna de largo.`,
    ...
    `E as camarinhas da porta do caminho para o oriente eram tres d'esta e tres da outra banda, uma mesma medida era a das tres: tambem os pilares d'esta e da outra banda tinham a mesma medida.`,
    `Mediu mais a largura da entrada da porta, de dez covados; e o comprimento da porta, treze covados.`,
    `E o espaço de diante das camarinhas era de um covado, e de um covado o espaço da outra banda: e cada camarinha tinha seis covados d'uma e seis covados da outra banda.`,
    ...
    `E as suas camarinhas, tres d'uma banda, e tres da outra, e os seus pilares e os seus vestibulos eram da medida da primeira porta: cincoenta covados era o seu comprimento, e a largura vinte e cinco covados.`,
    ...
    `E as suas camarinhas, e os seus pilares, e os seus vestibulos eram conforme estas medidas; e tinham tambem janellas ao redor dos seus vestibulos: o comprimento era de cincoenta covados, e a largura de vinte e cinco covados.`,
    ...
    `E os seus vestibulos estavam no atrio de fóra: tambem havia palmas nos seus pilares de uma e de outra banda; e eram as suas subidas de oito degraus.`,
    ...
    `E os seus pilares estavam no atrio exterior: tambem havia palmas nos seus pilares de uma e de outra banda; e eram as suas subidas de oito degraus.`,
    ...
    `Tambem da banda de fóra da subida para a entrada da porta do norte havia duas mesas; e da outra banda, que estava no vestibulo da porta, havia duas mesas.`,
    `Quatro mesas de uma, e quatro mesas da outra banda; aos lados da porta oito mesas, sobre as quaes immolavam.`,
    `E as quatro mesas para o holocausto eram de pedras lavradas: o comprimento era de um covado e meio, e a largura de um covado e meio, e a altura de um covado: e sobre ellas se punham os instrumentos com que immolavam o holocausto e o sacrificio.`,
    `E as pedras do lar eram de um palmo de grossura, postas na casa em redor, e sobre as mesas a carne da offerta.`,
    `E fóra da porta interior estavam as camaras dos cantores, no atrio de dentro, que estava da banda da porta do norte e olhava para o caminho do sul: uma estava á banda da porta do oriente, a qual olhava para o caminho do norte.`,
    `E elle me disse: Esta camara que olha para o caminho do sul é para os sacerdotes que teem a guarda do templo.`,
    `Mas a camara que olha para o caminho do norte é para os sacerdotes que teem a guarda do altar: estes são os filhos de Zadoc, que se chegam ao Senhor, d'entre os filhos de Levi, para o servir.`,
    ...
    `O comprimento do vestibulo era de vinte covados, e a largura de onze covados, e com degraus, pelos quaes se subia; e havia columnas junto aos pilares, uma de uma banda e outra da outra.`,
  ],
  41: [
    ...
    `E as camaras lateraes, camara sobre camara, eram trinta e tres por ordem, e entravam na parede que tocava no templo pelas camaras lateraes em redor, para travarem d'ellas, porque não travavam da parede do templo.`,
    ...
    `E as entradas das camaras lateraes estavam voltadas para o logar vazio: uma entrada para o caminho do norte, e outra entrada para o do sul: e a largura do logar vazio era de cinco covados em redor.`,
    ...
    `Tambem mediu o comprimento do edificio, diante da separação, que lhe estava por detraz, e as suas galerias de uma e de outra parte, de cem covados, com o templo de dentro e os vestibulos do atrio.`,
    ...
    `A saber: um rosto de homem olhava para a palma d'uma banda, e um rosto de leãosinho para a palma da outra: assim foi feito por toda a casa em redor.`,
    ...
    `O altar de madeira era de tres covados de altura, e o seu comprimento de dois covados, e tinha as suas esquinas; e o seu comprimento e as suas paredes eram de madeira; e me disse: Esta é a mesa que está perante a face do Senhor.`,
  ...
  44: [
    ...
    `E disse-me o Senhor: Filho do homem, põe no teu coração, e olha com os teus olhos, e ouve com os teus ouvidos, tudo quanto eu fallar comtigo de todos os estatutos da casa do Senhor, e de todas as suas leis; e põe o teu coração na entrada da casa, com todas as saidas do sanctuario.`,
    `E dize ao rebelde, á casa de Israel: Assim diz o Senhor Jehovah: Bastem-vos todas as vossas abominações, ó casa d'Israel!`,
    `Porque introduzistes estranhos, incircumcisos de coração e incircumcisos de carne, para estarem no meu sanctuario, para o profanarem em minha casa, quando offereceis o meu pão, a gordura, e o sangue; e elles invalidaram o meu concerto, por causa de todas as vossas abominações.`,
    ...
    `Comtudo serão ministros no meu sanctuario, nos officios das portas da casa, e servirão a casa: elles degolarão o holocausto, e o sacrificio para o povo, e elles estarão perante elles, para os servir.`,
    `Porque lhes ministraram diante dos seus idolos, e serviram á casa de Israel de tropeço de maldade: por isso eu levantei a minha mão sobre elles, diz o Senhor Jehovah, e elles levarão sobre si a sua iniquidade.`,
    ...
    `Mas os sacerdotes leviticos, os filhos de Zadoc, que guardaram a ordenança do meu sanctuario quando os filhos de Israel andavam errados de mim, elles se chegarão a mim, para me servirem, e estarão diante de mim, para me offerecerem a gordura e o sangue, diz o Senhor Jehovah.`,
    ...
    `E, saindo elles ao atrio exterior, ao atrio exterior ao povo, despirão as suas vestiduras com que elles ministraram, e as porão nas sanctas camaras, e se vestirão de outros vestidos, para que não sanctifiquem o povo estando com as suas vestiduras.`,
    ...
    `E, no dia em que elle entrar no logar sancto, no atrio interior, para ministrar no logar sancto, offerecerá a sua expiação pelo peccado, diz o Senhor Jehovah.`,
    ...
    `E as primicias de todos os primeiros fructos de tudo, e toda a offerta de todas as vossas offertas, serão dos sacerdotes; tambem as primeiras das vossas massas dareis ao sacerdote; para que faça repousar a benção sobre a tua casa.`,
  ...
  45: [
    ...
    `E d'esta medida medirás o comprimento de vinte e cinco mil covados, e a largura de dez mil: e ali estará o sanctuario e o logar sanctissimo.`,
    `Este será o logar sancto da terra; elle será para os sacerdotes que administram o sanctuario e se approximam para servir ao Senhor; e lhes servirá de logar para casas, e de logar sancto para o sanctuario.`,
    `E terão os levitas, ministros da casa, em possessão sua, vinte e cinco mil medidas de comprimento, para vinte camaras.`,
    `E para possessão da cidade, de largura dareis cinco mil cannas, e de comprimento vinte e cinco mil, defronte da offerta sancta: o que será para toda a casa de Israel.`,
    `O principe porém terá a sua parte d'esta e da outra banda da sancta offerta, e da possessão da cidade, diante da sancta offerta, e diante da possessão da cidade, da esquina occidental para o occidente, e da esquina oriental para o oriente; e será o comprimento, defronte d'uma das partes, desde o termo occidental até ao termo oriental.`,
    ...
    `E estarão a cargo do principe os holocaustos, e as offertas de manjares, e as libações, nas festas, e nas luas novas, e nos sabbados, em todas as solemnidades da casa de Israel: elle fará a expiação pelo peccado, e a offerta de manjares, e o holocausto, e os sacrificios pacificos, para fazer expiação pela casa de Israel.`,
    ...
    `E nos sete dias da festa preparará um holocausto ao Senhor, de sete bezerros e sete carneiros sem mancha, cada dia durante os sete dias; e o sacrificio de expiação d'um bode cada dia.`,
  ...
  47: [
    `Depois d'isto me fez voltar á entrada da casa, e eis que sahiam umas aguas debaixo do umbral da casa para o oriente; porque a face da casa olhava para o oriente, e as aguas desciam de debaixo, desde a banda direita da casa, da banda do sul do altar.`,
    ...
    `Então me disse: Estas aguas saem para a Galilea do oriente, e descem á campina, e entram no mar; e, sendo levadas ao mar, sararão as aguas.`,
    `E será que toda a creatura vivente que nadar por onde quer que entrarem estes dois ribeiros viverá, e haverá muitissimo peixe; porque lá chegarão estas aguas, e sararão, e viverá tudo por onde quer que entrar este ribeiro.`,
    ...
    `E junto ao ribeiro, á sua borda, de uma e de outra banda, subirá toda a sorte de arvore que dá fructo para se comer: não cairá a sua folha, nem perecerá o seu fructo: nos seus mezes produzirá novos fructos, porque as suas aguas saem do sanctuario; e o seu fructo servirá de comida e a sua folha de remedio`,
    ...
    `E o termo será desde o mar Hazer-enon, o termo de Damasco, e o norte, que olha para o norte, e o termo de Hamath: e este será o termo do norte.`,
    ...
    `Será, porém, que a sorteareis para vossa herança, e para a dos estrangeiros que peregrinam no meio de vós, que gerarão filhos no meio de vós; e vos serão como naturaes entre os filhos de Israel; comvosco entrarão em herança, no meio das tribus de Israel.`,
