const data: Record<number, string[]> = {
  1: [
    `No anno terceiro do reinado de Joaquim, rei de Judah, veiu Nabucodonozor, rei de Babylonia, a Jerusalem, e a sitiou.`,
    `E o Senhor entregou nas suas mãos a Joaquim, rei de Judah, e uma parte dos vasos da casa de Deus, e os levou para a terra de Shinar, para a casa do seu deus, e poz os vasos na casa do thesouro do seu deus.`,
    ...
    `Mancebos em quem não houvesse defeito algum, e formosos de parecer, e instruidos em toda a sabedoria, e sabios em sciencia, e entendidos no conhecimento, e que tivessem habilidade para assistir no palacio do rei, e que os ensinassem nas lettras e na lingua dos chaldeos.`,
    ...
    `E o chefe dos eunuchos lhes poz outros nomes, a saber: a Daniel poz o de Belteshazzar, e a Hananias o de Sadrach, e a Misael o de Mesach, e a Azarias o de Abed-nego.`,
    ...
    `E disse o chefe dos eunuchos a Daniel: Tenho medo do meu senhor, o rei, que ordenou a vossa comida e a vossa bebida; pois porque veria elle os vossos rostos mais tristes do que os dos mancebos que são vossos eguaes? assim arriscareis a minha cabeça para com o rei.`,
    ...
    `E o rei fallou com elles; porém entre todos elles não foram achados outros taes como Daniel, Hananias, Misael e Azarias; e assistiam diante do rei.`,
    `E em toda a materia de sabedoria e de intelligencia, que o rei lhes perguntou, os achou dez vezes mais doutos do que todos os magos ou astrologos que havia em todo o seu reino.`,
  ...
  2: [
    ...
    `E o rei mandou chamar os magos, e os astrologos, e os encantadores, e os chaldeos, para que declarassem ao rei os seus sonhos: os quaes vieram e se apresentaram diante do rei.`,
    ...
    `Respondeu o rei, e disse aos chaldeos: A coisa me tem escapado; se me não fizerdes saber o sonho e a sua interpretação, sereis despedaçados, e as vossas casas serão feitas um monturo;`,
    `Mas se vós me declarardes o sonho e a sua interpretação, recebereis de mim dons, e dadivas, e grande honra; portanto declarae-me o sonho e a sua interpretação.`,
    ...
    `De maneira que, se me não fazeis saber o sonho, uma só sentença será a vossa; pois vós preparastes palavras mentirosas e perversas para as proferir na minha presença, até que se mude o tempo: portanto dizei-me o sonho, para que eu entenda que me podeis declarar a sua interpretação.`,
    `Responderam os chaldeos na presença do rei, e disseram: Não ha ninguem sobre a terra que possa declarar a palavra ao rei; pois nenhum rei ha, grande ou dominador, que requeresse coisa similhante d'algum mago, ou astrologo, ou chaldeo.`,
    ...
    `Então Daniel fallou avisada e prudentemente a Arioch, capitão da guarda do rei, que tinha saido para matar os sabios de Babylonia.`,
    ...
    `Por isso Daniel entrou a Arioch, ao qual o rei tinha constituido para matar os sabios de Babylonia: entrou, e disse-lhe assim: Não mates os sabios de Babylonia; introduze-me na presença do rei, e declararei ao rei a interpretação.`,
    `Então Arioch depressa introduziu a Daniel na presença do rei, e disse-lhe assim: Achei um d'entre os filhos dos captivos de Judah, o qual fará saber ao rei a interpretação.`,
    `Respondeu o rei, e disse a Daniel (cujo nome era Belteshazzar): Podes tu fazer-me saber o sonho que vi e a sua interpretação?`,
    `Respondeu Daniel na presença do rei, e disse: O segredo que o rei requer, nem sabios, nem astrologos, nem magos, nem adivinhos o podem declarar ao rei;`,
    ...
    `Então foi juntamente esmiuçado o ferro, o barro, o cobre, a prata e o oiro, e se fizeram como pragana das eiras do estio, e o vento os levou, e não se achou logar algum para elles; mas a pedra, que feriu a estatua, se fez um grande monte, e encheu toda a terra.`,
    ...
    `E o quarto reino será forte como ferro; da maneira que o ferro esmiuça e enfraquece tudo, como o ferro, que quebranta todas estas coisas, assim esmiuçará e quebrantará.`,
    `E, quanto ao que viste dos pés e dos dedos, em parte de barro de oleiro, e em parte de ferro, isso será um reino dividido; comtudo haverá n'elle alguma coisa da firmeza do ferro, porquanto viste o ferro misturado com barro de lodo.`,
    ...
    `Quanto ao que viste do ferro misturado com barro de lodo, misturar-se-hão com semente humana, mas não se apegarão um ao outro, assim como o ferro se não mistura com o barro.`,
    `Mas, nos dias d'estes reis, o Deus do céu levantará um reino que não será jámais destruido; e este reino não será deixado a outro povo: esmiuçará e consumirá todos estes reinos, mas elle mesmo estará estabelecido para sempre.`,
    `Da maneira que viste que do monte foi cortada uma pedra, sem mãos, e ella esmiuçou o ferro, o cobre, o barro, a prata e o oiro, o Deus grande fez saber ao rei o que ha de ser depois d'isto; e certo é o sonho, e fiel a sua interpretação.`,
    ...
    `Então o rei engrandeceu a Daniel, e lhe deu muitos e grandes dons, e o poz por governador de toda a provincia de Babylonia, como tambem por principe dos prefeitos sobre todos os sabios de Babylonia.`,
    `E pediu Daniel ao rei, e constituiu elle sobre os negocios da provincia de Babylonia a Sadrach, Mesach e Abed-nego; porém Daniel estava á porta do rei.`,
  ],
  3: [
    `O rei Nabucodonozor fez uma estatua de oiro, a altura da qual era de sessenta covados, e a sua largura de seis covados: levantou-a no campo de Dura, na provincia de Babylonia.`,
    `E o rei Nabucodonozor mandou ajuntar os sátrapas, os prefeitos e presidentes, os juizes, os thesoureiros, os conselheiros, os officiaes, e todos os governadores das provincias, para que viessem á consagração da estatua que o rei Nabucodonozor tinha levantado.`,
    `Então se ajuntaram os sátrapas, os prefeitos e presidentes, os juizes, os thesoureiros, os conselheiros, os officiaes, e todos os governadores das provincias, á consagração da estatua que o rei Nabucodonozor tinha levantado, e estavam em pé diante da estatua que Nabucodonozor tinha levantado.`,
    `E o pregoeiro apregoava em alta voz: Ordena-se a vós, ó povos, nações e linguagens:`,
    `Quando ouvirdes o som da buzina, do pifaro, da harpa, da sambuca, do psalterio, da symphonia, e de toda a sorte de musica, vos prostrareis, e adorareis a estatua de oiro que o rei Nabucodonozor tem levantado.`,
    `E qualquer que se não prostrar e a não adorar, será na mesma hora lançado dentro do forno de fogo ardente.`,
    `Portanto, no mesmo instante em que todos os povos ouviram o som da buzina, do pifaro, da harpa, da sambuca, do psalterio, e de toda a sorte de musica, se prostraram todos os povos, nações e linguas, e adoraram a estatua de oiro que o rei Nabucodonozor tinha levantado.`,
    ...
    `Ha uns homens judeos, os quaes constituiste sobre os negocios da provincia de Babylonia: Sadrach, Mesach e Abed-nego: estes homens, ó rei, não fizeram caso de ti; a teus deuses não servem, nem a estatua de oiro, que levantaste, adoraram.`,
    `Então Nabucodonozor, com ira e furor, mandou trazer a Sadrach, Mesach e Abed-nego. E trouxeram a estes homens perante o rei.`,
    `Fallou Nabucodonozor, e lhes disse: Porventura de proposito, ó Sadrach, Mesach e Abed-nego, vós não servis a meus deuses nem adoraes a estatua de oiro que levantei?`,
    `Agora pois, se estaes promptos, quando ouvirdes o som da buzina, do pifaro, da guitarra, da harpa, do psalterio, da symphonia, e de toda a sorte de musica, para vos prostrardes e adorardes a estatua que fiz, bom é; mas, se a não adorardes, sereis lançados, na mesma hora, dentro do forno de fogo ardente: e quem é o Deus que vos poderá livrar das minhas mãos`,
    ...
    `Então Nabucodonozor se encheu de furor, e se mudou o aspecto do seu semblante contra Sadrach, Mesach e Abed-nego: respondeu, e ordenou que o forno se accendesse sete vezes mais do que se costumava accender.`,
    ...
    `E, porque a palavra do rei apertava, e o forno estava sobre-maneira acceso, a chamma do fogo matou aquelles homens que levantaram a Sadrach, Mesach e Abed-nego.`,
    ...
    `Então se chegou Nabucodonozor á porta do forno de fogo ardente; fallou, e disse: Sadrach, Mesach e Abed-nego, servos do Deus Altissimo, sahi e vinde! Então Sadrach, Mesach e Abed-nego sairam do meio do fogo.`,
    `E ajuntaram-se os sátrapas, os prefeitos, e os presidentes, e os capitães do rei, contemplando estes homens, como o fogo não tinha tido poder algum sobre os seus corpos: nem um só cabello da sua cabeça se tinha queimado, nem as suas capas se mudaram, nem cheiro de fogo tinha passado sobre elles.`,
    `Fallou Nabucodonozor, e disse: Bemdito seja o Deus de Sadrach, Mesach e Abed-nego, que enviou o seu anjo, e livrou os seus servos, que confiaram n'elle, pois violaram a palavra do rei, e entregaram os seus corpos, para que não servissem nem adorassem algum outro deus, senão o seu Deus.`,
    `Por mim pois se faz um decreto, que todo o povo, nação e lingua que disser blasphemia contra o Deus de Sadrach, Mesach e Abed-nego, seja despedaçado, e a sua casa seja feita um monturo; porquanto não ha outro Deus que possa livrar como este.`,
  ...
  4: [
    ...
    `Belteshazzar, principe dos magos, pois eu sei que ha em ti o espirito dos deuses sanctos, e nenhum segredo te é difficil; dize-me as visões do meu sonho que tive e a sua interpretação.`,
    ...
    `Crescia esta arvore, e se fazia forte, de maneira que a sua altura chegava até ao céu; e foi vista até á extremidade de toda a terra.`,
    `A sua folhagem era formosa, e o seu fructo muito, e havia n'ella sustento para todos: debaixo d'ella as bestas do campo achavam sombra, e as aves do céu faziam morada nos seus ramos, e toda a carne se mantinha d'ella.`,
    `Estava vendo nas visões da minha cabeça, na minha cama; e eis que um vigia, um sancto, descia do céu,`,
    `Clamando fortemente, e dizendo assim: Cortae a arvore, e decotae-lhe os ramos, sacudi as suas folhas, espalhae o seu fructo; afugentem-se as bestas de debaixo d'ella, e as aves dos seus ramos.`,
    `Porém o tronco com as suas raizes deixae na terra, e com atadura de ferro e de bronze, na herva do campo: e seja molhado do orvalho do céu, e a sua porção seja com as bestas na gramma da terra:`,
    `Seja mudado o seu coração, que não seja mais coração de homem, e lhe seja dado coração de besta; e passem sobre elle sete tempos`,
    ...
    `Isto em sonho vi eu, rei Nabucodonozor: tu, pois, Belteshazzar, dize a interpretação: porque todos os sabios do meu reino não poderam fazer-me saber a sua interpretação; mas tu podes; pois ha em ti o espirito dos deuses sanctos.`,
    `Então Daniel, cujo nome era Belteshazzar, esteve attonito quasi uma hora, e os seus pensamentos o turbavam; fallou pois o rei, e disse: Belteshazzar, não te espante o sonho, nem a sua interpretação. Respondeu Belteshazzar, e disse; Senhor meu: o sonho seja contra os que te teem odio, e a sua interpretação aos teus inimigos.`,
    ...
    `Esta arvore és tu, ó rei, que cresceste, e te fizeste forte; e a tua grandeza cresceu, e chegou até ao céu, e o teu dominio até á extremidade da terra`,
    `E quanto ao que viu o rei, um vigia, um sancto, que descia do céu, e disse: Cortae a arvore, e a destrui, porém o tronco com as suas raizes deixae na terra, e com atadura de ferro e de bronze, na herva do campo; e seja molhado do orvalho do céu, e a sua porção seja com as bestas do campo, até que passem sobre elle sete tempos:`,
    `Esta é a interpretação, ó rei: e este é o decreto do Altissimo, que virá sobre o rei, meu senhor,`,
    `A saber: Lançar-te-hão de entre os homens, e a tua morada será com as bestas do campo, e te farão comer herva como os bois, e serás molhado do orvalho do céu; e passar-se-hão sete tempos por cima de ti: até que conheças que o Altissimo domina sobre o reino dos homens, e os dá a quem quer`,
    ...
    `Portanto, ó rei, acceita o meu conselho, e desfaze os teus peccados pela justiça, e as tuas iniquidades usando de misericordia com os pobres, se porventura houver prolongação da tua paz`,
    ...
    `Fallou o rei, e disse: Porventura não é esta a grande Babylonia que eu edifiquei para a casa real, com a força da minha potencia, e para gloria da minha magnificencia?`,
    `Ainda estava a palavra na bocca do rei, quando caiu uma voz do céu: A ti se diz, ó rei Nabucodonozor: Passou de ti o reino.`,
    `E te lançarão d'entre os homens, e a tua morada será com as bestas do campo: far-te-hão comer herva como os bois, e passar-se-hão sete tempos sobre ti, até que conheças que o Altissimo domina sobre os reinos dos homens, e os dá a quem quer.`,
    `Na mesma hora se cumpriu a palavra sobre Nabucodonozor, e foi lançado d'entre os homens, e comia herva como os bois, e o seu corpo foi molhado do orvalho do céu, até que lhe cresceu pello, como as pennas da aguia, e as suas unhas como as das aves.`,
    `Mas ao fim d'aquelles dias eu, Nabucodonozor, levantei os meus olhos ao céu, e tornou-me a vir o meu entendimento, e eu bemdisse o Altissimo, e louvei e glorifiquei ao que vive para sempre, cujo dominio é um dominio sempiterno, e cujo reino é de geração em geração.`,
    `E todos os moradores da terra são reputados em nada, e segundo a sua vontade faz com o exercito do céu e os moradores da terra: não ha quem possa estorvar a sua mão, e lhe diga, Que fazes?`,
    `No mesmo tempo me tornou a vir o meu entendimento, e para a dignidade do meu reino tornou-me a vir a minha magestade e o meu resplandor; e me buscaram os meus capitães e os meus grandes; e fui restabelecido no meu reino, e se me accrescentou uma gloria maior do que nunca.`,
    `Agora pois eu, Nabucodonozor, louvo, e exalço, e glorifico ao rei do céu; porque todas as suas obras são verdade, e os seus caminhos juizo, e pode humilhar aos que andam na soberba.`,
  ],
  5: [
  ...
  7: [
    `No primeiro anno de Belshazzar, rei de Babylonia, teve Daniel um sonho e visões da sua cabeça estando na sua cama: escreveu logo o sonho, e relatou a summa das coisas.`,
    ...
    `O primeiro era como leão, e tinha azas de aguia: eu estava olhando, até que lhe foram arrancadas as azas; e foi levantado da terra, e posto em pé como um homem, e foi-lhe dado um coração de homem.`,
    `E eis aqui outro segundo animal, similhante a um urso, o qual se levantou de um lado, e tinha na bocca tres costellas entre os seus dentes, e foi-lhe dito assim: Levanta-te, devora muita carne.`,
    `Depois d'isto, eu estava olhando, e eis aqui outro, que era como leopardo, e tinha quatro azas de ave nas suas costas: tinha tambem este animal quatro cabeças, e foi-lhe dado dominio.`,
    `Depois d'isto, eu estava olhando nas visões da noite, e eis aqui o quarto animal, terrivel e espantoso, e muito forte, o qual tinha dentes grandes de ferro, devorava e fazia em pedaços, e pizava aos seus pés o que sobejava; e era differente de todos os animaes que foram antes d'elle, e tinha dez pontas.`,
    `Estando eu considerando as pontas, eis que outra ponta pequena subia entre ellas, e tres das pontas primeiras foram arrancadas de diante d'elle; e eis que n'esta ponta havia olhos, como olhos de homem, e uma bocca que fallava grandiosamente.`,
    `Eu estive olhando, até que foram postos uns thronos, e o ancião de dias se assentou: o seu vestido era branco como a neve, e o cabello da sua cabeça como a limpa lã; o seu throno chammas de fogo, e as rodas d'elle fogo ardente.`,
    ...
    `E foi-lhe dado o dominio e a honra, e o reino, e que todos os povos, nações e linguas o servissem: o seu dominio é um dominio eterno, que não passará, e o seu reino se não destruirá.`,
    ...
    `Tambem das dez pontas que tinha na cabeça, e da outra que subia, de diante da qual cairam tres, d'aquella ponta, digo, que tinha olhos, e bocca que fallava grandiosamente, e cujo parecer era maior do que o das suas companheiras.`,
    ...
    `Disse assim: O quarto animal será o quarto reino na terra, o qual será differente de todos os reinos; e devorará toda a terra, e a pizará aos pés, e a fará em pedaços.`,
    ...
    `E fallará palavras contra o Altissimo, e destruirá os sanctos do Altissimo, e cuidará em mudar os tempos e a lei; e serão entregues na sua mão por um tempo, e tempos, e a metade d'um tempo.`,
    `E o juizo estará assentado, e tirarão o seu dominio, para o destruir e para o desfazer até ao fim.`,
    `E o reino, e o dominio, e a magestade dos reinos debaixo de todo o céu se dará ao povo dos sanctos do Altissimo: o seu reino será um reino eterno, e todos os dominios o servirão, e lhe obedecerão:`,
  ...
  8: [
    ...
    `E levantei os meus olhos, e vi, e eis que um carneiro estava diante do rio, o qual tinha duas pontas; e as duas pontas eram altas, porém uma era mais alta do que a outra; e a que era mais alta subiu por ultimo.`,
    `Vi que o carneiro dava marradas para o occidente, e para o norte e para o meio-dia; e nenhuns animaes podiam parar diante d'elle, nem havia quem livrasse da sua mão; e fazia conforme a sua vontade, e se engrandecia.`,
    ...
    `E o vi chegar perto do carneiro, e se irritou contra elle, e feriu o carneiro, e lhe quebrou as duas pontas, pois não havia força no carneiro para parar diante d'elle, e o lançou por terra, e o pizou a pés; nem houve quem livrasse o carneiro da sua mão`,
    `E o bode se engrandeceu em grande maneira; mas, estando na sua maior força, aquella grande ponta foi quebrada: e subiram no seu logar outras quatro insignes, para os quatro ventos do céu.`,
    ...
    `Depois ouvi um sancto que fallava; e disse o sancto áquelle que fallava: Até quando durará a visão do continuo sacrificio, e da transgressão assoladora, para que seja entregue o sanctuario, e o exercito, para ser pizado?`,
  ...
  9: [
    ...
    `Tua, ó Senhor, é a justiça, mas a nós pertence confusão de rosto, como se vê n'este dia, aos homens de Judah, e aos moradores de Jerusalem, e a todo o Israel; aos de perto e aos de longe, em todas as terras por onde os tens lançado, por causa da sua prevaricação, com que prevaricaram contra ti.`,
    ...
    `Ao Senhor, nosso Deus, pertencem as misericordias e os perdões; ainda que nos rebellámos contra elle,`,
    `E não obedecemos á voz do Senhor, nosso Deus, para andarmos nas suas leis, que nos deu pela mão de seus servos, os prophetas.`,
    `E todo o Israel traspassou a tua lei, apartando-se para não obedecer á tua voz; por isso a maldição e o juramento, que está escripto na lei de Moysés, servo de Deus, se derramou sobre nós; porque peccámos contra elle.`,
    `E elle confirmou a sua palavra, que fallou contra nós, e contra os nossos juizes que nos julgavam, trazendo sobre nós um grande mal; que nunca foi feito debaixo de todo o céu como foi feito em Jerusalem.`,
    ...
    `Ora pois, ó Senhor, nosso Deus, que tiraste o teu povo da terra do Egypto com mão poderosa, e ganhaste para ti nome, como se vê n'este dia, peccámos; obrámos impiamente.`,
    `Ó Senhor, segundo todas as tuas justiças pois, aparte-se a tua ira e o teu furor da tua cidade de Jerusalem, do teu sancto monte; porque por causa dos nossos peccados, e por causa das iniquidades de nossos paes, vieram Jerusalem e o teu povo a servir de opprobrio a todos os que nos estão em redor.`,
    ...
    `Inclina, ó Deus meu, os teus ouvidos; e ouve: abre os teus olhos, e olha para a nossa desolação, e para a cidade a qual é chamada pelo teu nome, porque não lançamos as nossas supplicas perante a tua face fiados em nossas justiças, mas em tuas muitas misericordias.`,
    ...
    `Setenta semanas estão determinadas sobre o teu povo, e sobre a tua sancta cidade, para consumir a transgressão, e para acabar os peccados, e para expiar a iniquidade, e para trazer a justiça eterna, e para sellar a visão e o propheta, e para ungir o Sancto dos sanctos.`,
    `Sabe e entende: desde a saida da palavra para fazer tornar, e para edificar a Jerusalem, até ao Messias, o Principe, sete semanas, e sessenta e duas semanas: as ruas e as tranqueiras se reedificarão, porém em tempos angustiados.`,
    `E depois das sessenta e duas semanas será desarreigado o Messias, e não será mais: e o povo do principe, que virá, destruirá a cidade e o sanctuario, e o seu fim será com uma innundação; e até ao fim da guerra estão determinadas as assolações.`,
    `E confirmará concerto com muitos uma semana: e na metade da semana fará cessar o sacrificio e a offerta de manjares; e sobre a ala das abominações virá assolador, e isso até á consummação; e o que está determinado será derramado sobre o assolado`,
  ],
  10: [
    `No anno terceiro de Cyro, rei da Persia, foi revelada uma palavra a Daniel, cujo nome se chama Belteshazzar; e a palavra é verdadeira, porém trata d'uma guerra prolongada, e entendeu esta palavra, e tinha entendimento da visão.`,
    ...
    `E me disse: Daniel, homem mui desejado, está attento ás palavras que eu fallarei comtigo, e levanta-te sobre os teus pés; porque agora sou enviado a ti. E, fallando elle comigo esta palavra, eu estava tremendo.`,
    `Então me disse: Não temas, Daniel, porque desde o primeiro dia em que applicaste o teu coração a entender e a humilhar-te perante o teu Deus são ouvidas as tuas palavras; e eu vim por causa das tuas palavras.`,
    `Porém o principe do reino da Persia se poz defronte de mim vinte e um dias, e eis que Michael, um dos primeiros principes, veiu para ajudar-me, e eu fiquei ali com os reis da Persia.`,
    ...
    `E eis aqui alguem, similhante aos filhos dos homens, me tocou os labios: então abri a minha bocca, e fallei, e disse áquelle que estava diante de mim: Senhor meu, por causa da visão sobrevieram-me dôres, e não me ficou força alguma.`,
  ...
  11: [
    ...
    `E agora te declararei a verdade: Eis que ainda tres reis estarão na Persia, e o quarto será enriquecido de grandes riquezas mais do que todos; e, esforçando-se com as suas riquezas, suscitará a todos contra o reino da Grecia.`,
    `Depois se levantará um rei valente, que reinará com grande dominio, e fará o que lhe aprouver.`,
    `Mas, estando elle em pé, o seu reino será quebrado, e será repartido para os quatro ventos do céu, porém não para a sua posteridade, nem tão pouco segundo o seu dominio com que reinou, porque o seu reino será arrancado, e será para outros fóra d'estes.`,
    ...
    `Mas, ao cabo de alguns annos, um com outro fará concerto; e a filha do rei do sul virá ao rei do norte para fazer um tratado, mas ella não terá força de braço; nem elle persistirá, nem o seu braço, porque ella será entregue, e os que a tiverem trazido, e seu pae, e o que a esforçava n'aquelles tempos!`,
    ...
    `Porém seus filhos se entremetterão em guerra, e ajuntarão grande numero de exercitos, e um d'elles virá á pressa, e inundará, e passará, e tornará a entremetter-se em guerra, até chegar á sua fortaleza`,
    `Então o rei do sul se exasperará, e sairá, e pelejará contra elle, a saber, contra o rei do norte, que porá em campo grande multidão, mas aquella multidão será entregue na sua mão`,
    ...
    `E porá o seu rosto, para vir com a potencia de todo o seu reino, e com elle os rectos, e o fará: e lhe dará uma filha das mulheres, para a destruir a ella, mas ella não subsistirá, nem será por elle.`,
    ...
    `E em seu logar se levantará quem fará passar o arrecadador em gloria real; mas em poucos dias será quebrantado, e isto não em ira nem em batalha.`,
    `Depois se levantará em seu logar um homem vil, ao qual não darão a dignidade real; mas virá caladamente, e tomará o reino com engano.`,
    ...
    `Virá tambem caladamente aos logares gordos da provincia, e fará o que nunca fizeram seus paes, nem os paes de seus paes; repartirá entre elles a preza e os despojos, e a riqueza, e formará os seus projectos contra as fortalezas, porém sómente por certo tempo`,
    `E suscitará a sua força e o seu coração contra o rei do sul com um grande exercito; e o rei do sul se entremetterá na guerra com um grande e mui poderoso exercito; mas não subsistirá, porque formarão projectos contra elle.`,
    ...
    `E este rei fará conforme a sua vontade, e se levantará, e se engrandecerá sobre todo o deus; e contra o Deus dos deuses fallará coisas maravilhosas, e será prospero, até que a ira seja acabada; porque aquillo que está determinado será feito.`,
    ...
    `E ao deus das fortalezas honrará em seu logar, a saber, ao deus a quem seus paes não conheceram honrará com oiro, e com prata, e com pedras preciosas, e com coisas desejadas.`,
    ...
    `E, no fim do tempo, o rei do sul lhe dará marradas, e o rei do norte o accommetterá com carros, e com cavalleiros, e com muitos navios; e entrará nas terras, e as inundará, e passará.`,
