const data: Record<number, string[]> = {
  ...
  5: [
    `Totalmente se ouve que há entre vós pecados sexuais, e tais pecados sexuais que nem mesmo entre os gentioshá ,  como alguém que tomou como mulher a esposa de seu pai.`,
