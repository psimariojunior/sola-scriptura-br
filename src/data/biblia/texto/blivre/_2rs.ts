const data: Record<number, string[]> = {
  ...
  24: [
    ...
    `Também levou cativo Joaquim à Babilônia, assim como a mãe do rei, as mulheres do rei, os seus eunucos, e os poderosos do país; cativos os levou de Jerusalém à Babilônia.`,
