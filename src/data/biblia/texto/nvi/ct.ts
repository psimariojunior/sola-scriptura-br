const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Seu pescoço é como a torre de Davi, construída como arsenal. Nela estão pendurados mil escudos, todos eles escudos de heroicos guerreiros.`,
  ...
  7: [
    ...
    `Seu porte é como o da palmeira; os seus seios, como cachos de frutos.`,
    ...
    `Vamos cedo para as vinhas para ver se as videiras brotaram, se as suas flores se abriram e se as romãs estão em flor; ali eu darei a você o meu amor.`,
