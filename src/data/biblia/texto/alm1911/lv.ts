const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `E a trará aos filhos de Aarão, os sacerdotes, um dos quaes tomará d'ella um punhado da flor de farinha, e do seu azeite com todo o seu incenso: e o sacerdote queimará o seu memorial sobre o altar: offerta queimada é de cheiro suave ao Senhor.`,
  ...
  4: [
    ...
    `E trará o novilho á porta da tenda da congregação, perante o Senhor, e porá a sua mão sobre a cabeça do novilho, e degolará o novilho perante o Senhor.`,
    ...
    `Tambem porá o sacerdote d'aquelle sangue sobre os cornos do altar do incenso aromatico, perante o Senhor, que está na tenda da congregação: e todo o resto do sangue do novilho derramará á base do altar do holocausto, que está á porta da tenda da congregação.`,
    ...
    `E d'aquelle sangue porá sobre os cornos do altar, que está perante a face do Senhor, na tenda da congregação: e todo o resto do sangue derramará á base do altar do holocausto, que está diante da porta da tenda da congregação.`,
    ...
    `Depois o sacerdote com o seu dedo tomará do sangue da expiação, e o porá sobre os cornos do altar do holocausto: então o resto do seu sangue derramará á base do altar do holocausto.`,
    ...
    `Depois o sacerdote com o seu dedo tomará do sangue da expiação do peccado, e o porá sobre os cornos do altar do holocausto: então todo o resto do seu sangue derramará na base do altar`,
    `E tirará toda a sua gordura, como se tira a gordura do cordeiro do sacrificio pacifico; e o sacerdote a queimará sobre o altar, em cima das offertas queimadas do Senhor: assim o sacerdote por ella fará expiação dos seus peccados que peccou, e lhe será perdoado o peccado.`,
  ],
  5: [
  ...
  6: [
    `Fallou mais o Senhor a Moysés, dizendo:`,
    `Quando alguma pessoa peccar, e trespassar contra o Senhor, e negar ao seu proximo o que se lhe deu em guarda, ou o que depoz na sua mão, ou o roubo, ou o que retem violentamente ao seu proximo,`,
    ...
    `E a sua expiação trará ao Senhor: um carneiro sem mancha do rebanho, conforme á tua estimação, para expiação da culpa, trará ao sacerdote:`,
    ...
    `Fallou mais o Senhor a Moysés, dizendo:`,
    `Falla a Aarão e a seus filhos, dizendo: Esta é a lei da expiação do peccado: no logar onde se degola o holocausto se degolará a expiação do peccado perante o Senhor; coisa sanctissima é.`,
  ...
  7: [
    ...
    `Como a expiação do peccado, assim será a expiação da culpa: uma mesma lei haverá para ellas; será do sacerdote que houver feito propiciação com ella`,
    ...
    `Se o offerecer por offerta de louvores, com o sacrificio de louvores, offerecerá bolos asmos amassados com azeite; e coscorões asmos amassados com azeite; e os bolos amassados com azeite serão fritos, de flôr de farinha.`,
    ...
    `E, se o sacrificio da sua offerta fôr voto, ou offerta voluntaria, no dia em que offerecer o seu sacrificio se comerá; e o que d'elle ficar tambem se comerá no dia seguinte;`,
    ...
    `E, se uma pessoa tocar alguma coisa immunda, como immundicia de homem, ou gado immundo, ou qualquer abominação immunda, e comer da carne do sacrificio pacifico, que é do Senhor, aquella pessoa será extirpada dos seus povos.`,
  ...
  8: [
    `Fallou mais o Senhor a Moysés, dizendo:`,
    `Toma a Aarão e a seus filhos com elle, e os vestidos, e o azeite da uncção, como tambem o novilho da expiação do peccado, e os dois carneiros, e o cesto dos pães asmos`,
    ...
    `E d'elle espargiu sete vezes sobre o altar, e ungiu o altar e todos os seus vasos, como tambem a pia e a sua base, para sanctifical-as.`,
    ...
    `Porém a fressura e as pernas lavou com agua; e Moysés queimou todo o carneiro sobre o altar: holocausto de cheiro suave, uma offerta queimada era ao Senhor, como o Senhor ordenou a Moysés.`,
    ...
    `Tambem fez chegar os filhos de Aarão; e Moysés poz d'aquelle sangue sobre a ponta da orelha direita d'elles, e sobre o pollegar da sua mão direita, e sobre o pollegar do seu pé direito: e Moysés espargiu o resto do sangue sobre o altar em redor.`,
    ...
    `E Moysés disse a Aarão, e a seus filhos: Cozei a carne diante da porta da tenda da congregação, e ali a comei com o pão que está no cesto da consagração, como tenho ordenado, dizendo: Aarão e seus filhos a comerão.`,
    ...
    `Ficareis pois á porta da tenda da congregação dia e noite por sete dias, e fareis a guarda do Senhor, para que não morraes: porque assim me foi ordenado.`,
  ...
  15: [
    ...
    `E aquelle que se assentar sobre aquillo em que se assentou o que tem o fluxo, lavará os seus vestidos, e se banhará em agua e será immundo até á tarde.`,
    `E aquelle que tocar a carne do que tem o fluxo, lavará os seus vestidos, e se banhará em agua, e será immundo até á tarde.`,
    ...
    `E o sacerdote offerecerá um para expiação do peccado, e o outro para holocausto; e assim o sacerdote fará por elle expiação do seu fluxo perante o Senhor.`,
    ...
    `E qualquer que tocar alguma coisa, sobre o que ella se tiver assentado, lavará os seus vestidos, e se banhará com agua, e será immundo até á tarde.`,
    ...
    `Tambem a mulher, quando manar o fluxo do seu sangue, por muitos dias fóra do tempo da sua separação, ou quando tiver fluxo de sangue por mais tempo do que a sua separação, todos os dias do fluxo da sua immundicia será immunda, como nos dias da sua separação`,
    ...
    `Assim separareis os filhos de Israel das suas immundicias, para que não morram nas suas immundicias, contaminando o meu tabernaculo, que está no meio d'elles.`,
    `Esta é a lei d'aquelle que tem o fluxo, e d'aquelle de quem sae a semente da copula, e que fica por ella immundo;`,
    `Como tambem da mulher enferma na sua separação, e d'aquelle que padece do seu fluxo, seja macho ou femea, e do homem que se deita com mulher immunda.`,
  ],
  16: [
    `E fallou o Senhor a Moysés, depois que morreram os dois filhos de Aarão, quando se chegaram diante do Senhor e morreram.`,
    `Disse pois o Senhor a Moysés: Dize a Aarão, teu irmão que não entre no sanctuario em todo o tempo, para dentro do véu, diante do propiciatorio que está sobre a arca, para que não morra; porque eu appareço na nuvem sobre o propiciatorio.`,
    ...
    `Depois degolará o bode da expiação, que será para o povo, e trará o seu sangue para dentro do véu; e fará com o seu sangue como fez com o sangue do novilho, e o espargirá sobre o propiciatorio, e perante a face do propiciatorio.`,
    `Assim fará expiação pelo sanctuario por causa das immundicias dos filhos de Israel e das suas transgressões, segundo todos os seus peccados: e assim fará para a tenda da congregação que mora com elles no meio das suas immundicias.`,
    `E nenhum homem estará na tenda da congregação quando elle entrar a fazer expiação no sanctuario, até que elle saia: assim fará expiação por si mesmo, e pela sua casa, e por toda a congregação de Israel.`,
    ...
    `E Aarão porá ambas as suas mãos sobre a cabeça do bode vive, e sobre elle confessará todas as iniquidades dos filhos de Israel, e todas as suas transgressões, segundo todos os seus peccados: e os porá sobre a cabeça do bode, e envial-o-ha ao deserto, pela mão d'um homem designado para isso.`,
    ...
    `E banhará a sua carne em agua no logar sancto, e vestirá os seus vestidos; então sairá e preparará o seu holocausto, e o holocausto do povo, e fará expiação por si e pelo povo.`,
  ...
  17: [
    ...
    `E, qualquer homem da casa de Israel, ou dos estrangeiros que peregrinam entre elles, que comer algum sangue, contra aquella alma que comer sangue, eu porei a minha face, e a extirparei do seu povo.`,
    ...
    `E toda a alma entre os naturaes, ou entre os estrangeiros, que comer corpo morto ou dilacerado, lavará os seus vestidos, e se banhará com agua, e será immunda até á tarde; depois será limpa`,
  ...
  20: [
    ...
    `E, quando um homem tomar a sua irmã, filha de seu pae, ou filha de sua mãe, e elle vir a nudez d'ella, e ella vir a sua, torpeza é: portanto serão extirpados aos olhos dos filhos do seu povo: descobriu a nudez de sua irmã, levará sobre si a sua iniquidade.`,
    ...
    `Quando tambem um homem se deitar com a sua tia descobriu a nudez de seu tio: seu peccado sobre si levarão; sem filhos morrerão.`,
    ...
    `E a vós vos tenho dito: Em herança possuireis a sua terra, e eu a darei a vós, para possuil-a em herança, terra que mana leite e mel: Eu sou o Senhor vosso Deus, que vos separei dos povos.`,
    `Fareis pois differença entre os animaes limpos e immundos, e entre as aves immundas e as limpas; e as vossas almas não fareis abominaveis por causa dos animaes, ou das aves, ou de tudo o que se arrasta sobre a terra; as quaes coisas apartae de vós, para tel-as por immundas.`,
  ...
  26: [
    ...
    `Eu sou o Senhor vosso Deus, que vos tirei da terra dos egypcios, para que não fosseis seus escravos: e quebrantei os timões do vosso jugo, e vos fiz andar direitos.`,
    ...
    `Quando eu vos quebrantar o sustento do pão, então dez mulheres cozerão o vosso pão n'um forno, e tornar-vos-hão o vosso pão por peso; e comereis, mas não vos fartareis.`,
    ...
    `E destruirei os vossos altos, e desfarei as vossas imagens do sol, e lançarei os vossos cadaveres sobre os cadaveres mortos dos vossos deuses; a minha alma se enfadará de vós.`,
    ...
    `E, quanto aos que de vós ficarem, eu metterei tal pavor nos seus corações, nas terras dos seus inimigos, que o sonido d'uma folha movida os perseguirá; e fugirão como de fugida da espada; e cairão sem ninguem os perseguir.`,
    ...
    `Eu tambem andei com elles contrariamente, e os fiz entrar na terra dos seus inimigos; se então o seu coração incircumciso se humilhar, e então tomarem por bem o castigo da sua iniquidade,`,
    ...
    `E a terra será desamparada d'elles, e folgará nos seus sabbados, sendo assolada por causa d'elles; e tomarão por bem o castigo da sua iniquidade, em razão mesmo de que rejeitaram os meus juizos e a sua alma se enfastiou dos meus estatutos.`,
    ...
    `Antes por amor d'elles me lembrarei do concerto com os seus antepassados, que tirei da terra do Egypto perante os olhos das nações, para lhes ser por Deus: Eu sou o Senhor.`,
