const data: Record<number, string[]> = {
  1: [
    ...
    `Porque assim vos será abundantemente dada a entrada no reino eterno de nosso Senhor e Salvador Jesus Christo.`,
  ...
  2: [
    ...
    `E não perdoou ao mundo antigo, mas guardou a Noé, oitavo pregoeiro da justiça, trazendo o diluvio sobre o mundo dos impios;`,
    ...
    `E principalmente aos que segundo a carne andam em concupiscencias de immundicia, e desprezam as dominações; atrevidos, agradando-se a si mesmos, não receiando blasphemar das dignidades;`,
    ...
    `Recebendo o galardão da injustiça, tendo por prazer as delicias quotidianas, sendo nodoas e maculas, deleitando-se seus enganos, em ainda que se banqueteiem comvosco;`,
    ...
    `Os quaes, deixando o caminho direito, erraram seguindo o caminho de Balaão, filho de Bosor, que amou o galardão da injustiça;`,
    ...
    `Promettendo-lhes liberdade, sendo elles mesmos servos da corrupção. Porque de quem alguem é vencido, do tal faz-se tambem servo.`,
    `Porque se, depois de terem escapado das corrupções do mundo, pelo conhecimento do Senhor e Salvador Jesus Christo, forem outra vez envolvidos n'ellas e vencidos, tornou-se-lhes o ultimo estado peior do que o primeiro.`,
    `Porque melhor lhes fôra não conhecerem o caminho da justiça, do que, conhecendo-o, desviarem-se do sancto mandamento que lhes fôra dado;`,
