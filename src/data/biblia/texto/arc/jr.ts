const data: Record<number, string[]> = {
  ...
  13: [
    ...
    `Mas tu dize-lhes: Assim diz o SENHOR: Eis que eu encherei de embriaguez todos os habitantes desta terra, e os reis da estirpe de Davi, que estão assentados sobre o seu trono, e os sacerdotes, e os profetas, e todos os habitantes de Jerusalém.`,
  ...
  28: [
    ...
    `Então, falou Jeremias, o profeta, a Hananias, o profeta, aos olhos dos sacerdotes e aos olhos de todo o povo que estava na Casa do SENHOR.`,
    ...
    `Mas veio a palavra do SENHOR a Jeremias, depois que Hananias, o profeta, quebrou o jugo de sobre o pescoço do profeta Jeremias, dizendo:`,
  ...
  34: [
    ...
    `E entregarei os homens que traspassaram o meu concerto, que não confirmaram as palavras do concerto, como eles fizeram diante de mim com o bezerro que dividiram em duas partes, passando pelo meio das duas porções.`,
  ...
  51: [
    ...
    `Arvorai um estandarte sobre os muros de Babilônia, reforçai a guarda, colocai sentinelas e preparai as ciladas; porque o SENHOR intentou e fez o que tinha dito acerca dos moradores da Babilônia.`,
