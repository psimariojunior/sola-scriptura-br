const data: Record<number, string[]> = {
  1: [
    ...
    `No tempo de Herodes, rei da Judeia, havia um sacerdote chamado Zacarias, que pertencia ao grupo sacerdotal de Abias; Isabel, sua mulher, também era descendente de Arão.`,
  ...
  3: [
    `No décimo quinto ano do reinado de Tibério César, quando Pôncio Pilatos era governador da Judeia; Herodes, tetrarca da Galileia; seu irmão Filipe, tetrarca da Itureia e Traconites; e Lisânias, tetrarca de Abilene;`,
  ...
  5: [
    ...
    `Certo dia, quando ele ensinava, estavam sentados ali fariseus e mestres da lei, procedentes de todos os povoados da Galileia, da Judeia e de Jerusalém. E o poder do Senhor estava com ele para curar os doentes.`,
    ...
    `Mas para que vocês saibam que o Filho do homem tem na terra autoridade para perdoar pecados”—disse ao paralítico—“eu digo a você: Levante-se, pegue a sua maca e vá para casa”.`,
  ...
  6: [
    ...
    `Jesus lhes disse: “Eu pergunto: O que é permitido fazer no sábado: o bem ou o mal, salvar a vida ou destruí-la?”`,
  ...
  7: [
    ...
    `Ao ouvir isso, Jesus admirou-se dele e, voltando-se para a multidão que o seguia, disse: “Eu digo que nem em Israel encontrei tamanha fé”.`,
    ...
    `Todos ficaram cheios de temor e louvavam a Deus. “Um grande profeta se levantou dentre nós”, diziam eles. “Deus interveio em favor do seu povo.”`,
    ...
    `Então ele respondeu aos mensageiros: “Voltem e anunciem a João o que vocês viram e ouviram: os cegos veem, os aleijados andam, os leprosos são purificados, os surdos ouvem, os mortos são ressuscitados e as boas-novas são pregadas aos pobres;`,
    ...
    `Então lhe disse Jesus: “Simão, tenho algo a dizer a você”. “Dize, Mestre”, disse ele.`,
  ...
  8: [
    ...
    `As que caíram sobre as pedras são os que recebem a palavra com alegria quando a ouvem, mas não têm raiz. Creem durante algum tempo, mas desistem na hora da provação.`,
    ...
    `“Volte para casa e conte o quanto Deus fez a você”. Assim, o homem se foi e anunciou na cidade inteira o quanto Jesus tinha feito por ele.`,
  ...
  9: [
    ...
    `Ao voltarem, os apóstolos relataram a Jesus o que tinham feito. Então ele os tomou, e retiraram-se para uma cidade chamada Betsaida;`,
    ...
    `Ele, porém, respondeu: “Deem-lhes vocês algo para comer”. Eles disseram: “Temos apenas cinco pães e dois peixes—a menos que compremos alimento para toda esta multidão”.`,
    `(E estavam ali cerca de cinco mil homens.) Mas ele disse aos seus discípulos: “Façam-nos sentar-se em grupos de cinquenta”.`,
    ...
    `Tendo-se ouvido a voz, Jesus ficou só. Os discípulos guardaram isto somente para si; naqueles dias, não contaram a ninguém o que tinham visto.`,
  ...
  10: [
    ...
    `Fiquem naquela casa e comam e bebam o que derem a vocês, pois o trabalhador merece o seu salário. Não fiquem mudando de casa em casa.`,
    ...
    `“Aquele que dá ouvidos a vocês está me dando ouvidos; aquele que os rejeita está me rejeitando; mas aquele que me rejeita está rejeitando aquele que me enviou”.`,
  ...
  11: [
    ...
    `“E o que estiver dentro responda: ‘Não me incomode. A porta já está fechada, e eu e meus filhos já estamos deitados. Não posso me levantar e dar a você o que me pede’.`,
    `Eu digo: Embora ele não se levante para dar-lhe o pão por ser seu amigo, por causa da importunação se levantará e lhe dará tudo o que precisar.`,
    ...
    `Aumentando a multidão, Jesus começou a dizer: “Esta é uma geração perversa. Ela pede um sinal milagroso, mas nenhum sinal lhe será dado, exceto o sinal de Jonas.`,
    ...
    `Os homens de Nínive se levantarão no juízo com esta geração e a condenarão; pois eles se arrependeram com a pregação de Jonas, e agora está aqui quem é maior do que Jonas.`,
    ...
    `Por isso, Deus disse em sua sabedoria: ‘Eu mandarei a vocês profetas e apóstolos, dos quais eles matarão alguns, e a outros perseguirão’.`,
    `Pelo que, esta geração será considerada responsável pelo sangue de todos os profetas, derramado desde o princípio do mundo:`,
    `desde o sangue de Abel até o sangue de Zacarias, que foi morto entre o altar e o santuário. Sim, eu digo a vocês, esta geração será considerada responsável por tudo isso.`,
  ...
  12: [
    `Nesse meio tempo, tendo-se juntado uma multidão de milhares de pessoas, ao ponto de atropelarem umas às outras, Jesus começou a falar primeiramente aos seus discípulos, dizendo: “Tenham cuidado com o fermento dos fariseus, que é a hipocrisia.`,
    ...
    `“Eu digo a vocês: Quem me confessar diante dos homens, também o Filho do homem o confessará diante dos anjos de Deus.`,
    ...
    `pois naquela hora o Espírito Santo ensinará o que deverão dizer”.`,
    ...
    `Dirigindo-se aos seus discípulos, Jesus acrescentou: “Portanto eu digo a vocês: Não se preocupem com sua própria vida, quanto ao que comer; nem com seu próprio corpo, quanto ao que vestir.`,
    ...
    `“Observem como crescem os lírios. Eles não trabalham nem tecem. Contudo, eu digo a vocês que nem Salomão, em todo o seu esplendor, vestiu-se como um deles.`,
    ...
    `Busquem, pois, o Reino de Deus, e essas coisas serão acrescentadas a vocês.`,
    ...
    `Felizes os servos cujo senhor os encontrar vigiando, quando voltar. Eu afirmo que ele se vestirá para servir, fará que se reclinem à mesa, e virá servi-los.`,
  ...
  13: [
    ...
    `Eis que a casa de vocês ficará deserta. Eu digo que vocês não me verão mais até que digam: ‘Bendito o que vem em nome do Senhor’ ”.`,
  ],
  14: [
    ...
    `Se for assim, aquele que convidou os dois virá e dirá: ‘Dê o lugar a este’. Então, humilhado, você precisará ocupar o lugar menos importante.`,
    `Mas quando você for convidado, ocupe o lugar menos importante, de forma que, quando vier aquele que o convidou, diga: ‘Amigo, passe para um lugar mais importante’. Então você será honrado na presença de todos os convidados.`,
    ...
    `“O servo voltou e relatou isso ao seu senhor. Então o dono da casa irou-se e ordenou ao seu servo: ‘Vá rapidamente para as ruas e os becos da cidade e traga os pobres, os aleijados, os cegos e os mancos’.`,
  ...
  18: [
    ...
    `Ao ouvir isso, disse-lhe Jesus: “Falta ainda uma coisa. Venda tudo o que você possui e dê o dinheiro aos pobres, e você terá um tesouro nos céus. Depois venha e siga-me”.`,
  ...
  19: [
    ...
    `Também a lançarão por terra, você e os seus filhos. Não deixarão pedra sobre pedra, porque você não reconheceu a oportunidade que Deus concedeu”.`,
  ...
  22: [
    ...
    `Então Jesus lhes perguntou: “Quando eu os enviei sem bolsa, saco de viagem ou sandálias, faltou alguma coisa?” “Nada”, responderam eles.`,
    ...
    `Todos os dias eu estive com vocês no templo e vocês não levantaram a mão contra mim. Mas esta é a hora de vocês—quando as trevas reinam”.`,
  ...
  24: [
    ...
    `Eu envio a vocês a promessa de meu Pai; mas fiquem na cidade até serem revestidos do poder do alto”.`,
