  ...
  return (
      open && (
        <>
          ...
          />
          <div
            className="fixed left-4 sm:left-1/2 sm:-translate-x-1/2 top-20 z-50 w-80 max-w-[90vw] bg-[var(--surface-raised)] border border-[var(--border)] rounded-xl shadow-2xl p-3 animate-slide-up"
          >
