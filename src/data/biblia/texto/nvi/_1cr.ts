const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `onde Davi reinou trinta e três anos, nasceram-lhe os seguintes filhos: Simeia, Sobabe, Natã e Salomão, os quatro filhos que ele teve com Bate-Seba , filha de Amiel.`,
    `Davi teve ainda mais nove filhos: Ibar, Elisua , Elpalete,`,
    `Nogá, Nefegue, Jafia,`,
    `Elisama, Eliada e Elifelete.`,
    `Todos esses foram filhos de Davi, além dos que teve com suas concubinas, e a filha Tamar, irmã deles.`,
  ...
  4: [
    ...
    `Estes foram os filhos de Selá, filho de Judá: Er, pai de Leca; Lada, pai de Maressa. Selá também foi antepassado dos clãs daqueles que trabalhavam com linho em Bete-Asbeia,`,
    ...
    `Encontraram muitas pastagens boas, numa região vasta, pacífica e tranquila, onde alguns camitas tinham vivido anteriormente.`,
  ...
  6: [
    ...
    `Estes são os que ministravam, junto com seus filhos: Entre os coatitas: O músico Hemã, filho de Joel, filho de Samuel,`,
    `filho de Elcana, filho de Jeroão, filho de Eliel, filho de Toá,`,
    `filho de Zufe, filho de Elcana, filho de Maate, filho de Amasai,`,
    `filho de Elcana, filho de Joel, filho de Azarias, filho de Sofonias,`,
    `filho de Taate, filho de Assir, filho de Ebiasafe, filho de Corá,`,
    `filho de Isar, filho de Coate, filho de Levi, filho de Israel.`,
    `À direita de Hemã ficava seu parente Asafe, filho de Berequias, filho de Simeia,`,
    ...
    `Estes foram os descendentes de Arão: o seu filho Eleazar, pai de Fineias, que foi o pai de Abisua,`,
  ...
  11: [
    ...
    `Abisai, o irmão de Joabe, era o chefe do batalhão dos Trinta. Com uma lança enfrentou trezentos homens e matou-os, tornando-se famoso como os três.`,
  ...
  13: [
    ...
    `Toda a assembleia concordou, pois isso pareceu bom a todo o povo.`,
  ...
  15: [
    ...
    `e com eles seus parentes que estavam no segundo escalão: Zacarias , Jaaziel, Semiramote, Jeiel, Uni, Eliabe, Benaia, Maaseias, Matitias, Elifeleu, Micneias, Obede-Edom e Jeiel , os porteiros.`,
    `Os músicos Hemã, Asafe e Etã deviam tocar os címbalos de bronze;`,
    `Zacarias, Aziel, Semiramote, Jeiel, Uni, Eliabe, Maaseias e Benaia deviam tocar as liras, acompanhando o soprano;`,
  ...
  16: [
    ...
    `Deem ao SENHOR a glória devida ao seu nome. Tragam ofertas e venham à sua presença. Adorem o SENHOR no esplendor da sua santidade,`,
  ...
  19: [
    ...
    `Quando Davi soube disso, enviou mensageiros ao encontro deles, pois haviam sido profundamente humilhados, e mandou dizer-lhes: “Fiquem em Jericó até que a barba cresça e, então, voltem para casa”.`,
    ...
    `Vendo Joabe que estava cercado pelas linhas de combate, escolheu alguns dos melhores soldados de Israel e posicionou-os contra os arameus.`,
  ...
  21: [
    ...
    `Davi olhou para cima e viu o anjo do SENHOR entre o céu e a terra, com uma espada na mão, erguida sobre Jerusalém. Então Davi e as autoridades de Israel, vestidos de luto, prostraram-se com o rosto em terra.`,
    ...
    `Nisso chegou Davi e, quando Araúna o viu, saiu da eira e prostrou-se diante de Davi com o rosto em terra.`,
  ...
  29: [
    ...
    `No dia seguinte fizeram sacrifícios ao SENHOR e apresentaram-lhe holocaustos : mil novilhos, mil carneiros e mil cordeiros, acompanhados de ofertas derramadas, e muitos outros sacrifícios, em favor de todo o Israel.`,
