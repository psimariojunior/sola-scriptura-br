const data: Record<number, string[]> = {
  ...
  15: [
    ...
    `Tinha dezesseis anos quando começou a reinar e cinquenta e dois anos reinou em Jerusalém. Era o nome de sua mãe Jecolias, de Jerusalém.`,
    ...
    `Descansou Azarias com seus pais, e o sepultaram junto a seus pais, na Cidade de Davi; e Jotão, seu filho, reinou em seu lugar.`,
    `No trigésimo oitavo ano de Azarias, rei de Judá, reinou Zacarias, filho de Jeroboão, sobre Israel, em Samaria, seis meses.`,
    `Fez o que era mau perante o SENHOR, como tinham feito seus pais; não se apartou dos pecados de Jeroboão, filho de Nebate, que fez pecar a Israel.`,
    ...
    `Salum, filho de Jabes, começou a reinar no trigésimo nono ano de Uzias, rei de Judá; e reinou durante um mês em Samaria.`,
    `Subindo de Tirza, Menaém, filho de Gadi, veio a Samaria, feriu ali a Salum, filho de Jabes, matou-o e reinou em seu lugar.`,
    `Quanto aos mais atos de Salum e a conspiração que fez, eis que estão escritos no Livro da História dos Reis de Israel.`,
    ...
    `Desde o trigésimo nono ano de Azarias, rei de Judá, Menaém, filho de Gadi, começou a reinar sobre Israel e reinou dez anos em Samaria.`,
    ...
    `No quinquagésimo ano de Azarias, rei de Judá, começou a reinar Pecaías, filho de Menaém; e reinou sobre Israel, em Samaria, dois anos.`,
    `Fez o que era mau perante o SENHOR; não se apartou dos pecados de Jeroboão, filho de Nebate, que fez pecar a Israel.`,
    `Peca, seu capitão, filho de Remalias, conspirou contra ele e o feriu em Samaria, na fortaleza da casa do rei, juntamente com Argobe e com Arié; com Peca estavam cinquenta homens dos gileaditas; Peca o matou e reinou em seu lugar.`,
    `Quanto aos mais atos de Pecaías e a tudo quanto fez, eis que estão escritos no Livro da História dos Reis de Israel.`,
    `No quinquagésimo segundo ano de Azarias, rei de Judá, começou a reinar Peca, filho de Remalias, e reinou sobre Israel, em Samaria, vinte anos.`,
    `Fez o que era mau perante o SENHOR; não se apartou dos pecados de Jeroboão, filho de Nebate, que fez pecar a Israel.`,
    `Nos dias de Peca, rei de Israel, veio Tiglate-Pileser, rei da Assíria, e tomou a Ijom, a Abel-Bete-Maaca, a Janoa, a Quedes, a Hazor, a Gileade e à Galileia, a toda a terra de Naftali, e levou os seus habitantes para a Assíria.`,
    ...
    `Quanto aos mais atos de Peca e a tudo quanto fez, eis que estão escritos no Livro da História dos Reis de Israel.`,
    `No ano segundo de Peca, filho de Remalias, rei de Israel, começou a reinar Jotão, filho de Uzias, rei de Judá.`,
    `Tinha vinte e cinco anos de idade quando começou a reinar e reinou dezesseis anos em Jerusalém. Era o nome de sua mãe Jerusa, filha de Zadoque.`,
    `Fez o que era reto perante o SENHOR; e em tudo procedeu segundo fizera Uzias, seu pai.`,
    `Tão somente os altos não se tiraram; o povo ainda sacrificava e queimava incenso nos altos. Ele edificou a Porta de Cima da Casa do SENHOR.`,
    `Quanto aos mais atos de Jotão e a tudo quanto fez, porventura, não estão escritos no Livro da História dos Reis de Judá?`,
    `Naqueles dias, começou o SENHOR a enviar contra Judá a Rezim, rei da Síria, e a Peca, filho de Remalias.`,
    `Descansou Jotão com seus pais e foi sepultado junto a seus pais, na Cidade de Davi, seu pai. Em seu lugar reinou Acaz, seu filho.`,
  ],
  16: [
