const data: Record<number, string[]> = {
  1: [
    ...
    `Peço que o Deus de nosso Senhor Jesus Cristo, o glorioso Pai, dê a vocês espírito de sabedoria e de revelação, no pleno conhecimento dele.`,
  ...
  3: [
    ...
    `de acordo com o eterno plano que ele realizou em Cristo Jesus, nosso Senhor,`,
  ...
  6: [
    ...
    `Tíquico, o irmão amado e fiel servo do Senhor, informará tudo a vocês, para que também saibam qual é a minha situação e o que estou fazendo.`,
