const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `O sacerdote queimará a porção memorial do cereal esmagado e do óleo, com todo o incenso, como uma oferta ao SENHOR preparada no fogo.`,
  ],
  3: [
  ...
  4: [
    ...
    `“Se for o sacerdote ungido que pecar, trazendo culpa sobre o povo, o sacerdote trará ao SENHOR um novilho sem defeito como oferta pelo pecado que cometeu.`,
    ...
    `Quando o conscientizarem do seu pecado, o líder trará como oferta um bode sem defeito.`,
    ...
    `Então o sacerdote pegará com o dedo um pouco do sangue da oferta pelo pecado e o porá nas pontas do altar dos holocaustos e derramará o restante do sangue na base do altar.`,
    `Retirará toda a gordura, como se retira a gordura do cordeiro do sacrifício de comunhão; o sacerdote a queimará no altar, em cima das ofertas dedicadas ao SENHOR, preparadas no fogo. Assim o sacerdote fará em favor do culpado propiciação pelo pecado cometido, e ele será perdoado.`,
  ],
  5: [
    ...
    `“Se alguém tocar qualquer coisa impura—seja um cadáver de animal selvagem, seja de animal do rebanho, seja de uma das pequenas criaturas que povoam a terra—, ainda que não tenha consciência disso, ele se tornará impuro e será culpado.`,
    ...
    `“Se alguém impensadamente jurar fazer algo bom ou mau em qualquer assunto que possa jurar descuidadamente ainda que não tenha consciência disso, será culpado quando o souber.`,
    `“Quando alguém for culpado de qualquer dessas coisas, confessará em que pecou`,
    `e, pelo pecado que cometeu, trará ao SENHOR uma ovelha ou uma cabra do rebanho como oferta de reparação; e em favor do culpado o sacerdote fará propiciação pelo pecado.`,
    ...
    `O sacerdote então oferecerá a outra ave como holocausto, de acordo com a forma prescrita, e fará propiciação em favor do culpado pelo pecado cometido, e ele será perdoado.`,
    ...
    `Assim o sacerdote fará propiciação em favor do culpado por qualquer desses pecados cometidos, e ele será perdoado. O restante da oferta pertence ao sacerdote, como no caso da oferta de cereal”.`,
    ...
    `Fará restituição pelo que deixou de fazer em relação às coisas consagradas, acrescentará um quinto do valor e o entregará ao sacerdote. Este fará propiciação pelo culpado com o carneiro da oferta pela culpa, e ele será perdoado.`,
    `“Se alguém pecar, fazendo o que é proibido em qualquer dos mandamentos do SENHOR, ainda que não o saiba, será culpado e sofrerá as consequências da sua iniquidade.`,
    `Do rebanho ele trará ao sacerdote um carneiro, sem defeito e devidamente avaliado, como oferta pela culpa. Assim o sacerdote fará propiciação em favor do culpado pelo erro que cometeu sem intenção, e ele será perdoado.`,
  ...
  6: [
    ...
    `Dessa forma, o sacerdote fará propiciação pelo culpado perante o SENHOR, e ele será perdoado de qualquer dessas coisas que fez e que o tornou culpado”.`,
    `O SENHOR disse a Moisés:`,
    ...
    `O sacerdote apanhará um punhado da melhor farinha com óleo, com todo o incenso que está sobre a oferta de cereal, e queimará no altar a porção memorial como aroma agradável ao SENHOR.`,
  ...
  7: [
    ...
    `os dois rins com a gordura que os cobre e que está perto dos lombos, e o lóbulo do fígado, que será removido com os rins.`,
    ...
    `“Se alguém a fizer por gratidão, então, com sua oferta de gratidão, terá que oferecer bolos sem fermento e amassados com óleo, pães finos sem fermento e untados com óleo, e bolos da melhor farinha bem amassados e misturados com óleo.`,
  ...
  8: [
    ...
    `pôs a túnica em Arão, colocou-lhe o cinto e o manto e pôs sobre este o colete sacerdotal; depois a ele prendeu o manto sacerdotal com o cinturão;`,
    `colocou também o peitoral, no qual pôs o Urim e o Tumim ;`,
    ...
    `Moisés também mandou que os filhos de Arão se aproximassem e sobre cada um pôs um pouco do sangue na ponta da orelha direita, no polegar da mão direita e no polegar do pé direito; derramou o restante do sangue nos lados do altar.`,
    ...
    `A seguir pegou um pouco do óleo da unção e um pouco do sangue que estava no altar e os aspergiu sobre Arão e suas vestes, bem como sobre seus filhos e suas vestes. Assim consagrou Arão e suas vestes; seus filhos e suas vestes.`,
  ...
  10: [
    ...
    `“Por que vocês não comeram a carne da oferta pelo pecado no Lugar Santo? É santíssima; foi dada para retirar a culpa da comunidade e fazer propiciação por ela perante o SENHOR.`,
  ...
  13: [
    ...
    `Este examinará a parte afetada da pele, e, se naquela parte o pelo tiver se tornado branco e o lugar parecer mais profundo do que a pele, é sinal de lepra. Depois de examiná-lo, o sacerdote o declarará impuro.`,
    `Se a mancha na pele for branca, mas não parecer mais profunda do que a pele e sobre ela o pelo não tiver se tornado branco, o sacerdote o porá em isolamento por sete dias.`,
    ...
    `Este o examinará e, se houver inchaço branco na pele, o qual tenha tornado branco o pelo, e se houver carne viva no inchaço,`,
    ...
    `este a examinará e, se observar que a lepra cobriu todo o corpo, ele a declarará pura. Visto que tudo tenha ficado branco, ela está pura.`,
    ...
    `Este a examinará e, se a parte afetada tiver se tornado branca, o sacerdote declarará pura a pessoa infectada, a qual então estará pura.`,
    ...
    `Este examinará o local e, se parecer mais profundo do que a pele e o pelo ali tiver se tornado branco, o sacerdote o declarará impuro. É sinal de lepra que se alastrou onde estava a ferida.`,
    `Mas, se quando o sacerdote o examinar não houver nenhum pelo branco e o lugar não estiver mais profundo do que a pele e tiver diminuído, então o sacerdote o porá em isolamento por sete dias.`,
    ...
    `o sacerdote examinará a mancha e, se o pelo sobre ela tiver se tornado branco e ela parecer mais profunda do que a pele, é lepra que surgiu na queimadura. O sacerdote o declarará impuro; é sinal de lepra na pele.`,
    `Mas, se o sacerdote examinar a mancha e nela não houver pelo branco e esta não estiver mais profunda do que a pele e tiver diminuído, então o sacerdote o porá em isolamento por sete dias.`,
    ...
    `o sacerdote examinará a ferida e, se ela parecer mais profunda do que a pele e o pelo nela for amarelado e fino, o sacerdote declarará impura aquela pessoa; é sarna, isto é, lepra da cabeça ou do queixo.`,
    `Mas, se quando o sacerdote examinar o sinal de sarna este não parecer mais profundo do que a pele e não houver pelo escuro nela, então o sacerdote porá a pessoa infectada em isolamento por sete dias.`,
    `No sétimo dia o sacerdote examinará a parte afetada e, se a sarna não tiver se espalhado e não houver pelo amarelado nela e não parecer mais profunda do que a pele,`,
    ...
    `o sacerdote a examinará e, se a sarna tiver se espalhado pela pele, o sacerdote não precisará procurar pelo amarelado; a pessoa está impura.`,
    `Se, entretanto, verificar que não houve alteração e cresceu pelo escuro, a sarna está curada. A pessoa está pura, e o sacerdote a declarará pura.`,
    ...
    `Depois de lavado o objeto afetado, o sacerdote o examinará e, se a mancha não tiver alterado sua cor, ainda que não tenha se espalhado, o objeto estará impuro. Queime-o com fogo, quer o mofo corrosivo tenha afetado um lado do objeto quer o outro.`,
  ...
  14: [
    ...
    `e o oferecerá sobre o altar com a oferta de cereal; e assim fará propiciação pelo ofertante, o qual estará puro.`,
    `“Se, todavia, o ofertante for pobre, sem recursos para isso, pegará um cordeiro como oferta pela culpa, o qual será movido para fazer propiciação pelo ofertante, com um jarro da melhor farinha, amassada com óleo, como oferta de cereal, uma caneca de óleo`,
    `e duas rolinhas ou dois pombinhos, conforme os seus recursos, um como oferta pelo pecado e o outro como holocausto.`,
    `“No oitavo dia o ofertante os trará, para a sua purificação, ao sacerdote, à entrada da Tenda do Encontro, perante o SENHOR.`,
  ...
  15: [
    ...
    `“Quaisquer pessoas tocadas pelo homem com fluxo, sem que este tenha lavado as mãos, lavarão as suas roupas, se banharão com água e ficarão impuras até a tarde.`,
    `“A vasilha de barro na qual ele tocar será quebrada; se tocar numa vasilha de madeira, ela será lavada.`,
    `“Quando um homem sarar de seu fluxo, contará sete dias para a sua purificação; lavará as suas roupas, se banhará em água corrente e ficará puro.`,
    ...
    `Quem tocar em alguma coisa sobre a qual ela se sentar lavará as suas roupas, se banhará com água e estará impuro até a tarde.`,
  ...
  16: [
    ...
    `Então colocará as duas mãos sobre a cabeça do bode vivo e confessará todas as iniquidades e rebeliões dos israelitas, todos os seus pecados, e os porá sobre a cabeça do bode. Em seguida, enviará o bode para o deserto aos cuidados de um homem designado para isso.`,
    ...
    `e fará propiciação pelo Lugar Santíssimo, pela Tenda do Encontro, pelo altar, por todos os sacerdotes e por todo o povo da assembleia.`,
  ...
  19: [
    ...
    `Com o carneiro da oferta pela culpa, o sacerdote fará propiciação pelo ofertante perante o SENHOR, pelo pecado que cometeu; assim o pecado que ele cometeu será perdoado.`,
  ...
  20: [
    ...
    `“Se um homem tomar por mulher sua irmã, filha de seu pai ou de sua mãe, e se envolver sexualmente com ela, pratica um ato vergonhoso. Serão eliminados à vista de todo o povo. Esse homem desonrou sua irmã e sofrerá as consequências da sua iniquidade.`,
    ...
    `“Não se envolva sexualmente com a irmã de sua mãe nem com a irmã de seu pai; pois quem se envolver sexualmente com uma parenta próxima sofrerá as consequências da sua iniquidade.`,
    `“Se um homem se deitar com a mulher do seu tio, desonrou seu tio. Eles sofrerão as consequências do seu pecado; morrerão sem filhos.`,
    `“Se um homem tomar por mulher a mulher do seu irmão, comete impureza; desonrou seu irmão. Ficarão sem filhos.`,
    `“Obedeçam a todos os meus decretos e leis e pratiquem-nos, para que a terra para onde os estou levando para nela habitar não os vomite.`,
  ...
  23: [
    ...
    `Disse o SENHOR a Moisés:`,
    `“Diga o seguinte aos israelitas: Quando vocês entrarem na terra que dou a vocês e fizerem colheita, tragam ao sacerdote um feixe do primeiro cereal que colherem.`,
    ...
    `No dia em que moverem o feixe, vocês oferecerão em holocausto ao SENHOR um cordeiro de um ano de idade sem defeito.`,
    ...
    `Junto com os pães apresentem sete cordeiros, cada um com um ano de idade e sem defeito, um novilho e dois carneiros. Eles serão um holocausto ao SENHOR, com as suas ofertas de cereal e ofertas derramadas; é oferta preparada no fogo, de aroma agradável ao SENHOR.`,
    ...
    `Naquele mesmo dia, vocês proclamarão uma reunião sagrada e não realizarão trabalho algum. Este é um decreto perpétuo para as suas gerações, onde quer que morarem.`,
    ...
    `É um sábado de descanso para vocês, no qual vocês se humilharão. Desde o entardecer do nono dia do mês até o entardecer do dia seguinte vocês guardarão esse sábado”.`,
    `Disse o SENHOR a Moisés:`,
    ...
    `Durante sete dias apresentem ao SENHOR ofertas preparadas no fogo, no oitavo dia façam outra reunião sagrada e também apresentem ao SENHOR uma oferta preparada no fogo. É reunião solene; não realizem trabalho algum.`,
  ...
  25: [
    ...
    `“Diga o seguinte aos israelitas: Quando entrarem na terra que dou a vocês, a própria terra guardará um sábado para o SENHOR.`,
    ...
    `Consagrem o quinquagésimo ano e proclamem libertação por toda a terra a todos os seus moradores. Este será um ano de jubileu, quando cada um de vocês voltará para a propriedade da sua família e para o seu próprio clã.`,
    `O quinquagésimo ano será jubileu; não semeiem e não ceifem o que cresce por si mesmo nem colham das vinhas não podadas.`,
  ...
  26: [
    ...
    `“Guardem os meus sábados e reverenciem o meu santuário. Eu sou o SENHOR.`,
    `“Se vocês seguirem os meus decretos, obedecerem aos meus mandamentos e os puserem em prática,`,
    ...
    `e desprezarem os meus decretos, rejeitarem as minhas ordenanças, deixarem de pôr em prática todos os meus mandamentos e forem infiéis à minha aliança,`,
    `então assim os tratarei: eu trarei sobre vocês pavor repentino, doenças e febre que tirarão a sua visão e definharão a sua vida. Vocês semearão inutilmente, porque os seus inimigos comerão as suas sementes.`,
    ...
    `Quando eu cortar o suprimento de pão, dez mulheres assarão o pão num único forno e repartirão o pão a peso. Vocês comerão, mas não ficarão satisfeitos.`,
    ...
    `Espalharei vocês entre as nações e empunharei a espada contra vocês. Sua terra ficará desolada; as suas cidades, em ruínas.`,
  ...
  27: [
    ...
    `Se quem fizer o voto for pobre demais para pagar o valor especificado, deverá ser apresentado ao sacerdote, que estabelecerá o valor de acordo com as possibilidades do homem que fez o voto.`,
