const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Mas agora o não tenhas por inculpavel, pois és homem sabio, e bem saberás o que lhe has de fazer para que faças com que as suas cãs desçam á sepultura com sangue`,
  ...
  3: [
    `E Salomão se aparentou com Pharaó, rei do Egypto: e tomou a filha de Pharaó, e a trouxe á cidade de David, até que acabasse de edificar a sua casa, e a casa do Senhor, e a muralha de Jerusalem em roda`,
    ...
    `E Salomão amava ao Senhor, andando nos estatutos de David seu pae: sómente que nos altos sacrificava, e queimava incenso.`,
    `E foi o rei a Gibeon para lá sacrificar, porque aquelle era o alto grande: mil holocaustos sacrificou Salomão n'aquelle altar.`,
    `E em Gibeon appareceu o Senhor a Salomão de noite em sonhos: e disse-lhe Deus: Pede o que quizeres que te dê.`,
    `E disse Salomão: De grande beneficencia usaste tu com teu servo David meu pae, como tambem elle andou comtigo em verdade, e em justiça, e em rectidão de coração, perante a tua face: e guardaste-lhe esta grande beneficencia, e lhe déste um filho que se assentasse no seu throno, como se vê n'este dia.`,
    `Agora pois, ó Senhor meu Deus, tu fizeste reinar a teu servo em logar de David meu pae: e sou ainda menino pequeno; nem sei sair, nem entrar.`,
    ...
    `Eis que fiz segundo as tuas palavras: eis que te dei um coração tão sabio e entendido, que antes de ti teu egual não houve, e depois de ti teu egual se não levantará.`,
    ...
    `E acordou Salomão, e eis que era sonho. E veiu a Jerusalem, e poz-se perante a arca do concerto do Senhor, e sacrificou holocaustos, e preparou sacrificios pacificos, e fez um banquete a todos os seus servos.`,
    `Então vieram duas mulheres prostitutas ao rei, e se pozeram perante elle.`,
    `E disse-lhe uma das mulheres: Ah! senhor meu, eu e esta mulher moramos n'uma casa; e pari, morando com ella n'aquella casa.`,
    ...
    `Mas a mulher, cujo filho era o vivo, fallou ao rei (porque as suas entranhas se lhe enterneceram por seu filho), e disse: Ah! senhor meu, dae-lhe o menino vivo, e por modo nenhum o mateis. Porém a outra dizia: Nem teu nem meu seja; dividi-o antes.`,
  ...
  5: [
    `E enviou Hirão, rei de Tyro, os seus servos a Salomão (porque ouvira que ungiram a Salomão rei em logar de seu pae), porquanto Hirão sempre tinha amado a David.`,
    ...
    `Porém agora o Senhor meu Deus me tem dado descanço de todos os lados: adversario não ha, nem algum mau encontro.`,
    `E eis que eu, meu Deus, intento edificar uma casa ao nome do Senhor, como fallou o Senhor a David, meu pae, dizendo: Teu filho, que porei em teu logar no teu throno, elle edificará uma casa ao meu nome.`,
    `Dá ordem pois agora que do Libano me cortem cedros, e os meus servos estarão com os teus servos, e eu te darei a soldada dos teus servos, conforme a tudo o que disseres; porque bem sabes tu que entre nós ninguem ha que saiba cortar a madeira como os sidonios.`,
    `E aconteceu que, ouvindo Hirão as palavras de Salomão, muito se alegrou, e disse: Bemdito seja hoje o Senhor, que deu a David um filho sabio sobre este tão grande povo.`,
    ...
    `E Salomão deu a Hirão vinte mil coros de trigo, para sustento da sua casa, e vinte coros de azeite batido: isto dava Salomão a Hirão de anno em anno.`,
    ...
    `E os enviou ao Libano, cada mez dez mil por suas vezes: um mez estavam no Libano, e dois mezes cada um em sua casa: e Adoniram estava sobre a leva de gente.`,
    ...
    `E as lavravam os edificadores de Hirão e os giblitas: e preparavam a madeira e as pedras para edificar a casa.`,
  ],
  6: [
    `E Succedeu que no anno de quatrocentos e oitenta, depois de sairem os filhos de Israel do Egypto, no anno quarto do reinado de Salomão sobre Israel, no mez de Ziv (este é o mez segundo), começou a edificar a casa do Senhor.`,
    ...
    `Edificou em redor da parede da casa camaras, em redor das paredes da casa, tanto do templo como do oraculo: e assim lhe fez camaras collateraes em redor.`,
    `A camara de baixo era de cinco covados de largura, e a do meio de seis covados de largura, e a terceira de sete covados de largura; porque pela parte de fóra da casa em redor fizera encostos, para não travarem das paredes da casa.`,
    ...
    `A porta da camara do meio estava á banda direita da casa, e por corações se subia á do meio, e da do meio á terceira.`,
    ...
    `Quanto a esta casa que tu edificas, se andares nos meus estatutos, e fizeres os meus juizos, e guardares todos os meus mandamentos, andando n'elles, confirmarei para comtigo a minha palavra, a qual fallei a David, teu pae;`,
    ...
    `Tambem cobriu as paredes da casa por dentro com taboas de cedro; desde o soalho da casa até ao tecto tudo cobriu com madeira por dentro: e cobriu o soalho da casa com taboas de faia.`,
    ...
    `E o oraculo no interior era de vinte covados de comprimento, e de vinte covados de largura, e de vinte covados de altura: e o cobriu de oiro puro: tambem cobriu de cedro o altar.`,
    `E cobriu Salomão a casa por dentro de oiro puro: e com cadeias de oiro poz um véu diante do oraculo, e o cobriu com oiro.`,
    ...
    `Assim era tambem de dez covados o outro cherubim: ambos os cherubins eram d'uma mesma medida e d'um mesmo talhe.`,
    `A altura d'um cherubim de dez covados, e assim a do outro cherubim.`,
    `E poz a estes cherubins no meio da casa de dentro; e os cherubins estendiam as azas, de maneira que a aza d'um tocava na parede, e a aza do outro cherubim tocava na outra parede: e as suas azas no meio da casa tocavam uma na outra.`,
    ...
    `E á entrada do oraculo fez portas de madeira olearia: o umbral de cima com as hombreiras faziam a quinta parte da parede.`,
    `Tambem as duas portas eram de madeira olearia; e lavrou n'ellas entalhes de cherubins, e de palmas, e de flores abertas, os quaes cobriu de oiro: tambem estendeu oiro sobre os cherubins e sobre as palmas.`,
    `E assim fez á porta do templo hombreiras de madeira olearia, da quarta parte da parede.`,
    `E eram as duas portas de madeira de faia; e as duas folhas d'uma porta eram dobradiças, assim como eram tambem dobradiças as duas folhas entalhadas das outras portas.`,
    `E as lavrou de cherubins, e de palmas, e de flores abertas, e as cobriu de oiro acommodado ao lavor.`,
    ...
    `E no anno undecimo, no mez de Bul, que é o mez oitavo, se acabou esta casa com todos os seus apparelhos, e com tudo o que lhe convinha: e a edificou em sete annos.`,
  ],
  7: [
    `Porém a sua casa edificou Salomão em treze annos: e acabou toda a sua casa.`,
    `Tambem edificou a casa do bosque do Libano de cem covados de comprimento, e de cincoenta covados de largura, e de trinta covados de altura, sobre quatro ordens de columnas de cedro, e vigas de cedro sobre as columnas.`,
    ...
    `Depois fez um portico de columnas de cincoenta covados de comprimento e de trinta covados de largura; e o portico estava defronte d'ellas, e as columnas com as grossas vigas defronte d'ellas.`,
    `Tambem fez o portico para o throno onde julgava, para portico do juizo, que estava coberto de cedro de soalho a soalho.`,
    `E em sua casa em que morava havia outro pateo por dentro do portico, de obra similhante a este: tambem para a filha de Pharaó, que Salomão tomara por mulher, fez uma casa similhante áquelle portico.`,
    ...
    `Tambem estava fundado sobre pedras finas, pedras grandes; sobre pedras de dez covados e pedras de oito covados.`,
    `E em cima sobre pedras finas, lavradas segundo as medidas, e cedros.`,
    `E era o pateo grande em redor de tres ordens de pedras lavradas, com uma ordem de vigas de cedro: assim era tambem o pateo interior da casa do Senhor e o portico d'aquella casa.`,
    `E enviou o rei Salomão, e mandou trazer a Hirão de Tyro.`,
    `Era este filho d'uma mulher viuva, da tribu de Naphtali, e fôra seu pae um homem de Tyro, que trabalhava em cobre; e era cheio de sabedoria, e de entendimento, e de sciencia para fazer toda a obra de cobre: este veiu ao rei Salomão, e fez toda a sua obra.`,
    `Porque formou duas columnas de cobre: a altura de cada columna era de dezoito covados, e um fio de doze covados cercava cada uma das columnas.`,
    ...
    `As redes eram de obra de rede, as ligas de obra de cadeia para os capiteis que estavam sobre a cabeça das columnas, sete para um capitel e sete para o outro capitel.`,
    ...
    `Depois levantou as columnas no portico do templo: e levantando a columna direita, chamou o seu nome Jachin; e levantando a columna esquerda, chamou o seu nome Boaz.`,
    `E sobre a cabeça das columnas estava a obra de lirios: e assim se acabou a obra das columnas.`,
    `Fez mais o mar de fundição, de dez covados d'uma borda até á outra borda, redondo ao redor, e de cinco covados de alto; e um cordão de trinta covados o cingia em redor.`,
    `E por baixo da sua borda em redor havia botões que o cingiam; por dez covados cercavam aquelle mar em redor; duas ordens d'estes botões foram fundidas na sua fundição.`,
    ...
    `Fez tambem as dez bases de cobre: o comprimento d'uma base de quatro covados, e de quatro covados a sua largura, e tres covados a sua altura.`,
    ...
    `E a sua bocca estava dentro da corôa, e d'um covado por cima: e era a sua bocca redonda da obra da base de covado e meio: e tambem sobre a sua bocca havia entalhes, e as suas cintas eram quadradas, não redondas.`,
    `E as quatro rodas estavam debaixo das cintas, e os eixos das rodas na base: e era a altura de cada roda de covado e meio.`,
    `E era a obra das rodas como a obra da roda de carro: seus eixos, e suas caibras, e seus cubos, e seus raios, todos eram fundidos.`,
    ...
    `Tambem fez duas pias de cobre: em cada pia cabiam quarenta batos, e cada pia era de quatro covados, e sobre cada uma das dez bases estava uma pia.`,
    ...
    `A saber: as duas columnas, e os globos dos capiteis que estavam sobre a cabeça das duas columnas: e as duas redes, para cobrir os dois globos dos capiteis que estavam sobre a cabeça das columnas.`,
    `E as quatrocentas romãs para as duas redes, a saber: duas carreiras de romãs para cada rede, para cobrirem os dois globos dos capiteis que estavam em cima das columnas;`,
    ...
    `Na planicie do Jordão, o rei os fundiu, em terra barrenta: entre Succoth e Zarthan.`,
    ...
    `E os castiçaes, cinco á direita e cinco á esquerda, diante do oraculo, d'oiro finissimo; e as flores, e as lampadas, e os espivitadores, tambem d'oiro.`,
    `Como tambem as taças, e os apagadores, e as bacias, e os perfumadores, e os brazeiros, de oiro finissimo: e as couceiras para as portas da casa interior para o logar sanctissimo, e as das portas da casa do templo, tambem d'oiro.`,
    `Assim se acabou toda a obra que fez o rei Salomão para a casa do Senhor: então trouxe Salomão as coisas sanctas de seu pae David; a prata, e o oiro, e os vasos poz entre os thesouros da casa do Senhor.`,
  ],
  8: [
  ...
  9: [
    `Succedeu pois que, acabando Salomão de edificar a casa do Senhor, e a casa do rei, e todo o desejo de Salomão, que lhe veiu á vontade fazer,`,
    ...
    `Então confirmarei o throno de teu reino sobre Israel para sempre: como fallei ácerca de teu pae David, dizendo: Não te faltará varão sobre o throno d'Israel:`,
    `Porém se vós e vossos filhos de qualquer maneira vos apartardes de apoz mim, e não guardardes os meus mandamentos, e os meus estatutos, que vos tenho proposto, mas fôrdes, e servirdes a outros deuses, e vos curvardes perante elles,`,
    `Então destruirei a Israel da terra que lhes dei; e a esta casa, que sanctifiquei a meu nome, lançarei longe da minha presença: e Israel será por ditado e mote, entre todos os povos.`,
    `E esta casa será tão exaltada, que todo aquelle que por ella passar pasmará, e assobiará, e dirá: Porque fez o Senhor assim a esta terra e a esta casa`,
    `E dirão: Porque deixaram ao Senhor seu Deus, que tirou da terra do Egypto a seus paes, e se apegaram a deuses alheios, e se encurvaram perante elles, e os serviram: por isso trouxe o Senhor sobre elles todo este mal.`,
    ...
    `E esta é a causa do tributo que impoz o rei Salomão, para edificar a casa do Senhor e a sua casa e Millo, e o muro de Jerusalem, como tambem a Hasor, e a Megiddo, e a Gezer.`,
    ...
    `E a todas as cidades das munições que Salomão tinha, e as cidades dos carros, e as cidades dos cavalleiros, e o que o desejo de Salomão quiz edificar em Jerusalem, e no Libano, e em toda a terra do seu dominio.`,
    `Quanto a todo o povo que restou dos amorrheos, hetheos, pherezeos, heveos, e jebuseos, e que não eram dos filhos de Israel,`,
    `A seus filhos, que restaram depois d'elles na terra, os quaes os filhos de Israel não poderam destruir totalmente, Salomão os reduziu a tributo servil, até hoje.`,
    `Porém dos filhos de Israel não fez Salomão servo algum: porém eram homens de guerra, e seus creados, e seus principes, e seus capitães, e chefes dos seus carros e dos seus cavalleiros.`,
    `Estes eram os chefes dos officiaes que estavam sobre a obra de Salomão, quinhentos e cincoenta, que davam ordens ao povo que trabalhava na obra.`,
    `Subiu porém a filha de Pharaó da cidade de David á sua casa, que Salomão lhe edificara; então edificou a Millo.`,
    `E offerecia Salomão tres vezes cada anno holocaustos e sacrificios pacificos sobre o altar que edificaram ao Senhor, e queimava incenso sobre o que estava perante o Senhor: e assim acabou a casa.`,
  ...
  12: [
    ...
    `Succedeu pois que, ouvindo-o Jeroboão, filho de Nebat, estando ainda no Egypto (porque fugira de diante do rei Salomão, e habitava Jeroboão no Egypto),`,
    `Enviaram, e o mandaram chamar; e Jeroboão e toda a congregação d'Israel vieram, e fallaram a Roboão, dizendo:`,
    `Teu pae aggravou o nosso jugo; agora, pois, allivia tu a dura servidão de teu pae, e o seu pesado jugo que nos impoz, e nós te serviremos.`,
    ...
    `E elles lhe fallaram, dizendo: Se hoje fores servo d'este povo, e o servires, e, respondendo-lhe, lhe fallares boas palavras, todos os dias teus servos serão.`,
    ...
    `Veiu pois Jeroboão e todo o povo, ao terceiro dia, a Roboão, como o rei havia fallado, dizendo: Voltae a mim ao terceiro dia.`,
    `E o rei respondeu ao povo duramente; porque deixara o conselho que os anciãos lhe haviam aconselhado.`,
    `E lhe fallou conforme ao conselho dos mancebos, dizendo: Meu pae aggravou o vosso jugo, porém eu ainda augmentarei o vosso jugo; meu pae vos castigou com açoites, porém eu vos castigarei com escorpiões.`,
    `O rei pois não deu ouvidos ao povo; porque esta revolta vinha do Senhor, para confirmar a sua palavra que o Senhor tinha dito pelo ministerio de Ahias, o silonita, a Jeroboão, filho de Nebat.`,
    `Vendo pois todo o Israel que o rei não lhe dava ouvidos, tornou-lhe o povo a responder, dizendo: Que parte temos nós com David? e não ha para nós herança no filho de Jessé. Ás tuas tendas, ó Israel! Provê agora a tua casa, ó David. Então Israel se foi ás suas tendas`,
    ...
    `Vindo pois Roboão a Jerusalem, ajuntou toda a casa de Judah e a tribu de Benjamin, cento e oitenta mil escolhidos, destros para a guerra, para pelejar contra a casa d'Israel, para restituir o reino a Roboão, filho de Salomão.`,
    ...
    `Assim diz o Senhor: Não subireis nem pelejareis contra vossos irmãos, os filhos d'Israel; volte cada um para a sua casa, porque eu é que fiz esta obra. E ouviram a palavra do Senhor, e voltaram segundo a palavra do Senhor.`,
    ...
    `Se este povo subir para fazer sacrificios na casa do Senhor, em Jerusalem, o coração d'este povo se tornará a seu senhor, a Roboão, rei de Judah: e me matarão, e tornarão a Roboão, rei de Judah.`,
    ...
    `E fez Jeroboão uma festa no oitavo mez, no dia decimo quinto do mez, como a festa que se fazia em Judah, e sacrificou no altar; similhantemente fez em Bethel, sacrificando os bezerros que fizera: tambem em Bethel estabeleceu sacerdotes dos altos que fizera.`,
    `E sacrificou no altar que fizera em Bethel, no dia decimo quinto do oitavo mez, que elle tinha imaginado no seu coração: assim fez a festa aos filhos de Israel, e sacrificou no altar, queimando incenso.`,
  ],
  13: [
    ...
    `E clamou contra o altar com a palavra do Senhor, e disse: Altar, altar! assim diz o Senhor: Eis que um filho nascerá á casa de David, cujo nome será Josias, o qual sacrificará sobre ti os sacerdotes dos altos que queimam sobre ti incenso, e ossos de homens se queimarão sobre ti.`,
    ...
    `Succedeu pois, que, ouvindo o rei a palavra do homem de Deus, que clamara contra o altar de Bethel, Jeroboão estendeu a sua mão de sobre o altar, dizendo: Pegae d'elle. Mas a sua mão, que estendera contra elle, se seccou, e não a podia tornar a trazer a si.`,
    `E o altar se fendeu, e a cinza se derramou do altar; segundo o signal que o homem de Deus apontara pela palavra do Senhor.`,
    `Então respondeu o rei, e disse ao homem de Deus: Ora á face do Senhor teu Deus, e roga por mim, que a minha mão se me restitua. Então o homem de Deus orou á face do Senhor, e a mão do rei se lhe restituiu, e ficou como d'antes.`,
    ...
    `E morava em Bethel um propheta velho; e veiu seu filho, e contou-lhe tudo o que o homem de Deus fizera aquelle dia em Bethel, e as palavras que dissera ao rei; e as contaram a seu pae.`,
    ...
    `Então disse a seus filhos: Albardae-me um jumento. E albardaram-lhe o jumento, e montou n'elle.`,
    `E foi-se apoz o homem de Deus, e o achou assentado debaixo d'um carvalho: e disse-lhe: És tu o homem de Deus que vieste de Judah? E elle disse: Eu sou.`,
    ...
    `Porque me foi mandado pela palavra do Senhor: Ali nem comerás pão, nem beberás agua; nem tornarás a ir pelo caminho por que foste.`,
    ...
    `E eis que os homens passaram, e viram o corpo lançado no caminho, como tambem o leão, que estava junto ao corpo: e vieram, e o disseram na cidade onde o propheta velho habitava.`,
    ...
    `Então foi, e achou o seu cadaver lançado no caminho, e o jumento e o leão, que estavam parados junto ao cadaver: o leão não tinha devorado o corpo, nem tinha despedaçado o jumento.`,
    ...
    `Depois d'estas coisas, Jeroboão não tornou do seu máu caminho; antes dos mais baixos do povo tornou a fazer sacerdotes dos logares altos; a quem queria lhe enchia a mão, e assim era um dos sacerdotes dos logares altos.`,
  ...
  14: [
    ...
    `E disse Jeroboão a sua mulher: Levanta-te agora, e disfarça-te, para que não conheçam que és mulher de Jeroboão: e vae a Silo. Eis que lá está o propheta Ahias, o qual fallou de mim, que eu seria rei sobre este povo.`,
    ...
    `Porém o Senhor disse a Ahias: Eis que a mulher de Jeroboão vem consultar-te sobre seu filho, porque está doente: assim e assim lhe fallarás: e ha de ser que, entrando ella, fingirá ser outra.`,
    `E succedeu que, ouvindo Ahias o ruido de seus pés, entrando ella pela porta, disse elle: Entra, mulher de Jeroboão: porque te disfarças assim? pois eu sou enviado a ti com duras novas.`,
    ...
    `E rasguei o reino da casa de David, e a ti t'o dei, e tu não foste como o meu servo David, que guardou os meus mandamentos e que andou após mim com todo o seu coração para fazer sómente o que parecia recto aos meus olhos,`,
    ...
    `Portanto, eis que trarei mal sobre a casa de Jeroboão, e destruirei de Jeroboão todo o homem até ao menino, tanto o encerrado como o desamparado em Israel; e lançarei fóra os descendentes da casa de Jeroboão, como se lança fóra o esterco, até que de todo se acabe`,
    ...
    `E todo o Israel o pranteará, e o sepultará; porque este só entrará em sepultura de Jeroboão, porquanto se achou n'elle coisa boa para com o Senhor Deus de Israel em casa de Jeroboão.`,
    `O Senhor porém levantará para si um rei sobre Israel, que destruirá a casa de Jeroboão no mesmo dia: mas que será tambem agora?`,
    `Tambem o Senhor ferirá a Israel como se move a cana nas aguas; e arrancará a Israel d'esta boa terra que tinha dado a seus paes, e o espargirá para além do rio; porquanto fizeram os seus bosques, provocando o Senhor á ira.`,
    ...
    `E Roboão, filho de Salomão, reinava em Judah: de quarenta e um annos de edade era Roboão quando começou a reinar, e dezesete annos reinou em Jerusalem, na cidade que o Senhor elegera de todas as tribus de Israel para pôr ali o seu nome: e era o nome de sua mãe Naama, ammonita.`,
    ...
    `E Roboão dormiu com seus paes, e foi sepultado com seus paes na cidade de David: e era o nome de sua mãe Naama, ammonita: e Abião, seu filho, reinou em seu logar.`,
  ],
  15: [
    ...
    `Quanto ao mais dos successos de Abião, e a tudo quanto fez, porventura não está escripto no livro das chronicas dos reis de Judah? Tambem houve guerra entre Abião e Jeroboão.`,
    ...
    `E até a Maaca, sua mãe, removeu para que não fosse rainha, porquanto tinha feito um horrivel idolo a Asera: tambem Asa desfez o seu idolo horrivel, e o queimou junto ao ribeiro de Cedron.`,
    `Os altos porém se não tiraram: todavia foi o coração de Asa recto para com o Senhor todos os seus dias.`,
    `E á casa do Senhor trouxe as coisas consagradas de seu pae, e as coisas que elle mesmo consagrara: prata e oiro, e vasos.`,
    ...
    `Então Asa tomou toda a prata e oiro que ficara nos thesouros da casa do Senhor, e os thesouros da casa do rei, e os entregou nas mãos de seus servos: e o rei Asa os enviou a Benhadad, filho de Tabrimmon, filho de Hezion, rei da Syria, que habitava em Damasco, dizendo:`,
    `Alliança ha entre mim e ti, entre meu pae e teu pae: vês aqui que te mando um presente, prata e oiro; vae, e annulla a tua alliança com Baása, rei d'Israel, para que se retire de sobre mim`,
    `E Benhadad deu ouvidos ao rei Asa, e enviou aos capitães dos exercitos que tinha contra as cidades d'Israel; e feriu a Ijon, e a Dan, e a Abel, de Beth-maaca, e a toda a Chinneroth, com toda a terra de Naphtali.`,
    ...
    `Quanto ao mais de todos os successos de Asa, e a todo o seu poder, e a tudo quanto fez, e as cidades que edificou, porventura não está escripto no livro das chronicas dos reis de Judah? Porém, no tempo da sua velhice, padeceu dos pés.`,
  ...
  16: [
    ...
    `Porquanto te levantei do pó, e te puz por chefe sobre o meu povo Israel, e tu andaste no caminho de Jeroboão, e fizeste peccar a meu povo Israel, irritando-me com os seus peccados,`,
    ...
    `E Achab, filho de Omri, começou a reinar sobre Israel no anno trigesimo oitavo d'Asa, rei de Judah: e reinou Achab, filho de Omri, sobre Israel em Samaria vinte e dois annos.`,
    `E fez Achab, filho de Omri, o que parecia mal aos olhos do Senhor, mais do que todos os que foram antes d'elle.`,
    `E succedeu que (como se fôra coisa leve andar nos peccados de Jeroboão, filho de Nebat) ainda tomou por mulher a Jezabel, filha de Ethbaal, rei dos sidonios: e foi e serviu a Baal, e se encurvou diante d'elle.`,
    ...
    `Em seus dias Hiel, o bethelita, edificou a Jericó: morrendo Abiram, seu primogenito a fundou, e morrendo Segub, seu ultimo, poz as suas portas: conforme á palavra do Senhor, que fallara pelo ministerio de Josué, filho de Nun.`,
  ],
  17: [
    `Então Elias, o tesbita, dos moradores de Gilead, disse a Achab: Vive o Senhor, Deus de Israel, perante cuja face estou, que n'estes annos nem orvalho nem chuva haverá, senão segundo a minha palavra.`,
    ...
    `Porém ella disse: Vive o Senhor teu Deus, que nem um bolo tenho, senão sómente um punhado de farinha n'uma panella, e um pouco d'azeite n'uma botija: e vês aqui apanhei dois cavacos, e vou preparal-o para mim e para o meu filho, para que o comamos, e morramos.`,
    ...
    `Porque assim diz o Senhor Deus de Israel: A farinha da panella não se acabará, e o azeite da botija não faltará, até ao dia em que o Senhor dê chuva sobre a terra`,
    ...
    `E depois d'estas coisas succedeu que adoeceu o filho d'esta mulher, da dona da casa: e a sua doença se aggravou muito, até que n'elle nenhum folego ficou.`,
    ...
    `Então se mediu sobre o menino tres vezes, e clamou ao Senhor, e disse: Ó Senhor meu Deus, rogo-te que torne a alma d'este menino a entrar n'elle.`,
  ...
  19: [
    ...
    `E elle disse: Tenho sido muito zeloso pelo Senhor Deus dos Exercitos, porque os filhos d'Israel deixaram o teu concerto, derribaram os teus altares, e mataram os teus prophetas á espada, e eu só fiquei, e buscam a minha vida para m'a tirarem.`,
    `E elle lhe disse: Sae para fóra, e põe-te n'este monte perante a face do Senhor. E eis que passava o Senhor, como tambem um grande e forte vento que fendia os montes e quebrava as penhas diante da face do Senhor; porém o Senhor não estava no vento: e depois do vento um terremoto: tambem o Senhor não estava no terremoto:`,
    `E depois do terremoto um fogo; porém tambem o Senhor não estava no fogo: e depois do fogo uma voz mansa e delicada.`,
    `E succedeu que, ouvindo-a Elias, envolveu o seu rosto na sua capa, e saiu para fóra, e poz-se á entrada da caverna: e eis que veiu a elle uma voz, que dizia: Que fazes aqui, Elias?`,
    `E elle disse: Eu tenho sido em extremo zeloso pelo Senhor Deus dos exercitos, porque os filhos d'Israel deixaram o teu concerto, derribaram os teus altares, e mataram os teus prophetas á espada, e só eu fiquei; e buscam a minha vida para m'a tirarem.`,
    `E o Senhor lhe disse: Vae, torna-te pelo teu caminho para o deserto de Damasco; e vem, e unge a Hazael rei sobre a Syria.`,
    `Tambem a Jehu, filho de Nimsi, ungirás rei d'Israel: e tambem a Eliseo, filho de Saphat de Abel-mehola, ungirás propheta em teu logar.`,
    ...
    `Partiu pois Elias d'ali, e achou a Eliseo, filho de Saphat, que andava lavrando com doze juntas de bois adiante d'elle, e elle estava com a duodecima: e Elias passou por elle, e lançou a sua capa sobre elle.`,
    `Então deixou elle os bois, e correu apoz Elias: e disse: Deixa-me beijar a meu pae e a minha mãe, e então te seguirei. E elle lhe disse: Vae, e volta; porque que te tenho eu feito?`,
    `Voltou pois de atraz d'elle, e tomou uma junta de bois, e os matou, e com os apparelhos dos bois cozeu as carnes, e as deu ao povo, e comeram: então se levantou e seguiu a Elias, e o servia.`,
  ],
  20: [
