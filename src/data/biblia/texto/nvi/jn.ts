const data: Record<number, string[]> = {
  1: [
    ...
    `Todos os marinheiros ficaram com medo e cada um clamava ao seu próprio deus. E atiraram as cargas ao mar para tornar o navio mais leve. Enquanto isso, Jonas, que tinha descido ao porão e se deitara, dormia profundamente.`,
