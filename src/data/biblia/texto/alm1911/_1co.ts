const data: Record<number, string[]> = {
  ...
  2: [
    `E eu, irmãos, quando fui ter comvosco, annunciando-vos o testemunho de Deus, não fui com sublimidade de palavras ou de sabedoria.`,
    ...
    `A qual nenhum dos principes d'este mundo conheceu; porque, se a conhecessem, nunca crucificariam ao Senhor da gloria.`,
    ...
    `Porque, qual dos homens sabe as coisas do homem, senão o espirito do homem, que n'elle está? assim tambem ninguem sabe as coisas de Deus, senão o Espirito de Deus.`,
    ...
    `Porque, quem conheceu a mente do Senhor, para que possa instruil-o? Mas nós temos a mente de Christo.`,
  ],
  3: [
    ...
    `Ninguem se engane a si mesmo: se alguem d'entre vós se tem por sabio n'este mundo, faça-se louco para ser sabio.`,
  ...
  4: [
    ...
    `Porém a mim mui pouco se me dá de ser julgado por vós, ou por algum juizo humano; nem eu tão pouco a mim mesmo me julgo.`,
    ...
    `E eu, irmãos, appliquei estas coisas, por similhança, a mim e a Apollos, por amor de vós; para que em nós aprendaes a não ir além do que está escripto, para que não vos ensoberbeçaes a favor de um contra outro.`,
    `Porque, quem te differença? E que tens tu que não tenhas recebido? E, se o recebeste, porque te glorias, como se não o houveras recebido?`,
    `Já estaes fartos! já estaes ricos! sem nós reinaes! e oxalá reineis para que tambem nós reinemos comvosco!`,
    `Porque tenho para mim, que Deus a nós, apostolos, nos designou ultimos, como condemnados á morte; pois somos feitos espectaculo ao mundo, aos anjos, e aos homens.`,
    ...
    `Por esta causa vos mandei Timotheo, que é meu filho amado, e fiel no Senhor: o qual vos lembrará os meus caminhos em Christo, como por todas as partes ensino em cada egreja.`,
    ...
    `Que quereis? Irei ter comvosco com vara ou com amor e espirito de mansidão?`,
  ],
  5: [
  ...
  10: [
    ...
    `Ora todas estas coisas lhes sobrevieram em figuras, e estão escriptas para aviso nosso, para quem já são chegados os fins dos seculos.`,
  ...
  13: [
    ...
    `E ainda que tivesse o dom da prophecia, e conhecesse todos os mysterios e toda a sciencia, e ainda que tivesse toda a fé, de maneira tal que transportasse os montes, e não tivesse caridade, nada seria.`,
    ...
    `Quando eu era menino, fallava como menino, sentia como menino, discorria como menino, mas, logo que cheguei a ser homem, acabei com as coisas de meninos.`,
