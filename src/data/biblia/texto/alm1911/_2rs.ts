const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Então os filhos dos prophetas que estavam em Bethel sairam a Eliseo, e lhe disseram: Sabes que o Senhor hoje tomará o teu senhor por de cima da tua cabeça? E elle disse: Tambem eu bem o sei; calae-vos.`,
    ...
    `Então os filhos dos prophetas que estavam em Jericó se chegaram a Eliseo, e lhe disseram: Sabes que o Senhor hoje tomará o teu senhor por de cima da tua cabeça? E elle disse: Tambem eu bem o sei; calae-vos.`,
    `E Elias disse: Fica-te aqui, porque o Senhor me enviou ao Jordão. Mas elle disse: Vive o Senhor, e vive a tua alma, que te não deixarei. E assim ambos foram juntos.`,
    ...
    `E succedeu que, indo elles andando e fallando, eis que um carro de fogo, com cavallos de fogo, os separou um do outro: e Elias subiu ao céu n'um redemoinho.`,
    `O que vendo Eliseo, clamou: Meu pae, meu pae, carros de Israel, e seus cavalleiros! E nunca mais o viu: e, travando dos seus vestidos, os rasgou em duas partes.`,
    `Tambem levantou a capa de Elias, que lhe caira: e tornou-se, e parou á borda do Jordão.`,
    `E tomou a capa de Elias, que lhe caira, e feriu as aguas, e disse: Onde está o Senhor, Deus de Elias? Então feriu as aguas, e se dividiram ellas d'uma e outra banda; e Eliseo passou.`,
    ...
    `E disseram-lhe: Eis que com teus servos ha cincoenta homens valentes; ora deixa-os ir para buscar a teu senhor; pode ser que o elevasse o Espirito do Senhor, e o lançasse n'algum dos montes, ou n'algum dos valles. Porém elle disse: Não os envieis.`,
    ...
    `Então saiu elle ao manancial das aguas, e deitou sal n'elle; e disse: Assim diz o Senhor: Sararei a estas aguas; não haverá mais n'ellas morte nem esterilidade.`,
    `Ficaram pois sãs aquellas aguas até ao dia d'hoje, conforme á palavra que Eliseo tinha dito.`,
    `Então subiu d'ali a Bethel: e, subindo elle pelo caminho, uns moços pequenos sairam da cidade, e zombavam d'elle, e diziam-lhe: Sobe, calvo, sobe, calvo!`,
  ...
  5: [
    `E Naaman, chefe do exercito do rei da Syria, era um grande homem diante do seu senhor, e de muito respeito; porque por elle o Senhor déra livremente aos syros: e era este varão homem valoroso, porém leproso.`,
    ...
    `Então disse o rei da Syria: Vae, anda, e enviarei a carta ao rei de Israel. E foi, e tomou na sua mão dez talentos de prata, e seis mil siclos de oiro e dez mudas de vestidos.`,
    `E levou a carta ao rei de Israel, dizendo: Logo, em chegando a ti esta carta, saibas que eu te enviei Naaman, meu servo, para que o restaures da sua lepra.`,
    `E succedeu que, lendo o rei de Israel a carta, rasgou os seus vestidos, e disse: Sou eu Deus, para matar e para vivificar, para que este envie a mim, para eu restaurar a um homem da sua lepra? Pelo que devéras notae, peço-vos, e vede que busca occasião contra mim.`,
    `Succedeu porém que, ouvindo Eliseo, homem de Deus, que o rei de Israel rasgara os seus vestidos, mandou dizer ao rei: Porque rasgaste os teus vestidos? deixa-o vir a mim, e saberá que ha propheta em Israel.`,
    ...
    `Porém Naaman muito se indignou, e se foi dizendo: Eis que eu dizia comigo: Certamente elle sairá, pôr-se-ha em pé, e invocará o nome do Senhor seu Deus, e passará a sua mão sobre o logar, e restaurará o leproso`,
    `Não são porventura Abana e Farfar, rios de Damasco, melhores do que todas as aguas de Israel? Não me poderia eu lavar n'elles, e ficar purificado? E voltou-se, e se foi com indignação.`,
    `Então chegaram-se a elle os seus servos, e lhe fallaram, e disseram: Meu pae, se o propheta te dissera alguma grande coisa, porventura não a farias? Quanto mais, dizendo-te elle: Lava-te, e ficarás purificado.`,
    `Então desceu, e mergulhou no Jordão sete vezes, conforme a palavra do homem de Deus: e a sua carne tornou, como a carne d'um menino, e ficou purificado.`,
    `Então voltou ao homem de Deus, elle e toda a sua comitiva, e veiu, e poz-se diante d'elle, e disse: Eis que tenho conhecido que em toda a terra não ha Deus senão em Israel: agora pois te peço que tomes uma benção do teu servo`,
    ...
    `E disse Naaman: Quando não, comtudo dê-se a este teu servo uma carga de terra d'um jugo de mulas; porque nunca mais offerecerá este teu servo holocausto nem sacrificio a outros deuses, senão ao Senhor.`,
    `N'isto perdoe o Senhor a teu servo: quando meu senhor entra na casa de Rimmon para ali se encurvar, e elle se encosta na minha mão, e eu tambem me hei de encurvar na casa de Rimmon; quando assim me encurvar na casa de Rimmon, n'isto perdoe o Senhor a teu servo.`,
    `E elle lhe disse: Vae em paz. E foi-se d'elle a uma pequena distancia.`,
    `Então Geazi, moço d'Eliseo, homem de Deus, disse: Eis que meu senhor impediu a este syro Naaman que da sua mão se désse alguma coisa do que trazia; porém, vive o Senhor que hei de correr atraz d'elle, e tomar d'elle alguma coisa.`,
    `E foi Geazi em alcance de Naaman; e Naaman, vendo que corria atraz d'elle, saltou do carro a encontral-o, e disse-lhe: Vae tudo bem?`,
    `E elle disse: Tudo vae bem; meu senhor me mandou dizer: Eis que agora mesmo vieram a mim dois mancebos dos filhos dos prophetas da montanha d'Ephraim; dá-lhes pois um talento de prata e duas mudas de vestidos.`,
    `E disse Naaman: Sê servido tomar dois talentos. E instou com elle, e amarrou dois talentos de prata em dois saccos, com duas mudas de vestidos; e pôl-os sobre dois dos seus moços, os quaes os levaram diante d'elle.`,
    `E, chegando elle á altura, tomou-os das suas mãos, e os depositou na casa: e despediu aquelles homens, e foram-se.`,
    `Então elle entrou, e poz-se diante de seu senhor. E disse-lhe Eliseo: D'onde vens, Geazi? E disse: Teu servo não foi nem a uma nem a outra parte.`,
    `Porém elle lhe disse: Porventura não foi comtigo o meu coração, quando aquelle homem voltou de sobre o seu carro, a encontrar-te? Era isto tempo para tomares prata, e para tomares vestidos, e olivaes, e vinhas, e ovelhas, e bois e servos e servas?`,
  ...
  9: [
    ...
    `Porque á casa d'Achab hei de fazer como á casa de Jeroboão, filho de Nebat, e como á casa de Baása, filho d'Ahias.`,
    `E os cães comerão a Jezabel no pedaço de campo de Jizreel; não haverá quem a enterre. Então abriu a porta, e fugiu`,
    `E, saindo Jehu aos servos do seu senhor, disseram-lhe: Vae tudo bem? porque veiu a ti este louco? E elle lhes disse: Bem conheceis o homem e o seu fallar.`,
    `Mas elles disseram: É mentira; agora faze-nol-o saber. E disse: Assim e assim me fallou, dizendo: Assim diz o Senhor: Ungi-te rei sobre Israel.`,
    `Então se apressaram, e tomou cada um o seu vestido, e o poz debaixo d'elle, no mais alto degrau: e tocaram a buzina, e disseram: Jehu reina!`,
    ...
    `Porém o rei Jorão voltou para se curar em Jizreel das feridas que os syros lhe fizeram, quando pelejou contra Hazael, rei da Syria. E disse Jehu: Se é da vossa vontade, ninguem saia da cidade, nem escape, para ir denunciar isto em Jizreel.`,
    `Então Jehu subiu a um carro, e foi-se a Jizreel, porque Jorão estava deitado ali: e tambem Achazias, rei de Judah, descera para vêr a Jorão.`,
    `E o atalaia estava na torre de Jizreel, e viu a tropa de Jehu, que vinha, e disse: Vejo uma tropa. Então disse Jorão: Toma um cavalleiro, e envia-lh'o ao encontro; e diga: Ha paz?`,
    `E o cavalleiro lhe foi ao encontro, e disse: Assim diz o rei: Ha paz? E disse Jehu: Que tens tu que fazer com a paz? Vira-te para traz de mim. E o atalaia o fez saber, dizendo: Chegou a elles o mensageiro, porém não volta.`,
    `Então enviou outro cavalleiro; e, chegando este a elles, disse: Assim diz o rei: Ha paz? E disse Jehu: Que tens tu que fazer com a paz? Vira-te para traz de mim.`,
    `E o atalaia o fez saber, dizendo: Tambem este chegou a elles, porém não volta; e o andar parece como o andar de Jehu, filho de Nimsi, porque anda furiosamente.`,
    ...
    `E succedeu que, vendo Jorão a Jehu, disse: Ha paz, Jehu? E disse elle: Que paz, emquanto as fornicações da tua mãe Jezabel e as suas feitiçarias são tantas?`,
    ...
    `Então Jehu disse a Bidkar, seu capitão: Toma-o, lança-o no pedaço do campo de Naboth, o jizreelita; porque, lembra-te de que, indo eu e tu juntos a cavallo após seu pae, Achab, o Senhor poz sobre elle esta carga, dizendo:`,
    `Por certo que se eu não visse hontem á tarde o sangue de Naboth e o sangue de seus filhos, diz o Senhor, tambem não t'o pagaria n'este pedaço de campo, diz o Senhor. Agora, pois, toma-o, e lança-o n'este pedaço de campo, conforme a palavra do Senhor.`,
    `O que vendo Achazias, rei de Judah, fugiu pelo caminho da casa do jardim, porém Jehu seguiu após elle, e disse: Tambem feri a este no carro á subida de Gur, que está junto a Jibleam. E fugiu a Megiddo, e morreu ali`,
    ...
    `E levantou elle o rosto para a janella e disse: Quem é comigo? quem? E dois ou tres eunuchos olharam para elle.`,
    ...
    `Então voltaram, e lh'o fizeram saber; e elle disse: Esta é a palavra do Senhor, a qual fallou pelo ministerio de Elias, o tesbita, seu servo, dizendo: No pedaço do campo de Jizreel os cães comerão a carne de Jezabel.`,
  ...
  13: [
    ...
    `Porque não deixou a Joachaz mais povo, senão só cincoenta cavalleiros, e dez carros, e dez mil homens de pé: porquanto o rei da Syria os tinha destruido e os tinha feito como o pó, trilhando-os.`,
    `Ora o mais dos successos de Joachaz, e tudo quanto fez mais, e o seu poder, porventura não está escripto no livro das chronicas dos reis de Israel?`,
    ...
    `E fez o que parecia mal aos olhos do Senhor: não se apartou de nenhum dos peccados de Jeroboão, filho de Nebat, que fez peccar a Israel, porém andou n'elles.`,
    `Ora o mais dos successos de Jehoás, e tudo quanto fez mais, e o seu poder, com que pelejou contra Amasias, rei de Judah, porventura não está escripto no livro das chronicas dos reis de Israel?`,
    `E Jehoás dormiu com seus paes, e Jeroboão se assentou no seu throno: e Jehoás foi sepultado em Samaria, junto aos reis de Israel.`,
    `E Eliseo estava doente da sua doença de que morreu: e Jehoás, rei de Israel, desceu a elle, e chorou sobre o seu rosto, e disse: Meu pae, meu pae, o carro de Israel, e seus cavalleiros!`,
    ...
    `E disse: Abre a janella para o oriente. E abriu-a. Então disse Eliseo: Atira. E atirou; e disse: A frecha do livramento do Senhor é a frecha do livramento contra os syros; porque ferirás os syros em Afek, até os consumir.`,
    `Disse mais: Toma as frechas. E tomou-as. Então disse ao rei de Israel: Fere a terra. E feriu-a tres vezes, e cessou.`,
    `Então o homem de Deus se indignou muito contra elle, e disse: Cinco ou seis vezes a deverias ter ferido: então feririas os syros até os consumir: porém agora só tres vezes ferirás os syros`,
    `Depois morreu Eliseo, e o sepultaram. Ora as tropas dos moabitas invadiram a terra á entrada do anno.`,
    `E succedeu que, enterrando elles um homem, eis que viram uma tropa, e lançaram o homem na sepultura de Eliseo: e, caindo n'ella o homem, e tocando os ossos de Eliseo, reviveu, e se levantou sobre os seus pés.`,
    `E Hazael, rei da Syria, opprimiu a Israel todos os dias de Jehoás.`,
    `Porém o Senhor teve misericordia d'elles, e se compadeceu d'elles, e tornou para elles, por amor do seu concerto em Abrahão, Isaac e Jacob: e não os quiz destruir, e não os lançou ainda da sua presença.`,
  ...
  15: [
    ...
    `No anno trinta e oito d'Azarias, rei de Judah, reinou Zacharias, filho de Jeroboão, sobre Israel, em Samaria, seis mezes.`,
    `E fez o que parecia mal aos olhos do Senhor, como tinham feito seus paes; nunca se apartou dos peccados de Jeroboão, filho de Nebat, que fez peccar a Israel.`,
    ...
    `Ora o mais dos successos de Sallum, e a conspiração que fez, eis que está escripto no livro das chronicas dos reis d'Israel.`,
    ...
    `Então veiu Pul, rei d'Assyria, contra a terra: e Menahem deu a Pul mil talentos de prata, para que a sua mão fosse com elle, a fim de firmar o reino na sua mão.`,
    `E Menahem tirou este dinheiro d'Israel, de todos os poderosos e ricos, para o dar ao rei da Assyria, por cada homem cincoenta siclos de prata: assim voltou o rei d'Assyria, e não ficou ali na terra.`,
    ...
    `E Peka, filho de Remalias, seu capitão, conspirou contra elle, e o feriu em Samaria, no paço da casa do rei, juntamente com Argob e com Arieh, e com elle cincoenta homens dos filhos dos gileaditas: e o matou, e reinou em seu logar.`,
    ...
    `E fez o que parecia mal aos olhos do Senhor: nunca se apartou dos peccados de Jeroboão, filho de Nebat, que fez peccar a Israel.`,
    `Nos dias de Peka, rei de Israel, veiu Tiglath-pileser, rei d'Assyria, e tomou a Ijon, e a Abel-beth-maaca, e a Janoah, e a Kedes, e a Hasor, e a Gilead, e a Galilea, e a toda a terra de Naphtali, e os levou a Assyria.`,
    ...
    `Tinha vinte e cinco annos de edade quando começou a reinar, e reinou dezeseis annos em Jerusalem: e era o nome de sua mãe Jerusa, filha de Zadok.`,
  ...
  17: [
    ...
    `Porém o rei da Assyria achou em Hoseas conspiração; porque enviara mensageiros a So, rei do Egypto, e não pagava presentes ao rei da Assyria cada anno, como d'antes: então o rei d'Assyria o encerrou e aprisionou na casa do carcere.`,
    `Porque o rei da Assyria subiu por toda a terra, e veiu até Samaria, e a cercou tres annos.`,
    `No anno nono de Hoseas, o rei da Assyria tomou a Samaria, e transportou a Israel para a Assyria: e fel-os habitar em Halah, e em Habor, junto ao rio de Gozan, e nas cidades dos medos.`,
    `Porque succedeu, que os filhos de Israel peccaram contra o Senhor seu Deus, que os fizera subir da terra do Egypto, de debaixo da mão de Pharaó, rei do Egypto; e temeram a outros deuses,`,
    ...
    `E rejeitaram os seus estatutos, e o seu concerto, que fizera com seus paes, como tambem os seus testemunhos, com que protestara contra elle: e andaram após a vaidade, e ficaram vãos; como tambem após as nações, que estavam em roda d'elles, das quaes o Senhor lhes tinha ordenado que não fizessem como ellas`,
    `E deixaram todos os mandamentos do Senhor seu Deus, e fizeram imagens de fundição, dois bezerros: e fizeram um idolo do bosque, e se prostraram perante todo o exercito do céu, e serviram a Baal.`,
    `Tambem fizeram passar pelo fogo a seus filhos e suas filhas, e deram-se a adivinhações, e criam em agouros; e venderam-se para fazer o que parecia mal aos olhos do Senhor, para o provocarem á ira.`,
    ...
    `Porque rasgou a Israel da casa de David, e fizeram rei a Jeroboão, filho de Nebat: e Jeroboão apartou a Israel de após o Senhor, e os fez peccar um grande peccado.`,
    `Assim andaram os filhos de Israel em todos os peccados de Jeroboão, que tinha feito: nunca se apartaram d'elles.`,
    `Até que o Senhor tirou a Israel de diante da sua presença, como fallara pelo ministerio de todos os seus servos, os prophetas: assim foi Israel transportado da sua terra a Assyria até ao dia de hoje.`,
    `E o rei da Assyria trouxe gente de Babel, e de Cutha, e de Ava, e de Hamath e Sefarvaim, e a fez habitar nas cidades de Samaria, em logar dos filhos d'Israel: e tomaram a Samaria em herança, e habitaram nas suas cidades.`,
    ...
    `Pelo que fallaram ao rei da Assyria, dizendo: A gente que transportaste, e fizeste habitar nas cidades de Samaria, não sabe o costume do Deus da terra: pelo que mandou leões entre ellas, e eis que os matam, porquanto não sabem o culto do Deus da terra.`,
    ...
    `Assim que ao Senhor temiam, e tambem a seus deuses serviam, segundo o costume das nações d'entre as quaes transportaram aquellas.`,
  ...
  18: [
    ...
    `Tinha vinte e cinco annos de edade quando começou a reinar, e vinte e nove annos reinou em Jerusalem: e era o nome de sua mãe Abi, filha de Zacharias.`,
    `E fez o que era recto aos olhos do Senhor, conforme tudo o que fizera David, seu pae.`,
    `Este tirou os altos, e quebrou as estatuas, e deitou abaixo os bosques, e fez em pedaços a serpente de metal que Moysés fizera; porquanto até áquelle dia os filhos d'Israel lhe queimavam incenso, e lhe chamaram Nehustan.`,
    ...
    `E succedeu, no quarto anno do rei Ezequias (que era o setimo anno de Hoseas, filho de Ela, rei d'Israel), que Salmanasar, rei d'Assyria, subiu contra Samaria, e a cercou.`,
    `E a tomaram ao fim de tres annos, no anno sexto d'Ezequias, que era o anno nono de Hoseas, rei d'Israel, quando tomaram Samaria.`,
    ...
    `Então Ezequias, rei de Judah, enviou ao rei d'Assyria, a Lachis, dizendo: Pequei; torna-te de mim; tudo o que me impozeres levarei. Então o rei d'Assyria impoz a Ezequias, rei de Judah, trezentos talentos de prata e trinta talentos de oiro.`,
    `Assim deu Ezequias toda a prata que se achou na casa do Senhor e nos thesouros da casa do rei.`,
    `N'aquelle tempo cortou Ezequias o oiro das portas do templo do Senhor, e das hombreiras, de que Ezequias, rei de Judah, as cobrira, e o deu ao rei d'Assyria.`,
    `Comtudo enviou o rei d'Assyria a Tartan, e a Rabsaris, e a Rabsaké, de Lachis, com um grande exercito ao rei Ezequias, a Jerusalem: e subiram, e vieram a Jerusalem; e, subindo e vindo elle, pararam ao pé do aqueducto da piscina superior, que está junto ao caminho do campo do lavandeiro.`,
    `E chamaram o rei, e saiu a elles Eliakim, filho de Hilkias, o mordomo, e Sebna, o escrivão, e Joah, filho d'Asaph, o chanceler.`,
    ...
    `Eis que agora tu confias n'aquelle bordão de cana quebrada, no Egypto, no qual, se alguem se encostar, entrar-lhe-ha pela mão e lh'a furará: assim é Pharaó, rei do Egypto, para com todos os que n'elle confiam.`,
    `Se porém me disserdes: No Senhor nosso Deus confiamos: porventura não é este aquelle cujos altos e cujos altares Ezequias tirou, e disse a Judah e a Jerusalem: Perante este altar vos inclinareis em Jerusalem?`,
    ...
    `Então disse Eliakim, filho de Hilkias, e Sebna, e Joah, a Rabsaké: Rogamos-te que falles aos teus servos em syriaco; porque bem o entendemos; e não nos falles em judaico, aos ouvidos do povo que está em cima do muro.`,
    `Porém Rabsaké lhes disse: Porventura mandou-me meu senhor só a teu senhor e a ti, para fallar estas palavras? e não antes aos homens, que estão sentados em cima do muro, para que juntamente comvosco comam o seu esterco e bebam a sua urina?`,
    ...
    `Não deis ouvidos a Ezequias; porque assim diz o rei da Assyria: Contratae comigo por presentes, e sahi a mim, e coma cada um da sua vide, e da sua figueira, e beba cada um a agua da sua cisterna,`,
  ...
  19: [
    ...
    `Então enviou a Eliakim, o mordomo, e a Sebna, o escrivão, e os anciãos dos sacerdotes, cobertos de saccos, ao propheta Isaias, filho de Amós.`,
    `E disseram-lhe: Assim diz Ezequias: Este dia é dia de angustia, e de vituperação, e de blasphemia; porque os filhos chegaram ao parto, e não ha força para parir.`,
    `Bem pode ser que o Senhor teu Deus ouça todas as palavras de Rabsaké, a quem enviou o seu senhor, o rei da Assyria, para affrontar o Deus vivo, e para vituperal-o com as palavras que o Senhor teu Deus tem ouvido: faze pois oração pelo resto que se acha.`,
    ...
    `Porventura as livraram os deuses das nações, a quem destruiram, como a Gozan e a Haran? e a Reseph, e aos filhos de Eden, que estavam em Telassar?`,
    ...
    `Inclina, Senhor, o teu ouvido, e ouve; abre, Senhor, os teus olhos, e olha: e ouve as palavras de Sanherib, que enviou a este, para affrontar o Deus vivo.`,
    ...
    `A quem affrontaste e blasphemaste? E contra quem alçaste a voz, e ergueste os teus olhos ao alto? Contra o Sancto de Israel?`,
    `Por meio de teus mensageiros affrontaste o Senhor, e disseste: Com a multidão de meus carros subo eu ao alto dos montes, aos lados do Libano, e cortarei os seus altos cedros, e as suas mais formosas faias, e entrarei nas suas pousadas extremas, até no bosque do seu campo fertil.`,
    ...
    `Por isso os moradores d'ellas, com as mãos encolhidas, ficaram pasmados e confundidos: eram como a herva do campo, e a hortaliça verde, e o feno dos telhados, e o trigo queimado, antes que se levante.`,
    ...
    `E isto te será por signal: este anno se comerá o que nascer por si mesmo, e no anno seguinte o que d'ahi proceder; porém o terceiro anno semeae e segae, e plantae vinhas, e comei os seus fructos.`,
    ...
    `Succedeu pois que n'aquella mesma noite saiu o anjo do Senhor, e feriu no arraial dos assyrios a cento e oitenta e cinco mil d'elles; e, levantando-se pela manhã cedo, eis que todos eram corpos mortos.`,
    `Então Sanherib, rei d'Assyria, partiu, e se foi, e voltou: e ficou em Ninive.`,
    `E succedeu que, estando elle prostrado na casa de Nisroch, seu deus, Adram-melech e Sarezer, seus filhos, o feriram á espada; porém elles escaparam para a terra d'Ararat: e Esar-*haddon, seu filho, reinou em seu logar.`,
  ],
  20: [
    `N'aquelles dias adoeceu Ezequias de morte: e o propheta Isaias, filho d'Amós, veiu a elle, e lhe disse: Assim diz o Senhor: Ordena a tua casa, porque morrerás, e não viverás.`,
    `Então virou o rosto para a parede, e orou ao Senhor, dizendo:`,
    `Ah, Senhor! Sê servido de te lembrar de que andei diante de ti em verdade, e com o coração perfeito, e fiz o que era recto aos teus olhos. E chorou Ezequias muitissimo.`,
    ...
    `E accrescentarei aos teus dias quinze annos, e das mãos do rei d'Assyria te livrarei, a ti e a esta cidade; e ampararei esta cidade por amor de mim, e por amor de David, meu servo.`,
    ...
    `N'aquelle tempo enviou Berodac Baladan, filho de Baladan, rei de Babylonia, cartas e um presente a Ezequias; porque ouvira que Ezequias tinha estado doente.`,
    `E Ezequias lhes deu ouvidos, e lhes mostrou toda a casa de seu thesouro, a prata, e o oiro, e as especiarias, e os melhores unguentos, e a sua casa d'armas, e tudo quanto se achou nos seus thesouros: coisa nenhuma houve que lhes não mostrasse, nem em sua casa, nem em todo o seu dominio.`,
    ...
    `Ora o mais dos successos de Ezequias, e todo o seu poder, e como fez a piscina e o aqueducto, e como fez vir a agua á cidade, porventura não está escripto no livro das chronicas dos reis de Judah?`,
  ...
  21: [
    ...
    `Porque tornou a edificar os altos que Ezequias, seu pae, tinha destruido, e levantou altares a Baal, e fez um bosque como o que fizera Achab, rei d'Israel, e se inclinou diante de todo o exercito dos céus, e os serviu.`,
    ...
    `Tambem poz uma imagem de esculptura, do bosque que tinha feito, na casa de que o Senhor dissera a David e a Salomão, seu filho: N'esta casa e em Jerusalem, que escolhi de todas as tribus d'Israel, porei o meu nome para sempre.`,
    `E mais não farei mover o pé d'Israel d'esta terra que tenho dado a seus paes; comtanto sómente que tenham cuidado de fazer conforme tudo o que lhes tenho ordenado, e conforme toda a lei que Moysés, meu servo, lhes ordenou.`,
    ...
    `Porquanto Manasseh, rei de Judah, fez estas abominações, fazendo peior do que quanto fizeram os amorrheos, que antes d'elle foram, e até tambem a Judah fez peccar com os seus idolos;`,
    ...
    `E estenderei sobre Jerusalem o cordel de Samaria e o prumo da casa de Achab: e limparei a Jerusalem, como quem limpa a escudela, a limpa e a vira sobre a sua face.`,
    ...
    `De mais d'isto, tambem Manasseh derramou muitissimo sangue innocente, até que encheu a Jerusalem de um ao outro extremo, afóra o seu peccado, com que fez peccar a Judah, fazendo o que parecia mal aos olhos do Senhor.`,
    ...
    `Tinha Amon vinte e dois annos de edade quando começou a reinar, e dois annos reinou em Jerusalem: e era o nome de sua mãe Mesullemeth, filha d'Harus, de Jotba.`,
  ...
  22: [
    `Tinha Josias oito annos d'edade quando começou a reinar, e reinou trinta e um annos em Jerusalem: e era o nome de sua mãe, Jedida, filha de Adais, de Boskath.`,
    ...
    `Succedeu pois que, no anno decimo oitavo do rei Josias, o rei mandou ao escrivão Saphan, filho de Asalias, filho de Mesullam, á casa do Senhor, dizendo:`,
    ...
    `Então o escrivão Saphan veiu ao rei, e referiu ao rei a resposta; e disse: Teus servos ajuntaram o dinheiro que se achou na casa, e o entregaram na mão dos que teem cargo da obra, que estão encarregados da casa do Senhor.`,
    ...
    `Ide, e consultae ao Senhor por mim, e pelo povo, e por todo o Judah, ácerca das palavras d'este livro que se achou; porque grande é o furor do Senhor, que se accendeu contra nós; porquanto nossos paes não deram ouvidos ás palavras d'este livro, para fazerem conforme tudo quanto de nós está escripto.`,
    `Então foi o sacerdote Hilkias, e Ahikam, e Acbor, e Saphan, e Asaias á prophetiza Hulda, mulher de Sallum, filho de Tikva, o filho de Harhas, o guarda das vestiduras (e ella habitava em Jerusalem, na segunda parte,) e lhe fallaram.`,
    ...
    `Porquanto o teu coração se enterneceu, e te humilhaste perante o Senhor, quando ouviste o que fallei contra este logar, e contra os seus moradores, que seria para assolação e para maldição, e que rasgaste os teus vestidos, e choraste perante mim, tambem eu te ouvi, diz o Senhor.`,
    `Pelo que eis que eu te ajuntarei a teus paes, e tu serás ajuntado em paz á tua sepultura, e os teus olhos não verão todo o mal que hei de trazer sobre este logar. Então tornaram a trazer ao rei a resposta.`,
  ],
  23: [
    `Então o rei enviou, e todos os anciãos de Judah e de Jerusalem se ajuntaram a elle.`,
    `E o rei subiu á casa do Senhor, e com elle todos os homens de Judah, e todos o moradores de Jerusalem, e os sacerdotes, e os prophetas, e todo o povo, desde o mais pequeno até ao maior: e leu aos ouvidos d'elles todas as palavras do livro do concerto, que se achou na casa do Senhor.`,
    `E o rei se poz em pé junto á columna, e fez o concerto perante o Senhor, para andarem atraz do Senhor, e guardarem os seus mandamentos, e os seus testemunhos, e os seus estatutos, com todo o coração, e com toda a alma, confirmando as palavras d'este concerto, que estavam escriptas n'aquelle livro; e todo o povo esteve por este concerto.`,
    `E o rei mandou ao summo sacerdote Hilkias, e aos sacerdotes da segunda ordem, e aos guardas do umbral da porta, que se tirassem do templo do Senhor todos os vasos que se tinham feito para Baal, e para o bosque, e para todo o exercito dos céus: e os queimou fóra de Jerusalem, nos campos de Cedron, e levou o pó d'elles a Bethel.`,
    `Tambem abrogou os sacerdotes que os reis de Judah estabeleceram para incensarem sobre os altos nas cidades de Judah, e ao redor de Jerusalem, como tambem os que incensavam a Baal, ao sol, e á lua, e aos mais planetas, e a todo o exercito dos céus.`,
    ...
    `E a todos os sacerdotes trouxe das cidades de Judah, e profanou os altos em que os sacerdotes incensavam, desde Geba até Berseba: e derribou os altos das portas, o que estava á entrada da porta de Josué, o chefe da cidade, que estava á mão esquerda d'aquelle que entrava pela porta da cidade.`,
    ...
    `Tambem o rei derribou os altares que estavam sobre o terraço do cenaculo de Achaz, os quaes fizeram os reis de Judah, como tambem o rei derribou os altares que fizera Manasseh nos dois atrios da casa do Senhor: e esmiuçados os tirou d'ali, e lançou o pó d'elles no ribeiro de Cedron.`,
    `O rei profanou tambem os altos que estavam defronte de Jerusalem, á mão direita do monte de Mashith, os quaes edificara Salomão, rei d'Israel, a Astoreth, a abominação dos sidonios, e a Camos, a abominação dos moabitas, e a Milcom, a abominação dos filhos d'Ammon.`,
    `Similhantemente quebrou as estatuas, e cortou os bosques, e encheu o seu logar com ossos de homens.`,
    `E tambem o altar que estava em Bethel, e o alto que fez Jeroboão, filho de Nebat, que tinha feito peccar a Israel, juntamente com aquelle altar tambem o alto derribou; queimando o alto, em pó o esmiuçou, e queimou o bosque.`,
    `E, virando-se Josias, viu as sepulturas que estavam ali no monte, e enviou, e tomou os ossos das sepulturas, e os queimou sobre aquelle altar, e assim o profanou, conforme palavra do Senhor, que apregoara o homem de Deus, quando apregoou estas palavras.`,
    `Então disse: Que é este monumento que vejo? E o homens da cidade lhe disseram: É a sepultura do homem de Deus que veiu de Judah, e apregoou estas coisas que fizeste contra este altar de Bethel.`,
    ...
    `De mais d'isto tambem Josias tirou todas as casas dos altos que havia nas cidades de Samaria, e que os reis d'Israel tinham feito para provocarem á ira; e lhes fez conforme todos os feitos que tinha feito em Bethel.`,
    ...
    `Porém no anno decimo oitavo do rei Josias esta paschoa se celebrou ao Senhor em Jerusalem.`,
    `E tambem os adivinhos, e os feiticeiros, e os terafins, e os idolos, e todas as abominações que se viam na terra de Judah e em Jerusalem, os extirpou Josias, para confirmar as palavras da lei, que estavam escriptas no livro que o sacerdote Hilkias achara na casa do Senhor.`,
    ...
    `Ora o mais dos successos de Josias, e tudo quanto fez, porventura não está escripto no livro das chronicas dos reis de Judah?`,
    ...
    `E seus servos o levaram morto de Megiddo, e o trouxeram a Jerusalem, e o sepultaram na sua sepultura: e o povo da terra tomou a Joachaz, filho de Josias, e o ungiram, e o fizeram rei em logar de seu pae.`,
    `Tinha Joachaz vinte e tres annos de edade quando começou a reinar, e tres mezes reinou em Jerusalem: e era o nome de sua mãe Hamutal, filha de Jeremias, de Libna.`,
    `E fez o que parecia mal aos olhos do Senhor, conforme tudo o que fizeram seus paes.`,
    `Porém Pharaó Neco o mandou prender em Ribla, em terra de Hamath, para que não reinasse em Jerusalem: e á terra impoz pena de cem talentos de prata e um talento de oiro.`,
    `Tambem Pharaó Neco estabeleceu rei a Eliakim, filho de Josias, em logar de seu pae Josias, e lhe mudou o nome em Joaquim: porém a Joachaz tomou comsigo, e veiu ao Egypto e morreu ali.`,
    `E Joaquim deu aquella prata e aquelle oiro a Pharaó; porém fintou a terra, para dar esse dinheiro conforme o mandado de Pharaó: a cada um segundo a sua avaliação demandou a prata e o oiro do povo da terra, para o dar a Pharaó Neco.`,
  ...
  24: [
    ...
    `E Deus enviou contra elle as tro-* *pas dos chaldeos, e as tropas dos syros, e as tropas dos moabitas, e as tropas dos filhos d'Ammon; e as enviou contra Judah, para o destruir, conforme a palavra do Senhor, que fallara pelo ministerio de seus servos, os prophetas.`,
    ...
    `Então saiu Joachin, rei de Judah, ao rei de Babylonia, elle, e sua mãe, e seus servos, e seus principes, e seus eunuchos; e o rei de Babylonia o tomou preso, no anno oitavo do seu reinado.`,
    `E tirou d'ali todos os thesouros da casa do Senhor, e os thesouros da casa do rei: e fendeu todos os vasos d'oiro, que fizera Salomão, rei de Israel, no templo do Senhor, como o Senhor tinha dito.`,
    ...
    `Assim transportou Joachin a Babylonia; como tambem a mãe do rei, e as mulheres do rei, e os seus eunuchos, e os poderosos da terra levou presos de Jerusalem a Babylonia.`,
    ...
    `Tinha Zedekias vinte e um annos de edade quando começou a reinar, e reinou onze annos em Jerusalem: e era o nome de sua mãe Hamutal, filha de Jeremias, de Libna.`,
  ...
  25: [
    `E succedeu que, no nono anno do seu reinado, no mez decimo, aos dez do mez, Nabucodonosor, rei de Babylonia, veiu contra Jerusalem, elle e todo o seu exercito, e se acampou contra ella, e levantaram contra ella tranqueiras em redor.`,
    ...
    `E no quinto mez no setimo dia do mez (este era o anno decimo nono de Nabucodonosor rei de Babylonia), veiu Nebuzaradan, capitão da guarda, servo do rei de Babylonia, a Jerusalem,`,
    ...
    `A altura d'uma columna era de dezoito covados, e sobre ella havia um capitel de cobre, e de altura tinha o capitel tres covados; e a rede, e as romãs em roda do capitel, tudo era de cobre; e similhante a esta era a outra columna com a rede.`,
    ...
    `E da cidade tomou a um eunucho, que tinha cargo da gente de guerra, e a cinco homens dos que viam a face do rei, e se acharam na cidade, como tambem ao escrivão-mór do exercito, que registrava o povo da terra para a guerra, e a sessenta homens do povo da terra, que se acharam na cidade.`,
    ...
    `Ouvindo pois os capitães dos exercitos, elles e os seus homens, que o rei de Babylonia puzera a Gedalias por maioral, vieram a Gedalias, a Mispah, a saber: Ishmael, filho de Nethanias, e Johanan, filho de Kareath, e Seraias, filho de Tanhumeth, o netophatita, e Jazanias, filho do Maacatita, elles e os seus homens.`,
    ...
    `Succedeu, porém, que, no setimo mez, veiu Ishmael, filho de Nethanias, o filho de Elisama, da semente real, e dez homens com elle, e feriram a Gedalias, e elle morreu, como tambem aos judeos, e aos chaldeos que estavam com elle em Mispah.`,
    ...
    `Depois d'isto succedeu que, no anno trinta e sete do captiveiro de Joaquim, rei de Judah, no mez duodecimo, aos vinte e sete do mez, Evil-*merodac, rei de Babylonia, levantou, no anno em que reinou, a cabeça de Joaquim, rei de Judah, da casa da prisão.`,
