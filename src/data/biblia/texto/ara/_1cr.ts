const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `a Ozém, o sexto, e a Davi, o sétimo.`,
    ...
    `Calebe, filho de Hezrom, gerou filhos de Azuba, sua mulher, e de Jeriote; foram estes os filhos desta: Jeser, Sobabe e Ardom.`,
    ...
    `As famílias dos escribas que habitavam em Jabez foram os tiratitas, os simeatitas e os sucatitas; são estes os queneus, que vieram de Hamate, pai da casa de Recabe.`,
  ],
  3: [
  ...
  4: [
    ...
    `Acharam pasto farto e bom e a terra espaçosa, tranquila e pacífica, onde habitaram, dantes, os descendentes de Cam.`,
    ...
    `Também deles, dos filhos de Simeão, quinhentos homens foram ao monte Seir, tendo por capitães a Pelatias, a Nearias, a Refaías e a Uziel, filhos de Isi.`,
  ...
  25: [
    ...
    `A undécima, a Azarel, seus filhos e seus irmãos, doze.`,
