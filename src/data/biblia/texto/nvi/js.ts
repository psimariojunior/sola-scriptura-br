const data: Record<number, string[]> = {
  1: [
    ...
    `Somente seja forte e muito corajoso! Tenha o cuidado de obedecer a toda a lei que o meu servo Moisés ordenou a você; não se desvie dela, nem para a direita nem para a esquerda, para que você seja bem-sucedido por onde quer que andar.`,
  ...
  5: [
    ...
    `Os israelitas andaram quarenta anos pelo deserto, até que todos os guerreiros que tinham saído do Egito morressem, visto que não tinham obedecido ao SENHOR. Pois o SENHOR lhes havia jurado que não veriam a terra que prometera aos seus antepassados que nos daria, terra onde há leite e mel com fartura.`,
  ...
  6: [
    ...
    `Mas Josué tinha ordenado ao povo: “Não deem o brado de guerra, não levantem a voz, não digam palavra alguma, até o dia em que eu ordenar. Então vocês gritarão!”`,
  ...
  7: [
    ...
    `Então Josué, com todo o Israel, levou Acã, bisneto de Zerá, e a prata, a capa, a barra de ouro, seus filhos e filhas, seus bois, seus jumentos, suas ovelhas, sua tenda e tudo o que lhe pertencia, ao vale de Acor.`,
  ...
  9: [
    ...
    `Eles responderam a Josué: “Os seus servos ficaram sabendo como o SENHOR, o seu Deus, ordenou que o seu servo Moisés desse a vocês toda esta terra e que eliminasse todos os seus habitantes da presença de vocês. Tivemos medo do que poderia acontecer conosco por causa de vocês. Por isso agimos assim.`,
  ...
  10: [
    ...
    `Por isso Adoni-Zedeque, rei de Jerusalém, fez o seguinte apelo a Hoão, rei de Hebrom, a Piram, rei de Jarmute, a Jafia, rei de Laquis, e a Debir, rei de Eglom:`,
    `“Venham para cá e ajudem-me a atacar Gibeom, pois ela fez a paz com Josué e com os israelitas”.`,
    `Então os cinco reis dos amorreus, os reis de Jerusalém, de Hebrom, de Jarmute, de Laquis e de Eglom reuniram-se e vieram com todos os seus exércitos. Cercaram Gibeom e a atacaram.`,
    ...
    `Os cinco reis foram tirados da caverna. Eram os reis de Jerusalém, de Hebrom, de Jarmute, de Laquis e de Eglom.`,
    ...
    `O SENHOR entregou Laquis nas mãos dos israelitas, e Josué tomou-a no dia seguinte. Atacou a cidade e matou à espada todos os que nela viviam, como tinha feito com Libna.`,
  ...
  21: [
    ...
    `Receberam da tribo de Naftali: Quedes, na Galileia, cidade de refúgio dos acusados de homicídio, Hamote-Dor e Cartã, cada qual com os seus arredores. Foram três cidades.`,
  ...
  22: [
    ...
    `Durante muito tempo, e até hoje, vocês não abandonaram os seus irmãos, mas cumpriram a missão que o SENHOR, o seu Deus, entregou a vocês.`,
    `Agora que o SENHOR, o seu Deus, já concedeu descanso aos seus irmãos israelitas, como tinha prometido, voltem para casa, para a terra que Moisés, servo do SENHOR, deu a vocês no outro lado do Jordão.`,
    ...
    `Quando o sacerdote Fineias e os líderes da comunidade, os chefes dos clãs dos israelitas, ouviram o que os homens de Rúben, de Gade e de Manassés disseram, deram-se por satisfeitos.`,
    ...
    `Então Fineias, filho do sacerdote Eleazar, e os líderes voltaram do encontro com os homens de Rúben e de Gade em Gileade e foram para Canaã dar relatório aos outros israelitas.`,
  ...
  24: [
    ...
    `Sucedeu também que Eleazar, filho de Arão, morreu e foi sepultado em Gibeá, que fora dada a seu filho Fineias, nos montes de Efraim.`,
  ],
};
export default data;
