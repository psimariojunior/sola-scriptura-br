...
export default function TeologiaError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold mb-2">Erro ao carregar Teologia</h1>
        <p className="text-muted-foreground mb-6">
          Não foi possível carregar os dados teológicos. Verifique sua conexão e tente novamente.
        </p>
