const data: Record<number, string[]> = {
  1: [
    `No oitavo mez do segundo anno de Dario veiu a palavra do Senhor ao propheta Zacharias, filho de Barachias, filho de Iddo, dizendo:`,
    ...
    `Comtudo as minhas palavras e os meus estatutos, que eu mandei aos prophetas, meus servos, não alcançaram a vossos paes? E elles tornaram, e disseram: Assim como o Senhor dos Exercitos fez tenção de nos tratar, segundo os nossos caminhos, e segundo as nossas obras, assim elle nos tratou.`,
    `Aos vinte e quatro dias do mez undecimo (que é o mez de Sebat), no segundo anno de Dario, veiu a palavra do Senhor ao propheta Zacharias, filho de Barachias, filho de Iddo, dizendo:`,
    `Vi de noite, e eis um homem montado n'um cavallo vermelho, e parava entre as murtas que estavam na profundeza, e atraz d'elle estavam cavallos vermelhos, morenos e brancos.`,
    ...
    `E o anjo que fallava comigo me disse: Clama, dizendo: Assim diz o Senhor dos Exercitos: Com grande zelo estou zelando por Jerusalem e por Sião.`,
    ...
    `Então eu disse: Que veem estes fazer? E elle fallou, dizendo: Estes são os poderes que espalharam a Jerusalem, de maneira que ninguem levantasse a sua cabeça; estes pois vieram para lhes metter medo, para derribarem os poderes das nações que levantaram o seu poder contra a terra de Judah, para a espalharem.`,
  ],
  2: [
  ...
  12: [
    ...
    `N'aquelle dia porei os chefes de Judah como um brazeiro de fogo debaixo da lenha, e como um tição de fogo entre gavelas; e á banda direita e esquerda consumirão a todos os povos em redor, e Jerusalem será habitada outra vez no seu logar, em Jerusalem.`,
    ...
    `N'aquelle dia o Senhor amparará os habitantes de Jerusalem; e o que tropeçar entre elles n'aquelle dia será como David, e a casa de David será como Deus, como o anjo do Senhor diante d'elles.`,
    `E será, n'aquelle dia, que procurarei destruir todas as nações que vierem contra Jerusalem;`,
    `Porém sobre a casa de David, e sobre os habitantes de Jerusalem, derramarei o Espirito de graça e de supplicações; e olharão para mim, a quem traspassaram: e farão pranto sobre elle, como o pranto sobre o unigenito; e chorarão amargosamente sobre elle, como se chora amargosamente sobre o primogenito.`,
    `N'aquelle dia será grande o pranto em Jerusalem, como o pranto de Hadadrimmon no valle de Meggiddon.`,
    `E a terra pranteará, cada linhagem á parte: a linhagem da casa de David, á parte, e suas mulheres, á parte, e a linhagem da casa de Nathan, á parte, e suas mulheres, á parte`,
  ...
  13: [
    ...
    `E será que, quando alguem prophetizar mais, seu pae e sua mãe, que o geraram, lhe dirão: Não viverás, porque fallaste mentira em nome do Senhor; e seu pae e sua mãe, que o geraram, o traspassarão quando prophetizar.`,
