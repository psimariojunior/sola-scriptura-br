const data: Record<number, string[]> = {
  ...
  12: [
    ...
    `Ele respondeu: “Uma geração perversa e adúltera pede um sinal milagroso! Mas nenhum sinal será dado, exceto o sinal do profeta Jonas.`,
  ...
  13: [
    ...
    `Pois eu digo a verdade: Muitos profetas e justos desejaram ver o que vocês estão vendo, mas não viram, e ouvir o que vocês estão ouvindo, mas não ouviram.`,
    ...
    `Quanto à semente que caiu no meio dos espinhos, esse é o caso daquele que ouve a palavra, mas a preocupação desta vida e o engano das riquezas a sufocam, tornando-a infrutífera.`,
    `E quanto à semente que caiu em boa terra, esse é o caso daquele que ouve a palavra e a entende, e dá uma colheita de cem, sessenta e trinta por um”.`,
    ...
    `Chegando à sua cidade, começou a ensinar o povo na sinagoga. Todos ficaram admirados e perguntavam: “De onde lhe vêm esta sabedoria e estes poderes milagrosos?`,
  ...
  23: [
    ...
    `Obedeçam-lhes e façam tudo o que eles dizem a vocês. Mas não façam o que eles fazem, pois não praticam o que pregam.`,
    ...
    `Por isso, eu estou enviando profetas, sábios e mestres. A uns vocês matarão e crucificarão; a outros açoitarão nas sinagogas de vocês e perseguirão de cidade em cidade.`,
  ...
  25: [
    ...
    `“Então o Rei dirá aos que estiverem à sua direita: ‘Venham, benditos de meu Pai! Recebam como herança o Reino que foi preparado para vocês desde a criação do mundo.`,
