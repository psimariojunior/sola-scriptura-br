const data: Record<number, string[]> = {
  ...
  2: [
    `E, tendo nascido Jesus em Bethlehem de Judéa, no tempo do rei Herodes, eis que uns magos vieram do oriente a Jerusalem,`,
    `Dizendo: Onde está aquelle que é nascido rei dos judeos? porque vimos a sua estrella no oriente, e viemos a adoral-o.`,
    ...
    `E tu, Bethlehem, terra de Judah, de modo nenhum és a menor entre as capitaes de Judah; porque de ti sairá o Guia que ha de apascentar o meu povo de Israel.`,
    ...
    `E, entrando na casa, acharam o menino com Maria sua mãe, e, prostrando-se, o adoraram; e, abrindo os seus thesouros, lhe offertaram dadivas: oiro, incenso e myrrha.`,
    ...
    `E, tendo-se elles retirado, eis-que o anjo do Senhor appareceu a José em sonhos, dizendo: Levanta-te, e toma o menino e sua mãe, e foge para o Egypto, e demora-te lá até que eu te diga; porque Herodes ha de procurar o menino para o matar.`,
    ...
    `Então Herodes, vendo que tinha sido illudido pelos magos, irritou-se muito, e mandou matar todos os meninos que havia em Bethlehem, e em todos os seus contornos, de edade de dois annos e menos, segundo o tempo que diligentemente inquirira dos magos.`,
  ...
  3: [
    ...
    `E, vendo elle muitos dos phariseos e dos sadduceos, que vinham ao seu baptismo, dizia-lhes: Raça de viboras, quem vos ensinou a fugir da ira futura?`,
    ...
    `E eu, em verdade, vos baptizo com agua, para o arrependimento; mas aquelle que vem após mim, é mais poderoso do que eu; cujas alparcas não sou digno de levar; elle vos baptizará com o Espirito Sancto, e com fogo.`,
    `Em sua mão tem a pá, e limpará a sua eira, e recolherá no celleiro o seu trigo, e queimará a palha com fogo que nunca se apagará.`,
    ...
    `E, sendo Jesus baptizado, saiu logo da agua, e eis-que se lhe abriram os céus, e viu o Espirito de Deus descendo como pomba e vindo sobre elle.`,
  ...
  5: [
    ...
    `Eu vos digo, porém, que qualquer que, sem motivo, se encolerisar contra seu irmão, será réu de juizo; e qualquer que disser a seu irmão: Raca, será réu do synhedrio; qualquer que lhe disser: Louco, será réu do fogo do inferno.`,
  ...
  8: [
    ...
    `E o centurião, respondendo, disse: Senhor, não sou digno de que entres debaixo do meu telhado, mas dize sómente uma palavra, e o meu creado sarará;`,
    `Pois tambem eu sou homem sujeito ao poder, e tenho soldados ás minhas ordens; e digo a este: Vae, e elle vae; e a outro: Vem, e elle vem; e ao meu creado: Faze isto, e elle o faz.`,
    ...
    `E disse Jesus: As raposas teem seus covis, e as aves do céu teem seus ninhos, mas o Filho do homem não tem onde reclinar a cabeça.`,
    ...
    `E, tendo chegado á outra banda, á provincia dos gergesenos, sairam-lhe ao encontro dois endemoninhados, vindos dos sepulchros, tão ferozes que ninguem podia passar por aquelle caminho.`,
    ...
    `E elle lhes disse: Ide. E, saindo elles, se introduziram na manada dos porcos; e eis que toda aquella manada de porcos se precipitou no mar por um despenhadeiro, e morreram nas aguas.`,
  ...
  9: [
    ...
    `E Jesus, passando adiante d'ali, viu assentado na alfandega um homem, chamado Mattheus, e disse-lhe: Segue-me. E elle, levantando-se, o seguiu.`,
    ...
    `E disse-lhes Jesus: Podem porventura andar tristes os filhos das bodas, emquanto o esposo está com elles? Dias, porém, virão em que lhes será tirado o esposo, e então jejuarão.`,
    ...
    `E, quando chegou a casa, os cegos se approximaram d'elle; e Jesus disse-lhes: Credes vós que eu possa fazer isto? Disseram-lhe elles: Sim, Senhor.`,
    ...
    `E percorria Jesus todas as cidades e aldeias, ensinando nas synagogas d'elles, e prégando o evangelho do reino, e curando todas as enfermidades e molestias entre o povo.`,
  ...
  10: [
    ...
    `E não temaes os que matam o corpo, e não podem matar a alma: temei antes aquelle que pode fazer perecer no inferno a alma e o corpo.`,
  ...
  11: [
    ...
    `E tu, Capernaum, que te ergues até aos céus, serás abatida até aos infernos; porque, se entre os de Sodoma fossem feitos os prodigios que em ti se fizeram, teriam permanecido até hoje`,
  ...
  12: [
    ...
    `E, se qualquer fallar alguma palavra contra o Filho do homem, ser-lhe-ha perdoado, mas, se alguem fallar contra o Espirito Sancto, não lhe será perdoado, nem n'este seculo nem no futuro.`,
  ...
  13: [
    ...
    `E o que foi semeado em espinhos é o que ouve a palavra, mas os cuidados d'este mundo, e a seducção das riquezas, suffocam a palavra, e fica infructifera;`,
  ...
  18: [
    ...
    `Portanto, se a tua mão ou o teu pé te escandalizar, corta-o, e atira-o para longe de ti: melhor te é entrar na vida côxo, ou aleijado, do que, tendo duas mãos ou dois pés, ser lançado no fogo eterno`,
  ...
  19: [
    ...
    `Porque ha eunuchos que assim nasceram do ventre da mãe; e ha eunuchos que foram castrados pelos homens; e ha eunuchos que se castraram a si mesmos por causa do reino dos céus. Quem pode receber isto, receba-o.`,
    ...
    `Disse-lhe Jesus: Se queres ser perfeito, vae, vende tudo o que tens, dá aos pobres, e terás um thesouro no céu; e vem, e segue-me.`,
    ...
    `E Jesus disse-lhes: Em verdade vos digo que vós, que me seguistes, na regeneração, quando o Filho do homem se assentar no throno da sua gloria, tambem vos assentareis sobre doze thronos, para julgar as doze tribus d'Israel.`,
    `E todo aquelle que tiver deixado casas, ou irmãos, ou irmãs, ou pae, ou mãe, ou mulher, ou filhos, ou terras, por amor do meu nome, receberá cem vezes tanto, e herdará a vida eterna.`,
  ...
  20: [
    ...
    `E, approximando-se a noite, diz o senhor da vinha ao seu mordomo: Chama os trabalhadores, e paga-lhes o jornal, começando desde os derradeiros até aos primeiros.`,
    ...
    `Eis que subimos a Jerusalem, e o Filho do homem será entregue aos principes dos sacerdotes, e aos escribas, e condemnal-o-hão á morte.`,
    `E o entregarão aos gentios para que d'elle escarneçam, e o açoitem e crucifiquem; e ao terceiro dia resuscitará.`,
    `Então se approximou d'elle a mãe dos filhos de Zebedeo, com seus filhos, adorando-o, e pedindo-lhe alguma coisa.`,
    ...
    `Jesus, porém, respondendo, disse: Não sabeis o que pedis; podeis vós beber o calix que eu hei de beber, e ser baptizados com o baptismo com que eu sou baptizado? Dizem-lhe elles: Podemos.`,
  ...
  23: [
    ...
    `Ai de vós, escribas e phariseos, hypocritas! pois que percorreis o mar e a terra para fazer um proselyto; e, depois de o terdes feito, o fazeis filho do inferno duas vezes mais do que vós.`,
  ...
  24: [
    ...
    `E, estando assentado no monte das Oliveiras, chegaram-se a elle os seus discipulos em particular, dizendo: Dize-nos quando serão essas coisas, e que signal haverá da tua vinda e do fim do mundo?`,
  ...
  25: [
    ...
    `Então dirá tambem aos que estiverem á sua esquerda: Apartae-vos de mim, malditos, para o fogo eterno, preparado para o diabo e seus anjos;`,
