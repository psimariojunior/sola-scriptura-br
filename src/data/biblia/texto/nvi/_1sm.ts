const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Então mandaram trazer de Siló a arca da aliança do SENHOR dos Exércitos, que tem o seu trono entre os querubins. E os dois filhos de Eli, Hofni e Fineias, acompanharam a arca da aliança de Deus.`,
    ...
    `O mensageiro respondeu: “Israel fugiu dos filisteus, e houve uma grande matança entre os soldados. Também os seus dois filhos, Hofni e Fineias, estão mortos, e a arca de Deus foi tomada”.`,
    ...
    `Sua nora, a mulher de Fineias, estava grávida e perto de dar à luz. Quando ouviu a notícia de que a arca de Deus havia sido tomada e que seu sogro e seu marido estavam mortos, entrou em trabalho de parto e deu à luz, mas não resistiu às dores do parto.`,
  ...
  6: [
    ...
    `O número dos ratos de ouro foi conforme o número das cidades filisteias que pertenciam aos cinco governantes; tanto as cidades fortificadas como os povoados do campo. A grande rocha, sobre a qual puseram a arca do SENHOR, é até hoje uma testemunha no campo de Josué, de Bete-Semes.`,
  ...
  8: [
    ...
    `E o SENHOR lhe respondeu: “Atenda a tudo o que o povo está pedindo; não foi a você que rejeitaram; foi a mim que rejeitaram como rei.`,
  ...
  9: [
    ...
    `O cozinheiro pegou a coxa do animal com o que estava sobre ela e colocou tudo diante de Saul. E disse Samuel: “Aqui está o que foi reservado para você. Coma, pois desde o momento em que eu disse: Tenho convidados, essa parte foi separada para você para esta ocasião”. E Saul comeu com Samuel naquele dia.`,
    `Depois que desceu do altar do monte para a cidade, Samuel conversou com Saul no terraço de sua casa.`,
    `Ao romper do dia, quando se levantaram, Samuel chamou Saul no terraço e disse: “Levante-se, e eu o acompanharei, e depois você seguirá viagem”. Saul se levantou e saiu com Samuel.`,
    `Enquanto desciam para a saída da cidade, Samuel disse a Saul: “Diga ao servo que vá na frente”. O servo foi e Samuel prosseguiu: “Fique você aqui um instante, para que eu dê a você uma mensagem da parte de Deus”.`,
  ],
  10: [
    ...
    `Hoje, quando você partir, encontrará dois homens perto do túmulo de Raquel, em Zelza, na fronteira de Benjamim. Eles dirão: ‘As jumentas que você foi procurar já foram encontradas. Agora seu pai deixou de se importar com elas e está preocupado com vocês. Ele está perguntando: “Como encontrarei meu filho?” ’`,
    ...
    `“Vá na minha frente até Gilgal. Depois eu irei também, para oferecer holocaustos e sacrifícios de comunhão , mas você deve esperar sete dias, até que eu chegue e diga a você o que fazer”.`,
  ...
  12: [
    ...
    `Respondeu Samuel: “Não tenham medo. De fato, vocês fizeram todo esse mal. Contudo, não deixem de seguir o SENHOR, mas sirvam ao SENHOR de todo o coração.`,
  ...
  14: [
    ...
    `entre os quais Aías, que levava o colete sacerdotal. Ele era filho de Aitube, irmão de Icabode, filho de Fineias e neto de Eli, o sacerdote do SENHOR em Siló. Ninguém sabia que Jônatas havia saído.`,
    ...
    `E gritaram para Jônatas e seu escudeiro: “Subam até aqui e daremos uma lição em vocês”. Diante disso, Jônatas disse a seu escudeiro: “Siga-me; o SENHOR os entregou nas mãos de Israel”.`,
    ...
    `Eles então se lançaram sobre os despojos e pegaram ovelhas, bois e bezerros; mataram-nos ali mesmo e comeram a carne com o sangue.`,
  ...
  16: [
    ...
    `Convide Jessé para o sacrifício, e eu mostrarei a você o que fazer. Você irá ungir para mim aquele que eu indicar”.`,
  ...
  19: [
    ...
    `Então Jônatas chamou Davi e lhe contou a conversa toda. Levou-o até Saul, e Davi voltou a servir Saul como anteriormente.`,
    `E houve guerra outra vez, e Davi foi lutar contra os filisteus. Ele lhes impôs uma grande derrota, por isso fugiram de Davi.`,
  ...
  20: [
    ...
    `“Nem pense nisso”, respondeu Jônatas; “você não será morto! Meu pai não fará coisa alguma sem antes me avisar, quer importante quer não. Por que ele iria esconder isso de mim? Não é nada disso!”`,
    ...
    `Assim Jônatas fez uma aliança com a família de Davi, dizendo: “Que o SENHOR chame os inimigos de Davi para prestar contas”.`,
  ...
  23: [
    ...
    `“Não tenha medo”, disse ele, “meu pai não porá as mãos em você. Você será rei de Israel, e eu serei o seu segundo em comando. Até meu pai sabe disso.”`,
  ...
  24: [
    ...
    `Eles disseram: “Este é o dia sobre o qual o SENHOR falou a você: ‘Entregarei nas suas mãos o seu inimigo para que você faça com ele o que quiser’ ”. Então Davi foi com muito cuidado e cortou uma ponta do manto de Saul, sem que este percebesse.`,
    ...
    `Então Davi saiu da caverna e gritou para Saul: “Ó rei, meu senhor!” Quando Saul olhou para trás, Davi inclinou-se com o rosto em terra`,
    `e depois disse: “Por que o rei dá atenção aos que dizem que eu pretendo fazer-te mal?`,
    `Hoje o rei pode ver com teus próprios olhos como o SENHOR te entregou em minhas mãos na caverna. Alguns insistiram que eu te matasse, mas eu te poupei, pois disse: Não erguerei a mão contra meu senhor, pois ele é o ungido do SENHOR.`,
  ...
  28: [
    ...
    `Samuel já havia morrido, e todo o Israel o havia pranteado e sepultado em Ramá, sua cidade natal. Saul havia expulsado do país os médiuns e os que consultavam espíritos.`,
    ...
    `Ele perguntou: “Qual a aparência dele?” E disse ela: “Um ancião que veste um manto está subindo”. Então Saul ficou sabendo que era Samuel, inclinou-se e prostrou-se com o rosto em terra.`,
    ...
    `Porque você não obedeceu ao SENHOR nem executou a grande ira dele contra os amalequitas, ele faz isso a você hoje.`,
