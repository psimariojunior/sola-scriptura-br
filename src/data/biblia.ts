...
export const doutrinas: Doutrina[] = [
  ...
  { nome: 'Inerrância Bíblica', slug: 'inerrancia-biblica', definicao: 'As Escrituras, no original autógrafo, são verdadeiras e infalíveis em tudo o que afirmam, sem erro em matéria de fé, história ou ciência.', passagens: ['Sl 12:6', 'Pv 30:5', 'Jo 17:17'], categoria: 'Bibliologia', tradicoes: 'Reformada: Inerrância absoluta do texto original. Católica: Verdade sem erro em questões de fé e costumes. Liberal: Verdade espiritual, não necessariamente factual.', posicaoA: 'Inerrância plena: a Bíblia não contém erro em nada o que afirma, incluindo ciência e história.', posicaoB: 'Inerrância limitada: a Bíblia é infalível em questões de fé e prática, mas pode conter imprecisões históricas e científicas.', confessionDocument: 'Declaração de Chicago (1978): "As Escrituras, no original, não afirmam nada que seja contrário à realidade dos fatos." — Artigo XII sobre ciência e história.' },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  { nome: 'Trindade', slug: 'trindade', definicao: 'Deus é um só em essência, mas existe em três pessoas distintas: Pai, Filho e Espírito Santo. Cada pessoa é plenamente Deus, mas há um único Deus.', passagens: ['Mt 28:19', '2 Co 13:14', '1 Pe 1:2'], categoria: 'Teologia Proper', tradicoes: 'Reformada: Trindade consubstancial. Católica: Trindade com processão dupla do Espírito (filioque). Ortodoxa: Monarquia do Pai — o Espírito procede somente do Pai (contra o filioque). Perichoresis como interpenetração vital das pessoas. Pentecostal: Ênfase no Batismo no Espírito como experiência trinitária.', posicaoA: 'Consubstancialidade: as três pessoas são da mesma substância (homoousios), coeternas e iguais em poder e glória.', posicaoB: 'Subordinacionismo: o Filho e o Espírito são eternamente subordinados ao Pai, embora divinos.', confessionDocument: 'Credo Niceno (325 d.C.): "Creio em um só Deus, Pai todo-poderoso... e em um só Senhor Jesus Cristo, consubstancial ao Pai" — define a igualdade de essência entre as pessoas.' },
  ...
  { nome: 'Criação', slug: 'criacao', definicao: 'Deus criou todas as coisas do nada, pela Sua Palavra, em seis dias, e tudo era muito bom. A criação testifica do poder e da glória do Criador.', passagens: ['Gn 1:1-31', 'Sl 33:6', 'Hb 11:3'], categoria: 'Teologia Proper', tradicoes: 'Reformada: Criacionismo da terra velha ou jovem. Católica: Criacionismo com interpretação alegórica possível. Ortodoxa: Distinção fundamental entre criado (cosmos) e Increado (Deus). A criação participa da energia divina mas não da essência (Gregório Palamas). Evangélica: Ênfase na criação ex nihilo e no design inteligente.' },
  ...
  { nome: 'Santificação', slug: 'santificacao', definicao: 'Processo progressivo pelo qual o Espírito Santo transforma o crente à imagem de Cristo, separando-o para Deus, renovando a mente e produzindo frutos de justiça.', passagens: ['1 Ts 4:3', 'Hb 12:14', '1 Pe 1:15-16'], categoria: 'Soteriologia', tradicoes: 'Reformada: Santificação progressiva e gradual. Católica: Santificação através dos sacramentos e mérito. Ortodoxa: Santificação como theosis (deificação) — participação na natureza divina (2 Pe 1:4). Processo que começa no batismo e se consuma na glória eterna. Inclui práticas ascéticas: oração, jejum, sacramentos (Lossky, Schmemann). Wesleyana: Santificação instantaneous como segunda bênção. Pentecostal: Santificação pelo poder do Espírito.' },
  { nome: 'Perseverança dos Santos', slug: 'perseveranca-dos-santos', definicao: 'Aqueles que foram verdadeiramente regenerados e justificados pela graça de Deus perseverarão até o fim, sendo guardados pelo poder divino até a salvação final.', passagens: ['Jo 10:28-29', 'Fp 1:6', 'Rm 8:38-39'], categoria: 'Soteriologia', tradicoes: 'Reformada: Perseverança incondicional (perseverança dos santos). Católica: Salvação pode ser perdida pela graça mortal. Ortodoxa: Perseverança como resposta livre à graça de Deus. A salvação não é garantia automática; o crente deve cooperar (synergy) com a graça até o fim. A apostasia é real. Arminiana: Perseverança condicional à perseverança na fé. Evangélica: Segurança eterna do crente.' },
  { nome: 'Batismo', slug: 'batismo', definicao: 'Ordenança instituída por Cristo como sinal visível da graça, simbolizando a morte e ressurreição com Cristo, pela imersão em água em nome do Pai, do Filho e do Espírito Santo.', passagens: ['Mt 28:19', 'Rm 6:3-4', 'At 2:38'], categoria: 'Soteriologia', tradicoes: 'Reformada: Batismo como sinal da aliança. Católica: Batismo como sacramento que remove o pecado original. Ortodoxa: Batismo como iniciação cristã completa — morte e ressurreição com Cristo. Inclui crisma (confirmação) e eucaristia imediatamente. Regeneração e início da theosis. Batista: Batismo como ordenança de crentes apenas. Pentecostal: Batismo como testemunho público de fé.' },
  { nome: 'Ceia do Senhor', slug: 'ceia-do-senhor', definicao: 'A Ceia do Senhor é ordenança instituída por Jesus como memorial da Sua morte sacrificial, onde os crentes participam do pão e do vinho em comunhão espiritual.', passagens: ['1 Co 11:23-26', 'Mt 26:26-29', 'Lc 22:19-20'], categoria: 'Soteriologia', tradicoes: 'Reformada: Ceia como sinal e selo da aliança. Católica: Transubstanciação (presença real). Ortodoxa: Divina Liturgia como participate do Reino. Presença real de Cristo pelo Espírito Santo (metousiosis). A eucaristia é centro da vida da Igreja e meanos supremo da theosis (Schmemann). Luterana: Consubstanciação. Evangélica: Memória simbólica da morte de Cristo.' },

  // ═══════════════════════════════════════════════════════════════════════
  // ECCLESIOLOGIA
  // ═══════════════════════════════════════════════════════════════════════
  { nome: 'Igreja', slug: 'igreja', definicao: 'A igreja é a comunidade dos chamados por Deus, corpo de Cristo, templo do Espírito Santo, composta por todos os crentes verdadeiros, que existe para adoração, edificação e missão.', passagens: ['Mt 16:18', '1 Co 12:27', 'Ef 1:22-23'], categoria: 'Eclesiologia', tradicoes: 'Reformada: Igreja invisível (eleitos) e visível (congregação). Católica: Igreja como instituição com hierarquia apostólica. Ortodoxa: Igreja como comunhão (koinonia) — corpo de Cristo vivente. Sobornost (conciliaridade) como princípio de unidade. Successio apostolica ininterrompida. Batista: Igreja local autônoma de crentes.' },
  { nome: 'Natureza da Igreja', slug: 'natureza-da-igreja', definicao: 'A igreja é uma realidade espiritual e comunitária: corpo de Cristo, noiva de Cristo, povo de Deus, coluna e firmeza da verdade, constituída por crentes regenerados.', passagens: ['Ef 5:25-27', '1 Tm 3:15', '1 Pe 2:9'], categoria: 'Eclesiologia', tradicoes: 'Reformada: Igreja visível e invisível. Católica: Igreja como sacramento universal de salvação. Ortodoxa: Igreja como theophania — manifestação do Reino. O corpo de Cristo é real, não apenas conceptual. A Igreja é santa porque Cristo é seu cabeça, mesmo com membros imperfeitos. Evangélica: Igreja como comunidade de crentes.' },
  { nome: 'Ministério da Igreja', slug: 'ministerio-da-igreja', definicao: 'Deus estabeleceu ofícios na igreja — pastores, mestres, evangelistas, apóstolos e diáconos — para equipar os santos, edificar o corpo e cumprir a Grande Comissão.', passagens: ['Ef 4:11-13', '1 Tm 3:1-13', 'At 20:28'], categoria: 'Eclesiologia', tradicoes: 'Reformada: Governo congregacional ou presbiteriano. Católica: Hierarquia papal e episcopal. Ortodoxa: Sinodalidade — governança conciliar (sínodos) sem primazia de um bispo. Cada igreja autocéfala mantém a fé apostólica. Batista: Governo congregacional democrático.' },
  { nome: 'Sacramentos/Ordens', slug: 'sacramentos-ordens', definicao: 'Ordenanças instituídas por Cristo como sinais visíveis da graça invisível: Batismo e Ceia do Senhor, meios de graça pela qual Deus fortalece a fé dos crentes.', passagens: ['Mt 28:19', '1 Co 11:23-26', 'Rm 6:3-4'], categoria: 'Eclesiologia', tradicoes: 'Reformada: Dois sacramentos (Batismo e Ceia). Católica: Sete sacramentos. Ortodoxa: Sete mistérios (Batismo, Crisma, Eucaristia, Confissão, Unção, Ordenação, Matrimônio). Cada mistério é theophania — encontro com Cristo pelo Espírito. Evangélica: Duas ordenanças como memorial e sinal.' },
  ...
  { nome: 'Ressurreição dos Mortos', slug: 'ressurreicao-dos-mortos', definicao: 'No último dia, todos os mortos ressuscitarão: os justos para a vida eterna com Deus, e os ímpios para a condenação eterna, cada um segundo as suas obras.', passagens: ['Jo 5:28-29', '1 Co 15:51-53', 'Dn 12:2'], categoria: 'Escatologia', tradicoes: 'Reformada: Ressurreição dos justos e injustos. Católica: Ressurreição da carne e juízo particular. Ortodoxa: Ressurreição como transformação — o corpo é transfigurado pela graça (1 Co 15:42-44). A ressurreição de Cristo é protótipo da nossa. Evangélica: Ressurreição corporal como esperança central.' },
  { nome: 'Juízo Final', slug: 'juizo-final', definicao: 'O julgamento final de Deus sobre toda a humanidade diante do Grande Trono Branco, onde os justos herdarão a vida eterna e os ímpios receberão a condenação eterna.', passagens: ['Mt 25:31-46', 'Ap 20:11-15', '2 Co 5:10'], categoria: 'Escatologia', tradicoes: 'Reformada: Juízo baseado em obras como evidência de fé. Católica: Juízo particular antes do geral. Ortodoxa: Juízo como revelação da verdade — Deus revela o que cada ser humano realmente é. Misericórdia e justiça não se opõem. Evangélica: Juízo das nações e dos indivíduos.' },
  { nome: 'Céu e Inferno', slug: 'ceu-e-inferno', definicao: 'O céu é a habitação eterna dos redimidos em comunhão com Deus; o inferno é o lugar de tormento eterno para os ímpios e rebeldes que rejeitaram a Deus.', passagens: ['Mt 25:46', 'Ap 21:1-4', 'Mc 9:43-48'], categoria: 'Escatologia', tradicoes: 'Reformada: Céu e inferno como destinos eternos. Católica: Céu, inferno e purgatório. Ortodoxa: Céu e inferno como a mesma presença de Deus — experimentada como glória pelos justos e como tormento pelos ímpios (Lossky). Estado intermediário com pré-juízo. O destino eterno é escolha livre do ser humano. Evangélica: Céu como presença de Deus, inferno como separação eterna.' },
  ...
  { nome: 'Christus Victor (Aulén)', slug: 'christus-victor', definicao: 'Cristo venceu Satanás, o pecado e a morte na cruz e na ressurreição. A expiação é uma vitória cósmica do Deus guerreiro que liberta a humanidade da escravidão espiritual.', passagens: ['Cl 2:15', 'Hb 2:14-15', '1 Jo 3:8', 'Ef 6:12'], categoria: 'Soteriologia', tradicoes: 'Reformada: Reconhece o aspecto de vitória. Católica: Modelo predominante na patrística. Ortodoxa: Christus Victor como modelo dominante — Cristo vence a morte, o diabo e o pecado pela cruz e ressurreição. A expiação é libertação da escravidão para a theosis (Ireneu, Atanásio, Aulén). Evangélica: Modelo crescentemente reconhecido. Luterana: Cristo como conquistador do diabo.' },
