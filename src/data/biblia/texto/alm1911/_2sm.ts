const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `E tinham fugido os beerothitas para Gittaim, e ali tinham peregrinado até ao dia de hoje.`,
    `E Jonathan, filho de Saul, tinha um filho aleijado de ambos os pés: era da edade de cinco annos quando as novas de Saul e Jonathan vieram de Jizreel, e sua ama o tomou, e fugiu: e succedeu que, apressando-se ella a fugir, elle caiu, e ficou côxo; e o seu nome era Mephiboseth.`,
    `E foram os filhos de Rimmon, o beerothita, Rekab e Baena, e entraram em casa de Isboseth no maior calor do dia, estando elle deitado a dormir, ao meio dia.`,
    `E ali entraram até ao meio da casa, como que vindo tomar trigo, e o feriram na quinta costella: e Rekab e Baena, seu irmão, escaparam;`,
    ...
    `E trouxeram a cabeça d'Isboseth a David, a Hebron, e disseram ao rei: Eis aqui a cabeça de Isboseth, filho de Saul, teu inimigo, que te procurava a morte: assim o Senhor vingou hoje ao rei meu senhor de Saul e da sua semente.`,
    ...
    `Que, pois se áquelle que me trouxe novas (dizendo: Eis que Saul morto é, parecendo-lhe porém aos seus olhos que era como quem trazia boas novas), eu logo lancei mão d'elle, e o matei em Siclag, cuidando elle que eu por isso lhe désse alviçaras;`,
  ...
  6: [
    ...
    `E puzeram a arca de Deus em um carro novo, e a levaram da casa de Abinadab, que está em Gibeah: e Uza e Ahio, filhos de Abinadab, guiavam o carro novo.`,
    `E levando-o da casa d'Abinadab, que está em Gibeah, com a arca de Deus, Ahio ia diante da arca.`,
    `E David, e toda a casa de Israel, fazia alegrias perante o Senhor, com toda a sorte de instrumentos de pau de faia: como com harpas, e com psalterios, e com tamboris, e com pandeiros, e com cymbalos.`,
    `E, chegando á eira de Nachon, estendeu Uza a mão á arca de Deus, e teve mão n'ella; porque os bois a deixavam pender.`,
    ...
    `E succedeu que, entrando a arca do Senhor na cidade de David, Michal, a filha de Saul, estava olhando pela janella: e, vendo ao rei David, que ia bailando e saltando diante do Senhor, o desprezou no seu coração.`,
    ...
    `E acabando David de offerecer os holocaustos e offertas pacificas, abençoou o povo em nome do Senhor dos exercitos.`,
    `E repartiu a todo o povo, e a toda a multidão de Israel, desde os homens até ás mulheres, a cada um, um bolo de pão, e um bom pedaço de carne, e um frasco de vinho; então foi-se todo o povo, cada um para sua casa.`,
    `E, voltando David para abençoar a sua casa, Michal, a filha de Saul, saiu a encontrar-se com David, e disse: Quão honrado foi o rei d'Israel, descobrindo-se hoje aos olhos das servas de seus servos, como sem pejo se descobre qualquer dos vadios.`,
    ...
    `E ainda mais do que isto me envilecerei, e me humilharei aos meus olhos: e das servas, de quem fallaste, d'ellas serei honrado.`,
  ...
  7: [
    ...
    `E em todo o logar em que andei com todos os filhos d'Israel, fallei porventura alguma palavra com alguma das tribus d'Israel, a quem mandei apascentar o meu povo d'Israel, dizendo: Porque me não edificaes uma casa de cedros?`,
    `Agora, pois, assim dirás ao meu servo, a David: Assim diz o Senhor dos exercitos: Eu te tomei da malhada detraz das ovelhas, para que fosses o chefe sobre o meu povo, sobre Israel.`,
    ...
    `E prepararei logar para o meu povo, para Israel, e o plantarei, para que habite no seu logar. e não mais seja movido, e nunca mais os filhos de perversidade o afflijam, como d'antes,`,
    ...
    `Quando teus dias forem completos, e vieres a dormir com teus paes, então farei levantar depois de ti a tua semente, que sair das tuas entranhas, e estabelecerei o seu reino.`,
    ...
    `Mas a minha benignidade se não apartará d'elle; como a tirei de Saul, a quem tirei de diante de ti.`,
    ...
    `Portanto, grandioso és, ó Senhor Jehovah, porque não ha similhante a ti, e não ha outro Deus senão tu só, segundo tudo o que temos ouvido com os nossos ouvidos.`,
    `E quem ha como o teu povo, como Israel, gente unica na terra? a quem Deus foi resgatar para seu povo; e a fazer-se nome, e a fazer-vos estas grandes e terriveis coisas á tua terra, diante do teu povo, que tu resgataste do Egypto, desterrando as nações e a seus deuses.`,
    ...
    `Pois tu, Senhor dos exercitos, Deus d'Israel, revelaste aos ouvidos de teu servo, dizendo: Edificar-te-hei casa. Portanto o teu servo achou no seu coração o fazer-te esta oração.`,
  ...
  8: [
    ...
    `Tambem feriu os moabitas, e os mediu com cordel, fazendo-os deitar por terra, e os mediu com dois cordeis para os matar, e com um cordel inteiro para os deixar em vida: ficaram assim os moabitas por servos de David, trazendo presentes.`,
    ...
    `E vieram os syros de Damasco a soccorrer a Hadadezer, rei de Zoba: porém David feriu dos syros vinte e dois mil homens.`,
    ...
    `E David tomou os escudos de oiro que havia com os servos de Hadadezer, e os trouxe a Jerusalem.`,
    ...
    `Mandou Toi seu filho Joram ao rei David, para lhe perguntar como estava, e para lhe dar os parabens por haver pelejado contra Hadadezer, e por o haver ferido (porque Hadadezer de continuo fazia guerra a Toi); e na sua mão trazia vasos de prata, e vasos de oiro, e vasos de bronze,`,
    ...
    `E poz guarnições em Edom, em todo o Edom poz guarnições, e todos os idumeos ficaram por servos de David: e o Senhor ajudava a David por onde quer que ia.`,
  ...
  10: [
    ...
    `Então disse David: Usarei de beneficencia com Hanun, filho de Nahas, como seu pae usou de beneficencia comigo. E enviou David a consolal-o, pelo ministerio de seus servos, ácerca de seu pae: e vieram os servos de David á terra dos filhos de Ammon.`,
    `Então disseram os principes dos filhos d'Ammon a seu senhor, Hanun: Porventura honra David a teu pae aos teus olhos, porque te enviou consoladores? porventura não te enviou David os seus servos para reconhecerem esta cidade, e para espial-a, e para transtornal-a?`,
    ...
    `O que fazendo saber a David, enviou a encontral-os; porque estavam estes homens sobremaneira envergonhados; e disse o rei: Deixae-vos estar em Jericó, até que vos torne a crescer a barba; e então vinde.`,
    `Vendo pois os filhos de Ammon, que se tinham feito abominaveis para David, enviaram os filhos d'Ammon, e alugaram dos syros de Beth-rechob e dos syros de Zoba vinte mil homens de pé, e do rei de Maaca mil homens e dos homens de Tob doze mil homens.`,
    `O que ouvindo David, enviou a Joab e a todo o exercito dos valentes.`,
    `E sairam os filhos d'Ammon, e ordenaram a batalha á entrada da porta: mas os syros de Zoba e Rechob, e os homens de Tob e Maaca estavam á parte no campo.`,
    ...
    `E, vendo os filhos d'Ammon que os syros fugiam, tambem elles fugiram de diante de Abisai, e entraram na cidade: e voltou Joab dos filhos d'Ammon, e veiu para Jerusalem.`,
    `Vendo pois os syros que foram feridos diante d'Israel, tornaram a refazer-se.`,
    `E enviou Hadadezer, e fez sair os syros que estavam da outra banda do rio, e vieram a Helam: e Sobach, chefe do exercito de Hadadezer, marchava diante d'elles.`,
  ...
  16: [
    `E passando David um pouco mais adiante do cume, eis que Ziba, o moço de Mephiboseth, veiu encontrar-se com elle, com um par de jumentos albardados, e sobre elles duzentos pães, com cem cachos de passas, e cem de fructas de verão e um odre de vinho.`,
    `E disse o rei a Ziba: Que pretendes com isto? E disse Ziba: Os jumentos são para a casa do rei, para se montarem n'elles; e o pão e as fructas de verão para comerem os moços; e o vinho para beberem os cançados no deserto.`,
    ...
    `E, chegando o rei David a Bahurim, eis que d'ali saiu um homem da linhagem da casa de Saul, cujo nome era Simei, filho de Gera, e, saindo, ia amaldiçoando.`,
    ...
    `O Senhor te deu agora a paga de todo o sangue da casa de Saul, em cujo logar tens reinado; já deu o Senhor o reino na mão de Absalão teu filho; e eis-te agora na tua desgraça, porque és um homem de sangue.`,
    ...
    `E succedeu que, chegando Husai, o archita, amigo de David, a Absalão, disse Husai a Absalão: Viva o rei, viva o rei!`,
    ...
    `E disse Achitophel a Absalão: Entra ás concubinas de teu pae, que deixou para guardarem a casa; e assim todo o Israel ouvirá que te fizeste aborrecivel para com teu pae; e se esforçarão as mãos de todos os que estão comtigo.`,
  ...
  18: [
    ...
    `E David enviou o povo, um terço debaixo da mão de Joab, e outro terço debaixo da mão de Abisai, filho de Zeruia, irmão de Joab, e outro terço debaixo da mão de Ittai, o getheo; e disse o rei ao povo: Eu tambem juntamente sairei comvosco.`,
    ...
    `E Absalão se encontrou com os servos de David; e Absalão ia montado n'um mulo; e, entrando o mulo debaixo da espessura doe ramos d'um grande carvalho, pegou-se-lhe a cabeça no carvalho, e ficou pendurado entre o céu e a terra: e o mulo, que estava debaixo d'elle, passou adiante.`,
    ...
    `Disse porém aquelle homem a Joab: Ainda que eu podesse pesar nas minhas mãos mil moedas de prata, não estenderia a minha mão contra o filho do rei, pois bem ouvimos que o rei te deu ordem a ti, e a Abisai, e a Ittai, dizendo: Guardae, cada um de vós, de tocar ao mancebo, a Absalão.`,
    `Ainda que commettesse mentira a risco da minha vida, nem por isso coisa nenhuma se esconderia ao rei; e tu mesmo te opporias.`,
    ...
    `Ora Absalão, quando ainda vivia, tinha tomado e levantado para si uma columna, que está no valle do rei, porque dizia: Filho nenhum tenho para conservar a memoria do meu nome. E chamou aquella columna pelo seu proprio. nome; pelo que até ao dia d'hoje se chama o Pilar d'Absalão.`,
    ...
    `Então viu a sentinella outro homem que corria, e a sentinella gritou ao porteiro, e disse: Eis que lá vem outro homem correndo só. Então disse o rei: Tambem traz este novas.`,
    ...
    `Então disse o rei a Cusi: Vae bem com o mancebo, com Absalão? E disse Cusi: Sejam como aquelle mancebo os inimigos do rei meu senhor, e todos os que se levantam contra ti para mal.`,
    `Então o rei se perturbou, e subiu á sala que estava por cima da porta, e chorou: e andando, dizia assim: Meu filho Absalão, meu filho, meu filho, Absalão! quem me dera que eu morrera por ti, Absalão, meu filho, meu filho!`,
  ],
  19: [
    ...
    `Amando tu aos que te aborrecem, e aborrecendo aos que te amam: porque hoje dás a entender que nada valem para comtigo capitães e servos; porque entendo hoje que se Absalão vivesse, e todos nós hoje fossemos mortos, então bem te parecera aos teus olhos.`,
    `Levanta-te pois agora; sae, e falla conforme ao coração de teus servos: porque pelo Senhor te juro que, se não saires, nem um só homem ficará comtigo esta noite; e mais mal te será isto do que todo o mal que tem vindo sobre ti desde a tua mocidade até agora.`,
    ...
    `E todo o povo, em todas as tribus de Israel, andava porfiando entre si, dizendo: O rei nos tirou das mãos de nossos inimigos, e elle nos livrou das mãos dos philisteos; e agora fugiu da terra por causa de Absalão.`,
    `E Absalão, a quem ungimos sobre nós, já morreu na peleja: agora, pois, porque vos calaes, e não fazeis voltar o rei`,
    `Então o rei David enviou a Zadok e a Abiathar, sacerdotes, dizendo: Fallae aos anciãos de Judah, dizendo: Porque serieis vós os ultimos em tornar a trazer o rei para a sua casa? (porque as palavras de todo o Israel chegaram ao rei, até á sua casa.)`,
    ...
    `E, passando a barca, para fazer passar a casa do rei e para trazer o que bem parecesse aos seus olhos, então Simei, filho de Gera, se prostrou diante do rei, passando elle o Jordão.`,
    `E disse ao rei: Não me impute meu senhor a minha culpa, e não te lembres do que tão perversamente fez teu servo, no dia em que o rei meu senhor saiu de Jerusalem, para o rei conserval-o no coração.`,
    ...
    `E disse elle: Ó rei meu senhor, o meu servo me enganou; porque o teu servo dizia: Albardarei um jumento, e n'elle montarei, e irei com o rei; pois o teu servo é côxo.`,
    ...
    `Porque toda a casa de meu pae não era senão de homens dignos de morte diante do rei meu senhor; e comtudo puzeste a teu servo entre os que comem á tua mesa: e que mais direito tenho eu de clamar ao rei?`,
    ...
    `Da edade de oitenta annos sou eu hoje; poderia eu discernir entre bom e mau? poderia o teu servo ter gosto no que comer e beber? Poderia eu mais ouvir a voz dos cantores e cantoras? E porque será o teu servo ainda pesado ao rei meu senhor?`,
    `Com o rei passará teu servo ainda um pouco mais além do Jordão: e porque me recompensará o rei com tal recompensa?`,
    `Deixa voltar o teu servo, e morrerei na minha cidade, junto á sepultura de meu pae e de minha mãe: mas eis ahi está o teu servo Chimham, o qual passe com o rei meu senhor, e faze-lhe o que bem parecer aos teus olhos.`,
    `Então disse o rei: Chimham passará comigo, e eu lhe farei como bem parecer aos teus olhos, e tudo quanto me pedires te farei.`,
  ...
  20: [
    ...
    `Vindo pois David para sua casa, a Jerusalem, tomou o rei as dez mulheres, suas concubinas, que deixara para guardarem a casa, e as poz n'uma casa em guarda, e as sustentava; porém não entrou a ellas: e estiveram encerradas até ao dia da sua morte, vivendo como viuvas.`,
    ...
    `Chegando elles pois á pedra grande que está junto a Gibeon, Amasa veiu: e estava Joab cingido da sua roupa que vestiu, e sobre ella um cinto, ao qual estava pegada a espada a seus lombos na sua bainha; e, adiantando-se elle, lhe caiu.`,
    ...
    `E Amasa estava envolto no seu sangue no meio do caminho: e, vendo aquelle homem que todo o povo parava, desviou a Amasa do caminho para o campo, e lançou sobre elle um manto; porque via que todo aquelle que chegava a elle parava.`,
    ...
    `A coisa não é assim; porém um só homem do monte d'Ephraim, cujo nome é Seba, filho de Bichri, levantou a mão contra o rei, contra David; entregae-me só este, e retirar-me-hei da cidade. Então disse a mulher a Joab; Eis que te será lançada a sua cabeça pelo muro.`,
    `E a mulher, na sua sabedoria, entrou a todo o povo, e cortaram a cabeça de Seba, filho de Bichri, e a lançaram a Joab; então tocou a buzina, e se retiraram da cidade, cada um para as suas tendas, e Joab voltou a Jerusalem, ao rei.`,
