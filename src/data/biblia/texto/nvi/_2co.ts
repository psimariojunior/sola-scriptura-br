const data: Record<number, string[]> = {
  ...
  6: [
    ...
    `Falamos abertamente a vocês, coríntios, e abrimos todo o nosso coração!`,
  ...
  11: [
    ...
    `Pois, se alguém tem pregado a vocês um Jesus que não é aquele que pregamos, ou se vocês acolhem um espírito diferente do que acolheram ou um evangelho diferente do que aceitaram, vocês o toleram com facilidade.`,
    ...
    `Portanto, não é surpresa que os seus servos finjam ser servos da justiça. O fim deles será o que as suas ações merecem.`,
  ...
  12: [
    ...
    `Agora, estou pronto para visitá-los pela terceira vez e não serei um peso, porque o que desejo não são os seus bens, mas vocês mesmos. Além disso, os filhos não devem ajuntar riquezas para os pais, mas os pais para os filhos.`,
