const data: Record<number, string[]> = {
  1: [
    ...
    `Porque as suas coisas invisiveis, desde a creação do mundo, tanto o seu eterno poder, como a sua divindade, se entendem, e claramente se vêem pelas coisas que estão creadas, para que fiquem inexcusaveis;`,
  ...
  8: [
    ...
    `Porque o que era impossivel á lei, porquanto estava enferma pela carne, Deus, enviando o seu Filho em similhança da carne do peccado, e pelo peccado, condemnou o peccado na carne;`,
    ...
    `Porém vós não estaes na carne, mas no espirito, se é que o Espirito de Deus habita em vós. Mas, se alguem não tem o Espirito de Christo, esse tal não é d'elle.`,
    `E, se Christo está em vós, o corpo, na verdade, está morto por causa do peccado, mas o espirito vive por causa da justiça.`,
    `E, se o Espirito d'aquelle que dos mortos resuscitou a Jesus habita em vós, aquelle que dos mortos resuscitou a Christo tambem vivificará os vossos corpos mortaes, pelo seu Espirito que em vós habita.`,
    ...
    `E, se nós somos filhos, somos logo herdeiros tambem, herdeiros de Deus e coherdeiros de Christo; se porventura com elle padecemos, para que tambem com elle sejamos glorificados.`,
    ...
    `E da mesma maneira tambem o Espirito ajuda as nossas fraquezas; porque não sabemos o que havemos de pedir como convem, mas o mesmo Espirito intercede por nós com gemidos inexprimiveis.`,
    ...
    `Porque os que d'antes conheceu tambem os predestinou para serem conformes á imagem de seu Filho; para que seja o primogenito entre muitos irmãos.`,
    ...
    `Quem nos separará do amor de Christo? A tribulação, ou a angustia, ou a perseguição, ou a fome, ou a nudez, ou o perigo, ou a espada?`,
    ...
    `Nem a altura, nem a profundidade, nem alguma outra creatura nos poderá separar do amor de Deus, que está em Christo Jesus nosso Senhor.`,
  ],
  9: [
  ...
  11: [
    ...
    `Digo pois: Porventura tropeçaram, para que caissem? De modo nenhum, mas pela sua queda veiu a salvação aos gentios, para os incitar á emulação.`,
    ...
    `Porque não quero, irmãos, que ignoreis este segredo (para que não presumaes de vós mesmos): que o endurecimento veiu em parte sobre Israel, até que a plenitude dos gentios haja entrado.`,
  ...
  12: [
    ...
    `E não vos conformeis com este mundo, mas transformae-vos pela renovação do vosso entendimento, para que experimenteis qual seja a boa, agradavel, e perfeita vontade de Deus.`,
  ...
  15: [
    ...
    `Porém, meus irmãos, certo estou, a respeito de vós, que tambem vós mesmos estaes cheios de bondade, cheios de todo o conhecimento, e poderosos para tambem vos admoestardes uns aos outros.`,
    `Mas, irmãos, em parte vos escrevi mais ousadamente, como trazendo-vos outra vez isto á memoria, pela graça que por Deus me foi dada;`,
    ...
    `Quando partir para Hespanha irei ter comvosco; pois espero que de passagem vos verei e para lá serei acompanhado de vós, depois de ter gozado em parte da vossa presença.`,
    ...
    `E rogo-vos, irmãos, por nosso Senhor Jesus Christo e pelo amor do Espirito, que combataes comigo em orações por mim a Deus;`,
  ...
  16: [
    ...
    `Mas agora se manifestou, e se notificou pelas Escripturas dos prophetas, segundo o mandamento do Deus eterno, para obediencia da fé entre todas as nações,`,
