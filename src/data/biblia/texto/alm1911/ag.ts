const data: Record<number, string[]> = {
  1: [
    `No anno segundo do rei Dario, no sexto mez, no primeiro dia do mez, veiu a palavra do Senhor, pelo ministerio do propheta Aggeo, a Zorobabel, filho de Sealtiel, principe de Judah, e a Josué, filho de Josadac, o summo sacerdote, dizendo:`,
    ...
    `Porque chamei seccura sobre a terra, e sobre os montes, e sobre o trigo e sobre o mosto; e sobre o azeite, e sobre o que a terra produz: como tambem sobre os homens, e sobre os animaes, e sobre todo o trabalho das mãos.`,
    `Então ouviu Zorobabel, filho de Sealtiel, e Josué, filho de Josadac, summo sacerdote, e todo o resto do povo a voz do Senhor seu Deus; e as palavras do propheta Aggeo, assim como o Senhor seu Deus o enviou; e temeu o povo diante do Senhor.`,
    `Então Aggeo, o embaixador do Senhor, na embaixada do Senhor, fallou ao povo, dizendo: Eu sou comvosco, diz o Senhor.`,
    `E o Senhor suscitou o espirito de Zorobabel, filho de Sealtiel, principe de Judah, e o espirito de Josué, filho de Josadac, summo sacerdote, e o espirito do resto de todo o povo, e vieram, e fizeram a obra na casa do Senhor dos Exercitos, seu Deus,`,
