              ...
              <div className="sola-card p-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { titulo: 'Use um Aplicativo ou Caderno', descricao: 'Algo que te lembre e te acompanhe — as notas e os planos daqui, ou um caderno. O ato de anotar ancora a memória e cria um registro que você pode revisitar.', cor: 'border-l-violet-400' },
