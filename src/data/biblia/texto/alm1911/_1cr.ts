const data: Record<number, string[]> = {
  ...
  5: [
    `Quanto aos filhos de Ruben, o primogenito de Israel;--porque elle era o primogenito, mas porque profanara a cama de seu pae, deu-se a sua primogenitura aos filhos de José, filho de Israel; para assim não ser contado na genealogia da primogenitura.`,
    ...
    `Beera, seu filho, o qual Tilgath-*pilneser, rei da Assyria, levou preso: este foi principe dos rubenitas.`,
    ...
    `Todos estes foram registrados, segundo as suas genealogias, nos dias de Jothão, rei de Judah, e nos dias de Jeroboão, rei de Israel.`,
  ...
  9: [
    `E todo o Israel foi contado por genealogia: eis que estão escriptos no livro dos reis de Israel: e os de Judah foram transportados a Babylonia, por causa da sua transgressão.`,
    ...
    `E Ibneias, filho de Jeroham, e Ela, filho de Uzzi, filho de Michri, e Mesullam, filho de Sephatias, filho de Reuel, filho d'Ibnijas;`,
    `E seus irmãos, segundo as suas gerações, novecentos e cincoenta e seis: todos estes homens foram cabeças dos paes nas casas de seus paes.`,
    ...
    `Como tambem seus irmãos, cabeças nas casas de seus paes, mil, setecentos e sessenta, varões valentes para a obra do ministerio da casa de Deus.`,
    ...
    `E Sallum, filho de Kore, filho de Ebiasaph, filho de Korah, e seus irmãos da casa de seu pae, os korahitas, tinham cargo da obra do ministerio, e eram guardas dos umbraes do tabernaculo: e seus paes foram capitães do arraial do Senhor, e guardadores da entrada.`,
    ...
    `Todos estes, escolhidos para serem porteiros dos umbraes, foram duzentos e doze: e foram estes, segundo as suas aldeias, postos em suas genealogias; e David e Samuel, o vidente, os constituiram no seu cargo.`,
    ...
    `Porque havia n'aquelle officio quatro porteiros-móres que eram levitas, e tinham cargo das camaras e dos thesouros da casa de Deus.`,
    ...
    `Porque d'elles alguns havia que tinham cargo dos vasos e de todos os vasos sagrados; como tambem da flor de farinha, e do vinho, e do azeite, e do incenso, e da especiaria.`,
    ...
    `E dos filhos dos kohatitas, de seus irmãos houve alguns que tinham cargo dos pães da proposição, para os prepararem em todos os sabbados.`,
  ...
  10: [
    ...
    `E os philisteos apertaram com Saul e com seus filhos, e feriram os philisteos a Jonathan, e a Abinadab, e a Malchisua, filhos de Saul.`,
    `E a peleja se aggravou contra Saul, e os frecheiros o acharam: e temeu muito aos frecheiros.`,
    `Então disse Saul ao seu escudeiro: Arranca a tua espada, e atravessa-me com ella; para que porventura não venham estes incircumcisos e escarneçam de mim. Porém o seu escudeiro não quiz, porque temia muito; então tomou Saul a espada, e se lançou sobre ella.`,
    ...
    `E, vendo todos os homens de Israel, que estavam no valle, que haviam fugido, e que Saul e seus filhos eram mortos, deixaram as suas cidades, e fugiram: então vieram os philisteos, e habitaram n'ellas.`,
    ...
    `Então todos os homens bellicosos se levantaram, e tomaram o corpo de Saul, e os corpos de seus filhos, e os trouxeram a Jabes; e sepultaram os seus ossos debaixo d'um carvalho em Jabes, e jejuaram sete dias.`,
    `Assim morreu Saul por causa da sua transgressão com que transgrediu contra o Senhor, por causa da palavra do Senhor, a qual não havia guardado; e tambem porque buscou a adivinhadora para a consultar.`,
  ...
  15: [
    ...
    `E os filhos dos levitas trouxeram a arca de Deus aos hombros, como Moysés tinha ordenado, conforme a palavra do Senhor, com as varas que tinham sobre si.`,
    ...
    `E com elles a seus irmãos da segunda ordem: a Zacharias, Ben, e Jaaziel, e Semiramoth, e Jehiel, e Uni, Eliab, e Benaias, e Maaseias, e Mattithias, e Eliphelehu, e Mikneias, e Obed-edom, e Jeiel, os porteiros.`,
    `E os cantores, Heman, Asaph e Ethan, se faziam ouvir com cymbalos de metal;`,
    `E Zacharias, e Aziel, e Semiramoth, e Jehiel, e Uni, e Eliab, e Maaseias, e Benaias, com alaudes, sobre Alamoth:`,
    ...
    `E Sebanias, e Josaphat, e Nethaneel, e Amasai, e Zacharias, e Benaias, e Eliezer, os sacerdotes, tocavam as trombetas perante a arca de Deus: e Obed-edom e Jehias eram porteiros da arca.`,
    ...
    `E succedeu que, ajudando Deus os levitas que levavam a arca do concerto do Senhor, sacrificaram sete novilhos e sete carneiros.`,
  ...
  20: [
    ...
    `Tambem o povo que estava n'ella levou, e os fez serrar com a serra, e cortar com talhadeiras de ferro e com machados; e assim fez David com todas as cidades dos filhos de Ammon: então voltou David, com todo o povo, para Jerusalem.`,
  ...
  22: [
    ...
    `Porque dizia David: Salomão, meu filho, ainda é moço e tenro, e a casa que se ha de edificar para o Senhor se ha de fazer magnifica em excellencia, para nome e gloria em todas as terras; eu pois agora lhe prepararei materiaes. Assim preparou David materiaes em abundancia, antes da sua morte.`,
    ...
    `Porém a mim a palavra do Senhor veiu, dizendo: Tu derramaste sangue em abundancia, e fizeste grandes guerras; não edificarás casa ao meu nome; porquanto muito sangue tens derramado na terra, perante a minha face.`,
    ...
    `Eis que na minha oppressão preparei para a casa do Senhor cem mil talentos de oiro, e um milhão de talentos de prata, e de cobre e de ferro sem peso, porque em abundancia é: tambem madeira e pedras preparei, e tu suppre o que faltar.`,
  ...
  28: [
    `Então David convocou em Jerusalem todos os principes de Israel, os principes das tribus, e os capitães das turmas, que serviam o rei, e os capitães dos milhares, e os capitães das centenas, e os maioraes de toda a fazenda e possessão do rei, e de seus filhos, como tambem os eunuchos e varões, e todo o varão valente.`,
    `E poz-se o rei David em pé, e disse: Ouvi-me, irmãos meus, e povo meu: Em meu coração propuz eu edificar uma casa de repouso para a arca do concerto do Senhor e para o escabello dos pés do nosso Deus, e eu tinha feito o preparo para a edificar.`,
    `Porém Deus me disse: Não edificarás casa ao meu nome, porque és homem de guerra, e derramaste muito sangue.`,
    `E o Senhor Deus de Israel escolheu-me de toda a casa de meu pae, para que eternamente fosse rei sobre Israel; porque a Judah escolheu por principe, e a casa de meu pae na casa de Judah: e entre os filhos de meu pae se agradou de mim para me fazer reinar sobre todo o Israel.`,
    `E, de todos os meus filhos (porque muitos filhos me deu o Senhor), escolheu elle o meu filho Salomão para se assentar no throno do reino do Senhor sobre Israel.`,
    ...
    `E tu, meu filho Salomão, conhece o Deus de teu pae, e serve-o com um coração perfeito e com uma alma voluntaria; porque esquadrinha o Senhor todos os corações, e entende todas as imaginações dos pensamentos: se o buscares, será achado de ti; porém, se o deixares, rejeitar-te-ha para sempre.`,
    ...
    `O oiro deu, segundo o peso do oiro, para todos os vasos de cada ministerio: tambem a prata, por peso, para todos os vasos de prata, para todos os vasos de cada ministerio:`,
    `E o peso para os castiçaes de oiro, e suas candeias de oiro, segundo o peso de cada castiçal e as suas candeias: tambem para os castiçaes de prata, segundo o peso do castiçal e as suas candeias, segundo o ministerio de cada castiçal.`,
    `Tambem deu o oiro por peso para as mesas da proposição, para cada mesa: como tambem a prata para as mesas de prata.`,
    `E oiro puro para os garfos, e para as bacias, e para as escudelas, e para as taças de oiro, para cada taça seu peso; como tambem para as taças de prata, para cada taça seu peso.`,
    `E para o altar do incenso, oiro purificado, por seu peso: como tambem o oiro para o modelo do carro, a saber, dos cherubins, que haviam de estender as azas, e cobrir a arca do concerto do Senhor.`,
    `Tudo isto, disse David, por escripto me deram a entender por mandado do Senhor, a saber, todas as obras d'este risco.`,
    `E disse David a Salomão seu filho: Esforça-te e tem bom animo, e obra; não temas, nem te espavoreças; porque o Senhor Deus, meu Deus, ha de ser comtigo; não te deixará, nem te desamparará, até que acabes toda a obra do serviço da casa do Senhor.`,
  ...
  29: [
    ...
    `Então os chefes dos paes, e os principes das tribus d'Israel, e os capitães dos milhares e das centenas, até os capitães da obra do rei, voluntariamente contribuiram;`,
    `E deram para o serviço da casa de Deus cinco mil talentos de oiro, e dez mil drachmas, e dez mil talentos de prata, e dezoito mil talentos de cobre, e cem mil talentos de ferro.`,
    ...
    `Tua é, Senhor, a magnificencia, e o poder, e a honra, e a victoria, e a magestade; porque teu é tudo quanto ha nos céus e na terra; teu é, Senhor, o reino, e tu te exaltaste sobre todos por chefe.`,
    ...
    `E bem sei eu, Deus meu, que tu provas os corações, e que das sinceridades te agradas: eu tambem na sinceridade de meu coração voluntariamente dei todas estas coisas: e agora vi com alegria que o teu povo, que se acha aqui, voluntariamente te deu`,
    `Senhor, Deus de nossos paes Abrahão, Isaac, e Israel, conserva isto para sempre no intento dos pensamentos do coração de teu povo; e encaminha o seu coração para ti.`,
    ...
    `E comeram e beberam n'aquelle dia perante o Senhor, com grande gozo: e a segunda vez fizeram rei a Salomão filho de David, e o ungiram ao Senhor por guia, e a Zadok por sacerdote.`,
    ...
    `Os successos pois do rei David, assim os primeiros como os ultimos, eis que estão escriptos nas chronicas de Samuel, o vidente, e nas chronicas do propheta Nathan, e nas chronicas de Gad, o vidente;`,
