const data: Record<number, string[]> = {
  ...
  12: [
    ...
    `E o príncipe que está entre eles, levará nos ombros sua bagagem de noite, e sairá; na parede cavarão uma abertura para saírem por ela; cobrirá seu rosto para não ver com seus olhos a terra.`,
  ...
  39: [
    ...
    `Portanto assim diz o Senhor DEUS: Agora restaurarei Jacó de seu infortúnio, terei misericórdia de toda a casa de Israel, e zelarei por meu santo nome.`,
  ...
  40: [
    `No vigésimo quinto ano de nosso cativeiro, no princípio do ano, aos dez do mês, aos catorze anos depois que a cidade foi ferida, naquele mesmo dia veio sobre mim a mão do SENHOR, e me levou para lá.`,
