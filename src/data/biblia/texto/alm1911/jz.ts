const data: Record<number, string[]> = {
  1: [
    `E succedeu, depois da morte de Josué, que os filhos de Israel perguntaram ao Senhor, dizendo: Quem d'entre nós primeiro subirá aos cananeos, para pelejar contra elles?`,
    ...
    `E acharam a Adoni-bezek em Bezek, e pelejaram contra elle: e feriram aos cananeos e aos pherezeos.`,
    ...
    `Porém os filhos de Benjamin não expelliram os jebuseos que habitavam em Jerusalem: antes os jebuseos habitaram com os filhos de Benjamin em Jerusalem, até ao dia d'hoje.`,
    ...
    `Tão pouco Aser expelliu aos moradores d'Acco, nem aos moradores de Sidon: como nem a Acbal, nem a Acsih, nem a Chelba, nem a Aphik, nem a Recob;`,
    `Porém os aseritas habitaram no meio dos cananeos que habitavam na terra: porquanto os não expelliram.`,
    `Tão pouco Naphtali expelliu aos moradores de Beth-semes, nem aos moradores de Beth-anath; mas habitou no meio dos cananeos que habitavam na terra: porém lhes foram tributarios os moradores de Beth-semes e Beth-anath.`,
  ...
  4: [
    ...
    `E vendeu-os o Senhor em mão de Jabin, rei de Canaan, que reinava em Hazor: e Sisera era o capitão do seu exercito, o qual então habitava em Haroseth dos gentios.`,
    ...
    `E habitava debaixo das palmeiras de Debora, entre Rama e Beth-el, nas montanhas d'Ephraim: e os filhos d'Israel subiam a ella a juizo.`,
    `E enviou, e chamou a Barac, filho de Abinoam de Kedes de Naphtali, e disse-lhe: Porventura o Senhor Deus d'Israel não deu ordem, dizendo: Vae, e attrahe gente ao monte de Tabor, e toma comtigo dez mil homens dos filhos de Naphtali e dos filhos de Zebulon?`,
    ...
    `E disse ella: Certamente irei comtigo, porém não será tua a honra pelo caminho que levas; pois á mão de uma mulher o Senhor venderá a Sisera. E Debora se levantou, e partiu com Barac para Kedes`,
    ...
    `Porém Sisera fugiu a pé á tenda de Jael, mulher de Heber, keneo: porquanto havia paz entre Jabin, rei de Hazor, e a casa de Heber, keneo.`,
    `E Jael saiu ao encontro de Sisera, e disse-lhe: Retira-te, senhor meu, retira-te a mim, não temas. Retirou-se a ella á tenda, e cobriu-o com uma coberta.`,
    ...
    `Então Jael, mulher d'Heber, tomou uma estaca da tenda, e lançou mão d'um martello, e foi-se mansamente a elle, e lhe cravou a estaca na fonte, e a pregou na terra, estando elle porém carregado d'um profundo somno, e já cançado; e assim morreu.`,
    `E eis que, seguindo Barac a Sisera, Jael lhe saiu ao encontro, e disse-lhe: Vem, e mostrar-te-hei o homem que buscas. E veiu a ella, e eis-que Sisera jazia morto, e a estaca na fonte.`,
  ...
  7: [
    ...
    `E disse o Senhor a Gideon: Ainda muito povo ha; faze-os descer ás aguas, e ali t'os provarei: e será que, d'aquelle de que eu te disser: Este irá comtigo, esse comtigo irá; porém de todo aquelle, de que eu te disser: Este não irá comtigo, esse não irá.`,
    ...
    `E disse o Senhor a Gideon: Com estes trezentos homens que lamberam as aguas vos livrarei, e darei os midianitas na tua mão; pelo que toda a outra gente se vá cada um ao seu logar.`,
    ...
    `Chegando pois Gideon, eis que estava contando um homem ao seu companheiro um sonho, e dizia: Eis que um sonho sonhei, eis que um pão de cevada torrado rodava pelo arraial dos midianitas, e chegava até ás tendas, e as feriu, e cairam, e as transtornou de cima para baixo; e ficaram abatidas.`,
    ...
    `Assim tocaram os tres esquadrões as buzinas, e partiram os cantaros; e tinham nas suas mãos esquerdas as tochas accesas, e nas suas mãos direitas as buzinas, que tocavam: e exclamaram: Espada do Senhor, e de Gideon.`,
    `E ficou-se cada um no seu logar ao redor do arraial: então todo o exercito deitou a correr, e, gritando, fugiram.`,
    `Tocando pois os trezentos as buzinas, o Senhor tornou a espada d'um contra o outro, e isto em todo o arraial: e o exercito fugiu para Zererath, até Beth-sitta até aos limites de Abel-mehola, acima de Tabbath.`,
    `Então os homens de Israel, de Naphtali, e d'Aser e de todo o Manasseh foram convocados, e perseguiram aos midianitas.`,
    `Tambem Gideon enviou mensageiros a todas as montanhas d'Ephraim, dizendo: Descei ao encontro dos midianitas, e tomae-lhes as aguas até Beth-bara, a saber, o Jordão. Convocados pois todos os homens d'Ephraim, tomaram-lhes as aguas até Beth-bara e o Jordão.`,
    `E prenderam a dois principes dos midianitas, a Oreb e a Zeeb; e mataram a Oreb na penha d'Oreb, e a Zeeb mataram no lagar de Zeeb, e perseguiram aos midianitas: e trouxeram as cabeças d'Oreb e de Zeeb a Gideon, d'além do Jordão.`,
  ],
  8: [
    ...
    `E, como Gideon veiu ao Jordão, passou com os trezentos homens que com elle estavam, já cançados, mas ainda perseguindo.`,
    ...
    `E d'ali subiu a Penuel, e fallou-lhes da mesma maneira: e os homens de Penuel lhe responderam como os homens de Succoth lhe haviam respondido.`,
    `Pelo que tambem fallou aos homens de Penuel, dizendo: Quando eu voltar em paz, derribarei esta torre.`,
    `Estavam pois Zebah e Salmuna em Carcor, e os seus exercitos com elles, uns quinze mil homens, todos os que ficavam do exercito dos filhos do oriente: e os que cairam foram cento e vinte mil homens, que arrancavam a espada.`,
    ...
    `Tomou preso a um moço dos homens de Succoth, e lhe fez perguntas: o qual descreveu os principes de Succoth, e os seus anciãos, setenta e sete homens.`,
    `Então veiu aos homens de Succoth, e disse: Vedes aqui a Zebah e a Salmuna, dos quaes desprezivelmente me deitastes em rosto, dizendo: Está já a palma da mão de Zebah e Salmuna na tua mão, para que dêmos pão aos teus homens, já cançados?`,
    ...
    `Então disseram Zebah e Salmuna: Levanta-te tu, e accommette-nos; porque, qual o homem, tal a sua valentia. Levantou-se pois Gideon, e matou a Zebah e a Salmuna, e tomou as lunetas, que estavam aos pescoços dos seus camelos.`,
    ...
    `E disseram elles: De boamente os daremos. E estenderam uma capa, e cada um d'elles deitou ali um pendente do seu despojo.`,
    `E foi o pezo dos pendentes d'oiro, que pediu, mil e setecentos siclos d'oiro, afóra as lunetas, e as cadeias, e os vestidos de purpura, que traziam os reis dos midianitas, e afóra as colleiras que os camelos traziam ao pescoço.`,
  ...
  11: [
    ...
    `Tambem a mulher de Gilead lhe pariu filhos, e, sendo os filhos d'esta mulher já grandes, expelliram a Jefthe, e lhe disseram: Não herdarás em casa de nosso pae, porque és filho d'outra mulher.`,
    ...
    `E disseram os anciãos de Gilead a Jefthe: Por isso tornamos a ti, para que venhas comnosco, e combatas contra os filhos d'Ammon: e nos sejas por Cabeça sobre todos os moradores de Gilead.`,
    `Então Jefthe disse aos anciãos de Gilead: Se me tornardes a levar para combater contra os filhos d'Ammon, e o Senhor m'os dér diante de mim, então eu vos serei por Cabeça?`,
    `E disseram os anciãos de Gilead a Jefthe: O Senhor será testemunha entre nós, e assim o faremos conforme á tua palavra.`,
    `Assim Jefthe foi-se com os anciãos de Gilead, e o povo o poz por Cabeça e principe sobre si: e Jefthe fallou todas as suas palavras perante o Senhor em Mispah.`,
    ...
    `E Israel enviou mensageiros ao rei dos edomitas, dizendo: Rogo-te que me deixes passar pela tua terra. Porém o rei dos edomitas não lhe deu ouvidos; enviou tambem ao rei dos moabitas, o qual tambem não quiz: e assim Israel ficou em Cades.`,
    `Depois andou pelo deserto, e rodeou a terra dos edomitas e a terra dos moabitas, e veiu do nascente do sol á terra dos moabitas, e alojaram-se d'além d'Arnon; porém não entraram nos limites dos moabitas, porque Arnon é limite dos moabitas.`,
    ...
    `E o Senhor Deus d'Israel deu a Sehon com todo o seu povo na mão d'Israel, e os feriram: e Israel tomou por herança toda a terra dos amorrheos que habitavam n'aquella terra.`,
    ...
    `Agora pois és tu ainda melhor do que Balac, filho de Zippor, rei dos moabitas? porventura contendeu elle em algum tempo com Israel, ou pelejou alguma vez contra elles?`,
    `Emquanto Israel habitou trezentos annos em Hesbon e nas suas villas, e em Aroer e nas suas villas, em todas as cidades que estão ao longo d'Arnon, porque o não recuperastes n'aquelle tempo?`,
    ...
    `Então o espirito do Senhor veiu sobre Jefthe, e atravessou elle por Gilead e Manasseh: porque passou até Mispah de Gilead, e de Mispah de Gilead passou até aos filhos d'Ammon.`,
  ...
  13: [
    ...
    `Porém disse-me: Eis que tu conceberás e parirás um filho: agora pois não bebas vinho, nem bebida forte, e não comas coisa immunda; porque o menino será nazireo de Deus, desde o ventre até ao dia da sua morte.`,
    `Então Manué orou instantemente ao Senhor, e disse: Ah! Senhor meu, rogo-te que o homem de Deus, que enviaste, ainda venha para nós outra vez e nos ensine o que devemos fazer ao menino que ha de nascer.`,
    `E Deus ouviu a voz de Manué: e o anjo de Deus veiu outra vez á mulher, e ella estava no campo, porém não estava com ella seu marido Manué.`,
    ...
    `E disse o anjo do Senhor a Manué: De tudo quanto eu disse á mulher se guardará ella.`,
    ...
    `Porém o anjo do Senhor disse a Manué: Ainda que me detenhas, não comerei de teu pão; e se fizeres holocausto o offerecerás ao Senhor. Porque não sabia Manué que fosse o anjo do Senhor`,
    ...
    `Então Manué tomou um cabrito e uma offerta de manjares, e os offereceu sobre uma penha ao Senhor: e obrou o anjo maravilhosamente, vendo-o Manué e sua mulher.`,
    `E succedeu que, subindo a chamma do altar para o céu, o anjo do Senhor subiu na chamma do altar: o que vendo Manué e sua mulher, cairam em terra sobre seus rostos.`,
    ...
    `Porém sua mulher lhe disse: Se o Senhor nos quizera matar, não acceitaria da nossa mão o holocausto e a offerta de manjares, nem nos mostraria tudo isto, nem nos deixaria ouvir taes coisas n'este tempo.`,
  ...
  14: [
    ...
    `Porém seu pae e sua mãe lhe disseram: Não ha porventura mulher entre as filhas de teus irmãos, nem entre todo o meu povo, para que tu vás tomar mulher dos philisteos, d'aquelles incircumcisos? E disse Sansão a seu pae: Tomae-me esta, porque ella agrada aos meus olhos`,
    ...
    `E tomou-o nas suas mãos, e foi-se andando e comendo d'elle; e foi-se a seu pae e a sua mãe, e deu-lhes d'elle, e comeram, porém não lhes deu a saber que tomara o mel do corpo do leão.`,
    ...
    `Então lhes disse: Do comedor saiu comida, e doçura saiu do forte. E em tres dias não poderam declarar o enigma.`,
    `E succedeu que, ao setimo dia, disseram á mulher de Sansão: Persuade a teu marido que nos declare o enigma, para que porventura não queimemos a fogo a ti e á casa de teu pae: chamastes-nos vós aqui para possuir o que é nosso, não é assim?`,
    `E a mulher de Sansão chorou diante d'elle, e disse: Tão sómente me aborreces, e não me amas; pois déste aos filhos do meu povo um enigma a adivinhar, e ainda m'o não declaraste a mim. E elle lhe disse: Eis que nem a meu pae nem a minha mãe o declarei, e t'o declararia a ti?`,
    `E chorou diante d'elle os sete dias em que celebravam as bodas: succedeu pois que ao setimo dia lh'o declarou, porquanto o importunava; então ella declarou o enigma aos filhos do seu povo.`,
    ...
    `Então o espirito do Senhor tão possantemente se apossou d'elle, que desceu aos ascalonitas, e matou d'elles trinta homens, e tomou os seus vestidos, e deu as mudas de vestidos aos que declararam o enigma: porém accendeu-se a sua ira, e subiu á casa de seu pae`,
  ...
  15: [
    ...
    `Então tres mil homens de Judah desceram até á cova da rocha d'Etam, e disseram a Sansão: Não sabias tu que os philisteos dominam sobre nós? porque pois nos fizeste isto? E elle lhes disse: Assim como elles me fizeram a mim, eu lhes fiz a elles`,
    ...
    `E, vindo elle a Lechi, os philisteos lhe sairam ao encontro, jubilando: porém o espirito do Senhor possantemente se apossou d'elle, e as cordas que elle tinha nos braços se tornaram como fios de linho que se queimaram no fogo, e as suas amarraduras se desfizeram das suas mãos.`,
    `E achou uma queixada fresca d'um jumento, e estendeu a sua mão, e tomou-a, e feriu com ella mil homens,`,
  ...
  16: [
    ...
    `E foi dito aos gazitas: Sansão entrou aqui. Foram pois em roda, e toda a noite lhe puzeram espias á porta da cidade: porém toda a noite estiveram socegados, dizendo: Até á luz da manhã esperaremos; então o mataremos.`,
    `Porém Sansão deitou-se até á meia noite, e á meia noite se levantou, e travou das portas da entrada da cidade com ambas as umbreiras, e juntamente com a tranca as tomou, pondo-as sobre os hombros; e levou-as para cima até ao cume do monte que está defronte de Hebron`,
    `E depois d'isto aconteceu que se affeiçoou a uma mulher do valle de Sorec, cujo nome era Dalila.`,
    `Então os principes dos philisteos subiram a ella, e lhe disseram: Persuade-o, e vê, em que consiste a sua grande força, e com que poderiamos assenhorear-nos d'elle e amarral-o, para assim o affligir mos: e te daremos cada um mil e cem moedas de prata.`,
    ...
    `E os espias estavam assentados com ella n'uma camara. Então ella lhe disse: Os philisteos veem sobre ti, Sansão. Então quebrou as vergas de vimes, como se quebra o fio da estopa ao cheiro do fogo; assim não se soube em que consistia a sua força.`,
    ...
    `E descobriu-lhe todo o seu coração, disse-lhe: Nunca subiu navalha á minha cabeça, porque sou nazireo de Deus desde o ventre de minha mãe: se viesse a ser rapado, ir-se-hia de mim a minha força, e me enfraqueceria, e seria como todos os mais homens.`,
    `Vendo pois Dalila que já lhe descobrira todo o seu coração, enviou, e chamou os principes dos philisteos, dizendo: Subi esta vez, porque agora me descobriu elle todo o seu coração. E os principes dos philisteos subiram a ella, e trouxeram o dinheiro na sua mão.`,
    ...
    `E disse ella: Os philisteos veem sobre ti, Sansão. E despertou do seu somno, e disse: Sairei ainda esta vez como d'antes, e me sacudirei. Porque elle não sabia que já o Senhor se tinha retirado d'elle.`,
    ...
    `Ora estava a casa cheia de homens e mulheres: e tambem ali estavam todos os principes dos philisteos: e sobre o telhado havia alguns tres mil homens e mulheres, que estavam vendo brincar Sansão.`,
    ...
    `E disse Sansão: Morra eu com os philisteos. E inclinou-se com força, e a casa caiu sobre os principes e sobre todo o povo que n'ella havia: e foram mais os mortos que matou na sua morte do que os que matara na sua vida.`,
    `Então seus irmãos desceram, e toda a casa de seu pae, e tomaram-n'o, e subiram com elle, e sepultaram-n'o entre Tsora e Estaol, no sepulchro de Manué, seu pae: e julgou elle a Israel vinte annos.`,
  ],
  17: [
    `E havia um homem da montanha d'Ephraim, cujo nome era Micah.`,
    `O qual disse a sua mãe: As mil e cem moedas de prata que te foram tiradas, por cuja causa deitavas maldições, e tambem as disseste em meus ouvidos, eis que este dinheiro eu o tenho, eu o tomei. Então disse sua mãe: Bemdito seja meu filho do Senhor.`,
    `Assim restituiu as mil e cem moedas de prata a sua mãe: porém sua mãe disse: Inteiramente tenho dedicado este dinheiro da minha mão ao Senhor para meu filho, para fazer uma imagem de esculptura e de fundição: de sorte que agora t'o tornarei a dar`,
  ...
  21: [
    ...
    `E olhae, e eis ahi, saindo as filhas de Silo a dançar em ranchos, sahi vós das vinhas, e arrebatae-vos cada um sua mulher das filhas de Silo, e ide-vos á terra de Benjamin.`,
    `E será que, quando seus paes ou seus irmãos vierem a litigar comnosco, nós lhes diremos: Por amor de nós, tende compaixão d'elles, pois n'esta guerra não tomámos mulheres para cada um d'elles: porque não lh'as déstes vós, para que agora ficasseis culpados?`,
    `E os filhos de Benjamin o fizeram assim, e levaram mulheres conforme ao numero d'elles, das que arrebatavam dos ranchos que dançavam: e foram-se, e voltaram á sua herança, e reedificaram as cidades, e habitaram n'ellas.`,
