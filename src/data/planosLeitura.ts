...
export const novosPlanos: Record<string, PlanoLeitura> = {
  ...
  'fichas-40': {
    titulo: '40 dias nas fichas profundas',
    descricao: 'Um capítulo por dia com ficha escrita à mão: contexto, teologia e pergunta — não é só checklist de leitura.',
    duracao: 40,
    categoria: 'tematico',
    nivel: 'intermediario',
    versiculos: [
      { dia: 1, titulo: 'Deus fala e o mundo existe', passagens: p([r('gn', 1)]) },
      { dia: 2, titulo: 'O jardim e a aliança', passagens: p([r('gn', 2)]) },
      { dia: 3, titulo: 'A queda e o protoevangelho', passagens: p([r('gn', 3)]) },
      { dia: 4, titulo: 'A arca da graça', passagens: p([r('gn', 6)]) },
      { dia: 5, titulo: 'O chamado de Abrão', passagens: p([r('gn', 12)]) },
      { dia: 6, titulo: 'Justiça pela fé', passagens: p([r('gn', 15)]) },
      { dia: 7, titulo: 'O Cordeiro provido', passagens: p([r('gn', 22)]) },
      { dia: 8, titulo: 'Eu Sou o que Sou', passagens: p([r('ex', 3)]) },
      { dia: 9, titulo: 'A Páscoa', passagens: p([r('ex', 12)]) },
      { dia: 10, titulo: 'O mar se abre', passagens: p([r('ex', 14)]) },
      { dia: 11, titulo: 'Os Dez Mandamentos', passagens: p([r('ex', 20)]) },
      { dia: 12, titulo: 'O Dia da Expiação', passagens: p([r('lv', 16)]) },
      { dia: 13, titulo: 'O Shema', passagens: p([r('dt', 6)]) },
      { dia: 14, titulo: 'Sê forte: a Palavra', passagens: p([r('js', 1)]) },
      { dia: 15, titulo: 'Lealdade no amargor', passagens: p([r('rt', 1)]) },
      { dia: 16, titulo: 'Davi e Golias', passagens: p([r('1sm', 17)]) },
      { dia: 17, titulo: 'A aliança davídica', passagens: p([r('2sm', 7)]) },
      { dia: 18, titulo: 'Os dois caminhos', passagens: p([r('sl', 1)]) },
      { dia: 19, titulo: 'O Rei no Sião', passagens: p([r('sl', 2)]) },
      { dia: 20, titulo: 'O servo sofredor (Sl 22)', passagens: p([r('sl', 22)]) },
      { dia: 21, titulo: 'O Senhor é o meu pastor', passagens: p([r('sl', 23)]) },
      { dia: 22, titulo: 'Cria em mim um coração puro', passagens: p([r('sl', 51)]) },
      { dia: 23, titulo: 'Bendize, ó minha alma', passagens: p([r('sl', 103)]) },
      { dia: 24, titulo: 'O Senhor diz ao meu Senhor', passagens: p([r('sl', 110)]) },
      { dia: 25, titulo: 'Santo, santo, santo', passagens: p([r('is', 6)]) },
      { dia: 26, titulo: 'O Servo ferido', passagens: p([r('is', 53)]) },
      { dia: 27, titulo: 'A nova aliança', passagens: p([r('jr', 31)]) },
      { dia: 28, titulo: 'O Filho do Homem', passagens: p([r('dn', 7)]) },
      { dia: 29, titulo: 'As bem-aventuranças', passagens: p([r('mt', 5)]) },
      { dia: 30, titulo: 'O filho perdido', passagens: p([r('lc', 15)]) },
      { dia: 31, titulo: 'O Verbo se fez carne', passagens: p([r('jo', 1)]) },
      { dia: 32, titulo: 'Nascer do alto', passagens: p([r('jo', 3)]) },
      { dia: 33, titulo: 'Eis o Homem', passagens: p([r('jo', 19)]) },
      { dia: 34, titulo: 'Pentecostes', passagens: p([r('at', 2)]) },
      { dia: 35, titulo: 'Todos pecaram', passagens: p([r('rm', 3)]) },
      { dia: 36, titulo: 'Nenhuma condenação', passagens: p([r('rm', 8)]) },
      { dia: 37, titulo: 'Mortos, vivificados', passagens: p([r('ef', 2)]) },
      { dia: 38, titulo: 'A fé que vê o invisível', passagens: p([r('hb', 11)]) },
      { dia: 39, titulo: 'Deus é amor', passagens: p([r('1jo', 4)]) },
      { dia: 40, titulo: 'Céus novos, terra nova', passagens: p([r('ap', 21)]) },
    ],
  },
