const data: Record<number, string[]> = {
  1: [
    `Palavras de Jeremias, filho de Hilkias, dos sacerdotes que estavam em Anathoth, na terra de Benjamin:`,
    `Ao qual veiu a palavra do Senhor, nos dias de Josias, filho d'Ammon, rei de Judah, no decimo terceiro anno do seu reinado.`,
    `Assim lhe veiu tambem nos dias de Jeheiakim, filho de Josias, rei de Judah, até ao fim do anno undecimo de Zedekias, filho de Josias, rei de Judah, até que Jerusalem foi levada em captiveiro no quinto mez.`,
    ...
    `Porque eis que eu convoco todas as familias dos reinos do norte, diz o Senhor; e virão, e cada um porá o seu throno á entrada das portas de Jerusalem, e contra todos os seus muros em redor, e contra todas as cidades de Judah.`,
    ...
    `Porque, eis que te ponho hoje por cidade forte, e por columna de ferro, e por muros de bronze, contra toda a terra; contra os reis de Judah, contra os seus principes, contra os seus sacerdotes, e contra o povo da terra.`,
  ...
  2: [
    ...
    `Vae, e clama aos ouvidos de Jerusalem, dizendo: Assim diz o Senhor: Lembro-me de ti, da beneficencia da tua mocidade, e do amor dos teus desposorios, quando andavas após mim no deserto, n'uma terra que se não semeava.`,
    ...
    `E não disseram: Onde está o Senhor, que nos fez subir da terra do Egypto? que nos guiou pelo deserto, por uma terra de charnecas, e de covas, por uma terra de sequidão e sombra de morte, por uma terra pela qual ninguem passava, e homem nenhum morava n'ella?`,
    ...
    `Os sacerdotes não disseram: Onde está o Senhor? E os que tratavam da lei não me conheciam, e os pastores prevaricavam contra mim, e os prophetas prophetizavam por Baal, e andavam após o que de nada aproveita.`,
    ...
    `Quando eu já ha muito quebrava o teu jugo, e rompia as tuas ataduras, dizias tu: Nunca mais transgredirei; comtudo em todo o outeiro alto e debaixo de toda a arvore verde te andas encurvando e fornicando.`,
    ...
    `Como dizes logo: Não estou contaminado nem andei após os baalins? vê o teu caminho no valle, conhece o que fizeste: dromedaria ligeira és, que anda torcendo os seus caminhos.`,
  ...
  6: [
    `Fugi em tropas, filhos de Benjamin, do meio de Jerusalem; e tocae a buzina em Tekoa, e levantae o facho sobre Beth-accerem: porque da banda do norte apparece um mal e um grande quebrantamento.`,
    ...
    `Como a fonte produz as suas aguas, assim ella produz a sua malicia: violencia e estrago se ouvem n'ella; enfermidade e feridas ha diante de mim continuadamente.`,
    ...
    `A quem fallarei e testemunharei, que ouça? eis que os seus ouvidos estão incircumcisos, e já não podem escutar; eis que a palavra do Senhor lhes é coisa vergonhosa, e já não gostam d'ella`,
    `Pelo que já estou cheio do furor do Senhor, e cançado de o conter: derramal-o-hei sobre os meninos pelas ruas, e sobre o ajuntamento dos mancebos juntamente; porque até o marido com a mulher serão presos, e o velho com o que está cheio de dias`,
    ...
    `Assim diz o Senhor: Ponde-vos nos caminhos, e vêde, e perguntae pelas veredas antigas, qual seja o bom caminho, e andae por elle; e achareis descanço para a vossa alma: e dizem: Não andaremos por elle.`,
    ...
    `Arco e lança trarão, crueis são, e não usarão de misericordia, a sua voz rugirá como o mar, e em cavallos irão montados, dispostos como homens de guerra contra ti, ó filha de Sião`,
  ...
  11: [
    ...
    `Que ordenei a vossos paes no dia em que os tirei da terra do Egypto, da fornalha de ferro, dizendo: Dae ouvidos á minha voz, e fazei conforme tudo quanto vos mando; e vós me sereis a mim por povo, e eu vos serei a vós por Deus.`,
    ...
    `Porém não ouviram, nem inclinaram os seus ouvidos, antes andaram cada um conforme o proposito do seu coração malvado: pelo que trouxe sobre elles todas as palavras d'este concerto que lhes mandei que fizessem porém as não fizeram.`,
    `Disse-me mais o Senhor: Uma conjuração se achou entre os homens de Judah, entre os habitantes de Jerusalem.`,
    `Tornaram ás maldades de seus primeiros paes, que não quizeram ouvir as minhas palavras; e elles andaram após deuses alheios para os servir: a casa de Israel e a casa de Judah quebrantaram o meu concerto, que tinha feito com seus paes.`,
    `Portanto assim diz o Senhor: Eis que trarei mal sobre elles, de que não poderão escapar, e clamarão a mim e eu não os ouvirei.`,
    `Então irão as cidades de Judah e os habitantes de Jerusalem e clamarão aos deuses a quem elles queimaram incenso, porém de nenhuma sorte os livrarão no tempo do seu mal.`,
    ...
    `Porque o Senhor dos Exercitos, que te plantou, pronunciou contra ti o mal, pela maldade da casa d'Israel e da casa de Judah, que fizeram entre si mesmos, para me provocarem á ira, queimando incenso a Baal.`,
    `E o Senhor m'o fez saber, e assim o soube: então me fizeste ver as suas acções.`,
    `E eu era como um cordeiro, como um boi que levam á matança; porque não sabia que pensavam contra mim pensamentos, dizendo: Destruamos a arvore com o seu fructo, e cortemol-o da terra dos viventes, e não haja mais memoria do seu nome.`,
  ...
  12: [
    ...
    `A minha herança me é ave de varias côres; andam as aves contra ella em redor: vinde, pois, ajuntae-vos todos os animaes do campo, vinde a devoral-a.`,
    ...
    `Sobre todos os logares altos do deserto vieram destruidores; porque a espada do Senhor devora desde um extremo da terra até outro extremo da terra: não ha paz para nenhuma carne.`,
    ...
    `Assim diz o Senhor, ácerca de todos os meus maus visinhos, que tocam a minha herança, a qual dei por herança ao meu povo Israel: Eis que os arrancarei da sua terra, e a casa de Judah arrancarei do meio d'elles.`,
  ...
  16: [
    ...
    `Morrerão de enfermidades dolorosas, e não serão pranteados nem sepultados: servirão d'esterco sobre a terra; e pela espada e pela fome serão consumidos , e os seus cadaveres servirão de mantimento para as aves do céu e para os animaes da terra.`,
    ...
    `E nada se lhes repartirá por dó, para consolal-os por causa de morte: nem lhes darão a beber do copo de consolação, nem por pae de alguem, nem por mãe de alguem.`,
    `Nem entres na casa do banquete, para te assentares com elles a comer e a beber.`,
    `Porque assim diz o Senhor dos Exercitos, o Deus d'Israel: Eis que farei cessar d'este logar perante os vossos olhos, e em vossos dias, a voz de gozo e a voz de alegria, a voz do esposo e a voz da esposa.`,
    ...
    `Então lhes dirás: Porquanto vossos paes me deixaram, diz o Senhor, e se foram após deuses alheios, e os serviram, e se inclinaram diante d'elles, e a mim me deixaram, e a minha lei não a guardaram.`,
    ...
    `Mas: Vive o Senhor, que fez subir os filhos d'Israel da terra do norte, e de todas as terras para onde os tinha lançado; porque fal-os-hei voltar á sua terra, a qual dei a seus paes.`,
    `Eis que mandarei muitos pescadores, diz o Senhor, os quaes os pescarão, e depois enviarei muitos caçadores, os quaes os caçarão de sobre todo o monte, e de sobre todo o outeiro, e até das fendas das rochas.`,
  ...
  22: [
    ...
    `E dize: Ouve a palavra do Senhor, ó rei de Judah, que te assentas no throno de David: tu, e os teus servos, e o teu povo, que entraes por estas portas.`,
    ...
    `Portanto assim diz o Senhor ácerca de Joaquim, filho de Josias, rei de Judah: Não lamentarão por elle, dizendo: Ai, irmão meu, ou, Ai, irmã minha! nem lamentarão por elle, dizendo: Ai, Senhor, ou, Ai, sua magestade!`,
    `Em sepultura de jumento será sepultado, arrastando-o e lançando-o para bem longe, fóra das portas de Jerusalem.`,
    `Sobe ao Libano, e clama, e levanta a tua voz em Basan, e clama pelas passagens, que já estão quebrantados os teus namorados.`,
    ...
    `Vivo eu, diz o Senhor, que ainda que Conias, filho de Joaquim, rei de Judah, fosse o annel do sello na minha mão direita, que d'ali te arrancaria.`,
    `E te entregarei na mão dos que buscam a tua vida, e na mão d'aquelles diante de quem tu temes, a saber, na mão de Nabucodonozor, rei de Babylonia, e na mão dos chaldeos.`,
    ...
    `Assim diz o Senhor: Escrevei que este homem está roubado de filhos, homem que não prosperará nos seus dias; porque não prosperará algum da sua geração, que se assentar no throno de David, e que reinar mais em Judah.`,
  ],
  23: [
    `Ai dos pastores que destroem e dispersam as ovelhas do meu pasto, diz o Senhor.`,
    `Portanto assim diz o Senhor, o Deus d'Israel, ácerca dos pastores que apascentam o meu povo: Vós dispersastes as minhas ovelhas, e as afugentastes, e não as visitastes: eis que visitarei sobre vós a maldade das vossas acções, diz o Senhor.`,
    `E eu mesmo recolherei o resto das minhas ovelhas, de todas as terras para onde as tiver afugentado, e as farei voltar aos seus curraes; e fructificarão, e se multiplicarão.`,
    ...
    `Porque a terra está cheia de adulteros, e a terra chora por causa da maldição: os pastos do deserto se seccam; porque a sua carreira é má, e a sua força não é recta.`,
    ...
    `Mas nos prophetas de Jerusalem vejo uma coisa horrenda: commettem adulterios, e andam com falsidade, e esforçam as mãos dos malfeitores, para que não se convertam da sua maldade; teem-se tornado para mim como Sodoma, e os seus moradores como Gomorrah.`,
    ...
    `Que cuidam que farão que o meu povo se esqueça do meu nome pelos seus sonhos que cada um conta ao seu companheiro, assim como seus paes se esqueceram do meu nome por causa de Baal.`,
    ...
    `Eis que eu sou contra os que prophetizam sonhos falsos, diz o Senhor, e os contam, e fazem errar o meu povo com as suas mentiras e com as suas leviandades; e eu não os enviei, nem lhes dei ordem; e não fizeram proveito nenhum a este povo, diz o Senhor.`,
  ...
  24: [
    `Fez-me o Senhor ver, e eis aqui dois cestos de figos, postos diante do templo do Senhor, depois que Nabucodonosor, rei de Babylonia, levou em captiveiro a Jechonias, filho de Joaquim, rei de Judah, e os principes de Judah, e os carpinteiros, e os ferreiros de Jerusalem, e os trouxe a Babylonia.`,
    ...
    `Então veiu a mim a palavra do Senhor, dizendo:`,
    `Assim diz o Senhor, o Deus de Israel: Como a estes bons figos, assim tambem conhecerei aos de Judah, levados em captiveiro; os quaes enviei d'este logar para a terra dos chaldeos, para o seu bem.`,
    ...
    `E como os figos maus, que se não podem comer, de maus que são (porque assim diz o Senhor), assim usarei com Zedekias, rei de Judah, e com os seus principes, e com o resto de Jerusalem, que ficou de resto n'esta terra, e com os que habitam na terra do Egypto.`,
  ...
  25: [
    `A palavra que veiu a Jeremias ácerca de todo o povo de Judah no anno quarto de Joaquim, filho de Josias, rei de Judah (que é o primeiro anno de Nabucodonozor, rei de Babylonia),`,
    ...
    `Dizendo: Convertei-vos agora cada um do seu mau caminho, e da maldade das suas acções, e habitae na terra que vos deu o Senhor, e a vossos paes, de seculo em seculo;`,
    ...
    `Porque assim me disse o Senhor, o Deus d'Israel: Toma da minha mão este copo do vinho do furor, e darás a beber d'elle a todas as nações, ás quaes eu te enviarei.`,
    ...
    `E a todos os reis do norte, os de perto, e os de longe, um com outro, e a todos os reinos da terra, que estão sobre a face da terra, e o rei de Sheshach beberá depois d'elles.`,
    `Pois lhes dirás: Assim diz o Senhor dos Exercitos, o Deus d'Israel: Bebei, e embebedae-vos, e vomitae, e cahi, e não torneis a levantar-vos, por causa da espada que eu enviarei entre vós.`,
    ...
    `Porque, eis que na cidade que se chama pelo meu nome começo a castigar; e serieis vós totalmente innocentes? não sereis innocentes; porque eu chamo a espada sobre todos os moradores da terra, diz o Senhor dos Exercitos.`,
    `Tu pois lhes prophetizarás todas estas palavras, e lhes dirás: O Senhor desde o alto bramará, e dará a sua voz desde a morada da sua sanctidade: terrivelmente bramará contra a sua habitação, e com grito de alegria, como dos que pizam as uvas, contra todos os moradores da terra.`,
    ...
    `Uivae, pastores, e clamae, e rebolae-vos na cinza, honrados do rebanho, porque já se cumpriram os vossos dias para vos matar, e eu vos quebrantarei, e vós então caireis como um vaso precioso.`,
  ...
  26: [
    ...
    `Porém sabei por certo que, se me matardes a mim, trareis sangue innocente sobre vós, e sobre esta cidade, e sobre os seus habitantes: porque, na verdade, o Senhor me enviou a vós, a fallar aos vossos ouvidos todas estas palavras.`,
    ...
    `E, ouvindo o rei Joaquim, e todos os seus valentes, e todos os principes, as suas palavras, procurou o rei matal-o; o que ouvindo Urias, temeu, e fugiu, e foi para o Egypto;`,
  ...
  28: [
    `E succedeu no mesmo anno, no principio do reinado de Zedekias, rei de Judah, no anno quarto, no mez quinto, que me fallou Hananias, filho de Azur, o propheta que era de Gibeon, na casa do Senhor, perante os olhos dos sacerdotes e de todo o povo, dizendo:`,
    ...
    `Porque assim diz o Senhor dos Exercitos, o Deus d'Israel: Jugo de ferro puz sobre o pescoço de todas estas nações, para servirem a Nabucodonozor, rei de Babylonia, e servil-o-hão, e até os animaes do campo lhe dei.`,
  ...
  29: [
    `E estas são as palavras da carta que Jeremias, o propheta, enviou de Jerusalem, ao resto do captiveiro dos anciãos, como tambem aos sacerdotes, e aos prophetas, e a todo o povo que Nabucodonozor havia transportado de Jerusalem a Babylonia;`,
    `Depois que sairam o rei Jechonias, e a rainha, e os eunuchos, e os principes de Judah e Jerusalem, e os carpinteiros e ferreiros de Jerusalem,`,
    `Pela mão de Elasa, filho de Saphan, e de Gemarias, filho de Hilkias, os quaes enviou Zedekias, rei de Judah, a Babylonia, a Nabucodonozor, rei de Babylonia, dizendo:`,
    ...
    `Tomae mulheres e gerae filhos e filhas, e tomae mulheres para vossos filhos, e dae vossas filhas a maridos, e parirão filhos e filhas; e multiplicae-vos ali, e não vos diminuaes.`,
    ...
    `Porque assim diz o Senhor: Certamente que em se cumprindo setenta annos em Babylonia, vos visitarei, e continuarei sobre vós a minha boa palavra, tornando-vos a trazer a este logar.`,
    ...
    `E serei achado de vós, diz o Senhor, e farei tornar os vossos captivos, e congregar-vos-hei de todas as nações, e de todos os logares para onde vos lancei, diz o Senhor, e tornarei a trazer-vos ao logar d'onde vos transportei.`,
    ...
    `E perseguil-os-hei com a espada, com a fome, e com a peste; dal-os-hei para servirem de commoção a todos os reinos da terra, como tambem por maldição, e por espanto, e por assobio, e por opprobrio entre toda sas nações para onde os lançar;`,
    ...
    `Assim diz o Senhor dos Exercitos, o Deus de Israel, ácerca de Ahab, filho de Colaias, e de Zedekias, filho de Maaseias, que vos prophetizam falsamente no meu nome: Eis que os entregarei na mão de Nabucodonozor, rei de Babylonia, e elle os ferirá diante dos vossos olhos.`,
    ...
    `Assim diz o Senhor dos Exercitos, o Deus d'Israel, dizendo: Porquanto tu enviaste no teu nome cartas a todo o povo que está em Jerusalem, como tambem a Sofonias, filho de Maaseias, o sacerdote, e a todos os sacerdotes, dizendo:`,
    ...
    `Portanto assim diz o Senhor: Eis que visitarei a Semaias, o nehelamita, e a sua semente: elle não terá ninguem que habite entre este povo, e não verá o bem que hei de fazer ao meu povo, diz o Senhor, porquanto fallou rebellião contra o Senhor.`,
  ],
  30: [
  ...
  31: [
    ...
    `Assim que virão, e exultarão na altura de Sião, e correrão aos bens do Senhor, ao trigo, e ao mosto, e ao azeite, e aos cordeiros e bezerros; e a sua alma será como um jardim regado, e nunca mais andarão tristes.`,
    ...
    `Eis que dias veem, diz o Senhor, em que farei um concerto novo com a casa de Israel e com a casa de Judah.`,
    `Não conforme o concerto que fiz com seus paes, no dia em que os tomei pela mão, para os tirar da terra do Egypto; porque elles invalidaram o meu concerto, ainda que me desposei com elles, diz o Senhor.`,
    `Mas este é o concerto que farei com a casa de Israel depois d'aquelles dias, diz o Senhor: Porei a minha lei no seu interior, e a escreverei no seu coração; e lhes serei a elles por Deus e elles me serão a mim por povo.`,
    `E não ensinará alguem mais a seu proximo, nem alguem a seu irmão, dizendo: Conhecei ao Senhor: porque todos me conhecerão, desde o mais pequeno d'elles até ao maior d'elles, diz o Senhor: porque lhes perdoarei a sua maldade, e nunca mais me lembrarei dos seus peccados.`,
    `Assim diz o Senhor, que dá o sol para luz do dia, e as ordenanças da lua e das estrellas para luz da noite, que fende o mar, e as suas ondas bramem; o Senhor dos Exercitos é o seu nome.`,
  ...
  32: [
    ...
    `Porque Zedekias, rei de Judah, o tinha encerrado, dizendo: Porque prophetizas tu, dizendo: Assim diz o Senhor: Eis que entrego esta cidade na mão do rei de Babylonia, e elle a tomará;`,
    `E Zedekias, rei de Judah, não escapará das mãos dos chaldeos; mas certamente será entregue na mão do rei de Babylonia, e com elle fallará bocca a bocca, e os seus olhos verão os d'elle`,
    ...
    `Eis que Hanameel, filho de Sallum, teu tio, virá a ti, dizendo: Compra para ti a minha herdade que está em Anathot, pois tens o direito de resgate para compral-a.`,
    `Veiu pois a mim Hanameel, filho de meu tio, segundo a palavra do Senhor, ao pateo da guarda, e me disse: Compra agora a minha herdade que está em Anathot, que está na terra de Benjamin; porque tens o direito hereditario, e tens o resgate; compra-a para ti. Então entendi que isto era a palavra do Senhor.`,
    ...
    `E dei o auto da compra a Baruch, filho de Nerias, filho de Maaseias, perante os olhos de Hanameel, filho de meu tio, e perante os olhos das testemunhas, que subscreveram o conhecimento da compra, e perante os olhos de todos os judeos que se assentavam no pateo da guarda.`,
    ...
    `Que usas de benignidade com milhares, e rendes a maldade dos paes no seio dos filhos depois d'elles: o grande, o poderoso Deus cujo nome é o Senhor dos Exercitos:`,
    ...
    `Que pozeste signaes e maravilhas na terra do Egypto até ao dia de hoje, tanto em Israel, como entre os outros homens, e te fizeste um nome, qual tu tens n'este dia.`,
    ...
    `E entraram n'ella, e a possuiram, porém não obedeceram á tua voz, nem andaram na tua lei; tudo o que lhes mandaste que fizessem, elles não o fizeram; pelo que fizeste que lhes succedesse todo este mal`,
    `Eis aqui os vallados! já vieram contra a cidade para tomal-a, e a cidade está dada na mão dos chaldeos, que pelejam contra ella, por causa da espada, e da fome, e da pestilencia; e o que fallaste se ez, e eis aqui o estás presenciando.`,
    `Comtudo tu me disseste, Senhor Jehovah: Compra para ti o campo por dinheiro, e faze que o testifiquem testemunhas, posto que a cidade esteja já dada na mão dos chaldeos.`,
    ...
    `E os chaldeos, que pelejam contra esta cidade, entrarão n'ella, porão fogo a esta cidade, e queimarão juntamente as casas sobre cujos terraços queimarão incenso a Baal e offerecerão libações a outros deuses, para me provocarem á ira.`,
    `Porque os filhos de Israel e os filhos de Judah não fizeram senão mal aos meus olhos, desde a sua mocidade; porque os filhos de Israel sómente me provocaram á ira com as obras das suas mãos, diz o Senhor.`,
    ...
    `Por toda a maldade dos filhos de Israel, e dos filhos de Judah, que fizeram, para me provocarem á ira, assim elle como os seus reis, os seus principes, os seus sacerdotes, e os seus prophetas, como tambem os homens de Judah e os moradores de Jerusalem.`,
    ...
    `E edificaram os altos de Baal, que estão no valle do filho de Hinnom, para fazerem que seus filhos e suas filhas passassem pelo fogo a Moloch; o que nunca lhes ordenei, nem subiu ao meu coração, que fizessem tal abominação; para fazerem peccar a Judah.`,
    `E por isso agora assim diz o Senhor o Deus de Israel, ácerca d'esta cidade, da qual vós dizeis: Já está dada na mão do rei de Babylonia, á espada, e á fome, e á pestilencia:`,
    `Eis que eu os congregarei de todas as terras, para onde os houver lançado na minha ira, e no meu furor, e na minha grande indignação; e os tornarei a trazer a este logar, e farei que habitem n'elle seguramente.`,
    ...
    `Comprarão campos por dinheiro, e subscreverão os autos, e os sellarão, e farão que testifiquem testemunhas na terra de Benjamin, e nos contornos de Jerusalem, e nas cidades de Judah, e nas cidades das montanhas, e nas cidades das planicies, e nas cidades do sul; porque os farei voltar do seu captiveiro, diz o Senhor.`,
  ],
  33: [
    ...
    `E servir-me-ha de nome de alegria, de louvor, e de ornamento, entre todas as nações da terra, que ouvirem todo o bem que eu lhes faço; e espantar-se-hão e perturbar-se-hão por causa de todo o bem, e por causa de toda a paz que eu lhes dou.`,
    ...
    `A voz de gozo, e a voz d'alegria, a voz de noivo e a voz de esposa, e a voz dos que dizem: Louvae ao Senhor dos Exercitos, porque bom é o Senhor, porque a sua benignidade dura perpetuamente; como tambem dos que trazem louvor á casa do Senhor; porque tornarei o captiveiro da terra como ao principio, diz o Senhor.`,
    ...
    `Nas cidades das montanhas, nas cidades das planicies, e nas cidades do sul, e na terra de Benjamin, e nos contornos de Jerusalem, e nas cidades de Judah, ainda passará o gado pelas mãos dos contadores, diz o Senhor.`,
    ...
    `Nem aos sacerdotes leviticos faltará varão de diante de mim, que offereça holocausto, e queime offerta de manjares, e faça sacrificio todos os dias.`,
    `E veiu a palavra do Senhor a Jeremias, dizendo:`,
  ...
  35: [
    ...
    `Vae á casa dos rechabitas, e falla com elles, e leva-os á casa do Senhor, a uma das camaras e dá-lhes vinho a beber.`,
    ...
    `Porém elles disseram: Não beberemos vinho; porque Jonadab, filho de Rechab, nosso pae, nos mandou, dizendo: Não bebereis vinho, nem vós nem vossos filhos perpetuamente;`,
    `Nem edificareis casa, nem semeareis semente, nem plantareis vinha, nem a possuireis; mas habitareis em tenda todos os vossos dias, para que vivaes muitos dias sobre a face da terra, em que vós andaes peregrinando.`,
    ...
    `As palavras de Jonadab, filho de Rechab, que ordenou a seus filhos que não bebessem vinho, foram guardadas; pois não beberam até este dia, antes ouviram o mandamento de seu pae, e eu vos tenho fallado a vós, madrugando e fallando, porém vós não me ouvistes a mim.`,
    `E vos enviei a todos os meus servos, os prophetas, madrugando, e enviando, e dizendo: Convertei-vos agora, cada um do seu mau caminho, e fazei boas as vossas acções, e não sigaes a outros deuses para servil-os; e assim ficareis na terra que vos dei a vós e a vossos paes; porém não inclinastes o vosso ouvido, nem me obedecestes a mim`,
    ...
    `Por isso assim diz o Senhor, o Deus dos Exercitos, o Deus de Israel: Eis que trarei sobre Judah, e sobre todos os moradores de Jerusalem, todo o mal que fallei contra elles; porquanto lhes tenho fallado, e não ouviram; e clamei a elles, e não responderam.`,
  ...
  36: [
    ...
    `Toma o rolo d'um livro, e escreve n'elle todas as palavras que te tenho fallado de Israel, e de Judah, e de todas as nações, desde o dia em que eu te fallei a ti, desde os dias de Josias até ao dia de hoje.`,
    ...
    `Então Jeremias chamou a Baruch, filho de Nerias; e escreveu Baruch da bocca de Jeremias todas as palavras do Senhor, que lhe tinha fallado, no rolo de um livro.`,
    `E Jeremias deu ordem a Baruch, dizendo: Eu estou encerrado: não posso entrar na casa do Senhor.`,
    `Entra pois tu, e lê pelo rolo que escreveste da minha bocca as palavras do Senhor aos ouvidos do povo, na casa do Senhor, no dia de jejum; e tambem aos ouvidos de todo o Judah que vem das suas cidades as lerás.`,
    ...
    `Porque aconteceu, no anno quinto de Joaquim, filho de Josias, rei de Judah, no mez nono, que apregoaram jejum diante do Senhor a todo o povo em Jerusalem como tambem a todo o povo que vinha das cidades de Judah a Jerusalem.`,
    ...
    `Desceu á casa do rei, á camara do escriba. E eis que todos os principes estavam ali assentados: a saber: Elisama, o escriba, e Delaias, filho de Semaias, e Elnathan, filho de Achbor, e Gemarias, filho de Saphan, e Zedekias, filho de Hananias, como tambem todos os principes.`,
    ...
    `E succedeu que, tendo Jehudi lido tres ou quatro folhas, cortou-as com um canivete de escrivão, e lançou-as no fogo que havia no brazeiro, até que todo o rolo se consumiu no fogo que estava sobre o brazeiro.`,
    ...
    `Antes deu ordem o rei a Jerahmeel, filho de Hamelech, e a Seraias, filho d'Azriel, e a Selemias, filho de Abdeel, que prendessem a Baruch, o escrivão, e a Jeremias, o propheta: mas o Senhor tinha-os escondido.`,
    ...
    `E visitarei sobre elle, e sobre a sua semente, e sobre os seus servos, a sua iniquidade; e trarei sobre elle e sobre os moradores de Jerusalem, e sobre os homens de Judah, todo aquelle mal que lhes tenho fallado, e não ouviram.`,
    `Tomou pois Jeremias outro rolo, e o deu a Baruch, filho de Nerias, o escrivão, o qual escreveu n'elle da bocca de Jeremias todas as palavras do livro que Joaquim, rei de Judah, tinha queimado ao fogo; e ainda se accrescentaram a ellas muitas palavras similhantes.`,
  ],
  37: [
    ...
    `Assim diz o Senhor, Deus de Israel: Assim direis ao rei de Judah, que vos enviou a mim a perguntar-me: Eis que o exercito de Pharaó, que saiu para soccorro vosso, voltar-se-ha para a sua terra no Egypto.`,
    ...
    `Porque ainda que ferisseis a todo o exercito dos chaldeos, que peleja contra vós, e ficassem de resto d'elles homens traspassados, cada um levantar-se-hia na sua tenda, e queimaria a fogo esta cidade.`,
    ...
    `Porém, estando elle á porta de Benjamin, achava-se ali um capitão da guarda, cujo nome era Jerias, filho de Selemias, filho de Hananias: o qual prendeu a Jeremias, o propheta, dizendo: Tu foges para os chaldeos.`,
    `E Jeremias disse: Isso é falso, não fujo para o chaldeos. Porém não lhe deu ouvidos; antes Jerias prendeu a Jeremias, e o levou aos principes.`,
    `E os principes se iraram muito contra Jeremias, e o feriram; e o pozeram na casa da prisão, na casa de Jonathan, o escrivão; porque tinham feito d'ella a casa do carcere.`,
    `Entrando pois Jeremias na casa do calaboiço, e nas suas camarinhas, ficou ali Jeremias muitos dias.`,
    `E enviou o rei Zedekias a tiral-o; e o rei lhe perguntou em sua casa, em segredo, e disse: Ha porventura alguma palavra do Senhor? E disse Jeremias: Ha. E elle disse: Na mão do rei de Babylonia serás entregue.`,
    ...
    `Ora pois ouve agora, ó rei, meu senhor: caia agora a minha supplica diante de ti, e não me deixes tornar á casa de Jonathan, o escriba, para que não venha a morrer alli.`,
    `Então deu ordem o rei Zedekias que pozessem a Jeremias no atrio da guarda; e deram-lhe um bolo de pão cada dia, da rua dos padeiros, até que se acabou todo o pão da cidade: assim ficou Jeremias no atrio da guarda.`,
  ],
  38: [
    `Ouviu pois Sephatias, filho de Mathan, e Gedalias, filho de Pashur, e Juchal, filho de Selemias, e Pashur, filho de Malchias, as palavras que fallava Jeremias a todo o povo, dizendo:`,
    `Assim diz o Senhor: O que ficar n'esta cidade morrerá á espada, á fome e de pestilencia: mas o que sair aos chaldeos viverá; porque a sua alma lhe será por despojo, e viverá.`,
    `Assim diz o Senhor: Esta cidade infallivelmente se entregará na mão do exercito do rei de Babylonia, e tomal-a-ha.`,
    `E disseram os principes ao rei: Morra este homem, visto que elle assim enfraquece as mãos dos homens de guerra que ficaram de resto n'esta cidade, e as mãos de todo o povo, fallando-lhes taes palavras; porque este homem não busca a paz para este povo, senão o mal`,
    `E disse o rei Zedekias: Eis que elle está na vossa mão: porque não é o rei que possa coisa alguma contra vós`,
    `Então tomaram a Jeremias, e o lançaram no calaboiço de Malchias, filho do rei, que estava no atrio da guarda; e desceram a Jeremias com cordas; porém no calaboiço não havia agua, senão lama; e atolou-se Jeremias na lama.`,
    `E, ouvindo Ebed-melech, o ethiope, um eunucho que então estava na casa do rei, que pozeram a Jeremias no calaboiço (estava porém o rei assentado á porta de Benjamin),`,
    `Logo Ebed-melech saiu da casa do rei: e fallou ao rei, dizendo:`,
    `Ó rei, senhor meu, mal fizeram estes homens em tudo quanto fizeram a Jeremias, o propheta, lançando-o no calaboiço: sendo que morreria no logar onde se achava á fome, pois já não ha mais pão na cidade`,
    ...
    `E disse Jeremias a Zedekias: Declarando-t'a eu, porventura não me matarás certamente? e, aconselhando-te eu, não me darás ouvido.`,
    ...
    `Então Jeremias disse a Zedekias: Assim diz o Senhor, Deus dos Exercitos, Deus de Israel: Se voluntariamente saires aos principes do rei de Babylonia, então viverá a tua alma, e esta cidade não se queimará a fogo, e viverás tu e a tua casa.`,
    ...
    `Eis que todas as mulheres que ficaram de resto na casa do rei de Judah serão levadas fóra para os principes do rei de Babylonia, e ellas mesmas dirão: Teus pacificos te incitaram e prevaleceram contra ti, atolaram-se os teus pés na lama, voltaram para traz.`,
    ...
    `E quando os principes, ouvindo que fallei comtigo, vierem a ti, e te disserem: Declara-nos agora o que disseste ao rei, não nol-o encubras, e não te mataremos: e que te fallou o rei?`,
    `Então lhes dirás: Lancei eu a minha supplica diante do rei, que não me fizesse tornar á casa de Jonathan, para morrer ali`,
    `Vindo pois todos os principes a Jeremias, e perguntando-lhe, declarou-lhes conforme todas as palavras que o rei lhe havia ordenado: e o deixaram, porque não se ouviu o negocio.`,
  ...
  39: [
    `No anno nono de Zedekias, rei de Judah, no mez decimo, veiu Nabucodonozor, rei de Babylonia, todo o seu exercito, contra Jerusalem, e a cercaram.`,
    `No anno undecimo de Zedekias, no quarto mez, aos nove do mez, se fez a brecha na cidade.`,
    `E entraram n'ella todos os principes do rei de Babylonia, e pararam na porta do meio, a saber: Nergal-sarezer, Samgar-nebo, Sarsecim, Rab-saris, Nergal-sarezer, Rab-mag, e todo o resto dos principes do rei de Babylonia.`,
    `E succedeu que, vendo-os Zedekias, rei de Judah, e todos os homens de guerra, fugiram, e sairam de noite da cidade, pelo caminho do jardim do rei, pela porta d'entre os dois muros; e saiu pelo caminho da campina.`,
    `Porém o exercito dos chaldeos os perseguiu; e alcançaram a Zedekias nas campinas de Jericó, e o prenderam, e o fizeram subir a Nabucodonozor, rei de Babylonia, a Ribla, na terra de Hamath, e o sentenciou.`,
    ...
    `E o resto do povo, que ficou na cidade, e os rebeldes que tinham caido para elle, e o resto do povo que ficou, levou Nebuzaradan, capitão da guarda, a Babylonia.`,
    ...
    `Vae, e falla a Ebed-melech, o ethiope, dizendo: Assim diz o Senhor dos Exercitos, Deus de Israel: Eis que eu trarei as minhas palavras sobre esta cidade para mal e não para bem: e serão cumpridas diante de ti n'aquelle dia.`,
  ...
  40: [
    `A palavra que veiu a Jeremias da parte do Senhor, depois que Nebuzaradan, capitão dos da guarda, o deixara ir de Rama, quando o tomou, estando elle atado com cadeias no meio de todos os do captiveiro de Jerusalem e de Judah, que foram levados captivos para Babylonia;`,
    ...
    `Agora pois, eis que te soltei hoje das cadeias que estavam sobre as tuas mãos; se fôr bem aos teus olhos vir comigo para Babylonia, vem, e porei sobre ti os meus olhos; porém, se fôr mal aos teus olhos vir comigo para Babylonia, deixa de vir. Olha, toda a terra está diante de ti; para onde quer que fôr bom e recto aos teus olhos que vás, para ali vae.`,
    `Mas, porquanto elle ainda não tinha voltado, disse-lhe: Volta a Gedalias, filho de Ahicam, filho de Saphan, a quem o rei de Babylonia poz sobre as cidades de Judah, e habita com elle no meio do povo; ou para qualquer parte aonde quer que fôr recto aos teus olhos que vás, para ali vae. E deu-lhe o capitão da guarda sustento para o caminho, e um presente, e o deixou ir.`,
    `Assim veiu Jeremias a Gedalias, filho de Ahicam, a Mizpah; e habitou com elle no meio do povo que havia ficado na terra.`,
    `Ouvindo pois todos os principes dos exercitos, que estavam no campo, elles e os seus homens, que o rei de Babylonia tinha posto sobre a terra a Gedalias, filho de Ahicam, e que lhe havia encarregado a elle os homens, e as mulheres, e os meninos, e os mais pobres da terra, os quaes não foram levados captivos a Babylonia,`,
    `Vieram a Gedalias, a Mizpah: a saber: Ishmael, filho de Nethanias, e Johanan e Jonathan, filhos de Careah, e Seraias, filho de Tanhumeth, e os filhos de Ephai, o netophatita, e Jezanias, filho d'um maachatita, elles e os seus homens.`,
    `E jurou Gedalias, filho de Ahicam, filho de Saphan, a elles e aos seus homens, dizendo: Não temaes servir aos chaldeos: ficae na terra, e servi o rei de Babylonia, e bem vos irá.`,
    `Eu, porém, eis que habito em Mizpah, para estar ás ordens dos chaldeos que vierem a nós; e vós recolhei o vinho, e as fructas de verão, e o azeite, e mettei-os nos vossos vasos, e habitae nas vossas cidades, que já tomastes.`,
    `Como tambem todos os judeos que estavam em Moab, e entre os filhos de Ammon, e em Edom, e os que havia em todas aquellas terras, ouviram que o rei de Babylonia havia deixado um resto em Judah, e que havia posto sobre elles a Gedalias, filho de Ahicam, filho de Saphan.`,
    `E tornaram todos os judeos de todos os logares, para onde foram lançados, e vieram á terra de Judah, a Gedalias, a Mizpah; e recolheram vinho e fructas do verão mui abundantes.`,
    ...
    `Todavia Johanan, filho de Careah, fallou a Gedalias em segredo, em Mizpah, dizendo: Irei agora, e ferirei a Ishmael, filho de Nethanias, sem que ninguem o saiba: por que razão te tiraria elle a vida, e todo o Judah que se tem congregado a ti seria disperso, e pereceria o resto de Judah?`,
  ...
  42: [
    ...
    `Portanto ouvi agora pois a palavra do Senhor, ó resto de Judah: assim diz o Senhor dos Exercitos, Deus de Israel: Se vós absolutamente pozerdes os vossos rostos para entrardes no Egypto, e entrardes para lá peregrinar,`,
    ...
    `Assim serão todos os homens que pozeram os seus rostos para entrarem no Egypto, para lá peregrinarem: morrerão á espada, á fome, e da peste; e d'elles não haverá quem reste e escape do mal que eu farei vir sobre elles.`,
    `Porque assim diz o Senhor dos Exercitos, Deus de Israel: Como se derramou a minha ira e a minha indignação sobre os habitantes de Jerusalem, assim se derramará a minha indignação sobre vós, entrando no Egypto; e servireis de maldição, e de espanto, e de execração, e de opprobrio, e não vereis mais este logar`,
  ...
  43: [
    ...
    `Então disse Azarias, filho de Hosaias, e Johanan, filho de Careah, e todos os homens soberbos, dizendo a Jeremias: Tu dizes mentiras; o Senhor nosso Deus não te enviou a dizer: Não entreis no Egypto, para lá peregrinar:`,
    `Antes Baruch, filho de Nerias, te incita contra nós, para entregar-nos na mão dos chaldeos, para nos matarem, ou para nos transportarem para Babylonia.`,
    ...
    `Os homens, e as mulheres, e os meninos, e as filhas do rei, e a toda a alma que deixara Nebuzaradan, capitão dos da guarda, com Gedalias, filho de Ahicam, filho de Saphan; como tambem a Jeremias, o propheta, e a Baruch, filho de Nerias:`,
    ...
    `Toma na tua mão pedras grandes, e esconde-as entre o barro no forno que está á porta da casa de Pharaó em Tahpanhes, perante os olhos de homens judeos.`,
    `E dize-lhes: Assim diz o Senhor dos exercitos, Deus de Israel: Eis que eu enviarei, e tomarei a Nabucodonozor, rei de Babylonia, meu servo, e porei o seu throno sobre estas pedras que escondi; e estenderá a sua tenda real sobre ellas.`,
    ...
    `E porei fogo ás casas dos deuses do Egypto, e queimal-os-ha, e leval-os-ha captivos; e vestir-se-ha da terra do Egypto, como se veste o pastor do seu vestido, e sairá d'ali em paz.`,
  ...
  45: [
    `A palavra que fallou Jeremias, o propheta, a Baruch, filho de Nerias, escrevendo elle aquellas palavras n'um livro da bocca de Jeremias, no anno quarto de Joaquim, filho de Josias, rei de Judah, dizendo:`,
  ...
  47: [
    ...
    `Assim diz o Senhor: Eis que se levantam as aguas do norte, e tornar-se-hão em torrente transbordante, e alagarão a terra e sua plenitude, a cidade, e os que moram n'ella; e os homens clamarão, e todos os moradores da terra uivarão;`,
  ...
  50: [
    ...
    `Annunciae entre as nações; e fazei ouvir, e levantae bandeira, fazei ouvir, não encubraes; dizei: Já tomada é Babylonia, confundido está Bel, atropellado está Merodach, confundidos estão os seus idolos, e atropellados estão os seus deuses de esterco.`,
    ...
    `Todos os que os achavam os devoraram; e os seus adversarios diziam: Culpa nenhuma teremos; porque peccaram contra o Senhor na morada da justiça, contra o Senhor, a Esperança de seus paes.`,
    `Fugi do meio de Babylonia, e sahi da terra dos chaldeos; e sêde como os carneiros diante do rebanho.`,
    `Porque eis que eu suscitarei e farei subir contra Babylonia uma congregação de grandes nações da terra do norte, e se prepararão contra ella, e d'ali será tomada: as suas frechas serão como de valente heroe, não tornará sem effeito.`,
    `E Chaldea servirá de preza: todos os que a saqueiam serão fartos, diz o Senhor.`,
    `Porquanto vos alegrastes, porquanto saltastes de prazer, ó saqueadores da minha herança, porquanto vos inchastes como bezerra gorda, e rinchastes como cavallos vigorosos,`,
    `Será mui confundida vossa mãe, ficará envergonhada a que vos pariu: eis que ella será a ultima das nações, um deserto, uma terra secca e uma solidão.`,
    ...
    `E farei tornar Israel para a sua morada, e pastará no Carmelo e em Basan; e fartar-se-ha a sua alma no monte de Ephraim e em Gilead.`,
    ...
    `Convocae contra Babylonia os frecheiros, a todos os que armam arcos: acampae-vos contra ella em redor, ninguem escape d'ella: pagae-lhe conforme a sua obra, conforme tudo o que fez, fazei-lhe; porque se houve arrogantemente contra o Senhor, contra o Sancto de Israel.`,
    ...
    `Eis que elle como leão subirá da enchente do Jordão, contra a morada do forte, porque n'um momento o farei correr d'ali; e quem é o escolhido, a este porei contra ella: porque quem é similhante a mim? e quem me citaria a mim? e quem é aquelle pastor que subsistiria perante mim?`,
  ...
  51: [
    ...
    `Fugi do meio de Babylonia, e livrae cada um a sua alma, e não vos destruaes a vós na sua maldade: por-* que este é o tempo da vingança do Senhor, que lhe paga retribuição.`,
    ...
    `Arvorae bandeira sobre os muros de Babylonia, reforçae a guarda, collocae guardas, preparae as ciladas; porque como o Senhor intentou, assim fez o que tinha fallado ácerca dos moradores de Babylonia.`,
    ...
    `Dando elle a sua voz, grande estrondo de aguas ha nos céus, e faz subir os vapores desde o fim da terra: faz os relampagos com a chuva, e tira o vento dos seus thesouros.`,
    `Embruteceu-se todo o homem, e não tem sciencia; envergonhou-se todo o ourives de imagem de esculptura; porque a sua imagem de fundição mentira é, e não ha espirito n'ellas.`,
    ...
    `E por ti despedaçarei o pastor e o seu rebanho; e por ti despedaçarei o lavrador e a sua junta de bois; e por ti despedaçarei os capitães e os magistrados.`,
    ...
    `Arvorae bandeira na terra, tocae a buzina entre as nações, sanctificae as nações contra ella, convocae contra ella os reinos de Ararat, Minni, e Asquenaz: ordenae contra ella um capitão, fazei subir cavallos, como pulgão arripiado.`,
    ...
    `Um correio correrá ao encontro de outro correio, e um mensageiro ao encontro de outro mensageiro, para annunciar ao rei de Babylonia que a sua cidade está tomada desde um cabo até ao outro;`,
    ...
    `Nabucodonozor, rei de Babylonia, me devorou, atropellou-me, fez de mim um vaso vasio, como dragão me tragou, encheu o seu ventre das minhas delicadezas; lançou-me fóra.`,
    `A violencia que se me fez a mim e a minha carne venha sobre Babylonia, diga a moradora de Sião; e o meu sangue sobre os moradores da Chaldea, diga Jerusalem.`,
    ...
    `E visitarei a Bel em Babylonia, e tirarei da sua bocca o que tragou, e nunca mais concorrerão a elle as nações: tambem o muro de Babylonia caiu.`,
    ...
    `Portanto, eis que veem dias, e visitarei as imagens de esculptura de Babylonia, e toda a sua terra será envergonhada, e todos os seus traspassados cairão no meio d'ella.`,
    ...
    `Direis porém: Envergonhados estamos, porque ouvimos opprobrio; vergonha cobriu o nosso rosto, porquanto vieram estrangeiros sobre os sanctuarios da casa do Senhor.`,
    ...
    `Assim diz o Senhor dos Exercitos: Os largos muros de Babylonia totalmente serão derribados, e as suas portas excelsas serão abrazadas pelo fogo; e trabalharão os povos em vão, e as nações para o fogo, e cançar-se-hão.`,
    `A palavra que mandou Jeremias, o propheta, a Seraias, filho de Nerias, filho de Maaseias, indo elle com Zedekias, rei de Judah, a Babylonia, no anno quarto do seu reinado; e Seraias era um principe pacifico.`,
    ...
    `E dirás: Senhor! tu fallaste sobre este logar, que o havias de desarreigar, até não ficar n'elle morador algum, desde o homem até ao animal, mas que se tornaria em perpetuas assolações.`,
  ...
  52: [
    `Era Zedekias da edade de vinte e um annos quando começou a reinar, e reinou onze annos em Jerusalem: e o nome de sua mãe era Hamutal, filha de Jeremias, de Libna.`,
    ...
    `E aconteceu, no anno nono do seu reinado, no mez decimo, no decimo dia do mez, que veiu Nabucodonozor, rei de Babylonia, contra Jerusalem, elle e todo o seu exercito, e se acamparam contra ella, e levantaram contra ella tranqueiras ao redor.`,
    ...
    `Então a cidade foi arrombada, e todos os homens de guerra fugiram, e sairam da cidade de noite, pelo caminho da porta, entre os dois muros que estavam junto ao jardim do rei (porque os chaldeos estavam contra a cidade ao redor), e foram-se pelo caminho da campina.`,
    ...
    `E no quinto mez, no decimo dia do mez (este era o decimo nono anno do rei Nabucodonozor, rei de Babylonia), veiu Nebuzaradan, capitão da guarda, que assistia na presença do rei de Babylonia, a Jerusalem.`,
    ...
    `E dos mais pobres do povo, e o resto do povo, que deixaram ficar na cidade, e os rebeldes que se haviam passado ao rei de Babylonia, e o resto da multidão, Nebuzaradan, capitão da guarda, levou presos.`,
    ...
    `E da cidade tomou a um eunucho que tinha cargo da gente de guerra, e a sete homens dos que viam a face do rei, que se acharam na cidade, como tambem o escrivão-mór do exercito, que registrava o povo da terra para a guerra, e a sessenta homens do povo da terra, que se acharam no meio da cidade.`,
    ...
    `No anno vinte e tres de Nabucodonozor, levou Nebuzaradan, capitão da guarda, em captiveiro dos judeos, setecentas e quarenta e cinco almas: todas as almas são quatro mil e seiscentas.`,
    `Succedeu pois no anno trigesimo setimo do captiveiro de Joaquim, rei de Judah, no mez duodecimo, aos vinte e cinco do mez, que exalçou Evil-merodach, rei de Babylonia, no anno primeiro do seu reinado, a cabeça de Joaquim, rei de Judah, e o tirou da casa da prisão;`,
