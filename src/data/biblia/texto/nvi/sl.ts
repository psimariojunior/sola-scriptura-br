const data: Record<number, string[]> = {
  ...
  22: [
    ...
    `Proclamarei o teu nome a meus irmãos; na assembleia te louvarei.`,
  ...
  34: [
    ...
    `Os que olham para ele estão radiantes de alegria; seu rosto jamais mostrará decepção.`,
  ...
  40: [
    ...
    `Não oculto no coração a tua justiça; falo da tua fidelidade e da tua salvação. Não escondo da grande assembleia a tua fidelidade e a tua verdade.`,
  ...
  49: [
    ...
    `Seus túmulos serão sua morada para sempre, sua habitação de geração em geração, ainda que tenham dado seu nome a terras.`,
  ...
  59: [
    ...
    `Pelos pecados de sua boca, pelas palavras de seus lábios, sejam apanhados em seu orgulho. Pelas maldições e mentiras que pronunciam,`,
  ...
  63: [
    ...
    `Mas o rei se alegrará em Deus; todos os que juram pelo nome de Deus o louvarão, mas a boca dos mentirosos será tapada.`,
  ],
  64: [
  ...
  69: [
    ...
    `Que se lhe escureçam os olhos para que não consigam ver; faze-lhes tremer o corpo sem parar.`,
  ...
  73: [
    ...
    `Certamente me foi inútil manter puro o coração e lavar as mãos na inocência,`,
  ...
  82: [
    `É Deus quem preside a assembleia divina; no meio dos deuses, ele é o juiz.`,
  ...
  99: [
    ...
    `Rei poderoso, amigo da justiça! Estabeleceste a equidade e fizeste em Jacó o que é direito e justo.`,
  ...
  103: [
    ...
    `não nos trata conforme os nossos pecados nem nos retribui conforme as nossas iniquidades.`,
  ...
  105: [
    ...
    `por meio dos quais realizou os seus sinais milagrosos e as suas maravilhas na terra de Cam.`,
  ...
  106: [
    ...
    `para que eu possa testemunhar o bem-estar dos teus escolhidos, alegrar-me com a alegria do teu povo e louvar-te com a tua herança.`,
  ...
  134: [
    `Venham! Bendigam o SENHOR todos vocês, servos do SENHOR, vocês, que servem de noite na casa do SENHOR.`,
  ...
  135: [
    ...
    `Porque o SENHOR escolheu Jacó; a Israel, como seu tesouro pessoal.`,
  ...
  136: [
    ...
    `Deem graças ao Senhor dos senhores. O seu amor dura para sempre!`,
