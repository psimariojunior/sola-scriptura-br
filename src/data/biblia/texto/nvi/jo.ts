const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `Asseguro que nós falamos do que conhecemos e testemunhamos do que vimos, mas mesmo assim vocês não aceitam o nosso testemunho.`,
  ...
  5: [
    ...
    `Eu afirmo que está chegando a hora, e já chegou, em que os mortos ouvirão a voz do Filho de Deus, e aqueles que a ouvirem viverão.`,
  ...
  6: [
    ...
    `Declarou-lhes Jesus: “Digo a verdade: Não foi Moisés quem deu a vocês pão do céu, mas é meu Pai quem dá a vocês o verdadeiro pão do céu.`,
  ...
  10: [
    ...
    `Jesus respondeu: “Eu já disse, mas vocês não creem. As obras que eu realizo em nome de meu Pai falam por mim,`,
  ...
  11: [
    ...
    `Então os chefes dos sacerdotes e os fariseus convocaram uma reunião do Sinédrio. “O que estamos fazendo?”, perguntaram eles. “Aí está esse homem realizando muitos sinais milagrosos.`,
    ...
    `Por essa razão, Jesus não andava mais publicamente entre os judeus. Em vez disso, retirou-se para uma região próxima do deserto, para um povoado chamado Efraim, onde ficou com os seus discípulos.`,
  ...
  13: [
    ...
    `Quando terminou de lavar-lhes os pés, Jesus tornou a vestir sua capa e voltou ao seu lugar. Então lhes perguntou: “Vocês entendem o que fiz a vocês?`,
    ...
    `Eu garanto: Quem receber aquele que eu enviar estará me recebendo; e quem me recebe recebe aquele que me enviou”.`,
    ...
    `“Meus filhinhos, vou estar com vocês apenas mais um pouco. Vocês procurarão por mim e, como eu disse aos judeus, agora digo a vocês: Para onde eu vou, vocês não podem ir.`,
    ...
    `Então Jesus respondeu: “Você dará a vida por mim? Asseguro que, antes que o galo cante, você me negará três vezes!`,
  ],
  14: [
    `“Não se perturbe o coração de vocês. Creiam em Deus; creiam também em mim.`,
    `Na casa de meu Pai há muitos aposentos; se não fosse assim, eu teria dito a vocês. Vou preparar lugar para vocês.`,
  ...
  16: [
    ...
    `Estou dizendo isto para que, quando chegar a hora, lembrem-se de que eu os avisei. Não disse isso a vocês no princípio, porque eu estava com vocês.`,
    ...
    `Mas, quando o Espírito da verdade vier, ele os guiará a toda a verdade. Não falará de si mesmo; falará apenas o que ouvir, e anunciará a vocês o que está por vir.`,
    ...
    `Digo que certamente vocês chorarão e se lamentarão, mas o mundo se alegrará. Vocês se entristecerão, mas a tristeza de vocês se transformará em alegria.`,
    ...
    `Naquele dia, vocês não me perguntarão mais nada. Eu asseguro que meu Pai dará a vocês tudo o que pedirem em meu nome.`,
