const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `O qual, vendo a Pedro e João, que iam entrando no templo, pediu que lhe déssem uma esmola.`,
    ...
    `E conheciam-n'o, que era elle o que se assentava á esmola á porta Formosa do templo, e ficaram cheios de pasmo e assombro, pelo que lhe acontecera.`,
    ...
    `E Pedro, vendo isto, disse ao povo: Varões israelitas, porque vos maravilhaes d'isto? Ou, porque olhaes tanto para nós, como se por nossa propria virtude ou sanctidade o fizessemos andar?`,
    `O Deus d'Abrahão, e de Isaac e de Jacob, o Deus de nossos paes, glorificou a seu filho Jesus, a quem vós entregastes e perante a face de Pilatos negastes, julgando elle que devia ser solto.`,
    ...
    `E pela fé no seu nome o seu nome fortaleceu a este que vêdes e conheceis; e a fé que é por elle deu a este, na presença de todos vós, esta perfeita saude`,
  ...
  4: [
    ...
    `Muitos, porém, dos que ouviram a palavra crêram, e chegou o numero d'esses homens a quasi cinco mil.`,
    ...
    `Seja conhecido a vós todos, e a todo o povo d'Israel, que em nome de Jesus Christo, o nazareno, aquelle a quem vós crucificastes e a quem Deus resuscitou dos mortos, em nome d'esse é que este está são diante de vós.`,
    ...
    `Então elles, vendo a ousadia de Pedro e João, e informados de que eram homens sem lettras e indoutos, se maravilharam; e conheciam que elles haviam estado com Jesus.`,
    ...
    `Dizendo: Que havemos de fazer a estes homens? porque a todos os que habitam em Jerusalem é manifesto que por elles foi feito um signal notorio, e não o podemos negar;`,
    ...
    `E, ouvindo elles isto, unanimes levantaram a voz a Deus, e disseram: Senhor, tu és o Deus que fizeste o céu, e a terra, e o mar, e todas as coisas que n'elles ha;`,
    ...
    `E, tendo orado, moveu-se o logar em que estavam reunidos; e todos foram cheios do Espirito Sancto, e fallavam com ousadia a palavra de Deus.`,
  ...
  8: [
    `E tambem Saulo consentia na morte d'elle. E fez-se n'aquelle dia uma grande perseguição contra a egreja que estava em Jerusalem; e todos foram dispersos pelas terras da Judea e da Samaria, excepto os apostolos.`,
    ...
    `E levantou-se, e foi; e eis que um homem ethiope, eunucho, mordomo-mór de Candace, rainha dos ethiopes, o qual era superintendente de todos os seus thesouros, e tinha ido a Jerusalem a adorar,`,
    ...
    `E o logar da Escriptura que lia era este: Foi levado como a ovelha para o matadouro, e, como está mudo o cordeiro diante do que o tosquia, assim não abriu a sua bocca.`,
  ...
  9: [
    ...
    `E pediu-lhe cartas para Damasco, para as synagogas, para que, se encontrasse alguns d'aquella seita, quer homens quer mulheres, os conduzisse presos a Jerusalem.`,
    ...
    `E disse-lhe o Senhor: Levanta-te, e vae á rua chamada Direita, e pergunta em casa de Judas por um chamado Saulo, de Tarso; pois eis que elle ora;`,
    ...
    `E Ananias foi, e entrou na casa, e, impondo-lhe as mãos, disse: Irmão Saulo, o Senhor Jesus, que te appareceu no caminho por onde vinhas, me enviou, para que tornes a vêr e sejas cheio do Espirito Sancto.`,
    ...
    `E todos os que o ouviam estavam attonitos, e diziam: Não é este aquelle que em Jerusalem assolava aos que invocavam esse nome, e para isso veiu aqui, para os levar presos aos principaes dos sacerdotes?`,
    ...
    `Mas Barnabé, tomando-o comsigo, o trouxe aos apostolos, e lhes contou como no caminho elle vira ao Senhor e lhe fallara, e como em Damasco fallara ousadamente no nome de Jesus.`,
    ...
    `Assim pois, as egrejas em toda a Judea, e Galilea e Samaria tinham paz, e eram edificadas; e se multiplicavam, andando no temor do Senhor e consolação do Espirito Sancto.`,
    ...
    `E, como Lydda era perto de Joppe, ouvindo os discipulos que Pedro estava ali, lhe mandaram dois varões, rogando-lhe que não se demorasse em vir ter com elles.`,
    `E, levantando-se Pedro, foi com elles; e quando chegou o levaram ao quarto alto, e todas as viuvas o rodearam, chorando e mostrando as tunicas e vestidos que Dorcas fizera quando estava com ellas.`,
    `Porém Pedro, fazendo-as sair a todas, poz-se de joelhos e orou: e, voltando-se para o corpo, disse: Tabitha, levanta-te. E ella abriu os olhos, e, vendo a Pedro, assentou-se,`,
  ...
  12: [
    ...
    `E, havendo-o prendido, o encerrou na prisão, entregando-o a quatro quaternos de soldados, para que o guardassem, querendo apresental-o ao povo depois da paschoa.`,
    `Pedro, pois, era guardado na prisão; porém a egreja fazia continua oração por elle a Deus.`,
    `E quando Herodes o havia de tirar, n'aquella mesma noite, estava Pedro dormindo entre dois soldados, ligado com duas cadeias, e os guardas diante da porta guardavam a prisão.`,
    `E eis que sobreveiu o anjo do Senhor, e resplandeceu uma luz na prisão; e, tocando a Pedro na ilharga, o despertou, dizendo: Levanta-te depressa. E cairam-lhe das mãos as cadeias.`,
    ...
    `E, quando passaram a primeira e segunda guarda, chegaram á porta de ferro, que dá para a cidade, a qual se lhes abriu por si mesma; e, tendo saido, andaram uma rua, e logo o anjo se apartou d'elle.`,
    ...
    `E, acenando-lhes elle com a mão para que se calassem, contou-lhes como o Senhor o tirára da prisão, e disse: Annunciae isto a Thiago e aos irmãos. E, saindo, partiu para outro logar.`,
  ...
  13: [
    `E na egreja que estava em Antiochia havia alguns prophetas e doutores, a saber: Barnabé e Simeão, chamado Niger, e Lucio cyreneo, e Manahen, que fôra criado com Herodes o tetrarcha, e Saulo.`,
    `E, servindo elles ao Senhor, e jejuando, disse o Espirito Sancto: Apartae-me a Barnabé e a Saulo para a obra para que os tenho chamado.`,
    ...
    `Ó filho do diabo, cheio de todo o engano e de toda a malicia, inimigo de toda a justiça, não cessarás de perturbar os rectos caminhos do Senhor?`,
    `Eis-ahi, pois, agora contra ti a mão do Senhor, e ficarás cego, sem vêr o sol por algum tempo. E no mesmo instante a escuridão e as trevas cairam sobre elle, e, andando em redor, buscava a quem o guiasse pela mão`,
    `Então o proconsul, vendo o que havia acontecido, creu, maravilhado da doutrina do Senhor.`,
    `E, partindo de Paphos, Paulo e os que estavam com elle chegaram a Perge, cidade da Pamphylia. Porém João, apartando-se d'elles, voltou para Jerusalem.`,
    `E elles, saindo de Perge, chegaram a Antiochia, da Pisidia, e, entrando na synagoga, n'um dia de sabbado, assentaram-se;`,
    `E, depois da lição da lei e dos prophetas, lhes mandaram dizer os principaes da synagoga: Varões irmãos, se vós tendes alguma palavra de consolação para o povo, fallae`,
    ...
    `Mas, como João cumprisse a sua carreira, disse: Quem pensaes vós que eu sou? Eu não sou o Christo; mas eis que após mim vem aquelle a quem não sou digno de desatar as alparcas dos pés.`,
    ...
    `Porque, não conhecendo a este os que habitavam em Jerusalem, nem os seus principes, condemnando-o, cumpriram assim as vozes dos prophetas que se lêem todos os sabbados.`,
    ...
    `E, despedida a synagoga, muitos dos judeos e dos proselytos religiosos seguiram Paulo e Barnabé; os quaes, fallando-lhes, os exhortavam a que permanecessem na graça de Deus.`,
    ...
    `Mas Paulo e Barnabé, usando de ousadia, disseram: Era mister que a vós se vos fallasse primeiro a palavra de Deus; mas, visto que a rejeitaes, e vos não julgaes dignos da vida eterna, eis que nós voltamos para os gentios;`,
    ...
    `Mas os judeos incitaram a algumas mulheres religiosas e honestas, e aos principaes da cidade, e levantaram perseguição contra Paulo e Barnabé, e os lançaram fóra dos seus termos.`,
  ...
  16: [
    `E chegou a Derbe e Lystra. E eis que estava ali um certo discipulo por nome Timotheo, filho de uma mulher judia fiel, mas de pae grego:`,
    `Do qual davam bom testemunho os irmãos que estavam em Lystra e em Iconio.`,
    `Paulo quiz que este fosse com elle: e tomando-o, o circumcidou, por causa dos judeos que estavam n'aquelles logares; porque todos sabiam que seu pae era grego.`,
    ...
    `E uma certa mulher, chamada Lydia, vendedora de purpura, da cidade de Thyatira, e que servia a Deus, nos ouvia, e o Senhor lhe abriu o coração para que estivesse attenta ao que Paulo dizia.`,
    `E, depois que foi baptizada, ella e a sua casa, nos rogou, dizendo: Se haveis julgado que eu seja fiel ao Senhor, entrae em minha casa, e ficae ali. E nos constrangeu a isso.`,
    `E aconteceu que, indo nós á oração, nos saiu ao encontro uma moça que tinha espirito de adivinhação, a qual, adivinhando, dava grande lucro aos seus senhores.`,
  ...
  19: [
    ...
    `E alguns dos exorcistas judeos vagabundos tentavam invocar o nome do Senhor Jesus sobre os que tinham espiritos malignos, dizendo: Esconjuramos-vos por Jesus a quem Paulo préga.`,
    ...
    `E, saltando n'elles o homem em que estava o espirito maligno, e assenhoreando-se d'elles, poude mais do que elles; de tal maneira que, nús e feridos, fugiram d'aquella casa.`,
    `E foi isto notorio a todos os que habitavam em Epheso, tanto judeos como gregos; e caiu temor sobre todos elles, e o nome do Senhor Jesus era engrandecido.`,
    `E muitos dos que criam vinham, confessando e publicando os seus feitos.`,
    `Tambem muitos dos que seguiam artes curiosas trouxeram os seus livros, e os queimaram na presença de todos, e, feita a conta do seu preço, acharam que montava a cincoenta mil peças de prata.`,
    `Assim a palavra do Senhor crescia poderosamente e prevalecia.`,
    `E, cumpridas estas coisas, Paulo propoz-se, em espirito, ir a Jerusalem, passando pela Macedonia e pela Achaia, dizendo: Depois que houver estado ali, importa-me vêr tambem Roma.`,
    ...
    `E bem vêdes e ouvis que não só em Epheso, mas até quasi em toda a Asia, este Paulo tem persuadido e afastado uma grande multidão, dizendo que não são deuses os que se fazem com as mãos.`,
    `E não sómente ha o perigo de que isto venha a servir-nos de desprezo, mas tambem de que o proprio templo da grande deusa Diana seja estimado em nada, e de que a sua magestade, a qual toda a Asia e o mundo inteiro veneram, venha a ser destruida.`,
    ...
    `Então o escrivão da cidade, tendo apaziguado a multidão, disse: Varões ephesios, qual é o homem que não sabe que a cidade dos ephesios é a guardadora do templo da grande deusa Diana, e da imagem que desceu de Jupiter?`,
  ...
  22: [
    ...
    `Quanto a mim, sou varão judeo, nascido em Tarso de Cilicia, e n'esta cidade criado aos pés de Gamaliel, instruido conforme a verdade da lei de nossos paes, zelador de Deus, como todos vós hoje sois.`,
    `Que tenho perseguido este caminho até á morte, prendendo, e mettendo em prisões, assim varões como mulheres.`,
    `Como tambem o summo sacerdote me é testemunha, e todo o conselho dos anciãos: dos quaes ainda, levando cartas para os irmãos, fui a Damasco, para trazer manietados para Jerusalem aquelles que ali estivessem, para que fossem castigados.`,
    ...
    `E ouviram-n'o até esta palavra, e levantaram a voz, dizendo: Tira da terra um tal homem, porque não convem que viva.`,
  ...
  28: [
    ...
    `E elles esperavam que viesse a inchar ou a cair morto de repente; porém, tendo esperado já muito, e vendo que nenhum incommodo lhe sobrevinha, mudando de parecer, diziam que era um deus.`,
    ...
    `E aconteceu que o pae de Publio estava de cama enfermo de febres e dysenteria, ao qual Paulo foi ver, e, havendo orado, poz as mãos sobre elle, e o curou.`,
    ...
    `E aconteceu que, tres dias depois, Paulo convocou os que eram principaes dos judeos, e, juntos elles, lhes disse: Varões irmãos, não havendo eu feito nada contra o povo, ou contra os ritos paternos, vim todavia preso desde Jerusalem, entregue nas mãos dos romanos;`,
    ...
    `Porém elles lhe disseram: Nós não recebemos ácerca de ti cartas algumas da Judea, nem, vindo aqui algum dos irmãos, nos annunciou ou fallou de ti mal algum.`,
    ...
    `E, havendo-lhe elles assignalado um dia, muitos foram ter com elle á pousada, aos quaes declarava e testificava o reino de Deus, e procurava persuadil-os á fé de Jesus, tanto pela lei de Moysés como pelos prophetas, desde pela manhã até á tarde.`,
    `E alguns criam no que se dizia; porém outros não criam.`,
    `E, como ficaram entre si discordes, se despediram, dizendo Paulo esta palavra: Bem fallou o Espirito Sancto a nossos paes pelo propheta Isaias,`,
    ...
    `Seja-vos pois notorio que esta salvação de Deus é enviada aos gentios, e elles a ouvirão.`,
