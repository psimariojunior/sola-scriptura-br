const data: Record<number, string[]> = {
  1: [
    ...
    `Porque se introduziram alguns, que já d'antes estavam escriptos para este mesmo juizo, homens impios, que convertem em dissolução a graça de Deus, e negam a Deus, unico dominador e Senhor nosso, Jesus Christo.`,
    ...
    `Estes são manchas em vossas festas de caridade, banqueteando comvosco, e apascentando-se a si mesmos sem temor: são nuvens sem agua, levadas dos ventos de uma a outra parte: são como arvores murchas, infructiferas, duas vezes mortas, desarreigadas;`,
