const data: Record<number, string[]> = {
  1: [
    `E succedeu que, nos dias em que os juizes julgavam, houve uma fome na terra: pelo que um homem de Beth-lehem de Judah saiu a peregrinar nos campos de Moab, elle e sua mulher, e seus dois filhos:`,
    `E era o nome d'este homem Elimelech, e o nome de sua mulher Noemi, e os nomes de seus dois filhos Mahon e Chilion, ephrateos, de Beth-lehem de Judah: e vieram aos campos de Moab, e ficaram ali.`,
  ...
  4: [
    ...
    `E disse eu: Manifestal-o-hei em teus ouvidos, dizendo: Toma-a diante dos habitantes, e diante dos anciãos do meu povo; se a has de redimir, redime-a, e, se não se houver de redimir, declara-m'o, para que o saiba, pois outro não ha senão tu que a redima, e eu depois de ti. Então disse elle: Eu a redimirei.`,
    `Disse porém Boaz: No dia em que tomares a terra da mão de Noemi, tambem a tomarás da mão de Ruth, a moabita, mulher do defunto, para suscitar o nome do defunto sobre a sua herdade.`,
    `Então disse o remidor: Para mim não a poderei redimir, para que não damne a minha herdade: redime tu a minha remissão para ti, porque eu não a poderei redimir.`,
    ...
    `E de que tambem tomo por mulher a Ruth, a moabita, que foi mulher de Mahlon, para suscitar o nome do defunto sobre a sua herdade, para que o nome do defunto não seja desarraigado d'entre seus irmãos e da porta do seu logar: d'isto sois hoje testemunhas.`,
    `E todo o povo que estava na porta, e os anciãos, disseram: Somos testemunhas: o Senhor faça a esta mulher, que entra na tua casa, como a Rachel e como a Leah, que ambas edificaram a casa d'Israel; e ha-te já valorosamente em Ephrata, e faze-te nome afamado em Beth-lehem.`,
