const data: Record<number, string[]> = {
  ...
  4: [
    `Tambem fez um altar de metal de vinte covados de comprimento, e de vinte covados de largura, e de dez covados d'altura.`,
    `Fez tambem o mar de fundição, de dez covados d'uma borda até a outra, redondo ao redor, e de cinco covados d'alto; cingia-o em roda um cordão de trinta covados.`,
    ...
    `E estava sobre doze bois, tres que olhavam para o norte, e tres que olhavam para o occidente, e tres que olhavam para o sul, e tres que olhavam para o oriente; e o mar estava posto sobre elles: e as suas partes posteriores eram para a banda de dentro.`,
    `E tinha um palmo de grossura, e a sua borda foi feita como a borda d'um copo, ou como uma flôr de lis, da capacidade de tres mil batos.`,
    `Tambem fez dez pias; e poz cinco á direita, e cinco á esquerda, para lavarem n'ellas; o que pertencia ao holocausto o lavavam n'ellas: porém o mar era para que os sacerdotes se lavassem n'elle.`,
    ...
    `Fez mais o pateo dos sacerdotes, e o pateo grande: como tambem as portadas para o pateo, e as suas portas cobriu de cobre.`,
    `E o mar poz ao lado direito, para a banda do oriente, defronte do sul.`,
    `Tambem Hurão fez as caldeiras, e as pás, e as bacias: assim acabou Hurão de fazer a obra, que fazia para o rei Salomão, na casa de Deus.`,
    `A duas columnas, e os globos, e os dois capiteis sobre as cabeças das columnas: e as duas redes, para cobrir os dois globos dos capiteis, que estavam sobre a cabeça das columnas.`,
    `E as quatrocentas romãs para as duas redes: duas carreiras de romãs para cada rede, para cobrirem os dois globos dos capiteis que estavam em cima das columnas.`,
    ...
    `Na campina do Jordão os fundiu o rei na terra argillosa, entre Succoth e Zeredatha.`,
    ...
    `E os castiçaes com as suas alampadas d'oiro finissimo, para as accenderem segundo o costume, perante o oraculo.`,
    `E as flores, e as alampadas, e os espivitadores d'oiro, do mais perfeito oiro.`,
    `Como tambem os garfos, e as bacias, e as taças, e os incensarios d'oiro finissimo: e quanto á entrada da casa, as suas portas de dentro da sanctidade das sanctidades, e as portas da casa do templo, eram d'oiro.`,
  ],
  5: [
    `Assim se acabou toda a obra, que Salomão fez para a casa do Senhor, então trouxe Salomão as coisas consagradas de seu pae David, e a prata, e o oiro, e todos os vasos, e pôl-os entre os thesouros da casa de Deus.`,
    `Então Salomão convocou em Jerusalem os anciãos de Israel, e a todos os chefes das tribus, os principes dos paes entre os filhos d'Israel, para fazerem subir a arca do concerto do Senhor, da cidade de David, que é Sião.`,
    ...
    `Então o rei Salomão, e toda a congregação d'Israel, que se tinha congregado com elle diante da arca, sacrificaram carneiros, e bois, que se não podiam contar, nem numerar, por causa da sua multidão.`,
    ...
    `Porque os cherubins estendiam ambas as azas sobre o logar da arca, e os cherubins por cima cobriam a arca e os seus varaes.`,
    ...
    `E os levitas, cantores de todos elles, d'Asaph, d'Heman, de Jeduthun, e de seus filhos, e de seus irmãos, vestidos de linho fino, com cymbalos, e com alaudes, e com harpas, estavam em pé para o oriente do altar; e com elles até cento e vinte sacerdotes, que tocavam as trombetas),`,
  ...
  6: [
    ...
    `E elle disse: Bemdito seja o Senhor Deus d'Israel, que fallou pela sua bocca a David meu pae; e pelas suas mãos o cumpriu, dizendo:`,
    `Desde o dia em que tirei a meu povo da terra do Egypto, não escolhi cidade alguma de todas as tribus d'Israel, para edificar n'ella uma casa em que estivesse o meu nome; nem escolhi homem algum para ser chefe do meu povo, Israel.`,
    `Porém escolhi a Jerusalem, para que ali estivesse o meu nome; e escolhi a David, para que tivesse cargo do meu povo, Israel.`,
    ...
    `Comtudo tu não edificarás a casa, mas teu filho, que ha de proceder de teus lombos, esse edificará a casa ao meu nome.`,
    `Assim confirmou o Senhor a sua palavra, que elle fallou; porque eu me levantei em logar de David meu pae, e me assentei sobre o throno d'Israel, como o Senhor disse, e edifiquei a casa ao nome do Senhor, Deus d'Israel.`,
    ...
    `Porque Salomão tinha feito uma base de metal, de cinco covados de comprimento, e de cinco covados de largura, e de tres covados d'altura, e a tinha posto no meio do pateo, e poz-se n'ella em pé, e ajoelhou-se de joelhos em presença de toda a congregação d'Israel, e estendeu as suas mãos para o céu`,
    `E disse: Ó Senhor, Deus d'Israel, não ha Deus similhante a ti, nem nos céus nem na terra; que guardas o concerto e a beneficencia aos teus servos que caminham perante ti de todo o seu coração.`,
    `Que guardaste ao teu servo David, meu pae, o que lhe fallaste: porque tu pela tua bocca o disseste, e pela tua mão o cumpriste, como se vê n'este dia.`,
    `Agora pois, Senhor, Deus d'Israel, guarda ao teu servo David, meu pae, o que fallaste, dizendo: Nunca faltará de ti varão de diante de mim que se assente sobre o throno d'Israel; tão sómente que teus filhos guardem seu caminho, andando na minha lei, como tu andaste diante de mim`,
    `E agora, Senhor Deus d'Israel, verifique-se a tua palavra, que fallaste ao teu servo, a David.`,
    `Mas verdadeiramente habitará Deus com os homens na terra? eis que os céus e o céu dos céus não te podem conter, quanto menos esta casa que tenho edificado?`,
    ...
    `Que os teus olhos estejam dia e noite abertos sobre este logar, de que disseste que ali porias o teu nome; para ouvires a oração que o teu servo orar n'este logar.`,
    `Ouve pois as supplicas do teu servo, e do teu povo Israel, que orarem n'este logar; e ouve tu do logar da tua habitação, desde os céus; ouve pois, e perdoa.`,
    `Quando alguem peccar contra o seu proximo, e lhe impuzer juramento de maldição, para se amaldiçoar a si mesmo, e o juramento de maldição vier perante o teu altar, n'esta casa`,
    `Ouve tu então desde os céus, e obra, e julga a teus servos, pagando ao impio, lançando o seu proceder sobre a sua cabeça: e justificando ao justo, dando-lhe segundo a sua justiça.`,
    `Quando tambem o teu povo Israel fôr ferido diante do inimigo, por ter peccado contra ti, e elles se converterem, e confessarem o teu nome, e orarem e supplicarem perante ti n'esta casa,`,
    `Então ouve tu desde os céus, e perdoa os peccados de teu povo Israel; e fal-os tornar á terra que lhes tens dado a elles e a seus paes.`,
    `Quando os céus se cerrarem, e não houver chuva, por terem peccado contra ti, e orarem n'este logar, e confessarem teu nome, e se converterem dos seus peccados, quando tu os affligires,`,
    ...
    `Toda a oração, e toda a supplica, que qualquer homem fizer, ou todo o teu povo Israel, conhecendo cada um a sua praga, e a sua dôr, e estender as suas mãos para esta casa,`,
    ...
    `Assim tambem ao estrangeiro, que não fôr do teu povo Israel, mas vier de terras remotas por amor do teu grande nome, e da tua poderosa mão, e do teu braço estendido: vindo elles e orando n'esta casa,`,
    `Então ouve tu desde os céus, do assento da tua habitação, e faze conforme a tudo o que o estrangeiro te supplicar: a fim de que todos os povos da terra conheçam o teu nome, e te temam, como o teu povo Israel; e afim de saberem que pelo teu nome é chamada esta casa que edifiquei.`,
    ...
    `Quando peccarem contra ti (pois não ha homem que não peque), e tu te indignares contra elles, e os entregares diante do inimigo, para que os que os captivarem os levem em captiveiro para alguma terra, remota ou visinha,`,
    `E na terra, para onde forem levados em captiveiro, tornarem em si, e se converterem, e na terra do seu captiveiro, a ti supplicarem, dizendo: Peccámos, perversamente fizemos, e impiamente obrámos;`,
    `E se converterem a ti com todo o seu coração e com toda a sua alma, na terra do seu captiveiro, a que os levaram presos, e orarem para a banda da sua terra, que déste a seus paes, e d'esta cidade que escolheste, e d'esta casa que edifiquei ao teu nome,`,
    `Ouve então desde os céus, do assento da tua habitação, a sua oração e as suas supplicas, e executa o seu direito; e perdoa ao teu povo que houver peccado contra ti.`,
    `Agora pois, ó meu Deus, estejam os teus olhos abertos, e os teus ouvidos attentos á oração d'este logar.`,
    `Levanta-te pois agora, Senhor Deus, para o teu repouso, tu e a arca da tua fortaleza: os teus sacerdotes, ó Senhor Deus, sejam vestidos de salvação, e os teus sanctos se alegrem do bem.`,
  ...
  8: [
    ...
    `Como tambem a Baalath, e todas as cidades das munições, que Salomão tinha, e todas as cidades dos carros e as cidades dos cavalleiros; e tudo quanto, conforme ao seu desejo, Salomão quiz edificar em Jerusalem, e no Libano, e em toda a terra do seu dominio.`,
    `Quanto a todo o povo, que tinha ficado dos hetheos, e amorrheos, e pherezeos, e heveos, e jebuseos, que não eram d'Israel,`,
    `Dos seus filhos, que ficaram depois d'elles na terra, os quaes os filhos d'Israel não destruiram, Salomão os fez tributarios, até ao dia d'hoje.`,
    `Porém dos filhos d'Israel, a quem Salomão não fez servos para sua obra (mas eram homens de guerra, chefes dos seus capitães, e chefes dos seus carros, e dos seus cavalleiros),`,
    `D'estes pois eram os chefes dos officiaes que o rei Salomão tinha, duzentos e cincoenta, que presidiam sobre o povo.`,
    `E Salomão fez subir a filha de Pharaó da cidade de David para a casa que lhe tinha edificado; porque disse: Minha mulher não morará na casa de David, rei d'Israel, porquanto sanctos são os logares nos quaes entrou a arca do Senhor.`,
    `Então Salomão offereceu holocaustos ao Senhor, sobre o altar do Senhor, que tinha edificado diante do portico:`,
    `E isto segundo a ordem de cada dia, offerecendo o mandamento de Moysés, nos sabbados e nas luas novas, e nas solemnidades, tres vezes no anno: na festa dos pães asmos, e na festa das semanas, e na festa das tendas.`,
    `Tambem, conforme á ordem de David seu pae, ordenou as turmas dos sacerdotes nos seus ministerios, como tambem as dos levitas ácerca de suas guardas, para louvarem a Deus, e ministrarem diante dos sacerdotes, segundo a ordenação de cada dia, e os porteiros pelas suas turmas a cada porta: porque tal era o mandado de David, o homem de Deus.`,
    ...
    `E enviou-lhe Hurão, por mão de seus servos, navios, e servos praticos do mar, e foram com os servos de Salomão a Ophir, e tomaram de lá quatrocentos e cincoenta talentos d'oiro: e os trouxeram ao rei Salomão.`,
  ],
  9: [
    `E ouvindo a rainha de Saba a fama de Salomão, veiu a Jerusalem, provar a Salomão com enigmas, com um mui grande exercito, e camelos carregados d'especiarias, e oiro em abundancia e pedras preciosas; e veiu a Salomão, e fallou com elle de tudo o que tinha no seu coração.`,
    ...
    `E as iguarias da sua mesa, e o assentar dos seus servos, e o estar dos seus creados, e os vestidos d'elles; e os seus copeiros, e os vestidos d'elles; e a sua subida pela qual elle subia á casa do Senhor, ella ficou como fóra de si.`,
    `Então disse ao rei: Foi verdade a palavra que ouvi na minha terra ácerca dos teus feitos e da tua sabedoria.`,
    `Porém não cria as suas palavras, até que vim, e meus olhos o viram, e eis-que me não disseram a metade da grandeza da tua sabedoria: sobrepujaste á fama que ouvi`,
    `Bemaventurados os teus homens, e bemaventurados estes teus servos, que estão sempre diante de ti, e ouvem a tua sabedoria!`,
    `Bemdito seja o Senhor teu Deus, que se agradou em ti para te pôr como rei sobre o seu throno, pelo Senhor teu Deus: porquanto teu Deus ama a Israel, para estabelecel-o perpetuamente; e poz-te por rei sobre elles, para fazeres juizo e justiça.`,
    `E deu ao rei cento e vinte talentos d'oiro, e especiarias em grande abundancia, e pedras preciosas: e nunca houve taes especiarias, quaes a rainha de Saba deu ao rei Salomão.`,
    ...
    `E o rei Salomão deu á rainha de Saba tudo quanto lhe agradou, e o que lhe pediu, alem do que ella mesma trouxera ao rei: assim virou-se e foi para a sua terra, ella e os seus servos.`,
    ...
    `E o throno tinha seis degráus, e um estrado d'oiro, pegado ao throno, e encostos d'ambas as bandas no logar do assento: e dois leões estavam junto aos encostos.`,
    `E doze leões estavam ali d'ambas as bandas, sobre os seis degraus: outro tal se não fez em nenhum reino.`,
    `Tambem todos os vasos de beber do rei Salomão eram d'oiro, e todos os vasos da casa do bosque do Libano, d'oiro puro: a prata reputava-se por nada nos dias de Salomão.`,
    `Porque, indo os navios do rei com os servos d'Hurão, a Tharsis, tornavam os navios de Tharsis, uma vez em tres annos, e traziam oiro e prata, marfim, e bugios, e pavões.`,
    ...
    `E elles traziam cada um o seu presente, vasos d'oiro, e vestidos, armaduras, e especiarias, cavallos e mulos: cada coisa d'anno em anno.`,
    ...
    `Os mais successos pois de Salomão, tanto os primeiros como os ultimos, porventura não estão escriptos no livro das fallas de Nathan, o propheta, e na prophecia d'Ahias , o silonita, e nas visões de Iddo, o vidente, ácerca de Jeroboão, filho de Nebat`,
  ...
  11: [
    `Vindo pois Roboão a Jerusalem, ajuntou da casa de Judah e Benjamin cento e oitenta mil escolhidos, dextros na guerra para pelejarem contra Israel, e para restituirem o reino a Roboão.`,
    ...
    `E a Beth-zur, e a Soco, e a Adullam,`,
    `E a Gath, e a Maresa, e a Ziph,`,
    `E a Adoraim, e a Lachis, e a Azeka,`,
    `E a Zora, e a Aijalon, e a Hebron, que estavam em Judah e em Benjamin; cidades fortes.`,
    `E fortificou estas fortalezas e poz n'ellas maioraes, e armazens de viveres, e d'azeite, e de vinho.`,
    ...
    `Porque os levitas deixaram os seus arrabaldes, e a sua possessão, e vieram a Judah e a Jerusalem (porque Jeroboão e seus filhos os lançaram fóra para que não ministrassem ao Senhor.`,
    ...
    `Assim fortaleceram o reino de Judah e corroboraram a Roboão, filho de Salomão, por tres annos: porque tres annos andaram no caminho de David e Salomão.`,
    ...
    `E amava Roboão mais a Maaca, filha d'Absalão, do que a todas as suas outras mulheres e concubinas; porque elle tinha tomado dezoito mulheres, e sessenta concubinas; e gerou vinte e oito filhos, e sessenta filhas.`,
    `E Roboão poz por cabeça a Abias, filho de Maaca, para ser maioral entre os seus irmãos; porque o queria fazer rei.`,
    `E usou de prudencia, e de todos os seus filhos alguns espalhou por todas as terras de Judah e Benjamin, por todas as cidades fortes; e deu-lhes viveres em abundancia: e lhes desejou uma multidão de mulheres.`,
  ],
  12: [
  ...
  17: [
    ...
    `E poz gente de guerra em todas as cidades fortes de Judah e poz guarnições na terra de Judah, como tambem nas cidades d'Ephraim, que Asa seu pae tinha tomado.`,
    ...
    `E no terceiro anno do seu reinado enviou elle os seus principes, a Benchail, e a Obadias, e a Zacharias, e a Nathanael, e a Michaia, para ensinarem nas cidades de Judah.`,
    `E com elles os levitas, Semaias e Nethanias, e Zebadias, e Asael, e Semiramoth, e Jonathan, e Adonias, e Tobias, e Tobadonias, levitas: e com elles os sacerdotes, Elisama e Jorão.`,
    ...
    `E alguns d'entre os philisteos traziam presentes a Josaphat, com o dinheiro do tributo: tambem os arabios lhe trouxeram gado miudo; sete mil e setecentos carneiros, e sete mil e setecentos bodes.`,
    ...
    `E de Benjamin Eliada, varão valente, e com elle duzentos mil, armados d'arco e d'escudo:`,
  ...
  18: [
    ...
    `E ao cabo d'alguns annos desceu elle para Achab a Samaria; e Achab matou ovelhas e bois em abundancia, para elle e para o povo que vinha com elle: e o persuadiu a subir com elle a Ramoth-gilead.`,
    `Porque Achab, rei d'Israel, disse a Josaphat rei de Judah: Irás tu commigo a Ramoth-gilead? e elle lhe disse: Como tu és, serei eu; e o meu povo, como o teu povo; seremos comtigo n'esta guerra.`,
    ...
    `Então o rei d'Israel disse a Josaphat: Ainda ha um homem por quem podemos consultar ao Senhor; porém eu o aborreço; porque nunca prophetiza de mim bem, senão sempre mal; este é Micha, filho de Imla. E disse Josaphat: Não falle o rei assim`,
    `Então chamou o rei d'Israel um eunucho, e disse: Traze aqui depressa a Micha filho de Imla.`,
    `E o rei d'Israel, e Josaphat rei de Judah estavam assentados cada um no seu throno, vestidos de vestiduras, e estavam assentados na praça á entrada da porta de Samaria, e todos os prophetas prophetizavam na sua presença.`,
    ...
    `Disse mais: Pois ouvi a palavra do Senhor: Vi ao Senhor assentado no seu throno, e a todo o exercito celestial em pé á sua mão direita, e á sua esquerda.`,
    ...
    `E elle disse: Eu sairei, e serei um espirito de mentira na bocca de todos os seus prophetas. E disse o Senhor: Tu o persuadirás, e tambem prevalecerás; sae, e faze-o assim.`,
    ...
    `E disse o rei d'Israel a Josaphat: Disfarçando-me eu, então entrarei na peleja; tu porém veste as tuas vestiduras. Disfarçou-se pois o rei d'Israel, e entraram na peleja.`,
    ...
    `Succedeu pois que, vendo os capitães dos carros a Josaphat, disseram: Este é o rei d'Israel, e o cercaram para pelejarem; porém Josaphat clamou, e o Senhor o ajudou. E Deus os desviou d'elle.`,
    `Porque succedeu que, vendo os capitães dos carros, que não era o rei d'Israel, tornaram de seguil-o.`,
    `Então um homem armou o arco na sua simplicidade, e feriu o rei d'Israel entre as junturas e a couraça: então disse ao carreteiro: Vira a tua mão, e tira-me do exercito, porque estou mui ferido.`,
    `E aquelle dia cresceu a peleja, mas o rei d'Israel susteve-se em pé no carro defronte dos syros até á tarde; e morreu ao tempo do pôr do sol`,
  ],
  19: [
  ...
  20: [
    ...
    `Se algum mal nos sobrevier, espada, juizo, peste, ou fome, nós nos apresentaremos diante d'esta casa e diante de ti; pois teu nome está n'esta casa; e clamaremos a ti na nossa angustia, e tu nos ouvirás e livrarás.`,
    `Agora, pois, eis que os filhos d'Ammon e de Moab, e os das montanhas de Seir, pelos quaes não permittiste passar a Israel, quando vinham da terra do Egypto; mas d'elles se desviaram e não os destruiram;`,
    `Eis que nos dão o pago, vindo para lançar-nos fóra da tua herança, que nos fizeste herdar.`,
    `Ah Deus nosso, porventura não os julgarás? porque em nós não ha força perante esta grande multidão que vem contra nós, e não sabemos nós o que faremos; porém os nossos olhos estão postos em ti.`,
    `E todo o Judah estava em pé perante o Senhor, como tambem as suas creanças, as suas mulheres, e os seus filhos.`,
    `Então veiu o espirito do Senhor, no meio da congregação, sobre Jahaziel, filho de Zacharias, filho de Benaias, filho de Jehiel, filho de Mattanias, levita, dos filhos de Asaf,`,
    `E disse: Dae ouvidos todo o Judah, e vós, moradores de Jerusalem, e tu, ó rei Josaphat: assim o Senhor vos diz: Não temaes, nem vos assusteis por causa d'esta grande multidão; pois a peleja não é vossa, senão de Deus.`,
    ...
    `N'esta peleja não tereis que pelejar: parae-vos, estae em pé, e vêde a salvação do Senhor para comvosco, ó Judah e Jerusalem; não temaes, nem vos assusteis, ámanhã sahi-lhes ao encontro, porque o Senhor será comvosco.`,
    ...
    `E pela manhã cedo se levantaram e sairam ao deserto de Tekoa: e, saindo elles, poz-se em pé Josaphat, e disse: Ouvi-me, ó Judah, e vós, moradores de Jerusalem: Crede no Senhor vosso Deus, e estareis seguros; crede nos seus prophetas, e sereis prosperados.`,
    ...
    `E, ao tempo que começaram com jubilo e louvor, o Senhor poz emboscadas contra os filhos d'Ammon e de Moab, e os das montanhas de Seir, que vieram contra Judah e foram desbaratados.`,
    `Porque os filhos d'Ammon e de Moab se levantaram contra os moradores das montanhas de Seir, para os destruir e exterminar: e, acabando elles com os moradores de Seir, ajudaram uns aos outros a destruir-se.`,
    `Entretanto chegou Judah á atalaia do deserto: e olharam para a multidão, e eis que eram corpos mortos, que jaziam em terra, e nenhum escapou.`,
    `E vieram Josaphat e o seu povo para saquear os seus despojos, e acharam n'elles fazenda e cadaveres em abundancia, assim como vasos preciosos, e tomaram para si tanto, que não podiam levar mais: e tres dias saquearam o despojo, porque era muito.`,
    ...
    `E Josaphat reinou sobre Judah: era da edade de trinta e cinco annos quando começou a reinar e vinte e cinco annos reinou em Jerusalem; e era o nome de sua mãe, Azuba, filha de Silhi.`,
    ...
    `Ora o resto dos successos de Josaphat, assim primeiros, como ultimos, eis que está escripto nas notas de Jehu, filho de Hanani, que lhe fizeram apontar no livro dos reis de Israel.`,
    ...
    `Porém Eliezer, filho de Dodava, de Maresa, prophetizou contra Josaphat, dizendo: Porquanto te alliaste com Achazias, o Senhor despedaçou as tuas obras. E os navios se quebraram, e não poderam ir a Tharsis.`,
  ],
  21: [
    ...
    `Pelo que Jorão passou adiante com os seus chefes, e todos os carros com elle: e levantou-se de noite, e feriu aos idumeos, que o tinham cercado, como tambem aos capitães dos carros.`,
    `Todavia os idumeos se revoltaram de debaixo do mando de Judah até ao dia d'hoje; então no mesmo tempo Libna se revoltou de debaixo de seu mando; porque deixara ao Senhor, Deus de seus paes.`,
    ...
    `Mas andaste no caminho dos reis d'Israel, e fizeste fornicar a Judah e aos moradores de Jerusalem, segundo a fornicação da casa d'Achab, e tambem mataste a teus irmãos, da casa de teu pae, melhores do que tu`,
    ...
    `Tu tambem terás uma grande enfermidade por causa d'uma doença de tuas entranhas, até que te saiam as tuas entranhas, por causa da enfermidade, de dia em dia.`,
    `Despertou pois o Senhor, contra Jorão o espirito dos philisteos e dos arabios, que estão da banda dos ethiopes.`,
    `Estes subiram a Judah, e deram sobre ella, e levaram toda a fazenda, que se achou na casa do rei, como tambem a seus filhos e a suas mulheres; de modo que lhe não deixaram filho, senão a Joachaz, o mais moço de seus filhos.`,
    `E depois de tudo isto o Senhor o feriu nas suas entranhas com uma enfermidade incuravel.`,
    `E succedeu que, depois de muitos dias, e chegado que foi o fim de dois annos, sairam-lhe as entranhas com a doença; e morreu de más enfermidades: e o seu povo lhe não fez uma queimada como a queimada de seus paes.`,
  ...
  23: [
    `Porém no setimo anno Joiada se esforçou, e tomou comsigo em alliança os chefes das centenas, a Azarias, filho de Joroão, e a Ishmael, filho de Jahanan, e a Azarias, filho d'Obed, e a Maaseias, filho d'Adaias, e a Elisaphat, filho de Sicri.`,
    ...
    `E fizeram os levitas e todo o Judah conforme a tudo o que ordenara o sacerdote Joiada; e tomou cada um os seus homens, os que entravam no sabbado com os que sahiam do sabbado; porque o sacerdote Joiada não tinha despedido as turmas.`,
    ...
    `E olhou: e eis-que o rei estava perto da sua columna, á entrada, e os chefes, e as trombetas junto ao rei; e todo o povo da terra estava alegre, e tocava as trombetas; e tambem os cantores tocavam instrumentos musicos, e davam a entender que se deviam cantar louvores: então Athalia rasgou os seus vestidos, e clamou: Traição, traição!`,
    `Porém o sacerdote Joiada tirou para fóra os centuriões que estavam postos sobre o exercito e disse-lhes: Tirae-a para fóra das fileiras, e o que a seguir, morrerá á espada: porque dissera o sacerdote: Não a matareis na casa do Senhor`,
    ...
    `E Joiada ordenou os officios na casa do Senhor, debaixo da mão dos sacerdotes, os levitas a quem David repartira na casa do Senhor, para offerecerem os holocaustos do Senhor, como está escripto na lei de Moysés, com alegria e com canto, conforme a instituição de David.`,
    `E poz porteiros ás portas da casa do Senhor, para que não entrasse n'ella ninguem immundo em coisa alguma.`,
    `E tomou os centuriões, e os poderosos, e os que tinham dominio entre o povo e todo o povo da terra, e conduziu o rei da casa do Senhor, e entraram na casa do rei pelo meio da porta maior, e assentaram o rei no throno do reino.`,
  ...
  26: [
    ...
    `Porque saiu, e guerreou contra os philisteos, e quebrou o muro de Gath, e o muro de Jabne, e o muro d'Asdod: e edificou cidades em Asdod, e entre os philisteos.`,
    ...
    `Tambem edificou torres no deserto, e cavou muitos poços; porque tinha muito gado, tanto nos valles como nas campinas; lavradores e vinhateiros, nos montes e nos campos ferteis; porque era amigo da agricultura.`,
    `Tinha tambem Uzias um exercito d'homens destros na guerra, que sahiam ao exercito em tropas, segundo o numero da sua mostra, por mão de Jeiel, chanceler, e Maaseias, official, debaixo da mão d'Hananias, um dos principes do rei.`,
    ...
    `Tambem fez em Jerusalem machinas da invenção d'engenheiros, que estivessem nas torres e nos cantos, para atirarem frechas e grandes pedras: e voou a sua fama até muito longe; porque foi maravilhosamente ajudado, até que se fortificou.`,
    ...
    `E resistiram ao rei Uzias, e lhe disseram: A ti, Uzias, não compete queimar incenso perante o Senhor, mas aos sacerdotes, filhos d'Aarão, que são consagrados para queimar incenso; sae do sanctuario, porque transgrediste; e não será isto para honra tua da parte do Senhor Deus`,
    `Então Uzias se indignou: e tinha o incensario na sua mão para queimar incenso: indignando-se elle pois contra os sacerdotes, a lepra lhe saiu á testa perante os sacerdotes, na casa do Senhor, junto ao altar do incenso;`,
    `Então o summo sacerdote Azarias olhou para elle, como tambem todos os sacerdotes, e eis que já estava leproso na sua testa, e apressuradamente o lançaram fóra: e até elle mesmo se deu pressa a sair, visto que o Senhor o ferira.`,
    ...
    `E dormiu Uzias com seus paes, e o sepultaram com seus paes no campo do sepulchro que era dos reis; porque disseram: Leproso é. E Jothão, seu filho, reinou em seu logar.`,
  ],
  27: [
  ...
  28: [
    `Tinha Achaz vinte annos d'edade, quando começou a reinar, e dezeseis annos reinou em Jerusalem: e não fez o que era recto aos olhos do Senhor, como David seu pae.`,
    `Antes andou nos caminhos dos reis d'Israel, e, de mais d'isto, fez imagens fundidas a Baalim.`,
    `Tambem queimou incenso no valle do filho d'Hinnom, e queimou a seus filhos no fogo, conforme ás abominações dos gentios que o Senhor tinha desterrado de diante dos filhos d'Israel.`,
    `Tambem sacrificou, e queimou incenso nos altos e nos outeiros, como tambem debaixo de toda a arvore verde.`,
    `Pelo que o Senhor seu Deus o entregou na mão do rei dos syros, os quaes o feriram, e levaram d'elle em captiveiro uma grande multidão de presos, que trouxeram a Damasco: tambem foi entregue na mão do rei d'Israel, o qual o feriu de grande ferida.`,
    ...
    `E os filhos d'Israel levaram presos de seus irmãos duzentos mil, mulheres, filhos e filhas: e saquearam tambem d'elles grande despojo, e trouxeram o despojo para Samaria.`,
    `E estava ali um propheta do Senhor, cujo nome era Oded, o qual saiu ao encontro do exercito que vinha para Samaria, e lhe disse: Eis que, irando-se o Senhor Deus de vossos paes contra Judah, os entregou na vossa mão, e vós os matastes com uma raiva tal, que chegou até aos céus.`,
    `E agora vós cuidaes em sujeitar a vós os filhos de Judah e Jerusalem, como captivos e captivas: porventura não sois vós mesmos aquelles entre os quaes ha culpas contra o Senhor vosso Deus?`,
    ...
    `Então se levantaram alguns homens d'entre os chefes dos filhos d'Ephraim; Azarias, filho de Johanan, Berechias, filho de Mesillemoth, e Jehizkias filho de Sallum, e Amasa, filho de Hadlai, contra os que voltavam da batalha.`,
    `E lhes disseram: Não fareis entrar aqui estes presos, porque, em relação á nossa culpa contra o Senhor, vós intentaes accrescentar mais a nossos peccados e a nossas culpas, sendo que já temos tanta culpa, e já o ardor da ira está sobre Israel.`,
    `Então os homens armados deixaram os presos e o despojo diante dos maioraes e de toda a congregação.`,
    `E os homens que foram apontados por seus nomes se levantaram, e tomaram os presos, e vestiram do despojo a todos os que d'entre elles estavam nús; e os vestiram, e os calçaram, e lhes deram de comer e de beber, e os ungiram, e a todos os que estavam fracos levaram sobre jumentos, e os trouxeram a Jericó, á cidade das palmeiras, a seus irmãos: depois voltaram para Samaria.`,
    ...
    `Tambem os philisteos deram sobre as cidades da campina e do sul de Judah, e tomaram a Beth-semes, e Aijalon, e a Gederot e a Socoh, e os logares da sua jurisdicção, e a Thimna, e os logares da sua jurisdicção, e a Gimzo, e os logares da sua jurisdicção: e habitaram ali.`,
    ...
    `Porque sacrificou aos deuses de Damasco, que o feriram, e disse: Visto que os deuses dos reis da Syria os ajudam, eu lhes sacrificarei, para que me ajudem a mim. Porém elles foram a sua ruina, e de todo o Israel.`,
    `E ajuntou Achaz os vasos da casa do Senhor, e fez em pedaços os vasos da casa de Deus, e fechou as portas da casa do Senhor, e fez para si altares em todos os cantos de Jerusalem.`,
    ...
    `E dormiu Achaz com seus paes, e o sepultaram na cidade, em Jerusalem, porém não o pozeram nos sepulchros dos reis de Israel: e Ezequias, seu filho, reinou em seu logar.`,
  ],
  29: [
  ...
  31: [
    `E acabando tudo isto, todos os israelitas que ali se acharam sairam ás cidades de Judah e quebraram as estatuas cortaram os bosques, e derribaram os altos e altares por toda Judah e Benjamin, como tambem em Ephraim e Manasseh, até que tudo destruiram: então tornaram todos os filhos de Israel, cada um para sua possessão, para as cidades d'elles.`,
    `E estabeleceu Ezequias as turmas dos sacerdotes e levitas, segundo as suas turmas, a cada um segundo o seu ministerio; aos sacerdotes e levitas para o holocausto e para as offertas pacificas; para ministrarem, e louvarem, e cantarem, ás portas dos arraiaes do Senhor.`,
    `Tambem estabeleceu a parte da fazenda do rei para os holocaustos; para os holocaustos da manhã e da tarde, e para os holocaustos dos sabbados, e das luas novas, e das solemnidades: como está escripto na lei do Senhor.`,
    `E ordenou ao povo, aos moradores de Jerusalem, que dessem a parte dos sacerdotes e levitas; para que se podessem esforçar na lei do Senhor.`,
    ...
    `E aos filhos de Israel e de Judah, que habitavam na cidade de Judah tambem trouxeram dizimos das vaccas e das ovelhas, e dizimos das coisas sagradas que foram consagradas ao Senhor seu Deus: e fizeram muitos montões.`,
    ...
    `E Azarias, o summo sacerdote da casa de Zadok, lhe fallou, dizendo: Desde que esta offerta se começou a trazer á casa do Senhor, houve que comer e de que se fartar, e ainda sobejo em abundancia; porque o Senhor bemdisse ao seu povo, e sobejou esta abastança.`,
    ...
    `E Jehiel, e Azarias, e Nahath, e Asahel, e Jerimoth, e Jozabad, e Eliel, e Ismachias, e Mahath, e Benaias, eram superintendentes debaixo da mão de Conanias e Simei seu irmão, por mandado do rei Ezequias, e de Azarias, maioral da casa de Deus.`,
    ...
    `E debaixo das suas ordens estavam Eden, e Miniamin, e Jesua, e Semaias, Amorias, e Sechanias nas cidades dos sacerdotes, para distribuirem com fidelidade a seus irmãos, segundo as suas turmas, tanto aos pequenos como aos grandes;`,
    ...
    `Tambem d'entre os filhos d'Aarão havia sacerdotes nos campos dos arrabaldes das suas cidades, em cada cidade, homens que foram contados pelos seus nomes para distribuirem as porções a todo o macho entre os sacerdotes e a todos os que estavam contados pelas genealogias entre os levitas.`,
  ...
  32: [
    ...
    `Esforçae-vos, e tende bom animo; não temaes, nem vos espanteis, por causa do rei d'Assyria, nem por causa de toda a multidão que está com elle, porque ha um maior comnosco do que com elle.`,
    `Com elle está o braço de carne, mas comnosco o Senhor nosso Deus, para nos ajudar, e para guerrear nossas guerras. E o povo descançou nas palavras d'Ezequias, rei de Judah.`,
    `Depois d'isto Sennaquerib, rei d'Assyria, enviou os seus servos a Jerusalem (elle porém estava diante de Lachis, com todo o seu dominio), a Ezequias, rei de Judah, e a todo o Judah que estava em Jerusalem, dizendo:`,
    ...
    `Não é Ezequias o mesmo que tirou os seus altos e os seus altares, e fallou a Judah e a Jerusalem, dizendo: Diante do unico altar vos prostrareis, e sobre elle queimareis incenso?`,
    `Não sabeis vós o que eu e meus paes fizemos a todos os povos das terras? porventura poderam de qualquer maneira os deuses das nações d'aquellas terras livrar a sua terra da minha mão`,
    `Qual é, de todos os deuses d'aquellas nações que meus paes destruiram, que podesse livrar o seu povo da minha mão, para que vosso Deus vos possa livrar da minha mão`,
    `Agora, pois, não vos engane Ezequias, nem vos incite assim, nem lhe deis credito; porque nenhum deus de nação alguma, nem de reino algum, pode livrar o seu povo da minha mão, nem da mão de meus paes: quanto menos vos poderá livrar o vosso Deus da minha mão?`,
    `Tambem seus servos fallaram ainda mais contra o Senhor Deus, e contra Ezequias, o seu servo.`,
    `Escreveu tambem cartas, para blasphemar do Senhor Deus d'Israel, e para fallar contra elle, dizendo: Assim como os deuses das nações das terras não livraram o seu povo da minha mão, assim tambem o Deus d'Ezequias não livrará o seu povo da minha mão.`,
    `E clamaram em alta voz em judaico contra o povo de Jerusalem, que estava em cima do muro, para os atemorisarem e os perturbarem, para que tomassem a cidade.`,
    ...
    `Então o Senhor enviou um anjo que destruiu a todos os varões valentes, e os principes, e os chefes no arraial do rei d'Assyria: e tornou com vergonha de rosto á sua terra: e, entrando na casa de seu deus, os mesmos que sairam das suas entranhas, o mataram ali á espada.`,
    `Assim livrou o Senhor a Ezequias, e aos moradores de Jerusalem, da mão de Sennaquerib, rei d'Assyria, e da mão de todos: e de todos os lados os guiou.`,
    ...
    `Tambem o mesmo Ezequias tapou o manancial superior das aguas de Gihon, e as fez correr por baixo para o occidente da cidade de David: porque Ezequias prosperou em toda a sua obra.`,
    ...
    `Quanto ao resto dos successos d'Ezequias, e as suas beneficencias, eis que estão escriptos na visão do propheta Isaias, filho d'Amós, e no livro dos reis de Judah e d'Israel.`,
    `E dormiu Ezequias com seus paes, e o sepultaram no mais alto dos sepulchros dos filhos de David; e todo o Judah e os habitantes de Jerusalem lhe fizeram honras na sua morte: e Manasses, seu filho, reinou em seu logar.`,
  ],
  33: [
  ...
  35: [
    ...
    `E disse aos levitas que ensinavam a todo o Israel e estavam consagrados ao Senhor: Ponde a arca sagrada na casa que edificou Salomão, filho de David, rei d'Israel; não tereis mais este cargo aos hombros: agora servi ao Senhor vosso Deus, e ao seu povo Israel.`,
    ...
    `E estae no sanctuario segundo as divisões das casas paternas de vossos irmãos, os filhos do povo; e haja para cada um uma porção das casas paternas dos levitas.`,
    `E sacrificae a paschoa: e sanctificae-vos, e preparae-a para vossos irmãos, fazendo conforme á palavra do Senhor, dada pela mão de Moysés.`,
    `E apresentou Josias, aos filhos do povo, cordeiros e cabritos do rebanho, todos para os sacrificios da paschoa, por todo o que ali se achou, em numero de trinta mil, e de bois tres mil: isto era da fazenda do rei.`,
    `Tambem apresentaram os seus principes offertas voluntarias ao povo, aos sacerdotes e aos levitas: Hilkias, e Zacharias, e Jehiel, maioral da casa de Deus, deram aos sacerdotes para os sacrificios da paschoa duas mil e seiscentas rezes de gado miudo, e trezentos bois.`,
    `E Conanias, e Semaias, e Nathanael, seus irmãos, como tambem Hasabias, e Jeiel, e Jozabad, maioraes dos levitas, apresentaram aos levitas, para os sacrificios da paschoa, cinco mil rezes de gado miudo, e quinhentos bois.`,
    ...
    `E assaram a paschoa no fogo, segundo o rito: e as offertas sagradas cozeram em panellas, e em caldeiras e em sertãs; e promptamente as repartiram entre todo o povo.`,
    `Depois prepararam para si e para os sacerdotes; porque os sacerdotes, filhos d'Aarão, se occuparam até á noite com o sacrificio dos holocaustos e da gordura; pelo que os levitas prepararam para si e para os sacerdotes, filhos d'Aarão.`,
    `E os cantores, filhos d'Asaph, estavam no seu posto, segundo o mandado de David, e d'Asaph, e d'Heman, e de Jeduthun, vidente do rei, como tambem os porteiros a cada porta; não necessitaram de se desviarem do seu ministerio; porquanto seus irmãos, os levitas, preparavam para elles.`,
    `Assim se estabeleceu todo o serviço do Senhor n'aquelle dia, para celebrar a paschoa, e sacrificar holocaustos sobre o altar do Senhor, segundo o mandado do rei Josias.`,
    `E os filhos d'Israel que ali se acharam celebraram a paschoa n'aquelle tempo, e a festa dos pães asmos, sete dias.`,
    `Nunca pois se celebrou tal paschoa em Israel, desde os dias do propheta Samuel: nem nenhuns reis d'Israel celebraram tal paschoa como a que celebrou Josias com os sacerdotes, e levitas, e todo o Judah e Israel, que ali se acharam, e os habitantes de Jerusalem.`,
    `No anno decimo oitavo do reinado de Josias se celebrou esta paschoa.`,
    `Depois de tudo isto, havendo Josias já preparado a casa, subiu Necho, rei do Egypto, para guerrear contra Carchemis, junto ao Euphrates: e Josias lhe saiu ao encontro.`,
    `Então elle lhe mandou mensageiros, dizendo: Que tenho eu que fazer comtigo, rei de Judah? quanto a ti, contra ti não venho hoje, senão contra a casa que me faz guerra; e disse Deus que me apressasse: guarda-te de te oppores a Deus, que é comigo, para que não te destrua.`,
    ...
    `E seus servos o tiraram do carro, e o levaram no carro segundo que tinha, e o trouxeram a Jerusalem; e morreu, e o sepultaram nos sepulchros de seus paes: e todo o Judah e Jerusalem tomaram luto por Josias.`,
    `E Jeremias fez uma lamentação sobre Josias; e todos os cantores e cantoras fallaram de Josias nas suas lamentações, até ao dia d'hoje; porque as deram por estatuto em Israel; e eis que estão escriptas nas lamentações.`,
  ...
  36: [
    ...
    `E o rei do Egypto poz a Eliakim, seu irmão, rei sobre Judah e Jerusalem, e mudou-lhe o nome em Joaquim: mas a seu irmão Joachaz tomou Necho, e levou-o para o Egypto.`,
    `Era Joaquim de vinte e cinco annos d'edade, quando começou a reinar: e onze annos reinou em Jerusalem: e fez o que era mau aos olhos do Senhor seu Deus.`,
    ...
    `Quanto ao mais dos successos de Joaquim, e as suas abominações que fez, e o mais que se achou n'elle, eis que está escripto no livro dos reis d'Israel e de Judah: e Joaquim, seu filho, reinou em seu logar.`,
    ...
    `Tambem todos os chefes dos sacerdotes e o povo augmentavam de mais em mais as transgressões, segundo todas as abominações dos gentios: e contaminaram a casa do Senhor, que elle tinha sanctificado em Jerusalem.`,
    ...
    `Porque fez subir contra elles o rei dos chaldeos, o qual matou os seus mancebos á espada, na casa do seu sanctuario; e não teve piedade nem dos mancebos, nem das donzellas, nem dos velhos, nem dos decrepitos: a todos os deu na sua mão.`,
    ...
    `Porém, no primeiro anno de Cyro, rei da Persia (para que se cumprisse a palavra do Senhor pela bocca de Jeremias), despertou o Senhor o espirito de Cyro, rei da Persia, o qual fez passar pregão por todo o seu reino, como tambem por escripto, dizendo:`,
    `Assim diz Cyro, rei da Persia: O Senhor, Deus dos céus, me deu todos os reinos da terra, e me encarregou de lhe edificar uma casa em Jerusalem, que está em Judah; quem de vós ha entre todo o seu povo, o Senhor seu Deus seja com elle, e suba.`,
  ],
};
