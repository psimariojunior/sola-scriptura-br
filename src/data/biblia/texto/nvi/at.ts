const data: Record<number, string[]> = {
  1: [
    ...
    `Ele lhes respondeu: “Não compete a vocês saber os tempos ou as datas que o Pai estabeleceu pela sua própria autoridade.`,
  ...
  2: [
    ...
    `Este homem foi entregue por propósito determinado e pré-conhecimento de Deus; e vocês, com a ajuda de homens perversos , o mataram, pregando-o na cruz.`,
    ...
    `“Irmãos, posso dizer com franqueza que o patriarca Davi morreu e foi sepultado, e o seu túmulo está entre nós até o dia de hoje.`,
    ...
    `Exaltado à direita de Deus, ele recebeu do Pai o Espírito Santo prometido e derramou o que vocês agora veem e ouvem.`,
  ...
  5: [
    ...
    `Então perguntou Pedro: “Ananias, como você permitiu que Satanás enchesse o seu coração, a ponto de você mentir ao Espírito Santo e guardar para você uma parte do dinheiro que recebeu pela propriedade?`,
    `Ela não pertencia a você? E, depois de vendida, o dinheiro não estava em seu poder? O que o levou a pensar em fazer tal coisa? Você não mentiu aos homens, mas sim a Deus”.`,
    ...
    `Ao amanhecer, eles entraram no pátio do templo, como haviam sido instruídos, e começaram a ensinar o povo. Quando chegaram o sumo sacerdote e os seus companheiros, convocaram o Sinédrio—toda a assembleia dos líderes religiosos de Israel—e mandaram buscar os apóstolos na prisão.`,
  ...
  10: [
    ...
    `Depois que o anjo que lhe falou se foi, Cornélio chamou dois dos seus servos e um soldado religioso dentre os seus auxiliares`,
    ...
    `No outro dia chegaram a Cesareia. Cornélio os esperava com seus parentes e amigos mais íntimos que tinha convidado.`,
    ...
    `que disse: ‘Cornélio, Deus ouviu sua oração e lembrou-se de suas esmolas.`,
  ...
  13: [
    ...
    `“ ‘Olhem, escarnecedores, admirem-se e pereçam; pois nos dias de vocês farei algo em que vocês jamais creriam se a vocês fosse contado!’ ”`,
    ...
    `Mas os judeus incitaram as mulheres religiosas de elevada posição e os principais da cidade. E, provocando perseguição contra Paulo e Barnabé, os expulsaram do seu território.`,
  ...
  15: [
    ...
    `Isso levou Paulo e Barnabé a uma grande contenda e discussão com eles. Assim, Paulo e Barnabé foram designados, com outros, para irem a Jerusalém tratar dessa questão com os apóstolos e com os presbíteros.`,
    ...
    `Paulo e Barnabé permaneceram em Antioquia, onde, com muitos outros, ensinavam e pregavam a palavra do Senhor.`,
  ...
  17: [
    ...
    `Logo que anoiteceu, os irmãos enviaram Paulo e Silas para Bereia. Chegando ali, eles foram à sinagoga judaica.`,
    ...
    `Quando os judeus de Tessalônica ficaram sabendo que Paulo estava pregando a palavra de Deus em Bereia, dirigiram-se também para lá, agitando e alvoroçando as multidões.`,
  ...
  18: [
    ...
    `Ali, encontrou um judeu chamado Áquila, natural do Ponto, que havia chegado recentemente da Itália com Priscila, sua mulher, pois Cláudio havia ordenado que todos os judeus saíssem de Roma. Paulo foi vê-los`,
  ...
  19: [
    ...
    `Alguns judeus que andavam expulsando espíritos malignos tentaram invocar o nome do Senhor Jesus sobre os endemoninhados, dizendo: “Em nome de Jesus, a quem Paulo prega, eu ordeno que saiam!”`,
    ...
    `Grande número dos que tinham praticado ocultismo reuniram seus livros e os queimaram publicamente. Calculado o valor total, este chegou a cinquenta mil dracmas.`,
    ...
    `Alguns da multidão julgaram que Alexandre era a causa do tumulto, quando os judeus o empurraram para a frente. Ele fez sinal pedindo silêncio, com a intenção de fazer sua defesa diante do povo.`,
  ...
  20: [
    ...
    `sendo acompanhado por Sópatro, filho de Pirro, de Bereia; Aristarco e Secundo, de Tessalônica; Gaio, de Derbe; e Timóteo, além de Tíquico e Trófimo, da província da Ásia.`,
    ...
    `Vocês sabem que não deixei de pregar a vocês nada que fosse proveitoso, mas ensinei tudo publicamente e de casa em casa.`,
  ...
  25: [
    ...
    `Tendo passado com eles de oito a dez dias, desceu para Cesareia e, no dia seguinte, convocou o tribunal e ordenou que Paulo fosse trazido perante ele.`,
    ...
    `Fiquei sem saber como investigar tais assuntos; por isso perguntei-lhe se ele estaria disposto a ir a Jerusalém e ser julgado ali acerca dessas acusações.`,
  ...
  27: [
    ...
    `Agora eu os aconselho a comer algo, pois só assim poderão sobreviver. Nenhum de vocês perderá um fio de cabelo sequer”.`,
  ...
  28: [
    ...
    `Eles, porém, esperavam que ele começasse a inchar ou que caísse morto de repente, mas, tendo esperado muito tempo e vendo que nada de estranho lhe sucedia, mudaram de ideia e passaram a dizer que ele era um deus.`,
    ...
    `Passados três meses, embarcamos num navio que tinha passado o inverno na ilha; era um navio alexandrino, que tinha por emblema os deuses gêmeos Cástor e Pólux.`,
    ...
    `Os irmãos dali tinham ouvido falar que estávamos chegando e vieram até a praça de Ápio e às Três Vendas para nos encontrar. Vendo-os, Paulo deu graças a Deus e sentiu-se encorajado.`,
    ...
    `Assim combinaram encontrar-se com Paulo em dia determinado, indo em grupo ainda mais numeroso ao lugar onde ele estava. Desde a manhã até a tarde ele lhes deu explicações e lhes testemunhou do Reino de Deus, procurando convencê-los a respeito de Jesus, com base na Lei de Moisés e nos Profetas.`,
    ...
    `Pois o coração deste povo se tornou insensível; de má vontade ouviram com os ouvidos e fecharam os olhos. Se assim não fosse, poderiam ver com os olhos, ouvir com os ouvidos, entender com o coração e converter-se, e eu os curaria’.`,
    ...
    `Pregava o Reino de Deus e ensinava a respeito do Senhor Jesus Cristo, abertamente, sem impedimento algum.`,
  ],
};
export default data;
