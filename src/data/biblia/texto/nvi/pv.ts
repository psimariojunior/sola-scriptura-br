const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `A sabedoria o fará andar nos caminhos dos homens de bem e manter-se nas veredas dos justos.`,
  ...
  4: [
    ...
    `Meu filho, escute o que digo a você; preste atenção às minhas palavras.`,
  ...
  6: [
    ...
    `a sua pobreza o surpreenderá como um assaltante, e a sua necessidade sobrevirá como um homem armado sobre você.`,
  ...
  9: [
    ...
    `Se você for sábio, o benefício será seu; se for zombador, sofrerá as consequências”.`,
  ...
  21: [
    ...
    `A violência dos ímpios os arrastará, pois se recusam a agir corretamente.`,
  ...
  27: [
    ...
    `os cordeiros fornecerão a você roupa, e os bodes renderão a você o preço de um campo.`,
