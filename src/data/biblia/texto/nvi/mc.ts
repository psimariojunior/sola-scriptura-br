const data: Record<number, string[]> = {
  1: [
    ...
    `A ele vinha toda a região da Judeia e todo o povo de Jerusalém. Confessando os seus pecados, eram batizados por ele no rio Jordão.`,
    ...
    `Logo os chamou, e eles o seguiram, deixando seu pai, Zebedeu, com os empregados no barco.`,
  ...
  2: [
    ...
    `Ele se levantou, pegou a maca e saiu à vista de todos, que, atônitos, glorificaram a Deus, dizendo: “Nunca vimos nada igual!”`,
  ...
  3: [
    ...
    `Quando ouviram a respeito de tudo o que ele estava fazendo, muitas pessoas procedentes da Judeia, de Jerusalém, da Idumeia, das regiões do outro lado do Jordão e dos arredores de Tiro e de Sidom foram atrás dele.`,
  ...
  4: [
    ...
    `“Considerem atentamente o que vocês estão ouvindo”, continuou ele. “Com a medida com que medirem, vocês serão medidos; e ainda mais acrescentarão para vocês.`,
  ...
  6: [
    ...
    `O rei Herodes ouviu falar dessas coisas, pois o nome de Jesus havia se tornado bem conhecido. Algumas pessoas estavam dizendo : “João Batista ressuscitou dos mortos! Por isso estão operando nele poderes milagrosos”.`,
    ...
    `Finalmente Herodias teve uma ocasião oportuna. No seu aniversário, Herodes ofereceu um banquete aos seus líderes mais importantes, aos comandantes militares e às principais personalidades da Galileia.`,
    ...
    `Ele, porém, respondeu: “Deem-lhes vocês algo para comer”. Eles lhe disseram: “Isto exigiria duzentos denários! Devemos gastar tanto dinheiro em pão e dar-lhes de comer?”`,
  ...
  9: [
    `E lhes disse: “Garanto que alguns dos que aqui estão de modo nenhum experimentarão a morte, antes de verem o Reino de Deus vindo com poder”.`,
    ...
    `Eu digo a verdade: Quem der um copo de água a vocês em meu nome, por vocês pertencerem a Cristo, de modo nenhum perderá a sua recompensa.`,
  ...
  10: [
    ...
    `Respondeu Jesus: “Digo a verdade: Ninguém que tenha deixado casa, irmãos, irmãs, mãe, pai, filhos, ou campos, por causa de mim e do evangelho,`,
  ...
  11: [
    ...
    `Se alguém perguntar: ‘Por que vocês estão fazendo isso?’, digam-lhe: O Senhor precisa dele e logo o devolverá”.`,
    ...
    `E ele os ensinava, dizendo: “Não está escrito: “ ‘A minha casa será chamada casa de oração para todos os povos’? Mas vocês fizeram dela um ‘covil de ladrões’ ”.`,
    ...
    `Eu asseguro que, se alguém disser a este monte: ‘Levante-se e atire-se no mar’, e não duvidar em seu coração, mas crer que acontecerá o que diz, assim lhe será feito.`,
    ...
    `Respondeu Jesus: “Eu farei uma pergunta. Respondam-me, e eu direi com que autoridade estou fazendo estas coisas.`,
    ...
    `Eles responderam a Jesus: “Não sabemos”. Disse então Jesus: “Tampouco direi com que autoridade estou fazendo estas coisas”.`,
  ],
  12: [
  ...
  15: [
    ...
    `José de Arimateia, membro de destaque do Sinédrio, que também esperava o Reino de Deus, dirigiu-se corajosamente a Pilatos e pediu o corpo de Jesus.`,
  ...
  16: [
    ...
    `Vão e digam aos discípulos dele e a Pedro: Ele está indo adiante de vocês para a Galileia. Lá vocês o verão, como ele disse.”`,
