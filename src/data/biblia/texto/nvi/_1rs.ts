const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Mas, agora, não o considere inocente. Você é um homem sábio e saberá o que fazer com ele. Apesar de ele já ser idoso, faça-o descer ensanguentado à sepultura”.`,
    ...
    `“Tenho um pequeno pedido para fazer a você”, disse ela. “Não deixe de me atender.” O rei respondeu: “Faça o pedido, minha mãe; não deixarei de atendê-lo”.`,
  ...
  3: [
    ...
    `Também darei o que você não pediu: riquezas e fama, de forma que não haverá rei igual a você durante toda a sua vida.`,
    ...
    `Então Salomão acordou e percebeu que tinha sido um sonho. A seguir voltou a Jerusalém, pôs-se perante a arca da aliança do Senhor, sacrificou holocaustos e apresentou ofertas de comunhão. Depois ofereceu um banquete a toda a sua corte.`,
  ...
  5: [
    ...
    `Pretendo, por isso, construir um templo em honra ao nome do SENHOR, o meu Deus, conforme o SENHOR disse a meu pai, Davi: ‘O seu filho, a quem colocarei no trono em seu lugar, construirá o templo em honra ao meu nome’.`,
  ...
  7: [
    ...
    `as quatrocentas romãs para os dois conjuntos de correntes; duas fileiras de romãs para cada conjunto;`,
    ...
    `Terminada toda a obra que Salomão realizou para o templo do SENHOR, ele trouxe tudo o que seu pai havia consagrado e colocou-o com os tesouros do templo do SENHOR: a prata, o ouro e os utensílios.`,
  ],
  8: [
    ...
    `Ouve as súplicas do teu servo e de Israel, o teu povo, quando orarem voltados para este lugar. Ouve dos céus, lugar da tua habitação, e, quando ouvires, dá-lhes o teu perdão.`,
    `“Quando um homem pecar contra seu próximo, tiver que fazer um juramento e vier jurar diante do teu altar neste templo,`,
    `ouve dos céus e age. Julga os teus servos; condena o culpado, fazendo recair sobre a sua própria cabeça a consequência da sua conduta, e declara sem culpa o inocente, dando-lhe o que a sua inocência merece.`,
    ...
    `ouve dos céus, lugar da tua habitação, e atende ao pedido do estrangeiro, a fim de que todos os povos da terra conheçam o teu nome e te temam, como faz Israel, o teu povo, e saibam que este templo que construí traz o teu nome.`,
    ...
    `Pôs-se em pé e abençoou em alta voz toda a assembleia de Israel, dizendo:`,
  ...
  9: [
    ...
    `o rei Salomão deu vinte cidades da Galileia a Hirão, rei de Tiro, pois Hirão lhe havia fornecido toda a madeira de cedro e de pinho e o ouro de que ele precisou.`,
    ...
    `que não tinham sido mortos pelos israelitas, e esses povos continuam nesse trabalho até hoje.`,
    ...
    `Também eram israelitas os principais oficiais encarregados das construções de Salomão: quinhentos e cinquenta oficiais que supervisionavam os trabalhadores.`,
  ...
  14: [
    ...
    `A mulher de Jeroboão atendeu a seu pedido e foi à casa de Aías, em Siló. Ora, Aías já não conseguia enxergar; tinha ficado cego por causa da idade.`,
    ...
    `“ ‘Por isso, trarei desgraça à família de Jeroboão. Matarei de Jeroboão até o último indivíduo do sexo masculino em Israel, seja escravo seja livre. Queimarei a família de Jeroboão até o fim como quem queima esterco.`,
  ...
  15: [
    ...
    `Ele cometeu todos os pecados que o seu pai tinha cometido; seu coração não era inteiramente consagrado ao SENHOR, o seu Deus, quanto fora o coração de Davi, seu predecessor.`,
    ...
    `Então o rei Asa reuniu todos os homens de Judá—ninguém foi isentado—e eles retiraram de Ramá as pedras e a madeira que Baasa estivera usando. Com esse material Asa fortificou Geba, em Benjamim, e também Mispá.`,
    ...
    `e, quando descansou com os seus antepassados, foi sepultado com eles na Cidade de Davi, seu predecessor. E seu filho Josafá foi o seu sucessor.`,
  ...
  16: [
    ...
    `Assim que começou a reinar, logo que se assentou no trono, eliminou toda a família de Baasa. Não poupou uma só pessoa do sexo masculino , fosse parente fosse amigo.`,
  ...
  17: [
    ...
    `E ele foi. Quando chegou à porta da cidade, encontrou uma viúva que estava colhendo gravetos. Ele a chamou e perguntou: “Pode me trazer um pouco dʼágua numa jarra para eu beber?”`,
    ...
    `Elias, porém, lhe disse: “Não tenha medo. Vá para casa e faça o que eu disse. Mas primeiro faça um pequeno bolo com o que você tem e traga para mim, e depois faça algo para você e para o seu filho.`,
  ...
  18: [
    ...
    `Agora convoque todo o povo de Israel para encontrar-se comigo no monte Carmelo. E traga os quatrocentos e cinquenta profetas de Baal e os quatrocentos profetas de Aserá, que comem à mesa de Jezabel.”`,
    ...
    `Disse então Elias: “Eu sou o único que restou dos profetas do SENHOR, mas Baal tem quatrocentos e cinquenta profetas.`,
  ...
  19: [
    ...
    `Eliseu deixou os bois e correu atrás de Elias. “Deixa-me dar um beijo de despedida em meu pai e minha mãe”, disse, “e então irei contigo.” “Vá e volte”, respondeu Elias; “lembre-se do que fiz a você.”`,
  ...
  21: [
    ...
    `Acabe tinha dito a Nabote: “Dê-me a sua vinha para eu usar como horta, já que fica ao lado do meu palácio. Em troca eu darei a você uma vinha melhor ou, se preferir, eu pagarei, seja qual for o seu valor”.`,
  ...
  22: [
    ...
    `Josafá descansou com os seus antepassados e foi sepultado junto deles na Cidade de Davi, seu predecessor. E seu filho Jeorão foi o seu sucessor.`,
