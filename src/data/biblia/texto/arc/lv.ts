const data: Record<number, string[]> = {
  ...
  5: [
    ...
    `Porém, se a sua mão não alcançar duas rolas ou dois pombinhos, então, aquele que pecou trará pela sua oferta a décima parte de um efa de flor de farinha, para expiação do pecado; não deitará sobre ela azeite, nem lhe porá em cima o incenso, porquanto é expiação do pecado.`,
    ...
    `Assim, restituirá o que ele tirou das coisas sagradas, e ainda de mais acrescentará o seu quinto, e o dará ao sacerdote; assim, o sacerdote, com o carneiro da expiação, fará expiação por ela, e ser-lhe-á perdoado o pecado.`,
    ...
    `E trará ao sacerdote um carneiro sem mancha do rebanho, conforme a tua estimação, para expiação da culpa, e o sacerdote por ela fará expiação do seu erro em que errou sem saber; e lhe será perdoado.`,
