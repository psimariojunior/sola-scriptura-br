const data: Record<number, string[]> = {
  1: [
    ...
    `Naquela noite Deus apareceu a Salomão e lhe disse: “Peça-me o que quiser, e eu darei a você”.`,
  ...
  7: [
    ...
    `No oitavo dia realizaram uma assembleia solene. Levaram sete dias para a dedicação do altar, e a festa se prolongou por mais sete dias.`,
    ...
    `“E, se você andar segundo a minha vontade, como fez seu pai Davi, e fizer tudo o que eu ordeno a você, obedecendo aos meus decretos e às minhas leis,`,
    ...
    `“Mas, se vocês se afastarem de mim e abandonarem os decretos e os mandamentos que dei a vocês e prestarem culto a outros deuses e adorá-los,`,
  ...
  12: [
    ...
    `O rei Roboão firmou-se no poder em Jerusalém e continuou a reinar. Tinha quarenta e um anos de idade quando começou a reinar e reinou dezessete anos em Jerusalém, cidade que o SENHOR havia escolhido entre todas as tribos de Israel para nela pôr o seu nome. Sua mãe, uma amonita, chamava-se Naamá.`,
  ...
  18: [
    ...
    `A batalha foi violentadurante todo o dia, e assim, o rei de Israel teve que enfrentar os arameus em pé no seu carro, até a tarde. E, ao pôr do sol, ele morreu.`,
  ],
  19: [
  ...
  20: [
    ...
    `Ele disse: “Escutem, todos os que vivem em Judá e em Jerusalém e o rei Josafá! Assim diz o SENHOR a vocês; ‘Não tenham medo nem fiquem desanimados por causa desse exército enorme. Pois a batalha não é de vocês, mas de Deus.`,
    ...
    `Vocês não precisarão lutar nessa batalha. Tomem suas posições, permaneçam firmes e vejam o livramento que o SENHOR dará, ó Judá, ó Jerusalém. Não tenham medo nem desanimem. Saiam para enfrentá-los amanhã, e o SENHOR estará com vocês’ ”.`,
  ...
  21: [
    ...
    `Ele lhes deu muitos presentes de prata, de ouro e objetos de valor, bem como cidades fortificadas em Judá, mas o reino, deu a Jeorão, porque este era seu filho mais velho.`,
    ...
    `sim nos caminhos dos reis de Israel, levando Judá e o povo de Jerusalém a se prostituírem na idolatria como a família de Acabe. E ainda assassinou seus próprios irmãos, membros da família de seu pai, homens que eram melhores do que você.`,
  ...
  23: [
    `No sétimo ano Joiada encorajou-se e fez um acordo com os líderes dos batalhões de cem : Azarias, filho de Jeroão; Ismael, filho de Joanã; Azarias, filho de Obede; Maaseias, filho de Adaías; e Elisafate, filho de Zicri.`,
    ...
    `Então todo o povo foi ao templo de Baal e o derrubou. Despedaçaram os altares e os ídolos e mataram Matã, sacerdote de Baal, em frente aos altares.`,
  ...
  26: [
    ...
    `Uzias tinha dezesseis anos de idade quando se tornou rei e reinou cinquenta e dois anos em Jerusalém. Sua mãe era de Jerusalém e chamava-se Jecolias.`,
    `Ele fez o que o SENHOR aprova, tal como o seu pai Amazias;`,
    `e buscou a Deus durante a vida de Zacarias, que o instruiu no temor de Deus. Enquanto buscou ao SENHOR, Deus o fez prosperar.`,
  ...
  28: [
    ...
    `Zicri, guerreiro efraimita, matou Maaseias, filho do rei, Azricão, oficial encarregado do palácio, e Elcana, o braço direito do rei.`,
  ...
  29: [
    ...
    `entre os descendentes de Hemã: Jeuel e Simei; entre os descendentes de Jedutum: Semaías e Uziel.`,
    ...
    `Preparamos e consagramos todos os utensílios que o rei Acaz, em sua infidelidade, retirou durante o seu reinado. Eles estão em frente ao altar do SENHOR”.`,
    ...
    `Esses holocaustos que a assembleia ofertou ao SENHOR foram setenta bois, cem carneiros e duzentos cordeiros.`,
  ...
  30: [
    ...
    `Ezequias, rei de Judá, forneceu mil novilhos e sete mil ovelhas e bodes para a assembleia; e os líderes, mil novilhos e dez mil ovelhas e bodes. Muitos sacerdotes se consagraram,`,
  ...
  34: [
    ...
    `No décimo oitavo ano do seu reinado, a fim de purificar o país e o templo, ele enviou Safã, filho de Azalias, e Maaseias, governador da cidade, junto com Joá, filho do arquivista real Joacaz, para restaurarem o templo do SENHOR, o seu Deus.`,
