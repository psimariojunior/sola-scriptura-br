...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/guia`, lastModified: TODAY, changeFrequency: 'weekly' as const, priority: 0.85 },
    { url: `${BASE_URL}/historico`, lastModified: ONE_WEEK_AGO, changeFrequency: 'weekly' as const, priority: 0.55 },
    ...
    { url: `${BASE_URL}/quiz/vocabulario`, lastModified: ONE_WEEK_AGO, changeFrequency: 'weekly' as const, priority: 0.7 },
