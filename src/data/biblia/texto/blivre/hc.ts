const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Pois a visão ainda é para um tempo determinado, mas ao fim ela dará testemunho, e não será mentirosa; ainda que se tardar, espera-o, porque virá; não se atrasará.`,
    `Eis que o soberbo não tem a alma correta em si; mas o justo viverá por sua fé.`,
    `Pois também o vinho é enganador, é como um homem arrogante, que não fica quieto em casa; seu apetite se alarga como o mundo dos mortos, e é semelhante à morte, que não se farta; e ajunta a si todas as nações, e reúne a si todos os povos.`,
    `Por acaso todos estes não levantarão um insulto e provérbios de ridicularizações contra ele? E dirão: Ai daquele que acumula o que não era seu, e daquele de se enriquece por meio de extorsão! Até quando?`,
