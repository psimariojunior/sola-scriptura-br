const data: Record<number, string[]> = {
  1: [
    ...
    `De sua própria mesa, o rei designou-lhes uma porção diária de comida e de vinho. Eles receberiam um treinamento durante três anos e depois disso passariam a servir o rei.`,
  ...
  2: [
    ...
    `Mas, se me revelarem o sonho e o interpretarem, eu darei a vocês presentes, recompensas e grandes honrarias. Portanto, revelem-me o sonho e a sua interpretação”.`,
    ...
    `“Tu olhaste, ó rei, e diante de ti estava uma grande estátua: uma estátua enorme, impressionante, de aparência terrível.`,
    ...
    `nas tuas mãos ele pôs a humanidade, os animais selvagens e as aves do céu. Onde quer que vivam, ele fez de ti o governante deles todos. Tu és a cabeça de ouro.`,
    ...
    `E, como viste, o ferro estava misturado com o barro. Isso significa que se farão alianças políticas por meio de casamentos, mas a união decorrente dessas alianças não se firmará, assim como o ferro não se mistura com o barro.`,
    ...
    `Assim o rei pôs Daniel num alto cargo e o cobriu de presentes. Ele o designou governante de toda a província da Babilônia e o encarregou de todos os sábios da província.`,
  ...
  3: [
    ...
    `Mas logo depois o rei Nabucodonosor, alarmado, levantou-se e perguntou aos seus conselheiros: “Não foram três os homens amarrados que nós atiramos no fogo?” Eles responderam: “Sim, ó rei”.`,
  ...
  4: [
    `O rei Nabucodonosor, aos homens de todos os povos, nações e línguas, que vivem no mundo inteiro: Paz e prosperidade!`,
    ...
    `Eu disse: Beltessazar, chefe dos magos, sei que o espírito dos santos deuses está em você, e que nenhum mistério é difícil demais para você. Vou contar o meu sonho; interprete-o para mim.`,
    ...
    `A sentença sobre Nabucodonosor cumpriu-se imediatamente. Ele foi expulso do meio dos homens e passou a comer capim como os bois. Seu corpo molhou-se com o orvalho do céu, até que os seus cabelos e pelos cresceram como as penas da águia, e as suas unhas como as garras das aves.`,
  ...
  6: [
    ...
    `Ora, Daniel se destacou tanto entre os supervisores e os sátrapas por suas grandes qualidades, que o rei planejava tê-lo à frente do governo de todo o império.`,
  ...
  10: [
    ...
    `E ele disse: “Daniel, você é muito amado. Preste bem atenção ao que vou falar; levante-se, pois eu fui enviado a você”. Quando ele me disse isso, pus-me em pé, tremendo.`,
  ...
  11: [
    ...
    `“Agora, pois, vou anunciar a você a verdade: Outros três reis aparecerão na Pérsia, e depois virá um quarto rei, que será bem mais rico do que os anteriores. Depois de conquistar o poder com sua riqueza, instigará todos contra o reino da Grécia.`,
    `Então surgirá um rei guerreiro, que governará com grande poder e fará o que quiser.`,
    `Logo depois de estabelecido , o seu império se desfará e será repartido entre os quatro ventos do céu. Não passará para os seus descendentes, e o império não será poderoso como antes, pois será desarraigado e entregue a outros.`,
    ...
    `Depois de alguns anos, eles se tornarão aliados. A filha do rei do sul fará um tratado com o rei do norte, mas ela não manterá o seu poder, tampouco ele conservará o dele. Naqueles dias ela será entregue à morte, com sua escolta real e com seu pai e com aquele que a apoiou.`,
