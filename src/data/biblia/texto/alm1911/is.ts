const data: Record<number, string[]> = {
  1: [
    `Visão d'Isaias, filho d'Amós, a qual viu sobre Judah e Jerusalem, nos dias d'Uzias, Jothão, Achaz, e Ezequias, reis de Judah.`,
  ...
  5: [
    ...
    `E a cercou, e a limpou das pedras, e a plantou d'excellentes vides; e edificou no meio d'ella uma torre, e tambem fundou n'ella um lagar; e esperava que desse uvas boas, porém deu uvas bravas.`,
    `Agora pois, ó moradores de Jerusalem, e homens de Judah, julgae, vos peço, entre mim e a minha vinha.`,
    `Que mais se podia fazer á minha vinha, que eu lhe não tenha feito? como, esperando eu que desse uvas boas, veiu a dar uvas bravas?`,
    `Agora pois vos farei saber o que eu hei de fazer á minha vinha: tirarei a sua cerca, para que sirva de pasto; derribarei a sua parede, para que seja pisada;`,
    ...
    `Porque a vinha do Senhor dos Exercitos é a casa d'Israel, e os homens de Judah são a planta das suas delicias: e esperou que fizesse juizo, e eis aqui é oppressão; justiça, e eis aqui clamor.`,
    ...
    `E dizem: Avie-se já com isso, e acabe a sua obra, para que já a vejamos; e achegue-se e venha já o conselho do Sancto de Israel, para que o venhamos a saber.`,
    ...
    `Pelo que se accendeu a ira do Senhor contra o seu povo, e estendeu a sua mão contra elle, e o feriu, de modo que as montanhas tremeram, e os seus cadaveres foram como immundicia pelo meio das ruas: com tudo isto não tornou atraz a sua ira, antes ainda está alçada a sua mão`,
  ...
  9: [
    `Mas a terra, que foi angustiada, não será entenebrecida; envileceu nos primeiros tempos, a terra de Zabulon, e a terra de Naphtali; mas nos ultimos a ennobreceu junto ao caminho do mar, d'além do Jordão, na Galilea dos gentios.`,
    ...
    `Porque um menino nos nasceu, um filho se nos deu, e o principado está sobre os seus hombros, e o seu nome se chama Maravilhoso, Conselheiro, Deus forte, Pae da eternidade, Principe da paz.`,
    ...
    `E todo este povo o saberá, Ephraim e os moradores de Samaria, em soberba e altivez de coração, dizendo:`,
    ...
    `Pelo que o Senhor não tomará contentamento nos seus mancebos, e não se compadecerá dos seus orphãos e das suas viuvas, porque todos elles são hypocritas e malfazejos, e toda a bocca falla doidices: e nem com tudo isto se apartou a sua ira, mas ainda está estendida a sua mão.`,
  ...
  10: [
    ...
    `Como a minha mão achou os reinos dos idolos, ainda que as suas imagens de vulto fossem melhores do que as de Jerusalem e de que as de Samaria.`,
    `Porventura como fiz a Samaria e aos seus idolos, não faria eu tambem assim a Jerusalem e aos seus idolos?`,
    `Porque acontecerá que, havendo o Senhor acabado toda a sua obra no monte de Sião e em Jerusalem, então visitarei o fructo da arrogante grandeza do coração do rei da Assyria e a pompa da altivez dos seus olhos.`,
    `Porquanto disse: Com a força da minha mão o fiz, e com a minha sabedoria, porque sou entendido: e terei os limites dos povos, e roubei a sua provisão, e como valente abati aos moradores.`,
    ...
    `Porventura gloriar-se-ha o machado contra o que corta com elle? ou presumirá a serra contra o que puxa por ella? como se o bordão movesse aos que o levantam, ou a vara se levantasse como não sendo pau?`,
    ...
    `Pelo que assim diz o Senhor Jehovah dos Exercitos: Não temas, povo meu, que habitas em Sião, á Assyria, quando te ferir com a vara, e contra ti levantar o seu bordão ao modo dos egypcios,`,
  ...
  13: [
    ...
    `Já se ouve a voz de arroido sobre os montes, como de muito povo: a voz do reboliço de reinos e de nações já congregadas. O Senhor dos Exercitos passa a mostra do exercito de guerra.`,
    ...
    `Pelo que farei estremecer os céus; e a terra se moverá do seu logar, por causa do furor do Senhor dos Exercitos, e por causa do dia da sua ardente ira.`,
  ...
  14: [
    ...
    `E os povos os receberão, e os levarão aos seus logares, e a casa d'Israel os possuirá por servos e por servas, na terra do Senhor: e captivarão aquelles que os captivaram, e dominarão sobre os seus oppressores.`,
    ...
    `Porém tu és lançado da tua sepultura, como um renovo abominavel, como um vestido de mortos atravessados á espada, como os que descem ao covil de pedras, como corpo morto e atropellado.`,
    ...
    `Dá uivos, ó porta, grita, ó cidade, que já tu, ó Philistia, estás toda derretida; porque do norte vem um fumo, e nenhum solitario haverá nas suas congregações.`,
  ...
  16: [
    ...
    `Porque já os campos d'Hesbon enfraqueceram, como tambem a vide de Sibma; já os senhores das nações atropellaram as suas melhores plantas; vão chegando a Jazer; andam vagueando pelo deserto: os seus renovos se estenderam e já passaram além do mar`,
  ...
  17: [
    ...
    `E no dia em que as plantares as farás crescer, e pela manhã farás que a tua semente brote: porém sómente será um montão do segado no dia da enfermidade e das dôres insoffriveis.`,
    ...
    `Bem rugirão as nações, como rugem as muitas aguas, porém reprehendel-o-ha e fugirá para longe; e será afugentado como a pragana dos montes diante do vento, e como a bola diante do tufão`,
  ...
  18: [
    ...
    `Que envia embaixadores por mar, e em navios de junco sobre as aguas, dizendo: Ide, mensageiros ligeiros, á nação arrastada e pellada, a um povo terrivel desde o seu principio e d'ahi em diante; a uma nação de regra em regra e de atropellar, cuja terra despojam os rios`,
    ...
    `N'aquelle tempo trará um presente ao Senhor dos exercitos o povo arrastado e pellado, e o povo terrivel desde o seu principio e d'ahi em diante; uma nação de regra em regra e d'atropellar, cuja terra despojam os rios, ao logar do nome do Senhor dos exercitos, ao monte de Sião.`,
  ],
  19: [
  ...
  21: [
    ...
    `E eis agora vem um carro de homens, e cavalleiros aos pares. Então respondeu e disse: Caída é Babylonia, caída é! e todas as imagens de esculptura dos seus deuses quebrantou contra a terra.`,
  ...
  28: [
    ...
    `E a flor caida do seu glorioso ornamento, que está sobre a cabeça do fertil valle, será como a bêbera antes do verão, que, vendo a alguem, e tendo-a ainda na mão, a engole.`,
    ...
    `Mas tambem estes erram com o vinho e com a bebida forte se desencaminham: até o sacerdote e o propheta erram por causa da bebida forte; são devorados do vinho; se desencaminham com a bebida forte, andam errados na visão, e tropeçam no juizo.`,
    ...
    `Porquanto dizeis: Fizemos concerto com a morte, e com o inferno fizemos alliança; quando passar o diluvio do açoite, não chegará a nós, porque pozemos a mentira por nosso refugio, e debaixo da falsidade nos escondemos.`,
    ...
    `Desde que começa a passar, vos arrebatará, porque todas as manhãs passará, de dia e de noite: e será que sómente o ouvir a fama causará grande turbação.`,
    ...
    `O trigo é esmiuçado, mas não se trilha continuamente, nem se esmiuça com as rodas do seu carro, nem se quebranta com os seus cavallos.`,
  ...
  29: [
    ...
    `Será tambem como o faminto que sonha, e eis-que lhe parece que come, porém, acordando, se acha a sua alma vazia, ou como o sequioso que sonha, e eis-que lhe parece que bebe, porém, acordando, eis-que ainda desfallecido se acha, e a sua alma com sêde: assim será toda a multidão das nações, que pelejarem contra o monte de Sião`,
    ...
    `Porque o Senhor disse: Pois que este povo se chega para mim com a sua bocca, e com os seus labios me honra, porém o seu coração afugenta para longe de mim e o seu temor para comigo consiste só em mandamentos de homens, em que foi instruido;`,
  ...
  37: [
    ...
    `E disseram-lhe: Assim diz Ezequias: Este dia é dia d'angustia e de vituperação, e de blasphemias; porque chegados são os filhos ao parto, e força não ha para parir`,
    `Porventura o Senhor teu Deus ouvirá as palavras de Rabsaké, a quem enviou o seu senhor, o rei da Assyria, para affrontar o Deus vivo, e para vituperal-o com as palavras que o Senhor teu Deus tem ouvido: faze oração pelo resto que ainda se acha.`,
    ...
    `Ó Senhor dos Exercitos, Deus d'Israel, que habitas entre os cherubins; tu mesmo, só tu és Deus de todos os reinos da terra; tu fizeste os céus e a terra.`,
    ...
    `Por meio de teus servos affrontaste o Senhor, e disseste: Com a multidão dos meus carros subi eu aos cumes dos montes, aos lados do Libano; e cortarei os seus altos cedros e as suas faias escolhidas, e entrarei na altura do seu cume, ao bosque do seu campo fertil.`,
    ...
    `Por isso os seus moradores, com as mãos caidas, andaram atemorisados e envergonhados: eram como a herva do campo, e a hortaliça verde, e o feno dos telhados, e o trigo queimado antes da seara.`,
    ...
    `E isto te seja por signal, que este anno se comerá o que de si mesmo nascer, e no segundo anno o que d'ahi proceder: porém no terceiro anno semeae e segae, e plantae vinhas, e comei os fructos d'ellas.`,
    ...
    `Pelo que assim diz o Senhor ácerca do rei da Assyria: Não entrará n'esta cidade, nem lançará n'ella frecha alguma: tão pouco virá perante ella com escudo, nem levantará contra ella tranqueira alguma.`,
    ...
    `Assim Senacherib, rei da Assyria, se retirou, e se foi, e voltou, e se ficou em Ninive.`,
    `E succedeu que, estando elle prostrado na casa de Nisroch, seu deus, Adramelech e Sarezer, seus filhos, o feriram á espada; porém elles se escaparam para a terra d'Ararat, e Esarhaddon, seu filho, reinou em seu logar.`,
  ],
  38: [
    `N'aquelles dias Ezequias adoeceu d'uma enfermidade mortal: e veiu a elle Isaias, filho d'Amós, o propheta, e lhe disse: Assim diz o Senhor: Ordena a tua casa, porque morrerás, e não viverás.`,
    ...
    `Vae, e dize a Ezequias: Assim diz o Senhor, o Deus de David teu pae: Ouvi a tua oração, e vi as tuas lagrimas; eis que accrescento sobre os teus dias quinze annos.`,
    ...
    `Eis que farei tornar a sombra dos graus, que declinou com o sol pelos graus do relogio d'Achaz dez graus atraz. Assim tornou o sol dez graus atraz, pelos graus que já tinha descido.`,
  ...
  39: [
    ...
    `E Ezequias se alegrou d'elles, e lhes mostrou a casa do seu thesouro, a prata, e o oiro, e as especiarias, e os melhores unguentos, e toda a sua casa d'armas, e tudo quanto se achou nos seus thesouros: coisa nenhuma houve, nem em sua casa, nem em todo o seu dominio, que Ezequias lhes não mostrasse.`,
    `Então o propheta Isaias veiu ao rei Ezequias, e lhe disse: Que é o que aquelles homens disseram, e d'onde vieram a ti? E disse Ezequias: D'uma terra remota vieram a mim, de Babylonia.`,
  ...
  40: [
    ...
    `Levantae ao alto os vossos olhos, e vede quem creou estas coisas, quem produz por conta o seu exercito, quem a todas chama pelos seus nomes; por causa da grandeza das suas forças, e porquanto é forte em poder, nenhuma d'ellas vem a faltar.`,
  ...
  42: [
    ...
    `Já ha muito me calei; estive posto em silencio, e me retive: darei gritos como a que está de parto, e a todos os assolarei e juntamente devorarei.`,
    ...
    `E guiarei os cegos pelo caminho que nunca conheceram, os farei caminhar pelas veredas que não conheceram: tornarei as trevas em luz perante elles, e as coisas tortas farei direitas. Estas coisas lhes farei, e nunca os desampararei.`,
  ...
  43: [
    ...
    `Quando passares pelas aguas estarei comtigo, e quando pelos rios, não te submergirão: quando passares pelo fogo, não te queimarás, nem a chamma arderá em ti.`,
    ...
    `Todas as nações se congreguem juntamente, e os povos se reunam; quem d'entre elles pode annunciar isto, e fazer-nos ouvir as coisas antigas? produzam as suas testemunhas, para que se justifiquem, e se ouça, e se diga: Verdade é.`,
    ...
    `Não me compraste por dinheiro canna aromatica, nem com a gordura dos teus sacrificios me encheste, mas me déste trabalho com os teus peccados, e me cançaste com as tuas maldades.`,
  ...
  45: [
    ...
    `Assim diz o Senhor: O trabalho do Egypto, e o commercio dos ethiopes, e dos sabeos, homens d'alta estatura, se passarão para ti, e serão teus; irão atraz de ti, passarão em grilhões, e a ti se prostrarão; far-te-hão as suas supplicas diante de ti, dizendo: Devéras Deus está em ti, e nenhum outro deus ha mais.`,
    ...
    `Annunciae, e chegae-vos, e tomae conselho todos juntos: quem fez ouvir isto desde a antiguidade? quem desde então o annunciou? porventura não sou eu, o Senhor? e não ha outro Deus senão eu; Deus justo e Salvador não o ha fóra de mim.`,
  ...
  48: [
    `Ouvi isto, casa de Jacob, que vos chamaes do nome d'Israel, e saistes das aguas de Judah, que juraes pelo nome do Senhor, e fazeis menção do Deus de Israel, porém não em verdade nem em justiça.`,
    ...
    `Por isso t'o annunciei desde então, e t'o fiz ouvir antes que viesse, para que porventura não dissesses: O meu idolo fez estas coisas, ou a minha imagem de esculptura, ou a minha imagem de fundição as mandou.`,
    ...
    `Assim diz o Senhor, o teu Redemptor, o Sancto de Israel: Eu sou o Senhor, o teu Deus, que te ensina o que é util, e te guia pelo caminho em que deves andar.`,
  ...
  49: [
    ...
    `E fez a minha bocca como uma espada aguda, com a sombra da sua mão me cobriu: e me poz como uma frecha limpa, e me escondeu na sua aljava.`,
    ...
    `Disse mais: Pouco é que sejas o meu servo, para restaurares as tribus de Jacob, e tornares a trazer os guardados em Israel: tambem te dei para luz dos gentios, para seres a minha salvação até á extremidade da terra.`,
    `Assim diz o Senhor, o Redemptor de Israel, o seu Sancto, á alma desprezada, ao que a gente abomina, ao servo dos que dominam: Os reis o verão, e se levantarão, tambem os principes, e diante de ti se inclinarão, por amor do Senhor, que é fiel, e do Sancto de Israel, que te escolheu.`,
    `Assim diz o Senhor: No tempo favoravel te ouvi e no dia da salvação te ajudei, e te guardarei, e te darei por concerto do povo, para restaurares a terra, para fazer possuir as herdades assoladas;`,
    ...
    `Exultae, ó céus, e alegra-te tu, terra, e vós, montes, estalae com jubilo, porque já o Senhor consolou o seu povo, e dos seus afflictos se compadecerá.`,
    ...
    `Porém assim diz o Senhor: Por certo que os presos se tirarão ao valente, e a preza do tyranno escapará; porque eu contenderei com os teus contendedores, e os teus filhos eu remirei.`,
  ...
  50: [
    `Assim diz o Senhor: Que libello de divorcio é este de vossa mãe, pelo qual eu a repudiei? ou quem é o meu crédor, a quem eu vos tenha vendido? eis que por vossas maldades fostes vendidos, e por vossas prevaricações vossa mãe foi repudiada.`,
    `Por que razão vim eu, e ninguem appareceu? chamei, e ninguem respondeu? porventura tanto se encolheu a minha mão, que já não possa remir? ou não ha mais força em mim para livrar? eis que com a minha reprehensão faço seccar o mar, torno os rios em deserto, até que cheirem mal os seus peixes, porquanto não teem agua e morrem de sêde.`,
  ...
  53: [
    ...
    `Porém elle foi ferido pelas nossas transgressões, e moido pelas nossas iniquidades: o castigo que nos traz a paz estava sobre elle, e pelas suas pisaduras fomos sarados.`,
    ...
    `Exigindo-se-lhe, elle foi opprimido, porém não abriu a sua bocca: como um cordeiro foi levado ao matadouro, e como a ovelha muda perante os seus tosquiadores, assim não abriu a sua bocca.`,
  ...
  55: [
    ...
    `Porque gastaes o dinheiro n'aquillo que não é pão? e o producto do vosso trabalho n'aquillo que não pode fartar? ouvi-me attentamente, e comei o bem, e a vossa alma se deleite com a gordura.`,
    ...
    `Porque, assim como desce a chuva e a neve dos céus, e para lá não torna, porém rega a terra, e a faz produzir, e brotar, e dar semente ao semeador, e pão ao que come`,
    `Assim será a minha palavra, que sair da minha bocca; ella não tornará a mim vazia; antes fará o que me apraz, e prosperará n'aquillo para o que a enviei.`,
  ...
  58: [
    ...
    `Ainda que me buscam cada dia, tomam prazer em saber os meus caminhos, como um povo que obra justiça, e não deixa o direito do seu Deus: perguntam-me pelos direitos da justiça, e teem prazer em se chegarem a Deus,`,
    ...
    `Eis que para contendas e debates jejuaes, e para dardes punhadas impiamente: não jejueis como hoje, para fazer ouvir a vossa voz no alto.`,
    `Seria este o jejum que eu escolheria, que o homem um dia afflija a sua alma? que incline a sua cabeça como o junco, e estenda debaixo de si sacco e cinza? chamarias tu a isto jejum e dia aprazivel ao Senhor?`,
    ...
    `E o Senhor te guiará continuamente, e fartará a tua alma em grandes sequidões, e fortificará os teus ossos; e serás como um jardim regado, e como um manancial de aguas, cujas aguas nunca faltam.`,
    ...
    `Se desviares o teu pé do sabbado, de fazeres a tua vontade no meu sancto dia, e chamares ao sabbado deleitoso, e o sancto dia do Senhor, digno de honra, e o honrares não seguindo os teus caminhos, nem pretendendo fazer a tua propria vontade, nem fallares as tuas proprias palavras,`,
    `Então te deleitarás no Senhor, e te farei cavalgar sobre as alturas da terra, a te sustentarei com a herança de teu pae Jacob; porque a bocca do Senhor o fallou.`,
  ],
  59: [
    ...
    `Como o prevaricar, e mentir contra o Senhor, e o retirar-se de após o nosso Deus, o fallar de oppressão e rebellião, o conceber e inventar palavras de falsidade do coração.`,
    ...
    `Quanto a mim, este é o meu concerto com elles, diz o Senhor: o meu espirito, que está sobre ti, e as minhas palavras, que puz em tua bocca, não se desviarão da tua bocca nem da bocca da tua semente, nem da bocca da semente da tua semente, diz o Senhor, desde agora e para todo o sempre.`,
  ],
  60: [
  ...
  61: [
    `O Espirito do Senhor Jehovah está sobre mim; porque o Senhor me ungiu, para prégar boas novas aos mansos: enviou-me a restaurar os contritos de coração, a apregoar liberdade aos captivos, e a abertura de prisão aos presos;`,
    `A apregoar o anno acceitavel do Senhor e o dia da vingança do nosso Deus, a consolar todos os tristes;`,
    `A ordenar aos tristes de Sião que se lhes dê ornamento por cinza, oleo de gozo por tristeza, vestidura de louvor por espirito angustiado; para que se chamem carvalhos de justiça, plantados do Senhor, para que seja glorificado.`,
    ...
    `Gozo-me muito no Senhor, a minha alma se alegra no meu Deus: porque me vestiu de vestidos de salvação, me cobriu com o manto de justiça, como quando o noivo se orna com atavio sacerdotal, e como a noiva se enfeita com as suas joias.`,
  ...
  63: [
    `Quem é este, que vem de Edom, com vestidos tintos de Bozra? este ornado com a sua vestidura, que marcha com a sua grande força? Eu, que fallo em justiça, poderoso para salvar.`,
    `Porque estás vermelho na tua vestidura? e os teus vestidos como aquelle que piza no lagar?`,
    `Eu pizei só o lagar, e dos povos ninguem houve commigo; e os pizei na minha ira, e os atropelei no meu furor; e o seu sangue se aspergia sobre os meus vestidos, e manchei toda a minha vestidura.`,
    ...
    `Das benignidades do Senhor farei menção, e dos muitos louvores do Senhor, conforme tudo quanto o Senhor nos fez; e da grande bondade para com a casa de Israel, que usou com elles segundo as suas misericordias, e segundo a multidão das suas benignidades.`,
    `Porque dizia: Comtudo meu povo são, filhos que não mentirão: assim se lhes fez Salvador.`,
    `Em toda a angustia d'elles elle foi angustiado, e o anjo da sua face os salvou; pelo seu amor, e pela sua compaixão elle os remiu; e os tomou, e os trouxe sobre si todos os dias da antiguidade.`,
    ...
    `Todavia se lembrou dos dias da antiguidade, de Moysés, e do seu povo. Porém onde está agora o que os fez subir do mar com os pastores do seu rebanho? onde está o que punha no meio d'elles o seu Espirito Sancto?`,
  ...
  66: [
    ...
    `Tambem eu escolherei seus escarneos, farei vir sobre elles os seus temores; porquanto clamei e ninguem respondeu, fallei, e não escutaram; mas fizeram o que parece mal aos meus olhos, e escolheram aquillo em que não tinha prazer.`,
    ...
    `Quem jámais ouviu tal coisa? quem viu coisas similhantes? poder-se-hia fazer parir uma terra n'um só dia? nasceria uma nação de uma só vez? mas já Sião esteve de parto e já pariu seus filhos.`,
    `Abriria eu a madre, e não geraria? diz o Senhor: geraria eu, e fechar-me-hia? diz o teu Deus.`,
    `Gozae-vos com Jerusalem, e alegrae-vos d'ella, vós todos os que a amaes: alegrae-vos com ella de alegria, todos os que pranteastes por ella;`,
    `Para que mameis, e vos farteis dos peitos das suas consolações: para que chupeis, e vos deleiteis com o resplandor da sua gloria.`,
    `Porque assim diz o Senhor: Eis que estenderei sobre ella a paz como um rio, e a gloria das nações como um ribeiro que trasborda; então mamareis, ao colo vos trarão, e sobre os joelhos vos afagarão.`,
    ...
    `E porei entre elles um signal, e os que d'elles escaparem enviarei ás nações, a Tarsis, Pul, e Lud, frecheiros a Tubal e Javan, até ás ilhas de mais longe, que não ouviram a minha fama, nem viram a minha gloria; e annunciarão a minha gloria entre as nações`,
    `E trarão a todos os vossos irmãos, d'entre todas as nações, de presente ao Senhor, sobre cavallos, e em carros, e em liteiras, e sobre mulas, e sobre dromedarios, ao meu sancto monte, a Jerusalem, diz o Senhor: como quando os filhos de Israel trazem os seus presentes em vasos limpos á casa do Senhor:`,
