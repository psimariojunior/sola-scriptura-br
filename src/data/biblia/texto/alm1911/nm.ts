const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `Estes são os nomes dos filhos de Aarão, dos sacerdotes ungidos, cujas mãos foram sagradas para administrar o sacerdocio.`,
    ...
    `Porque todo o primogenito meu é: desde o dia em que tenho ferido a todo o primogenito na terra do Egypto, sanctifiquei-me todo o primogenito em Israel, desde o homem até ao animal: meus serão; Eu sou o Senhor.`,
    ...
    `E as cortinas do pateo, e o pavilhão da porta do pateo, que estão junto ao tabernaculo e junto ao altar, em redor: como tambem as suas cordas para todo o seu serviço.`,
    ...
    `E a sua guarda será a arca, e a mesa, e o castiçal, e os altares, e os vasos do sanctuario com que ministram, e o véu com todo o seu serviço.`,
    ...
    `E os que assentarão as suas tendas diante do tabernaculo, ao oriente, diante da tenda da congregação, para a banda do nascente, serão Moysés e Aarão, com seus filhos, tendo o cuidado da guarda do sanctuario, pela guarda dos filhos de Israel: e o estranho que se chegar morrerá.`,
    ...
    `E fallou o Senhor a Moysés, dizendo:`,
    `Toma os levitas em logar de todo o primogenito entre os filhos d'Israel, e os animaes dos levitas em logar dos seus animaes: porquanto os levitas serão meus: Eu sou o Senhor.`,
  ...
  4: [
    ...
    `Tambem sobre a mesa da proposição estenderão um panno d'azul: e sobre ella porão os pratos os seus incensarios, e as taças e escudellas; tambem o pão continuo estará sobre ella.`,
    ...
    `Tambem tomarão todos os vasos do ministerio, com que servem no sanctuario; e os porão n'um panno d'azul, e os cobrirão com uma coberta de pelles de teixugos, e os porão sobre os varaes.`,
    ...
    `Havendo pois Aarão e seus filhos, ao partir do arraial, acabado de cobrir o sanctuario, e todos os instrumentos do sanctuario, então os filhos de Kohath virão para leval-o; mas no sanctuario não tocarão, para que não morram: este é o cargo dos filhos de Kohath na tenda da congregação.`,
    `Porém o cargo d'Eleasar, filho d'Aarão, o sacerdote, será o azeite da luminaria, e o incenso aromatico, e a continua offerta dos manjares, e azeite da uncção, o cargo de todo o tabernaculo, e de tudo que n'elle ha, no sanctuario e nos seus vasos.`,
    `E fallou o Senhor a Moysés e a Aarão, dizendo:`,
    ...
    `Da edade de trinta annos e para cima, até aos cincoenta, contarás a todo aquelle que entrar a servir no seu serviço, para administrar o ministerio na tenda da congregação.`,
    ...
    `Todo o ministerio dos filhos dos gersonitas, em todo o seu cargo, e em todo o seu ministerio, será segundo o mandado d'Aarão e de seus filhos: e lhes encommendareis em guarda todo o seu cargo.`,
    ...
    `Da edade de trinta annos e para cima, até ao cincoenta, todo aquelle que entrou n'este serviço, para o ministerio da tenda da congregação.`,
    `Os que d'elles foram contados, pois, segundo as sua gerações, foram dois mil e setecentos e cincoenta.`,
    `Estes são os que foram contados das gerações dos kohathitas, de todo aquelle que ministrava na tenda da congregação, os quaes contaram Moysés e Aarão, conforme ao mandado do Senhor pela mão de Moysés.`,
  ...
  5: [
    ...
    `De maneira que algum homem se houver deitado com ella, e fôr occulto aos olhos de seu marido, e ella o tiver occultado, havendo-se ella contaminado, e contra ella não houver testemunha, e no feito não fôr apanhada,`,
    `E o espirito de ciumes vier sobre elle, e de sua mulher tiver ciumes, por ella se haver contaminado, ou sobre elle vier o espirito de ciumes, e de sua mulher tiver ciumes, não se havendo ella contaminado,`,
    `Então aquelle varão trará a sua mulher perante o sacerdote, e juntamente trará a sua offerta por ella: uma decima de epha de farinha de cevada, sobre a qual não deitará azeite, nem sobre ella porá incenso, porquanto é offerta de manjares de ciumes, offerta memorativa, que traz a iniquidade em memoria`,
    `E o sacerdote a fará chegar, e a porá perante a face do Senhor.`,
    `E o sacerdote tomará agua sancta n'um vaso de barro; tambem tomará o sacerdote do pó que houver no chão do tabernaculo, e o deitará na agua`,
    ...
    `E o sacerdote a conjurará, e dirá áquella mulher: Se ninguem comtigo se deitou, e se não te apartaste de teu marido pela immundicia, d'estas aguas amargas, amaldiçoantes, serás livre`,
    ...
    `E o sacerdote tomará a offerta de manjares dos ciumes da mão da mulher, e moverá a offerta de manjares perante o Senhor; e a offerecerá sobre o altar.`,
    ...
    `E, havendo-lhe dado a beber aquella agua, será que, se ella se tiver contaminado, e contra seu marido tiver trespassado, a agua amaldiçoante entrará n'ella para amargura, e o seu ventre se inchará, e a sua côxa descairá; e aquella mulher será por maldição no meio do seu povo`,
    ...
    `Ou quando sobre o homem vier o espirito de ciumes, e tiver ciumes de sua mulher, apresente a mulher perante o Senhor, e o sacerdote n'ella execute toda esta lei.`,
  ...
  6: [
    ...
    `De vinho e de bebida forte se apartará: vinagre de vinho, nem vinagre de bebida forte não beberá; nem beberá alguma beberagem d'uvas; nem uvas frescas nem seccas comerá.`,
    ...
    `E se o morto vier a morrer junto a elle por acaso, subitamente, que contaminasse a cabeça do seu nazireado, então no dia da sua purificação rapará a sua cabeça, e ao setimo dia a rapará.`,
    ...
    `E elle offerecerá a sua offerta ao Senhor, um cordeiro sem mancha d'um anno em holocausto, e uma cordeira sem mancha de um anno para expiação do peccado, e um carneiro sem mancha por offerta pacifica;`,
    `E um cesto de bolos asmos, bolos de flor de farinha com azeite, amassados, e coscorões asmos untados com azeite, como tambem a sua offerta de manjares, e as suas libações.`,
    `E o sacerdote os trará perante o Senhor, e sacrificará a sua expiação do peccado, e o seu holocausto:`,
    `Tambem sacrificará o carneiro em sacrificio pacifico ao Senhor, com o cesto dos bolos asmos: e o sacerdote offerecerá a sua offerta de manjares, e a sua libação.`,
  ...
  9: [
    ...
    `E no dia de levantar o tabernaculo, a nuvem cobriu o tabernaculo sobre a tenda do testemunho: e á tarde estava sobre o tabernaculo como uma apparencia de fogo até á manhã.`,
  ...
  11: [
    ...
    `E disse Moysés ao Senhor: Porque fizeste mal a teu servo, e porque não achei graça aos teus olhos; que pozesses sobre mim o cargo de todo este povo?`,
    `Concebi eu porventura todo este povo? pari-o eu? que me dissesses: leva-o ao teu collo, como o aio leva o que cria, á terra que juraste a seus paes?`,
    ...
    `E disse o Senhor a Moysés: Ajunta-me setenta homens dos anciãos d'Israel , de quem sabes que são anciãos do povo, e seus officiaes: e os trarás perante a tenda da congregação, e ali se porão comtigo`,
    ...
    `E dirás ao povo: Sanctificae-vos para ámanhã, e comereis carne: porquanto chorastes aos ouvidos do Senhor, dizendo: Quem nos dará carne a comer? pois bem nos ia no Egypto: pelo que o Senhor vos dará carne, e comereis:`,
    `Não comereis um dia, nem dois dias, nem cinco dias, nem dez dias, nem vinte dias;`,
    `Até um mez inteiro, até vos sair pelos narizes, até que vos enfastieis d'ella: porquanto rejeitastes ao Senhor, que está no meio de vós, e chorastes diante d'elle, dizendo: Porque saimos do Egypto?`,
    ...
    `Então o Senhor desceu na nuvem, e lhe fallou; e, tirando do espirito, que estava sobre elle, o poz sobre aquelles setenta anciãos: e aconteceu que, assim como o espirito repousou sobre elles, prophetizaram; mas depois nunca mais.`,
    ...
    `Então soprou um vento do Senhor, e trouxe codornizes do mar, e as espalhou pelo arraial quasi caminho d'um dia d'uma banda, e quasi caminho d'um dia da outra banda, á roda do arraial; e estavam quasi dois covados sobre a terra.`,
    `Então o povo se levantou todo aquelle dia e toda aquella noite, e todo o dia seguinte, e colheram as codornizes; o que menos tinha, colhera dez homers; e as estenderam para si ao redor do arraial.`,
  ...
  12: [
    ...
    `Ora não seja ella como um morto, que saindo do ventre de sua mãe, a metade da sua carne já está consumida.`,
  ...
  14: [
    ...
    `E todos os filhos d'Israel murmuraram contra Moysés e contra Aarão; e toda a congregação lhe disse: Ah se morrêramos na terra do Egypto! ou, ah se morrêramos n'este deserto!`,
    ...
    `E dirão aos moradores d'esta terra, os que ouviram que tu, ó Senhor, estás no meio d'este povo, que de cara a cara, ó Senhor, lhes appareces, que tua nuvem está sobre elles, e que vaes adiante d'elles n'uma columna de nuvem de dia, e n'uma columna de fogo de noite.`,
    ...
    `O Senhor é longanimo, e grande em beneficencia, que perdôa a iniquidade e a transgressão, que o culpado não tem por innocente, e visita a iniquidade dos paes sobre os filhos até á terceira e quarta geração.`,
    ...
    `N'este deserto cairão os vossos cadaveres, como tambem todos os que de vós foram contados segundo toda a vossa conta, de vinte annos e para cima, os que d'entre vós contra mim murmurastes;`,
    ...
    `Segundo o numero dos dias em que espiastes esta terra, quarenta dias, por cada dia um anno, levareis sobre vós as vossas iniquidades quarenta annos, e conhecereis o meu apartamento.`,
  ...
  16: [
    `E Coré, filho de Jizhar, filho de Kohath, filho de Levi, tomou comsigo a Dathan e a Abiram, filhos de Eliab, e a On, filho de Peleth, filhos de Ruben,`,
    ...
    `E fallou a Coré e a toda a sua congregação, dizendo: Ámanhã pela manhã o Senhor fará saber quem é seu, e quem o sancto que elle fará chegar a si: e aquelle a quem escolher fará chegar a si.`,
    `Fazei isto: tomae vós incensarios, Coré e toda a sua congregação;`,
    `E, pondo fogo n'elles ámanhã, sobre elles deitae incenso perante o Senhor: e será que o homem a quem o Senhor escolher, este será o sancto: baste-vos, filhos de Levi.`,
    `Disse mais Moysés a Coré: Ouvi agora, filhos de Levi:`,
    `Porventura pouco para vós é que o Deus de Israel vos separou da congregação de Israel, para vos fazer chegar a si, a administrar o ministerio do tabernaculo do Senhor e estar perante a congregação para ministrar-lhe:`,
    ...
    `Porventura pouco é que nos fizeste subir de uma terra que mana leite e mel, para nos matares n'este deserto, senão que tambem totalmente te assenhoreias de nós?`,
    ...
    `Disse mais Moysés a Coré: Tu e toda a tua congregação vos ponde perante o Senhor, tu, e elles, e Aarão, ámanhã.`,
    ...
    `E fallou á congregação, dizendo: Desviae-vos, peço-vos, das tendas d'estes impios homens, e não toqueis nada do que é seu, para que porventura não pereçaes em todos os seus peccados.`,
    `Levantaram-se pois do redor da habitação de Coré, Dathan e Abiram, E Dathan e Abiram sairam, e se pozeram á porta das suas tendas, juntamente com as suas mulheres, e seus filhos, e suas creanças.`,
    ...
    `Mas, se o Senhor crear alguma coisa nova, e a terra abrir a sua bocca e os tragar com tudo o que é seu, e vivos descerem ao sepulchro, então conhecereis que estes homens irritaram ao Senhor.`,
    ...
    `E Eleazar, o sacerdote, tomou os incensarios de metal, que trouxeram aquelles que foram queimados, e os estenderam para cobertura do altar,`,
    ...
    `E disse Moysés a Aarão: Toma o teu incensario, e põe n'elle fogo do altar, e deita incenso sobre elle, e vae depressa á congregação, e faze expiação por elles: porque grande indignação saiu de diante do Senhor; já começou a praga.`,
  ...
  20: [
    `Chegando os filhos d'Israel, toda a congregação, ao deserto de Zin, no mez primeiro, o povo ficou em Cades: e Miriam morreu ali, e ali foi sepultada.`,
    ...
    `E porque nos fizestes subir do Egypto, para nos trazer a este logar máu? logar não de semente, nem de figos, nem de vides, nem de romãs, nem d'agua para beber.`,
    ...
    `Toma a vara, e ajunta a congregação, tu e Aarão, teu irmão, e fallae á rocha perante os seus olhos, e dará a sua agua: assim lhes tirarás agua da rocha, e darás a beber á congregação e aos seus animaes.`,
    `Então Moysés tomou a vara de diante do Senhor, como lhe tinha ordenado,`,
    `E Moysés e Aarão congregaram a congregação diante da rocha, e disse-lhes: Ouvi agora, rebeldes, porventura tiraremos agua d'esta rocha para vós`,
    ...
    `E o Senhor disse a Moysés e a Aarão: Porquanto não me crestes a mim, para me sanctificar diante dos filhos de Israel, por isso não mettereis esta congregação na terra que lhes tenho dado.`,
    ...
    `E clamámos ao Senhor, e elle ouviu a nossa voz, e mandou um anjo, e nos tirou do Egypto: e eis que estamos em Cades, cidade na extremidade dos teus termos.`,
    `Deixa-nos pois passar pela tua terra; não passaremos pelo campo, nem pelas vinhas, nem beberemos a agua dos poços: iremos pela estrada real; não nos desviaremos para a direita nem para a esquerda, até que passemos pelos teus termos.`,
    ...
    `Porém elle disse: Não passarás. E saiu-lhe Edom ao encontro com muita gente, e com mão forte.`,
    ...
    `E Moysés despiu a Aarão os vestidos, e os vestiu a Eleazar, seu filho; e morreu Aarão ali sobre o cume do monte; e desceram Moysés e Eleazar do monte.`,
  ...
  22: [
    ...
    `Este enviou mensageiros a Balaão, filho de Beor, a Pethor, que está junto ao rio, na terra dos filhos do seu povo, a chamal-o, dizendo: Eis que um povo saiu do Egypto; eis que cobre a face da terra, e parado está defronte de mim.`,
    `Vem pois agora, rogo-te, amaldiçoa-me este povo, pois mais poderoso é do que eu; porventura o poderei ferir, e o lançarei fóra da terra: porque eu sei que, a quem tu abençoares será abençoado, e a quem tu amaldiçoares será amaldiçoado.`,
    ...
    `Então Balaão respondeu, e disse aos servos de Balac: Ainda que Balac me désse a sua casa cheia de prata e de oiro, eu não poderia traspassar o mandado do Senhor meu Deus, para fazer coisa pequena ou grande;`,
    ...
    `E a ira de Deus accendeu-se, porque elle se ia: e o anjo do Senhor poz-se-lhe no caminho por adversario: e elle ia caminhando, montado na sua jumenta, e dois de seus moços com elle.`,
    `Viu pois a jumenta o anjo do Senhor, que estava no caminho, com a sua espada desembainhada na mão; pelo que desviou-se a jumenta do caminho, e foi-se pelo campo: então Balaão espancou a jumenta para fazel-a tornar ao caminho.`,
    ...
    `E a jumenta disse a Balaão: Porventura não sou a tua jumenta, em que cavalgaste desde o tempo que eu fui tua até hoje? costumei eu alguma vez de fazer assim comtigo? E elle respondeu: Não.`,
  ...
  23: [
    ...
    `Quem contará o pó de Jacob e o numero da quarta parte de Israel? a minha alma morra da morte dos justos, e seja o meu fim como o seu.`,
    ...
    `Pois contra Jacob não vale encantamento, nem adivinhação contra Israel: n'este tempo se dirá de Jacob e d'Israel: Que coisas Deus tem obrado!`,
  ...
  25: [
    ...
    `E eis que veiu um homem dos filhos de Israel, e trouxe a seus irmãos uma midianita aos olhos de Moysés, e aos olhos de toda a congregação dos filhos de Israel, chorando elles diante da tenda da congregação.`,
  ...
  27: [
    `E chegaram as filhas de Selofad, filho de Hepher, filho de Gilead, filho de Machir, filho de Manasseh, entre as familias de Manasseh, filho de José: (e estes são os nomes de suas filhas: Machla, Noa, Hogla, Milca, e Tirza);`,
    ...
    `E fallou o Senhor a Moysés, dizendo:`,
    `As filhas de Selofad fallam rectamente: certamente lhes darás possessão de herança entre os irmãos de seu pae; e a herança de seu pae farás passar a ellas`,
    ...
    `Se tambem seu pae não tiver irmãos, então a sua herança dareis a seu parente, áquelle que lhe fôr o mais chegado da sua familia, para que a possua: isto aos filhos de Israel será por estatuto de direito, como o Senhor ordenou a Moysés`,
    ...
    `Porquanto rebeldes fostes no deserto de Zin, na contenda da congregação, ao meu mandado de me sanctificar nas aguas diante dos seus olhos: (estas são as aguas de Meribah de Cades, no deserto de Zin.)`,
    ...
    `E se porá perante Eleazar, o sacerdote, o qual por elle consultará, segundo o juizo de Urim, perante o Senhor: conforme ao seu dito sairão, e conforme ao seu dito entrarão, elle e todos os filhos de Israel com elle, e toda a congregação.`,
  ...
  29: [
    ...
    `E pela sua offerta de manjares de flor de farinha misturada com azeite, tres decimas para o bezerro, e duas decimas para o carneiro,`,
    `E uma decima para um cordeiro, para cada um dos sete cordeiros.`,
    `E um bode para expiação do peccado, para fazer expiação por vós`,
    `Além do holocausto do mez, e a sua offerta manjares, e o holocausto continuo, e a sua offerta de manjares, com as suas libações, segundo o seu estatuto, em cheiro suave, offerta queimada ao Senhor.`,
    ...
    `E a sua offerta de manjares e as suas libações para os bezerros, para os carneiros e para os cordeiros, conforme ao seu numero, segundo o estatuto;`,
    ...
    `E as suas offertas de manjares, e as suas libações para os bezerros, para os carneiros e para os cordeiros, conforme ao seu numero, segundo o estatuto;`,
    `E um bode para expiação do peccado, além do holocausto continuo, e a sua offerta de manjares e a sua libação.`,
    `E, no quarto dia, dez bezerros, dois carneiros, quatorze cordeiros d'um anno, sem mancha;`,
    `A sua offerta de manjares, e as suas libações para os bezerros, para os carneiros e para os cordeiros, conforme ao numero, segundo o estatuto;`,
    `E um bode para expiação do peccado, além do holocausto continuo, a sua offerta de manjares e a sua libação.`,
    ...
    `E um bode para expiação do peccado, além do holocausto continuo, e a sua offerta de manjares e a sua libação.`,
    `E, no sexto dia, oito bezerros, dois carneiros, quatorze cordeiros d'um anno, sem mancha;`,
    `E a sua offerta de manjares, e as suas libações para os bezerros, para os carneiros e para os cordeiros, conforme ao seu numero, segundo o estatuto;`,
    `E um bode para expiação do peccado, de mais do holocausto continuo, a sua offerta de manjares e a sua libação.`,
    `E, no setimo dia, sete bezerros, dois carneiros, quatorze cordeiros d'um anno, sem mancha;`,
    `E a sua offerta de manjares, e as suas libações para os bezerros, para os carneiros e para os cordeiros, conforme ao seu numero, segundo o seu estatuto,`,
    `E um bode para expiação do peccado, de mais do holocausto continuo, a sua offerta de manjares e a sua libação.`,
  ...
  32: [
    ...
    `Que os varões, que subiram do Egypto, de vinte annos e para cima não verão a terra que jurei a Abrahão, a Isaac, e a Jacob porquanto não perseveraram em seguir-me;`,
    ...
    `Porém nós nos armaremos, apressando-nos diante dos d'Israel, até que os levemos ao seu logar: e ficarão as nossas crianças nas cidades fortes por causa dos moradores da terra.`,
    ...
    `E disse-lhes Moysés: Se os filhos de Gad, e os filhos de Ruben passarem comvosco o Jordão, armado cada um para a guerra perante o Senhor; e a terra estiver subjugada diante de vós, em possessão lhes dareis a terra de Gilead;`,
  ...
  35: [
    `E fallou o Senhor a Moysés nas campinas dos moabitas, junto ao Jordão de Jericó, dizendo:`,
    `Dá ordem aos filhos de Israel que, da herança da sua possessão, dêem cidades aos levitas, em que habitem: e tambem aos levitas dareis arrabaldes ao redor d'ellas.`,
    ...
    `E de fóra da cidade, da banda do oriente, medireis dois mil covados, e da banda do sul dois mil covados, e da banda do occidente dois mil covados, e da banda do norte dois mil covados, e a cidade no meio: isto terão por arrabaldes das cidades.`,
    `Das cidades pois que dareis aos levitas haverá seis cidades de refugio, as quaes dareis para que o homicida ali se acolha: e, além d'estas, lhes dareis quarenta e duas cidades.`,
    ...
    `Serão por refugio estas seis cidades para os filhos de Israel, e para o estrangeiro, e para o que se hospedar no meio d'elles, para que ali se acolha aquelle que ferir a alguma alma por erro.`,
    `Porém, se a ferir com instrumento de ferro, e morrer, homicida é: certamente o homicida morrerá.`,
    `Ou, se lhe atirar uma pedrada, de que possa morrer, e ella morrer, homicida é: certamente o homicida morrerá.`,
