...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    descricao: 'Comece pela Bíblia em 10 traduções — ARC, ARA, ACF, KJV, NVI, WEB e mais.',
    targetSelector: 'a[href="/biblia"]',
    position: 'bottom',
  },
  {
    id: 'estudar',
    titulo: 'Hub de Estudos',
    descricao: 'Pesquisa avançada, harmonia sinótica, léxico, referências cruzadas e muito mais.',
    targetSelector: 'a[href="/estudar"]',
    position: 'bottom',
  },
  {
    id: 'idiomas',
    titulo: 'Grego e Hebraico',
    descricao: '5.526 palavras gregas + 8.674 hebraicas com morfologia e Strong\'s — tudo grátis.',
