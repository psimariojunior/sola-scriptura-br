const data: Record<number, string[]> = {
  1: [
    ...
    `Ainda que Edom dizia: Empobrecidos somos, porém tornaremos a edificar os logares desertos: elles edificarão, e eu destruirei: e lhes chamarão; Termo de impiedade, e povo contra quem o Senhor está irado para sempre.`,
    `E os vossos olhos o verão, e direis: O Senhor seja engrandecido desde o termo de Israel.`,
    `O filho honrará a seu pae, e o servo ao seu senhor; e, se eu sou Pae, onde está a minha honra? e, se eu sou o Senhor, onde está o meu temor? diz o Senhor dos Exercitos a vós, ó sacerdotes, que desprezaes o meu nome; mas vós dizeis: Em que desprezámos nós o teu nome?`,
    ...
    `Porque, quando trazeis animal cego para o sacrificardes, não é isto mau? e, quando offereceis o côxo ou o enfermo, não é isto mau? Ora apresenta-o ao teu principe; porventura terá elle agrado em ti? ou acceitará elle a tua pessoa? diz o Senhor dos Exercitos.`,
    ...
    `Mas desde o nascente do sol até ao poente será grande entre as nações o meu nome; e em todo o logar se offerecerá ao meu nome incenso e uma oblação pura; porque o meu nome será grande entre as nações, diz o Senhor dos Exercitos`,
    `Mas vós o profanaes, quando dizeis: A mesa do Senhor é immunda, e, quanto ao seu rendimento, sua comida é desprezivel.`,
    `E dizeis: Eis aqui, que canceira! e o lançastes com desprezo, diz o Senhor dos Exercitos: vós tambem offereceis o roubado, e o côxo e o enfermo, e offereceis a offerta: ser-me-ha acceito isto de vossa mão? diz o Senhor.`,
  ...
  2: [
    ...
    `Se o não ouvirdes, e se não propozerdes no coração, dar honra ao meu nome, diz o Senhor dos Exercitos, enviarei a maldição contra vós, e amaldiçoarei as vossas bençãos; e tambem já tenho maldito a cada qual d'ellas, porque vós não pondes isso no coração.`,
    ...
    `Porque os labios do sacerdote guardarão a sciencia, e da sua bocca buscarão a lei, porque elle é o anjo do Senhor dos Exercitos.`,
    ...
    `E não fez elle sómente um? sobejando-lhe espirito? e porque sómente este um? buscava uma semente de Deus: portanto guardae-vos em vosso espirito, e contra a mulher da vossa mocidade nenhum seja desleal.`,
  ...
  3: [
    `Eis que eu envio o meu anjo, que apparelhará o caminho diante de mim; e de repente virá ao seu templo o Senhor, a quem vós buscaes, e o anjo do concerto, a quem vós desejaes; eis aqui que vem, diz o Senhor dos Exercitos.`,
    ...
    `E assentar-se-ha, affinando e purificando a prata; e purgará os filhos de Levi, e os affinará como oiro e como prata: então ao Senhor trarão offerta em justiça.`,
    `E a offerta de Judah e de Jerusalem será suave ao Senhor, como nos dias antigos, e como nos primeiros.`,
    `E chegar-me-hei a vós para juizo, e serei uma testemunha veloz contra os feiticeiros e contra os adulteros, e contra os que juram falsamente, e contra os que defraudam o jornaleiro em seu jornal, e a viuva, e o orphão, que pervertem o direito do estrangeiro, e não me temem, diz o Senhor dos Exercitos.`,
    ...
    `Trazei todos os dizimos á casa do thesouro, para que haja mantimento na minha casa, e provae-me n'isto, diz o Senhor dos Exercitos, se eu então não vos abrirei as janellas do céu, e não vasarei sobre vós uma benção até que não caiba mais.`,
    ...
    `E elles serão meus, diz o Senhor dos Exercitos, n'aquelle dia que farei me serão propriedade; poupal-os-hei, como um homem poupa a seu filho, que o serve.`,
  ...
  4: [
    ...
    `Lembrae-vos da lei de Moysés, meu servo, que lhe mandei em Horeb para todo o Israel, dos estatutos e juizos.`,
