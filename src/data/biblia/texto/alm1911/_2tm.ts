const data: Record<number, string[]> = {
  1: [
    ...
    `O qual nos salvou, e chamou com uma sancta vocação; não segundo as nossas obras, mas segundo o seu proprio proposito e graça que nos foi dada em Christo Jesus antes dos tempos dos seculos;`,
  ...
  4: [
    ...
    `Porque Démas me desamparou, amando o presente seculo, e foi para Thessalonica, Crescente para Galacia, Tito para Dalmacia.`,
