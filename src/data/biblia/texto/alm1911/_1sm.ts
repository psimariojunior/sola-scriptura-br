const data: Record<number, string[]> = {
  1: [
    `Houve um homem de Ramathaim de Zophim, da montanha de Ephraim, cujo nome era Elcana, filho de Jeroham, filho de Elihu, filho de Tohu, filho de Suph, ephrateo.`,
    `E este tinha duas mulheres: o nome d'uma era Anna, e o nome da outra Peninna: e Peninna tinha filhos, porém Anna não tinha filhos.`,
    `Subia pois este homem da sua cidade de anno em anno a adorar e a sacrificar ao Senhor dos Exercitos em Silo: e estavam ali os sacerdotes do Senhor, Hophni e Phineas, os dois filhos d'Eli.`,
    ...
    `E votou um voto, dizendo: Senhor dos Exercitos! se benignamente attenderes para a afflicção da tua serva, e de mim te lembrares, e da tua serva te não esqueceres, mas á tua serva deres um filho varão, ao Senhor o darei por todos os dias da sua vida, e sobre a sua cabeça não subirá navalha`,
    `E succedeu que, perseverando ella em orar perante o Senhor, Eli fez attenção á sua bocca.`,
    `Porquanto Anna no seu coração fallava, só se moviam os seus beiços, porém não se ouvia a sua voz: pelo que Eli a teve por embriagada.`,
    `E disse-lhe Eli: Até quando estarás tu embriagada? aparta de ti o teu vinho.`,
    `Porém Anna respondeu, e disse: Não, senhor meu, eu sou uma mulher attribulada de espirito; nem vinho nem bebida forte tenho bebido: porém tenho derramado a minha alma perante o Senhor.`,
    ...
    `E levantaram-se de madrugada, e adoraram perante o Senhor, e tornaram-se, e vieram á sua casa, a Rama, e Elcana conheceu a Anna, sua mulher, e o Senhor se lembrou d'ella.`,
    ...
    `E Elcana, seu marido, lhe disse: Faze o que bem te parecer em teus olhos, fica até que o desmames; tão sómente confirme o Senhor a sua palavra: assim ficou a mulher, e deu leite a seu filho, até que o desmamou.`,
    `E, havendo-o desmamado, o levou comsigo, com tres bezerros, e um epha de farinha, e um odre de vinho, e o trouxe á casa do Senhor, a Silo, e era o menino ainda muito creança.`,
    `E degolaram um bezerro: e assim trouxeram o menino a Eli.`,
    `E disse ella: Ah, meu senhor, viva a tua alma, meu senhor; eu sou aquella mulher que aqui esteve comtigo, para orar ao Senhor.`,
  ...
  2: [
    ...
    `Não ha sancto como é o Senhor; porque não ha outro fóra de ti: e rocha nenhuma ha como o nosso Deus.`,
    ...
    `Os fartos se alugaram por pão, e cessaram os famintos: até a esteril pariu sete filhos, e a que tinha muitos filhos enfraqueceu.`,
    ...
    `Tambem antes de queimarem a gordura vinha o moço do sacerdote, e dizia ao homem que sacrificava: Dá essa carne para assar ao sacerdote: porque não tomará de ti carne cozida, senão crua`,
    ...
    `E sua mãe lhe fazia uma tunica pequena, e de anno em anno lh'a trazia, quando com seu marido subia a sacrificar o sacrificio annual.`,
    `E Eli abençoava a Elcana e a sua mulher, e dizia: O Senhor te dê semente d'esta mulher, pela petição que fez ao Senhor. E voltaram para o seu logar.`,
    ...
    `Peccando homem contra homem, os juizes o julgarão; peccando porém o homem contra o Senhor, quem rogará por elle? Mas não ouviram a voz de seu pae, porque o Senhor os queria matar.`,
    ...
    `Portanto, diz o Senhor Deus d'Israel: Na verdade tinha dito eu que a tua casa e a casa de teu pae andariam diante de mim perpetuamente; porém agora diz o Senhor: Longe de mim tal coisa, porque aos que me honram honrarei, porém os que me desprezam serão envilecidos.`,
    `Eis que veem dias em que cortarei o teu braço e o braço da casa de teu pae, para que não haja mais velho algum em tua casa.`,
    ...
    `O homem porém que eu te não desarraigar do meu altar seria para vos consumir os olhos e para te entristecer a alma: e toda a multidão da tua casa morrerá quando chegar á edade varonil.`,
  ...
  3: [
    ...
    `E succedeu n'aquelle dia que, estando Eli deitado no seu locar (e os seus olhos se começavam já a escurecer, que não podia ver),`,
    `E estando tambem Samuel já deitado, antes que a lampada de Deus se apagasse no templo do Senhor, em que estava a arca de Deus,`,
    `O Senhor chamou a Samuel, e disse elle: Eis-me aqui.`,
    `E correu a Eli, e disse: Eis-me aqui, porque tu me chamaste. Mas elle disse: Não te chamei eu, torna a deitar-te. E foi e se deitou.`,
    ...
    `N'aquelle mesmo dia suscitarei contra Eli tudo quanto tenho fallado contra a sua casa: começal-o-hei e acabal-o-hei.`,
    ...
    `Portanto, jurei á casa d'Eli que nunca jámais será expiada a iniquidade da casa d'Eli com sacrificio nem com offerta de manjares.`,
    ...
    `E elle disse: Que é a palavra que te fallou? peço-te que m'a não encubras: assim Deus te faça, e outro tanto, se me encobrires alguma palavra de todas as palavras que te fallou.`,
    ...
    `E continuou o Senhor a apparecer em Silo: porquanto o Senhor se manifestava a Samuel em Silo pela palavra do Senhor.`,
  ],
  4: [
  ...
  5: [
    ...
    `Levantando-se porém de madrugada os d'Asdod, no dia seguinte, eis que Dagon estava caido com o rosto em terra diante da arca do Senhor: e tomaram a Dagon, e tornaram a pôl-o no seu logar.`,
    ...
    `Pelo que nem os sacerdotes de Dagon, nem nenhum de todos os que entram na casa de Dagon pisam o lumiar de Dagon em Asdod, até ao dia d'hoje.`,
    ...
    `Então enviaram a arca de Deus a Ekron. Succedeu porém que, vindo a arca de Deus a Ekron, os de Ekron exclamaram, dizendo: Transportaram para mim a arca do Deus de Israel, para me matarem, a mim e ao meu povo.`,
    `E enviaram, e congregaram a todos os principes dos philisteos, e disseram: Enviae a arca do Deus de Israel, e torne para o seu logar, para que não mate nem a mim nem ao meu povo. Porque havia mortal vexação em toda a cidade, e a mão de Deus muito se aggravara ali`,
  ...
  9: [
    ...
    `E perderam-se as jumentas de Kis, pae de Saul; pelo que disse Kis a Saul, seu filho: Toma agora comtigo um dos moços, e levanta-te e vae a buscar as jumentas.`,
    `Passou pois pela montanha de Ephraim, e d'ali passou á terra de Salisa, porém não as acharam: depois passaram á terra de Sahalim, porém tão pouco estavam ali: tambem passou á terra de Benjamin, porém tão pouco as acharam.`,
    `Vindo elles então á terra de Zuph, Saul disse para o seu moço, com quem elle ia: Vem, e voltemos; para que porventura meu pae não deixe de inquietar-se pelas jumentas e se afflija por causa de nós`,
    ...
    `E o moço tornou a responder a Saul, e disse: Eis que ainda se acha na minha mão um quarto d'um siclo de prata, o qual darei ao homem de Deus, para que nos mostre o caminho.`,
    `(Antigamente em Israel, indo qualquer consultar a Deus, dizia assim: Vinde, e vamos ao vidente: porque ao propheta de hoje antigamente se chamava vidente.)`,
    `Então disse Saul ao moço: Bem dizes, vem, pois, vamos. E foram-se á cidade onde estava o homem de Deus.`,
    ...
    `Entrando vós na cidade, logo o achareis, antes que suba ao alto para comer; porque o povo não comerá, até que elle venha; porque elle é o que abençoa o sacrificio, e depois comem os convidados: subi pois agora, que hoje o achareis.`,
    ...
    `Ámanhã a estas horas te enviarei um homem da terra de Benjamin, o qual ungirás por capitão sobre o meu povo de Israel, e elle livrará o meu povo da mão dos philisteos; porque tenho olhado para o meu povo; porque o clamor chegou a mim`,
    ...
    `E Samuel respondeu a Saul, e disse: Eu sou o vidente; sobe diante de mim ao alto, e comei hoje comigo; e pela manhã te despedirei, e tudo quanto está no teu coração, t'o declararei.`,
    ...
    `Então respondeu Saul, e disse: Porventura não sou eu filho de Benjamin, da mais pequena das tribus de Israel? e a minha familia a mais pequena de todas as familias da tribu de Benjamin? porque pois me fallas com similhantes palavras?`,
    `Porém Samuel tomou a Saul e ao seu moço, e os levou á camara; e deu-lhes logar a cima de todos os convidados, que eram uns trinta homens.`,
    `Então disse Samuel ao cozinheiro: Dá cá a porção que te dei, de que te disse: Pôe-n'a á parte comtigo.`,
    `Levantou pois o cozinheiro a espadoa, com o que havia n'ella, e pôl-a diante de Saul: e disse Samuel: Eis que isto é o sobejo; pôe-n'o diante de ti, e come; porque se guardou para ti para esta occasião, dizendo eu: Tenho convidado o povo. Assim comeu Saul aquelle dia com Samuel.`,
    `Então desceram do alto para a cidade; e fallou com Saul sobre o eirado.`,
    `E se levantaram de madrugada; e succedeu que, quasi ao subir da alva, chamou Samuel a Saul ao eirado, dizendo: Levanta-te, e despedir-te-hei. Levantou-se Saul, e sairam para fóra ambos, elle e Samuel.`,
    `E, descendo elles para a extremidade da cidade, Samuel disse a Saul: Dize ao moço que passe adiante de nós; (e passou) porém tu espera agora, e te farei ouvir a palavra de Deus.`,
  ],
  10: [
  ...
  11: [
    ...
    `E tomou um par de bois, e cortou-os em pedaços, e os enviou a todos os termos de Israel pelas mãos dos mensageiros, dizendo: Qualquer que não sair atraz de Saul e atraz de Samuel, assim se fará aos seus bois. Então caiu o temor do Senhor sobre o povo, e sairam como um só homem`,
    `E contou-os em Bezek: e houve dos filhos d'Israel trezentos mil, e dos homens de Judah trinta mil.`,
    `Então disseram aos mensageiros que vieram: Assim direis aos homens de Jabez-gilead: Amanhã, em aquecendo o sol, vos virá livramento. Vindo pois os mensageiros, e annunciando-o aos homens de Jabez, se alegraram.`,
    `E os homens de Jabez disseram: Ámanhã sairemos a vós; então nos fareis conforme a tudo o que parecer bem aos vossos olhos.`,
    `E succedeu que ao outro dia Saul poz o povo em tres companhias, e vieram ao meio do arraial pela vela da manhã, e feriram a Ammon, até que o dia aqueceu: e succedeu que os restantes se espalharam, que não ficaram dois d'elles juntos.`,
  ...
  12: [
    ...
    `Agora, pois, eis que o rei vae diante de vós, e já envelheci e encaneci, e eis que meus filhos estão comvosco, e eu tenho andado diante de vós desde a minha mocidade até ao dia de hoje`,
    `Eis-me aqui, testificae contra mim perante o Senhor, e perante o seu ungido, a quem o boi tomei, a quem o jumento tomei, e a quem defraudei, a quem tenho opprimido, e de cuja mão tenho tomado presente e com elle encobri os meus olhos, e vol-o restituirei.`,
    ...
    `E vendo vós que Nahas, rei dos filhos de Ammon, vinha contra vós, me dissestes: Não, mas reinará sobre nós um rei: sendo porém o Senhor vosso Deus, o vosso Rei.`,
    ...
    `Então invocou Samuel ao Senhor, e o Senhor deu trovões e chuva n'aquelle dia; pelo que todo o povo temeu em grande maneira ao Senhor e a Samuel.`,
  ...
  14: [
    ...
    `E entre os passos pelos quaes Jonathan procurava passar á guarnição dos philisteos, d'esta banda havia uma penha aguda, e da outra banda uma penha aguda: e era o nome de uma Bozez, e o nome da outra Senné.`,
    `Uma penha para o norte estava defronte de Michmas, e a outra para o sul defronte de Gibeah.`,
    `Disse pois Jonathan ao moço que lhe levava as armas: Vem, passemos á guarnição d'estes incircumcisos; porventura obrará o Senhor por nós, porque para com o Senhor nenhum impedimento ha de livrar com muitos ou com poucos.`,
    ...
    `E succedeu esta primeira desfeita, em que Jonathan e o seu pagem d'armas feriram até uns vinte homens, quasi no meio de uma geira de terra que uma junta de bois podia lavrar.`,
    ...
    `Tambem com os philisteos havia hebreos, como d'antes, que subiram com elles ao arraial em redor; e tambem estes se ajuntaram com os israelitas que estavam com Saul e Jonathan.`,
    ...
    `E estavam os homens d'Israel já exhaustos n'aquelle dia, porquanto Saul conjurou o povo, dizendo: Maldito o homem que comer pão até á tarde, para que me vingue de meus inimigos. Pelo que todo o povo se absteve de provar pão`,
    ...
    `Porém Jonathan não tinha ouvido quando seu pae conjurava o povo, e estendeu a ponta da vara que tinha na mão, e a molhou no favo de mel; e, tornando a mão á bocca, aclararam-se os seus olhos.`,
    ...
    `Disse mais Saul: Derramae-vos entre o povo, e dizei-lhes: Trazei-me cada um o seu boi, e cada um a sua ovelha, e degolae-os aqui, e comei, e não pequeis contra o Senhor, comendo com sangue. Então todo o povo trouxe de noite, cada um com a sua mão, o seu boi, e os degolaram ali.`,
    `Então edificou Saul um altar ao Senhor: este foi o primeiro altar que edificou ao Senhor.`,
    `Depois disse Saul: Desçamos de noite atraz dos philisteos, e despojemol-os, até que amanheça a luz, e não deixemos de resto um homem d'elles. E disseram: Tudo o que parecer bem aos teus olhos faze. Disse porém o sacerdote: Cheguemo-nos aqui a Deus`,
    ...
    `Porém o povo disse a Saul: Morrerá Jonathan, que obrou tão grande salvação em Israel? nunca tal succeda; vive o Senhor, que não lhe ha de cair no chão um só cabello da sua cabeça! pois com Deus fez isso hoje. Assim o povo livrou a Jonathan, para que não morresse.`,
    `E Saul deixou de seguir os philisteos: e os philisteos se foram ao seu logar.`,
    `Então tomou Saul o reino sobre Israel; e pelejou contra todos os seus inimigos em redor: contra Moab, e contra os filhos de Ammon, e contra Edom, e contra os reis de Zoba, e contra os philisteos, e para onde quer que se tornava executava castigos.`,
  ...
  15: [
    ...
    `Vae pois agora e fere a Amalek; e destroe totalmente a tudo o que tiver, e não lhe perdoes; porém matarás desde o homem até á mulher, desde os meninos até aos de mama, desde os bois até ás ovelhas, e desde os camelos até aos jumentos`,
    ...
    `E Saul e o povo perdoaram a Agag, e ao melhor das ovelhas e das vaccas, e ás da segunda sorte, e aos cordeiros e ao melhor que havia, e não os quizeram destruir totalmente: porém a toda a coisa vil e desprezivel detruiram totalmente.`,
    ...
    `E madrugou Samuel para encontrar a Saul pela manhã: e annunciou-se a Samuel, dizendo: Já chegou Saul ao Carmelo, e eis que levantou para si uma columna. Então fez volta, e passou e desceu e Gilgal.`,
    ...
    `E disse Saul: De Amalek as trouxeram; porque o povo perdoou ao melhor das ovelhas e das vaccas, para as offerecer ao Senhor teu Deus: o resto porém temos destruido totalmente.`,
    ...
    `Então disse Saul a Samuel: Antes dei ouvidos á voz do Senhor, e caminhei no caminho pelo qual o Senhor me enviou; e trouxe a Agag, rei de Amalek, e os amalekitas destrui totalmente;`,
    `Mas o povo tomou do despojo ovelhas e vaccas, o melhor do interdicto, para offerecer ao Senhor teu Deus em Gilgal.`,
    ...
    `Então disse Samuel: Trazei-me aqui a Agag, rei dos amalekitas. E Agag veiu a elle melindrosamente: e disse Agag: Na verdade já passou a amargura da morte.`,
  ...
  16: [
    `Então disse o Senhor a Samuel: Até quando terás dó de Saul, havendo-o eu rejeitado, para que não reine sobre Israel? enche o teu vaso d'azeite, e vem, enviar-te-hei a Jessé o beth-lehemita; porque d'entre os seus filhos me tenho provido de um rei.`,
    ...
    `Porém o Senhor disse a Samuel: Não attentes para a sua apparencia, nem para a altura da sua estatura, porque o tenho rejeitado, porque o Senhor não vê como vê o homem, pois o homem vê o que está diante dos olhos, porém o Senhor olha para o coração`,
    ...
    `Diga pois nosso senhor a seus servos, que estão em tua presença, que busquem um homem que saiba tocar harpa, e será que, quando o espirito mau da parte do Senhor vier sobre ti, então elle tocará com a sua mão, e te acharás melhor`,
    `Então disse Saul aos seus servos: Buscae-me pois um homem que toque bem, e trazei-m'o.`,
    `Então respondeu um dos mancebos, e disse: Eis que tenho visto a um filho de Jessé, o beth-lehemita, que sabe tocar, e é valente e animoso, e homem de guerra, e sisudo em palavras, e de gentil presença: o Senhor é com elle`,
  ...
  17: [
    ...
    `E David era filho de um homem, ephrateo, de Beth-lehem de Judah, cujo nome era Jessé, que tinha oito filhos: e nos dias de Saul era este homem já velho e adiantado na edade entre os homens.`,
    ...
    `E disse Jessé a David, seu filho: Toma, peço-te, para teus irmãos um epha d'este grão tostado e estes dez pães, e corre a leval-os ao arraial, a teus irmãos.`,
    `Porém estes dez queijos de leite leva ao chefe de mil; e visitarás a teus irmãos, a ver se lhes vae bem; e tomarás o seu penhor.`,
    `E estavam Saul, e elles, e todos os homens d'Israel no valle do carvalho, pelejando com os philisteos.`,
    `David então de madrugada se levantou pela manhã, e deixou as ovelhas a um guarda, e carregou-se, e partiu, como Jessé lhe ordenara: e chegou ao logar dos carros, quando já o arraial sahia em ordem de batalha, e a gritos chamavam á peleja.`,
    ...
    `E diziam os homens de Israel: Vistes aquelle homem que subiu? pois subiu para affrontar a Israel: ha de ser pois que o homem que o ferir o rei o enriquecerá de grandes riquezas, e lhe dará a sua filha, e fará franca a casa de seu pae em Israel.`,
    `Então fallou David aos homens que estavam com elle, dizendo: Que farão áquelle homem que ferir a este philisteo, e tirar a affronta de sobre Israel? quem é pois este incircumciso philisteo, para affrontar os exercitos do Deus vivo?`,
    ...
    `Disse mais David: O Senhor me livrou da mão do leão, e da do urso; elle me livrará da mão d'este philisteo. Então disse Saul a David: Vae-te embora, e o Senhor seja comtigo.`,
    ...
    `David porém disse ao philisteo: Tu vens a mim com espada, e com lança, e com escudo; porém eu venho a ti em nome do Senhor dos exercitos, o Deus dos exercitos de Israel, a quem tens affrontado.`,
    `Hoje mesmo o Senhor te entregará na minha mão, e ferir-te-hei, e te tirarei a cabeça, e os corpos do arraial dos philisteos darei hoje mesmo ás aves do céu e ás bestas da terra: e toda a terra saberá que ha Deus em Israel`,
    ...
    `Vendo porém Saul sair David a encontrar-se com o philisteo, disse a Abner, o chefe do exercito: De quem é filho este mancebo, Abner? E disse Abner: Vive a tua alma, ó rei, que o não sei`,
  ...
  19: [
    `E fallou Saul a Jonathan, seu filho, e a todos os seus servos, para que matassem a David. Porém Jonathan, filho de Saul, estava mui affeiçoado a David.`,
    ...
    `E sairei eu, e estarei á mão de meu pae no campo em que estiveres, e eu fallarei de ti a meu pae, e verei o que houver, e t'o annunciarei.`,
    `Então Jonathan fallou bem de David a Saul, seu pae, e disse-lhe: Não peque o rei contra seu servo David, porque elle não peccou contra ti, e porque os seus feitos te são mui bons.`,
    `Porque poz a sua alma na mão, e feriu aos philisteos, e fez o Senhor um grande livramento a todo o Israel; tu mesmo o viste, e te alegraste: porque, pois, peccarias contra o sangue innocente, matando a David sem causa?`,
    ...
    `Porém Saul mandou mensageiros á casa de David, que o guardassem, e o matassem pela manhã: do que Michal, sua mulher, avisou a David, dizendo: Se não salvares a tua vida esta noite, ámanhã te matarão.`,
    `Então Michal desceu a David por uma janella: e elle se foi, e fugiu, e escapou.`,
    `E Michal tomou uma estatua e a deitou na cama, e poz-lhe á cabeceira uma pelle de cabra, e a cobriu com uma coberta.`,
    ...
    `Assim David fugiu e escapou, e veiu a Samuel, a Rama, e lhe participou tudo quanto Saul lhe fizera: e foram, elle e Samuel, e ficaram em Naioth.`,
    ...
    `Então foi tambem elle mesmo a Rama, e chegou ao poço grande que estava em Secu; e, perguntando, disse: Onde estão Samuel e David? E disseram-lhe: Eis que estão em Naioth, em Rama.`,
    ...
    `E elle tambem despiu os seus vestidos, e elle tambem prophetizou diante de Samuel, e esteve nú por terra todo aquelle dia e toda aquella noite; pelo que se diz: Está tambem Saul entre os prophetas?`,
  ],
  20: [
  ...
  21: [
    ...
    `E respondeu David ao sacerdote, e lhe disse: Sim, em boa fé, as mulheres se nos vedaram desde hontem: e ante hontem, quando eu sahi, os vasos dos mancebos tambem eram sanctos: e em alguma maneira é pão commum, quanto mais que hoje se sanctificará outro nos vasos.`,
    ...
    `Faltam-me a mim doidos, para que trouxesseis a este que fizesse doidices diante de mim? ha de este entrar na minha casa?`,
  ],
  22: [
    ...
    `Para que todos vos tenhaes conspirado contra mim, e ninguem ha que me dê aviso de que meu filho tem feito alliança com o filho de Jessé, e nenhum d'entre vós ha que se dôa de mim, e m'o participe, pois meu filho tem contra mim sublevado a meu servo, para me armar ciladas, como se vê n'este dia.`,
    ...
    `Então David disse a Abiathar: Bem sabia eu n'aquelle dia que, estando ali Doeg, o idumeo, não deixaria de o denunciar a Saul: eu dei occasião contra todas as almas da casa de teu pae.`,
    `Fica comigo, não temas, porque quem procurar a minha morte tambem procurará a tua, pois estarás salvo comigo.`,
  ],
  23: [
  ...
  25: [
    `E falleceu Samuel, e todo o Israel se ajuntou, e o prantearam, e o sepultaram na sua casa, em Rama. E David, se levantou e desceu ao deserto de Paran.`,
    `E havia um homem em Maon, que tinha as suas possessões no Carmelo: e era este homem mui poderoso, e tinha tres mil ovelhas e mil cabras: e estava tosquiando as suas ovelhas no Carmelo.`,
    ...
    `Pergunta-o aos teus mancebos, e elles t'o dirão; estes mancebos pois achem graça em teus olhos, porque viemos em bom dia: dá pois a teus servos e a David, teu filho, o que achares á mão`,
    ...
    `Tomaria eu pois o meu pão, e a minha agua, e a carne das minhas rezes que degolei para os meus tosquiadores, e o daria a homens que eu não sei d'onde veem?`,
    ...
    `Pelo que disse David aos seus homens: Cada um cinja a sua espada. E cada um cingiu a sua espada, e cingiu tambem David a sua: e subiram após David uns quatrocentos homens, e duzentos ficaram com a bagagem.`,
    ...
    `Olha pois, agora, e vê o que has de fazer, porque já de todo determinado está o mal contra o nosso amo e contra toda a sua casa, e elle é um tal filho de Belial, que não ha quem lhe possa fallar.`,
    ...
    `Meu senhor, agora não faça este homem de Belial, a saber, Nabal, impressão no seu coração, porque tal é elle qual é o seu nome. Nabal é o seu nome, e a loucura está com elle, e eu, tua serva, não vi os mancebos de meu senhor, que enviaste.`,
    `Agora, pois, meu senhor, vive o Senhor, e vive a tua alma, que o Senhor te impediu de vires com sangue, e de que a tua mão te salvasse: e, agora, taes quaes Nabal sejam os teus inimigos e os que procuram mal contra o meu senhor.`,
    `E agora esta é a benção que trouxe a tua serva a meu senhor: dê-se aos mancebos que andam após das pisadas de meu senhor.`,
    `Perdôa pois á tua serva esta transgressão, porque certamente fará o Senhor casa firme a meu senhor, porque meu senhor guerreia as guerras do Senhor, e não se tem achado mal em ti por todos os teus dias`,
    `E, levantando-se algum homem para te perseguir, e para procurar a tua morte; comtudo a vida de meu senhor será atada no feixe dos que vivem com o Senhor teu Deus; porém a vida de teus inimigos se arrojará ao longe, como do meio do concavo de uma funda.`,
    ...
    `Então, meu senhor, não te será por tropeço, nem por pezar no coração, o sangue que sem causa derramaste, nem tão pouco o haver-se salvado meu senhor a si mesmo: e quando o Senhor fizer bem a meu senhor, lembra-te então da tua serva.`,
    ...
    `Porque, na verdade, vive o Senhor Deus d'Israel, que me impediu de que te fizesse mal, que se tu não te apressaras, e me não vieras ao encontro, não ficaria a Nabal pela luz da manhã nem mesmo um menino.`,
    ...
    `E, vindo Abigail a Nabal, eis que tinha em sua casa um banquete, como banquete de rei; e o coração de Nabal estava alegre n'elle, e elle já mui embriagado, pelo que não lhe deu a entender palavra alguma, pequena nem grande, até á luz da manhã`,
    ...
    `E, ouvindo David que Nabal morrera, disse: Bemdito seja o Senhor, que pleiteou o pleito da minha affronta da mão de Nabal, e deteve a seu servo do mal, fazendo o Senhor tornar o mal de Nabal sobre a sua cabeça. E mandou David fallar a Abigail, para tomal-a por sua mulher.`,
    ...
    `Então ella se levantou, e se inclinou com o rosto em terra, e disse: Eis aqui a tua serva servirá de creada para lavar os pés dos creados de meu senhor.`,
  ...
  26: [
    ...
    `E acampou-se Saul no outeiro d'Hachila, que está á entrada de Jesimon, junto ao caminho: porém David ficou no deserto, e viu que Saul vinha após d'elle ao deserto.`,
    ...
    `E respondeu David, e fallou a Achimelech, o hetheo, e a Abisai, filho de Zeruia, irmão de Jacob, dizendo: Quem descerá comigo a Saul ao arraial? E disse Abisai: Eu descerei comtigo.`,
    ...
    `Não é bom isto, que fizeste; vive o Senhor, que sois dignos de morte, vós que não guardastes a vosso senhor, o ungido do Senhor: vede pois agora onde está a lança do rei, e a bilha da agua, que tinha á sua cabeceira.`,
    ...
    `Ouve pois agora, te rogo, rei meu senhor, as palavras de teu servo: Se o Senhor te incita contra mim, cheire elle a offerta de manjares; porém se os filhos dos homens, malditos sejam perante o Senhor: pois elles me teem expellido hoje para que eu não fique apegado á herança do Senhor, dizendo: Vae, serve a outros deuses.`,
  ...
  27: [
    `Disse porém David no seu coração: Ora ainda algum dia perecerei pela mão de Saul; não ha coisa melhor para mim do que escapar apressadamente para a terra dos philisteos, para que Saul perca a esperança de mim, e cesse de me buscar por todos os termos de Israel; e assim escaparei da sua mão.`,
    ...
    `E disse David a Achis: Se eu tenho achado graça em teus olhos, dá-me logar n'uma das cidades da terra, para que ali habite: pois por que razão habitaria o teu servo comtigo na cidade real?`,
  ...
  30: [
    `Succedeu pois que, chegando David e os seus homens ao terceiro dia a Siclag, já os amalekitas com impeto tinham dado sobre o sul, e sobre Siclag, e tinham ferido a Siclag e a tinham queimado a fogo.`,
    ...
    `E David muito se angustiou, porque o povo fallava de apedrejal-o, porque o animo de todo o povo estava em amargura, cada um por causa dos seus filhos e das suas filhas: todavia David se esforçou no Senhor seu Deus.`,
    ...
    `E seguiu-os David, elle e os quatrocentos homens, pois que duzentos homens ficaram, por não poderem, de cançados que estavam, passar o ribeiro de Besor.`,
    ...
    `E, descendo, o guiou e eis que estavam espalhados sobre a face de toda a terra, comendo, e bebendo, e dançando, por todo aquelle grande despojo que tomaram da terra dos philisteos e da terra de Judah.`,
    ...
    `Tambem tomou David todas as ovelhas e vaccas, e levavam-n'as diante do outro gado, e diziam: Este é o despojo de David.`,
    `E, chegando David aos duzentos homens que, de cançados que estavam, não poderam seguir a David, e que deixaram ficar no ribeiro de Besor, estes sairam ao encontro de David e do povo que com elle vinha: e, chegando-se David ao povo, os saudou em paz.`,
    `Então todos os maus, e filhos de Belial, d'entre os homens que tinham ido com David, responderam, e disseram: Visto que não foram comnosco, não lhes daremos do despojo que libertámos; mas que leve cada um sua mulher e seus filhos, e se vá.`,
    ...
    `E, chegando David a Siclag, enviou do despojo aos anciãos de Judah, seus amigos, dizendo: Eis ahi para vós uma benção do despojo dos inimigos do Senhor;`,
  ...
  31: [
    ...
    `Então disse Saul ao seu pagem d'armas: Arranca a tua espada, e atravessa-me com ella, para que porventura não venham estes incircumcisos, e me atravessem e escarneçam de mim. Porém o seu pagem d'armas não quiz, porque temia muito: então Saul tomou a espada, e se lançou sobre ella.`,
