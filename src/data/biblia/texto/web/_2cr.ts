const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `even to prepare timber in abundance for me; for the house which I am about to build will be great and wonderful.`,
  ...
  14: [
    ...
    `Asa cried to the LORD his God, and said, “LORD, there is no one besides you to help, between the mighty and him who has no strength. Help us, LORD our God; for we rely on you, and in your name we have come against this multitude. LORD, you are our God. Don’t let man prevail against you.”`,
  ...
  15: [
    ...
    `They sacrificed to the LORD in that day, from the plunder which they had brought, seven hundred head of cattle and seven thousand sheep.`,
  ...
  20: [
    `After this, the children of Moab, the children of Ammon, and with them some of the Meunites, came against Jehoshaphat to battle.`,
  ...
  29: [
    ...
    `For our fathers were unfaithful, and have done that which was evil in the LORD our God’s sight, and have forsaken him, and have turned away their faces from the habitation of the LORD, and turned their backs.`,
