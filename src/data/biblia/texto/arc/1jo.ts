const data: Record<number, string[]> = {
  ...
  2: [
    ...
    "Amados, não vos escrevo um mandamento novo, mas o mandamento antigo, que desde o princípio tivestes. Este mandamento antigo é a palavra que desde o princípio ouvistes.",
    ...
    "Aquele que ama a seu irmão permanece na luz, e nele não há escândalo.",
    ...
    "Pais, escrevo-vos, porque conhecestes aquele que é desde o princípio. Jovens, escrevo-vos, porque vencestes o maligno. Meninos, escrevo-vos, porque conhecestes o Pai.",
    ...
    "Filhinhos, já é a última hora; e, como ouvistes que vem o anticristo, também agora muitos se têm feito anticristos; por onde conhecemos que é já a última hora.",
    "Saíram de nós, mas não eram de nós; porque, se fossem de nós, ficariam conosco; mas isso é para que se manifestasse que não são todos de nós.",
    "E vós tendes a unção do Santo e sabeis tudo.",
    "Não vos escrevi porque não saibais a verdade, mas porque a sabeis, e porque nenhuma mentira vem da verdade.",
  ...
  3: [
    ...
    "Quem comete o pecado é do diabo, porque o diabo peca desde o princípio. Para isso o Filho de Deus se manifestou: para desfazer as obras do diabo.",
    ...
    "Qualquer que aborrece a seu irmão é homicida; e vós sabeis que nenhum homicida tem a vida eterna permanente nele.",
    "Conhecemos o amor nisto: que ele deu a sua vida por nós, e nós devemos dar a vida pelos irmãos.",
    "Quem, pois, tiver bens do mundo e, vendo o seu irmão necessitado, lhe cerrar as suas entranhas, como permanecerá nele o amor de Deus?",
    "Meus filhinhos, não amemos de palavra, nem de língua, mas por obra e em verdade.",
    "E nisso conhecemos que somos da verdade, e diante dele asseguraremos nosso coração;",
  ...
  4: [
    ...
    "e todo espírito que não confessa que Jesus Cristo veio em carne não é de Deus; mas este é o espírito do anticristo, do qual já ouvistes que há de vir, e eis que já está no mundo.",
    "Filhinhos, sois de Deus e já os vencestes, porque maior é o que está em vós do que o que está no mundo.",
    ...
    "Ninguém nunca viu a Deus; se nos amamos uns aos outros, Deus está em nós, e em nós é perfeito o seu amor.",
  ...
  5: [
    "Todo aquele que crê que Jesus é o Cristo é nascido de Deus; e qualquer que ama ao que o gerou também ama ao que dele é gerado.",
    ...
    "Sabemos que todo aquele que é nascido de Deus não peca; mas o que de Deus é gerado guarda-se a si mesmo, e o maligno não lhe toca.",
    "Sabemos que somos de Deus e que todo o mundo está no maligno.",
    "E sabemos que já o Filho de Deus é vindo e nos deu entendimento para conhecermos o Verdadeiro; e no Verdadeiro estamos, isto é, em seu Filho Jesus Cristo. Este é o verdadeiro Deus e a vida eterna.",
