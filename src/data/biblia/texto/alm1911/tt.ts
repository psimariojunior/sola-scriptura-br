const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `Não pelas obras de justiça que houvessemos feito, mas segundo a sua misericordia, nos salvou pela lavagem da regeneração e da renovação do Espirito Sancto;`,
    ...
    `Fiel é a palavra, e isto quero que devéras affirmes, para que os que crêem em Deus procurem applicar-se ás boas obras; estas coisas são boas e proveitosas aos homens.`,
