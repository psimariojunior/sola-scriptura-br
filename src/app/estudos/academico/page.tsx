...
const ESTUDOS: EstudoAcademico[] = [
  {
    ...
    bibliografia: [
      { autor: 'Moo, Douglas J.', obra: 'The Epistle to the Romans', ano: 1996, editora: 'Eerdmans' },
      { autor: 'Dunn, James D.G.', obra: 'Romans 1-8', ano: 1988, editora: 'Word Books' },
      { autor: 'Wright, N.T.', obra: 'The Climax of the Covenant', ano: 1992, editora: 'Fortress Press' },
      { autor: 'Käsemann, Ernst', obra: 'Commentary on Romans', ano: 1980, editora: 'Fortress Press' },
      { autor: 'Schreiner, Thomas R.', obra: 'Romans', ano: 1998, editora: 'Baker Academic' },
      { autor: 'Cranfield, I.E.B.', obra: 'Romans ICC (2 vols.)', ano: 1975, editora: 'T&T Clark' },
    ],
    cor: 'from-amber-600/20 to-red-700/20',
  },
  {
    id: 'hermenutica-academico',
    titulo: 'Hermenêutica Avançada: Crítica Textual e Interpretação',
    ...
    objetivos: [
      'Classificar variantes textuais usando o sistema Aland-Black',
      'Aplicar os princípios da crítica externa (lectio difficilior, lectio brevior)',
      'Comparar as abordagens hermenêuticas (histórico-crítica, teológica, canônica, social)',
      'Avaliar criticamente a proposta de Gadamer sobre fusão de horizontes',
    ],
    bibliografia: [
      { autor: 'Aland, Kurt & Barbara', obra: 'The Text of the New Testament', ano: 1987, editora: 'Eerdmans' },
      { autor: 'Metzger, Bruce M.', obra: 'A Textual Commentary on the Greek NT', ano: 1994, editora: 'Deutsche Bibelgesellschaft' },
      { autor: 'Gadamer, Hans-Georg', obra: 'Verdade e Método', ano: 1960, editora: 'Vozes' },
      { autor: 'Thiselton, Anthony C.', obra: 'The New Hermeneutic of the New Testament', ano: 1980, editora: 'Fortress Press' },
      { autor: 'Sanders, E.P.', obra: 'Jesus and Judaism', ano: 1985, editora: 'Fortress Press' },
      { autor: 'Childs, Brevard S.', obra: 'The New Testament as Canon', ano: 1984, editora: 'Fortress Press' },
    ],
    cor: 'from-purple-600/20 to-indigo-700/20',
  },
  {
    ...
    objetivos: [
      'Articular as principais doutrinas cristãs com precisão terminológica',
      'Comparar as perspectivas reformada, arminiana, católica e oriental sobre cada doutrina',
      'Avaliar criticamente o debate contemporâneo (Open Theism, Nova Perspectiva)',
      'Citar fontes primárias (Confissões, Catecismos) e secundárias com precisão',
    ],
    bibliografia: [
      { autor: 'Bavinck, Herman', obra: 'Reformed Dogmatics (4 vols.)', ano: 2008, editora: 'Baker Academic' },
      { autor: 'Grudem, Wayne', obra: 'Systematic Theology', ano: 1994, editora: 'Zondervan' },
      { autor: 'Pannenberg, Wolfhart', obra: 'Systematic Theology (3 vols.)', ano: 1991, editora: 'Eerdmans' },
      { autor: 'Letham, Robert', obra: 'Systematic Theology', ano: 2019, editora: 'Crossway' },
      { autor: 'Kelly, J.N.D.', obra: 'Early Christian Doctrines', ano: 1958, editora: 'Harper & Row' },
    ],
    cor: 'from-amber-500/20 to-orange-500/20',
  },
  {
    id: 'hermeneutica-avancada',
    titulo: 'Hermenêutica (Nível Intermediário)',
  ...
  },
  {
    ...
    bibliografia: [
      ...
      { autor: 'Wallace, Daniel B.', obra: 'Gramática Grega Beyond the Basics', ano: 1996, editora: 'Zondervan' },
  ...
  },
  {
    ...
    titulo: 'Teologia Sistematizada (Nível Intermediário)',
  ...
  },
  {
    ...
    cor: 'from-indigo-500/20 to-violet-500/20',
  },
];
