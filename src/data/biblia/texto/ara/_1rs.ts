const data: Record<number, string[]> = {
  ...
  12: [
    ...
    `Tendo ouvido todo o Israel que Jeroboão tinha voltado, mandaram chamá-lo para a congregação e o fizeram rei sobre todo o Israel; ninguém seguiu a casa de Davi, senão somente a tribo de Judá.`,
  ...
  15: [
    ...
    `Trouxe à Casa do SENHOR as coisas consagradas por seu pai e as coisas que ele mesmo consagrara: prata, ouro e objetos de utilidade.`,
