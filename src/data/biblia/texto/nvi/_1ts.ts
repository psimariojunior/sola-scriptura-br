const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Irmãos, certamente vocês se lembram do nosso trabalho esgotante e da nossa fadiga; trabalhamos noite e dia para não sermos pesados a ninguém, enquanto pregávamos o evangelho de Deus a vocês.`,
    ...
    `Também agradecemos a Deus sem cessar o fato de que, ao receberem de nossa parte a palavra de Deus, vocês a aceitaram, não como palavra de homens, mas conforme ela verdadeiramente é, como palavra de Deus, que atua com eficácia em vocês, os que creem.`,
    `Porque vocês, irmãos, tornaram-se imitadores das igrejas de Deus em Cristo Jesus que estão na Judeia. Vocês sofreram da parte dos seus próprios conterrâneos as mesmas coisas que aquelas igrejas sofreram da parte dos judeus,`,
    `que mataram o Senhor Jesus e os profetas, e também nos perseguiram. Eles desagradam a Deus e são hostis a todos,`,
    `esforçando-se para nos impedir que falemos aos gentios , e estes sejam salvos. Dessa forma, continuam acumulando seus pecados. Sobre eles, finalmente , veio a ira.`,
  ...
  3: [
    ...
    `e, assim, enviamos Timóteo, nosso irmão e cooperador de Deus no evangelho de Cristo, para fortalecê-los e dar a vocês ânimo na fé,`,
  ...
  4: [
    `Quanto ao mais, irmãos, já os instruímos acerca de como viver a fim de agradar a Deus e, de fato, assim vocês estão procedendo. Agora pedimos e exortamos a vocês no Senhor Jesus que cresçam nisso cada vez mais.`,
    `Pois conhecem os mandamentos que demos a vocês pela autoridade do Senhor Jesus.`,
    ...
    `Neste assunto, ninguém prejudique seu irmão nem dele se aproveite. O Senhor castigará todas essas práticas, como já dissemos e asseguramos.`,
