const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Então disse o Senhor a Moysés: Estende a tua mão, e pega-lhe pela cauda, E estendeu sua mão, e pegou-lhe pela cauda, e tornou-se em vara na sua mão`,
    ...
    `Então disse Moysés ao Senhor: Ah Senhor! eu não sou homem que bem falla, nem de hontem nem de antehontem, nem ainda desde que tens fallado ao teu servo; porque sou pesado de bocca, e pesado de lingua.`,
    `E disse-lhe o Senhor: Quem fez a bocca do homem? ou quem fez o mudo, ou o surdo, ou o que vê, ou o cego? não sou eu, o Senhor?`,
    ...
    `Então Zippora tomou uma pedra aguda, e circumcidou o prepucio de seu filho, e o lançou a seus pés, e disse: Certamente me és um esposo sanguinario.`,
  ...
  6: [
    ...
    `Portanto dize aos filhos de Israel: Eu sou o Senhor, e vos tirarei de debaixo das cargas dos egypcios, e vos resgatarei com braço estendido e com juizos grandes.`,
  ...
  7: [
    ...
    `Pharaó pois não vos ouvirá; e eu porei minha mão sobre o Egypto, e tirarei meus exercitos, meu povo, os filhos de Israel, da terra do Egypto, com grandes juizos.`,
    ...
    `E Moysés era da edade de oitenta annos, e Aarão da edade de oitenta e tres annos, quando fallaram a Pharaó.`,
  ...
  8: [
    ...
    `E o rio creará rãs, que subirão e virão á tua casa, e ao teu dormitorio, e sobre a tua cama, e ás casas dos teus servos, e sobre o teu povo, e aos teus fornos, e ás tuas amassadeiras.`,
    ...
    `E Pharaó chamou a Moysés e a Aarão, e disse: Rogae ao Senhor que tire as rãs de mim e do meu povo; depois deixarei ir o povo, para que sacrifiquem ao Senhor.`,
    ...
    `Vendo pois Pharaó que havia descanço, aggravou o seu coração, e não os ouviu, como o Senhor tinha dito`,
    ...
    `E fizeram assim; porque Aarão estendeu a sua mão com a sua vara, e feriu o pó da terra, e havia muitos piolhos nos homens e no gado: todo o pó da terra se tornou em piolhos em toda a terra do Egypto.`,
    ...
    `Disse mais o Senhor a Moysés: Levanta-te pela manhã cedo, e põe-te diante de Pharaó; eis que elle sairá ás aguas, e dize-lhe: Assim diz o Senhor: Deixa ir o meu povo, para que me sirva`,
    ...
    `E n'aquelle dia eu separarei a terra de Goshen, em que meu povo habita, que n'ella não haja enxames de moscas, para que saibas que eu sou o Senhor no meio d'esta terra.`,
    `E porei separação entre o meu povo e o teu povo: ámanhã será este signal.`,
    `E o Senhor fez assim; e vieram grandes enxames de moscas á casa de Pharaó, e ás casas dos seus servos, e sobre toda a terra do Egypto: a terra foi corrompida d'estes enxames.`,
    `Então chamou Pharaó a Moysés e a Aarão, e disse: Ide, e sacrificae ao vosso Deus n'esta terra.`,
    `E Moysés disse: Não convem que façamos assim, porque sacrificariamos ao Senhor nosso Deus a abominação dos egypcios: eis que se sacrificassemos a abominação dos egypcios perante os seus olhos, não nos apedrejariam elles?`,
    ...
    `E Moysés disse: Eis que saio de ti, e orarei ao Senhor, que estes enxames de moscas se retirem ámanhã de Pharaó, dos seus servos, e do seu povo: sómente que Pharaó não mais me engane, não deixando ir a este povo para sacrificar ao Senhor.`,
  ...
  9: [
    ...
    `E tornar-se-ha em pó miudo sobre toda a terra do Egypto, e se tornará em sarna, que arrebente em ulceras nos homens e no gado, por toda a terra do Egypto.`,
    ...
    `Então disse o Senhor a Moysés: Levanta-te pela manhã cedo, e põe-te diante de Pharaó, e dize-lhe: Assim diz o Senhor, o Deus dos hebreos: Deixa ir o meu povo, para que me sirva;`,
    ...
    `Agora pois envia, recolhe o teu gado, e tudo o que tens no campo; todo o homem e animal, que fôr achado no campo, e não fôr recolhido á casa, a saraiva cairá sobre elles, e morrerão.`,
  ...
  12: [
    ...
    `Assim pois o comereis: os vossos lombos cingidos, os vossos sapatos nos pés, e o vosso cajado na mão: e o comereis apressadamente: esta é a paschoa do Senhor.`,
    `E eu passarei pela terra do Egypto esta noite, e ferirei todo o primogenito na terra do Egypto, desde os homens até aos animaes; e em todos os deuses do Egypto farei juizos, Eu sou o Senhor.`,
    `E aquelle sangue vos será por signal nas casas em que estiverdes; vendo eu sangue, passarei por cima de vós, e não haverá entre vós praga de mortandade, quando eu ferir a terra do Egypto.`,
    ...
    `Porque o Senhor passará para ferir aos egypcios, porém quando vir o sangue na lumieira da porta, e em ambas as umbreiras, o Senhor passará aquella porta, e não deixará ao destruidor entrar em vossas casas, para vos ferir.`,
    ...
    `Então direis: Este é o sacrificio da paschoa ao Senhor, que passou as casas dos filhos d'Israel no Egypto, quando feriu aos egypcios, e livrou as nossas casas. Então o povo inclinou-se, e adorou.`,
    `E foram os filhos d'Israel, e fizeram isso; como o Senhor ordenara a Moysés e a Aarão, assim fizeram.`,
    `E aconteceu, á meia noite, que o Senhor feriu a todos os primogenitos na terra do Egypto, desde o primogenito de Pharaó, que se sentava em seu throno, até ao primogenito do captivo que estava no carcere, e todos os primogenitos dos animaes.`,
    ...
    `E os egypcios apertavam ao povo, apressando-se para lançal-os da terra; porque diziam: Todos somos mortos.`,
  ...
  13: [
    ...
    `E acontecerá que, quando o Senhor te houver mettido na terra dos cananeos, e dos hetheos, e dos amorrheos, e dos heveos, e dos jebuzeos, a qual jurou a teus paes que t'a daria, terra que mana leite e mel, guardarás este culto n'este mez.`,
    ...
    `Porém tudo o que abrir a madre da jumenta, resgatarás com cordeiro; e se o não resgatares cortar-lhe-has a cabeça: mas todo o primogenito do homem entre teus filhos resgatarás.`,
    ...
    `Porque succedeu que, endurecendo-se Pharaó, para não nos deixar ir, o Senhor matou todos os primogenitos na terra do Egypto, do primogenito do homem até ao primogenito dos animaes: por isso eu sacrifico ao Senhor os machos de tudo que abre a madre; porém a todo o primogenito de meus filhos eu resgato.`,
    `E será por signal sobre tua mão, e por frontaes entre os teus olhos; porque o Senhor nos tirou do Egypto com mão forte.`,
    `E aconteceu, que quando Pharaó deixou ir o povo, Deus não os levou pelo caminho da terra dos philisteos, que estava mais perto; porque Deus disse: Para que porventura o povo não se arrependa, vendo a guerra, e se tornem ao Egypto.`,
  ...
  16: [
    `E partidos de Elim, toda a congregação dos filhos d'Israel veiu ao deserto de Sin, que está entre Elim e Sinai, aos quinze dias do mez segundo, depois que sairam da terra do Egypto.`,
    ...
    `Disse mais Moysés: Isso será quando o Senhor á tarde vos der carne para comer, e pela manhã pão a fartar, porquanto o Senhor ouviu as vossas murmurações, com que murmuraes contra elle: porque, quem somos nós? As vossas murmurações não são contra nós, mas sim contra o Senhor.`,
    ...
    `Esta é a palavra que o Senhor tem mandado: Colhei d'elle cada um conforme ao que pode comer, um gomer por cada cabeça, segundo o numero das vossas almas; cada um tomará para os que se acharem na sua tenda.`,
    ...
    `E elle disse-lhes: Isto é o que o Senhor tem dito: Amanhã é repouso, do sancto sabbado do Senhor: o que quizerdes cozer no forno, cozei-o, e o que quizerdes cozer em agua, cozei-o em agua; e tudo o que sobejar, para vós ponde em guarda até ámanhã.`,
    ...
    `Vêde, porquanto o Senhor vos deu o sabbado, portanto elle no sexto dia vos dá pão para dois dias; cada um fique no seu logar, que ninguem saia do seu logar no setimo dia.`,
    ...
    `E disse Moysés: Esta é a palavra que o Senhor tem mandado: Encherás um gomer d'elle em guarda para as vossas gerações, para que vejam o pão que vos tenho dado a comer n'este deserto, quando eu vos tirei da terra do Egypto.`,
  ...
  17: [
    `Depois toda a congregação dos filhos d'Israel partiu do deserto de Sin pelas suas jornadas, segundo o mandamento do Senhor, e acamparam em Rephidim; e não havia ali agua para o povo beber.`,
    ...
    `Porém as mãos de Moysés eram pesadas, por isso tomaram uma pedra, e a pozeram debaixo d'elle, para assentar-se sobre ella: e Aarão e Hur sustentaram as suas mãos, um d'uma banda, e o outra da outra: assim ficaram as suas mãos firmes até que o sol se poz`,
  ...
  18: [
    ...
    `Vindo pois Jethro, o sogro de Moysés, com seus filhos e com sua mulher, a Moysés no deserto, ao monte de Deus, onde se tinha acampado,`,
    `Disse a Moysés: Eu, teu sogro Jethro, venho a ti, com tua mulher, e seus dois filhos com ella.`,
    `Então saiu Moysés ao encontro de seu sogro, e inclinou-se, e beijou-o, e perguntaram um ao outro como estavam, e entraram na tenda.`,
    ...
    `Vendo pois o sogro de Moysés tudo o que elle fazia ao povo, disse: Que é isto, que tu fazes as povo? porque te assentas só, e todo o povo está em pé diante de ti, desde a manhã até á tarde?`,
    ...
    `Totalmente desfallecerás, assim tu, como este povo que está comtigo: porque este negocio é mui difficil para ti; tu só não o podes fazer.`,
    ...
    `Para que julguem este povo em tempo; e seja que todo o negocio pequeno elles o julguem: assim a ti mesmo te alliviarás da carga, e elles a levarão comtigo.`,
    ...
    `E escolheu Moysés homens capazes, de todo o Israel, e os poz por cabeças sobre o povo: maioraes de mil, maioraes de cento, maioraes de cincoenta, e maioraes de dez.`,
  ...
  28: [
    `Depois tu farás chegar a ti teu irmão Aarão, e seus filhos com elle, do meio dos filhos de Israel, para me administrarem o officio sacerdotal: a saber, Aarão, Nadab e Abihu, Eleazar e Ithamar, os filhos de Aarão.`,
    ...
    `Estes pois são os vestidos que farão: um peitoral, e um ephod, e um manto, e uma tunica bordada, uma mitra, e um cinto: farão pois sanctos vestidos a Aarão teu irmão, e a seus filhos, para me administrarem o officio sacerdotal.`,
    ...
    `Conforme á obra do lapidario, como o lavor de sêllos lavrarás estas duas pedras, com os nomes dos filhos de Israel: engastadas ao redor em oiro as farás.`,
    ...
    `Farás tambem o peitoral do juizo de obra esmerada, conforme á obra do ephod o farás: de oiro, de azul, e de purpura, e de carmezim, e de linho fino torcido o farás.`,
    ...
    `E ligarão o peitoral com os seus anneis aos anneis do ephod por cima com um cordão d'azul, para que esteja sobre o cinto d'obra esmerada do ephod; e nunca se separará o peitoral do ephod.`,
    ...
    `Tambem porás no peitoral do juizo Urim e Thummim, para que estejam sobre o coração de Aarão, quando entrar diante do Senhor: assim Aarão levará o juizo dos filhos de Israel sobre o seu coração diante do Senhor continuamente.`,
    ...
    `E estarão sobre Aarão e sobre seus filhos, quando entrarem na tenda da congregação, ou quando chegarem ao altar para ministrar no sanctuario, para que não levem iniquidade, e morram; isto será estatuto perpetuo para elle e para a sua semente depois d'elle.`,
  ],
  29: [
    ...
    `E os cingirás com o cinto, a Aarão e a seus filhos, e lhes atarás as tiaras, para que tenham o sacerdocio por estatuto perpetuo, e sagrarás a Aarão e a seus filhos;`,
    ...
    `Depois tomarás do carneiro a gordura, e a cauda, e a gordura que cobre as entranhas, e o redenho do figado, e ambos os rins com a gordura que houver n'elles, e o hombro direito, porque é carneiro das consagrações;`,
    ...
    `E será para Aarão e para seus filhos por estatuto perpetuo dos filhos d'Israel, porque é offerta alçada: e a offerta alçada será dos filhos d'Israel dos seus sacrificios pacificos; a sua offerta alçada será para o Senhor.`,
    `E os vestidos sanctos, que são d'Aarão, serão de seus filhos depois d'elle, para serem ungidos n'elles e para sagral-os n'elles.`,
    ...
    `Tambem cada dia prepararás um novilho por sacrificio pelo peccado para as expiações, e expiarás o altar, fazendo expiação sobre elle; e o ungirás para sanctifical-o.`,
  ...
  30: [
    ...
    `Fallou mais o Senhor a Moysés, dizendo:`,
    `Quando tomares a somma dos filhos d'Israel, conforme á sua conta, cada um d'elles dará ao Senhor o resgate da sua alma, quando os contares; para que não haja entre elles praga alguma, quando os contares.`,
    ...
    `Quando entrarem na tenda da congregação, lavar-se-hão com agua, para que não morram, ou quando se chegarem ao altar para ministrar, para accender a offerta queimada ao Senhor.`,
    ...
    `Tambem ungirás a Aarão e seus filhos, e os sanctificarás para me administrarem o sacerdocio.`,
  ...
  33: [
    `Disse mais o Senhor a Moysés: Vae, sobe d'aqui, tu e o povo que fizeste subir da terra do Egypto, á terra que jurei a Abrahão, a Isaac, e a Jacob, dizendo: Á tua semente a darei.`,
    ...
    `Porquanto o Senhor tinha dito a Moysés: Dize aos filhos de Israel: Povo obstinado és; se um momento subir no meio de ti, te consumirei: porém agora tira de ti os teus atavios, para que eu saiba o que te hei de fazer.`,
    ...
    `E aconteceu que, saindo Moysés á tenda, todo o povo se levantava, e cada um ficou em pé á porta da sua tenda: e olhavam para Moysés pelas costas, até elle entrar na tenda`,
    ...
    `E fallava o Senhor a Moysés cara a cara, como qualquer falla com o seu amigo: depois tornou-se ao arraial; mas o seu servidor Josué, filho de Nun, mancebo, nunca se apartava do meio da tenda.`,
    ...
    `Como pois se saberá agora que tenho achado graça aos teus olhos, eu e o teu povo? acaso não é n'isso que andas tu comnosco? assim separados seremos, eu e o teu povo, de todo o povo que ha sobre a face da terra.`,
    ...
    `Porém elle disse: Eu farei passar toda a minha bondade por diante de ti, e apregoarei o nome do Senhor diante de ti; e terei misericordia de quem tiver misericordia, e me compadecerei de quem me compadecer.`,
