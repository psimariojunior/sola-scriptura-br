const data: Record<number, string[]> = {
  1: [
    ...
    `à igreja de Deus que está em Corinto, aos santificados em Cristo Jesus e chamados para serem santos, com todos os que, em toda parte, invocam o nome de nosso Senhor Jesus Cristo, Senhor deles e nosso:`,
  ...
  4: [
    ...
    `Porque me parece que Deus nos pôs a nós, os apóstolos, em último lugar, como condenados à morte. Viemos a ser um espetáculo para o mundo, tanto diante de anjos como de homens.`,
  ...
  7: [
    ...
    `Estou dizendo isso para o próprio bem de vocês; não para lhes impor restrições, mas para que possam viver de maneira correta, em plena consagração ao Senhor.`,
  ...
  9: [
    ...
    `Essa é minha defesa diante daqueles que me julgam.`,
    ...
    `Se outros têm direito de ser sustentados por vocês, não o temos nós ainda mais? Mas nós nunca usamos desse direito. Ao contrário, suportamos tudo para não pôr obstáculo algum ao evangelho de Cristo.`,
  ...
  11: [
    ...
    `Quero, porém, que entendam que o cabeça de todo homem é Cristo, o cabeça da mulher é o homem e o cabeça de Cristo é Deus.`,
    ...
    `Será que vocês não têm casa onde comer e beber? Ou desprezam a igreja de Deus e humilham os que nada têm? Que direi? Eu os elogiarei por isso? Certamente que não!`,
    `Pois recebi do Senhor o que também entreguei a vocês: Que o Senhor Jesus, na noite em que foi traído, tomou o pão`,
    ...
    `Se alguém estiver com fome, coma em casa, para que, quando vocês se reunirem, isso não resulte em condenação. Quanto ao mais, quando eu fordarei instruções a vocês.`,
  ],
  12: [
  ...
  14: [
    ...
    `Assim, se toda a igreja se reunir e falar em línguas e alguns não instruídos ou descrentes entrarem, não dirão que vocês estão loucos?`,
  ...
  16: [
    ...
    `Quanto ao irmão Apolo, insisti para que fosse com os irmãos visitar vocês. Ele não quis de modo nenhum ir agora, mas irá quando tiver boa oportunidade.`,
    ...
    `As igrejas da província da Ásia enviam saudações. Áquila e Priscila os saúdam afetuosamente no Senhor, e também a igreja que se reúne na casa deles.`,
