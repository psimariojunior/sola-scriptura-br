const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Porque o Senhor tornará a excellencia de Jacob como a excellencia de Israel; porque os que despejam os vazaram, e corromperam os seus sarmentos.`,
    ...
    `Eis que eu estou contra ti, diz o Senhor dos exercitos, e queimarei no fumo os seus carros, e a espada devorará os teus leõesinhos, e arrancarei da terra a tua preza, e não se ouvirá mais a voz dos teus embaixadores.`,
  ],
  3: [
