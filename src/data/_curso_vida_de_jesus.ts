...
export const CURSO_VIDA_DE_JESUS: Curso = {
  ...
  descrição: 'Curso introdutório: do nascimento à ascensão, com os quatro evangelhos. Vídeos de panorama (BibleProject e fontes já usadas no site) + texto. Não é harmonia acadêmica nem carga horária.',
  ...
  módulos: [
      ...
      aulas: [
        {
          ...
          videoTítulo: 'Evangelho de Lucas – BibleProject Português',
      ...
      aulas: [
        {
          ...
          videoTítulo: 'Evangelho de Mateus – BibleProject Português',
    ...
    },
    {
      ...
      aulas: [
        ...
        },
        {
          ...
          videoTítulo: 'O julgamento e a morte de Jesus — fonte já usada no curso dos Evangelhos',
    ...
    },
    {
      id: 'mod-jesus-quiz',
      título: 'Avaliação',
      descrição: 'Quiz de introdução à vida de Jesus — 70% para contar a aula',
      ícone: '🏆',
      aulas: [
        {
          id: 'aula-jesus-quiz-final',
          título: 'Avaliação — Vida de Jesus (introdução)',
          tipo: 'quiz',
          duração: '12 min',
          perguntas: [
            {
              id: 'vj-q1',
              pergunta: 'Lucas 1:35 atribui a concepção de Jesus a:',
              opções: ['José, o carpinteiro', 'O Espírito Santo e o poder do Altíssimo', 'Um decreto de Herodes', 'A adoção no templo'],
              respostaCorreta: 1,
              explicação: 'O anjo diz a Maria que o Espírito Santo virá sobre ela; o santo que nascer será chamado Filho de Deus.',
            },
            {
              id: 'vj-q2',
              pergunta: 'O censo de Lucas 2:1 foi decretado por:',
              opções: ['César Augusto', 'César Agostinho', 'Pôncio Pilatos', 'Herodes Agripa'],
              respostaCorreta: 0,
              explicação: 'O texto fala de César Augusto. O decreto levou José e Maria a Belém (Mq 5:2).',
            },
            {
              id: 'vj-q3',
              pergunta: 'No batismo de Jesus (Mateus 3:16–17) vemos:',
              opções: ['Só o Filho, sem o Pai', 'Pai, Filho e Espírito Santo juntos', 'Apenas João Batista pregando', 'A transfiguração'],
              respostaCorreta: 1,
              explicação: 'O Filho na água, o Espírito como pomba, a voz do Pai: evento trinitário.',
            },
            {
              id: 'vj-q4',
              pergunta: 'Nas tentações (Mateus 4), Jesus responde a Satanás principalmente com:',
              opções: ['Milagres', 'Citações de Deuteronômio', 'O Sermão da Montanha', 'Silêncio'],
              respostaCorreta: 1,
              explicação: 'Três vezes «está escrito», todas de Deuteronômio.',
            },
            {
              id: 'vj-q5',
              pergunta: 'Mateus 5:17 diz que Jesus veio para:',
              opções: ['Abolir a Lei e os Profetas', 'Cumprir a Lei e os Profetas', 'Substituir Moisés por César', 'Acabar com o templo no mesmo dia'],
              respostaCorreta: 1,
              explicação: 'Não veio destruir, mas cumprir.',
            },
            {
              id: 'vj-q6',
              pergunta: 'João 20:30–31 diz que os sinais foram escritos para que:',
              opções: ['Roma se converta por medo', 'Creiais que Jesus é o Cristo, o Filho de Deus', 'Os fariseus ganhem debates', 'Se prove a genealogia de José'],
              respostaCorreta: 1,
              explicação: 'O propósito do Evangelho de João é a fé no Filho de Deus.',
            },
            {
              id: 'vj-q7',
              pergunta: 'Em Mateus 26:39, no Getsêmani, Jesus pede:',
              opções: ['Que os discípulos lutem', 'Que o cálice passe, mas que se faça a vontade do Pai', 'Que Judas seja perdoado na hora', 'Que o templo caia'],
              respostaCorreta: 1,
              explicação: 'Submissão: «não seja como eu quero, mas como tu queres».',
            },
            {
              id: 'vj-q8',
              pergunta: 'Mateus 27:51 (o véu rasgado) aponta sobretudo para:',
              opções: ['Um terremoto só geológico', 'O caminho aberto a Deus pelo sacrifício de Cristo', 'A destruição de Roma', 'O fim da oração'],
              respostaCorreta: 1,
              explicação: 'O véu do Santo dos Santos rasga-se: acesso a Deus em Cristo.',
            },
            {
              id: 'vj-q9',
              pergunta: '1 Coríntios 15:14 ensina que, se Cristo não ressuscitou:',
              opções: ['A fé ainda vale como metáfora', 'Vã é a pregação e vã é a fé', 'Só o Antigo Testamento importa', 'Os milagres bastam'],
              respostaCorreta: 1,
              explicação: 'A ressurreição é o fundamento, não um detalhe opcional.',
            },
            {
              id: 'vj-q10',
              pergunta: 'Este curso, neste site, é:',
              opções: ['Harmonia acadêmica com carga horária', 'Introdução à vida de Jesus, com aulas e quiz na plataforma', 'Diploma de seminário', 'Ordenação pastoral'],
              respostaCorreta: 1,
              explicação: 'O certificado atesta a conclusão introdutória nesta plataforma.',
            },
          ],
        },
      ],
