const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `E entre os sacerdotes: os descendentes de Habaías, Hacoz e Barzilai, homem que se casou com uma filha de Barzilai, de Gileade, e que era chamado pelo nome do sogro.`,
  ...
  4: [
    ...
    `Pagaram alguns funcionários para que se opusessem ao povo e frustrassem o seu plano. E fizeram isso durante todo o reinado de Ciro até o reinado de Dario, reis da Pérsia.`,
    ...
    `Informamos ao rei que, se essa cidade for reconstruída e seus muros reparados, nada sobrará a oeste do Eufrates”.`,
  ...
  8: [
    ...
    `Pesei e entreguei-lhes vinte e dois mil e setecentos e cinquenta quilos de prata, três toneladas e meia de utensílios de prata, três toneladas e meia de ouro,`,
    ...
    `No quarto dia, no templo do nosso Deus, pesamos a prata, o ouro e os utensílios sagrados, e os demos a Meremote, filho do sacerdote Urias. Estavam com ele Eleazar, filho de Fineias, e os levitas Jozabade, filho de Jesua, e Noadias, filho de Binui.`,
  ...
  10: [
    ...
    `Que os nossos líderes decidam por toda a assembleia. Depois, que cada homem de nossas cidades que se casou com mulher estrangeira venha numa data marcada, acompanhado dos líderes e juízes de cada cidade, para que se afaste de nós o furor da ira de nosso Deus por causa desse pecado”.`,
    ...
    `Entre os descendentes dos sacerdotes, estes foram os que se casaram com mulheres estrangeiras: Entre os descendentes de Jesua, filho de Jozadaque, e de seus irmãos: Maaseias, Eliézer, Jaribe e Gedalias.`,
    ...
    `Entre os descendentes de Imer: Hanani e Zebadias.`,
    `Entre os descendentes de Harim: Maaseias, Elias, Semaías, Jeiel e Uzias.`,
    `Entre os descendentes de Pasur: Elioenai, Maaseias, Ismael, Natanael, Jozabade e Eleasa.`,
    ...
    `E entre os outros israelitas: Entre os descendentes de Parós: Ramias, Jezias, Malquias, Miamim, Eleazar, Malquias e Benaia.`,
    `Entre os descendentes de Elão: Matanias, Zacarias, Jeiel, Abdi, Jeremote e Elias.`,
    `Entre os descendentes de Zatu: Elioenai, Eliasibe, Matanias, Jeremote, Zabade e Aziza.`,
    `Entre os descendentes de Bebai: Joanã, Hananias, Zabai e Atlai.`,
    `Entre os descendentes de Bani: Mesulão, Maluque, Adaías, Jasube, Seal e Jeremote.`,
    `Entre os descendentes de Paate-Moabe: Adna, Quelal, Benaia, Maaseias, Matanias, Bezalel, Binui e Manassés.`,
    `Entre os descendentes de Harim: Eliézer, Issias, Malquias, Semaías, Simeão,`,
    ...
    `Entre os descendentes de Binui: Simei,`,
    `Selemias, Natã, Adaías,`,
    `Macnadbai, Sasai, Sarai,`,
    `Azareel, Selemias, Semarias,`,
    `Salum, Amarias e José.`,
    `Entre os descendentes de Nebo: Jeiel, Matitias, Zabade, Zebina, Jadai, Joel e Benaia.`,
