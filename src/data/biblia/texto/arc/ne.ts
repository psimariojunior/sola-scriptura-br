const data: Record<number, string[]> = {
  ...
  3: [
    ...
    `E a Porta do Peixe edificaram os filhos de Hassenaá, a qual emadeiraram, e levantaram as suas portas com as suas fechaduras e os seus ferrolhos.`,
    ...
    `Depois dele, repararam os levitas, Reum, filho de Bani, e, ao seu lado, reparou Hasabias, maioral da metade de Queila, no seu distrito.`,
    `Depois dele, repararam seus irmãos: Bavai, filho de Henadade, maioral da outra meia parte de Queila;`,
    `ao seu lado, reparou Ezer, filho de Jesua, maioral de Mispa, outra porção, defronte da subida para a casa das armas, à esquina.`,
  ...
  10: [
    ...
    `para os pães da proposição, e para a contínua oferta de manjares, e para o contínuo holocausto dos sábados, das luas novas, e para as festas solenes, e para as coisas sagradas, e para os sacrifícios pelo pecado, para reconciliar a Israel, e para toda a obra da Casa do nosso Deus.`,
  ...
  11: [
    ...
    `E Petaías, filho de Mesezabel, dos filhos de Zerá, filho de Judá, estava à mão do rei, em todos os negócios do povo.`,
