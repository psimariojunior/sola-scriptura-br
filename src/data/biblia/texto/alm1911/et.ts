const data: Record<number, string[]> = {
  1: [
    `E succedeu nos dias de Assuero (este é aquelle Assuero que reinou desde a India até Ethiopia, sobre cento e vinte e sete provincias):`,
    `N'aquelles dias, assentando-se o rei Assuero sobre o throno do seu reino, que está na fortaleza de Susan,`,
    `No terceiro anno do seu reinado, fez um convite a todos os seus principes e seus servos (o poder da Persia e Media e os maiores senhores das provincias estavam perante elle),`,
    ...
    `As tapeçarias eram de branco, verde, e azul celeste, pendentes de cordões de linho fino e purpura, e argolas de prata, e columnas de marmore: os leitos d'oiro e de prata, sobre um pavimento de porphyro, e de marmore, e d'alabastro, e de pedras preciosas.`,
    ...
    `E ao setimo dia, estando já o coração do rei alegre do vinho, mandou a Mehuman, Biztha, Harbona, Bigtha, e Abagtha, Zethar, e a Carchas, os sete eunuchos que serviam na presença do rei Assuero,`,
    ...
    `Então disse Memuchan na presença do rei e dos principes: Não sómente peccou contra o rei a rainha Vasthi, porém tambem contra todos os principes, e contra todos os povos que ha em todas as provincias do rei Assuero.`,
    `Porque a noticia d'este feito da rainha sairá a todas as mulheres, de modo que desprezarão a seus maridos aos seus olhos quando se disser: Mandou o rei Assuero que introduzissem á sua presença a rainha Vasthi, porém ella não veiu.`,
    ...
    `Se bem parecer ao rei, saia da sua parte um edicto real, e escreva-se nas leis dos persas e dos medos, e não se quebrante, a saber: que Vasthi não entre mais na presença do rei Assuero, e o rei dê o reino d'ella á sua companheira que seja melhor do que ella`,
    ...
    `Então enviou cartas a todas as provincias do rei, a cada provincia segundo a sua escriptura, e a cada povo segundo a sua lingua: que cada homem fosse senhor em sua casa, e que se publicasse conforme á lingua do seu povo.`,
  ],
  2: [
    ...
    `Então disseram os mancebos do rei, que lhe serviam: Busquem-se para o rei moças virgens, formosas á vista.`,
    `E ponha o rei commissarios em todas as provincias do seu reino, que ajuntem a todas as moças virgens, formosas á vista, na fortaleza de Susan, na casa das mulheres, debaixo da mão d'Hegai, eunucho do rei, guarda das mulheres, e dêem-se-lhes os seus enfeites.`,
    ...
    `Este criara a Hadassa (que é Esther, filha de seu tio), porque não tinha pae nem mãe: e era moça bella de parecer, e formosa á vista; e, morrendo seu pae e sua mãe, Mardoqueo a tomara por sua filha`,
    `Succedeu pois que, divulgando-se o mandado do rei e a sua lei, e ajuntando-se muitas moças na fortaleza de Susan, debaixo da mão d'Hegai, tambem levaram Esther á casa do rei, debaixo da mão d'Hegai, guarda das mulheres.`,
    `E a moça pareceu formosa aos seus olhos, e alcançou graça perante elle; pelo que se apressurou com os seus enfeites, e em lhe dar os seus quinhões, como tambem em lhe dar sete moças de respeito da casa do rei: e a fez passar com as suas moças ao melhor logar da casa das mulheres.`,
    ...
    `E, chegando já a vez de cada moça, para vir ao rei Assuero, depois que fôra feito a ella segundo a lei das mulheres, por doze mezes (porque assim se cumpriam os dias das suas purificações), seis mezes com oleo de myrrha, e seis mezes com especiarias, e com as coisas para a purificação das mulheres:`,
    ...
    `Á tarde entrava, e pela manhã tornava á segunda casa das mulheres, debaixo da mão de Saasgaz, eunucho do rei, guarda das concubinas: não tornava mais ao rei, salvo se o rei a desejasse, e fosse chamada por nome`,
    `Chegando pois a vez d'Esther, filha d'Abihail, tio de Mardoqueo (que a tomara por sua filha), para ir ao rei, coisa nenhuma pediu, senão o que disse Hegai, eunucho do rei, guarda das mulheres: e alcançava Esther graça aos olhos de todos quantos a viam.`,
    ...
    `Esther porém não declarava a sua parentela e o seu povo, como Mardoqueo lhe ordenara: porque Esther fazia o mandado de Mardoqueo, como quando a criara.`,
  ...
  3: [
    `Depois d'estas coisas o rei Assuero engrandeceu a Haman, filho d'Hammedatha, agagita, e o exaltou: e poz o seu assento acima de todos os principes que estavam com elle.`,
    ...
    `Então os servos do rei, que estavam á porta do rei, disseram a Mardoqueo: Porque traspassas o mandado do rei?`,
    `Succedeu pois que, dizendo-lhe elles isto de dia em dia, e não lhes dando elle ouvidos, o fizeram saber a Haman, para verem se as palavras de Mardoqueo se sustentariam, porque elle lhes tinha declarado que era judeo.`,
    `Vendo pois Haman que Mardoqueo se não inclinava nem se prostrava diante d'elle, Haman se encheu de furor.`,
    `Porém em seus olhos teve em pouco de pôr as mãos só em Mardoqueo (porque lhe haviam declarado o povo de Mardoqueo); Haman pois procurou destruir a todos os judeos que havia em todo o reino d'Assuero, ao povo de Mardoqueo.`,
    `No primeiro mez (que é o mez de nisan), no anno duodecimo do rei Assuero, se lançou pur, isto é, sorte, perante Haman, de dia em dia, e de mez em mez, até ao duodecimo mez, que é o mez d'adar.`,
    `E Haman disse ao rei Assuero: Ha um povo espargido e dividido entre os povos em todas as provincias do teu reino, cujas leis são differentes das leis de todos os povos, e tão pouco fazem as leis do rei; pelo que não convém ao rei deixal-os ficar.`,
    ...
    `E as cartas se enviaram pela mão dos correios a todas as provincias do rei, que destruissem, matassem, e lançassem a perder a todos os judeos desde o moço até ao velho, creanças e mulheres, em um mesmo dia, a treze do duodecimo mez (que é o mez d'adar), e que saqueassem o seu despojo.`,
  ...
  4: [
    `Quando Mardoqueo soube tudo quanto havia passado, rasgou Mardoqueo os seus vestidos, e vestiu-se de um sacco com cinza, e saiu pelo meio da cidade, e clamou com grande e amargo clamor;`,
    `E chegou até diante da porta do rei: porque ninguem vestido de sacco podia entrar pelas portas do rei.`,
    `E em todas as provincias aonde a palavra do rei e a sua lei chegava, havia entre os judeos grande luto, com jejum, e choro, e lamentação: e muitos estavam deitados em sacco e em cinza.`,
    `Então vieram as moças de Esther, e os seus eunuchos, e fizeram-lh'o saber, do que a rainha muito se doeu: e mandou vestidos para vestir a Mardoqueo, e tirar-lhe o seu sacco; porém elle os não acceitou.`,
    ...
    `Mardoqueo lhe fez saber tudo quanto lhe tinha succedido; como tambem a offerta da prata, que Haman dissera que daria para os thesouros do rei, pelos judeos, para os lançar a perder.`,
    `Tambem lhe deu a copia da lei escripta, que se publicara em Susan, para os destruir, para a mostrar a Esther, e a fazer saber: e para lhe ordenar que, se fosse ter com o rei, e lhe pedisse e supplicasse na sua presença pelo seu povo.`,
    ...
    `Porque, se de todo te calares n'este tempo, soccorro e livramento d'outra parte sairá para os judeos, mas tu e a casa de teu pae perecereis: e quem sabe se para tal tempo como este chegaste a este reino?`,
    `Então disse Esther que tornassem a dizer a Mardoqueo:`,
    `Vae, ajunta a todos os judeos que se acharem em Susan, e jejuae por mim, e não comaes nem bebaes por tres dias, nem de dia nem de noite, e eu e as minhas moças tambem assim jejuaremos: e assim entrarei a ter com o rei, ainda que não é segundo a lei; e, perecendo, pereça.`,
    `Então Mardoqueo foi, e fez conforme a tudo quanto Esther lhe ordenou.`,
  ],
  5: [
    `Succedeu pois que ao terceiro dia Esther se vestiu de seus vestidos reaes, e se poz no pateo interior da casa do rei, defronte do aposento do rei: e o rei estava assentado sobre o seu throno real, na casa real defronte da porta do aposento.`,
    `E succedeu que, vendo o rei a rainha Esther, que estava no pateo, alcançou graça aos seus olhos, que o rei apontou para Esther com o sceptro d'oiro, que tinha na sua mão, e Esther chegou, e tocou a ponta do sceptro.`,
    ...
    `Então disse o rei: Fazei apressar a Haman, que faça o mandado d'Esther. Vindo pois o rei e Haman ao banquete, que Esther tinha preparado,`,
    ...
    `Se achei graça aos olhos do rei, e se bem parecer ao rei conceder-me a minha petição, e outorgar-me o meu requerimento, venha o rei com Haman ao banquete que lhes hei de preparar, e ámanhã farei conforme ao mandado do rei.`,
    `Então saiu Haman n'aquelle dia alegre e de bom animo: porém, vendo Haman a Mardoqueo á porta do rei, e que não se levantara nem se movera por elle, então Haman se encheu de furor contra Mardoqueo.`,
    `Haman porém se refreou, e veiu á sua casa: e enviou, e mandou vir os seus amigos, e a Zeres sua mulher.`,
    `E contou-lhes Haman a gloria das suas riquezas e a multidão de seus filhos, e tudo em que o rei o tinha engrandecido, e o em que o tinha exaltado sobre os principes e servos do rei.`,
  ...
  7: [
    ...
    `Disse tambem o rei a Esther no segundo dia, no banquete do vinho: Qual é a tua petição, rainha Esther? e se te dará: e qual é o teu requerimento? até metade do reino, se fará.`,
    ...
    `Porque estamos vendidos, eu e o meu povo, para nos destruirem, matarem, e lançarem a perder: se ainda por servos e por servas nos vendessem, calar-me-hia; ainda que o oppressor não recompensaria a perda do rei.`,
    ...
    `Tornando pois o rei do jardim do palacio á casa do banquete do vinho, Haman tinha caido prostrado sobre o leito em que estava Esther. Então disse o rei: Porventura quereria elle tambem forçar a rainha perante mim n'esta casa? Saindo esta palavra da bocca do rei, cobriram a Haman o rosto.`,
    `Então disse Harbona, um dos eunuchos que serviam diante do rei: Eis aqui tambem a forca de cincoenta covados de altura que Haman fizera para Mardoqueo, que fallara para bem do rei, está junto á casa de Haman. Então disse o rei: Enforcae-o n'ella.`,
  ...
  8: [
    ...
    `E disse: Se bem parecer ao rei, e se eu achei graça perante elle, e se este negocio é recto diante do rei, e se eu lhe agrado aos seus olhos, escreva-se que se revoguem as cartas e o intento d'Haman filho d'Hammedatha, o agagita, as quaes elle escreveu para lançar a perder os judeos, que ha em todas as provincias do rei.`,
    `Porque como poderei ver o mal que sobrevirá ao meu povo? e como poderei ver a perdição da minha geração?`,
    `Então disse o rei Assuero á rainha Esther e ao judeo Mardoqueo: Eis-que dei a Esther a casa de Haman, e a elle enforcaram n'uma forca, porquanto quizera pôr as mãos nos judeos.`,
    `Escrevei pois aos judeos, como parecer bem aos vossos olhos, em nome do rei, e sellae-o com o annel do rei; porque a escriptura que se escreve em nome do rei, e se sella com o annel do rei, não é para revogar.`,
    ...
    `Que o rei concedia aos judeos, que havia em cada cidade, que se ajuntassem, e se dispozessem para defenderem as suas vidas: para destruirem, matarem e assolarem a todas as forças do povo e provincia que com elles apertassem, creanças e mulheres, e que se saqueassem os seus despojos,`,
    `N'um mesmo dia, em todas as provincias do rei Assuero, no dia treze do duodecimo mez, que é o mez d'adar.`,
    ...
    `Então Mardoqueo saiu da presença do rei com um vestido real azul celeste e branco, como tambem com uma grande corôa d'oiro, e com uma capa de linho fino e purpura, e a cidade de Susan jubilou e se alegrou.`,
    `E para os judeos houve luz, e alegria, e gozo, e honra.`,
    `Tambem em toda a provincia, e em toda a cidade, aonde chegava a palavra do rei e a sua ordem, havia entre os judeos alegria, e gozo, convites e dias de folguedo: e muitos dos povos da terra se fizeram judeos; porque o temor dos judeos tinha caido sobre elles.`,
  ],
  9: [
    `E no mez duodecimo, que é o mez d'adar, no dia treze do mesmo mez em que chegou a palavra do rei e a sua ordem para a executar, no dia em que os inimigos dos judeos esperavam assenhorear-se d'elles, succedeu o contrario, porque os judeos foram os que se assenhorearam dos seus aborrecedores.`,
    `Porque os judeos nas suas cidades, em todas as provincias do rei Assuero, se ajuntaram para pôr as mãos n'aquelles que procuravam o seu mal: e nenhum parou diante d'elles; porque o seu terror caiu sobre todos aquelles povos.`,
    ...
    `E disse o rei á rainha Esther: Na fortaleza de Susan mataram e destruiram os judeos quinhentos homens, e os dez filhos d'Haman; nas mais provincias do rei que fariam? qual é pois a tua petição, e dar-se-te-ha; ou qual é ainda o teu requerimento? e far-se-ha.`,
    ...
    `E ajuntaram-se os judeos que se achavam em Susan tambem no dia quatorze do mez d'adar, e mataram em Susan a trezentos homens: porém ao despojo não estenderam a sua mão.`,
    `Tambem os demais judeos que se achavam nas provincias do rei se ajuntaram para se pôrem em defeza da sua vida, e tiveram repouso dos seus inimigos; e mataram dos seus aborrecedores setenta e cinco mil; porém ao despojo não estenderam a sua mão.`,
    `Succedeu isto no dia treze do mez d'adar: e repousaram no dia quatorze do mesmo, e fizeram d'aquelle dia dia de banquetes e d'alegria.`,
    `Tambem os judeos, que se achavam em Susan se ajuntaram nos dias treze e quatorze do mesmo: e repousaram no dia quinze do mesmo, e fizeram d'aquelle dia dia de banquetes e d'alegria.`,
    ...
    `Conforme aos dias em que os judeos tiveram repouso dos seus inimigos; e ao mez que se lhes mudou de tristeza em alegria, e de luto em dia de folguedo; para que os fizessem dias de banquetes e d'alegria, e de mandarem presentes uns aos outros, e aos pobres dadivas.`,
    `E se encarregaram os judeos de fazerem o que já tinham começado, como tambem o que Mardoqueo lhes tinha escripto.`,
    `Porque Haman, filho d'Hammedatha, o agagita, inimigo de todos os judeos, tinha intentado destruir os judeos; e tinha lançado pur, isto é, a sorte, para os assolar e destruir.`,
    `Mas, vindo isto perante o rei, mandou elle por cartas que o seu mau intento, que intentara contra os judeos, se tornasse sobre a sua cabeça; pelo que o enforcaram a elle e a seus filhos n'uma forca.`,
    ...
    `E que estes dias seriam lembrados e guardados por cada geração, familia, provincia, e cidade, e que estes dias de purim não traspassariam d'entre os judeos, e que a memoria d'elles nunca teria fim entre os de sua semente.`,
