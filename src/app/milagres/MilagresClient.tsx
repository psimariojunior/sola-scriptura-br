...
const TIPOS_MILAGRE = [
  ...
  { valor: 'expulsao', label: 'Expulsao' },
  { valor: 'ressurreicao', label: 'Ressurreicao' },
  { valor: 'alimentacao', label: 'Alimentacao' },
  { valor: 'outro', label: 'Outro' },
];

const MILAGRE_TIPO_MAP: Record<string, string> = {
  'mil-001': 'outro', 'mil-002': 'expulsao', 'mil-003': 'cura',
  'mil-004': 'ressurreicao', 'mil-005': 'cura', 'mil-006': 'alimentacao',
  'mil-007': 'natureza', 'mil-008': 'cura', 'mil-009': 'alimentacao',
  'mil-010': 'cura', 'mil-011': 'cura', 'mil-012': 'natureza',
  'mil-013': 'cura', 'mil-014': 'cura', 'mil-015': 'cura',
  'mil-016': 'cura', 'mil-017': 'natureza', 'mil-018': 'natureza',
  'mil-019': 'outro', 'mil-020': 'ressurreicao', 'mil-021': 'cura',
  'mil-022': 'natureza', 'mil-023': 'outro', 'mil-025': 'alimentacao',
  'mil-026': 'cura', 'mil-027': 'natureza', 'mil-028': 'natureza',
  'mil-029': 'cura', 'mil-030': 'alimentacao',
};

const MILAGRE_LOCAL: Record<string, string> = {
  'mil-001': 'cana', 'mil-002': 'geraseno', 'mil-003': 'galileia',
  'mil-004': 'cafarnaum', 'mil-005': 'jerusalem', 'mil-006': 'galileia',
  'mil-007': 'galileia', 'mil-008': 'decapole', 'mil-009': 'galileia',
  'mil-010': 'betsaida', 'mil-011': 'jerico', 'mil-012': 'monte tabor',
  'mil-013': 'galileia', 'mil-014': 'fenicia', 'mil-015': 'samaria',
  'mil-017': 'galileia', 'mil-018': 'jerusalem', 'mil-019': 'jerusalem',
  'mil-020': 'betania', 'mil-021': 'jerusalem', 'mil-022': 'galileia',
  'mil-023': 'jerusalem', 'mil-025': 'galileia', 'mil-028': 'galileia',
  'mil-030': 'galileia',
};
...
export default function MilagresClient() {
        ...
        <div className="max-w-6xl mx-auto px-6 mb-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Catalogo completo dos milagres registrados nos Evangelhos. Cada milagre com localizacao, tipo e referencias.
            </p>
