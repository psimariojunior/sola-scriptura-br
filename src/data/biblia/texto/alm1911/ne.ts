const data: Record<number, string[]> = {
  1: [
    `As palavras de Nehemias, filho d'Hacalias. E succedeu no mez de chisleu, no anno vigesimo, estando eu em Susan, a fortaleza,`,
    `Que veiu Hanani, um de meus irmãos, elle e alguns de Judah; e perguntei-lhes pelos judeos que escaparam, e que restaram do captiveiro, e ácerca de Jerusalem.`,
    `E disseram-me: Os restantes, que restaram do captiveiro, lá na provincia estão em grande miseria e desprezo: e o muro de Jerusalem fendido, e as suas portas queimadas a fogo.`,
    ...
    `Estejam pois attentos os teus ouvidos, e os teus olhos abertos, para ouvires a oração do teu servo, que eu hoje oro perante ti, de dia e de noite, pelos filhos d'Israel, teus servos: e faço confissão pelos peccados dos filhos d'Israel, que peccámos contra ti; tambem eu e a casa de meu pae peccámos.`,
    ...
    `Ah, Senhor, estejam pois attentos os teus ouvidos á oração do teu servo, e á oração dos teus servos que desejam temer o teu nome; e faze prosperar hoje o teu servo, e dá-lhe graça perante este homem. Então era eu copeiro do rei.`,
  ],
  2: [
    `Succedeu pois no mez de nisan, no anno vigesimo do rei Artaxerxes, que estava posto vinho diante d'elle, e eu tomei o vinho, e o dei ao rei porém nunca estivera triste diante d'elle.`,
    ...
    `E disse ao rei: Viva o rei para sempre! Como não estaria triste o meu rosto, estando a cidade, o logar dos sepulchros de meus paes, assolada, e tendo sido consumidas as suas portas a fogo?`,
    `E o rei me disse: Que me pedes agora? Então orei ao Deus dos céus,`,
    `E disse ao rei: Se é do agrado do rei, e se o teu servo é acceito em tua presença, peço-te que me envies a Judah, á cidade dos sepulchros de meus paes, para que eu a edifique.`,
    ...
    `Como tambem uma carta para Asaph, guarda do jardim do rei, que me dê madeira para cobrir as portas do paço da casa, e para o muro da cidade, e para a casa em que eu houver de entrar. E o rei m'as deu, segundo a boa mão de Deus sobre mim.`,
    ...
    `E não souberam os magistrados aonde eu fui nem o que eu fazia: porque ainda nem aos judeos, nem aos nobres, nem aos magistrados, nem aos mais que faziam a obra, até então tinha declarado coisa alguma.`,
    `Então lhes disse: Bem vêdes vós a miseria em que estamos, que Jerusalem está assolada, e que as suas portas teem sido queimadas a fogo: vinde pois e reedifiquemos o muro de Jerusalem, e não sejamos mais em opprobrio.`,
    `Então lhes declarei como a mão do meu Deus me fôra favoravel, como tambem as palavras do rei, que elle me tinha dito: então disseram: Levantemo-nos, e edifiquemos. E esforçaram as suas mãos para o bem`,
    `O que ouvindo Sanballat, o horonita, e Tobias, o servo ammonita, e Gesem, o arabio, zombaram de nós, e desprezaram-n'os, e disseram: Que é isto que fazeis? quereis rebellar-vos contra o rei?`,
  ...
  4: [
    ...
    `E fallou na presença de seus irmãos, e do exercito de Samaria, e disse: Que fazem estes fracos judeos? permittir-se-lhes-ha isto? sacrificarão? acabal-o-hão n'um só dia? vivificarão dos montões do pó as pedras que foram queimadas?`,
    ...
    `Ouve, ó nosso Deus, que somos tão desprezados, e torna o seu opprobrio sobre a sua cabeça, e faze com que sejam um despojo, na terra do captiveiro.`,
    ...
    `E succedeu que, ouvindo Sanballat e Tobias, e os arabios, e os ammonitas, e os asdoditas, que tanto ia crescendo a reparação dos muros de Jerusalem, que já as roturas se começavam a tapar, iraram-se sobremodo,`,
    ...
    `Disseram porém os nossos inimigos: Nada saberão d'isto, nem verão, até que entremos no meio d'elles, e os matemos; assim faremos cessar a obra.`,
    ...
    `E olhei, e levantei-me, e disse aos nobres, e aos magistrados, e ao resto do povo: Não os temaes: lembrae-vos do grande e terrivel Senhor, e pelejae pelos vossos irmãos, vossos filhos, vossas mulheres e vossas casas.`,
  ...
  6: [
    `Succedeu mais que, ouvindo Sanballat, Tobias, Gesem, o arabio, e o resto dos nossos inimigos que eu tinha edificado o muro, e que n'elle já não havia brecha alguma; ainda que até este tempo não tinha posto as portas nos portaes;`,
    ...
    `E, entrando eu em casa de Semaias, filho de Delaias, o filho de Mehetabel (que estava encerrado), disse elle: Vamos juntamente á casa de Deus, ao meio do templo, e fechemos as portas do templo; porque virão matar-te: sim, de noite virão matar-te.`,
    ...
    `Tambem n'aquelles dias alguns nobres de Judah escreveram muitas cartas, que iam para Tobias: e as cartas de Tobias vinham para elles.`,
  ...
  13: [
    ...
    `Porquanto não sairam ao encontro dos filhos d'Israel com pão e agua; antes alugaram contra elles a Balaão para os amaldiçoar; ainda que o nosso Deus converteu a maldição em benção.`,
    ...
    `E fizera-lhe uma camara grande, onde d'antes se mettiam as offertas de manjares, o incenso, e os vasos, e os dizimos do grão, do mosto, e do azeite, que se ordenaram para os levitas, e cantores, e porteiros, como tambem a offerta alçada para os sacerdotes.`,
    ...
    `E por thesoureiros puz sobre os celleiros a Selemias o sacerdote, e a Zadok o escrivão, e a Pedaias, d'entre os levitas; e á mão d'elles Hanan, filho de Zacchur, o filho de Matthanias: porque se tinham achado fieis: e se lhes encarregou a elles a distribuição para seus irmãos.`,
    `(Por isto, Deus meu, lembra-te de mim: e não risques as minhas beneficencias que eu fiz á casa de meu Deus e ás suas guardas.)`,
    `N'aquelles dias vi em Judah os que pisavam lagares ao sabbado e traziam feixes que carregavam sobre os jumentos; como tambem vinho, uvas e figos, e toda a casta de cargas, que traziam a Jerusalem no dia de sabbado; e protestei contra elles no dia em que vendiam mantimentos.`,
    ...
    `Succedeu pois que, dando as portas de Jerusalem já sombra antes do sabbado, ordenando-o eu, as portas se fecharam; e mandei que as não abrissem até passado o sabbado; e puz ás portas alguns de meus moços, para que carga nenhuma entrasse no dia de sabbado.`,
    ...
    `Tambem disse aos levitas que se purificassem, e viessem guardar as portas, para sanctificar o sabbado. (N'isto tambem, Deus meu, lembra-te de mim; e perdoa-me segundo a abundancia da tua benignidade.)`,
