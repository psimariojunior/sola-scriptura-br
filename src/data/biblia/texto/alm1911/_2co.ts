const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Nos quaes o Deus d'este seculo cegou os entendimentos dos incredulos, para que lhes não resplandeça a luz do evangelho da gloria de Christo, que é a imagem de Deus.`,
    ...
    `Não attentando nós nas coisas que se vêem, mas nas que se não vêem; porque as que se vêem são temporaes, e as que se não vêem são eternas.`,
  ],
  5: [
    `Porque sabemos que, se a nossa casa terrestre d'este tabernaculo se desfizer, temos de Deus um edificio, uma casa não feita por mãos, eterna nos céus.`,
  ...
  7: [
    `Ora, amados, pois que temos taes promessas, purifiquemo-nos de toda a immundicia da carne e do espirito, aperfeiçoando a sanctificação no temor de Deus.`,
    ...
    `Grande é a ousadia da minha falla para comvosco, e grande a minha jactancia a respeito de vós; estou cheio de consolação: superabundo de gozo em todas as nossas tribulações.`,
    ...
    `E não sómente com a sua vinda, senão tambem pela consolação com que foi consolado de vós, contando-nos as vossas saudades, o vosso choro, o vosso zelo por mim, de maneira que muito me regozijei.`,
    ...
    `Porque, quanto cuidado não produziu isto mesmo em vós, que segundo Deus fostes contristados! que apologia, que indignação, que temor, que saudades, que zelo, que vingança! em tudo mostrastes estar puros n'este negocio.`,
  ...
  9: [
    ...
    `Porque bem sei a promptidão do vosso animo da qual me glorio de vós para com os macedonios; que a Achaia está prompta desde o anno passado, e o vosso zelo tem estimulado muitos.`,
    `Porém enviei estes irmãos, para que a nossa gloria, ácerca de vós, não seja vã n'esta parte; para que (como já disse) possaes estar promptos:`,
    ...
    `Conforme está escripto: Espalhou, deu aos pobres: a sua justiça permanece para sempre.`,
    ...
    `Porque a administração d'este serviço, não só suppre as necessidades dos sanctos, mas tambem abunda em muitas graças, que se dão a Deus`,
  ...
  10: [
    ...
    `Olhaes para as coisas segundo a apparencia? Se alguem confia de si mesmo que é de Christo, pense outra vez isto comsigo, que, assim como elle é de Christo, tambem nós somos de Christo.`,
    ...
    `Porque as cartas, dizem, são graves e fortes, mas a presença do corpo é fraca, e a palavra desprezivel.`,
    ...
    `Não nos gloriando fóra de medida nos trabalhos alheios; antes tendo esperança de que, crescendo a vossa fé, seremos abundantemente engrandecidos entre vós, conforme a nossa regra;`,
  ...
  13: [
    ...
    `Já anteriormente o disse: e segunda vez o digo como se estivesse presente; agora pois, estando ausente, o digo aos que d'antes peccaram e a todos os mais, que, se outra vez fôr, não lhes perdoarei;`,
    ...
    `Ora eu rogo a Deus que não façaes mal algum, não para que sejamos achados approvados, mas para que vós façaes o bem, embora nós sejamos como reprovados.`,
    ...
    `Saudae-vos uns aos outros com osculo sancto. Todos os sanctos vos saudam.`,
    `A graça do Senhor Jesus Christo, e o amor de Deus, e a communhão do Espirito Sancto seja com vós todos. Amen.`,
  ],
};
