const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Mas aquelle que beber da agua que eu lhe der nunca terá sêde, porque a agua que eu lhe der se fará n'elle uma fonte d'agua que salte para a vida eterna.`,
  ...
  6: [
    ...
    `Trabalhae, não pela comida que perece, mas pela comida que permanece para a vida eterna, a qual o Filho do homem vos dará; porque a este sellou o Pae, Deus.`,
    ...
    `E a vontade d'aquelle que me enviou é esta: que todo aquelle que vê o Filho, e crê n'Elle, tenha a vida eterna; e eu o resuscitarei no ultimo dia.`,
    ...
    `Eu sou o pão vivo que desceu do céu; se alguem comer d'este pão, viverá para sempre: e o pão que eu der é a minha carne, que eu darei pela vida do mundo`,
  ...
  12: [
    ...
    `Respondeu-lhe a multidão: Nós temos ouvido da lei, que o Christo permanece para sempre; e como dizes tu que convem que o Filho do homem seja levantado? Quem é esse Filho do homem?`,
  ...
  18: [
    `Tendo Jesus dito estas coisas, saiu com os seus discipulos para além do ribeiro de Cedron, onde havia um horto, no qual elle entrou e seus discipulos.`,
    ...
    `Então Simão Pedro, que tinha espada, desembainhou-a, e feriu o servo do summo sacerdote, e cortou-lhe a orelha direita. E o nome do servo era Malco.`,
    ...
    `E Simão Pedro e outro discipulo seguiam a Jesus. E este discipulo era conhecido do summo sacerdote, e entrou com Jesus na sala do summo sacerdote.`,
    ...
    `Jesus lhe respondeu: Eu fallei abertamente ao mundo; eu sempre ensinei na synagoga e no templo onde todos os judeos se ajuntam, e nada disse em occulto;`,
    ...
    `Depois levaram Jesus da casa de Caiphás para a audiencia. E era pela manhã. E não entraram na audiencia, para não se contaminarem, mas poderem comer a paschoa.`,
    ...
    `Respondeu Jesus: O meu reino não é d'este mundo: se o meu reino fosse d'este mundo, pelejariam os meus servos, para que eu não fosse entregue aos judeos: porém agora o meu reino não é d'aqui.`,
    `Disse-lhe pois Pilatos: Logo tu és rei? Jesus respondeu: Tu dizes que eu sou rei. Eu para isso nasci, e para isso vim ao mundo, para dar testemunho á verdade. Todo aquelle que é da verdade ouve a minha voz.`,
  ...
  20: [
    `E no primeiro dia da semana Maria Magdalena foi ao sepulchro de madrugada, sendo ainda escuro, e viu a pedra já tirada do sepulchro.`,
    `Correu pois, e foi a Simão Pedro, e ao outro discipulo, a quem Jesus amava, e disse-lhes: Levaram o Senhor do sepulchro, e não sabemos onde o pozeram.`,
    ...
    `Disse-lhe Jesus: Mulher, porque choras? Quem buscas? Ella, cuidando que era o hortelão, disse-lhe: Senhor, se tu o levaste, dize-me onde o pozeste, e eu o levarei.`,
    `Disse-lhe Jesus: Maria! Ella, voltando-se, disse-lhe: Rabboni (que quer dizer, Mestre).`,
    `Disse-lhe Jesus: Não me toques, porque ainda não subi para meu Pae, mas vae para meus irmãos, e dize-lhes: Subo para meu Pae e vosso Pae, e para meu Deus e vosso Deus.`,
    `Maria Magdalena foi e annunciou aos discipulos que vira o Senhor, e que elle lhe dissera estas coisas.`,
    `Chegada pois a tarde de aquelle dia, o primeiro da semana, e cerradas as portas onde os discipulos, com medo dos judeos, se tinham ajuntado, chegou Jesus, e poz-se no meio, e disse-lhes: Paz comvosco.`,
    ...
    `Disseram-lhe pois os outros discipulos: Vimos o Senhor. Porém elle disse-lhes: Se eu não vir o signal dos cravos em suas mãos e não metter o dedo no logar dos cravos, e não metter a minha mão no seu lado, em maneira nenhuma o crerei.`,
  ...
  21: [
    ...
    `Estavam juntos Simão Pedro, e Thomé, chamado Didymo, e Nathanael, o de Caná da Galilea, os filhos de Zebedeo, e outros dois dos seus discipulos.`,
    ...
    `Disse-lhes Jesus: Vinde, jantae. E nenhum dos discipulos ousava perguntar-lhe: Quem és tu? sabendo que era o Senhor.`,
    ...
    `E, depois de terem jantado, disse Jesus a Simão Pedro: Simão, filho de Jonas, amas-me mais do que estes? E elle respondeu: Sim, Senhor; tu sabes que te amo. Disse-lhe: Apascenta os meus cordeiros.`,
    `Tornou a dizer-lhe segunda vez. Simão, filho de Jonas, amas-me? Disse-lhe: Sim, Senhor; tu sabes que te amo. Disse-lhe: Apascenta as minhas ovelhas.`,
    `Disse-lhe terceira vez: Simão, filho de Jonas, amas-me? Simão entristeceu-se por lhe ter dito terceira vez: Amas-me? e disse-lhe: Senhor, tu sabes todas as coisas; tu sabes que eu te amo. Jesus disse-lhe: Apascenta as minhas ovelhas.`,
    ...
    `Divulgou-se pois entre os irmãos este dito, que aquelle discipulo não havia de morrer. Jesus, porém, não lhe disse que não morreria, mas: Se eu quero que elle fique até que eu venha, que te importa a ti?`,
    `Este é o discipulo que testifica d'estas coisas, e estas coisas escreveu; e sabemos que o seu testemunho é verdadeiro.`,
    `Ha, porém, ainda muitas outras coisas que Jesus fez, as quaes, se cada uma de per si fosse escripta, cuido que nem ainda o mundo todo poderia conter os livros que se escrevessem. Amen.`,
  ],
};
