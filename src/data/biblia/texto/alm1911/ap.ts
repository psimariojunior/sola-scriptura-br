const data: Record<number, string[]> = {
  1: [
    `Revelação de Jesus Christo, a qual Deus lhe deu, para mostrar aos seus servos as coisas que brevemente devem acontecer; e pelo seu anjo as enviou, e as notificou a João seu servo;`,
    ...
    `Eis que vem com as nuvens, e todo o olho o verá, até os mesmos que o traspassaram, e todas as tribus da terra se lamentarão sobre elle. Sim. Amen.`,
    ...
    `Que dizia: O que vês, escreve-o n'um livro, e envia-o ás sete egrejas que estão na Asia: a Epheso, e a Smyrna, e a Pergamo, e a Thyatira, e a Sardo, e a Philadelphia, e a Laodicéa.`,
    ...
    `O mysterio das sete estrellas, que viste na minha dextra, e dos sete castiçaes de oiro. As sete estrellas são os anjos das sete egrejas, e os sete castiçaes, que viste, são as sete egrejas.`,
  ],
  2: [
    `Escreve ao anjo da egreja que está em Epheso: Isto diz aquelle que tem na sua dextra as sete estrellas, que anda no meio dos sete castiçaes de oiro.`,
    `Eu sei as tuas obras, e o teu trabalho, e a tua paciencia, e que não pódes soffrer os maus; e provaste os que dizem ser apostolos e o não são; e tu os achaste mentirosos.`,
    ...
    `Lembra-te pois d'onde decaiste, e arrepende-te, e pratica as primeiras obras; e, senão, brevemente a ti virei, e tirarei do seu logar o teu castiçal, se te não arrependeres.`,
    ...
    `Nada temas das coisas que has de padecer. Eis que o diabo lançará alguns de vós na prisão, para que sejaes tentados; e tereis tribulação de dez dias. Sê fiel até á morte, e dar-te-hei a corôa da vida.`,
    ...
    `Eu sei as tuas obras, e onde habitas, que é onde está o throno de Satanás; e retens o meu nome, e não negaste a minha fé, ainda nos dias de Antipas, minha fiel testemunha, o qual foi morto entre vós, onde Satanás habita`,
    ...
    `Quem tem ouvidos, ouça o que o Espirito diz ás egrejas: Ao que vencer darei eu a comer do manná escondido, e dar-lhe-hei um seixo branco, e um novo nome escripto no seixo, o qual ninguem conhece senão aquelle que o recebe.`,
    ...
    `Mas eu vos digo a vós, e aos demais que estão em Thyatira, a todos quantos não teem esta doutrina, e não conheceram, como dizem, as profundezas de Satanás, que outra carga vos não porei`,
  ...
  3: [
    ...
    `O que vencer será vestido de vestidos brancos, e em maneira nenhuma riscarei o seu nome do livro da vida; e confessarei o seu nome diante de meu Pae e diante dos seus anjos.`,
    `Quem tem ouvidos, ouça o que o Espirito diz ás egrejas.`,
    ...
    `Eis aqui dou, da synagoga de Satanás, dos que se dizem judeos, e não são, mas mentem: eis que eu farei que venham, e adorem prostrados a teus pés, e saibam que eu te amo`,
    ...
    `A quem vencer, eu o farei columna no templo do meu Deus, e d'elle nunca sairá; e escreverei sobre elle o nome do meu Deus, e o nome da cidade do meu Deus, o da nova Jerusalem, que desce do céu do meu Deus, e o meu novo nome.`,
    `Quem tem ouvidos, ouça o que o Espirito diz ás egrejas.`,
    ...
    `Porque dizes: Rico sou, e estou enriquecido, e de nada tenho falta; e não sabes que és um desgraçado, e miseravel, e pobre, e cego, e nú`,
  ...
  4: [
    ...
    `Os vinte e quatro anciãos prostravam-se diante do que estava assentado sobre o throno, e adoravam o que vive para todo o sempre; e lançavam as suas corôas diante do throno, dizendo:`,
  ...
  5: [
    ...
    `E disse-me um dos anciãos: Não chores: eis aqui, o Leão da tribu de Judah, a raiz de David, que venceu, para abrir o livro e desatar os seus sete sellos.`,
    `E olhei, e eis que no meio dos anciãos estava um Cordeiro, como havendo sido morto, e tinha sete cornos, e sete olhos, que são os sete Espiritos de Deus enviados a toda a terra.`,
    ...
    `E ouvi a toda a creatura que está no céu, e na terra, e debaixo da terra, e que está no mar, e a todas as coisas que n'elles ha, dizendo: Ao que está assentado sobre o throno, e ao Cordeiro, sejam dadas acções de graças, e honra, e gloria, e poder para todo o sempre`,
  ...
  6: [
    ...
    `E saiu outro cavallo, vermelho; e ao que estava assentado sobre elle foi dado que tirasse a paz da terra, e que se matassem uns aos outros; e foi-lhe dada uma grande espada.`,
    ...
    `E ouvi uma voz no meio dos quatro animaes, que dizia: Uma medida de trigo por um dinheiro, e tres medidas de cevada por um dinheiro; e não damnifiques o azeite e o vinho.`,
    `E, havendo aberto o quarto sello, ouvi a voz do quarto animal, que dizia: Vem e vê.`,
    `E olhei, e eis um cavallo amarello, e o que estava assentado sobre elle tinha por nome Morte; e o inferno o seguiu; e foi-lhes dado poder para matar a quarta parte da terra, com espada, e com fome, e com mortandade, e com as feras da terra.`,
    ...
    `E deram-se-lhes a cada um vestidos brancos compridos, e foi-lhes dito que repousassem ainda um pouco de tempo, até que tambem se completasse o numero de seus conservos e seus irmãos, que haviam de ser mortos como elles.`,
    `E, havendo aberto o sexto sello, olhei, e eis que houve um grande tremor de terra; e o sol tornou-se negro como sacco de cilicio, e a lua tornou-se como sangue.`,
  ...
  7: [
    ...
    `E vi outro anjo subir da banda do sol nascente, e que tinha o sello do Deus vivo; e clamou com grande voz aos quatro anjos a quem fôra dado o poder de damnificar a terra e o mar,`,
    ...
    `Da tribu de Simeão, doze mil assignalados: da tribu de Levi, doze mil assignalados: da tribu de Issacar, doze mil assignalados:`,
    `Da tribu de Zabulon, doze mil assignalados: da tribu de José, doze mil assignalados: da tribu de Benjamin, doze mil assignalados.`,
    `Depois d'estas coisas olhei, e eis aqui uma multidão, a qual ninguem podia contar, de todas as nações, e tribus, e povos, e linguas, que estavam diante do throno, e perante o Cordeiro, trajando vestidos brancos e com palmas nas suas mãos:`,
    ...
    `Dizendo: Amen. Louvor, e gloria, e sabedoria, e acção de graças, e honra, e poder, e força ao nosso Deus, para todo o sempre. Amen.`,
  ...
  8: [
    ...
    `E o quarto anjo tocou a sua trombeta, e foi ferida a terça parte do sol, e a terça parte da lua, e a terça parte das estrellas; para que a terça parte d'elles se escurecesse, e a terça parte do dia não brilhasse, e similhantemente a da noite`,
  ...
  10: [
    `E vi outro anjo forte, que descia do céu, vestido de uma nuvem; e por cima da sua cabeça estava o arco celeste, e o seu rosto era como o sol, e os seus pés como columnas de fogo;`,
    ...
    `E jurou por Aquelle que vive para todo o sempre, o qual creou o céu e as coisas que n'elle ha, e a terra e as coisas que n'ella ha, e o mar e as coisas que n'elle ha, que não haveria mais tempo;`,
    ...
    `E a voz que eu do céu tinha ouvido tornou a fallar comigo, e disse: Vae, e toma o livrinho aberto da mão do anjo que está sobre o mar e sobre a terra.`,
    `E fui ao anjo, dizendo-lhe: Dá-me o livrinho. E elle disse-me: Toma-o, e come-o, e fará amargo o teu ventre, porém na tua bocca será doce como mel`,
    `E tomei o livrinho da mão do anjo, e comi-o; e na minha bocca era doce como mel; e, havendo-o comido, o meu ventre ficou amargo.`,
  ...
  12: [
    `E viu-se um grande signal no céu: uma mulher vestida de sol, e a lua debaixo dos seus pés, e uma corôa de doze estrellas sobre a sua cabeça.`,
    ...
    `E ouvi uma grande voz no céu, que dizia: Agora chegada está a salvação, e a força, e o reino do nosso Deus, e o poder do seu Christo; porque já o accusador de nossos irmãos é derribado, o qual diante do nosso Deus os accusava de dia e de noite.`,
    `E elles o venceram pelo sangue do Cordeiro e pela palavra do seu testemunho; e não amaram as suas vidas até á morte.`,
    `Pelo que alegrae-vos, ó céus, e os que n'elles habitaes. Ai dos que habitam na terra e no mar; porque o diabo desceu a vós, e tem grande ira, sabendo que já tem pouco tempo.`,
    ...
    `E o dragão irou-se contra a mulher, e foi fazer guerra contra os demais da sua semente, que guardam os mandamentos de Deus, e teem o testemunho de Jesus Christo.`,
  ],
  13: [
    ...
    `E exerce todo o poder da primeira besta na sua presença, e faz que a terra e os que n'ella habitam adorem a primeira besta, cuja chaga mortal fôra curada.`,
    `E faz grandes signaes, de maneira que até fogo faz descer do céu á terra, diante dos homens.`,
    `E engana aos que habitam na terra com signaes que se lhe permittiram que fizesse em presença da besta, dizendo aos que habitam na terra que fizessem uma imagem á besta que recebera a ferida da espada e vivia.`,
  ...
  14: [
    ...
    `E vi outro anjo voar pelo meio do céu, e tinha o evangelho eterno, para proclamal-o aos que habitam sobre a terra, e a toda a nação, e tribu, e lingua, e povo.`,
    ...
    `E o fumo do seu tormento sobe para todo o sempre; e não teem repouso nem de dia nem de noite os que adoram a besta e a sua imagem, e aquelle que receber o signal do seu nome.`,
  ...
  17: [
    ...
    `A besta que viste foi e já não é, e ha de subir do abysmo, e ir-se á perdição; e os que habitam na terra (cujos nomes não estão escriptos no livro da vida, desde a fundação do mundo) se admirarão vendo a besta que era e já não é, ainda que é.`,
  ...
  18: [
    ...
    `E ouvi outra voz do céu, que dizia: Sae d'ella, povo meu, para que não sejas participante dos seus peccados, e para que não recebas das suas pragas.`,
    ...
    `Mercadorias de oiro, e de prata, e de pedras preciosas, e de perolas, e de linho fino, e de purpura, e de seda, e de escarlata; e toda a madeira odorifera, e todo o vaso de marfim, e todo o vaso de madeira preciosissima, de bronze e de ferro, e de marmore;`,
    `E canella, e especiaria, e perfume, e unguento odorifero, e incenso, e vinho, e azeite, e flor de farinha, e trigo, e cavalgaduras, e ovelhas; e mercadorias de cavallos, e de carros, e de corpos e de almas de homens.`,
    ...
    `E dizendo: Ai, ai d'aquella grande cidade! que estava vestida de linho fino, e purpura, e escarlata; e adornada com oiro e pedras preciosas e perolas! Porque n'uma hora foram assoladas tantas riquezas.`,
  ...
  19: [
    ...
    `E ouvi como que a voz de uma grande multidão, e como que a voz de muitas aguas, e como que a voz de grandes trovões, que dizia: Alleluia: pois já o Senhor Deus Todo-poderosoreina.`,
    ...
    `E eu lancei-me a seus pés para o adorar; porém elle disse-me: Olha não faças tal: sou teu conservo, e de teus irmãos, que teem o testemunho de Jesus: adora a Deus; porque o testemunho de Jesus é o espirito de prophecia.`,
    ...
    `Para que comaes a carne dos reis, e a carne dos tribunos, e a carne dos fortes, e a carne dos cavallos e dos que sobre elles se assentam; e a carne de todos os livres e servos, e pequenos e grandes.`,
    `E vi a besta, e os reis da terra, e os seus exercitos ajuntados, para fazerem guerra áquelle que estava assentado sobre o cavallo, e ao seu exercito.`,
    `E a besta foi presa, e com ella o falso propheta, que diante d'ella fizera os signaes, com que enganou os que receberam o signal da besta, e adoraram a sua imagem. Estes dois foram lançados vivos no ardente lago do fogo e do enxofre.`,
  ...
  20: [
    ...
    `E lançou-o no abysmo, e ali o encerrou, e poz sello sobre elle, para que mais não engane as nações, até que os mil annos se acabem. E depois importa que seja solto por um pouco de tempo.`,
    ...
    `E o diabo, que os enganava, foi lançado no lago do fogo e enxofre, onde estão a besta e o falso propheta; e de dia e de noite serão atormentados para todo o sempre.`,
  ...
  21: [
    ...
    `E eu, João, vi a sancta cidade, a nova Jerusalem, que de Deus descia do céu, adereçada como a esposa ataviada para o seu marido.`,
    `E ouvi uma grande voz do céu, que dizia: Eis aqui o tabernaculo de Deus com os homens, e com elles habitará, e elles serão o seu povo, e o mesmo Deus estará com elles, e será o seu Deus`,
    ...
    `E disse-me: Está cumprido: Eu sou o Alpha e o Omega, o principio e o fim. A quem quer que tiver sêde, de graça lhe darei da fonte da agua da vida.`,
    `Quem vencer, herdará todas as coisas; e eu serei seu Deus, e elle será meu filho,`,
    `Mas quanto aos timidos, e aos incredulos, e aos abominaveis, e aos homicidas, e aos fornicadores, e aos feiticeiros, e aos idolatras e a todos os mentirosos, a sua parte será no lago que arde com fogo e enxofre; o que é a segunda morte.`,
    `E veiu a mim um dos sete anjos que tinham as sete taças cheias das ultimas sete pragas, e fallou comigo, dizendo: Vem, mostrar-te-hei a esposa, a mulher do Cordeiro.`,
    ...
    `E a cidade estava situada em quadrado; e o seu comprimento era tanto quanto a sua largura. E mediu a cidade com a canna até doze mil estadios: e o seu comprimento, largura e altura eram eguaes.`,
    ...
    `O quinto, sardonica; o sexto, sardio; o setimo, crisolito; o oitavo, beryllo; o nono, topazio; o decimo, crysopraso; o undecimo, jacintho; o duodecimo, amethysta.`,
    `E as doze portas eram doze perolas: cada uma das portas era uma perola, e a praça da cidade de oiro puro, como vidro transparente.`,
  ...
  22: [
    ...
    `E eu, João, sou aquelle que vi e ouvi estas coisas. E, havendo-as ouvido e visto, prostrei-me aos pés do anjo que me mostrava estas coisas, para o adorar.`,
    ...
    `Eu, Jesus, enviei o meu anjo, para vos testificar estas coisas nas egrejas: eu sou a raiz e a geração de David, a resplandecente estrella da manhã.`,
