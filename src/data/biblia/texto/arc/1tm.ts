const data: Record<number, string[]> = {
  1: [
    "Paulo, apóstolo de Jesus Cristo, segundo o mandamento de Deus, nosso Salvador, e do Senhor Jesus Cristo, esperança nossa,",
    ...
    "conforme o evangelho da glória de Deus bendito, que me foi confiado.",
    ...
    "E entre esses estão Himeneu e Alexandre, os quais entreguei a Satanás, para que aprendam a não blasfemar.",
  ],
  2: [
    ...
    "o qual se deu a si mesmo em preço de redenção por todos, para ser testemunho a seu tempo.",
    "Para o que (digo a verdade em Cristo, não minto) fui constituído pregador e apóstolo dos gentios, na fé e na verdade.",
  ...
  3: [
    ...
    "Convém, pois, que o bispo seja irrepreensível, marido de uma mulher, vigilante, sóbrio, honesto, dado à hospitalidade, apto para ensinar;",
    ...
    "Também é necessário que tenha bom testemunho dos que estão de fora, para que não caia em afronta e no laço do diabo.",
    "Da mesma sorte, os diáconos sejam honestos, não de língua dobre, não dados a muito vinho, não cobiçosos de torpe ganância;",
    "guardando o mistério da fé com uma consciência pura.",
    ...
    "Os diáconos sejam maridos de uma mulher e governem bem a seus filhos e suas próprias casas.",
    ...
    "mas, se tardar, para que saibas como convém andar na casa de Deus, que é a igreja do Deus vivo, a coluna e o firmamento da verdade.",
  ...
  4: [
    ...
    "Não desprezes o dom que em ti há, o qual te foi dado por profecia, com a imposição das mãos do presbitério.",
    "Cuida destas coisas e está nelas, para que o teu aproveitamento seja manifesto a todos.",
  ...
  5: [
    ...
    "Mas, se alguma viúva tem filhos ou netos, aprendam primeiro a exercer piedade para com a sua própria família e a recompensar seus pais; porque isto é bom e agradável diante de Deus.",
    "Ora, a que verdadeiramente é viúva e desamparada espera em Deus e persevera de noite e de dia em rogos e orações;",
    "mas a que vive em delícias, vivendo, está morta.",
    "Manda, pois, estas coisas, para que elas sejam irrepreensíveis.",
    "Mas, se alguém não tem cuidado dos seus e, principalmente, dos da sua família, negou a fé e é pior do que o infiel.",
    "Nunca seja inscrita viúva com menos de sessenta anos, e só a que tenha sido mulher de um marido;",
    ...
    "Mas não admitas as viúvas mais novas, porque, quando se tornam desregradas contra Cristo, querem casar-se;",
    "tendo já a sua condenação, por haverem aniquilado a primeira fé;",
    "e, além disto, aprendem também a andar ociosas, andando de casa em casa; e não somente ociosas, mas também paroleiras e curiosas, falando o que não convém.",
    "Quero, pois, que as que são mais novas se casem, gerem filhos, governem a casa e não deem ocasião ao adversário de maldizer;",
    "porque já algumas se desviaram, indo após Satanás.",
    "Se algum crente ou alguma crente tem viúvas, as socorra, e não se sobrecarregue a igreja, para que se possam sustentar as que verdadeiramente são viúvas.",
    "Os presbíteros que governam bem sejam estimados por dignos de duplicada honra, principalmente os que trabalham na palavra e na doutrina.",
    "Porque diz a Escritura: Não ligarás a boca ao boi que debulha o trigo; e: Digno é o obreiro do seu salário.",
    "Não admitas acusação contra o presbítero, senão com duas ou três testemunhas.",
    ...
    "A nenhum imponhas apressadamente as mãos, nem participes dos pecados alheios; conserva-te puro a ti mesmo.",
    "Não bebas mais água só, mas usa um pouco de vinho, por causa do teu estômago e das tuas frequentes fraquezas.",
    "Os pecados de alguns homens são manifestos, precedendo o juízo; e os de alguns, depois se manifestam.",
    "Assim, também as boas obras são manifestas; e as que são de outra maneira não podem esconder-se.",
  ],
  6: [
    ...
    "é soberbo e nada sabe, mas delira acerca de questões e contendas de palavras, das quais nascem invejas, porfias, blasfêmias, suspeitas malignas,",
    ...
    "Mando-te diante de Deus, que todas as coisas vivifica, e diante de Cristo Jesus, que diante de Pôncio Pilatos deu o testemunho de boa confissão,",
    ...
    "Manda aos ricos deste mundo que não sejam altivos, nem esperem na incerteza das riquezas, mas no Deus vivo, que abundantemente nos dá todas as coisas para delas gozarmos;",
