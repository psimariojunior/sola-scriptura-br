const data: Record<number, string[]> = {
  1: [
    `Palavra do Senhor, feita a Sofonias, filho de Cushi, filho de Gedalia, filho de Amaria, filho de Hizekia, nos dias de Josia, filho de Amon, rei de Judah.`,
    `Eu indubitavelmente hei de arrebatar tudo de sobre a face da terra, diz o Senhor.`,
    `Arrebatarei os homens e os animaes, arrebatarei as aves do céu, e os peixes do mar, e os tropeços com os impios; e exterminarei os homens de cima da terra, disse o Senhor.`,
    `E estenderei a minha mão contra Judah, e contra todos os habitantes de Jerusalem, e exterminarei d'este logar o resto de Baal, e o nome dos chemarins com os sacerdotes;`,
    ...
    `Nem a sua prata nem o seu oiro os poderá livrar no dia do furor do Senhor, mas pelo fogo do seu zelo toda esta terra será consumida, porque certamente fará de todos os moradores d'esta terra uma destruição total e apressada.`,
  ],
  2: [
