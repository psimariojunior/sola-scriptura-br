const data: Record<number, string[]> = {
  1: [
    ...
    "punishing those who don't know God, and those who don't obey the Good News of our Lord Jesus Christ.",
    "They will pay the penalty: eternal destruction from the face of the Lord and from the glory of his might,",
  ...
  3: [
    ...
    "Now we command you, brothers, in the name of our Lord Jesus Christ, that you withdraw yourselves from every brother who walks in rebellion and not after the tradition which you received from us.",
    "For you know how you ought to imitate us. For we didn't behave ourselves rebelliously among you,",
    "neither did we eat bread from anyone's hand without paying for it, but in labor and travail worked night and day, that we might not burden any of you.",
    "It was not because we don't have the right, but to make ourselves an example to you, that you should imitate us.",
    ...
    "Yet don't count him as an enemy, but admonish him as a brother.",
