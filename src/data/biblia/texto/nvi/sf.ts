const data: Record<number, string[]> = {
  1: [
    ...
    `“Destruirei tanto os homens quanto os animais; destruirei as aves do céu e os peixes do mar e os que causam tropeço junto com os ímpios. Farei isso quando eu ceifar o homem da face da terra”, declara o SENHOR.`,
  ...
  3: [
    ...
    `Naquele tempo, eu ajuntarei vocês; naquele tempo, os trarei para casa. Eu darei a vocês honra e louvor entre todos os povos da terra, quando eu restaurar a sua sorte diante dos seus próprios olhos”, diz o SENHOR.`,
  ],
};
export default data;
