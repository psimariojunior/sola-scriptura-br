const data: Record<number, string[]> = {
  1: [
    ...
    `O jardim possuía forrações em branco e azul, presas com cordas de linho branco e tecido roxo, ligadas por anéis de prata a colunas de mármore. Tinha assentos de ouro e de prata num piso de mosaicos de pórfiro, mármore, madrepérola e outras pedras preciosas.`,
  ...
  2: [
    ...
    `O rei deu um grande banquete, o banquete de Ester, para todos os seus nobres e oficiais. Proclamou feriado em todas as províncias e distribuiu presentes por sua generosidade real.`,
  ...
  3: [
    ...
    `Se for do agrado do rei, que se decrete a destruição deles, e eu colocarei trezentas e cinquenta toneladas de prata na tesouraria real à disposição para que se execute esse trabalho”.`,
  ...
  9: [
    ...
    `que disse à rainha Ester: “Os judeus mataram e destruíram quinhentos homens e os dez filhos de Hamã na cidadela de Susã. Que terão feito nas outras províncias do império? Agora, diga qual é o seu pedido, e você será atendida. Tem ainda algum desejo? Este será concedido a você”.`,
