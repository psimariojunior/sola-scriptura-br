const data: Record<number, string[]> = {
  ...
  7: [
    ...
    "Mas, se alguém julga que trata indigidnte a sua virgem, se tiver passado a flor da idade, e se for necessário, que faça o tal o que quiser; não peca; casem-se.",
  ...
  11: [
    ...
    "Portanto, qualquer que comer este pão, ou beber o cálice do Senhor indigidnte, será culpado do corpo e do sangue do Senhor.",
    "Examine-se, pois, o homem a si mesmo, e assim coma deste pão e beba deste cálice.",
    "Porque o que come e bebe indigidnte, come e bebe para sua própria condenação, não discernindo o corpo do Senhor.",
