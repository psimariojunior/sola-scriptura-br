const data: Record<number, string[]> = {
  1: [
    ...
    `Vi que a parte de cima do que parecia ser a cintura dele parecia metal brilhante, como se estivesse cheia de fogo, e a parte de baixo parecia fogo; e uma luz brilhante o cercava.`,
  ...
  3: [
    ...
    `E acrescentou: “Filho do homem, coma este rolo que estou dando a você e encha o seu estômago com ele”. Então eu o comi, e em minha boca era doce como mel.`,
    ...
    `Quando eu disser a um ímpio que ele vai morrer e você não o advertir nem lhe falar para dissuadi-lo dos seus maus caminhos e salvar a vida dele, aquele ímpio morrerá por sua iniquidade; para mim, porém, você será responsável pela morte dele.`,
    `Se, porém, você advertir o ímpio e ele não se desviar de sua impiedade ou dos seus maus caminhos, ele morrerá por sua iniquidade, mas você estará livre dessa culpa.`,
  ...
  4: [
    ...
    `Em seguida, cerque-a e erga obras de cerco contra ela; construa uma rampa, monte acampamentos e ponha aríetes ao redor dela.`,
    ...
    `“Deite-se então sobre o seu lado esquerdo e sobre você ponha a iniquidade da nação de Israel. Você terá que carregar a iniquidade dela durante o número de dias em que estiver deitado sobre o lado esquerdo.`,
  ...
  7: [
    ...
    `Não olharei com piedade para você nem a pouparei; com certeza eu a retribuirei por sua conduta e suas práticas em seu meio. Então você saberá que eu sou o SENHOR”.`,
    ...
    `Estou prestes a derramar a minha ira sobre você e esgotar a minha indignação contra você; eu a julgarei de acordo com a sua conduta e a retribuirei por todas as suas práticas repugnantes.`,
    `Não olharei com piedade para você nem a pouparei; eu a retribuirei de acordo com todas as práticas repugnantes que há no seu meio. Então você saberá que é o SENHOR que desfere o golpe.`,
    ...
    `Todos os que se livrarem e escaparem estarão nos montes, gemendo como pombas nos vales, cada um por causa de sua própria iniquidade.`,
    ...
    `Eles tinham orgulho de suas lindas joias e as usavam para fazer os seus ídolos repugnantes e as suas imagens detestáveis. Por isso tornarei essas coisas em algo impuro para eles.`,
  ...
  8: [
    ...
    `E de novo disse: “Você os verá cometer práticas ainda mais repugnantes”.`,
  ...
  10: [
    ...
    `Cada um dos querubins tinha quatro rostos: Um rosto era o de um querubim; o segundo, de um homem; o terceiro, de um leão; o quarto, de uma águia.`,
  ...
  12: [
    ...
    `“Filho do homem, acaso aquela nação rebelde de Israel não perguntou: ‘O que você está fazendo?’`,
  ...
  13: [
    ...
    `Minha mão será contra os profetas que têm visões falsas e proferem adivinhações mentirosas. Eles não pertencerão ao conselho do meu povo, não estarão inscritos nos registros da nação de Israel e não entrarão na terra de Israel. Então vocês saberão que eu sou o Soberano, o SENHOR.`,
  ...
  14: [
    ...
    `Isso para que a nação de Israel não se desvie mais de mim nem mais se contamine com todos os seus pecados. Serão o meu povo, e eu serei o seu Deus. Palavra do Soberano, o SENHOR”.`,
    `Esta palavra do SENHOR veio a mim:`,
  ...
  16: [
    ...
    `“Então, passando por perto, vi você se esperneando em seu sangue e, enquanto você jazia ali em seu sangue, eu disse: Viva!`,
    `E eu a fiz crescer como uma planta no campo. Você cresceu e se desenvolveu e se tornou a mais linda das joias. Seus seios se formaram e seu cabelo cresceu, mas você ainda estava totalmente nua.`,
    ...
    `Sua fama espalhou-se entre as nações por sua beleza, porque o esplendor que eu dera a você tornou perfeita a sua formosura. Palavra do Soberano, o SENHOR.`,
    ...
    `em cada praça pública, você construiu para você mesma altares e santuários elevados.`,
    ...
    `Você é uma verdadeira filha de sua mãe, que detestou o seu marido e os seus filhos; e você é uma verdadeira irmã de suas irmãs, as quais detestaram os seus maridos e os seus filhos. A mãe de vocês era hitita e o pai de vocês amorreu.`,
    ...
    `Aguente a sua vergonha, pois você proporcionou alguma justificativa às suas irmãs. Visto que os seus pecados são mais detestáveis que os delas, elas parecem mais justas que você. Envergonhe-se, pois, e suporte a sua humilhação, porquanto você fez as suas irmãs parecerem justas.`,
  ...
  21: [
    ...
    `“Portanto, assim diz o Soberano, o SENHOR: Visto que vocês trouxeram à lembrança a sua iniquidade mediante rebelião ostensiva, revelando seus pecados em tudo o que fazem; por isso vão ser levados prisioneiros.`,
    ...
    `A despeito das visões falsas e das adivinhações mentirosas sobre vocês, ela será posta no pescoço dos ímpios que devem ser mortos e cujo dia chegou, cujo momento de castigo é agora.`,
  ...
  23: [
    ...
    `“Agora, assim diz o Soberano, o SENHOR: Visto que você se esqueceu de mim e me deu as costas, você vai sofrer as consequências de sua lascívia e de sua prostituição”.`,
    ...
    `“Elas até enviaram mensageiros atrás de homens, vindos de bem longe, e, quando eles chegaram, você se banhou para recebê-los, pintou os olhos e pôs suas joias.`,
    `Você se sentou num belo sofá, tendo à frente uma mesa, na qual você havia colocado o incenso e o óleo que me pertenciam.`,
    `“Em torno dela havia o ruído de uma multidão despreocupada; sabeus foram trazidos do deserto com homens do povo, e eles puseram braceletes nos braços da mulher e da sua irmã e belíssimas coroas na cabeça delas.`,
  ...
  26: [
    ...
    `Depois entoarão um lamento acerca de você e dirão: “ ‘Como você está destruída, ó cidade de renome, povoada por homens do mar! Você era um poder nos mares, você e os seus cidadãos; você impunha pavor a todos os que ali vivem.`,
  ...
  27: [
    ...
    `“Os homens de Rodes negociaram com você, e muitas regiões costeiras se tornaram seus clientes; pagaram suas compras a você com presas de marfim e com ébano.`,
    `“Arã negociou com você, atraído por seus muitos produtos; em troca de suas mercadorias deu a você turquesa, tecido púrpura, trabalhos bordados, linho fino, coral e rubis.`,
    `“Judá e Israel negociaram com você; pelos seus bens trocaram trigo de Minite, confeitos, mel, azeite e bálsamo.`,
    `“Em razão dos muitos produtos de que você dispõe e da grande riqueza de seus bens, Damasco negociou com você, pagando com vinho de Helbom e lã de Zaar.`,
  ...
  28: [
    ...
    `Por sua grande habilidade comercial você aumentou as suas riquezas e, por causa das suas riquezas, o seu coração ficou cada vez mais orgulhoso.`,
  ...
  32: [
    ...
    `Farei que muitos povos espantem-se ao vê-lo, e que os seus reis fiquem arrepiados de horror por sua causa, quando eu brandir a minha espada diante deles. No dia da sua queda todos eles tremerão de medo sem parar, por suas vidas.`,
  ...
  33: [
    ...
    `Mas, se a sentinela vir chegar a espada e não tocar a trombeta para advertir o povo e a espada vier e tirar a vida de um deles, aquele homem morrerá por causa de sua iniquidade, mas considerarei a sentinela responsável pela morte daquele homem.`,
    ...
    `Entretanto, se você de fato advertir o ímpio para que se desvie dos seus caminhos e ele não se desviar, ele morrerá por sua iniquidade, e você estará livre da sua responsabilidade.`,
  ...
  37: [
    ...
    `“Quando os seus compatriotas perguntarem: ‘Você não vai nos dizer o que significa isso?’`,
  ...
  40: [
    ...
    `E ele me disse: “Filho do homem, fixe bem os olhos e procure ouvir bem, e preste atenção a tudo o que vou mostrar a você, pois para isso você foi trazido aqui. Conte à nação de Israel tudo o que você vai ver”.`,
    ...
    `A seguir ele mediu a distância da parte interna da entrada inferior até a parte externa do pátio interno, o que deu cinquenta metros, tanto no lado leste como no lado norte.`,
    ...
    `Também havia quatro mesas de pedra lavrada para os holocaustos, cada uma com setenta e cinco centímetros de comprimento e de largura, e cinquenta centímetros de altura. Nelas colocavam-se os utensílios para o abate dos holocaustos e dos outros sacrifícios.`,
    `E ganchos de duas pontas, cada um com quatro dedos de comprimento, estavam presos à parede, em toda a sua extensão. As mesas destinavam-se à carne das ofertas.`,
  ...
  42: [
    ...
    `A fileira de quartos junto ao pátio interno tinha vinte e cinco metros de comprimento, e a que ficava mais próxima do santuário tinha cinquenta metros de comprimento.`,
    ...
    `Mediu o lado norte; tinha duzentos e cinquenta metros, segundo a vara de medir.`,
  ...
  43: [
    ...
    `A visão que tive era como a que eu tivera quando ele veio destruir a cidade e como as que eu tivera junto ao rio Quebar; e me prostrei com o rosto em terra.`,
  ...
  44: [
    ...
    `O SENHOR me disse: “Filho do homem, preste atenção, olhe e ouça atentamente tudo o que eu disser acerca de todos os regulamentos relacionados com o templo do SENHOR. Preste atenção à entrada do templo e a todas as saídas do santuário.`,
    ...
    `Em vez de cumprirem seu dever quanto às minhas coisas sagradas, vocês encarregaram outros do meu santuário.`,
    ...
    `Mas, porque os serviram na presença de seus ídolos e fizeram a nação de Israel cair em pecado, jurei de mão erguida que eles sofrerão as consequências de sua iniquidade. Palavra do Soberano, o SENHOR.`,
    ...
    `“Mas os sacerdotes levitas, descendentes de Zadoque, que fielmente executaram os deveres do meu santuário quando os israelitas se desviaram de mim, se aproximarão para ministrar diante de mim; eles estarão diante de mim para oferecer sacrifícios de gordura e de sangue. Palavra do Soberano, o SENHOR.`,
  ...
  45: [
    ...
    `Desse terreno, uma área quadrada de duzentos e cinquenta metros de lado servirá para o santuário, com vinte e cinco metros ao redor para terreno aberto.`,
    ...
    `O peso padrão deve ser de doze gramas. Vinte pesos, mais vinte e cinco pesos, mais quinze pesos equivalem a setecentos e vinte gramas.`,
    ...
    `Ele fornecerá como oferta de cereal uma arroba para cada novilho e uma arroba para cada carneiro, com um galão de azeite para cada arroba.`,
