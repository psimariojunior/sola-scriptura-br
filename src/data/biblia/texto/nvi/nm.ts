const data: Record<number, string[]> = {
  1: [
    ...
    `Foram esses os escolhidos da comunidade, líderes das tribos dos seus antepassados, chefes dos clãs de Israel.`,
  ...
  5: [
    ...
    `Então o sacerdote fará a mulher jurar e lhe dirá: Se nenhum outro homem se deitou com você e se você não foi infiel nem se tornou impura enquanto casada, que esta água amarga que traz maldição não faça mal a você.`,
    ...
    `Se ela houver se contaminado, sendo infiel ao seu marido, quando o sacerdote fizer que ela beba a água que traz maldição, essa água entrará nela e causará um amargo sofrimento; sua barriga inchará e ela, incapaz de ter filhos, se tornará objeto de maldição no meio do seu povo.`,
    ...
    `Se a suspeita se confirmar ou não, o marido estará inocente; mas a mulher sofrerá as consequências da sua iniquidade”.`,
  ],
  6: [
  ...
  12: [
    ...
    `Não permita que ela fique como um feto abortado que sai do ventre de sua mãe com a metade do corpo destruída”.`,
  ...
  13: [
    ...
    `São esses os nomes dos homens que Moisés enviou em missão de reconhecimento do território. (A Oseias, filho de Num, Moisés deu o nome de Josué.)`,
    ...
    `E deram o seguinte relatório a Moisés: “Entramos na terra à qual você nos enviou, onde há leite e mel com fartura! Aqui estão alguns frutos dela.`,
  ...
  14: [
    ...
    `Então Moisés e Arão prostraram-se com o rosto em terra, diante de toda a assembleia dos israelitas.`,
    ...
    `e falarão disso aos habitantes desta terra. Eles ouviram que tu, ó SENHOR, estás com este povo e que te veem face a face, SENHOR, e que a tua nuvem paira sobre eles, e que vais adiante deles numa coluna de nuvem de dia e numa coluna de fogo de noite.`,
    ...
    `‘O SENHOR é muito paciente e grande em fidelidade e perdoa a iniquidade e a rebelião, se bem que não deixa o pecado sem punição e castiga os filhos pela iniquidade dos pais até a terceira e quarta gerações’.`,
    `Segundo a tua grande fidelidade, perdoa a iniquidade deste povo, como a este povo tens perdoado desde que saíram do Egito até agora”.`,
    ...
    `Visto que os amalequitas e os cananeus habitam nos vales, amanhã deem meia-volta e partam em direção ao deserto pelo caminho que vai para o mar Vermelho”.`,
  ...
  15: [
    `O SENHOR disse a Moisés:`,
    `“Diga o seguinte aos israelitas: Quando entrarem na terra que dou a vocês para sua habitação`,
  ...
  16: [
    ...
    `e eles se insurgiram contra Moisés. Com eles estavam duzentos e cinquenta israelitas, líderes bem conhecidos na comunidade e que haviam sido nomeados membros do concílio.`,
    `Eles se ajuntaram contra Moisés e Arão, e lhes disseram: “Basta! A assembleia toda é santa, cada um deles é santo, e o SENHOR está no meio deles. Então, por que vocês se colocam acima da assembleia do SENHOR?”`,
    ...
    `Não é suficiente para vocês que o Deus de Israel os tenha separado do restante da comunidade de Israel e os tenha trazido para junto de si a fim de realizarem o trabalho no tabernáculo do SENHOR e para estarem preparados para servir a comunidade?`,
    ...
    `Além disso, você não nos levou a uma terra onde há leite e mel com fartura, nem nos deu uma herança de campos e vinhas. Você pensa que pode cegar os olhos destes homens? Nós não iremos!”`,
    ...
    `Cada homem pegará o seu incensário, nele colocará incenso e o apresentará ao SENHOR. Serão duzentos e cinquenta incensários ao todo. Você e Arão também apresentarão os seus incensários”.`,
    ...
    `Mas Moisés e Arão prostraram-se com o rosto em terra e disseram: “Ó Deus, Deus que a todos dá vida , ficarás tu irado contra toda a comunidade quando um só homem pecou?”`,
    `Então o SENHOR disse a Moisés:`,
    ...
    `Desceram vivos à sepultura, com tudo o que possuíam; a terra fechou-se sobre eles, e pereceram, desaparecendo do meio da assembleia.`,
  ...
  18: [
    ...
    `“Também dou a você, e a seus filhos e filhas, por decreto perpétuo, as contribuições que cabe a vocês de todas as ofertas dos israelitas e que devem ser ritualmente movidas. Todos os da sua família que estiverem cerimonialmente puros poderão comê-las.`,
  ...
  19: [
    ...
    `Deverá purificar-se com essa água no terceiro e no sétimo dias; então estará puro. Mas, se não se purificar no terceiro e no sétimo dias, não estará puro.`,
  ...
  20: [
    ...
    `Moisés e Arão saíram de diante da assembleia para a entrada da Tenda do Encontro e se prostraram com o rosto em terra, e a glória do SENHOR lhes apareceu.`,
    `E o SENHOR disse a Moisés:`,
    ...
    `O SENHOR, porém, disse a Moisés e a Arão: “Como vocês não confiaram em mim para honrar minha santidade à vista dos israelitas, vocês não conduzirão esta comunidade para a terra que dou a vocês”.`,
  ...
  22: [
    ...
    `enviou mensageiros para chamar Balaão, filho de Beor, que estava em Petor, perto do Eufrates , em sua terra natal. A mensagem de Balaque dizia: “Um povo que saiu do Egito cobre a face da terra e se estabeleceu perto de mim.`,
    ...
    `Disse-lhes Balaão: “Passem a noite aqui, e eu trarei a vocês a resposta que o SENHOR me der”. E os líderes moabitas ficaram com ele.`,
    ...
    `Naquela noite, Deus veio a Balaão e lhe disse: “Visto que esses homens vieram chamá-lo, vá com eles, mas faça apenas o que eu disser a você”.`,
    ...
    `Quando a jumenta viu o Anjo do SENHOR parado no caminho, empunhando uma espada, saiu do caminho e prosseguiu pelo campo. Balaão bateu nela para fazê-la voltar ao caminho.`,
    ...
    `Então o SENHOR abriu os olhos de Balaão, e ele viu o Anjo do SENHOR parado no caminho, empunhando a sua espada. Então Balaão inclinou-se e prostrou-se com o rosto em terra.`,
    ...
    `Então o Anjo do SENHOR disse a Balaão: “Vá com os homens, mas fale apenas o que eu disser a você”. Assim Balaão foi com os príncipes de Balaque.`,
  ...
  24: [
    ...
    `Balaão viu Amaleque e pronunciou este oráculo: “Amaleque foi o primeiro das nações, mas o seu fim será destruição”.`,
  ...
  25: [
    ...
    `E o SENHOR disse a Moisés:`,
    `“Fineias, filho de Eleazar, neto do sacerdote Arão, desviou a minha ira de sobre os israelitas, pois foi zeloso, com o mesmo zelo que tenho por eles, para que em meu zelo eu não os consumisse.`,
  ...
  27: [
    ...
    `Se ainda seu pai não tiver irmãos, deem a herança ao parente mais próximo em seu clã”. Esta será uma exigência legal para os israelitas, como o SENHOR ordenou a Moisés.`,
  ...
  28: [
    ...
    `No primeiro dia convoquem uma santa assembleia e não façam trabalho algum.`,
  ...
  29: [
    `“No primeiro dia do sétimo mês convoquem uma santa assembleia e não façam trabalho algum. Nesse dia vocês tocarão as trombetas.`,
    ...
    `“No décimo quinto dia do sétimo mês convoquem uma santa assembleia e não façam trabalho algum. Celebrem uma festa ao SENHOR durante sete dias.`,
    ...
    `Para a oferta de novilhos, carneiros e cordeiros, preparem ofertas derramadas e de cereal, de acordo com o número especificado.`,
    `Ofereçam também um bode como sacrifício pelo pecado, além do holocausto diário com a oferta derramada e com a oferta de cereal.`,
    `“No oitavo dia convoquem uma assembleia e não façam trabalho algum.`,
    ...
    `Ofereçam também um bode como sacrifício pelo pecado, além do holocausto diário com a oferta derramada e com a oferta de cereal.`,
    `“Além dos votos que fizerem e das ofertas voluntárias, preparem isto para o SENHOR nas festas que são designadas a vocês: os holocaustos, as ofertas derramadas, de cereal e de comunhão ”.`,
  ...
  30: [
    ...
    `“Se ela se casar depois de fazer um voto ou depois de seus lábios proferirem uma promessa precipitada pela qual obriga a si mesma`,
  ...
  31: [
    ...
    `Moisés os enviou à guerra, mil de cada tribo, juntamente com Fineias, filho do sacerdote Eleazar, que levou consigo objetos do santuário e as cornetas para o toque de guerra.`,
  ...
  33: [
    ...
    `“Se, contudo, vocês não expulsarem os habitantes da terra, aqueles que vocês permitirem ficar se tornarão farpas em seus olhos e espinhos em suas costas. Eles causarão problemas para vocês na terra em que vocês irão morar.`,
