const data: Record<number, string[]> = {
  1: [
    ...
    `Então os homens de Judá disseram aos seus irmãos de Simeão: “Venham conosco ao território que nos foi designado por sorteio, e lutemos contra os cananeus. Iremos juntos para o território”. E os homens de Simeão foram com eles.`,
    ...
    `Os descendentes do sogro de Moisés, o queneu, saíram da Cidade das Palmeiras com os homens de Judá e passaram a viver no meio do povo do deserto de Judá, no Neguebe, perto de Arade.`,
    ...
    `Quando os espias viram um homem saindo da cidade, disseram-lhe: “Mostre-nos como entrar na cidade, e nós pouparemos a sua vida”.`,
  ...
  8: [
    ...
    `Em Sucote, disse ele aos homens dali: “Peço a vocês um pouco de pão para as minhas tropas; os homens estão cansados, e eu ainda estou perseguindo os reis de Midiã, Zeba e Zalmuna”.`,
    ...
    `E prosseguiu: “Só faço a vocês um pedido: que cada um de vocês me dê um brinco da sua parte dos despojos”. (Os ismaelitas costumavam usar brincos de ouro.)`,
  ...
  13: [
    ...
    `quando a chama do altar subiu ao céu, o Anjo do SENHOR subiu na chama. Vendo isso, Manoá e sua mulher prostraram-se com o rosto em terra.`,
  ...
  16: [
    ...
    `Os líderes dos filisteus foram dizer a ela: “Veja se consegue induzi-lo a mostrar para você o segredo da sua grande força e como poderemos dominá-lo, para que o amarremos e o subjuguemos. Cada um de nós dará a você treze quilos de prata”.`,
    ...
    `Disse Dalila a Sansão: “Até agora você me fez de boba e mentiu para mim. Diga-me como pode ser amarrado”. Ele respondeu: “Se você tecer num pano as sete tranças da minha cabeça e o prender com uma lançadeira, ficarei tão fraco quanto qualquer outro homem”. Assim, enquanto ele dormia, Dalila teceu as sete tranças da sua cabeça num pano`,
  ...
  20: [
    `Então todos os israelitas, de Dã a Berseba, e de Gileade, saíram como um só homem e se reuniram em assembleia perante o SENHOR, em Mispá.`,
    `Os líderes de todo o povo das tribos de Israel tomaram seus lugares na assembleia do povo de Deus, quatrocentos mil soldados armados de espada.`,
    ...
    `e Fineias, filho de Eleazar, filho de Arão, ministrava perante ela.) Perguntaram: “Sairemos de novo ou não, para lutar contra os nossos irmãos benjamitas?” O SENHOR respondeu: “Vão, pois amanhã eu os entregarei nas suas mãos”.`,
