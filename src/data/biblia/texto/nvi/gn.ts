const data: Record<number, string[]> = {
  ...
  21: [
    ...
    `Na manhã seguinte, Abraão pegou alguns pães e uma vasilha de couro cheia dʼágua, entregou-os a Hagar e, tendo-os colocado nos ombros dela, despediu-a com o menino. Ela se pôs a caminho e ficou vagando pelo deserto de Berseba.`,
  ...
  22: [
    ...
    `Disse ele a seus servos: “Fiquem aqui com o jumento enquanto eu e o rapaz vamos até lá. Depois de adorar, voltaremos”.`,
  ...
  26: [
    ...
    `Os servos de Isaque cavaram no vale e descobriram um veio dʼágua.`,
  ...
  27: [
    ...
    `Quando contaram a Rebeca o que seu filho Esaú dissera, ela mandou chamar Jacó, seu filho mais novo, e lhe disse: “Esaú está se consolando com a ideia de matá-lo.`,
  ...
  28: [
    ...
    `Esaú viu que Isaque havia abençoado a Jacó e o havia mandado a Padã-Arã para escolher ali uma mulher e que, ao abençoá-lo, dera-lhe a ordem de não se casar com mulher cananeia.`,
  ...
  29: [
    ...
    `Disse ele: “Olhem, o sol ainda vai alto e não é hora de recolher os rebanhos. Deem de beber às ovelhas e levem-nas de volta ao pasto”.`,
  ...
  32: [
    ...
    `Designou cada rebanho sob o cuidado de um servo e disse-lhes: “Vão à minha frente e mantenham certa distância entre um rebanho e outro”.`,
    ...
    `Quando o homem viu que não poderia dominar Jacó, tocou-lhe na articulação da coxa, de forma que a deslocou enquanto lutavam.`,
  ...
  41: [
    ...
    `Também o fez subir em sua segunda carruagem real, e à frente os arautos iam gritando: “Abram caminho!” Assim José foi posto no comando de toda a terra do Egito.`,
  ...
  46: [
    ...
    `Estes foram os filhos de Simeão: Jemuel, Jamim, Oade, Jaquim, Zoar e Saul, filho de uma cananeia.`,
    ...
    `Foram esses os filhos que Lia deu a Jacó em Padã-Arã , além de Diná, sua filha. Seus descendentes eram ao todo trinta e três.`,
  ...
  49: [
    ...
    `Que eu não entre no conselho deles, nem participe da sua assembleia, porque em sua ira mataram homens e a seu bel-prazer aleijaram bois, cortando-lhes o tendão.`,
