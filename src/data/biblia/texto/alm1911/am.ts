const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `Vinde a Beth-el, e transgredi, em Gilgal augmentae as transgressões, e de manhã trazei os vossos sacrificios, e os vossos dizimos ao terceiro dia.`,
    ...
    `Além d'isso, retive de vós a chuva, faltando ainda tres mezes até á sega; e fiz chover sobre uma cidade, e sobre outra cidade não fiz chover; sobre um campo choveu, mas o outro, sobre o qual não choveu, se seccou.`,
    ...
    `Enviei a peste contra vós, á maneira do Egypto: os vossos mancebos matei á espada, e os vossos cavallos deixei levar presos, e o fedor dos vossos exercitos fiz subir aos vossos narizes; comtudo não vos convertestes a mim, disse o Senhor.`,
    `Subverti a alguns d'entre vós, como Deus subverteu a Sodoma e Gomorrah, sendo vós como um tição arrebatado do incendio; comtudo não vos convertestes a mim, disse o Senhor.`,
  ...
  6: [
    `Ai dos descançados em Sião, e dos seguros no monte de Samaria: que teem nome entre as primeiras das nações, e aos quaes se foi a casa de Israel!`,
  ...
  7: [
    ...
    `E aconteceu que, como elles de todo tivessem comido a herva da terra, eu disse: Senhor Jehovah, ora perdoa: como se levantará Jacob? porque é pequeno.`,
    ...
    `Mostrou-me tambem assim; e eis que o Senhor estava sobre um muro, feito a prumo: e tinha um prumo na sua mão.`,
    ...
    `Então Amazia, o sacerdote em Beth-el, enviou a Jeroboão, rei de Israel, dizendo: Amós tem conspirado contra ti, no meio da casa de Israel; a terra não poderá soffrer todas as suas palavras.`,
    ...
    `Portanto assim diz o Senhor: Tua mulher se prostituirá na cidade, e teus filhos e tuas filhas cairão á espada, e a tua terra será repartida a cordel, e tu morrerás na terra immunda, e Israel certamente será levado captivo para fóra da sua terra.`,
  ],
  8: [
  ...
  9: [
    `Vi o Senhor, que estava em pé sobre o altar, e me disse: Fere o capitel, e estremeçam os umbraes, e corta-lhes em pedaços a cabeça a todos elles; e eu matarei á espada até ao ultimo d'elles: o que fugir d'entre elles não escapará, nem o que escapar d'entre elles se salvará`,
    ...
    `E tornarei o captiveiro do meu povo Israel, e reedificarão as cidades assoladas, e n'ellas habitarão, e plantarão vinhas, e beberão o seu vinho, e farão jardins, e lhes comerão o fructo.`,
