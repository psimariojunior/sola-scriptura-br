const data: Record<number, string[]> = {
  ...
  4: [
    ...
    `E, se ainda assim não acreditarem nesses dois sinais nem lhe derem ouvidos, tire um pouco de água do Nilo e derrame-a em terra seca. Quando você derramar essa água em terra seca, ela se transformará em sangue”.`,
    ...
    `Você falará com ele e dirá o que ele deve dizer; eu estarei com vocês quando falarem e direi a vocês o que fazer.`,
    ...
    `e eu já disse a você que deixe o meu filho ir para prestar-me culto. Mas você não quis deixá-lo ir; por isso matarei o seu primeiro filho!”`,
  ...
  6: [
    ...
    `Os filhos de Simeão foram: Jemuel, Jamim, Oade, Jaquim, Zoar e Saul, filho de uma cananeia. Esses foram os clãs de Simeão.`,
    ...
    `Eleazar, filho de Arão, tomou por mulher uma das filhas de Futiel, e ela lhe deu à luz Fineias. Esses foram os chefes das famílias dos levitas, conforme seus clãs.`,
  ...
  7: [
    `O SENHOR lhe respondeu: “Dou a você a minha autoridade perante o faraó, e seu irmão, Arão, será seu porta-voz.`,
    `Você falará tudo o que eu ordenar, e o seu irmão, Arão, dirá ao faraó que deixe os israelitas sair do país.`,
    ...
    `“Quando o faraó pedir que façam algum milagre, diga a Arão que tome a sua vara e jogue-a diante do faraó; e ela se transformará numa serpente”.`,
  ...
  12: [
    ...
    `“Obedeçam a essas instruções como decreto perpétuo para vocês e para os seus descendentes.`,
  ...
  13: [
    ...
    `Quando o SENHOR os fizer entrar na terra dos cananeus, dos hititas, dos amorreus, dos heveus e dos jebuseus—terra que ele jurou aos seus antepassados que daria a vocês, terra onde há leite e mel com fartura—vocês deverão celebrar esta cerimônia neste mesmo mês.`,
    ...
    `“Isto será como sinal em sua mão e símbolo em sua testa de que o SENHOR nos tirou do Egito com mão poderosa”.`,
    `Quando o faraó deixou sair o povo, Deus não o guiou pela rota da terra dos filisteus, embora esse fosse o caminho mais curto, pois disse: “Se eles se defrontarem com a guerra, talvez se arrependam e voltem para o Egito”.`,
  ...
  14: [
    ...
    `Contaram ao rei do Egito que o povo havia fugido. Então o faraó e os seus conselheiros mudaram de ideia e disseram: “O que foi que fizemos? Deixamos os israelitas sair e perdemos os nossos escravos!”`,
    ...
    `Já tínhamos dito a você no Egito: ‘Deixe-nos em paz! Seremos escravos dos egípcios!’ Antes ser escravos dos egípcios do que morrer no deserto!”`,
  ...
  16: [
    ...
    `Quando os israelitas viram aquilo, começaram a perguntar uns aos outros: “Que é isso?”, pois não sabiam do que se tratava. Disse-lhes Moisés: “Este é o pão que o SENHOR deu a vocês para comer.`,
    ...
    `Vejam que o SENHOR deu o sábado a vocês; por isso, no sexto dia, ele lhes envia pão para dois dias. No sétimo dia, fiquem todos onde estiverem; ninguém deve sair”.`,
  ...
  18: [
    ...
    `Você e o seu povo ficarão esgotados, pois essa tarefa é pesada demais. Você não pode executá-la sozinho.`,
    ...
    `Escolheu homens capazes de todo o Israel e colocou-os como líderes do povo: chefes de mil, de cem, de cinquenta e de dez.`,
  ...
  19: [
    ...
    `Agora, se me obedecerem fielmente e guardarem a minha aliança, vocês serão o meu tesouro pessoal entre todas as nações. Embora toda a terra seja minha,`,
    ...
    `Disse o SENHOR a Moisés: “Virei numa densa nuvem, a fim de que o povo, ouvindo-me falar com você, passe a confiar sempre em você”. Então Moisés relatou ao SENHOR o que o povo lhe dissera.`,
  ...
  30: [
    ...
    `Faça com eles o óleo sagrado para as unções, uma mistura de aromas—obra de perfumista. Esse será o óleo sagrado para as unções.`,
  ...
  31: [
    ...
    `e o óleo para as unções e o incenso aromático para o Lugar Santo. Tudo deve ser feito exatamente como eu lhe ordenei”.`,
  ...
  33: [
    ...
    `Vão para a terra onde há leite e mel com fartura. Mas eu não irei com vocês, pois vocês são um povo obstinado, e eu poderia destruí-los no caminho”.`,
  ...
  34: [
    ...
    `e a escolher para os seus filhos mulheres dentre as filhas deles. Quando elas se prostituírem seguindo os seus deuses, poderão levar os seus filhos a se prostituir também.`,
  ...
  35: [
    ...
    `fios de tecidos azul, roxo e vermelho; linho fino e pelos de cabra;`,
    ...
    `Todos os que se dispuseram, tanto homens como mulheres, trouxeram joias de ouro de todos os tipos: broches, brincos, anéis e ornamentos; e apresentaram seus objetos de ouro como oferta ritualmente movida perante o SENHOR.`,
    `Todos os que possuíam fios de tecidos azul, roxo e vermelho, ou linho fino, ou pelos de cabra, peles de carneiro tingidas de vermelho, ou couro, trouxeram-nos.`,
  ...
  36: [
    `“Assim Bezalel, Aoliabe e todos os homens capazes, a quem o SENHOR concedeu destreza e habilidade para fazer toda a obra de construção do santuário, realizarão a obra como o SENHOR ordenou”.`,
    ...
    `Depois fizeram cinquenta laçadas em volta da borda da última cortina interna de um dos conjuntos e também na borda da última cortina interna do outro conjunto.`,
  ...
  38: [
    ...
    `O lado ocidental, com suas cortinas externas, tinha vinte e dois metros e meio de largura, com dez colunas e dez bases. Os ganchos e as ligaduras das colunas eram de prata.`,
    ...
    `seis gramas para cada um dos recenseados, isto é, para seiscentos e três mil, quinhentos e cinquenta homens de vinte anos de idade para cima.`,
