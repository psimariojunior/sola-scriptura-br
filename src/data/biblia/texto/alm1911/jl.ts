const data: Record<number, string[]> = {
  1: [
    ...
    `Despertae-vos, bebados, e chorae e uivae, todos os que bebeis vinho, por causa do mosto, porque cortado é da vossa bocca.`,
    ...
    `Cingi-vos e lamentae-vos, sacerdotes; uivae, ministros do altar; entrae e passae, vestidos de saccos, a noite, ministros do meu Deus; porque a offerta de manjares, e a libação, affastada está da casa de vosso Deus.`,
    `Sanctificae um jejum, apregoae um dia de prohibição, congregae os anciãos, e todos os moradores d'esta terra, na casa do Senhor vosso Deus, e clamae ao Senhor.`,
  ...
  3: [
    ...
    `E tambem que tendes vós comigo, Tyro e Sidon, e todos os termos da Palestina? É tal o pago que vós me daes? pois se me pagaes assim, bem depressa vos farei tornar a vossa paga sobre a vossa cabeça.`,
    ...
    `O Egypto se fará uma assolação, e Edom se fará um deserto de solidão, por causa da violencia que fizeram aos filhos de Judah, em cuja terra derramaram sangue innocente.`,
