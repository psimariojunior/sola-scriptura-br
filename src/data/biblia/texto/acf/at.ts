const data: Record<number, string[]> = {
  ...
  9: [
    ...
    `E disse-lhe o Senhor: Levantate, e vai à rua chamada Direita, e pergunta em casa de Judas por um homem de Tarso chamado Saulo; pois eis que ele está orando;`,
