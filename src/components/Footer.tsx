...
import { BookOpen, Mail, ExternalLink, Heart } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div className="sm:col-span-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://twitter.com/solascriptura_br" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors duration-200" aria-label="Twitter / X">
