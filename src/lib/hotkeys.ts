...
export const HOTKEYS: HotkeyDefinition[] = [
  ...
  {
    id: 'versiculo-anterior',
    combo: 'arrowup',
    description: 'Versículo anterior',
    scope: 'page',
    icon: ArrowUp,
    group: 'Bíblia',
  },
  {
    id: 'proximo-versiculo',
    combo: 'arrowdown',
    description: 'Próximo versículo',
    scope: 'page',
    icon: ArrowDown,
    group: 'Bíblia',
  },
  {
    id: 'busca-biblia',
    combo: 'mod+k',
    description: 'Buscar no texto bíblico',
    scope: 'page',
    icon: Search,
    group: 'Bíblia',
  },
  {
    id: 'versiculo-do-dia',
    combo: 'mod+d',
    description: 'Ir para o versículo do dia',
    scope: 'page',
    icon: Sparkles,
    group: 'Bíblia',
  },
  {
    id: 'tela-cheia',
    combo: 'f',
    description: 'Tela cheia / modo zen',
    scope: 'page',
    icon: Maximize2,
    group: 'Bíblia',
  },
  {
    id: 'vista-interlinear',
    combo: 'i',
    description: 'Alternar vista interlinear',
    scope: 'page',
    icon: Languages,
    group: 'Bíblia',
  },
  {
    id: 'split-view',
    combo: 's',
    description: 'Split view (Bíblia + notas)',
    scope: 'page',
    icon: Columns,
    group: 'Bíblia',
  },
