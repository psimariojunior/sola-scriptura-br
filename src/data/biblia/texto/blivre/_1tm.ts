const data: Record<number, string[]> = {
  ...
  6: [
    `Todos os servos que estão sob escravidão  estimem aos seus senhores como dignos de toda honra; para que o nome de Deus e a doutrina não sejam blasfemados.`,
