const data: Record<number, string[]> = {
  ...
  12: [
    ...
    `Jesua gerou a Joiaquim, Joiaquim gerou a Eliasibe, Eliasibe gerou a Joiada,`,
    `Joiada gerou a Jônatas, e Jônatas gerou a Jadua.`,
    `Nos dias de Joiaquim, foram sacerdotes, cabeças de famílias: de Seraías, Meraías; de Jeremias, Hananias;`,
    ...
    `como também Maaseias, Semaías, Eleazar, Uzi, Joanã, Malquias, Elão e Ezer; e faziam-se ouvir os cantores sob a direção de Jezraías.`,
