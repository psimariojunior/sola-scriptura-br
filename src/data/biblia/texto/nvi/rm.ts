const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Contudo, por causa da sua teimosia e do seu coração obstinado, você está acumulando ira contra você mesmo, para o dia da ira de Deus, quando se revelará o seu justo julgamento.`,
  ...
  3: [
    ...
    `Sabemos que tudo o que a Lei diz, o diz àqueles que estão debaixo dela, para que toda boca se cale e o mundo todo esteja sob o juízo de Deus.`,
  ...
  9: [
    ...
    `o povo de Israel. Deles é a adoção de filhos; deles são a glória divina, as alianças, a concessão da Lei, a adoração no templo e as promessas.`,
    ...
    `Que dizer, se ele fez isso para tornar conhecidas as riquezas de sua glória aos vasos de sua misericórdia, que preparou de antemão para glória,`,
  ...
  14: [
    ...
    `Portanto, deixemos de julgar uns aos outros. Em vez disso, façamos o propósito de não pôr pedra de tropeço ou obstáculo no caminho do irmão.`,
  ...
  16: [
    ...
    `Saúdem uns aos outros com beijo santo. Todas as igrejas de Cristo enviam saudações.`,
    ...
    `Gaio, cuja hospitalidade eu e toda a igreja desfrutamos, envia-lhes saudações. Erasto, administrador da cidade, e nosso irmão Quarto enviam saudações.`,
