const data: Record<number, string[]> = {
  1: [
    ...
    "de maneira que nós mesmos nos gloriamos de vós nas igrejas de Deus, pela vossa paciência e fé, em todas as vossas perseguições e aflições que suportais;",
    "prova evidente do justo juízo de Deus, para que sejais havidos por dignos do Reino de Deus, pelo qual também padeceis;",
    ...
    "com chama de fogo, tomando vingança dos que não conhecem a Deus e dos que não obedecem ao evangelho de nosso Senhor Jesus Cristo;",
    "os quais, por castigo, padecerão eterna perdição, ante a face do Senhor e a glória do seu poder,",
    "quando, naquele dia, vier para ser glorificado nos seus santos e para se fazer admirável em todos os que creem (porquanto o nosso testemunho foi crido entre vós).",
  ...
  2: [
    ...
    "que não vos movais facilmente do vosso entendimento, nem vos perturbeis, quer por espírito, quer por palavra, quer por epístola, como se fosse nossa, como se o Dia de Cristo estivesse já perto.",
    ...
    "Mas devemos sempre dar graças a Deus por vós, irmãos amados do Senhor, porquanto Deus vos escolheu desde o princípio para a salvação, em santificação do Espírito e fé da verdade,",
    "para o que, pelo nosso evangelho, vos chamou, para alcançardes a glória de nosso Senhor Jesus Cristo.",
    "Assim, pois, irmãos, estai firmes e retende as tradições que vos foram ensinadas, seja por palavra, seja por epístola nossa.",
  ...
  3: [
    "Finalmente, irmãos, rogai por nós, para que a palavra do Senhor tenha livre curso e seja glorificada, como também o é entre vós;",
    "e para que sejamos livres dos homens dissolutos e maus; porque a fé não é de todos.",
    "Mas fiel é o Senhor, o qual vos confirmará e guardará do maligno.",
    "E confiamos no Senhor acerca de vós, que não só fazeis o que vos mandamos, como também o fareis ainda mais.",
    "Ora, o Senhor encaminhe os vossos corações no amor de Deus e na paciência de Cristo.",
    "Mandamo-vos, porém, irmãos, em nome de nosso Senhor Jesus Cristo, que vos aparteis de todo irmão que anda desordenadamente e não segundo a tradição que de nós recebeu.",
    "Porque vós mesmos sabeis como convém imitar-nos, pois que não nos portamos desordenadamente entre vós,",
    "nem comemos de graça o pão de ninguém, antes, com trabalho e fadiga, trabalhando noite e dia, para não sermos pesados a nenhum de vós.",
    ...
    "Mas, se alguém não obedecer à nossa palavra, por esta epístola, notai o tal e não vos mistureis com ele, para que se envergonhe;",
    "todavia, não o tenhais como inimigo, mas admoestai-o como irmão.",
    "Ora, o próprio Senhor da paz vos dê paz sempre, em todos os modos. O Senhor seja com todos vós.",
    "Saudação da minha mão, de Paulo, que é o sinal em toda epístola; assim escrevo.",
