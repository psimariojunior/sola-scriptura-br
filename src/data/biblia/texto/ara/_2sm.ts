const data: Record<number, string[]> = {
  ...
  20: [
    ...
    `Vieram Joabe e os homens, e o cercaram em Abel-Bete-Maaca, e levantaram contra a cidade um montão da altura do muro; e todo o povo que estava com Joabe trabalhava no muro para o derribar.`,
