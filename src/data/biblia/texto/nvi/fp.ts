const data: Record<number, string[]> = {
  ...
  2: [
    ...
    `Espero no Senhor Jesus enviar Timóteo brevemente, para que eu também me sinta animado quando receber notícias de vocês.`,
  ...
  3: [
    `Finalmente, meus irmãos, alegrem-se no Senhor! Escrever de novo as mesmas coisas não é cansativo para mim e é uma segurança para vocês.`,
