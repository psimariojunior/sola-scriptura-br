...
var HebraicoService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.HebraicoService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const palavra_hebraica_entity_1 = require("../domain/palavra-hebraica.entity");
let HebraicoService = HebraicoService_1 = class HebraicoService {
    constructor(palavraRepo) {
        this.palavraRepo = palavraRepo;
        this.logger = new common_1.Logger(HebraicoService_1.name);
    }
...
exports.HebraicoService = HebraicoService;
exports.HebraicoService = HebraicoService = HebraicoService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(palavra_hebraica_entity_1.PalavraHebraica)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], HebraicoService);
//# sourceMappingURL=hebraico.service.js.map