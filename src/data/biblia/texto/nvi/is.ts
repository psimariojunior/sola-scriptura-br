const data: Record<number, string[]> = {
  1: [
    ...
    `Por que haveriam de continuar a ser castigados? Por que insistem na revolta? A cabeça toda está ferida, todo o coração está sofrendo.`,
  ...
  2: [
    ...
    `Os olhos do arrogante serão humilhados e o orgulho dos homens será abatido; somente o SENHOR será exaltado naquele dia.`,
  ...
  5: [
    ...
    `Pois eu digo a vocês o que vou fazer com a minha vinha: Derrubarei a sua cerca para que ela seja transformada em pasto; derrubarei o seu muro para que seja pisoteada.`,
  ...
  13: [
    ...
    `Castigarei o mundo por causa da sua maldade, os ímpios pela sua iniquidade. Darei fim à arrogância dos altivos e humilharei o orgulho dos cruéis.`,
    ...
    `Babilônia, a joia dos reinos, o esplendor do orgulho dos babilônios , será destruída por Deus, à semelhança de Sodoma e Gomorra.`,
  ...
  17: [
    `Advertência contra Damasco: Damasco deixará de ser cidade; vai se tornar um monte de ruínas.`,
  ...
  22: [
    ...
    `O SENHOR dos Exércitos revelou-me isto: “Até o dia de sua morte não haverá propiciação em favor desse pecado”, diz o Soberano, o SENHOR dos Exércitos.`,
    `Assim diz o Soberano, o SENHOR dos Exércitos: “Vá dizer a esse Sebna, administrador do palácio:`,
    `Que faz você aqui, e quem deu a você permissão para abrir aqui um túmulo, você que o está lavrando no alto do monte e talhando na rocha o seu lugar de descanso?`,
  ...
  23: [
    `Advertência contra Tiro: Pranteiem, navios de Társis! Pois Tiro foi destruída e ficou sem nenhuma casa e sem porto. De Chipre veio a você essa mensagem.`,
    ...
    `Quem planejou isso contra Tiro, contra aquela que dava coroas, cujos comerciantes são príncipes, cujos negociantes são famosos em toda a terra?`,
    ...
    `Olhem para a terra dos babilônios ; esse é o povo que não existe mais! Os assírios a deixaram para as criaturas do deserto; ergueram torres de vigia, despojaram suas cidadelas e fizeram dela uma ruína.`,
  ...
  25: [
    ...
    `destruirá a morte para sempre. O Soberano, o SENHOR, enxugará as lágrimas de todo rosto e retirará de toda a terra a zombaria do seu povo. Foi o SENHOR quem o disse!`,
  ...
  28: [
    ...
    `Vejam! O Senhor envia alguém que é poderoso e forte. Como chuva de granizo e vento destruidor, como violento aguaceiro e tromba dʼágua inundante, ele a lançará com força ao chão.`,
  ...
  32: [
    ...
    `Tremam, vocês, mulheres tranquilas! Estremeçam, vocês, que se sentem seguras! Arranquem suas vestes e vistam roupas de lamento.`,
  ...
  36: [
    ...
    `Pois veja! Agora você está confiando no Egito, aquela cana esmagada, que fura a mão de quem nela se apoia! Assim é o faraó, o rei do Egito, para todos os que dele dependem.`,
    ...
    `“Faça, agora, um acordo com o meu senhor, o rei da Assíria: Eu darei a você dois mil cavalos—se você puder pôr cavaleiros neles!`,
    `Como então você poderá repelir um só dos menores oficiais do meu senhor, confiando que o Egito dará a você carros e cavaleiros?`,
    ...
    `“Não deem atenção a Ezequias. Assim diz o rei da Assíria: ‘Venham fazer as pazes comigo. Então cada um de vocês comerá de sua própria videira e de sua própria figueira, e beberá água de sua própria cisterna,`,
    ...
    `Quem entre todos os deuses dessas nações conseguiu livrar a sua terra? Como então o SENHOR poderá livrar Jerusalém das minhas mãos?’ ”`,
  ...
  37: [
    ...
    `“ ‘Você não soube que há muito eu já o havia ordenado, que desde os dias da antiguidade eu o havia planejado? Agora eu o executo e faço você transformar cidades fortificadas em montões de pedra.`,
    ...
    `“ ‘Eu, porém, sei onde você está, quando sai e quando retorna e quando você se enfurece contra mim.`,
  ...
  40: [
    ...
    `Encorajem Jerusalém e anunciem que ela já cumpriu o trabalho que lhe foi imposto, pagou por sua iniquidade e recebeu da mão do SENHOR em dobro por todos os seus pecados.`,
    ...
    `Uma voz ordena: “Clame”. E eu pergunto: O que clamarei? “Que toda a humanidade é como a relva, e toda a sua glória como a flor da relva.`,
  ...
  44: [
    ...
    `O carpinteiro mede a madeira com uma linha e faz um esboço com um traçador; ele o modela toscamente com formões e o marca com compassos. Ele o faz na forma de homem, de um homem em toda a sua beleza, para que habite num santuário.`,
    ...
    `Para pensar ninguém para, ninguém tem o conhecimento ou o entendimento para dizer: “Metade dela usei como combustível; até mesmo assei pão sobre suas brasas, assei carne e comi. Faria eu algo repugnante com o que sobrou? Iria eu ajoelhar-me diante de um pedaço de madeira?”`,
  ...
  45: [
    ...
    `Por amor de meu servo Jacó, de meu escolhido Israel, eu o convoco pelo nome e concedo a você um título de honra, embora você não me reconheça.`,
    ...
    `Pois assim diz o SENHOR, que criou os céus, ele é Deus; que moldou a terra e a fez, ele a estabeleceu; não a criou para estar vazia, mas a formou para ser habitada; ele diz: “Eu sou o SENHOR, e não há nenhum outro.`,
  ...
  48: [
    ...
    `Por isso há muito contei a você essas coisas; antes que acontecessem eu as anunciei a você para que você não pudesse dizer: ‘Meus ídolos as fizeram; minha imagem de madeira e meu deus de metal as determinaram’.`,
    ...
    `Você não tinha conhecimento nem entendimento; desde a antiguidade o seu ouvido tem se fechado. Sei quão traiçoeiro você é; desde o nascimento você foi chamado rebelde.`,
  ...
  51: [
    ...
    `olhem para Abraão, seu pai, e para Sara, que os deu à luz. Quando eu o chamei, ele era apenas um, e eu o abençoei e o tornei muitos.”`,
  ...
  55: [
    ...
    `Assim como a chuva e a neve descem dos céus e não voltam para eles sem regarem a terra e fazerem-na brotar e florescer, para ela produzir semente para o semeador e pão para o que come,`,
  ...
  56: [
    ...
    `esses eu trarei ao meu santo monte e lhes darei alegria em minha casa de oração. Seus holocaustos e demais sacrifícios serão aceitos em meu altar; pois a minha casa será chamada casa de oração para todos os povos”.`,
  ...
  59: [
    ...
    `Ninguém pleiteia sua causa com justiça, ninguém faz defesa com integridade. Apoiam-se em argumentos vazios e falam mentiras; concebem maldade e geram iniquidade.`,
    ...
    `Assim a justiça retrocede, e a retidão fica a distância, pois a verdade caiu na praça e a honestidade não consegue entrar.`,
  ...
  60: [
    ...
    `“Estrangeiros reconstruirão os seus muros, e seus reis a servirão. Com ira eu a feri, mas com amor mostrarei a você compaixão.`,
    `As suas portas permanecerão abertas; jamais serão fechadas, dia e noite, para que tragam a você as riquezas das nações, com seus reis e sua comitiva.`,
  ...
  63: [
    ...
    `Então o seu povo recordou o passado, o tempo de Moisés e a sua geração: Onde está aquele que os fez passar através do mar, com o pastor do seu rebanho? Onde está aquele que entre eles pôs o seu Espírito Santo,`,
