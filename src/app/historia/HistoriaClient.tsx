...
const PERIODOS_CONFIG: Record<string, { cor: string; icone: string; bgHeader: string }> = {
  'Criacao':            { cor: 'bg-slate-500',     icone: '\u{1F30D}', bgHeader: 'from-slate-500 to-slate-600' },
  'Patriarcas':         { cor: 'bg-amber-500',     icone: '\u26FA', bgHeader: 'from-amber-500 to-amber-600' },
  'Lei e Conquista':    { cor: 'bg-blue-500',      icone: '\u{1F4DC}', bgHeader: 'from-blue-500 to-blue-600' },
  'Reis':               { cor: 'bg-purple-500',    icone: '\u{1F451}', bgHeader: 'from-purple-500 to-purple-600' },
  'Profetas':           { cor: 'bg-rose-500',      icone: '\u{1F4E2}', bgHeader: 'from-rose-500 to-rose-600' },
  'Exilio':             { cor: 'bg-red-500',       icone: '\u{1F3DB}\uFE0F', bgHeader: 'from-red-500 to-red-600' },
  'Vida de Cristo':     { cor: 'bg-green-500',     icone: '\u271D\uFE0F', bgHeader: 'from-green-500 to-green-600' },
  'Igreja Primitiva':   { cor: 'bg-cyan-500',      icone: '\u{1F525}', bgHeader: 'from-cyan-500 to-cyan-600' },
};
...
const CIVILIZACOES: Civilizacao[] = [
  ...
  { nome: 'Assiria',    inicio: -2500, fim: -609,   cor: 'bg-orange-700', abbr: 'AS' },
  { nome: 'Babilonia',  inicio: -1894, fim: -539,   cor: 'bg-amber-700',  abbr: 'BA' },
  { nome: 'Persia',     inicio: -550,  fim: -330,   cor: 'bg-teal-700',   abbr: 'PE' },
  { nome: 'Grecia',     inicio: -800,  fim: -146,   cor: 'bg-indigo-700', abbr: 'GR' },
    ...
    <>
      ...
      <ScrollReveal>
        <div className="glass-card p-1.5 mb-8 rounded-2xl">
          <div className="flex">
            {([
              { id: 'periodos' as const, label: 'Periodos', icon: BookOpen },
              { id: 'timeline' as const, label: 'Linha do Tempo', icon: CalendarDays },
              { id: 'civilizacoes' as const, label: 'Civilizacoes', icon: Globe },
        ...
        <ScrollReveal>
          <div className="glass-card p-6 sm:p-8 rounded-2xl">
            ...
            <p className="text-sm text-muted-foreground mb-8">
              {cronologia.length} eventos — clique em uma referencia para abrir na Biblia
            </p>
        ...
        <ScrollReveal>
          <div className="glass-card p-6 sm:p-8 rounded-2xl">
            <h2 className="font-display text-2xl font-semibold mb-2 flex items-center gap-3">
              ...
              Civilizacoes e o Povo de Deus
            </h2>
            <p className="text-sm text-muted-foreground mb-8">
              Imperios que moldaram o cenario biblico
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-5 bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl">
              ...
              <p className="text-sm text-foreground/80 leading-relaxed">
                A terra de Israel, o Crescente Fertil e as rotas comerciais conectam os eventos biblicos. O Jordao, o Mediterraneo e o deserto sao cenarios centrais.
              </p>
            </div>
            <div className="p-5 bg-gradient-to-br from-amber-500/5 to-amber-500/10 rounded-2xl">
              ...
              <p className="text-sm text-foreground/80 leading-relaxed">
                Sociedade tribal, pastoril e agricola. A familia e o clan sao a base social. Honra, hospitalidade e alianca sao valores fundamentais.
              </p>
            </div>
            <div className="p-5 bg-gradient-to-br from-purple-500/5 to-purple-500/10 rounded-2xl">
              ...
              <h4 className="font-semibold text-sm uppercase tracking-wider text-purple-600 mb-2">Imperios</h4>
              <p className="text-sm text-foreground/80 leading-relaxed">
                Egito, Assiria, Babilonia, Persia, Grecia e Roma dominaram Israel em diferentes periodos, moldando seu contexto politico e religioso.
              </p>
            </div>
          </div>
        </div>
